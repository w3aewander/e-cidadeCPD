...
if (!empty($e55_autori) &&
    $daoAndamentoAutorizacao->travaAutorizacaoAndamento($e55_autori)
) {
    $db_botao = false;
    $msg = "3 - Não é possivel alterar a autorização no andamento em que ele está.";
...
<script>
  function js_verificar() {
    ...
    const vltot = Number(document.form1.e55_vltot.value);
