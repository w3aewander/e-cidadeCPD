  ...
  <tr>
    <td align="center" valign="top">
      ...
      if (!isset($pesquisa_chave)) {
        ...
        $sql = $clabatimento->sql_query("", $sCampos, "k125_sequencial", $sWhereTipoAbatimento, 'k125_sequencial');
        if (!empty($chave_k125_sequencial)) {

           $sql = $clabatimento->sql_query(
             "", $sCampos, "k125_sequencial",
             " k125_sequencial = {$chave_k125_sequencial} " . ($sWhereTipoAbatimento != "" ? " and " . $sWhereTipoAbatimento:" and k125_instit = {$iDBInstit}"), 'k125_sequencial'
           );
        }
