    ...
    <fieldset style="width: 500px;">
        ...
        <fieldset class="separator">
            ...
            <table>
                <tr>
                    <td>
                        <label class="bold" for="cc30_valorinicial">
                            De: </label><?php db_input("cc30_valorinicial", 10, 0, true, 'text', 1); ?>
                        <label class="bold" for="cc30_valorfinal">
                            Até: </label><?php db_input("cc30_valorfinal", 10, 0, true, 'text', 1); ?>
                    </td>
                </tr>
            </table>
        </fieldset>
...
<div id="ctnElemento" class="container" style="display: none">
...
<div id="ctnTipoCompra" style="display: none">
    <div id="lancadorTipoCompra" class="container"></div>
</div>

<div id="ctnEvento" style="display: none">
...
<p style="text-align: center;">
    ...
    <input type="button" id="btnSalvar" value="Salvar" <?php echo $sDesabilitarSalvar ?>
           style="<?php echo $sVisibilidadeSalvar ?>"/>
...
<script>
    ...
    function carregarDados(iCodigo) {
        ...
        var fnRetorno = function (oRetorno, lErro) {
            ...
            gridRecursos.clear();
            for (let recurso of oRetorno.fontesRecursos) {
                preencheCollection(
    ...
    function salvar() {
        ...
        let aRecurso = collectionRecurso.build().map((recurso) => {
            return {
                "sCodigo": recurso.codigo,
                "sDescricao": recurso.descricao
            }
        });
    ...
    function init() {
        ...
        $('ctnElemento').style.display = '';
        $('ctnRecurso').style.display = '';
        $('ctnTipoCompra').style.display = '';
        $('ctnEvento').style.display = '';
