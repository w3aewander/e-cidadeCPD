...
class SigfisArquivoPagamento extends SigfisArquivoBase implements iPadArquivoTXTBase {
  ...
  */
  public function gerarDados() {
    ...
    $sCampos .= "pagordem.e50_codord as codordem, to_char(max(conlancam.c70_data),'YYYYmm') as competencia, orcdotacao.o58_unidade,";
    ...
    $sWhere  .= " group by empempenho.e60_codemp, empempenho.e60_anousu, c70_data, codordem, orcdotacao.o58_orgao, empempenho.e60_numemp, ";
      ...
      for ($i = 0; $i < $clConLanCamEmp->numrows; $i++) {
        ...
        if ($oDadosQuery->valor_pago == 0 ){
           continue;
			...
			$sSqlTotalRetencao .= "WHERE  e20_pagordem = {$codordem}";
