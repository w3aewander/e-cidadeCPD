...
}else if(isset($pTipo) && $pTipo == 4){
  $getLabel = 'Parágrafos para Notificação de Lançamento';
}
?>
<html>
<head>
    ...
    <fieldset>
      ...
      <table>
        <?php 
          ...
          if(isset($pTipo) && ($pTipo == 1 || $pTipo == 2 || $pTipo == 3 || $pTipo == 4)){
            $sWhere .= ' and pl09_tipo = '.$pTipo.' ';
          }
          $pSql  = 'select distinct * from fiscalizacao.fis_paragrafo where pl09_status = true '.$sWhere.' order by pl09_paragrafo';
