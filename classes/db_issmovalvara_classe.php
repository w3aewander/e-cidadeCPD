...
class cl_issmovalvara {
   ...
   public $q120_sequencial = 0;
   public $q120_issalvara = 0;
   public $q120_isstipomovalvara = 0;
   public $q120_dtmov_dia = null;
   public $q120_dtmov_mes = null;
   public $q120_dtmov_ano = null;
   public $q120_dtmov = null;
   public $q120_validadealvara = 0;
   public $q120_usuario = 0;
   public $q120_obs = null;
   ...
   public function incluir ($q120_sequencial){
      $this->atualizacampos();
     ...
     if($q120_sequencial == "" || $q120_sequencial == null ){
       ...
       $this->q120_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from issmovalvara_q120_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q120_sequencial)){
   ...
   public function alterar ($q120_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($q120_sequencial=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $q120_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $q120_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
 ...
 /** Retorna uma String com todos os alvaras que podem ser transformados
   ...
   * @return String
   */
  public function sql_queryListaAlvaraTransf ($sOrdem=null, $sWhere = null){
   ...
   * @return String
   */
  public function sql_AlvaraLiberado($q123_sequencial=null,$iInscr, $campos="*", $dbwhere="") {
