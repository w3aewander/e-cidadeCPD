...
class cl_empnotaele {
   ...
   private function validarValorPago(){
    ...
    $sql = "
             select *
               from empnotaele
              where e70_codnota = {$this->e70_codnota};
    ";
      ...
      if ( $this->numrows > 0 ) {
        ...
        if (  ($dados->e70_vlrliq - $dados->e70_vlranu) > $dados->e70_valor ) {

            $this->erro_sql = " Nota já teve seu valor Integral Liquidado.";
   ...
   function alterar ($e70_codnota=null,$e70_codele=null) {
     ...
     if(trim($this->e70_codnota)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e70_codnota"])){
       ...
       $sqlLock = " SELECT * FROM empnotaele WHERE e70_codnota = {$this->e70_codnota}  FOR UPDATE ";
       db_query($sqlLock);
