...
class cl_rhslipfolha
{
    ...
    public $rh79_sequencial = 0;
    public $rh79_recurso = 0;
    public $rh79_anousu = 0;
    public $rh79_mesusu = 0;
    public $rh79_siglaarq = null;
    public $rh79_tipoempenho = 0;
    public $rh79_tabprev = 0;
    public $rh79_seqcompl = 0;
    public $rh79_concarpeculiar = null;
    ...
    public function incluir($rh79_sequencial)
    {
        $this->atualizacampos();
    ...
    public function alterar($rh79_sequencial = null)
    {
        $this->atualizacampos();
    ...
    public  function excluir($rh79_sequencial = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query($rh79_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    // funcao do sql
    public function sql_query_file($rh79_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_rubricas($rh79_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_slip($rh79_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "
        select {$campos}
          from rhslipfolha
               left  join rhslipfolhaslip               on rh82_rhslipfolha           = rh79_sequencial
               ...
               left  join rhcontasrec                   on rh41_codigo                = rh79_recurso
                                                       and rh41_anousu                = rh79_anousu
                                                       and rh41_instit                = rh73_instit
    ";
