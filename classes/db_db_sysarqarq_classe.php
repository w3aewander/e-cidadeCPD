...
class cl_db_sysarqarq
{
    ...
    public function incluir($codarqpai, $codarq)
    {
        $this->atualizacampos();
    ...
    public function alterar($codarqpai = null, $codarq = null)
    {
        $this->atualizacampos();
            ...
            for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["codarq"])) {
                    $resac = db_query("insert into db_acount values($acount,387,759,'" . AddSlashes(pg_result(
                            ...
                            $conresaco,
                            'codarq'
                        )) . "','$this->codarq'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                }
            }
        }
        $result = db_query($sql);
    ...
    public function excluir($codarqpai = null, $codarq = null, $dbwhere = null)
    {
    ...
    public function sql_query($codarqpai = null, $codarq = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_file($codarqpai = null, $codarq = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_filho($codarqpai = null, $codarq = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
