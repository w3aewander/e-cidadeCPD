...
require_once(modification("classes/db_regracompensacao_classe.php"));
...
if(isset($alterar) and !$lErro){
  ...
  db_fim_transacao();
   ...
   $sCampos .= "regracompensacao.k155_database                   , ";
...
<table width="790" align="center"  style="margin:30px auto">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmregracompensacao.php"));
	?>
    </center>
	</td>
  </tr>
