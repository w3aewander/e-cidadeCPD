...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    ...
    <?php
      ...
      if((!isset($pesquisa_chave) && !isset($chave_assent)) || !empty($configuracaoAssentamentoNaoDescontaDSR)){
        ...
        if ( isset($sAcao) && $sAcao == 'lancamento') {
          ...
          $sWhereAdicional.= "                     and rh165_anousu = $iAno                   \n";
          $sWhereAdicional.= "                     and rh165_mesusu = $iMes )                 \n";
          $sWhereAdicional.= " end ";
        ...
        }else if( !empty($configuracaoAssentamentoNaoDescontaDSR) && !empty($pesquisa_chave)){
	         $sql = $cltipoasse->sql_query(null,$campos,"h12_assent"," h12_assent = '".$pesquisa_chave."' ".($dbwhere != "" ? " and " : "").$dbwhere);
        }else{
