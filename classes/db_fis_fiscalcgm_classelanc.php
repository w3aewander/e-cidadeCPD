...
class cl_fis_fiscalcgmlanc {
   ...
   public function incluir ($nl10_codnoti){
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "fiscalcgm ($this->nl10_codnoti) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function sql_query ( $nl10_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_fiscalcgm.nl10_numcgm";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalcgm.nl10_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($nl10_codnoti!=null ){
         $sql2 .= " where fis_fiscalcgm.nl10_codnoti = $nl10_codnoti ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
