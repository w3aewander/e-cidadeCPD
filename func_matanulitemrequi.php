...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    ...
    if (isset($sFiltro)) {
	  ...
	  $where .= "		having sum(coalesce(m43_quantatend,0)-coalesce(m46_quantdev, 0)) >= 0 and 			          ";
		$where .= "					 sum(coalesce(m43_quantatend,0)-coalesce(m46_quantdev, 0)) < matrequiitem.m41_quant ";
