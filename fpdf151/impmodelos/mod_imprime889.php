<?php
/**
 * Modelo para solitação / atendimento de saída de materiais
 * @see mat2_matpedido001.php 
 */
...
for ($i = 0; $i < $iVias; $i++) {
    ...
    $this->objpdf->text(110, $xlin - 15, 'SOLICITAÇÃO DE TRANSFERÊNCIA N' . chr(176) . ' ' . $this->Rnumero);
    $this->objpdf->text(110, $xlin - 12, 'Observação: ');
    $this->objpdf->Setfont('Arial', '', 6);
    //$this->objpdf->text(128, $xlin - 12, $this->Rresumo);
    $this->objpdf->setXY( 127, 6);
    $this->objpdf->multicell(80, 3, $this->Rresumo);



    //$this->objpdf->Image('imagens/files/logo_boleto.png', 10, $xlin - 17, 12);
    //$this->objpdf->Image('imagens/files/logo_boleto.default.png', 10, $xlin - 17, 12);
