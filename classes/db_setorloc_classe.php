...
class cl_setorloc {
   ...
   public $j05_codigo = 0;
   public $j05_descr = null;
   public $j05_codigoproprio = null;
   ...
   public function incluir ($j05_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($j05_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($j05_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $j05_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $j05_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
    ...
    public function query($campos = '*', $joins = '', $where = 'true', $order = '1')
    {
        $sql = "
            SELECT {$campos}
            FROM setorloc {$joins}
