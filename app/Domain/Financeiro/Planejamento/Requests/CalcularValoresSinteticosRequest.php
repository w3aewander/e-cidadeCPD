...
/**
 * Class CalcularValoresSinteticosRequest
 * @package App\Domain\Financeiro\Planejamento\Requests
 */
class CalcularValoresSinteticosRequest extends FormRequest
{
    /**
     * @return bool
     */
    ...
    {
        return [
            'planejamento_id.integer' => 'Plano se informado deve ser um inteiro.',
            'planejamento_id.required' => 'O "Código do Plano" deve ser informado.',
            'planejamento_id.filled' => 'O "Código do Plano" deve ser preenchido.',
