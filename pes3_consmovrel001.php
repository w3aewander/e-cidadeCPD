...
$onloadAction = '';
// Verifica a mesma condição que decide se mostra o formulário ou os resultados
if (!isset($r54_regist) && !isset($r54_codeve) && !isset($r54_codrel)) {
    $onloadAction = 'onload="document.form1.r54_codrel.focus();"';
}
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <?php echo $onloadAction; ?>
        ...
        <center>
          ...
          <?php
            ...
            if (isset($r54_codrel) && $r54_codrel != "") {
              $dbwhere .= " and trim(r54_codrel) = '" . trim($r54_codrel) . "' ";
            ...
            if (isset($r54_codeve) && $r54_codeve != "") {
              $dbwhere .= " and trim(r54_codeve) = '" . trim($r54_codeve) . "' ";
          ...
          ?>
            <BR>
            <button type="button" onclick="location.href='pes3_consmovrel001.php'" tabindex="1"> Nova consulta </button>
            <button type="button" onclick="js_abrejan(false);" tabindex="2"> Imprimir </button>
          <?php
          }
          ?>
        </center>
