  ...
  if($clvistusuario->erro_status=="0"){
    ...
    if($sqlerro==true){
      ...
      echo "
         <script>
         function js_src(){
           parent.iframe_fiscais.location.href='fis1_fis_vistusuario001.php?y75_codvist=".$clvistusuario->y75_codvist."&opcao=Incluir&y39_codandam=".$clfandamusu->y40_codandam=$y39_codandam."';\n
           }
           js_src();
         </script>
       ";
