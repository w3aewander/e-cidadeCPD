                ...
                <td>
                    <table border="0">
                        <tr>
                            ...
                            <td>
                                <?php db_input('bi20_codigo', 10, $Ibi20_codigo, true, 'text', 3, "") ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td nowrap title="<?= @$Tbi20_localizacao ?>">
                                <?php db_ancora(@$Lbi20_localizacao, "js_pesquisabi20_localizacao(true);", $db_opcao); ?>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td nowrap title="Ordem sequencia">
                                <?= @$Lbi20_sequencia ?>
                            <td>
                                <?php db_input('bi20_sequencia', 10, $Ibi20_sequencia, true, 'text', $db_opcao) ?>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <table border="1" cellspacing="0" cellpading="2" width="95%" bgcolor="#f3f3f3">
                                ...
                                for ($i = 0; $i < $linhas; $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <input type="text" id="bi_letra" name="bi_letra[]" size="1"
                                                   value="<?= $valorletra ?>"
                                                   style="text-transform:uppercase;font-weight:bold;text-align:center"
                                                   readonly>
                                            <input type="hidden" id="bi_exemplar" name="bi_exemplar[]"
                                                   value="<?= $bi23_codigo ?>">
                                            <input type="hidden" id="bi_codigo" name="bi_codigo[]"
                                                   value="<?= $bi27_codigo ?>">
                                        </td>
                                    </tr>
                                    <?php
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <select name="localacervo" id="localacervo" size="10"
