...
class cl_mer_alimento {
   ...
   public function incluir ($me35_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($me35_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($me35_i_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $me35_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $me35_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
