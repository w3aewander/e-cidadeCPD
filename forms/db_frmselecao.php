...
function js_pesquisa() {
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_selecao','func_selecao.php?funcao_js=parent.js_preenchepesquisa|r44_selec&sGrupoSelecao=3,2,1','Pesquisa',true);
}
