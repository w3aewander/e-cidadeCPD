...
if (isset($oPost->lancar)) {
  ...
  try {
    ...
    } else if($oPost->z_numcgm){
      $oCancelamentoISSQNVariavel->setEmpresa(new Empresa(null,$oPost->z_numcgm));
    }
...
<body style="margin:30px 0 0;background:#CCC" onload="document.form1.q07_inscr.focus();">
  <div style="width:770px;margin: 0 auto">
      <div style="height:430px"><?php include(modification('forms/db_frmissvarsemmov.php')) ?></div>
  </div>
  <?php 
