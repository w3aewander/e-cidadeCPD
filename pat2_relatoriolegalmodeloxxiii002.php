...
if(db_getsession("DB_instit") == 30){
    $result = pg_exec ($conexao, 
"select t52_ident, t52_descr, t52_dtaqu, t52_valaqu, t52_obs from bens inner join clabens on t64_codcla = t52_codcla and t52_dtaqu between '".$dt_ini."' and '".$dt_fin."' AND t52_instit = 30 and t64_bemtipos = 1 order by t52_ident::numeric");    
}elseif(db_getsession("DB_instit") == 96){
    $result = pg_exec ($conexao, 
"select t52_ident, t52_descr, t52_dtaqu, t52_valaqu, t52_obs from bens inner join clabens on t64_codcla = t52_codcla and t52_dtaqu between '".$dt_ini."' and '".$dt_fin."' AND t52_instit = 96 and t64_bemtipos = 1 order by t52_ident::numeric");    
}
*/

$result = pg_exec ($conexao, 
"select t52_ident, t52_descr, t52_dtaqu, t52_valaqu, t52_obs from bens inner join clabens on t64_codcla = t52_codcla and t52_dtaqu between '".$dt_ini."' and '".$dt_fin."' AND t52_instit = ".db_getsession("DB_instit")." and t64_bemtipos = 1 order by t52_ident::numeric");    
