...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_sanicalc");
...
public function incluir ($y84_codsani,$y84_anousu){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_sanicalc(
                                       y84_codsani
                                      ,y84_anousu
                                      ,y84_numpre
                                      ,y84_valor
...
public function alterar ($y84_codsani=null,$y84_anousu=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_sanicalc set ";
     $virgula = "";
...
public function excluir ($y84_codsani=null,$y84_anousu=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_sanicalc
                    where ";
     $sql2 = "";
