...
if (isset($codproj)) {
    ...
    $sql = "
        select j01_matric,j40_refant,z01_nome,j34_setor,j34_quadra,j34_lote,j34_zona,
    ...
    <head>
        ...
        <script>
            ...
            */
            ...
            function js_marca(obj, sTipo) {
                const OBJeto = document.form1;
                if (sTipo == 'matric') {
                    for (i = 0; i < OBJeto.length; i++) {
                        const name = OBJeto.elements[i].name;
                        if (OBJeto.elements[i].type == 'checkbox' && name.substr(0,5) == "CHECK") {
                            OBJeto.elements[i].click();
                        }
                    }
                } else {
                    for (i = 0; i < OBJeto.length; i++) {
                        if (OBJeto.elements[i].type == 'checkbox' && OBJeto.elements[i].name .substr(0,13) == "d41_pgtopref_") {
                            OBJeto.elements[i].click();
                        }
                    }
                }
