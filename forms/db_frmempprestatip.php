      ...
      <table border="0">
        ...
        <tr>
          <td nowrap title="<?php echo $Te44_naturezaevento; ?>">
            <label for="e44_naturezaevento" class="bold"
                   id="lbl_e44_naturezaevento"><?php echo $Le44_naturezaevento; ?></label>
          </td>
          <td>
              <?php
              $aOpcoes = array(
        ...
        <tr>
            <td nowrap title="Diária">
                <label for="e44_diaria">
            ...
            <td>
                <?php 
                if ($e44_diaria == "t") {
                    echo '<input name="e44_diaria" type="checkbox" id="e44_diaria" value="1" checked>'; 
                } else {
                    echo '<input name="e44_diaria" type="checkbox" id="e44_diaria" value="1">'; 
                }
                ?>
            </td>
        </tr>
