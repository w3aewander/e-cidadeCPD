...
if(isset($excluir)){
  db_inicio_transacao();
  $db_opcao = 3;
  $clalunopassagemqtd->excluir("","ed227_i_valorpassagem= $ed230_i_codigo");
  $clvalorpassagem->excluir($ed230_i_codigo);
  db_fim_transacao();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <br>
    <fieldset style="width:95%"><legend><b>Exclusão Valor Passagem</b></legend>
    <center>
