...
try {
  ...
  switch ($oParametros->exec) {
		...
		case 'getDadosLayout' :
            ...
            /**
             * Código do banco que foi efetuado o pagamento
             */
            $oBancoPagamento            = new stdClass;
            $oBancoPagamento->nomeCampo = 'k15_bancopagamento';
            $oBancoPagamento->campo     = 'Banco de Pagamento';
            $aDadosLayoutDetalhes[] = $oBancoPagamento;

            /**
             * Código da agecia que foi efetuado o pagamento
             */
            $oAgenciaPagamento            = new stdClass;
            $oAgenciaPagamento->nomeCampo = 'k15_agenciapagamento';
            $oAgenciaPagamento->campo     = 'Agência de Pagamento';
            $aDadosLayoutDetalhes[] = $oAgenciaPagamento;
