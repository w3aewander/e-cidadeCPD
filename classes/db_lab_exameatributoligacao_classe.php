...
class cl_lab_exameatributoligacao {
   ...
   public $la26_i_codigo = 0;
   public $la26_i_exameatributofilho = 0;
   public $la26_i_exameatributopai = 0;
   ...
   public function incluir ($la26_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($la26_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($la26_i_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $la26_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $la26_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   // funcao do sql
   public function sql_query_pai ( $la26_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_filho ( $la26_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
