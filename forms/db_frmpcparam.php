                ...
                <table border="0">
                  <tr>
                    <td>
                        ...
                        <tr>
                            <td nowrap title="<?php echo @$Tpc30_validadept?>">
                                <?php echo @$Lpc30_validadept?>
                            </td>
                            <td>
                                <?php
                                $opcoes = ["t" => "SIM",
                                ...
                                db_select('pc30_validadept', $opcoes, true, $db_opcao, "");
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td nowrap title="<?php echo @$Tpc30_bloqueiaautemp?>">
                                <?php echo @$Lpc30_bloqueiaautemp?>
                            </td>
                            <td>
                                <?php
                                $opcoes = ["t" => "SIM",
                                ...
                                db_select('pc30_bloqueiaautemp', $opcoes, true, $db_opcao, "");
                                ?>
                            </td>
                        </tr>
                                    </table>
                    ...
                    <td>
                          <fieldset>
                            ...
                            <table border="0">
                              ...
                              <tr>
                              <td nowrap title="<?=@$Tpc30_tipojulgamentoorcamento?>"><?=@$Lpc30_tipojulgamentoorcamento?>
                             </td>
                             <td>
                               <?php
