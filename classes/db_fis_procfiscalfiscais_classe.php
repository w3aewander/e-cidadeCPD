...
class cl_fis_procfiscalfiscais
{
    ...
    public function __construct()
    {
         ...
         $this->rotulo = new rotulo("fis_procfiscalfiscais");
   ...
   // funcao para inclusao
    public function incluir($y106_sequencial = null)
    {
        $this->atualizacampos();
        ...
        $sql = "insert into fiscalizacao.fis_procfiscalfiscais(
                                       y106_procfiscal
                                      ,y106_cadfiscais
                                      ,y106_principal
                       )
        ...
        $result = db_query($sql);
        $this->y106_sequencial = db_utils::fieldsmemory($result, 0)->y106_sequencial;
    ...
    public function alterar($y106_sequencial = null)
    {
         $this->atualizacampos();
         $sql = " update fiscalizacao.fis_procfiscalfiscais set ";
         $virgula = "";
   ...
   // funcao para exclusao
    public function excluir($y106_sequencial = null, $dbwhere = null)
    {
         $sql = " delete from fiscalizacao.fis_procfiscalfiscais where ";
         $sql2 = "";
   ...
   // funcao do recordset
    ...
    public function sql_query($y106_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
         $sql = "select ";
        if ($campos != "*") {
        ...
        $sql .= " from fiscalizacao.fis_procfiscalfiscais ";
        ...
        if ($dbwhere=="") {
            if ($y106_sequencial!=null) {
                $sql2 .= " where fis_procfiscalfiscais.y106_sequencial = $y106_sequencial ";
            }
        } elseif ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
    ...
    public function sql_query_file($y106_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
         $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
