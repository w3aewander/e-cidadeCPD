...
class cl_rhempenhofolhaempenho
{
   ...
   // cria variaveis do arquivo
    public $rh76_sequencial = 0;
    public $rh76_rhempenhofolha = 0;
    public $rh76_numemp = 0;
   ...
   // funcao para inclusao
    public function incluir($rh76_sequencial)
    {
        $this->atualizacampos();
        ...
        if ($rh76_sequencial == "" || $rh76_sequencial == null) {
            ...
            $this->rh76_sequencial = pg_fetch_result($result, 0, 0);
        } else {
            $result = db_query("select last_value from rhempenhofolhaempenho_rh76_sequencial_seq");
            if ($result && (pg_fetch_result($result, 0, 0) < $rh76_sequencial)) {
        ...
        if (($resaco!=false)||($this->numrows!=0)) {
            ...
            $resac = db_query("insert into db_acount values($acount,2538,14393,'','".addSlashes(pg_fetch_result($resaco, 0, 'rh76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,2538,14394,'','".addSlashes(pg_fetch_result($resaco, 0, 'rh76_rhempenhofolha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,2538,14395,'','".addSlashes(pg_fetch_result($resaco, 0, 'rh76_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        }
        return true;
    }
   // funcao para alteracao
    public function alterar($rh76_sequencial = null)
    {
        $this->atualizacampos();
        ...
        if ($this->numrows>0) {
            for ($conresaco=0; $conresaco<$this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["rh76_sequencial"]) || $this->rh76_sequencial != "") {
                    $resac = db_query("insert into db_acount values($acount,2538,14393,'".addSlashes(pg_fetch_result($resaco, $conresaco, 'rh76_sequencial'))."','$this->rh76_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["rh76_rhempenhofolha"]) || $this->rh76_rhempenhofolha != "") {
                    $resac = db_query("insert into db_acount values($acount,2538,14394,'".addSlashes(pg_fetch_result($resaco, $conresaco, 'rh76_rhempenhofolha'))."','$this->rh76_rhempenhofolha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["rh76_numemp"]) || $this->rh76_numemp != "") {
                    $resac = db_query("insert into db_acount values($acount,2538,14395,'".addSlashes(pg_fetch_result($resaco, $conresaco, 'rh76_numemp'))."','$this->rh76_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
        $result = db_query($sql);
   ...
   // funcao para exclusao
    public function excluir($rh76_sequencial = null, $dbwhere = null)
    {
        ...
        if ($resaco ||($this->numrows!=0)) {
            for ($iresaco=0; $iresaco<$this->numrows; $iresaco++) {
                ...
                $resac = db_query("insert into db_acount values($acount,2538,14393,'','".addSlashes(pg_fetch_result($resaco, $iresaco, 'rh76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,2538,14394,'','".addSlashes(pg_fetch_result($resaco, $iresaco, 'rh76_rhempenhofolha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,2538,14395,'','".addSlashes(pg_fetch_result($resaco, $iresaco, 'rh76_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
   ...
   // funcao do sql
    public function sql_query($rh76_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
   ...
   // funcao do sql
    public function sql_query_file($rh76_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
