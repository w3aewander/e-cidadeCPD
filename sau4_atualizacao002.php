...
function funcCid($sOrigem, $sCompetencia) {
    ...
    $oDaoSauAgravo = new cl_sau_agravo;
...
function funcGrupoHabilitacao($sOrigem, $sCompetencia) {
    ...
    $oDaoSauHabilitacao      = new cl_sau_habilitacao;
    $oDaoSauGrupoHabilitacao = new cl_sau_grupohabilitacao;
    ...
    for ($iCont = 0; $iCont < $iLinhas; $iCont++) {
        ...
        if (strstr(trim(substr($aFile[$iCont], 8, 9)), ',') && strstr(trim(substr($aFile[$iCont], 15, 16)), 'e')) {
            $codigo = str_replace(', ', '-', $aFile[$iCont]);
            $codigo = str_replace(' e ', '-', $codigo);
            $codigo = str_replace(substr($aFile[$iCont], 21, 250), '', $codigo);

            $aHabilitacao = explode('-', trim(substr($codigo, 4, 20)));
            $iLinhas2 = count($aHabilitacao);
        }
...
function funcProcedimento($sOrigem, $sCompetencia) {
    ...
    $oDaoSauComplexidade  = new cl_sau_complexidade;
    $oDaoSauFinanciamento = new cl_sau_financiamento;
    $oDaoSauRubrica       = new cl_sau_rubrica;
...
function funcProcCid($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauCid          = new cl_sau_cid;
    $oDaoSauProcCid      = new cl_sau_proccid;
...
function funcProcDetalhe($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauDetalhe      = new cl_sau_detalhe;
    $oDaoSauProcDetalhe  = new cl_sau_procdetalhe;
...
function funcProcIncremento($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento   = new cl_sau_procedimento;
    $oDaoSauHabilitacao    = new cl_sau_habilitacao;
    $oDaoSauProcIncremento = new cl_sau_procincremento;
...
function funcProcLeito($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauTipoLeito    = new cl_sau_tipoleito;
    $oDaoSauProcLeito    = new cl_sau_procleito;
...
function funcProcModalidade($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento   = new cl_sau_procedimento;
    $oDaoSauModalidade     = new cl_sau_modalidade;
    $oDaoSauProcModalidade = new cl_sau_procmodalidade;
...
function funcProcOrigem($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauProcOrigem   = new cl_sau_procorigem;
...
function funcProcRegistro($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauRegistro     = new cl_sau_registro;
    $oDaoSauProcRegistro = new cl_sau_procregistro;
...
function funcServClassificacao($sOrigem, $sCompetencia) {
    ...
    $oDaoSauServico           = new cl_sau_servico;
    $oDaoSauServClassificacao = new cl_sau_servclassificacao;
...
function funcProcServico($sOrigem, $sCompetencia) {
    ...
    $oDaoSauServico           = new cl_sau_servico;
    $oDaoSauServClassificacao = new cl_sau_servclassificacao;
    $oDaoSauProcServico       = new cl_sau_procservico;
...
function funcSiasihTipoproc($sOrigem, $sCompetencia) {
    ...
    $oDaoSauTipoProc = new cl_sau_tipoproc;
    $oDaoSauSiaSih   = new cl_sau_siasih;
...
function funcProcSiasih($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoSauSiaSih       = new cl_sau_siasih;
    $oDaoSauProcSiaSih   = new cl_sau_procsiasih;
...
function funcProcCbo($sOrigem, $sCompetencia ) {
    ...
    $oDaoSauProcedimento = new cl_sau_procedimento;
    $oDaoRhcbo           = new cl_rhcbo;
    $oDaoSauProcCbo      = new cl_sau_proccbo;
...
function funcProcCompativel($sOrigem,$sCompetencia) {
    ...
    $oDaoSauTipoCompatibilidade = new cl_sau_tipocompatibilidade;
    $oDaoSauProcedimento        = new cl_sau_procedimento;
    $oDaoSauRegistro            = new cl_sau_registro;
    $oDaoSauProcCompativel      = new cl_sau_proccompativel;
...
function funcProcRestricao($sOrigem, $sCompetencia) {
    ...
    $oDaoSauProcedimento            = new cl_sau_procedimento;
    $oDaoSauRegistro                = new cl_sau_registro;
    $oDaoSauExecaoCompatibilidade   = new cl_sau_execaocompatibilidade;
...
function funcProcHabilitacao($sOrigem, $sCompetencia) {
    ...
    $oDaoSauHabilitacao      = new cl_sau_habilitacao;
    $oDaoSauGrupoHabilitacao = new cl_sau_grupohabilitacao;
    $oDaoSauProcHabilitacao  = new cl_sau_prochabilitacao;
