...
<script>
  function js_close(){
    ...
    if(alerta != "" && <?=$testanome?> == true && false){
    ...
    <td align="center" valign="top"> 
      <?
        if ($filtro==1){
          ...
          $campos = "cgm.z01_numcgm, z01_nome,trim(z01_cgccpf) as z01_cgccpf, z01_sexo,z01_nasc, trim(z01_ender) as z01_ender, z01_numero, z01_compl, z01_munic, z01_uf, z01_cep, z01_email";
