...
include_once(modification("libs/db_libsys.php"));
...
include_once(modification("classes/db_db_relatorio_classe.php"));
include_once(modification("classes/db_db_geradorrelatoriotemplate_classe.php"));
include_once(modification("model/dbColunaRelatorio.php"));
include_once(modification("model/dbFiltroRelatorio.php"));
include_once(modification("model/dbVariaveisRelatorio.php"));
include_once(modification("model/dbGeradorRelatorio.model.php"));
include_once(modification("model/dbOrdemRelatorio.model.php"));
include_once(modification("model/dbPropriedadeRelatorio.php"));
