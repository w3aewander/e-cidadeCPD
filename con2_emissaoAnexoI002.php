...
$sessao             = $_SESSION;
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\Factory\Layout\AnexoI as LayoutAnexo;
...
try {
  ...
  $oRelatorio =  LayoutAnexo::getInstance($iAnoSessao, new Periodo($oGet->bimestre), $sInstituicoes, $sessao);
  $oRelatorio->emitir();
