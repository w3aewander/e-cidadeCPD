...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_autolancancanc");
...
public function incluir (){
     ...
     $sql = "insert into fiscalizacao.fis_autolancancanc(
                                       y89_codtermo
                                      ,y89_datacanc
                                      ,y89_motivo
                       )
...
public function alterar ( $oid=null ) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_autolancancanc set ";
     $virgula = "";
...
public function excluir ( $oid=null ,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_autolancancanc
                    where ";
     $sql2 = "";
