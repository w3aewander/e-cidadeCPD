...
$jusu = utf8_encode($dados[0]["justificativasuspensao"]);
$jusuret = utf8_encode($dados[0]["justificativaretiradasuspensao"]);
...
//<h2>Certificado nº: <span style="font-weight:normal">'. $dados["nocertificado"] .'</span></h2>
    $html = '
        ...
        <tr>
            <td width="100%" rowspan="3" style="font-size:10px">'.$jusu.'</td>
        </tr>
        </table>
        ...
        <tr>
            <td width="100%" rowspan="3" style="font-size:10px">'.$jusuret.'</td>
        </tr>
        </table>
