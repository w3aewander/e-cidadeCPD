    ...
    if ($pesquisa_chave!=null && $pesquisa_chave!="") {
      ...
      if (isset($chave_coddepto) && (trim($chave_descrdepto)!="")) {
        ...
        if (!isset($lRetornoPlaca)) {          
          ...
          $sql    = $clbens->{$sMetodoQuery}(null,$campos,"","t52_ident = '{$pesquisa_chave}' and t52_instit = ".db_getsession("DB_instit")." ".$where_baixado);          
          $result = $clbens->sql_record($sql);
      ...
      if (!isset($lRetornoPlaca)) {
        ...
        if($clbens->numrows != 0) {
          ...
          echo "<script>".$funcao_js."('$t52_descr', '$t52_bem',false);</script>";
        } else {
