...
try {
  ...
  switch ($oParam->exec) {
    ...
    case "buscarCursos":
      ...
      $sSqlCurso = $oDaoCurso->sql_query_file( null, 'ed29_i_codigo, ed29_c_descr', 'ed29_c_descr', $where);
    ...
    case "buscarCursosPorAluno":
        ...
        if (!empty($oParam->cursosConcluidos)) {
            ...
            $aCursos = CursoRepository::getCursosPorAluno($oAluno);
        }
