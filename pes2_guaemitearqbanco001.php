...
function js_controlarodape(mostra, hora){
  ...
  if(hora == true){
    ...
    (window.CurrentWindow || parent.CurrentWindow).bstatus.document.getElementById('st').innerHTML += " - <b>Tempo de geração: "+tempototal+"</b>";
  }
}
</script>  
...
<table align="center" border="0">
  ...
  <tr> 
    <td align="left" nowrap title=" <?php echo @$Trh34_codarq?>">
  ...
  <tr>
    <td nowrap title="<?php echo @$Trh34_codban?>">
      <?php
  ...
  <tr>
    <td nowrap title="<?php echo @$Trh34_agencia?>">
      <?php echo @$Lrh34_agencia?>
    </td>
    <td> 
      <?php
    ...
    <td nowrap title="<?php echo @$Trh34_dvagencia?>" align="right">
      <?php echo @$Lrh34_dvagencia?>
    </td>
    <td> 
      <?php
  ...
  <tr>
    <td nowrap title="<?php echo @$Trh34_conta?>">
      <?php echo @$Lrh34_conta?>
    </td>
    <td> 
      <?php
    ...
    <td nowrap title="<?php echo @$Trh34_dvconta?>" align="right">
      <?php echo @$Lrh34_dvconta?>
    </td>
    <td> 
      <?php
  ...
  <tr>
    <td nowrap title="<?php echo @$Trh34_convenio?>">
      <?php echo @$Lrh34_convenio?>
    </td>
    <td> 
      <?php
  ...
  <tr>
    <td nowrap title="<?php echo @$Trh34_sequencial?>">
      <?php echo @$Lrh34_sequencial?>
    </td>
    <td> 
      <?php
