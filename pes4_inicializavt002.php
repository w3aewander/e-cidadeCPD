...
function inicializa_vt()
{
  ...
  global $subpes_ant,$m_vtfdias02, $vtffuncant, $Ivtffuncant, $matric;
  ...
  if ($condicaoaux == " and r63_difere = 'f' ") {
      $condicaoaux = " and r63_difere = 'f' ";
  } else {
      $condicaoaux = " and r63_difere = 't' ";
  }
  ...
  for ($Ivtffuncant=0; $Ivtffuncant<count($vtffuncant); $Ivtffuncant++) {
    ...
    if ($primeiro_mes) {
      ...
      $matriz2[5] = $vtffuncant[$Ivtffuncant]["r17_tipo"];
...
function leitura_vtfdias_mesanterior($matric)
{
  ...
  // cria vetor todo vazio para depois preencher com os dias com qtd do arquivo;
  $subpes = $subpes_ant;
