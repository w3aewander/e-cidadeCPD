...
<div class="container">
	<?php
	include(modification("forms/db_frm_fis_autorec.php"));
	?>
</div>
</body>
</html>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Incluir"){
  if($clautorec->erro_status=="0"){
    ...
    $clautorec->erro(true,false);
    echo "<script>parent.iframe_receitas.location.href='fis1_fis_autorec001.php?y59_codauto=$y59_codauto';</script>";
  };
};
?>