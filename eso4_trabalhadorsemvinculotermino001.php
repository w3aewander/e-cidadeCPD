...
<form id="formPesquisarEsocial" method="POST" action="eso4_trabalhadorsemvinculotermino002.php?semVinculo=true"
      class="container">
    <fieldset>
...
<script>
    (function () {
        ...
        var oLookUpCgm = new DBLookUp($('lbl_rh01_regist'), $('rh01_regist'), $('z01_nome'), {
            'sArquivo': 'func_desligamentotrabalhadorsemvinculo.php',
            'sLabel': 'Pesquisa de Servidores Sem Vínculo Desligados',
