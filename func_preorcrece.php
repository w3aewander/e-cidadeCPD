    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o70_codrec) && (trim($chave_o70_codrec)!="") ){
          $sqlp = "SELECT id, o70_anousu, o70_codrec, o50_estrutreceita, o57_descr, o70_codigo, o15_descr, o70_valor, o70_reclan, o70_concarpeculiar, c58_descr, o70_instit FROM previareceitas WHERE o70_codrec = '{$chave_o70_codrec}' ORDER BY o50_estrutreceita";
          //var_dump($sqlp); die("c");
          db_lovrot($sqlp,15,"()","",$funcao_js);

        }else if(isset($chave_o70_codigo) && (trim($chave_o70_codigo)!="")){
          $sqlp = "SELECT id, o70_anousu, o70_codrec, o50_estrutreceita, o57_descr, o70_codigo, o15_descr, o70_valor, o70_reclan, o70_concarpeculiar, c58_descr, o70_instit FROM previareceitas WHERE o70_codigo = '{$chave_o70_codigo}' ORDER BY o50_estrutreceita";
          //var_dump($sqlp); die("c");
          db_lovrot($sqlp,15,"()","",$funcao_js);
        } else {          
          $sql2 = "SELECT id, o70_anousu, o70_codrec, o50_estrutreceita, o57_descr, o70_codigo, o15_descr, o70_valor, o70_reclan, o70_concarpeculiar, c58_descr, o70_instit FROM previareceitas WHERE o70_instit = '".db_getsession("DB_instit")."' ORDER BY o50_estrutreceita";
