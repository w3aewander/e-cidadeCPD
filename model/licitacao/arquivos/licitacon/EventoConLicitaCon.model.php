   ...
   */
    private function processarEventos()
    {
        ...
        for ($iIndice = 0; $iIndice < $iTotalEventos; $iIndice++) {
            ...
            $dados = $service->buscarDados($oEvento->ac55_acordo);
           ...
           */
            ...
            $oStdEvento->NR_LICITACAO          = $dados->ac63_sequencial == "" ? $oLicitacao->numero : $dados->ac63_numero;
            $oStdEvento->ANO_LICITACAO         = $dados->ac63_sequencial == "" ? $oLicitacao->ano :    $dados->ac63_ano;
            $oStdEvento->CD_TIPO_MODALIDADE    = $dados->ac63_sequencial == "" ? $oLicitacao->tipo :   $modalidade;
