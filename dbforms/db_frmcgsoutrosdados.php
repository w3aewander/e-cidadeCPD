...
<fieldset class='separator'>
  ...
  <table class="form-container">
    ...
    <!-- plugin ESF operation#0 - adicionando campo 'Equipe Responsável:' -->
    <tr>
      <td>
...
<script>
  ...
  callbackCarregamento.outrosDados = function(outros, dados_padrao) {
    ...
    //plugin ESF operation#3 - adicionando condição para preencher campo select de equipe
    ...
    $('z01_nome').setValue(outros.label_cgm.urlDecode());
    $('ed47_i_codigo').setValue(outros.codigo_aluno);
    $('ed47_v_nome').setValue(outros.label_aluno.urlDecode());
    $('ov02_sequencial').setValue(outros.codigo_cidadao);
    $('ov02_nome').setValue(outros.label_cidadao.urlDecode());
    $('rh70_sequencial').setValue(outros.codigo_ocupacao);
    $('rh70_descr').setValue(outros.label_ocupacao.urlDecode());
    ...
    outrosDados.escolaridade.setValue(outros.escolaridade);
    outrosDados.bolsafamilia.setValue(outros.bolsa_familia);
  };
  ...
  function setValoresOutrosDados( oParametros ) {
    ...
    oParametros.outrosDados = {
      ...
      //plugin ESF operation#1 - adicionando atributo equipe
  ...
  var montarComboFamilia = function(familias) {
    ...
    for ( var familia of familias) {
      outrosDados.familia.add(
        new Option(familia.label_familia.urlDecode(), familia.codigo_familia)
      );
    }
  }
  ...
  validacoes.push(function(){
    ...
    if (outrosDados.microarea.getValue() && !outrosDados.familia.getValue()) {
      ...
      oDBAba.mostraFilho(oDBAba.aAbas[4]);
  ...
  //plugin ESF operation#2 - adicionando função retornaEquipesAtivas()
</script>
