...
class cl_empempenho
{
    ...
    public $e60_numemp = 0;
    public $e60_codemp = null;
    public $e60_anousu = 0;
    public $e60_coddot = 0;
    public $e60_numcgm = 0;
    public $e60_emiss_dia = null;
    public $e60_emiss_mes = null;
    public $e60_emiss_ano = null;
    public $e60_emiss = null;
    public $e60_vencim_dia = null;
    public $e60_vencim_mes = null;
    public $e60_vencim_ano = null;
    public $e60_vencim = null;
    public $e60_vlrorc = 0;
    public $e60_vlremp = 0;
    public $e60_vlrliq = 0;
    public $e60_vlrpag = 0;
    public $e60_vlranu = 0;
    public $e60_codtipo = 0;
    public $e60_resumo = null;
    public $e60_destin = null;
    public $e60_salant = 0;
    public $e60_instit = 0;
    public $e60_codcom = 0;
    public $e60_tipol = null;
    public $e60_numerol = null;
    public $migra_elemento = null;
    public $e60_concarpeculiar = null;
    // cria propriedade com as variaveis do arquivo
    public $campos = "
                 e60_numemp = int4 = Seq. Empenho
                 e60_codemp = varchar(15) = Número do Empenho
                 ...
                 e60_numerol = varchar(24) = Numero Licitação
    ...
    public function incluir($e60_numemp)
    {
        $this->atualizacampos();
        ...
        if ($this->e60_vlremp == null) {
            $this->erro_sql = " Campo Valor Empenho não informado.";
        ...
        if (($this->e60_numemp == null) || ($this->e60_numemp == "")) {
            $this->erro_sql = " Campo e60_numemp não declarado.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = "Empenhos na prefeitura ($this->e60_numemp) não Incluído. Inclusão Abortada.";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    public function alterar($e60_numemp = null)
    {
        $this->atualizacampos();
        ...
        if (trim($this->e60_numerol) != "" || isset($GLOBALS["HTTP_POST_VARS"]["e60_numerol"])) {
            ...
            if ($this->e60_numerol == "null") {
                $sql .= $virgula . " e60_numerol = '' ";
                $virgula = ",";
            } else {
        ...
        if (!$result) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Empenhos na prefeitura não Alterado. Alteração Abortada.\\n";
            $this->erro_sql .= "Valores : " . $this->e60_numemp;
            $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Empenhos na prefeitura não foi Alterado. Alteração Executada.\\n";
                $this->erro_sql .= "Valores : " . $this->e60_numemp;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function excluir($e60_numemp = null, $dbwhere = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Empenhos na prefeitura não Excluído. Exclusão Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Empenhos na prefeitura não Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $e60_numemp;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function sql_query($e60_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_file($e60_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    function sql_query_relatorio($e60_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= "
            ...
            join db_config on db_config.codigo = empempenho.e60_instit
            join orcdotacao on orcdotacao.o58_anousu = empempenho.e60_anousu
                 and  orcdotacao.o58_coddot = empempenho.e60_coddot
            join emptipo on emptipo.e41_codtipo = empempenho.e60_codtipo
            join db_config  as a on  a.codigo = orcdotacao.o58_instit
            ...
            join orctiporec on orctiporec.o15_codigo = origemcomplementorecurso.o206_recurso
            ...
            join pctipocompra on pctipocompra.pc50_codcom = empempenho.e60_codcom
            join empempitem on e62_numemp = e60_numemp
";
        $sql2 = "";
        if ($dbwhere == "") {
            if ($e60_numemp != null) {
    ...
    public function sql_query_empenho_classificacao_nota($sCampos = "*", $sWhere = null)
    {
        ...
        $sSql .= "        inner join orcdotacao   on (e60_anousu, e60_coddot) = (o58_anousu, o58_coddot)
                      inner join origemcomplementorecurso on o206_numero = e60_numemp
                                 and o206_origem = 1 ";
        $sSql .= "    inner join orctiporec   on o15_codigo = o206_recurso
                      inner join fonterecurso on fonterecurso.orctiporec_id = o15_codigo
                                 and fonterecurso.exercicio = empempenho.e60_anousu
                      inner join complementofonterecurso on o200_sequencial = o15_complemento ";
        $sSql .= "        inner join orcunidade   on (o41_anousu, o41_orgao, o41_unidade) = (o58_anousu, o58_orgao, o58_unidade) ";
        $sSql .= "        inner join empelemento  on e64_numemp = e60_numemp ";
        $sSql .= "        inner join orcelemento on (o56_codele, o56_anousu) = (e64_codele, e60_anousu) ";
        ...
        $sSql .= "        inner join conlancamnota on c66_codnota = e69_codnota ";
        $sSql .= "        inner join conlancam on c70_codlan = c66_codlan ";
        $sSql .= "        inner join conlancamdoc on c70_codlan = c71_codlan ";
        $sSql .= "        inner join conhistdoc on c71_coddoc = c53_coddoc ";
        $sSql .= "                             and c53_tipo in (20, 21) ";
