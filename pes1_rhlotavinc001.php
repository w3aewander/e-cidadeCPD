...
if (isset($incluir)) {
    ...
    $sql = $clrhlota->sql_query_file($chavepesquisa, "r70_codigo as rh25_codigo,r70_descr as rh25_descr");
    $result_descr = $clrhlota->sql_record($sql);
...
if (isset($opcao) && trim($opcao) != "" && isset($rh25_codlotavinc) && trim($rh25_codlotavinc) != "") {
    $sql = $clrhlotavinc->sql_query2($rh25_codlotavinc);
    $result = $clrhlotavinc->sql_record($sql);
...
<body onLoad="document.form1.rh25_projativ.focus();">

<?php
include(modification("forms/db_frmrhlotavinc.php"));
?>
