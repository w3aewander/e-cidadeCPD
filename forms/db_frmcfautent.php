...
$clrotulo->label("k11_tef");
$clrotulo->label("k11_infisc");
...
?>
    ...
    <tr>
        <td nowrap title="<?= @$Tk11_infisc ?>">
            <?= @$Lk11_infisc ?>
        </td>
        <td>
            <?php
            db_input('k11_infisc',5,$Ik11_infisc,true,'checkbox',$db_opcao,"")
            ?>
        </td>
    </tr>
