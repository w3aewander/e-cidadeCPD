...
<table border="0">
  ...
  <tr>
    ...
    <td style="display: inline-block;"><b>Matrícula</b></td>
    <?php /* ?>
    <td style="display: inline-block;"><input type="text" name="matricula" maxlength="15" onKeyPress="return js_mascara(event);"></td>
    <?php */ ?>
    <td style="display: inline-block;">
    <?
