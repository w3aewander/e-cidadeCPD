...
class ParametrosGerais
{
    ...
    {
        return $this->tipoAssentamentoAtraso;
    }
    ...
    {
        $this->tipoAssentamentoAtraso = $tipoAssentamentoAtraso;
    }
    ...
    {
        return $this->oTipoAssentamentoFaltaDSR;
    }
     ...
     * @return self
     */
    public function setTipoAssentamentoFaltaDSR($oTipoAssentamentoFaltaDSR)
    {
        $this->oTipoAssentamentoFaltaDSR = $oTipoAssentamentoFaltaDSR;
