...
<center>
    <form name="form1" method="post" action="" onSubmit="return js_validaSubmit();">
        <?php db_input(($db_opcao == 1 ? "incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "alterar" : "excluir")), 10,
            $Ih16_codigo, true, 'hidden', 3, ""); ?>
        ...
        <fieldset id="assinante">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('h31_portariaassinatura', 10, $Ih31_portariaassinatura, true, 'text', $db_opcao,
                            "onchange='js_pesquisa_Assinaturas(false)';");
...
<script>
    ...
    function js_validaSubmit() {
        if ($F('h31_dtportaria') == '') {
            alert("Data da portaria é um campo obrigatório.");
            return;
        }

        if ($F('h31_dtinicio') == '') {
            alert("Data da inicial no grupo Dados da Portaria é um campo obrigatório.");
            return;
        }
    ...
    function js_retornoEmite(oAjax) {
        ...
        if (aRetorno.erro == true) {
            ...
            if (document.form1.selTipoPortaria.value == 'l') {
                ...
                js_imprimeRelatorio(aRetorno.iModColetiva, js_downloadArquivo, JSON.stringify(aRetorno.aParametros));
            }
        }
    }
