...
use ECidade\Saude\Laboratorio\Model\LaboratorioDepartamento;
use Exception;
...
class LaboratorioDepartamentoService
{
    ...
    /**
     * Buscar laboratorio por departamento
     */
    public function buscarLaboratorioPorDepartamento($parametros)
    {
        $laboratorio = $this->repositorio->buscar(
            "la03_i_laboratorio",
            "la03_i_departamento=".$parametros->departamento
        );
        return $laboratorio[0]['la03_i_laboratorio'];
    }
}
