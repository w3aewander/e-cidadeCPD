...
switch($oParam->exec) {
    ...
    case 'processarDadosConvenio' :
        ...
        if (isset($iConvenio) && $iConvenio != "") {
            ...
            $sDbwhere .= " and trim(r54_codrel) = '".trim($iConvenio)."' and r54_lancad='f' and r54_instit = ".db_getsession('DB_instit');
        ...
        if (isset($iRelacionamento) && $iRelacionamento != "") {
            ...
            $sDbwhere .= " and trim(r54_codeve) = '".trim($iRelacionamento)."' and r54_instit = ".db_getsession('DB_instit') ;
            $sQueryst .= "&r54_codeve=".$iRelacionamento;
        }

        $sCampos    = "r54_sequencial,
                       r54_codrel as codrel,
                       r54_regist as regist,
                       r54_codeve as codeve,
                       (r54_quant1) as quant1,
                       (r54_quant2) as quant2,
                       (r54_quant3) as quant3 ";
        ...
        if ($clmovrel->numrows > 0) {
            ...
            for ($iClmovrelRow = 0; $iClmovrelRow < $clmovrel->numrows; $iClmovrelRow++) {
                ...
                $iSequencial = $oRsImportados->r54_sequencial;
                ...
                if (isset($iCodrel) && $iCodrel != "") {
                    $sWhere .= " and trim(r54_codrel) = '".trim($iCodrel)."' ";
                }
                ...
                if (isset($iCodeve) && $iCodeve != "") {
                    $sWhere .= " and trim(r54_codeve) = '".trim($iCodeve)."' ";
                }
                ...
                if ($sqlerro == false) {
                    ...
                    if ($r1 == true || $r2 == true || $r3 == true) {
                        ...
                        $clmovrel->r54_sequencial = $iSequencial;
    ...
    case 'processarRubricas' :
         ...
         * conforme opção do usuário tomamos 2 tipos de ação
         */
