...
class LinhaInformacaoComplementarRegistry
{
    /**
     ...
     */
    public static function set(LinhaInformacaoComplementar $linhaInformacaoComplementar)
    {
        self::$storage[$linhaInformacaoComplementar->getSequencial()] = $linhaInformacaoComplementar;
    }
}
