...
<head>
  ...
  <script language="JavaScript" type="text/JavaScript">
   ...
   function js_novamatric(){
    ...
    area = iframe_lote.document.form1.j34_area.value;
    location.href="cad1_iptubase001.php?idlote="+idlote+"&liberamatri=true&j34_area="+area;
  }
  ...
  function js_parentiframe(iframe,confere){
    ...
    if(iframe=="lote" && confere==true){
     ...
     iframe_iptubase.document.form1.j34_area.value=iframe_lote.document.form1.j34_area.value;
  ...
  if (tipoImovel == "2") {
    ...
    iframe_anexos.location.href = `cad4_iptuarquivo001.php&j01_matric=${document.form1.idmatricula.value}`;
    iframe_propri.location.href = `cad1_proprialt.php&j42_matric=${document.form1.idmatricula.value}&tipoImovel=2`;
           ...
           <?php if ($tipoImovel == "2") : ?>
             <td style="display:none">
              <table class="bordas" border="0" style="border: 3px outset #666666; border-bottom-width: 0px; border-right-width: 1px ;border-right-color: #000000; border-top-color: #3c3c3c; border-right-style: inset; " id="lote"  cellpadding="3" cellspacing="0" width="12%">
                <tr>
                  <td nowrap>
                    <input  <?= $tipoImovel != "2"? "":"disabled" ?> readonly name="lote" class="nomes" style="font-weight:bold; color:black" type="text" value="Lote" title="Cadastro de Lote" size="4" maxlength="7" onClick="mo_camada('lote',true,'Iframe1');">
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table border="0" class="bordas" id="anexos" cellpadding="3" cellspacing="0" width="12%">
                <tr>
                  <td id="link_anexos" nowrap>
                    <input disabled readonly type="text" value="Anexos" size="11" maxlength="11"  class="nomes"  name="anexos" title="Anexos" onClick="mo_camada('anexos',true,'Iframe11');">
                  </td>
                </tr>
              </table>
            </td>
  ...
  <form name="form1" method="post" id="form1" >
    ...
    <td height="100%" width=100%>    <br><br>
      ...
      <div  id="Iframe1" style="position:absolute;left:0px; top:47px; z-index:99; visibility: visible;">
       ...
       ?>
       <iframe name="iframe_lote" frameborder="0" marginwidth="0" leftmargin="0" topmargin="0" src="cad1_lotealt.php<?=$query_xx . "tipoImovel=".$tipoImovel?>"  height="100%" scrolling="no"  width="100%">
       </iframe>
     </div>
     ...
     <div class="tabela" id="Iframe2" style="position:absolute; left:0px; top:47px; z-index:99; visibility: <?=(isset($liberamatri)?"visible":"hidden")?>;">
       <iframe id="iptubase"  class="bordasi"  frameborder="0" name="iframe_iptubase"   leftmargin="0" topmargin="0" src="cad1_iptubasealt.php<?=(isset($idlote)?"?j01_idbql=$idlote":"") . '?'. "tipoImovel=".$tipoImovel . '&j34_area=' . $j34_area ?>" scrolling="no"  height="1200px" width="1600px"></iframe>
     </div>
    ...
    <div class="tabela" id="Iframe11" style="position:absolute; left:0px; top:47px;  z-index:99; visibility: hidden;">
     <iframe name="iframe_anexos"  frameborder="0"  class="bordasi"  leftmargin="0" topmargin="0"  src=""  scrolling="no" height="100%" width="100%"></iframe>
    </div>
...
<script>
  ...
  if (isset($liberamatri)){
    echo "js_novamatriaba();";
  } else {
    echo "mo_camada('lote',true,'Iframe1');";
  } ?>
