    ...
    switch ( (int)$this->oParag->db02_tipo ) {
      ...
      case 1:
        if ( !class_exists('libparagrafoText') ) {
          require_once(modification("libs/db_libparagrafoText.php"));
        }
      ...
      case 2:
        if ( !class_exists('libParagrafoTabela') ) {
          require_once(modification("libs/db_libParagrafoTabela.php"));
        }
      ...
      case 3:
        if ( !class_exists('libParagrafoCodPhp') ) {
          require_once(modification("libs/db_libparagrafoCodPhp.php"));
        }
