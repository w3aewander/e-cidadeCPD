...
use ECidade\RecursosHumanos\Pessoal\Service\PrevidenciaAfastamentoService;

/**
 * @fileoverview Arquivo de funes do clculo da folha de pagamento, utilizado em conjunto dos fontes
 * pes4_gerafolha003.php pes4_gerafolha002.php
 *
 * @Version: $Id: pes4_gerafolha004.php,v 1.507 2018/11/09 19:03:54 dbdaiane Exp $
 */
function calculos_especificos_18($opcao_geral,$r110_regist, $r110_lotac) {
  ...
  if( $calcula_valor_514 ){
    if( $opcao_geral == 1 ){
      ...
      if ( db_selectmaxlinha(1, "transacao", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )) {
	  ...
	  $matriz2[10] = $DB_instit;
          ...
          db_insertlinha(1, "gerfsal", $matriz1, $matriz2 );
        }
      }
    } else {
      ...
      if ( db_selectmaxlinha(2, "transacao", "select * from gerfcom ".bb_condicaosubpes( "r48_" ).$condicaoaux )){
        ...
        if( $valor_514 > 0){
          ...
          db_insertlinha(2, "gerfcom", $matriz1, $matriz2 );
        }
      }
    }
  }
...
function calculos_especificos_17($opcao_geral,$r110_regist, $r110_lotac) {
  ...
  if($opcao_geral == 1 || $opcao_geral == 8){
    ...
    // - media de horas extras e lana no salrio ou complementar.
    ...
    if (db_selectmaxlinha(2, "basesr", "select r09_rubric from basesr ".bb_condicaosubpes("r09_").$condicaoaux )){
      ...
      if(db_selectmaxlinha(3, "cadferia_17", "select r30_ponto
      ...
      global $gerffer;
      if(db_selectmaxlinha(4, "gerffer", "select r31_regist,
        ...
        if( $gerffer[0]["r31_quant"] != 0 || $gerffer[0]["r31_valor"] !=0) {
          if($opcao_geral == 1 && $ponto_pag_17 == 'S'){
            ...
            if( !db_selectmaxlinha(5, "pontofs", "select r10_regist from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )){
              db_insertlinha(3, "pontofs", $matriz1, $matriz2 );
            }else{
	    ...
	    $condicaoaux .= " and r14_rubric = '0085'";
            ...
            if( !db_selectmaxlinha(6, "gerfsal", "select r14_regist from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
              db_insertlinha(4, "gerfsal", $matriz3, $matriz4 );
            }else{
            ...
            if( !db_selectmaxlinha(7, "pontocom", "select r47_regist from pontocom ".bb_condicaosubpes( "r47_" ).$condicaoaux )){
              db_insertlinha(5, "pontocom", $matriz1, $matriz2 );
            }else{
            ...
            if( !db_selectmaxlinha(8, "gerfcom", "select r48_regist from gerfcom ".bb_condicaosubpes( "r48_" ).$condicaoaux )){
              db_insertlinha(6, "gerfcom", $matriz3, $matriz4 );
            }else{
...
function calculos_especificos_17_ajuste($registro_, $lotac_){
  ...
  global $gerfsal;
  if (db_selectmaxlinha(9, "gerfsal", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )) {
    ...
    for($Igerfsal = 0; $Igerfsal < $iTotalLinhas; $Igerfsal++) {
      ...
      if( $gerfsal[$Igerfsal]["r14_pd"] == 1) {
        ...
        // 0054   APEI                    DESCONTO...                   No
        // 0059   DESC.ADIANT.SALARIO
        // 0060   PENSAO ALIMENTICIA      DESCONTO...                   No
        // 0063   APEMI                   DESCONTO...   D009*1/100      No
        // 0064   CESTA BASICA 1% BAS.    DESCONTO...                   No   LANCAR EM VALOR.
        // 0066   MENSALIDADE CAMI        DESCONTO...   B013*0.01       No   LANCAR 1,00 NA QUANTIDADE.
        // 0116   PARTIDO PMDB 5%BRUTO    DESCONTO...   B014*0.05       No   LANCAR 1,00 NA QUANTIDADE.
        // 0143   MENSALIDADE ASEMI       DESCONTO...   D008*4.5/100    No   INFORMAR 1,00 NO PONTO.
        // 0144   MENSALIDADE SINDICATO   DESCONTO...   D008*3/100      No   INFORMAR 1,00 NO PONTO.
        ...
        // 0125   CONVENIO CEF            DESCONTO...                  No   LANCAR EM VALOR (COLOCAR DATA LIMITE)
        // 0051   SINDICATO PL. SAUDE     DESCONTO...      B016*0.10   No   LANCAR 1,00 NA QUANTIDADE.
        // 0065   S.P.S. - ESPOSO         DESCONTO...                  No   LANCAR EM VALOR.
        // 0092   S.P.S. - CONSULTAS      DESCONTO...                  No
        // 0122   S.P.S. - DEPENDENTE     DESCONTO...                  No   LANCAR EM VALOR.
  ...
  global $pontofs_;
  if( db_selectmaxlinha(10, "pontofs_", "select sum(r10_valor) as total_descontos_avaliar from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )){
    ...
    db_selectmaxlinha(11, "pontofs_", "select r10_rubric, r10_valor from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux );
  ...
  for($i= 1 ;$i<= 12;$i+=4){
	...
	$condicaoaux .= " and r14_rubric = ".db_sqlformat( "0".$rubrica_varia);
        ...
        if( !db_selectmaxlinha(12, "gerfsal", "select r14_regist from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){

          if( $valor_a_gravar  > 0){
            db_insertlinha(7, "gerfsal", $matriz1, $matriz2 );
          }
        }else{
          if( $valor_a_gravar  > 0){
  ...
  $condicaoaux .= " and r14_rubric <= 'R926' ";
  global $gerfsal;
  if (db_selectmaxlinha(13, "gerfsal", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )) {
...
function funcionario_inicio_ferias(){
  ...
  if(!db_empty( $pessoal[$Ipessoal]["r01_recis"] ) ){
    ...
    if(db_selectmaxlinha(14, "cadferia_", "select r30_per1i,r30_per2i,r30_regist,r30_perai from cadferia ".bb_condicaosubpes( "r30_" ).$condicaoaux)){
...
function calculos_especificos_15($opcao_geral){
  ...
  if( !db_empty($tot_prov) || !db_empty($tot_desc)){
    ...
    if( db_selectmaxlinha(14, "transacao", "select sum(case when r14_rubric = '0687' then r14_valor else 0 end) as rub_0687,
      ...
      if( $liquido_folha <= $minimo){
        ...
        if( db_selectmaxlinha(16, "transacao1", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
          db_delete("gerfsal", bb_condicaosubpes("r14_").$condicaoaux) ;
        }
         ...
         * 11 Cauzo          -> 0730
         *
         * A ordem do array abaixo  inversa (de menor prioridade para maior)
         * pois quando o calculo  efetuado as rubricas so adicionadas a folha
         * de salario do servidor e assim enquanto existe margem para efetuar
         * a deduo, estas so deduzidas do calculo na competencia at que
         * a margem se esgote.
         */
...
// Rubricas que sao calculadas pegando por base o liquido (prov - desc) e aplicado um percentual que  indicado no
...
function calculos_desconto_liquido_generico_ajuste($registro_, $lotac_){
  ...
  if ( db_selectmaxlinha(17, "pontofs_", "select r10_rubric from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )) {
  ...
  if ( db_selectmaxlinha(18, "gerfsal_", "select r14_valor,r14_pd,r14_rubric from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
  ...
  for($I=0;$I < strlen($rubricas_);$I+=4){
    ...
    if( ( $$verifica_calcula_valor )){
      ...
      global $rubr_;
      db_selectmaxlinha(19, "rubr_", "select rh27_pd from rhrubricas ".$condicaoaux );

      $condicaoaux  = " and r10_regist  = ".db_sqlformat( $registro_ );
      $condicaoaux .= " and r10_rubric = '".$rubrica_varia."'" ;
      $condicaoaux .= " and r10_valor = 0 " ;
      if( db_selectmaxlinha(20, "pontofs_", "select r10_quant from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )){
        ...
        global $gerfsal_;
        if( !db_selectmaxlinha(21, "gerfsal_", "select r14_regist from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
		if( $valor_a_gravar  > 0){
	  

            db_insertlinha(8, "gerfsal",$matriz1, $matriz2 );
          }
        }else{
		if( $valor_a_gravar  > 0){
  ...
  if( $retornar){
    if( !db_empty($tot_prov) || !db_empty($tot_desc)){
      ...
      if( $arredn > 0){
        if( !db_selectmaxlinha(22, "gerfsal_", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
          $acao = "insere";
        }else{
          $acao = "altera";
        }
	...
	$matriz2[10] = $DB_instit;
        ...
        if( $acao == "altera"){
          ...
          db_insertlinha(9, "gerfsal", $matriz1, $matriz2 );
        }
      }else{
...
// , possivel programar 3 tipos de formulas e associar a cada uma, uma condicao para dispara-la.
...
function le_rubricas_condicao($qual_parametro=null){
  ...
  // db_selectmaxlinha(1,"carregarubricas","select * from rhrubricas where rh27_instit = $DB_instit ".$condicaoaux." order by rh27_rubric" );
  ...
  if ( DBRegistry::get($sIndice) ) {
    ...
    db_selectmaxlinha(23,"carregarubricas", "select * from rhrubricas where rh27_instit = $DB_instit " . $condicaoaux . " order by rh27_rubric");
...
function le_salfamilia($salario,$r01_regime,$r01_tbprev){
  ...
  global $db21_codcli;
  global $anousu, $mesusu, $DB_instit;
  global $F001,$F002,$F003,$F004,$F005,$F006,$F007,$F008,$F009,$F010,$F011,$F012,$F013,$F014,$F015,$F022,$F024,$F025,$F030,
         $F031,$F032, $F033;
...
function gerfadi($opcao_geral=null,$opcao_tipo=1){
  ...
  if( $opcao_tipo == 2){
    ...
    //   db_selectmaxlinha(1, "pessoal", "select ".$campos_pessoal." from pessoal ".bb_condicaosubpes( "r01_" ).$condicaoaux );

    $condicaoaux  = " and rh05_recis is null ";
    $condicaoaux .= " order by rh02_regist ";
    db_selectmaxlinha(24,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
      ...
      left join rhpescargo    on rh20_seqpes     = rhpessoalmov.rh02_seqpes
    ...
    if( $opcao_filtro != "0" ){
      ...
      db_selectmaxlinha(25,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
  ...
  for ($Ipessoal = 0; $Ipessoal < $iTotalLinhasPessoal; $Ipessoal++) {
    ...
    db_atutermometro($Ipessoal, $iTotalLinhasPessoal, 'calculo_folha'.($icalc_geral == 1?'':($icalc_geral == 2?'2':'3')), 1);

    $condicaoaux  = " and r21_regist = ".db_sqlformat( $pessoal[$Ipessoal]["r01_regist"]);
    $condicaoaux .= " order by r21_regist,r21_rubric ";
    global $pontofa;
    if( !db_selectmaxlinha(26, "pontofa", "select * from pontofa ".bb_condicaosubpes( "r21_" ).$condicaoaux )){
      continue;
    }
    ...
    for ($Ipontofa = 0; $Ipontofa < $iTotalLinhasPontoFA; $Ipontofa++) {
      ...
      db_selectmaxlinha(27, "rub_", "select * from rhrubricas ".$condicaoaux );

      $r22_pd = $rub_[0]["rh27_pd"];

      global $pontofx, $proc_ler_var_bxxx;
      $condicaoaux = " and r90_regist = ".db_sqlformat( $r110_regist );
      $proc_ler_var_bxxx = db_selectmaxlinha(28, "pontofx", "select * from pontofx ".bb_condicaosubpes( "r90_" ).$condicaoaux );
      ...
      if( $r22_valor > 0){
        ...
        db_insertlinha(10, $chamada_geral_arquivo,$matriz1, $matriz2 );
...
function gerffer($opcao_geral=null,$opcao_tipo=1){
  ...
  if( $opcao_tipo == 2){
    ...
    $condicaoaux  = " and rh05_recis is null ";
    $condicaoaux .= " order by rh02_regist ";
    db_selectmaxlinha(29,"pessoal", "select distinct(rh02_regist),".$campos_pessoal.",r29_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit          = rhpessoalmov.rh02_instit
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
    ...
    if( $opcao_filtro != "0" ){
      ...
      db_selectmaxlinha(30,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
	...
	left join rhpespadrao on rhpespadrao.rh03_seqpes = rhpessoalmov.rh02_seqpes
      ...
      if ( db_selectmaxlinha(31, $chamada_geral_arquivo, "select * from ".$chamada_geral_arquivo." ".bb_condicaosubpes( $siglag ).$condicaoaux )) {
  ...
  for ($Ipessoal =0; $Ipessoal < $iTotalPessoalRescisao; $Ipessoal++) {
    ...
    db_atutermometro($Ipessoal, $iTotalPessoalRescisao, 'calculo_folha'.($icalc_geral == 1?'':($icalc_geral == 2?'2':'3')), 1);
    $mpsal = false;    // pagamento de salarios no ponto de ferias;
    if( $chamada_geral == "p"  ){
	    $condicaoaux = " and r52_regist = ".db_sqlformat( $pessoal[$Ipessoal]["r01_regist"] )." 
		             and ( r52_limite is null or extract( year from r52_limite ) > $anousu or
			           ( extract(year from r52_limite ) = $anousu and extract( month from r52_limite ) >= $mesusu ) ) ";
      if( !db_selectmaxlinha(32, "pensao", "select r52_regist from pensao ".bb_condicaosubpes( "r52_" ).$condicaoaux )){
        continue;
      }else{
    ...
    $proc_ler_var_bxxx = db_selectmaxlinha(33, "pontofe", "select * from pontofe ".bb_condicaosubpes("r29_").$condicaoaux );
    ...
    global $inssirf_;
    $achou_tabela = db_selectmaxlinha(34, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    ...
    if( db_selectmaxlinha(35, "cadferia", "select * from cadferia ".bb_condicaosubpes( "r30_" ).$condicaoaux )){
    ...
    if( !$mpsal){
      ...
      if (db_selectmaxlinha(36, "gerfsal_", $condicaoaux ) ){
    ...
    for ($Ipontofe = 0; $Ipontofe < $iTotalLinhasPontoFE; $Ipontofe++) {
      ...
      global $rub_;
      db_selectmaxlinha(37, "rub_", "select * from rhrubricas ".$condicaoaux );
      $r14_pd    = $rub_[0]["rh27_pd"];
      $condicaoaux = " and r10_regist = ".db_sqlformat( $r110_regist );
      $condicaoaux .= " order by r10_regist,r10_rubric ";
      global $pontofs;
      db_selectmaxlinha(38, "pontofs", "select * from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux );
      ...
      if (!db_empty($r14_valor)) {
        ...
        /**
         * Se o parametro de comparativo de frias estiver ativo,
         * sobreescrevemos o valor das rubricas de 1/3 de ferias.
         */

        if ($matriz2[2] == 'R931' || $matriz2[2] == 'R940'){
        ...
        db_insertlinha(11, $chamada_geral_arquivo,$matriz1,$matriz2 );
    ...
    if( !db_empty($tot_prov) || !db_empty($tot_desc)){
      ...
      if( !db_empty($arredn)){
        ...
        db_insertlinha(12, $chamada_geral_arquivo,$matriz1, $matriz2 );
     ...
     * de frias, que ir realizat o lanamento dos registros financeiros no pontofs ou pontocom dependendo de
     * qual ponto que o pagamento de frias foi cadastrado,
     */
...
function gerfprovfer($opcao_geral=null,$opcao_tipo=1){
  ...
  db_selectmaxlinha(39,"pessoal", "select distinct(rh02_regist),".$campos_pessoal." from rhpessoalmov
    inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
    inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
    and rhlota.r70_instit          = rhpessoalmov.rh02_instit
    inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
  ...
  for ($Ipessoal = 0; $Ipessoal < $iTotalLinhaPessoal; $Ipessoal++) {
    ...
    db_atutermometro($Ipessoal, $iTotalLinhaPessoal, 'calculo_folha'.($icalc_geral == 1?'':($icalc_geral == 2?'2':'3')),1);

    $condicaoaux = " and r33_codtab = ".db_sqlformat( $pessoal[$Ipessoal]["r01_tbprev"]+2 );
    global $inssirf_;
    db_selectmaxlinha(40, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    ...
    global $pontoprovfe;
    if( !db_selectmaxlinha(41, "pontoprovfe", "select * from pontoprovfe ".bb_condicaosubpes( "r91_" ).$condicaoaux )){
      if ($db_debug == true) {
        echo "[gerfprovfer] no encontrou registros em pontoprovfe quando ".bb_condicaosubpes( "r91_" ).$condicaoaux."...<br> continuando... <br>";
      }
      continue;
    }
    ...
    if ($db_debug == true) {
      echo "[gerfprovfer] <br>";
      echo "[gerfprovfer] chamando a funcao carrega_fxxx(".db_str($pessoal[$Ipessoal]["r01_regist"],6).",true)<br>";
      echo "[gerfprovfer] <br>";
    }
    ...
    if ($db_debug == true) {
      echo "[gerfprovfer] <br>";
      echo "[gerfprovfer] fim do processamento da funcao carrega_fxxx(".db_str($pessoal[$Ipessoal]["r01_regist"],6).",true)<br>";
      echo "[gerfprovfer] <br>";
    }

    /**
     * Passa por parmetro o nome da tabela 'gerfprovfer' para que seja salvo na tabela gerfprovfer
     * os dados referentes ao provento de frias.
     */
    if ($db_debug == true) {
      echo "[gerfprovfer] <br>";
      echo "[gerfprovfer] chamando a funcao le_rubricas_condicao('gerfprovfer')<br>";
      echo "[gerfprovfer] <br>";
    }
    ...
    if ($db_debug == true) {
      echo "[gerfprovfer] <br>";
      echo "[gerfprovfer] fim do processamento da funcao le_rubricas_condicao('gerfprovfer')<br>";
      echo "[gerfprovfer] <br>";
      echo "[gerfprovfer] Iniciando variveis com o numero de dias a pagar<br>";
    ...
    $condicaoaux  = " and r30_regist = ".db_sqlformat( $r110_regist ) ;
    $condicaoaux .= " order by r30_perai desc limit 1";
    if( db_selectmaxlinha(42, "cadferia", "select * from cadferia ".bb_condicaosubpes( "r30_" ).$condicaoaux )){
    ...
    for($Ipontoprovfe=0;$Ipontoprovfe< count($pontoprovfe) ;$Ipontoprovfe++){
      ...
      global $rub_;
      db_selectmaxlinha(43, "rub_", "select * from rhrubricas ".$condicaoaux );
      $r93_pd = $rub_[0]["rh27_pd"];

      if($db_debug == true){ echo "[gerfprovfer] 2 - chamando a funcao calc_rubrica()<br>"; }
      ...
      if( $r93_valor > 0){
        ...
        if( !db_empty( $rub_[0]["rh27_formq"] )){
          ...
          if($db_debug == true){ echo "[gerfprovfer] 3 - chamando a funcao calc_rubrica() <br>"; }
        ...
        db_insertlinha(13, $chamada_geral_arquivo,$matriz1, $matriz2 );
    ...
    if( $pessoal[$Ipessoal]["r01_arredn"] > 0){
      ...
      db_insertlinha(14, $chamada_geral_arquivo,$matriz1, $matriz2 );
...
function gerfres($opcao_geral=null,$opcao_tipo=1){
  ...
  global $F001, $F002, $F004, $F005, $F006,
    ...
    $F012, $F013, $F014, $F015, $F016,
    $F017, $F018, $F019, $F020, $F021,
    $F022, $F023, $F006_clt, $F024, $F003, $F025, $F026, $F027, $F028, $F030, $F031, $F032, $F033;
  ...
  if( $opcao_tipo == 2){
    ...
    db_selectmaxlinha(44,"pessoal", "select distinct(rh02_regist),".$campos_pessoal." from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit           = rhpessoalmov.rh02_instit
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
    ...
    if( $opcao_filtro <> "0" ){
      ...
      db_selectmaxlinha(45,"pessoal", "select ".$campos_pessoal."
        from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit           = rhpessoalmov.rh02_instit
	...
	left join rhpespadrao   on rhpespadrao.rh03_seqpes     = rhpessoalmov.rh02_seqpes
      ...
      if (db_selectmaxlinha(47, $chamada_geral_arquivo, "select * from ".$chamada_geral_arquivo." ".bb_condicaosubpes( $siglag ).$condicaoaux )){
        ...
        if( db_selectmaxlinha(48, "gerfsal_", $sQqueryParaExclusaoFolhaSalarioRescisao)){
  ...
  for($Ipessoal=0;$Ipessoal< count($pessoal);$Ipessoal++){
    ...
    db_atutermometro($Ipessoal,count($pessoal),'calculo_folha'.($icalc_geral == 1?'':($icalc_geral == 2?'2':'3')),1);
    ...
    $condicaoaux = " and r33_codtab = ".db_sqlformat( $pessoal[$Ipessoal]["r01_tbprev"]+2 );
    global $inssirf_;
    db_selectmaxlinha(49, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    ...
    db_selectmaxlinha(50, "rescisao", "select * from rescisao ".bb_condicaosubpes( "r59_" ).$condicaoaux );
    ...
    if( strtolower($chamada_geral) == "p"  ){
	    $condicaoaux = " and r52_regist = ".db_sqlformat( $pessoal[$Ipessoal]["r01_regist"] )."
                              and ( r52_limite is null or extract( year from r52_limite ) > $anousu or
                                   ( extract(year from r52_limite ) = $anousu and extract( month from r52_limite ) >= $mesusu ) ) ";
      if( !db_selectmaxlinha(51, "pensao", "select r52_regist from pensao ".bb_condicaosubpes( "r52_" ).$condicaoaux )){
        continue;
      }else{
    ...
    global $pontofr;
    if( !db_selectmaxlinha(52, "pontofr", "select * from pontofr ".bb_condicaosubpes( "r19_" ).$condicaoaux )){
      continue;
    }
    ...
    for($Ipontofr=0;$Ipontofr< count($pontofr) ;$Ipontofr++){
      ...
      global $rub_;
      db_selectmaxlinha(53, "rub_", "select * from rhrubricas ".$condicaoaux );
      $r20_pd = $rub_[0]["rh27_pd"];

      if($db_debug == true){ echo "[gerfres] 4 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if( $r20_valor > 0){
        ...
        if( !db_empty( $rub_[0]["rh27_formq"] )){
          ...
          if($db_debug == true){ echo "[gerfres] 5 - chamando a funcao calc_rubrica() <br>"; }
        ...
        db_insertlinha(15, $chamada_geral_arquivo,$matriz1, $matriz2 );
    ...
    if( $pessoal[$Ipessoal]["r01_arredn"] > 0){
      ...
      db_insertlinha(16, $chamada_geral_arquivo,$matriz1, $matriz2 );
    }
    ...
    global $gerfadi;
    if( db_selectmaxlinha(54, "gerfadi", "select * from gerfadi ".bb_condicaosubpes( "r22_" ).$condicaoaux )){
      for($Igerfadi=0;$Igerfadi< count($gerfadi);$Igerfadi++){
        ...
        db_insertlinha(17, $chamada_geral_arquivo,$matriz1, $matriz2 );
...
function gerffx($opcao_geral=null,$opcao_tipo=1){
  ...
  global $tem_base_rubricareg, $tem_base_rubrica, $tem_base_rubricareg_unico;
  global $tem_base_reg;
  db_selectmax("tem_base_reg","select rh54_regist,rh54_base,rh54_rubric 
	                       from rhbasesreg 
			            inner join rhbases on rh54_base = rh32_base 
			       where rh32_instit = ".db_getsession('DB_instit'));

   for($ixxx=0;$ixxx<count($tem_base_reg);$ixxx++){

      $tem_base_rubricareg[ $tem_base_reg[$ixxx]['rh54_regist'] ."-".$tem_base_reg[$ixxx]['rh54_base']."-".$tem_base_reg[$ixxx]['rh54_rubric'] ] = 0;
      $tem_base_rubricareg_unico[$tem_base_reg[$ixxx]['rh54_regist'] ."-".$tem_base_reg[$ixxx]['rh54_base']] = 0;

   }

  global $tem_base;
  db_selectmax("tem_base","select r09_base,r09_rubric 
	                   from basesr 
			   where r09_anousu = ".DBPessoal::getAnoFolha()."
                             and r09_mesusu = ".DBPessoal::getMesFolha()." 
                             and r09_instit = ".db_getsession('DB_instit'));

   for($ixxx=0;$ixxx<count($tem_base);$ixxx++){

      $tem_base_rubrica[ $tem_base[$ixxx]['r09_base']."-".$tem_base[$ixxx]['r09_rubric'] ] = 0;
  ...
  if( $opcao_tipo == 2 ){
    ...
    //   $condicaoaux .= " order by r01_regist ";
    //   db_selectmaxlinha(1, "pessoal", $condicaoaux );


    $condicaoaux  = " and ( rh05_recis is null or rh05_recis >= ".db_sqlformat(db_ctod("01/".substr("#".$subpes,6,2)."/".substr("#".$subpes,1,4))).")";
    $condicaoaux .= " order by rh02_regist ";
    db_selectmaxlinha(55,"pessoal", "select distinct(rh02_regist),".$campos_pessoal.",r90_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit          = rhpessoalmov.rh02_instit
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
    ...
    if( $opcao_filtro <> "0" ){
      ...
      db_selectmaxlinha(56,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
  ...
  // includo este trecho para incluir as rubricas vari√°veis no fixo
  // paulo aqui
  //
  for($Ipessoal=0;$Ipessoal<count($pessoal);$Ipessoal++){
    ...
    $condicaoaux .= " order by r10_regist,r10_rubric ";
    global $pontofs;
    if (db_selectmaxlinha(60, "pontofs", "select * from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )) {
      ...
      for($Ipontofs=0;$Ipontofs<count($pontofs);$Ipontofs++) {
        ...
        if (db_at($pontofs[$Ipontofs]["r10_rubric"],
          $cfpess[0]["r11_ferias"]."-".   // Rubrica onde  pago as frias
          $cfpess[0]["r11_fer13"]."-".   // Rubrica onde  pago um 1/3 de frias
          $cfpess[0]["r11_fer13a"]."-".   // Rubrica onde  pago um 1/3 s/ abono de frias
          $cfpess[0]["r11_ferabo"]."-".   // Rubrica onde  pago o abono de frias
          $cfpess[0]["r11_feradi"]."-".   // Rubrica onde  pago o adiantamento de frias
          $cfpess[0]["r11_ferant"]."-".   // Rubrica onde  descontado as frias pagas no ms anterior
          $cfpess[0]["r11_feabot"]."-".   // Rubrica em que ser lanado o abono do ms anterior
          $cfpess[0]["r11_fadiab"]) > 0){ // Rubrica onde ser lanado o adiantamento s/abono de frias
          continue;
        }

        $condicaoaux = " where rh27_instit = $DB_instit and rh27_rubric = ".db_sqlformat( $pontofs[$Ipontofs]["r10_rubric"] );
        global $rub_;
        db_selectmaxlinha(61, "rub_", "select * from rhrubricas ".$condicaoaux );
        ...
        if( db_val( $rub_[0]["rh27_rubric"] ) < 2000 && substr("#".$rub_[0]["rh27_rubric"],1,1) != "R" ){
          global $transacao;
          if( $rub_[0]["rh27_tipo"] == "2" ){

              $matriz1 = array();
              $matriz2 = array();

              $matriz1[1] = "r90_regist";
              $matriz1[2] = "r90_rubric";
              $matriz1[3] = "r90_lotac";
              $matriz1[4] = "r90_valor";
              $matriz1[5] = "r90_quant";
              $matriz1[6] = "r90_anousu";
              $matriz1[7] = "r90_mesusu";
              $matriz1[8] = "r90_datlim";
              $matriz1[9] = "r90_instit";

              $matriz2[1] = $pontofs[$Ipontofs]["r10_regist"];
              $matriz2[2] = $pontofs[$Ipontofs]["r10_rubric"];
              $matriz2[3] = $pontofs[$Ipontofs]["r10_lotac"];
              $matriz2[4] = $pontofs[$Ipontofs]["r10_valor"];
              $matriz2[5] = $pontofs[$Ipontofs]["r10_quant"];
              $matriz2[6] = $pontofs[$Ipontofs]["r10_anousu"];
              $matriz2[7] = $pontofs[$Ipontofs]["r10_mesusu"];
              $matriz2[8] = $pontofs[$Ipontofs]["r10_datlim"];
              $matriz2[9] = $pontofs[$Ipontofs]["r10_instit"];

              $condicaoaux  = " and r90_regist = ".db_sqlformat( $pessoal[$Ipessoal]["r01_regist"] );
              $condicaoaux .= " and r90_rubric = ".db_sqlformat( $pontofs[$Ipontofs]["r10_rubric"] );
              if( db_selectmaxlinha(67, "transacao", "select * from pontofx ".bb_condicaosubpes("r90_").$condicaoaux )){
                $acao = "altera";
              }else{
                $acao = "insere";
              }
              ...
              if( $acao == "insere"){
                db_insertlinha(19, "pontofx" ,$matriz1, $matriz2 );
              }else{
    ...
    $condicaoaux = " and r90_regist = ".db_sqlformat( $pessoal[$Ipessoal]["r01_regist"] );
//$condicaoaux .=dd " order by r90_regist,r90_rubric ";
    global $pontofx;
    if( !db_selectmaxlinha(57, "pontofx", "(select * from pontofx ".bb_condicaosubpes( "r90_" ).$condicaoaux." and r90_rubric not in ( '0371','0206')) union all (select * from pontofx ".bb_condicaosubpes( "r90_" ).$condicaoaux." and r90_rubric in ('0371','0206'))"                                         )){
      //  echo "<BR> 1.1 passou aqui !!!";
      //   flush();
      continue;
    }
    ...
    $condicaoaux = " and r33_codtab = ".db_sqlformat( $pessoal[$Ipessoal]["r01_tbprev"]+2 );
    global $inssirf_;
    db_selectmaxlinha(58, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    $inssirf_base_ferias = "B002";
    if( !db_empty( $inssirf_[0]["r33_basfer"] )){
      $inssirf_base_ferias = $inssirf_[0]["r33_basfer"];
    }
    ...
    for ($Ipontofx = 0; $Ipontofx < $iTotalPonto; $Ipontofx++) {
      ...
      global $rub_;
      db_selectmaxlinha(59, "rub_", "select rh27_pd,rh27_propi from rhrubricas ".$condicaoaux );

      $r53_pd = $rub_[0]["rh27_pd"];

      if($db_debug == true){ echo "[gerffx] 6 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if ( $r53_valor > 0){
        ...
        db_insertlinha(18, $chamada_geral_arquivo,$matriz1, $matriz2 );
...
function gerfprovs13($opcao_geral=null,$opcao_tipo=1){
  ...
  if( $opcao_tipo == 2){
    ...
    $condicaoaux  = " and ( rh05_recis is null or rh05_recis >= ".db_sqlformat(db_ctod("01/".substr("#".$subpes,6,2)."/".substr("#".$subpes,1,4))).")";
    $condicaoaux .= " order by rh02_regist ";
    db_selectmaxlinha(68,"pessoal", "select distinct(rh02_regist),".$campos_pessoal.",r34_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit          = rhpessoalmov.rh02_instit
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
  ...
  for($Ipessoal=0;$Ipessoal< count($pessoal);$Ipessoal++){
    ...
    global $pontoprovf13;
    if( !db_selectmaxlinha(69, "pontoprovf13", "select * from pontoprovf13 ".bb_condicaosubpes( "r92_" ).$condicaoaux )){
    ...
    $condicaoaux = " and r33_codtab = ".db_sqlformat( $pessoal[$Ipessoal]["r01_tbprev"]+2 );
    global $inssirf_;
    db_selectmaxlinha(70, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    $inssirf_base_ferias = "B002";
    if( !db_empty( $inssirf_[0]["r33_basfer"] )){
      $inssirf_base_ferias = $inssirf_[0]["r33_basfer"];
    }
    ...
    for ($Ipontoprovf13 = 0; $Ipontoprovf13 < count($pontoprovf13);$Ipontoprovf13++) {
      ...
      db_selectmaxlinha(71, "rub_", "select * from rhrubricas ".$condicaoaux );

      $r94_pd  = $rub_[0]["rh27_pd"];

      if($db_debug == true){ echo "[gerfprovs13] 8 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if ($r94_valor > 0) {
        ...
        if ( !db_empty( $rub_[0]["rh27_formq"] )) {
          ...
          if($db_debug == true){ echo "[gerfprovs13] 9 - chamando a funcao calc_rubrica() <br>"; }
        ...
        $matriz2[9] = db_val( substr("#".$subpes,6,2 ));
        $matriz2[10] = $DB_instit;
        db_insertlinha(20, $chamada_geral_arquivo,$matriz1, $matriz2 );
...
function gerfs13($opcao_geral=null,$opcao_tipo=1) {
  ...
  global $tem_base;
  db_selectmaxlinha(999,"tem_base","select r09_base,r09_rubric 
	                   from basesr 
			   where r09_anousu = ".DBPessoal::getAnoFolha()."
                             and r09_mesusu = ".DBPessoal::getMesFolha()." 
                             and r09_instit = ".db_getsession('DB_instit'));
  ...
  if ($opcao_tipo == 2) {
    ...
    db_selectmaxlinha(72,"pessoal", "select distinct(rh02_regist),".$campos_pessoal.",r34_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit          = rhpessoalmov.rh02_instit
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
    ...
    if( $opcao_filtro != "0" ){
      ...
      $condicaoaux .= " order by  rh02_regist ";
      db_selectmaxlinha(73,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
	...
	left join rhpespadrao on rhpespadrao.rh03_seqpes = rhpessoalmov.rh02_seqpes
      ...
      $condicaoaux = db_condicaoaux($opcao_filtro,$opcao_gml,$siglag,$r110_regisi,$r110_regisf,$r110_lotaci,
        $r110_lotacf,$faixa_regis,$faixa_lotac);
      global $$chamada_geral_arquivo;
      if( db_selectmaxlinha(74, $chamada_geral_arquivo, "select * from ".$chamada_geral_arquivo." ".bb_condicaosubpes( $siglag ).$condicaoaux )){
  ...
  for($Ipessoal=0;$Ipessoal< count($pessoal);$Ipessoal++){
    ...
    if( $chamada_geral == "p"  ){
	    ...
	    and ( r52_limite is null or  extract( year from r52_limite ) > $anousu or
                                   ( extract(year from r52_limite ) = $anousu and extract( month from r52_limite ) >= $mesusu ) ) ";
      if( !db_selectmaxlinha(75, "pensao", "select r52_regist from pensao ".bb_condicaosubpes( "r52_" ).$condicaoaux )){
        continue;
      }else{
    ...
    global $pontof13;
    if (!db_selectmaxlinha(76, "pontof13", "select * from pontof13 ".bb_condicaosubpes( "r34_" ).$condicaoaux )){
      continue;
    }
    ...
    if ($db_debug == true) {
      echo "[gerfs13] chamando a funcao carrega_fxxx<br>";
    }
    carrega_fxxx(db_str($pessoal[$Ipessoal]["r01_regist"],6),true);

    if ($db_debug == true) {
      echo "[gerfs13] chamando a funcao le_rubricas_condicao<br>";
    }
    le_rubricas_condicao();
    ...
    $condicaoaux = " and r33_codtab = ".db_sqlformat( $pessoal[$Ipessoal]["r01_tbprev"]+2 );
    global $inssirf_;
    db_selectmaxlinha(77, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux );
    $inssirf_base_ferias = "B002";
    if( !db_empty( $inssirf_[0]["r33_basfer"] )){
      $inssirf_base_ferias = $inssirf_[0]["r33_basfer"];
    }
    ...
    for($Ipontof13=0;$Ipontof13< count($pontof13);$Ipontof13++){
      ...
      global $rub_;
      db_selectmaxlinha(78, "rub_", "select * from rhrubricas ".$condicaoaux );

      $r14_pd  = $rub_[0]["rh27_pd"];

      if($db_debug == true){ echo "[gerfs13] 10 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if( $r14_valor > 0){
        ...
        if( !db_empty( $rub_[0]["rh27_formq"] )){
          ...
          if($db_debug == true){ echo "[gerfs13] 11 - chamando a funcao calc_rubrica() <br>"; }
        ...
        db_insertlinha(21, $chamada_geral_arquivo,$matriz1, $matriz2 );
    ...
    if ($db_debug == true) {
      ...
      echo "[gerfs13] cahmando a funcao carrega_r9xx() ";
    }
    ...
    if( !db_empty($tot_prov) || !db_empty($tot_desc)){
      ...
      if( $arredn > 0){
        ...
        db_insertlinha(22, $chamada_geral_arquivo,$matriz1, $matriz2 );
  ...
  if ($db_debug == true ) {
    echo "[gerfs13] FIM DO PROCESSAMENTO DA FUNCAO gerfs13() <br><br>";
  }
...
function gerfsal( $opcao_geral=null, $opcao_tipo = TIPO_CALCULO_PARCIAL ) {
  ...
  global $dias_pagamento,$mes,$ano,$dias_do_mes,$vlr_sal_saude_ou_acidente,$valor_salario_maternidade ;
  global $rubricas,$prev_desc,$func_em_ferias,$ajusta,$sigla_ajuste,$inssirf_base_ferias;
  global $F001, $F002, $F004, $F005, $F006, $F007, $F008, $F009, $F010, $F011, $F012, $F013, $F014, $F015, $F016, $F017, $F018, $F019,
         $F020, $F021, $F022, $F023, $F006_clt, $F024, $F003, $F025, $F026, $F027, $F028, $F030, $F031, $F032, $F033;
  global $quais_diversos;
  eval($quais_diversos);
  global $opcao_filtro,$opcao_gml,$r110_regisf,$r110_lotaci, $r110_lotacf,$faixa_regis,$faixa_lotac;
  global $dtot_vpass,$dperc_pass,$dquant_pass,$quant_pass,$contador_registros;
  ...
  global $transacao_paulo;
  $transacao_paulo = array();
  global $tem_base_rubricareg, $tem_base_rubrica, $tem_base_rubricareg_unico;
  global $tem_base_reg;
  db_selectmax("tem_base_reg","select rh54_regist,rh54_base,rh54_rubric 
	                       from rhbasesreg 
  ...
  if ($db_debug == true) {
    echo "[gerfsal] INICIANDO PROCESSAMENTO DA FUNCAO gerfsal()... <br>";
  }
  if ($opcao_geral == 1 ) {
    $siglag = "r14_";
    $siglap = "r10_";
  ...
  if ( $opcao_tipo == TIPO_CALCULO_GERAL ) {
    ...
    if ( $opcao_geral == PONTO_SALARIO ) {
      ...
      $condicaoaux .= " order by rh02_regist ";
      db_selectmaxlinha(79,"pessoal", "select ".$campos_pessoal." from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
	...
	left join rhpespadrao on rhpespadrao.rh03_seqpes = rhpessoalmov.rh02_seqpes
        ...
        left join rhpesprop on rh19_regist = rh02_regist
        ".bb_condicaosubpes("rh02_" ).$condicaoaux );
      LogCalculoFolha::write("SQL: Calculo Geral de Salrio");
    } else {

      $condicaoaux  = " and ( rh05_recis is null or rh05_recis >= ".db_sqlformat(db_ctod("01/".substr("#".$subpes,6,2)."/".substr("#".$subpes,1,4))).")";
      $condicaoaux .= " order by rh02_regist ";
      db_selectmaxlinha(80,"pessoal", "select distinct(rh02_regist),".$campos_pessoal.",r47_regist,r29_regist from rhpessoalmov
        inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
        inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
        and rhlota.r70_instit          = rhpessoalmov.rh02_instit
        inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
	...
	left join rhpespadrao on rhpespadrao.rh03_seqpes = rhpessoalmov.rh02_seqpes
        ...
        and r29_instit= rhpessoalmov.rh02_instit
        ".bb_condicaosubpes("rh02_" ).$condicaoaux );
      LogCalculoFolha::write("SQL: Calculo Geral Diferente de Salrio");
    }
  } else {
    ...
    if ($opcao_filtro != "0" ) {
      ...
      if ($opcao_geral == PONTO_SALARIO ) {
        LogCalculoFolha::write("SQL: Calculo PARCIAL de Salrio");
        $condicaoaux .= " and rh05_recis is null ";
      } else {
        LogCalculoFolha::write("SQL: Calculo PARCIAL diferente de Salrio");
        $condicaoaux .= " and ( rh05_recis is null or rh05_recis >= ".db_sqlformat(db_ctod("01/".substr("#".$subpes,6,2)."/".substr("#".$subpes,1,4))).")";
      }
      ...
      $sSqlServidores .= "        left join rhpescargo     on rh20_seqpes                  = rh02_seqpes              ".PHP_EOL;
      $sSqlServidores .= bb_condicaosubpes("rh02_" );
      $sSqlServidores .= "$condicaoaux                                                                                ".PHP_EOL;

      db_selectmaxlinha(81,"pessoal", $sSqlServidores);
...
/*
      ...
      if (db_selectmaxlinha(82,$chamada_geral_arquivo, "select * from ".$chamada_geral_arquivo." ".bb_condicaosubpes($siglag ).$condicaoaux )) {
	  ...
	  db_delete($chamada_geral_arquivo, bb_condicaosubpes($siglag ).$condicaoaux );
	  if( $chamada_geral_arquivo == "gerfsal"){
	    db_delete("gerfsal", bb_condicaosubpes($siglag ).$condicaoaux );
          }
          ...
          if ( !DBPessoal::verificarUtilizacaoEstruturaSuplementar() ) {
            ...
            if (db_selectmaxlinha(83,"gerfsal_", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
...
*/
      ...
      if ($opcao_geral == 1 ) {
         ...
         $sCampos = "r14_rubric, r14_regist";
         $sWhere = bb_condicaosubpes($siglag ).$condicaoaux;
         $sWhere = str_replace('where', '', $sWhere);
         $sSqlGerfsal = $clgerfsal->sql_query_file(null, null, null, null, $sCampos, null, $sWhere);
         $retorno_gerfsal = $clgerfsal->sql_record($sSqlGerfsal);

         $iTotalLinhasarq = $clgerfsal->numrows;         

         //echo "<BR> Apagar registro do gerfsal";
         global $Igerfsal;

         while ($aGerfsal = pg_fetch_object($retorno_gerfsal)) {
            deleta_para_ajustes($aGerfsal->r14_rubric, $aGerfsal->r14_regist, "S");
         }
  ...
  for ($Ipessoal = 0; $Ipessoal < $iTotalLinhasPessoal; $Ipessoal++) {
    ...
    if ($chamada_geral == "p"  ) {
	    ...
	    and ( r52_limite is null or extract( year from r52_limite ) > $anousu or
				   ( extract(year from r52_limite ) = $anousu and extract( month from r52_limite ) >= $mesusu ) ) ";
      if (!db_selectmaxlinha(84,"pensao", "select r52_regist from pensao ".bb_condicaosubpes("r52_" ).$condicaoaux )) {
        LogCalculoFolha::write("Saindo do Lao pois Chamada Geral == 'P'... continue");
        continue;
      } else {
    ...
    if (!$inssirf_) {
      ...
      db_selectmaxlinha(85,"inssirf_", "SELECT * FROM inssirf " . bb_condicaosubpes("r33_") . $condicaoaux);
    ...
    if ($opcao_geral == 1) {
      ...
      $condicaoaux .= " order by r10_regist,r10_rubric ";
      global $pontofs;
      db_selectmaxlinha(86,"pontofs", "select *
        from pontofs
      ...
      global $pontocom;
      db_selectmaxlinha(87,"pontocom", "select * from pontocom inner join rhrubricas on r47_instit = rh27_instit and r47_rubric = rh27_rubric ".bb_condicaosubpes("r47_" ).$condicaoaux );
    }
    ...
    if ($quant_pontofs ==0) {
	  ...
	  $condicaoaux .= " and r14_rubric = ".db_sqlformat($pessoal[$Ipessoal]["r01_rubric"] );
          ...
          if (db_selectmaxlinha(88,"transacao", "select * from gerfsal " . bb_condicaosubpes("r14_") . $condicaoaux)) {
            db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_") . $condicaoaux);
          } else {
            if ($db_debug == true) {
            ...
            db_insertlinha(23,"gerfsal", $matriz1, $matriz2);
          }
	  ...
	  $matriz2[6] = 1;
          ...
          if (db_selectmaxlinha(89,"transacao", "select * from gerfsal " . bb_condicaosubpes("r14_") . $condicaoaux)) {
            db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_") . $condicaoaux);
          } else {
            if ($db_debug == true) {
            ...
            db_insertlinha(24,"gerfsal", $matriz1, $matriz2);
          }
        }else{
          LogCalculoFolha::write("Saiu pois no tem R928 na tabela de calculo de salario... continue");
          continue;
        }
      }else{
        LogCalculoFolha::write("Saiu pois no  salrio... continue");
        continue;
      }
    }
    ...
    for ($Iponto=0; $Iponto<$quant_pontofs; $Iponto++) {
      ...
      if (strtolower($db21_codcli) == "18") {
        ...
        if ($opcao_geral == 1) {
          if ($pontofs[$Iponto]["r10_rubric"] == "0514" && !db_empty($pessoal[$Ipessoal]["r01_cc"])) {
            ...
            LogCalculoFolha::write("Saiu achou Rubrica 0514 e no  CC... continue");
            continue;
          }
      ...
      if ($opcao_geral == 1) {
        ...
        // O calculo do Ponto de salario quando em licena gestante, a quantidade vai ser baseada no que foi
        // lancado no ponto fixo
        global $pontofx;
        ...
        if ($F019 > 0 && (in_array(Afastamento::AFASTADO_LICENCA_GESTANTE, $SituacoesFuncionario) || //$situacao_funcionario == 5  Afastado Licenca Gestante
                          in_array(Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE, $SituacoesFuncionario))  //$situacao_funcionario == 9  Afastado Prorrogacao Licenca Gestante
          && db_selectmaxlinha(90,"pontofx", "select * from pontofx ".bb_condicaosubpes("r90_" ).$condicaoaux ) ) {
          ...
          if($db_debug == true){ echo "[gerfsal] 12 - chamando a funcao calc_rubrica() <br>"; }
          ...
          //        db_selectmaxlinha(1, "rubricas", "select rh27_propi,rh27_rubric,rh27_pd,rh27_calcp,rh27_propq,rh27_formq from rhrubricas ".$condicaoaux );
          $r14_pd = $pontofs[$Iponto]["rh27_pd"];

          if($db_debug == true){ echo "[gerfsal] 13 - chamando a funcao calc_rubrica() <br>"; }
	  ...
	  $matriz2[10] = $DB_instit;
          ...
          db_insertlinha(25,"gerfsal", $matriz1, $matriz2 );

          $r14_quant = 0;

          if ( ($pontofs[$Iponto]["r10_rubric"] == "R916") || $pontofs[$Iponto]["r10_rubric"] < "R800" && !in_array($r14_pd, Rubrica::TIPO_BASES) && db_at($pontofs[$Iponto]["r10_rubric"],$rubricas_calc_integral) == 0 ) {
        ...
        //     db_selectmaxlinha(1, "rubricas", "select * from rhrubricas ".$condicaoaux );
        $r14_pd = $pontocom[$Iponto]["rh27_pd"];

        if($db_debug){ echo "[gerfsal] 15 - chamando a funcao calc_rubrica() <br>"; }
        ...
        if ($r14_valor > 0) {
          ...
          if (!db_empty($pontocom[$Iponto]["rh27_formq"] )) {
            ...
            if($db_debug == true){ echo "[gerfsal] 16 - chamando a funcao calc_rubrica() <br>"; }
          ...
          db_insertlinha(26,"gerfcom", $matriz1, $matriz2 );
          $r14_quant = 0;
    ...
    $aRubricaDeCadaTipo[Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE]          = $rubrica_maternidade_prorrogacao;
    ...
    if (isset($SituacoesFuncionario)) {
      ...
      $daoControleAfastamento = new cl_controleafastamento();
      $repositoryControleAfastamento = new ControleAfastamentoRepository($daoControleAfastamento);
      $serviceControleAfastamento = new ControleAfastamentoService($repositoryControleAfastamento);

      $controleAfastamento = DBRegistry::get('controleAfastamento');
      ...
      if (empty($controleAfastamento[$DB_instit][$tabela])) {
           ...
           */
	  $controleAfastamentosPorTabela = $serviceControleAfastamento->buscaControleAfastamentosCalculo(InstituicaoRepository::getInstituicaoSessao(), $tabela, $anousu, $mesusu);

          foreach ($controleAfastamentosPorTabela as $controleAfastamentoPorTabela) {
              $controleAfastamento[$DB_instit][$tabela][$controleAfastamentoPorTabela->getAfastamento()][] = $controleAfastamentoPorTabela;
          }
      }

      DBRegistry::add('controleAfastamento', $controleAfastamento);

      db_selectmaxlinha(91,"aValoresFolhaSalario", "select distinct gerffx.*,rh27_rubric,rh27_pd,rh27_calcp,rh27_propq from gerffx inner join rhrubricas on r53_instit = rh27_instit and r53_rubric = rh27_rubric " . bb_condicaosubpes("r53_") . $condicaoaux1);
      $houveControleDeProporcionalizacao = false;
      foreach ($aAfastamentosServidor as $oAfastamento) {
        ...
        if ($iTotalLinhasFolhaSalario > 0) {
          for ($Itransacao = 0;$Itransacao < $iTotalLinhasFolhaSalario; $Itransacao++) {
            ...
            $proporcionalizaRubricaControleAfastamento = false;
            $rubricaControleAfastamento = $aValoresFolhaSalario[$Itransacao]["r53_rubric"];

            if (!empty($controleAfastamento[$DB_instit][$tabela][$oAfastamento->r45_situac])) {
                /**
                 * @var ControleAfastamento[] $controleAfastamentosVerificacao
                 */
                $controleAfastamentosVerificacao = $controleAfastamento[$DB_instit][$tabela][$oAfastamento->r45_situac];

                foreach($controleAfastamentosVerificacao as $controleAfastamentoVerificacao) {
                  if ($rubricaControleAfastamento === $controleAfastamentoVerificacao->getRubrica()->getCodigo()) {
                      $proporcionalizaRubricaControleAfastamento = true;
                      $houveControleDeProporcionalizacao = true;
                      continue;
                  }
                }
            ...
            /**
             * Caso o afastamento seja de mes inteiro, deve remover as rubricas que nao sao proporcionalizadas
             * pelo novo sistema de controle de afastamentos
             */
            if (!$proporcionalizaRubricaControleAfastamento && $dias_pagamento === 0) {
                $whereDeleteControleAfastamento = " and r14_regist = " . db_sqlformat($pessoal[$Ipessoal]["r01_regist"]);
                $whereDeleteControleAfastamento .= " and r14_rubric = " . db_sqlformat($rubricaControleAfastamento);
                db_delete("gerfsal", bb_condicaosubpes("r14_") . $whereDeleteControleAfastamento);
            }
            ...
            if (substr("#" . $aValoresFolhaSalario[$Itransacao]["r53_rubric"], 1, 1) != "R") {
                  ...
                  if (in_array($oAfastamento->r45_situac, $aAfastamentosLicencaSaude) && !db_empty($rubrica_licenca_saude)
                      ...
                      if ($aValoresFolhaSalario[$Itransacao]["rh27_pd"] == 2) {
                          if ($proporcionalizaRubricaControleAfastamento) {
                  ...
                  if ((($oAfastamento->r45_situac == Afastamento::AFASTADO_LICENCA_GESTANTE) ||
                       ($oAfastamento->r45_situac == Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE)) && !db_empty($rubrica_maternidade)) {
                  ...
                  if ($dias_pagamento - $iDiasFerias == 0) {
                      ...
                      if ((30 - (30 - $dias_pagamento) - $iDiasFerias) > 0) {
                           ...
                           * Os valores sero utilizados para realizar o ajuste da diferena dos valores entre o fracionamento da rubrica e a o pagamento do valor do afastamento na rubrica
	  ...
	  global $gerfsalafa;
          db_selectmaxlinha(130,"gerfsalafa"," select r14_regist from gerfsal ".bb_condicaosubpes("r14_")." and r14_rubric = '$sRubricaDoAfastamento'  and r14_regist = $r110_regist ");
          if( count($gerfsalafa) == 0 ){
            db_insertlinha(27,"gerfsal", $matriz1, $matriz2);
	  }else{
	    db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_")." and r14_rubric = '$sRubricaDoAfastamento'  and r14_regist = $r110_regist ");
          }
    ...
    if (count($aValoresDeRubricasAfastamentos) > 0 && ($dias_pagamento - $F019 > 0)) {
      ...
      if ($nValorDasRubricas != $nValorAjustadoDeAfastamento && !$houveControleDeProporcionalizacao) {
    ...
    if ((!in_array(Afastamento::AFASTADO_SERVICO_MILITAR, $SituacoesFuncionario)
	  ...
	  $condicaoaux .= " and r14_rubric = ".db_sqlformat($pessoal[$Ipessoal]["r01_rubric"] );
          ...
          if (db_selectmaxlinha(92,"transacao", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
            db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_" ).$condicaoaux );
          } else {
            if ($db_debug == true) {
            ...
            db_insertlinha(28,"gerfsal", $matriz1, $matriz2 );
          }
        }
        ...
        $condicaoaux .= " and r22_pd    != 3 ";
        global $gerfadi;
        if (db_selectmaxlinha(93,"gerfadi", "select * from gerfadi ".bb_condicaosubpes("r22_" ).$condicaoaux )) {
          ...
          for ( $Igerfadi = 0; $Igerfadi < $iTotalLinhasgerfadi; $Igerfadi++) {
            ...
            db_insertlinha(29,"gerfsal", $matriz1, $matriz2 );
          }
        }
      }
    ...
    if ((in_array(Afastamento::AFASTADO_LICENCA_GESTANTE, $SituacoesFuncionario) ||
        in_array(Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE, $SituacoesFuncionario)) && $dias_pagamento == 0) {
      
      $prevAfastaService = New PrevidenciaAfastamentoService($inssirf_[0]);
      $sPrevAfastamentos = $prevAfastaService->addAfastamentosConfigurados()->toInner();
      
      $condicaoaux  = " and rh27_calcp = 't' and r14_regist = ".db_sqlformat($r110_regist );
      $condicaoaux .= " and r14_rubric < 'R900' ";
      $condicaoaux .= " and r14_rubric not in ({$sPrevAfastamentos})";
      // $condicaoaux .= " and r14_rubric != ".db_sqlformat($inssirf_[0]["r33_rubmat"] );

      global $transacao;
      if (db_selectmaxlinha(94,"transacao", "select r14_regist,
        r14_rubric,
        rh27_calcp
      ...
      if (db_selectmaxlinha(95,"transacao", "select sum(case when r14_pd = 1 then r14_valor else 0 end ) as tot_prov,
    ...
    LogCalculoFolha::write("Iniciando Parte de Gravao de Ajutes");

    /**
     * @var $ajusta Verifica se o clculo est no momento do Ajuste
      ...
      if ($vlr_sal_saude_ou_acidente > 0) {
          $sqlDeleteGerfsal = "
            ...
            WHERE r14_anousu = {$anousu}
                  ...
                  AND r14_regist = {$pessoal[$Ipessoal]["r01_regist"]}
                  AND r14_rubric = 'R960';
          ";

          if (!db_query($sqlDeleteGerfsal)) {
          ...
          if (!db_query($sqlInsertGerfsal)) {
              throw new Exception('No foi possvel inserir o salrio.');
          }
      }
  }
...
function deleta_para_ajustes($vrubrica, $registro_, $tipo) {
  ...
  if ( !in_array($vrubrica, array_merge($aRubricasIRRF, $aRubricasPrevidencia)) ) {
    ...
    LogCalculoFolha::write("Rubrica '$vrubrica' no precisa ser deletada para ajustes.");
    return false;
  }
  ...
  if( in_array($vrubrica , $aRubricasPrevidencia) ) {
    ...
    db_selectmaxlinha(96,"pessoal_del", "select rh01_numcgm as r01_numcgm, rh02_tbprev as r01_tbprev, rh02_regist as r01_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
      inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
      and rhlota.r70_instit          = rhpessoalmov.rh02_instit
  ...
  if ( in_array($vrubrica , $aRubricasIRRF) ) {
    ...
    // R982 BASE IRF 13O SAL (BRUTA)
	  ...
	  unset($GLOBALS['pessoal_del']);
	  global $pessoal_del;
	
    $condicaoaux = " and rh02_regist = ".db_sqlformat( $registro_ );
    db_selectmaxlinha(97,"pessoal_del", "select rh01_numcgm as r01_numcgm, rh02_regist as r01_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
      ".bb_condicaosubpes("rh02_" ).$condicaoaux );
...
/**
 * Calcula valo r real do imposto de renda retido na fonte e utilizando geralmente quando h duplo vinculo ou resciso
...
function carrega_fxxx ($codigo, $carrega, $cfuncao=null ) {
  ...
  if($db_debug == true){
    echo "[carrega_fxxx] INICIANDO PROCESSAMENTO DA FUNCAO carrega_fxxx() <br>";
...
global $pessoal_;
//  db_selectmaxlinha(1, "pessoal_", "select ".$campos_pessoal_." from pessoal ".bb_condicaosubpes( "r01_" ).$condicaoaux);

$condicaoaux = " and rh02_regist = ".db_sqlformat( $codigo );
db_selectmaxlinha(98,"pessoal_", "select ".$campos_pessoal_." from rhpessoalmov
  inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
  inner join rhlota       on rhlota.r70_codigo           = rhpessoalmov.rh02_lota
  and rhlota.r70_instit          = rhpessoalmov.rh02_instit
  inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
...
$F033 = DBPessoal::getVariaveisCalculo($oServidor, 'f033');
...
if( count($pessoal_) > 0){
  ...
  if( $pessoal_[0]["r01_hrssem"] > 0){
    ...
    if( db_selectmaxlinha(99, "padroes", "select * from padroes ".bb_condicaosubpes( "r02_" ).$condicaoaux )){
  ...
  if( $pessoal_[0]["r01_hrsmen"] > 0 ){
    ...
    $condicaoaux  = " and r02_regime = ".db_sqlformat($pessoal_[0]["r01_regime"] );
    $condicaoaux .= " and trim(upper(r02_codigo)) = ".db_sqlformat(trim(strtoupper($pessoal_[0]["r01_padrao"])) );
    if( db_selectmaxlinha(100,"padroes","select * from padroes ".bb_condicaosubpes( "r02_" ).$condicaoaux )){
    ...
    if( $db21_codcli == "4"){
      if( $pessoal_[0]["r01_regime"] == 2 && strtolower(substr("#".$pessoal_[0]["r01_padrao"],1,2)) != 'pf'){
        if( db_mktime($pessoal_[0]["r01_admiss"]) > db_mktime(db_ctod('30/09/1984'))){
          if( db_selectmaxlinha(101,"tri","select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
            $F013 = $tri[0]["fc_idade"]/3;
            $F013 = (int)$F013;
          }
        }else{
          if( db_selectmaxlinha(102, "tri", "select fc_idade(to_date('30-09-1984','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
            $F013 = $tri[0]["fc_idade"]/3;
            $F013 = (int)$F013;
          }
        }
        if( db_selectmaxlinha(103, "pad", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
          $F012 = $pad[0]["fc_idade"];
        }
        ...
        if( trim($pessoal_[0]["r01_clas1"]) == '2'){
          if( db_empty($pessoal_[0]["r01_clas2"]) ){
            if( db_mktime($pessoal_[0]["r01_admiss"]) < db_mktime(db_ctod("31/10/1997"))){
              if( db_selectmaxlinha(104, "tri", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('31-10-1997','dd-mm-YYYY'))") ){
                $F013 = $tri[0]["fc_idade"]/3;
                $F013 = (int)$F013;
              }
            }else{
              if( db_selectmaxlinha(105, "tri", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
                $F013 = $tri[0]["fc_idade"]/3;
                $F013 = (int)$F013;
              }
            }
            ...
            if( db_selectmaxlinha(106, "pad", "select fc_idade(to_date('".db_dtoc($xdata)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
              $F012 = $pad[0]["fc_idade"];
            }
            $data_base = $data_base_ant;
            $xdata = $xdata_ant;
          }else{
            if( db_selectmaxlinha(107, "tri", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($pessoal_[0]["r01_clas2"])."','dd-mm-YYYY'))") ){
              $F013 = $tri[0]["fc_idade"]/3;
              $F013 = (int)$F013;
            }
            ...
            $xclas2_ant = $xdata;
            if( db_selectmaxlinha(108, "pad", "select fc_idade(to_date('".db_dtoc($xclas2_ant)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
              $F012 = $pad[0]["fc_idade"];
            }
          }
        }else if( trim($pessoal_[0]["r01_clas1"]) == '9'){
          if( db_selectmaxlinha(109,"tri", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('31-10-1997','dd-mm-YYYY'))") ){
            $F013 = $tri[0]["fc_idade"]/3;
            $F013 = (int)$F013;
          }
          ...
          if( db_selectmaxlinha(110,"pad", "select fc_idade(to_date('".db_dtoc($xdata)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
            $F012 = $pad[0]["fc_idade"];
          }
        }else{
          if( db_selectmaxlinha(111,"tri", "select fc_idade(to_date('".db_dtoc($data_trien)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
            $F013 = $tri[0]["fc_idade"]/3;
            $F013 = (int)$F013;
          }
          if( db_selectmaxlinha(112,"pad", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
            $F012 = $pad[0]["fc_idade"];
          }
        }
      }else{
        if( db_selectmaxlinha(113,"pad", "select fc_idade(to_date('".db_dtoc($data_trien)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
        ...
        if( db_selectmaxlinha(114,"pad", "select fc_idade(to_date('".db_dtoc($pessoal_[0]["r01_admiss"])."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))") ){
          $F012 = $pad[0]["fc_idade"];
        }
        $data_base = $data_base_ant;
      }
      ...
      if(!DBRegistry::get($sIndice)) {
        if(!db_selectmaxlinha(115, "pad", "select fc_idade(to_date('".db_dtoc($data_progr)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))")) {
          $pad = false;
        }
      ...
      if (!DBRegistry::get($sIndice)) {
        ...
        if(!db_selectmaxlinha(116,"tri", "select fc_idade(to_date('".db_dtoc($data_trien)."','dd-mm-YYYY'),to_date('".db_dtoc($data_base)."','dd-mm-YYYY'))")) {
          $tri = false;
        }
  ...
  if( strtolower($pessoal_[0]["r01_progr"]) == "s"){
    ...
    global $progress;
    if( db_selectmaxlinha(117, "progress", "select * from progress ".bb_condicaosubpes( "r24_" ).$condicaoaux )){
      $F014 = 0;
      $F015 = 0;
...
function carrega_r9xx($area, $sigla, $sigla2, $nro_do_registro,$opcao_tipo) {
  ...
  if($db_debug == true){
    echo "[carrega_r9xx] INICIANDO PROCESSAMENTO DA FUNCAO carrega_r9xx() <br>";
  }
  ...
  if($db_debug == true){ echo "[carrega_r9xx] 17 - chamando a funcao calc_rubrica() <br>"; }
  ...
  if (!db_empty($r14_valor)  ) {
// paulo aqui
	  if($area == "pontofr" && $r14_valor < 0 ){
             $r07_valor = $r07_valor * -1;
	     $r14_valor = $r14_valor * -1;
	  }
	  // paulo atÈ aqui
    $r20_rubr = "R988";
    $r14_quant = 0;
    ...
    if ($db_debug == true) {
      echo "[carrega_r9xx] 1 - Chamando a funcao grava_gerf() <br>";
    }
    grava_gerf($area);
  }
  ...
  if($db_debug == true){ echo "[carrega_r9xx] 18 - chamando a funcao calc_rubrica() <br>"; }
  ...
  if (!db_empty($r14_valor)  ) {
    ...
    $r14_quant = 0;
    if ($db_debug == true) {
      echo "[carrega_r9xx] 2 - Chamando a funcao grava_gerf() <br>";
    }
    grava_gerf($area);
  }
  ...
  if($db_debug == true){ echo "[carrega_r9xx] 19 - chamando a funcao calc_rubrica() <br>"; }
  ...
  if (!db_empty($r14_valor)  ) {
    ...
    $r14_quant = 0;
    if ($db_debug == true) {
      echo "[carrega_r9xx] 3 - Chamando a funcao grava_gerf() <br>";
    }
    grava_gerf($area);
  }
  ...
  if ($pessoal[$Ipessoal]["r01_tbprev"] == 0) {
    ...
    if ($n == 3 && (  ( strtolower($cfpess[0]["r11_fersal"]) == "f" && ('t' == $cadferia[0]["r30_paga13"]) ) || 'f' == $cadferia[0]["r30_paga13"])) {
      ...
      if (($F019+$F023) > 0) {
        ...
        global $gerffer;
        if (db_selectmaxlinha(118,"gerffer", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )
          && (  ( $opcao_geral == 1
        ...
        if (db_selectmaxlinha(119,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
          $r14_valor = $gerffer_[0]["r31_valor"];
          if ($db_debug == true) { echo "[carrega_r9xx] 35 - r14_valor = $r14_valor  <br>"; }
          $r14_quant = $gerffer_[0]["r31_quant"];
          $r20_rubr = "R915";
          if ($db_debug == true) {
            echo "[carrega_r9xx] 4 - Chamando a funcao grava_gerf() <br>";
          }
          grava_gerf($area);
        }
        $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"]);
        $condicaoaux .= " and r31_rubric = ".db_sqlformat("R983" );
        if (db_selectmaxlinha(120,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
          $r14_valor = $gerffer_[0]["r31_valor"];
          if ($db_debug == true) { echo "[carrega_r9xx] 36 - r14_valor = $r14_valor  <br>"; }
          $r14_quant = $gerffer_[0]["r31_quant"];
          $r20_rubr = "R983";
          if ($db_debug == true) {
            echo "[carrega_r9xx] 5 - Chamando a funcao grava_gerf() <br>";
          }
          grava_gerf($area);
        }
        $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
        $condicaoaux .= " and r31_rubric = ".db_sqlformat("R979" );
        if (db_selectmaxlinha(121,"gerffer_", "select * from gerffer ".bb_condicaosubpes("r31_" ).$condicaoaux )) {
          $r14_valor = $gerffer_[0]["r31_valor"];
          if ($db_debug == true) { echo "[carrega_r9xx] 37 - r14_valor = $r14_valor  <br>"; }
          $r14_quant = $gerffer_[0]["r31_quant"];
          $r20_rubr = "R979";
          if ($db_debug == true) {
            echo "[carrega_r9xx] 6 - Chamando a funcao grava_gerf() <br>";
          }
          grava_gerf($area);
        }
        ...
        if (( $area == "pontocom" && !db_selectmaxlinha(122,"transacao", "select * from gerfcom ".bb_condicaosubpes("R48_").$condicaoaux48 ) )
          || ($area == "pontofs" && !db_selectmaxlinha(123,"transacao", "select * from gerfsal ".bb_condicaosubpes("R14_" ).$condicaoaux ))) {

          $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
          $condicaoaux .= " and r31_rubric = ".db_sqlformat("R984" );
          global $gerffer_;
          if (db_selectmaxlinha(124,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
            $r14_valor = $gerffer_[0]["r31_valor"];
            if ($db_debug == true) { echo "[carrega_r9xx] 38 - r14_valor = $r14_valor  <br>"; }
            $r14_quant = $gerffer_[0]["r31_quant"];
            $r20_rubr = "R984";
            // R984 --> VLR REF DEPENDENTES P/ IRF
            if ($db_debug == true) { echo "[carrega_r9xx] 7 - Chamando a funcao grava_gerf() <br>"; }
            grava_gerf($area);
          }
        }
        }
    ...
    // R904 % Faps S/ SALRIO DESCONTO -
    // R905 % Faps S/ 13o SALRIO DESCONTO -
    // R906 % Faps S/ FRIAS DESCONTO -
  ...
  if (( ( $db21_codcli != "999999999" && $dias_pagamento > 0 ) || ( ( $db21_codcli == "999999999" )
    ...
    if (( $func_em_ferias == false
      ...
      if($db_debug == true){ echo "[carrega_r9xx] 20 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if (empty($rubrica_vale_802['consultado'])) {
        ...
        $lTemRubrica = db_selectmaxlinha(125,"rubrica_vale", "select * from rhrubricas where rh27_rubric = 'R802' and rh27_instit = $DB_instit" );
      ...
      if (empty($rubrica_vale_R801['consultado'])) {
        ...
        db_selectmaxlinha(125,"rubrica_vale", "select * from rhrubricas where rh27_rubric = 'R801' and rh27_instit = $DB_instit");
      ...
      if ($db21_codcli != "999999999" ||  $area == "pontofs") {
        if ($db_debug == true) { echo "[carrega_r9xx] 8 - Chamando a funcao grava_gerf() <br>"; }
        grava_gerf($area);
      }
      if ($area == "pontofs") {
        ...
        if ($db_debug == true) { echo "[carrega_r9xx] 9 - Chamando a funcao grava_gerf() <br>"; }
        grava_gerf($area);
      }
    }
  }
  ...
  if ($area != "pontof13" && $area != "pontocom") {
      ...
      LogCalculoFolha::write("Valor Base de Salrio Familia..: {$valor_base_sal_familia}");
      ...
      LogCalculoFolha::write("Salrio Maternidade............: {$valor_base_sal_familia}");

      // R917 BASE P/SALARIO FAMILIA , Pesquisando no Salrio.

      if($db_debug == true){ echo "[carrega_r9xx] 21 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if ($area == "pontofs") {
        ...
        if (db_selectmaxlinha(127,"gerfcom_", "select * from gerfcom ".$condicao.$condicaoaux )) {
          ...
          for ($Igerfcom=0; $Igerfcom<count($gerfcom_); $Igerfcom++) {
            ...
            if (db_selectmaxlinha(128,"basesr", "select * from rhbasesreg ".$condicaoaux )) {
              $condicaoaux .= " and rh54_rubric = ".db_sqlformat($gerfcom_[$Igerfcom]["r48_rubric"] );
              if (db_selectmaxlinha(129,"basesr", "select * from rhbasesreg ".$condicaoaux )) {
              ...
              if (db_selectmaxlinha(130,"basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )) {
                $valor_base_sal_familia += $gerfcom_[$Igerfcom]["r48_valor"];
                LogCalculoFolha::write("Somando valores na Complementar: {$gerfcom_[$Igerfcom]["r48_valor"]}");
                LogCalculoFolha::write("Novo Valor Base Sal. Familia...: {$valor_base_sal_familia}");
              }
      ...
      /**
       *  Para acrescentar o valor da licenca maternidade  importante que a rubrica maternidade esteja marcado na base salario familia (B009)
       *  O codigo da rubrica maternidade  indicado no cadastro de manutenao da tabela de Previdencia
       */
      ...
      if (in_array(Afastamento::AFASTADO_LICENCA_GESTANTE, $SituacoesFuncionario) ||
          in_array(Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE, $SituacoesFuncionario)) {
        ...
        if (( db_selectmaxlinha(131,"inssirf_", "select * from inssirf ".bb_condicaosubpes("r33_" ).$condicaoaux )
      ...
      if ( ( $valor_base_sal_familia > 0 && $gerar_salario_familia ) ) {
        ...
        $aMatriculasServidor = "";
        $sqlSalario = "
          SELECT SUM(valor_provento - valor_desconto) AS valor
          FROM
              (SELECT CASE
                          WHEN r14_pd = 1 THEN sum(r14_valor)
                          ELSE 0
                      END AS valor_provento,
                      CASE
                          WHEN r14_pd = 2 THEN sum(r14_valor)
                          ELSE 0
               ...
               GROUP BY r14_pd) AS x;";
        $rsSalario = db_query($sqlSalario);
        $rsComplementar = db_query("
          SELECT SUM(valor_provento - valor_desconto) AS valor
          FROM
              (SELECT CASE
                          WHEN r48_pd = 1 THEN sum(r48_valor)
                          ELSE 0
                      END AS valor_provento,
                      CASE
                          WHEN r48_pd = 2 THEN sum(r48_valor)
                          ELSE 0
                      END AS valor_desconto
               FROM gerfcom
               WHERE r48_rubric IN
      ...
      if ($area == "pontofe") {
        if ($mpsal) {
          ...
          LogCalculoFolha::write(" frias e 'mpsal???' ento zera o valor");
      ...
      if (($pessoal[$Ipessoal]["r01_regime"] == 1
        ...
        // Entra aqui quando o funcionario  Estatutario ou Extra Quadro e esta sendo regido pela Previdencia INSS
        // Poucos so os casos em que esta condio  preenchida, o normal  o regime 1 terem Previdencia diferente
        // da INSS
      ...
      // F019 - Numero de dias a pagar no mes
      if ($db_debug == true) { echo "[carrega_r9xx] 10 - Chamando a funcao grava_gerf() <br>"; }
      grava_gerf($area);
      ...
      if (($pessoal[$Ipessoal]["r01_regime"] == 1
        ...
        if ($db_debug == true) { echo "[carrega_r9xx] 11 - Chamando a funcao grava_gerf() <br>"; }
        grava_gerf($area);
      }
    }
  }
  ...
  if($db_debug == true){ echo "[carrega_r9xx] 22 - chamando a funcao calc_rubrica() <br>"; }
  ...
  if (( ($pessoal[$Ipessoal]["r01_regime"] == 2) || ($pessoal[$Ipessoal]["r01_regime"] == 4)  )
    ...
    if ($dias_pagamento > 0  && (servidorPossuiSituacao($pessoal[$Ipessoal]["r01_regist"], Afastamento::AFASTADO_LICENCA_GESTANTE) ||
                                 servidorPossuiSituacao($pessoal[$Ipessoal]["r01_regist"], Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE))) {
      $r14_valor += $valor_salario_maternidade;
      if ($db_debug == true) { echo "[carrega_r9xx] 58 - r14_valor = $r14_valor  <br>"; }
    }

    if ($db_debug == true) { echo "[carrega_r9xx] 12 - Chamando a funcao grava_gerf() <br>"; }
    grava_gerf($area);
  }
  ...
  if (db_selectmaxlinha(132,"transacao", "select * from ".$chamada_geral_arquivo." ".bb_condicaosubpes($siglag ).$condicaoaux )) {

    if($db_debug == true){ echo "[carrega_r9xx] 23 - chamando a funcao calc_rubrica() <br>"; }
    ...
    if ($db_debug == true) { echo "[carrega_r9xx] 13 - Chamando a funcao grava_gerf() <br>"; }
    grava_gerf($area);
  }
  // Fim do Calculo do valor Referente aos dependentes para IRF -> R984
  if ($db_debug == true) {
    echo "[carrega_r9xx]  FIM DO PROCESSAMENTO DA FUNCAO carrega_r9xx()... <br><br>";
  }
}
...
function calc_rubrica($rubrica, $area0, $sigla, $sigla2, $nro_do_registro, $operacao,$formq=null,$valor_=0,$recursivo=0) {
  ...
  if ($db_debug == true) {
    echo "[calc_rubrica] INICIANDO PROCESSAMENTO DA FUNCAO calc_rubrica <br>";
    echo "[calc_rubrica] regist --> $r110_regist  Calculando uma rubrica $rubrica <br>";
  }
  
  if ( $rubrica == "formq") {

    $rubrica_contem = "+".$formq;
    if ($db_debug == true) { echo "[calc_rubrica] Calculando uma rubrica 12 -> $rubrica_contem <br>"; }
    ...
    $posicao = db_at( $rubrica ,$rubrica_contem );
     ...
     if ($db_debug == true) { echo "[calc_rubrica] rubrica contem - $rubrica_contem <br>"; }
  ...
  if( ($rubrica_contem == "+") || ($rubrica_contem == "-")){
     ...
     if( $area0 == "pontofr" || $area0 == "pontoprovfe"|| $area0 == "pontoprovf13"){
       ...
       if ($db_debug == true) {
         echo "[calc_rubrica] Funo: calc_rubrica -> le_var_bxxx <br>";
  ...
  if ($db_debug == true) {
    echo "[calc_rubrica] FIM DO PROCESSAMENTO DA FUNCAO calc_rubrica <br><br>";
  }
...
function le_var_bxxx($formula=null, $area0=null, $area1=null, $sigla=null, $sigla2=null, $nro_do_registro=0,$rubrica=null) {
  ...
  if ($db_debug == true) {
    echo "[le_var_bxxx] INICIANDO PROCESSAMENTO DA FUNCAO le_var_bxxx...<br>";
  }
  ...
  if ($pos_base > 0 && db_val(substr("#".$formula,$pos_base+1,3)) > 0 ) {
    ...
    while ($pos_base  > 0 && db_val(substr("#".$formula,$pos_base+1,3)) > 0 ) {
      ...
      global $bases;
      db_selectmaxlinha(133,"bases", "select * from bases ".bb_condicaosubpes("r08_").$condicaoaux );

      if($db_debug == true) { echo "[busca bases] select * from bases ".bb_condicaosubpes("r08_").$condicaoaux." <br>"; }
      ...
      if (('t' == $bases[0]["r08_calqua"]) && 'f' == $bases[0]["r08_mesant"] ) {
        ...
        if($db_debug == true) { echo "[busca rubricas no ponto] select * from ".$area0." ".bb_condicaosubpes($sigla."_" ).$condicaoaux." <br>"; }

        if (db_selectmaxlinha(134,"transacao1","select * from ".$area0." ".bb_condicaosubpes($sigla."_" ).$condicaoaux ) ) {
...
//paulo acertos bases
	    ...
	    global $tem_base_rubricareg;
	    global $tem_base_rubricareg_unico;
	    global $tem_base_rubrica;

	    if( isset($tem_base_rubricareg_unico[$r110_regist."-".$base]) ){


		if( isset( $tem_base_rubricareg[$r110_regist."-".$base."-".$campo_rubrica]) ){
		  $achou = true;
		}
	      } else {
                if( isset($tem_base_rubrica[$base."-".$campo_rubrica]) ){
                  $achou = true;
                }
	      }
        ...
        if (db_selectmaxlinha(138,"basesr", "select * from rhbasesreg ".$condicaoaux )) {
          ...
          if (db_selectmaxlinha(139,"basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )) {
        ...
        if ($achou) {
          ...
          global $gerfant;
          $condicaoaux  = " and r14_regist = ".db_sqlformat($r110_regist );
          db_selectmaxlinha(140,"gerfant", "select * from gerfsal ".bb_condicaosubpesanterior("r14_" ).$condicaoaux );
        ...
        $condicaoaux  = " where rh54_base = ".db_sqlformat($base );
        $condicaoaux .= " and rh54_regist = ".db_sqlformat($r110_regist );
        if (db_selectmaxlinha(141,"basesr", "select * from rhbasesreg ".$condicaoaux )) {

          $achou = true;
          $rubric = "rh54_rubric";
        } else {
          $condicaoaux  = "select * from basesr ".bb_condicaosubpes("r09_")." and r09_base = ".db_sqlformat($base );
          if (db_selectmaxlinha(142,"basesr",$condicaoaux )) {
        ...
        if ($achou ) {
          ...
          global $transacao;
          db_selectmaxlinha(143,"transacao", "select * from gerffx ".bb_condicaosubpes("r53_" ).$condicaoaux);
...
// paulo aqui
		...
		if( isset( $tem_base_rubricareg[$r110_regist."-".$base."-".$campo_rubrica]) ){
		  $achou = true;
            ...
            if($db_debug == true) { echo "[if_rubrica] achou $achou campo_rubrica $campo_rubrica rubrica $rubrica  <br>"; }
            ...
            if ($achou && $campo_rubrica != $rubrica) {
              ...
              if ($base == "B004" && ($area0 == "pontofs" || $area0 == "pontocom")) {
                if (( strtolower($cfpess[0]["r11_fersal"]) == "f" && ('t' == $cadferia[0]["r30_paga13"]) && $cadferia[0][$r30_proc] ==  $mes_gozo )) {
                  ...
                  $campo_rubrica == $cfpess[0]["r11_fer13a"] ||      // Rubrica onde  pago um 1/3 s/ abono de frias Pecuniario
                  $campo_rubrica == $cfpess[0]["r11_ferabo"] ||      // Rubrica onde  pago o abono de frias
                  $campo_rubrica == $cfpess[0]["r11_feradi"] ||      // Rubrica onde  pago o adiantamento de frias
                  $campo_rubrica == $cfpess[0]["r11_fadiab"] ||      // Rubrica onde  descontado as frias pagas no ms anterior
                  $campo_rubrica == $cfpess[0]["r11_ferant"] ||      // Rubrica em que ser lanado o abono do ms anterior
              ...
              if ($area0 == "pontofe") {
                ...
                if ('f' ==  $cadferia[0]["r30_paga13"] ) {
                  if ($base == $inssirf_base_ferias) {
                    if ( $tpgto =="a" ) {
                      // As rubricas de Abono no so contabilizados ou no incide Previdncia no Abono
                      continue;
                    }
                  } else if ($base == "B005" ) {
                    ...
                    if ($cadferia[0][$r30_proc] < $subpes && ( $tpgto == "d" )) {
                      // No recalculo (diferena de Frias) as rubricas de Adiantamento no so contabilizados
                      // no incide na Base IRRF
                      //echo "<BR> 3 passou aqui !!";
                      continue;
                    }
                  }
                  ...
                  if ($base == $inssirf_base_ferias) {
                    ...
                    if ( $tpgto == "a" ) {
                      // No entra na Base da Previdncia as Rubricas de Adiantamento de Frias ou Abono
                      //echo "<BR> 4 passou aqui !!";
                      continue;
                    }
                  } else if ($base == "B005" ) {
...
// aqui paulo
		...
		global $transacao, $transacao_paulo;
		$tem_valor_calculado = false;
		if( isset( $transacao_paulo[$r110_regist."-".$campo_rubrica] ) ){
		   $transacao[0]['r14_valor'] = $transacao_paulo[$r110_regist."-".$campo_rubrica];
		   $tem_valor_calculado = true ;
		}else{
		  if (db_selectmaxlinha(147,"transacao","select ".$sigla2."_valor from ".$area1." ".bb_condicaosubpes($sigla2."_" ).$condicaoaux )) {
		//system("echo 'achou 147 --' >> tmp/paul_folha.txt ");	 
	           $transacao_paulo[$r110_regist."-".$campo_rubrica] =  $transacao[0]['r14_valor'];
		   $tem_valor_calculado = true ;
		  }
		}
		if( $tem_valor_calculado == true ){
              ...
              if($db_debug == true) { echo "[le_var_bxxx] 20 - Parte que calculo as rubricas do Ponto se no encontrar calculado nos gerf... <br>"; }
              if (!db_empty($formula1) && $campo_valor == 0) {

                 if($db_debug == true){ echo "[le_var_bxxx] 21 - chamando a funcao calc_rubrica() <br>"; }
                 ...
                 if($valor_ < 0){
                  ...
                  if (!servidorPossuiSituacao($iMatricula, Afastamento::AFASTADO_LICENCA_GESTANTE) ||
                      !servidorPossuiSituacao($iMatricula, Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE) ||
                     (servidorPossuiSituacao($iMatricula, Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE) && $F019 == 0 ) ||
                     (servidorPossuiSituacao($iMatricula, Afastamento::AFASTADO_LICENCA_GESTANTE) && $F019 == 0 )) {

                    /**
                     * No alteramos os valores das bases para servidores que nao estao afastados
                     */
                ...
                if ((strpos("#".$rubrica_contem,"B")+0) == 0) {
                  ...
                  if (!servidorPossuiSituacao($iMatricula, Afastamento::AFASTADO_LICENCA_GESTANTE) ||
                    ...
                    // Achou na Base mas no esta calculado , calcula aqui.
                ...
                if ($db_debug == true) { echo "[le_var_bxxx] 22 - Parte que pega os valores das rubricas do Ponto se no encontrar calculado nos gerf... <br> "; }
  ...
  if($db_debug == true) {
    echo "[le_var_bxxx] FIM DO PROCESSAMENTO DA FUNCAO le_var_bxxx <br>";
  }
  return $formula;
}
...
function le_tbprev($r20_rubr=null, $area=null, $sigla=null, $sigla2=null, $nro_do_registro=null, $operacao=null) {
  ...
  global $anousu, $mesusu, $DB_instit,$vlr_desc_prev_ferias_F,$vlr_desc_prev_ferias_D;
  ...
  $vlr_desc_prev_ferias_D = 0;
  $vlr_base_prev_ferias_F = 0;
  $vlr_desc_prev_ferias_F = 0;

  if($db_debug == true){
    echo "[le_tbprev] INICIO DO PROCESSAMENTO DA FUNCAO le_tbprev... <br>";
  }
  if (db_empty($cadferia[0]["r30_proc2"]) ) {
    $r30_proc = "r30_proc1";
    $r30_peri = "r30_per1i";
  ...
  if ($opcao_geral != 1 && $opcao_geral != 8) {
    $situacao_funcionario = situacao_funcionario($pessoal[$Ipessoal]["r01_regist"] );
    LogCalculoFolha::write("Situao do Funcionario: {$situacao_funcionario}");
  }
  ...
  /**
   * No e-cidade existe a limitao de 4 previdencias
   *
   * Logo:
   *  - R901 %Previdncia 1 - S/SALARIO DESCONTO
   *  - R902 %Previdncia 1 - S/13 SALARIO DESCONTO
   *  - R903 %Previdncia 1 - S/FERIAS DESCONTO
   *
   *  - R904 %Previdencia 2 - S/ SALRIO DESCONTO
   *  - R905 %Previdencia 2 - S/ 13o SALRIO DESCONTO
   *  - R906 %Previdencia 2 - S/ FRIAS DESCONTO
   *
   *  - R907 %Previdncia 3 - S/SALARIO DESCONTO
   *  - R908 %Previdncia 3 - S/13 SALARIO DESCONTO
   *  - R909 %Previdncia 3 - S/FERIAS DESCONTO
   *
   *  - R910 %Previdncia 4 - S/SALARIO DESCONTO
   *  - R911 %Previdncia 4 - S/13 SALARIO DESCONTO
   *  - R912 %Previdncia 4 - S/FERIAS DESCONTO
   *
   * Todas os Descontos so regidos pelas seguintes rubricas do tipo BASE:
   *  - R985 - Base de Previdncia S/ Salrio
   *  - R986 - Base de Previdncia S/ 13 SAlario
   *  - R987 - Base de Previdncia S/ Frias
   */
  if (!db_empty($r11_tbprev ) && $cfpess[0]["r11_tbprev"] == $pessoal[$Ipessoal]["r01_tbprev"]+2 ) {
    ...
    for ($i=1; $i < 4 ; $i++) {
      ...
      if($db_debug == true){ echo "[le_tbprev] 25 - chamando a funcao calc_rubrica() <br>"; }
      ...
      if ($n != 2) {
        ...
        if (($area != "pontof13" && $area != "pontoprovf13") || $cfpess[0]["r11_mes13"] == substr("#".$subpes,6,2)+0 ) {
          ...
          LogCalculoFolha::write("Chamando funcao que calcula o valor da previdencia");
  ...
  for ($n=1; $n < 4; $n++) {
    ...
    if($db_debug == true){ echo "[calc_rubrica] entrando na funcao calc_rubrica() rubrica $r20_rubr <br>"; }
    ...
    /**
     * Quando o servidor tiver mais de um vinculo na instituio
     */
    ...
    $base_prev += $r07_valor;
	    ...
	    if($db_debug == true) { echo "[Sandro] --> TPCont --> {$opcao_geral}   PercInss --> {$perc_inss} <br>"; }
...
// *paulo* aqui
      ...
      if ( (in_array(5, $SituacoesFuncionario) || in_array(9, $SituacoesFuncionario)) && !db_empty($rubrica_maternidade) ) {
...
// *paulo* aqui
    ...
    if ($opcao_geral == 1 && !$naoencontroupontosalario) {
      ...
      if ($n == 1) {
        ...
        if (db_selectmaxlinha(148,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("R48_" ).$condicaoaux )) {
      ...
      if ($n == 2) {
        ...
        if (db_selectmaxlinha(149,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("R48_" ).$condicaoaux )) {
          $base_folha_complementar = $gerfcom_[0]["r48_valor"];
          $base_crubr = "R954";
      ...
      if ($n == 3) {
        ...
        if (db_selectmaxlinha(150,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
          $base_folha_complementar = $gerfcom_[0]["r48_valor"];
          $base_crubr = "R955";
          // Base Prev. Ferias
        }
      ...
      if (!db_empty($base_folha_complementar)) {
        ...
        if ($db_debug == true) {
          echo "[le_tbprev] 15 - Chamando a funcao grava_gerf() <br>";
    ...
    if ($opcao_geral == 1 ) {
      if ($n == 1) {
        ...
        if (db_selectmaxlinha(151,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("R48_" ).$condicaoaux )) {
        ...
        if (db_selectmaxlinha(152,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("R48_" ).$condicaoaux )) {
          $r14_valor -= $gerfcom_[0]["r48_valor"];
        ...
        if (db_selectmaxlinha(153,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("R48_" ).$condicaoaux )) {
          $r14_valor -= $gerfcom_[0]["r48_valor"];
    ...
    if( $area == "pontofs" || $area == "pontocom" || $area == "pontofe" ){
      ...
      if ( $n == 1 ){
        ...
        if ($db_debug == true) { echo "<BR> 1 - Valor da complementar r31_valor = $r31_valor <br>"; }
        ...
        if ($db_debug == true) { echo "<BR> 1 gravando na Rubrica $r20_rubr --> $r14_valor -= $r31_valor <br>"; }
        $r14_valor -= $r31_valor;
        if ($db_debug == true) { echo "[le_tbprev] 72 - r14_valor = $r14_valor  r31_valor = $r31_valor<br>"; }
        $desc_prev -= $r31_valor;
        if ($db_debug == true) { echo "<BR> 2 gravando na Rubrica $r20_rubr --> $r14_valor -= $r31_valor <br>"; }
        ...
        if ( $F023 != 0 ){
          ...
          if ($db_debug == true) { echo "[le_tbprev] 17 - Chamando a funcao grava_gerf() <br>"; }
          grava_gerf($area,"D");
        }
        ...
        if ( $F019 != 0 ){
         ...
         if ( $F023 != 0 ){
            if ($db_debug == true) { echo "<BR> 1 - gravando na Rubrica $r20_rubr --> $r14_valor = $r14_valor_diferenca - $r14_valor_r906  tipo --> F matricula $r110_regist <br>"; }
            $r14_quant  = $r14_quant_diferenca ;
            if ($db_debug == true) { echo "<BR> 2 - gravando na Rubrica $r20_rubr --> $r14_valor = $r14_valor_diferenca - $r14_valor_r906  tipo --> F matricula $r110_regist <br>"; }
        ...
        if ($db_debug == true) { echo "[le_tbprev] 19 - Chamando a funcao grava_gerf() <br>"; }
        grava_gerf($area);

      }
    }else{

      if ($db_debug == true) { echo "[le_tbprev] 20 - Chamando a funcao grava_gerf() <br>"; }
      grava_gerf($area);
    ...
    if ($db21_codcli != "999999999" ) {
      ...
      if ($n == 3 && strtolower($cfpess[0]["r11_fersal"]) == "f" ) {
        ...
        if (($F019+$F023) > 0) {
          ...
          global $gerffer;
          if(db_selectmaxlinha(154,"gerffer", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )
            &&
            (
              (   't' == $cadferia[0]["r30_paga13"]
              &&
          ...
          $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
          $condicaoaux .= " and r31_rubric = ".db_sqlformat("R915" );
          if (db_selectmaxlinha(155,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
            $r14_valor = $gerffer_[0]["r31_valor"];
            if ($db_debug == true) { echo "[le_tbprev] 75 - r14_valor = $r14_valor  <br>"; }
            $r14_quant = $gerffer_[0]["r31_quant"];
            $r20_rubr = "R915";

            if ($db_debug == true) { echo "[le_tbprev] 21 - Chamando a funcao grava_gerf() <br>"; }
            grava_gerf($area);
          }
          $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"]);
          $condicaoaux .= " and r31_rubric = ".db_sqlformat("R983" );
          if (db_selectmaxlinha(156,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
            $r14_valor = $gerffer_[0]["r31_valor"];
            if ($db_debug == true) { echo "[le_tbprev] 76 - r14_valor = $r14_valor  <br>"; }
            $r14_quant = $gerffer_[0]["r31_quant"];
            $r20_rubr = "R983";

            if ($db_debug == true) { echo "[le_tbprev] 22 - Chamando a funcao grava_gerf() <br>"; }
            grava_gerf($area);
          }
          $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
          $condicaoaux .= " and r31_rubric = ".db_sqlformat("R979" );
          if (db_selectmaxlinha(157,"gerffer_", "select * from gerffer ".bb_condicaosubpes("r31_" ).$condicaoaux )) {
            $r14_valor = $gerffer_[0]["r31_valor"];
            if ($db_debug == true) { echo "[le_tbprev] 77 - r14_valor = $r14_valor  <br>"; }
            $r14_quant = $gerffer_[0]["r31_quant"];
            $r20_rubr = "R979";

            if ($db_debug == true) { echo "[le_tbprev] 23 - Chamando a funcao grava_gerf() <br>"; }
            grava_gerf($area);
          }
          ...
          $condicaoaux48                   = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
          $condicaoaux48                  .= " and r48_rubric = ".db_sqlformat("R984" );
          if (( $area == "pontocom" && !db_selectmaxlinha(158,"transacao", "select * from gerfcom ".bb_condicaosubpes("R48_").$condicaoaux48 ) )
            || ($area == "pontofs" && !db_selectmaxlinha(159,"transacao", "select * from gerfsal ".bb_condicaosubpes("R14_" ).$condicaoaux ))) {

            $condicaoaux  = " and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
            $condicaoaux .= " and r31_rubric = ".db_sqlformat("R984" );
            global $gerffer_;
            if (db_selectmaxlinha(160,"gerffer_", "select * from gerffer ".bb_condicaosubpes("R31_" ).$condicaoaux )) {
              $r14_valor = $gerffer_[0]["r31_valor"];
              ...
              if ($db_debug == true) { echo "[le_tbprev] 24 - Chamando a funcao grava_gerf() <br>"; }
              grava_gerf($area);
            }
          }
          }
  ...
  if($db_debug == true){
    echo "[le_tbprev] chamando a funcao grava_base_prev($area)... <br>";
  }
  grava_base_prev($area);

  if($db_debug == true){
    echo "[le_tbprev] FIM DO PROCESSAMENTO DA FUNCAO le_tbprev... <br>";
  }
...
function rle_var_bxxx ($formula=null, $area0=null, $area1=null, $sigla=null, $sigla2=null, $nro_do_registro=null,$rubrica=null){
  ...
  global $anousu, $mesusu, $DB_instit;
  global $F001, $F002, $F004, $F005, $F006, $F007, $F008, $F009, $F010, $F011, $F012, $F013, $F014, $F015, $F016, $F017, $F018, $F019, $F020, $F021, $F022, $F023, $F006_clt, $F024, $F003, $F025, $F026, $F027, $F028, $F030;
  ...
  LogCalculoFolha::write("------------------------------------Parmetros da funcao-----------------------------------");
  ...
  LogCalculoFolha::write("-----------------------------------Parmetros da Rescisao----------------------------------");
  ...
  if( $pos_base > 0 && db_val(substr("#".$formula,$pos_base+1,3)) > 0 ){
    ...
    $base_mae = substr("#".$formula,$pos_base,4);
    LogCalculoFolha::write("Base me.......: $base_mae");
    ...
    while( $pos_base  > 0 && db_val(substr("#".$formula,$pos_base+1,3)) > 0 ){
      ...
      $condicaoaux  = " and r08_codigo = ".db_sqlformat( $base );
      db_selectmaxlinha(161, "bases", "select * from bases ".bb_condicaosubpes("R08_").$condicaoaux );
      $abre_base     = "(0";
      $n1            = 0;
      $valor         = 0;
      $monta_formula = "(0";
      ...
      if( ( $rubrica == "R987" && ('f' == $rescisao[0]["r59_finss"]))    // Incide Ferias Previdencia
        ...
        if ( ('t' == $bases[0]["r08_calqua"]) && 'f' == $bases[0]["r08_mesant"] ) {
          ...
          LogCalculoFolha::write("Mes Anteiror...............: NO");
          ...
          $condicaoaux .= " order by ".$sigla."_regist, ".$sigla."_rubric ";
          global $transacao1;
          db_selectmaxlinha(162, "transacao1", "select * from ".$area0." ".bb_condicaosubpes( $sigla."_" ).$condicaoaux );
          ...
          for($i=0;$i<count($transacao1);$i++){
            ...
            $condicaoaux  = " where rh54_base = ".db_sqlformat( $base );
            $condicaoaux .= " and rh54_regist = ".db_sqlformat( $r110_regist );
            if( db_selectmaxlinha(163, "basesr", "select * from rhbasesreg ".$condicaoaux )){
              $condicaoaux .= " and rh54_rubric = ".db_sqlformat( $campo_rubrica );
              if( db_selectmaxlinha(164, "basesr", "select * from rhbasesreg ".$condicaoaux )){
                $achou = true;
              }
            }else{
              $condicaoaux  = " and r09_base = ".db_sqlformat( $base );
              $condicaoaux .= " and r09_rubric = ".db_sqlformat( $campo_rubrica );
              if( db_selectmaxlinha(165, "basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )){
                $achou = true;
              }
            }
            if($achou){
          ...
          $condicaoaux  = " where rh54_base = ".db_sqlformat( $base );
          $condicaoaux .= " and rh54_regist = ".db_sqlformat( $r110_regist );
          if( db_selectmaxlinha(166, "basesr", "select * from rhbasesreg ".$condicaoaux )){
            $achou = true;
            $rubric = "rh54_rubric";
            //     echo "<BR> base rhbasesreg 4 --> $condicaoaux";
          }else{
            $condicaoaux  = " and r09_base = ".db_sqlformat( $base );
            if( db_selectmaxlinha(167, "basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )){
              $achou = true;
              $rubric = "r09_rubric";
          ...
          if($achou){
            ...
            for($i=0;$i<count($basesr);$i++){
              if( !db_empty($basesr[$i][$rubric])){
                ...
                if( db_selectmaxlinha(168, "gerfant", "select * from gerfsal ".bb_condicaosubpesanterior( "r14_" ).$condicaoaux )){
          ...
          $condicaoaux  = " where rh54_base = ".db_sqlformat( $base );
          $condicaoaux .= " and rh54_regist = ".db_sqlformat( $r110_regist );
          if( db_selectmaxlinha(169, "basesr", "select * from rhbasesreg ".$condicaoaux )){
            $achou = true;
            $rubric = "rh54_rubric";
            //     echo "<BR> base rhbasesreg 1--> $condicaoaux";
          }else{
            $condicaoaux  = " and r09_base = ".db_sqlformat( $base );
            if( db_selectmaxlinha(170, "basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )){
              $achou = true;
              $rubric = "r09_rubric";
          ...
          if($achou){
            for($i=0;$i<count($basesr);$i++){
              if( !db_empty($basesr[$i][$rubric])){
                ...
                global $transacao2;
                if( db_selectmaxlinha(171, "transacao2", "select * from gerffx ".bb_condicaosubpes( "r53_" ).$condicaoaux )){
          ...
          for ($i = 0; $i < $iTotalLinhasArea0; $i++) {
            ...
            LogCalculoFolha::write("Rubrica $campo_rubrica ignorado pela condio das bases.");
            continue;
            }
            ...
            if( db_at($base, "B007-B077") > 0
              ...
              || $campo_rubrica == "R931"
              || $campo_rubrica == "R932" ) ) )
              || ($campo_rubrica == "R931"  && $base == "B004"  && $area0 == "pontofr" &&  $rescisao[0]["r59_firrf"] == 'f')
            ...
            if( db_selectmaxlinha(172, "basesr", "select * from rhbasesreg ".$condicaoaux )){

              $condicaoaux .= " and rh54_rubric = ".db_sqlformat( $campo_rubrica );

              if( db_selectmaxlinha(173, "basesr", "select * from rhbasesreg ".$condicaoaux )){
                $achou = true;
              }
            }else{
              ...
              if( db_selectmaxlinha(174, "basesr", "select * from basesr ".bb_condicaosubpes("r09_").$condicaoaux )){
                $achou = true;
              }
            }
            ...
            if($achou){
              ...
              // r01_propi --> Perc.Inativo
                ...
                global $transacao;
                if( db_selectmaxlinha(180, "transacao", "select * from ".$area1." ".bb_condicaosubpes( $sigla2."_" ).$condicaoaux )){
                ...
                if( (strpos("#".$rubrica_contem,"A")+0) == 0 && (strpos("#".$rubrica_contem,"B")+0) == 0 && (strpos("#".$rubrica_contem,"P")+0) == 0 ){
                  ...
                  if( ( $base_na_rubrica != $base) && ( $base_na_rubrica != $base_mae)){
                    ...
                    if( db_empty($campo_quant)){
                      ...
                      if( $campo_pd == "1"){
                        $abre_base .= $rubrica_contem;
                        LogCalculoFolha::write("Adicionado a Frmula da Base '$base' a Rubrica '$campo_rubrica': + $rubrica_contem");
                      }else{
                        $abre_base .= "-".$rubrica_contem;
                        LogCalculoFolha::write("Adicionado a Frmula da Base '$base' a Rubrica '$campo_rubrica': - $rubrica_contem");
                      }
                      ...
                      if ( $campo_pd == "1" ) {
                        ...
                        LogCalculoFolha::write("Adicionado a Frmula da Base '$base' a Rubrica '$campo_rubrica':".'+('.$formula1.'*'.db_strtran(db_str($campo_quant,7,2),",",".").')');
                      } else {
                        $abre_base .= '-('.$formula1.'*'.db_strtran(db_str($campo_quant,7,2),",",".").')' ;
                        LogCalculoFolha::write("Adicionado a Frmula a Formula da rubrica '$campo_rubrica'Base '$base' a :".'-('.$formula1.'*'.db_strtran(db_str($campo_quant,7,2),",",".").')');
                      }
                    }
                  }else{
                    $n1 = 1;
                  ...
                  if ( db_empty($campo_quant) ) {
                    ...
                    if( $campo_pd == "1"){
                      ...
                      LogCalculoFolha::write("Modificando montagem de frmula: $monta_formula");
                    }else{
                      $monta_formula .= "-". $rubrica_contem;
                      LogCalculoFolha::write("Modificando montagem de frmula: $monta_formula");
                    }
      ...
      LogCalculoFolha::write("Frmula Geral Antes.....................: $formula");
      ...
      LogCalculoFolha::write("Frmula da Base.........................: $abre_base");
      LogCalculoFolha::write("Frmula Geral ..........................: $formula");

      if( $n1 == 1){
        $formula = db_strtran($formula,$base,$monta_formula);
        LogCalculoFolha::write("Frmula...............................: $formula");
      }

      $pos_base = strpos("#".$formula,"B")+0;
    }
  }
  LogCalculoFolha::write("Fim do Parse da Frmula, resultado......: $formula");
  return $formula;
}
...
function teto_prev_inativo($r07_valor, $tbprev){
  ...
  if( db_selectmaxlinha(181, "inssirf_", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux )){
...
function grava_base_prev($area_grava) {
  ...
  $servidor = ServidorRepository::getInstanciaByCodigo($pessoal[$Ipessoal]["r01_regist"]);
...
// aqui *paulo*
  ...
  if (( ($area_grava != "pontof13" && $area_grava != "pontoprovf13") || !( $area_grava == "pontof13" && $cfpess[0]["r11_mes13"] != $mesusu)) ) {
    ...
    if ($db_debug == true) { echo "[grava_base_prev] 25 - Chamando a funcao grava_gerf() <br>"; }
    grava_gerf($area_grava);
  }
  if (in_array(5, $SituacoesFuncionario) || in_array(9, $SituacoesFuncionario)) {

      $r14_valor = $base_prev;
      if ($db_debug == true) {
          echo "[grava_base_prev] 83 - r14_valor = $r14_valor  <br>";
      }
      if (!db_empty($rubrica_maternidade)) {
          if ($dias_pagamento > 0) {
              ...
              $r14_valor += $valor_salario_maternidade;
              if ($db_debug == true) {
                  echo "[grava_base_prev] 84 - r14_valor = $r14_valor  <br>";
              }
          }
      }
      if ($servidor->getTabelaPrevidencia() == 1) {
          if (db_empty($rubrica_maternidade) || (!db_empty($rubrica_maternidade) && $dias_pagamento == 0)) {
              $r20_rubr = "R990";
              // R990 BASE PREVID.PATRONAL (21%INSS)

              if ($db_debug == true) {
                  echo "[grava_base_prev] 26 - Chamando a funcao grava_gerf() <br>";
              }
              grava_gerf($area_grava);
          }
      }
  ...
  if (empty($teto_prev)) {
    ...
    db_selectmaxlinha(182,"teto_prev", "select r33_fim as ultima_faixa from inssirf ".bb_condicaosubpes("r33_" ).$condicaoaux );
  ...
  if (db_selectmaxlinha(183,"transacao1", "select sum(".$siglag."valor) as descontod from ".$chamada_geral_arquivo." ".bb_condicaosubpes($siglag).$condicaoaux )) {
  ...
  if ($db_debug == true) {
    echo "[grava_base_prev] FIM DO PROCESSAMENTO DA FUNCAO grava_base_prev <BR><BR>";
  }
}
...
function gravb_base_irf ($area_grava,$r20_rubrp){
  ...
  if ($db_debug == true) {
    echo "[gravb_base_irf] INICIANDO PROCESSAMENTO DA FUNCAO gravb_base_irf<BR>";
  }
  ...
  if( $r20_rubr  == "R981" || $r20_rubr  == "R982" || $r20_rubr  == "R983"){
    ...
    if($r20_rubr == "R981"){
      if (in_array(Afastamento::AFASTADO_LICENCA_GESTANTE, $aSituacoesFuncionario) ||
          in_array(Afastamento::AFASTADO_PRORROGACAO_MATERNIDADE, $aSituacoesFuncionario)) {
        if( !db_empty( $rubrica_maternidade ) ){
		if( $dias_pagamento > 0){

//aqui paulo - erro no calculo da base irrrf
      ...
      if ($dias_pagamento == 0 && $vlr_sal_saude_ou_acidente > 0) {
          $r14_valor = 0;
          $base_irfb = 0;
      }
    ...
    if( round($r14_valor,2) > 0.00){
      ...
      if ($db_debug == true) {
        echo "[gravb_base_irf] 29 - Chamando a funcao grava_gerf() <br>";
      }
      ...
      /**
       * Realiza o lanamento do valor de molstia grave, apenas para os servidores com o vinculo ATIVO ou PENSIONISTAS.
       */
  ...
  if( !db_empty($base_folha_complementar)){
    ...
    if( !$naoencontroupontosalario){
      if ($db_debug == true) { echo "[gravb_base_irf] 30 - Chamando a funcao grava_gerf() <br>"; }
      grava_gerf($area_grava);
    }
    $r20_rubr = $r20_rubrc;
  }
  ...
  if ($db_debug == true) {
    echo "[gravb_base_irf] FIM DO PROCESSAMENTO DA FUNCAO gravb_base_irf<BR><BR>";
  }
}
...
function grava_gerf($area_grava,$grava_tpp=" ") {
  ...
  if (in_array($oRubrica->getTipo(), Rubrica::TIPO_BASES) && $r14_valor == 0) {
  ...
  if ($r14_valor > 0.01 || $lPermiteInclusaoZerada ) {
    ...
    if ($nro <= 16) {
      ...
      if($area_grava == "pontofs" && $r20_rubr == ("R9".db_str(( (3*$pessoal[$Ipessoal]["r01_tbprev"])-2)-1+$n ,2,0,"0"))){
        ...
        if(db_selectmaxlinha(184,"pessoal__", "select rh02_regist as r01_regist from rhpessoalmov
          inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
          inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
          left join rhpesrescisao on rhpesrescisao.rh05_seqpes = rhpessoalmov.rh02_seqpes
          ".bb_condicaosubpes("rh02_" ).$condicaoaux )){
          if(count($pessoal__) > 0 ){
    ...
    global $rubr_;
    db_selectmaxlinha(185,"rubr_", "select * from rhrubricas ".$condicaoaux );
    $r14_pd = $rubr_[0]["rh27_pd"];

    if ($area_grava == "pontofs") {
      if ($db_debug == true) { echo "[grava_gerf] 93.1 - situacao_funcionario = $situacao_funcionario   <br>"; }
      ...
      if ($db_debug == true) { echo "[grava_gerf] 93.2 - situacao_funcionario = $situacao_funcionario   <br>"; }
      if (( (!db_empty($dias_pagamento) || $dias_pagamento > 0 ) || $r20_rubr == "R991" || $r20_rubr == "R985" || $r20_rubr == "R992"  )
        || $situacao_funcionario == 5 // Afastado Licenca Gestante
        || $situacao_funcionario == 9 // Afastado Prorrogacao Licenca Gestante
        ...
        if ($db_debug == true) { echo "[grava_gerf] 93.3 - situacao_funcionario = $situacao_funcionario   <br>"; }
        //echo "<BR> Afastado Acidente de Trabalho + 15 Dias";
        $condicaoaux  = " and r14_regist = ".db_sqlformat($r110_regist );
        $condicaoaux .= " and r14_rubric = ".db_sqlformat($r20_rubr );
        if (!db_selectmaxlinha(186,"transacao", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
          $acao = "insere";
        } else {
          $acao = "altera";
        }
        ...
        if ($acao=="insere") {
          ...
          LogCalculoFolha::write();
          db_insertlinha(30,"gerfsal", $matriz1, $matriz2 );
        } else {
          db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_").$condicaoaux );
        }
      }
      ...
      if (!db_selectmaxlinha(187,"transacao", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $acao = "insere";
      } else {
        $acao = "altera";
      }
      ...
      if ($acao=="insere") {
        $retornar = db_insertlinha(31,"gerfcom", $matriz1, $matriz2 );
      } else {
      ...
      if (!db_selectmaxlinha(188,"transacao", "select * from gerfres ".bb_condicaosubpes("r20_" ).$condicaoaux )) {
        $matriz2[4] = round($r14_valor,2);
        db_insertlinha(32,"gerfres", $matriz1, $matriz2 );
      } else {
      ...
      if (!db_selectmaxlinha(189,"transacao", "select * from gerffer ".bb_condicaosubpes("r31_" ).$condicaoaux )) {
        $matriz2[4] = round($r14_valor,2);
        $retornar = db_insertlinha(33,"gerffer", $matriz1, $matriz2 );
    } else {
      ...
      if (!db_selectmaxlinha(190,"transacao", "select * from gerfprovfer ".bb_condicaosubpes("r93_" ).$condicaoaux )) {
        $matriz2[4] = round($r14_valor,2);
        $retornar = db_insertlinha(34,"gerfprovfer", $matriz1, $matriz2 );
      } else {
      ...
      if (!db_selectmaxlinha(191,"transacao", "select * from gerfs13 ".bb_condicaosubpes("r35_" ).$condicaoaux )) {
        $matriz2[4] = round($r14_valor,2);
        $retornar = db_insertlinha(35,"gerfs13", $matriz1, $matriz2 );
      } else {
      ...
      if (!db_selectmaxlinha(200,"transacao", "select * from gerfprovs13 ".bb_condicaosubpes("r94_" ).$condicaoaux )) {
        $matriz2[4] = round($r14_valor,2);
        $retornar = db_insertlinha(36,"gerfprovs13", $matriz1, $matriz2 );
      } else {
  ...
  if ($db_debug == true) {
    echo "[grava_gerf] FIM DO PROCESSAMENTO DA FUNCAO grava_gerf<BR><BR>";
  }
}
...
function calculos_especificos($r110_regist,$r110_lotac){
  ...
  if( $db21_codcli == "15"){
    ...
    if( $opcao_geral == 1){
      ...
      if( db_selectmaxlinha(201, "transacao", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
      ...
      if( db_selectmaxlinha(202, "transacao", "select * from gerfcom ".bb_condicaosubpes( "r48_" ).$condicaoaux )){
        for($xy=0;$xy<count($transacao);$xy++){
  ...
  if(!db_empty($varifica_tamanho)){
    for($Ii=0;$Ii < strlen($varifica_tamanho) ;$Ii+=4){
      ...
      if( $calcula_xvalor){
        ...
        if( db_selectmaxlinha(203, "pontofs_", "select * from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )){
          ...
          if( !db_empty($rub)){
            ...
            if( $xvalor_espec > 0){
              ...
              if( !db_selectmaxlinha(204, "transacao", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
                if(  $xvalor_espec > 0){
                  $matriz2[1] = $r110_regist;
                  $matriz2[2] = $rub;
                  $matriz2[3] = $r110_lotac;
                  ...
                  db_insertlinha(40, "gerfsal", $matriz1, $matriz2 );
                }
              }else{
                if( $valor_liquido > 0){
                  $matriz2[1] = $r110_regist;
  ...
  if ($db_debug == true) {
    echo "[calculos_especificos] FIM DO PROCESSAMENTO DA FUNCAO <BR><BR>";
  }
}
...
function calculos_especificos_4($opcao_geral) {
  ...
  if ($db_debug == true) {
    echo "[calculos_especificos_4] INICIO DO PROCESSAMENTO DA FUNCAO... <br><br> ";
  }

  if( $calcula_valor_1602 ){
    $condicaoaux  = " and r10_regist = ".db_sqlformat( $r110_regist );
    $condicaoaux .= " and r10_rubric = '1602'";
    if( db_selectmaxlinha(205, "pontofs_", "select * from pontofs ".bb_condicaosubpes( "r10_" ).$condicaoaux )){
      ...
      if( !db_empty($tem_1602)){
        ...
        if( !db_empty($valor_compara)){
          ...
          if( $valor_liquido > 0 ){
            ...
            if( !db_selectmaxlinha(206, "transacao", "select * from gerfsal ".bb_condicaosubpes( "r14_" ).$condicaoaux )){
              if(  $valor_liquido > 0){
                $matriz2[1] = $r110_regist;
                $matriz2[2] = "1602";
                $matriz2[3] = $r110_lotac;
                ...
                $retornar = db_insertlinha(41, "gerfsal", $matriz1, $matriz2 );
  ...
  if ($db_debug == true) {
    echo "[calculos_especificos_4] FIM DO PROCESSAMENTO DA FUNCAO... <br><br> ";
  }
...
function calcula_r928 ($r110_regist,$r110_lotac,$opcao_geral) {
  ...
  if ($db_debug == true) {
    ...
    LogCalculoFolha::write("[calcula_r928] INICIO DO PROCESSAMENTO DA FUNCAO calcula_r928... ");
  ...
  $sSqlDadosProvento  = "select round(sum(case when r14_pd = 1 then r14_valor end),2) as tot_prov,";
  $sSqlDadosProvento .= "       round(sum(case when r14_pd = 2 then r14_valor end),2) as tot_desc";
  ...
  if (!db_empty($tot_prov) || !db_empty($tot_desc)) {
    ...
    if ($tot_prov > $tot_desc) {
      ...
      $tot_liq   = $tot_prov + $salfamilia - $tot_desc;
      if ($db_debug == true) {
        LogCalculoFolha::write("Total Liquido: $tot_liq Critrio:".$cfpess[0]["r11_arredn"]);
      }
      $arredn   = arredonda_100($tot_liq, $cfpess[0]["r11_arredn"]);
      $tot_liq += $arredn;
      if ($db_debug == true) {
    ...
    if ($arredn > 0 ) {
      ...
      if ($opcao_geral == 1) {
        ...
        $condicaoaux .= " and r14_rubric = 'R928'";
          ...
          if ($db_debug == true) {
	    LogCalculoFolha::write("[calcula_r928] 11 - Insert: Gerfsal<br>");
            LogCalculoFolha::write( "[calcula_r928] Dados: <br>");
            LogCalculoFolha::write( "[calcula_r928] r14_regist: ".$matriz2[1]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_rubric:".$matriz2[2]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_lotac:".$matriz2[3]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_valor:".$matriz2[4]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_quant:".$matriz2[5]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_pd:".$matriz2[6]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_semest:".$matriz2[7]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_anousu:".$matriz2[8]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_mesusu:".$matriz2[9]."<br>");
            LogCalculoFolha::write( "[calcula_r928] r14_instit:".$matriz2[10]);
            LogCalculoFolha::write( "<br>");
	  }
	
        if (db_selectmaxlinha(207,"transacao", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
          db_update("gerfsal", $matriz1, $matriz2, bb_condicaosubpes("r14_" ).$condicaoaux );
        } else {
	    ...
	    LogCalculoFolha::write("[calcula_r928] 11 - Insert: Gerfsal<br>");
          ...
          db_insertlinha(42,"gerfsal", $matriz1, $matriz2 );
        }
      } else {
        ...
        $matriz2[9] = $mesusu;
        $matriz2[10] = $DB_instit;
        $retornar = db_insertlinha(43, "gerfcom", $matriz1, $matriz2 );
      }
    }
  }
  if ($db_debug == true) {
    echo "[calcula_r928] FIM DO PROCESSAMENTO DA FUNCAO calcula_r928... <br>";
  }
}
...
function dependentes($registro){
  ...
  if(!db_selectmaxlinha(208,"depend", "select rh31_depend as r03_depend, rh31_irf as r03_irf,rh31_dtnasc as r03_dtnasc from rhdepend ".$condicaoaux )){
...
function vale_transp($registro, $admissao){
  ...
  db_selectmaxlinha(209, "vtffunc", "select * from vtffunc ".bb_condicaosubpes("r17_").$condicaoaux );
  $iTotalvtffunc = 0;
  if (!empty($vtffunc) && is_array($vtffunc)) {
      $iTotalvtffunc = count($vtffunc);
  }
  for($Ivt = 0; $Ivt < $iTotalvtffunc; $Ivt++) {

    $condicaoaux = " and r16_codigo = ".db_sqlformat( $vtffunc[$Ivt]["r17_codigo"] );
    if (db_selectmaxlinha(210, "vtfempr", "select * from vtfempr ".bb_condicaosubpes("r16_").$condicaoaux)) {
      if( strtolower($vtffunc[$Ivt]["r17_situac"]) == "a"){
        ...
        if( ('t' == $cfpess[0]["r11_vtprop"]) && !('t' ==  $vtffunc[$Ivt]["r17_tipo"] )){
          ...
          if( db_selectmaxlinha(211, "transacao1",$sqlaux )){
          ...
          if( db_selectmaxlinha(212, "transacao1",$sqlaux )){
            $quantvale = $transacao1[0]["total"];
          }
          ...
          if( ('t' == $cfpess[0]["r11_vtmpro"]) && ('t' ==  $vtffunc[$Ivt]["r17_tipo"] )){
            ...
            /**
             * @todo  soluo paliativa, pois em algum momento a varivel $quantvale
             * estava retornando null e no o valor 0, ocasionando erro na query
             */
            if ( empty($quantvale)) {
              $iQuantidadeVale = 0;
            }
            ...
            if( db_selectmaxlinha(213, "transacao1",$sqlaux )){
              $quantvale = $transacao1[0]["total"];
            }
          }
        }
...
function calc_tabprev ($base_inss=null,$codigo=null, $tpcont=null)
{
    ...
    if (empty($inssirf)) {
        ...
        if (!db_selectmaxlinha(214,"inssirf", $sSqlDadosPrevidencia)) {
            LogCalculoFolha::write("Valor das Faixas no encontrado na competencia");
    ...
    for( $Iinssirf = 0; $Iinssirf < $iTotalLinhas; $Iinssirf++ ) {
        ...
        if ($base_inss >= $oDadosPrevidencia->r33_inic && $base_inss <= $oDadosPrevidencia->r33_fim) {
            ...
            $calculo = CalculoFolha::geraDescontoInss($base_inss, $inssirf);
            LogCalculoFolha::write("Valor Calculado : $calculo");
            return $calculo;
        }
    }//Fim do For
    ...
    LogCalculoFolha::write("Valor Calculado : $calculo    Tipo de Contrato $tpcont    Percentual de desconto $perc_inss ");
    return $calculo;
}
...
function teto_tabprev ($base_inss=null,$codigo=null, $tpcont=null){
  ...
  $condicaoaux = " and r33_codtab = ".db_sqlformat( $codigo )." order by r33_inic";
  global $inssirf;
  if( db_selectmaxlinha(215, "inssirf", "select * from inssirf ".bb_condicaosubpes( "r33_" ).$condicaoaux )){
...
function calc_irf($r20_rubr_=null, $area=null, $sigla=null, $sigla2=null, $nro_do_registro=null, $operacao=null) {
  ...
  global $F001, $F002, $F004, $F005, $F006,
    ...
    $deducaoPrevidencia = 0;
    $deducaoPensao = 0;
    $deducaoPrevidenciaFerias = 0;
    $deducaoComplementar = 0;
    $diferencaDeducao = 0;
  ...
  LogCalculoFolha::write("Chamando a funcao calc_rubrica");
  $r20_rubr  = $r20_rubr_;
  $r20_rubrp = $r20_rubr;
  $r07_valor = calc_rubrica($r20_rubr, $area, $sigla, $sigla2, $nro_do_registro, $operacao);
  ...
  try {
    ...
    LogCalculoFolha::write("Parmetro para tributao do abono (not yet).............: ". ((int)$oParametros->getAbonoPermanenciaTributavel()) ? 'Sim' : 'No');
  ...
  if($r20_rubr == "R915"
    ...
    $condicaoaux .= "  or (extract(year from rh05_recis) >= ".db_sqlformat(substr("#".$subpes,1,4));
    $condicaoaux .= " and  extract(month from rh05_recis) >= ".db_sqlformat(substr("#".$subpes,6,2))."))";
    db_selectmaxlinha(216,"transacao", "select rh02_regist as r01_regist from rhpessoalmov
      inner join rhpessoal    on rhpessoal.rh01_regist       = rhpessoalmov.rh02_regist
      inner join cgm          on cgm.z01_numcgm              = rhpessoal.rh01_numcgm
      left join rhpesrescisao on rhpesrescisao.rh05_seqpes = rhpessoalmov.rh02_seqpes
      ".bb_condicaosubpes("rh02_" ).$condicaoaux );
    ...
    if(count($transacao) < 2){
      ...
      if (db_selectmaxlinha(217,"transacao", "select sum(r31_valor) as descontod from gerffer ".bb_condicaosubpes("r31_" ).$condicaoaux )) {
        /**
         *  Comentado codigo a pedido do Sandro
         *  A R983 - Base de irrf de ferias estava descontando a R903 - INSS S/ F…RIAS
         *  gerando valor da base incorreto no calculo
         * Redmine - 24549
         */
        //$r07_valor -= $transacao[0]["descontod"]  ;
        LogCalculoFolha::write("Modificando valor(Desconto fÈrias mes anterior(R979)(Codigo Comentado!)......: -{$transacao[0]["descontod"]}" );
      }
    }
  }
  ...
  if ($opcao_geral == 1 || $opcao_geral==4) {
    if ($r20_rubr == "R913" ) {
      ...
      // R981 BASE IRF SALARIO (BRUTA)
      if (db_selectmaxlinha(218,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar = $gerfcom_[0]["r48_valor"];
        $condicaoaux  = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
        ...
        if (db_selectmaxlinha(219,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
    ...
    if ($r20_rubr == "R914" ) {
      ...
      // R982 BASE IRF 13O SAL (BRUTA)
      if (db_selectmaxlinha(220,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar = $gerfcom_[0]["r48_valor"];
        $condicaoaux  = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
        $condicaoaux .= " and r48_rubric in ( 'R902','R905','R908','R911')";
        // R902 % Inss S/ 13o SALRIO
        // R905 % Funpas S/13 SALARIO
        // R908 % F Inativos S/13 SALARIO
        // R911 % Previdencia 4 S/13 SALARIO
        if (db_selectmaxlinha(221,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
          $base_desconto_prev_complementar  = $gerfcom_[0]["r48_valor"];
    ...
    if ($r20_rubr == "R915" ) {
      ...
      // R983 BASE IRF FERIAS (BRUTA)
      if (db_selectmaxlinha(222,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar = $gerfcom_[0]["r48_valor"];
        $condicaoaux  = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
        $condicaoaux .= " and r48_rubric in ( 'R903','R906','R909','R912' )";
        // R903 % Inss S/ FRIAS
        ...
        if (db_selectmaxlinha(223,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
          $base_desconto_prev_complementar  = $gerfcom_[0]["r48_valor"];
  ...
  LogCalculoFolha::write("Modificando valor (DiferenÁa Base e Desconto complementar): +" . ($base_folha_complementar - $base_desconto_prev_complementar));
  ...
  if ($r20_rubr=="R915" && ( $opcao_geral == 3 || $opcao_geral == 11 ) && (  ( strtolower($cfpess[0]["r11_fersal"]) == "f"
    ...
    $deducaoDependentes = ($D901*$F005);
    LogCalculoFolha::write("D901 VLR DESC IRF P/DEPENDENTE.......: -{$deducaoDependentes}");
    // $r07_valor -= ($D901*$F005);
  } else {
    // D901 VLR DESC IRF P/DEPENDENTE
    if ($area == 'pontofe' ) {
      // $r07_valor -= ($vlr_desc_prev_ferias_F + ($D901*$F005));
      $deducaoPrevidenciaFerias = ($vlr_desc_prev_ferias_F + ($D901*$F005));
      ...
      $deducaoPrevidencia = ($nValorPrevidencia + ($D901*$F005));
  ...
  if ( $r07_valor > 0 && db_at(strtolower($pessoal[$Ipessoal]["r01_tpvinc"]),"i-p") > 0 && ver_idade($ultdat,db_dtoc($pessoal[$Ipessoal]["r01_nasc"])) >= 65 ) {
    ...
    /**
     * Verifica qual clculo est sendo feito
     */
    $sCalculoTipo = null;
    switch ($area) {
    ...
    /**
     * Valida a varavel de tipo de calculo para obter o clculo correspondente e chamar o mtodo ajustaParcelaIsenta
     */
    ...
    LogCalculoFolha::write('Gravando Valores no Clculo');
    grava_gerf($area);
  ...
  if ($opcao_geral == 4 ) {
    if ($r20_rubr == "R913" ) {
      ...
      $condicaoaux  = " and r20_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
      $condicaoaux .= " and r20_rubric = ".db_sqlformat("R988" );
      // R988 DEDUCOES P/IRRF(SALARIO)
      if (db_selectmaxlinha(224,"gerfcom_", "select * from gerfres ".bb_condicaosubpes("r20_" ).$condicaoaux )) {
        $base_folha_complementar_deducoes = $gerfcom_[0]["r20_valor"];
      }
    }
    ...
    if ($r20_rubr == "R914"  ) {
      ...
      $condicaoaux  = " and r20_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
      $condicaoaux .= " and r20_rubric = ".db_sqlformat("R989" );
      // R989 DEDUCOES P/IRRF(13.SALARIO)
      if (db_selectmaxlinha(225,"gerfcom_", "select * from gerfres ".bb_condicaosubpes("r20_" ).$condicaoaux )) {
    ...
    if ($r20_rubr == "R915" ) {
      ...
      $condicaoaux .= " and r20_rubric = ".db_sqlformat("R988" );
      // R988 DEDUCOES P/IRRF(SALARIO)
      if (db_selectmaxlinha(226,"gerfcom_", "select * from gerfres ".bb_condicaosubpes("r20_" ).$condicaoaux )) {
        $base_folha_complementar_deducoes = $gerfcom_[0]["r48_valor"];
      }
    }
  ...
  if ($opcao_geral == 1 || $opcao_geral == 4 ) {
    ...
    if ($r20_rubr == "R913" ) {
      ...
      // R988 DEDUCOES P/IRRF(SALARIO)
      if (db_selectmaxlinha(227,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar_deducoes = $gerfcom_[0]["r48_valor"];
      }
    }
    ...
    if ($r20_rubr == "R914"  ) {
      ...
      // R989 DEDUCOES P/IRRF(13.SALARIO)
      if (db_selectmaxlinha(228,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar_deducoes = $gerfcom_[0]["r48_valor"];
      }
    }
    ...
    if ($r20_rubr == "R915" ) {
      ...
      $condicaoaux .= " and r48_rubric = ".db_sqlformat("R988" );
      // R988 DEDUCOES P/IRRF(SALARIO)
      if (db_selectmaxlinha(229,"gerfcom_", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_folha_complementar_deducoes = $gerfcom_[0]["r48_valor"];
      }
    }
  }
  ...
  $aSituacoesFuncionario = DBRegistry::get('situacoes_funcionario_'.$pessoal[$Ipessoal]["r01_regist"]);
  LogCalculoFolha::write("Modificando valor (DeduÁıes Complementar)................: -{$base_folha_complementar_deducoes}");

  $deducaoComplementar = $base_folha_complementar_deducoes;
  ...
  if ( $r20_rubr == "R913" || $r20_rubr == "R915" ) {
    ...
    if ($opcao_geral == 1) {
      ...
      $condicaoaux  = " and r14_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
      if (db_selectmaxlinha(230,"transacao", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
        for ($xy=0; $xy<count($transacao); $xy++) {
          if ($transacao[$xy]["r14_rubric"] == "R988") {
            // R988 DEDUCOES P/IRRF(SALARIO)
            // $base_irf  -= $transacao[$xy]["r14_valor"];
            // $r07_valor -= $transacao[$xy]["r14_valor"];
            $totalDeducoesBase += $transacao[$xy]["r14_valor"];
            $deducaoPensao += $transacao[$xy]["r14_valor"];
            LogCalculoFolha::write("Modificando valor (Pensıes AlimentÌcias).................: -{$transacao[$xy]["r14_valor"]}");
            break;
          }
        }
      }
      ...
      // Abatimento da Pensao Alimenticia
      $condicaoaux  = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
      if (db_selectmaxlinha(231,"transacao", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        for ($xy=0; $xy<count($transacao); $xy++) {
          if ($transacao[$xy]["r48_rubric"] == "R988") {
            // R988 DEDUCOES P/IRRF(SALARIO)
            // $base_irf -= $transacao[$xy]["r48_valor"]  ;
            // $r07_valor -= $transacao[$xy]["r48_valor"]  ;
            $totalDeducoesBase += $transacao[$xy]["r48_valor"];
            $deducaoPensao += $transacao[$xy]["r48_valor"];
            LogCalculoFolha::write("Modificando valor (Pensıes AlimentÌcias).................: -{$transacao[$xy]["r48_valor"]}");
            break;
          }
        }
      }
      ...
      if (!empty($vlr_desc_prev_ferias_F)) {
        $totalDeducoesBase += $vlr_desc_prev_ferias_F;
        $deducaoPrevidenciaFerias += $vlr_desc_prev_ferias_F;  
        LogCalculoFolha::write("DEDUCOES P/IRRF (FERIAS) .................: -{$vlr_desc_prev_ferias_F}");
      } else {
        if (!empty($vlr_desc_prev_ferias_D)) {
          $totalDeducoesBase += $vlr_desc_prev_ferias_D;
          $deducaoPrevidenciaFerias += $vlr_desc_prev_ferias_D;
          LogCalculoFolha::write("DEDUCOES P/IRRF (FERIAS) - ADIANTAMENTO .................: -{$vlr_desc_prev_ferias_D}");
        }
      }

      $condicaoaux  = " and r31_rubric = 'R979' and r31_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"]);
      if (db_selectmaxlinha(232,"transacao", "select * from gerffer ".bb_condicaosubpes("r31_" ).$condicaoaux )) {
        // $base_irf -= $transacao[0]["r31_valor"]  ;
        // $r07_valor -= $transacao[0]["r31_valor"]  ;
        $totalDeducoesBase += $transacao[0]["r31_valor"];
        $deducaoPensao += $transacao[0]["r31_valor"];
        LogCalculoFolha::write("Modificando valor (Pensıes AlimentÌcias).................: -{$transacao[0]["r31_valor"]}");
      }
    }

    if ($r20_rubr =="R913") {
      if (   in_array(Afastamento::AFASTADO_ACIDENTE_TRABALHO_MAIS_15_DIAS, $aSituacoesFuncionario)
          || in_array(Afastamento::AFASTADO_DOENCA_MAIS_15_DIAS, $aSituacoesFuncionario)
          || in_array(Afastamento::AFASTADO_DOENCA_MAIS_30_DIAS, $aSituacoesFuncionario)) {
        // Afastado Doenca + 15 Dias ou + 30 Dias
	  // 
	  // aqui paulo alterado porque a R960 nao estava calculando
	  //
	  //if ($dias_pagamento == 0) {
    ...
    if ($opcao_geral == 1) {
      ...
      if (db_selectmaxlinha(233,"transacao", "select * from gerfsal ".bb_condicaosubpes("r14_" ).$condicaoaux )) {
        $base_irf  -= $transacao[0]["r14_valor"]  ;
        $r07_valor -= $transacao[0]["r14_valor"]  ;
        LogCalculoFolha::write("Modificando valor (Dedues P/IRRF[R989])................: -{$transacao[0]["r14_valor"]}");
      }
    } else if ($opcao_geral == 8) {
      // R989 DEDUCOES P/IRRF(13.SALARIO)
      $condicaoaux  = " and r48_rubric = 'R989' and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
      if (db_selectmaxlinha(234,"transacao", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
        $base_irf  -= $transacao[0]["r48_valor"]  ;
        $r07_valor -= $transacao[0]["r48_valor"]  ;
        LogCalculoFolha::write("Modificando valor (Dedues P/IRRF[R989])................: -{$transacao[0]["r48_valor"]}");
      }
      ...
      if (db_selectmaxlinha(235,"transacao", "select * from gerfs13 ".bb_condicaosubpes("r35_" ).$condicaoaux )) {
        $base_irf  -= $transacao[0]["r35_valor"]  ;
        $r07_valor -= $transacao[0]["r35_valor"]  ;
        LogCalculoFolha::write("Modificando valor (Dedues P/IRRF[R989])................: -{$transacao[0]["r35_valor"]}");
      }
      ...
      if (db_selectmaxlinha(236,"transacao", "select * from gerfs13 ".bb_condicaosubpes("r35_" ).$condicaoaux )) {
        $base_irf  -= $transacao[0]["r35_valor"]  ;
        $r07_valor -= $transacao[0]["r35_valor"]  ;
  ...
  $totalDeducoes = $deducaoDependentes + $deducaoPrevidencia + $deducaoComplementar + $deducaoPrevidenciaFerias + $deducaoPensao;
  LogCalculoFolha::write("Total de Deducao antes da regra (IR - 2023)................: {$totalDeducoes}");


  if ($totalDeducoes <= $D950) {
      $diferencaDeducao = $D950 - $totalDeducoes;
      LogCalculoFolha::write("Existe diferenca de Deducao (IR - 2023)................: {$diferencaDeducao}");
      $totalDeducoes = $D950;
  }

  $base_irf -= $totalDeducoesBase;
  $r07_valor -= $totalDeducoes;

  if ($r07_valor > 0.009) {

    LogCalculoFolha::write("Chamando FunÁ„o de C·lculo de IRRF - Valor: $r07_valor");
    ...
    if (db_at($r20_rubr,"R913-R915-R914")>0 && $r14_valor <= $D911) {
      ...
      if ($opcao_geral == 1) {
        $condicaoaux  = " and r48_regist = ".db_sqlformat($pessoal[$Ipessoal]["r01_regist"] );
        $condicaoaux .= " and r48_rubric = ".db_sqlformat($r20_rubr );
        if (db_selectmaxlinha(237,"transacao", "select * from gerfcom ".bb_condicaosubpes("r48_" ).$condicaoaux )) {
    ...
    if ($db_debug == true) { echo "[calc_irf] 32 - Chamando a funcao grava_gerf() <br>"; }
    grava_gerf($area);
    ...
    $base_irf = 0;
    // Caso exista diferenca de deducao
    if ($diferencaDeducao > 0) {
        // Alteramos o valor da rubrica e a rubrica, apenas para salvar a R957 com o valor da deducao
        $r14_valorOriginal = $r14_valor;
        $r20_rubrOriginal = $r20_rubr;
        $r20_rubr = 'R957';
        $r14_valor = $diferencaDeducao;
        LogCalculoFolha::write("Salvando rubrica de diferenca de Deducao (R957)................: {$diferencaDeducao}");
        grava_gerf($area);
        // Retornamos os valores originais para nao ocorrer impactos
        $r14_valor = $r14_valorOriginal;
        $r20_rubr = $r20_rubrOriginal;
    }
  }

  if ($db_debug == true) {
    echo "[calc_irf] chamando a funcao gravb_base_irf($area, $r20_rubrp)... <br>";
  }
  gravb_base_irf($area,$r20_rubrp);

  if ($db_debug == true) {
    echo "[calc_irf] FIM DO PROCESSAMENTO DA FUNCAO calc_irf... <br><br>";
  }
}
/// le_irf ///
/**
 ...
 * @param mixed $codigo   Cdigo da Tabela na Tabela do Banco INSSIRF
 * @access public
 * @return void
 */
function le_irf ($base_irf=null,$codigo=null){
  ...
  if (empty($inssirf)) {
    ...
    db_selectmaxlinha(238,"inssirf", "SELECT * FROM inssirf " . bb_condicaosubpes("r33_") . $condicaoaux);
  ...
  for ($Iinssirf = 0; $Iinssirf < $iTotalLinhasIrrf; $Iinssirf++) {
    ...
    if( !db_empty($inssirf[$Iinssirf]["r33_fim"]) ) {
      if( $base_irf >= $inssirf[$Iinssirf]["r33_inic"] && $base_irf <= $inssirf[$Iinssirf]["r33_fim"]){
        ...
        LogCalculoFolha::write('Clculo: ($base_irf/100)*($inssirf[$Iinssirf]["r33_perc"])-($inssirf[$Iinssirf]["r33_deduzi"])');
        LogCalculoFolha::write("Clculo: ({$base_irf}/100)*({$inssirf[$Iinssirf]["r33_perc"]})-({$inssirf[$Iinssirf]["r33_deduzi"]})");
        LogCalculoFolha::write("Clculo: " . ($base_irf/100) . "*". ($inssirf[$Iinssirf]["r33_perc"])-($inssirf[$Iinssirf]["r33_deduzi"]) );
        LogCalculoFolha::write("Clculo: " . ($base_irf/100)*($inssirf[$Iinssirf]["r33_perc"])-($inssirf[$Iinssirf]["r33_deduzi"]));
...
function qvale ($registro,$tipo,$codigo,$difere,$quant,$admissao ){
  ...
  if( ('t' == $cfpess[0]["r11_vtprop"]) && !('t' ==  $tipo )){
    ...
    if( db_selectmaxlinha(239, "transacao1",$sqlaux )){
      $quantvale = $transacao1[0]["total"];
    }
    ...
    $sqlaux .= "'" . $difere                       ."'" ;
    $sqlaux .= ",$DB_instit) as total" ;
    if( db_selectmaxlinha(240, "transacao1",$sqlaux )){
      $quantvale = $transacao1[0]["total"];
    }
    if( ('t' == $cfpess[0]["r11_vtmpro"]) && ('t' ==  $tipo )){
      ...
      if( db_selectmaxlinha(200, "transacao1",$sqlaux )){
        $quantvale = $transacao1[0]["total"];
      }
...
function arredonda_100 ($valor,$criterio){
  global $db_debug;
  if ($db_debug == true) { echo "[arredonda_100] funcao arredonda_100<br>"; }
  $arredn = 0;
...
/**
 * Verifica se o o servidor possui a situao informada na competencia
 * @param $sSituacao
 * @param $iMatricula
 * @return bool
 */
 ...
 * @param $sDataDeAdmissao data de admisso do funcionario
...
/**
 * Funo utilizada na frmula da rubrica R932. Verifica se tem direito a receber 1/3 do abono, quando houverem dias
 * a serem abonados.
 * Frmula: (PAGATERCO() > 0 ?  (((B030/(F019+F020+F023))*(F020))  / 3): 0)
 * @return int
 * @throws BusinessException
 */
function pagaTerco()
{
    global $anousu, $mesusu, $DB_instit,$dias_do_mes, $Ipessoal, $pessoal;

    $pagaTerco = true;
    $sSql      = "select rh110_temdireitotercoabono ";
    $sSql     .= "  from rhferiasperiodo ";
    $sSql     .= "       inner join rhferias on rh110_rhferias = rh109_sequencial ";
    $sSql     .= " where rh110_anopagamento = {$anousu} and rh110_mespagamento = {$mesusu}";
    $sSql     .= " and rh109_regist = {$pessoal[$Ipessoal]["r01_regist"]}";
    $rs = db_query($sSql);

    if (!$rs) {
        throw new  BusinessException("Erro ao pesquisar frias");
    }

    if (pg_num_rows($rs) > 0) {
        $pagaTerco = db_utils::fieldsMemory($rs, 0)->rh110_temdireitotercoabono == 't';
    }
