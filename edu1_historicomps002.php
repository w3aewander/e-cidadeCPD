...
if (isset($alterar)) {
  ...
  if ($oDaoMatricula->numrows > 0 && $ed62_c_situacao != 'TRANSFERIDO' && $ed62_c_resultadofinal != 'R') {
    ...
    } else if ( $ed62_c_situacao == "CONCLUÍDO" || $ed62_c_situacao == "RECLASSIFICADO"  || $ed62_c_situacao == "AVANÇO" ) {
    ...
    if ($vinculo == true) {
      db_msgbox("Etapa com situação diferente de CONCLUÍDO, RECLASSIFICADO ou AVANÇO não deve ter disciplinas vinculadas!");
    } else {
      ...
      $oDaoHistoricoMps->ed62_i_periodoref           = "{$ed62_i_periodoref}";
