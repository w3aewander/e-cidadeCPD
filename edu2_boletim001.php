...
//Usuario autualmente logadao
$isAdmin = db_getsession("DB_administrador") == 1;
...
<body bgcolor="#CCCCCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1;" >
  ...
  <div class="center">
      ...
      <fieldset style="width:95%">
        ...
        <table border="0" align="left">
            ...
            <td colspan="3">
              ...
              if ($clprocresultado->numrows > 0) {
                ...
                if (trim($ed37_c_tipo) == "PARECER") {
                  ...
                  echo $ed37_c_tipo;
                  ?>
                  &nbsp;&nbsp;&nbsp;&nbsp;<b>BOLETIM POR RELATÓRIO DESCRITIVO</b>
          ...
          if (trim($ed37_c_tipo) == "PARECER") {
              ...
              <td colspan="3">
                ...
                <select name="disciplinas" id="disciplinas" style="font-size:9px;width:180px;">
                  ...
                  if ($clregencia->numrows > 1) {
                    ...
                    echo "<option value='PU'>RELATÓRIO ÚNICO</option>";
            ...
            <tr>
              <td colspan='3'>
                <b>Relatórios Padronizados:</b>
                <select name="padraotipo" style="font-size:9px;height:16px;">
                <?php /* ?>
                  <option value="C">Concatenar relatórios lado a lado</option>
                  <option value="L">Listar relatórios um abaixo do outro</option>
                  <?php */ ?>
                  <option value="L" selected>Listar relatórios um abaixo do outro</option>
                </select>
                <input type="checkbox"
	...
	<tr>
	    <td>
		    <input type="checkbox" name="impfrequencia" value="" > <b>Imprimir percentual de frequência</b><br>
		</td>
	</tr>
	<tr>
	    <td>
             <!-- alterado por Wanderlei Silva (Wander) para exibir o campo de observação -->
		    <input type="checkbox" name="integral" onchange="js_mostrarCampoObservacao();js_lerObservacaoBoletim();" value="" > <b>Imprimir boletim integral</b><br>
		</td>
	</tr>

    <tr>
      <td colspan="3"><? db_ancora("<b>Assinatura Adicional: </b>", "js_pesquisaRecHumano(true);", 1); ?>
        <?
  ...
  <tr>
    <td colspan="3"><? db_ancora("<b>Assinatura Adicional: </b>", "js_pesquisaRecHumano2(true);", 1); ?>
      <?
        db_input("02", 6, $Ied20_i_codigo, true, "text", 1, "onChange='js_pesquisaRecHumano2(false);'");
        db_input("z01_numcgm2", 10, $Iz01_numcgm, true, "hidden", 3);
        db_input("z01_nome2", 73, $Iz01_nome, true, "text", 3);
      ?>
    </td>
  </tr>
  <tr>
    <td><b>Atividades:</b></td>
    <td id='ctnAtividades2' colspan="3"></td>
  </tr>
...
<!--
                ...
                <select name="modelo" id="modelo" style="font-size:9px; ">
                  ...
                  <option value='4'>MODELO 2</option>
                </select>
-->
                <input type="checkbox" id='assinaturaregente' name="assinaturaregente" value=""> <b>Imprimir assinatura do professor conselheiro</b>
                <br>
              </td>
            </tr>
            <tr>
              <td colspan="3">
                ...
                <input type="checkbox" name="assresp" value="" checked> <b>Imprimir comprovante de assinatura para os responsáveis</b>
				<input type="checkbox" name="impfrequencia" value="" > <b>Imprimir percentual de frequência</b><br>
                <br>
				<input type="checkbox" name="integral" value="" onchange="js_mostrarCampoObservacao();js_lerObservacaoBoletim();" > <b>Imprimir boletim integral</b><br>
                <!-- Observação para Boletim integral somente para administradores -->
                <?php if ( $isAdmin ) { ?>
                    <fieldset id="biCampoObservacao" style="display:none;margin:10px;padding: 5px;">
                    <h4>Atualizar observação no boletim (visível apenas para administradores.)</h4>
                    <b>Observação:</b>
                    <textarea name="ctx_observacao" id="ctx_observacao" rows="2" cols="110" style="margin-bottom:30px; width:100%; text-transform: uppercase"></textarea>
                        <div style="display:table-cell; margin-right: 10px;vertical-align: middle;">
                            <input type="checkbox" id="chk_observacao" name="chk_observacao" value="n">
                            <label for="chk_observacao">Exibir observação no boletim para esta escola</label>

                        <button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                                type="button"
                                onclick="js_salvaObservacaoBoletim();">
                            <span class="ui-button-text">Alterar observação</span>
                        </button>
                    </div>
                ...
                <!-- Fim Boletim integral -->

				<br>
                <input type="checkbox" id='descritivo' name="descritivo" value="" > <b>Mostrar parecer descritivo</b><br>
            ...
            <td align="center" colspan="3">
              ...
              if (trim($ed37_c_tipo) == "PARECER") {
                ...
                <input name="pesquisar"
                       ...
                       id="pesquisar"
                       value="Processar"
                       onclick="js_salvaObs(document.form1.subgrupo.value, 2);"
                       disabled>
              ...
              <?php
                ...
                <input name="pesquisar"
                       ...
                       id="pesquisar"
                       value="Processar"
                       onclick="js_salvaObs(document.form1.subgrupo.value, 1);"
                       disabled >
...
function js_salvaObs(iTurma, iPesquisa){
    ...
    /*if(document.form1.obs.value !== "undefined" ){
...
function js_pesquisa(turma) {
  ...
  if (grade == "no" && padrao == "no" && descritivo == "no") {
    alert("Escolha uma das oções de layout!");
    return false;
  }
  */
...
//  padrao = "no";
  ...
  // variável para armazenar a observação do boletim integral (solicitado pela Suellen)
  obsAdicional = "";

  if (document.form1.assresp.checked == true) {
    assresp = "yes";
  } else {
    assresp = "no";
  }

  if (document.form1.impfrequencia.checked == true)
  {
     impfrequencia = "yes";
  }else{
	 impfrequencia = "no";
  ...
  if (document.form1.integral.checked == true) // acrescentado opção para boletim integral 26/02/2025
  {
     integral = "yes";
...
/*
	  if (document.form1.modelo.value == 1) {
		...
		//sUrlBoletim = 'edu2_boletimdiarioprogressaoparcial002.php';
	  } else if (document.form1.modelo.value == 3) {
		sUrlBoletim = 'edu2_boletimunificado002.php';
	  }else if (document.form1.modelo.value == 4) {
		sUrlBoletim = 'edu2_boletim003m.php';
	  } else {
...
*/
	  ...
	  jan = window.open(sUrlBoletim+'?padraotipo='+padraotipo+'&grade='+grade+
						'&padrao='+padrao+'&descritivo='+descritivo+'&niveis='+niveis+
						'&assinaturaregente='+assinaturaregente+'&alunos='+alunos+
						'&periodo='+document.form1.periodo.value+'&turma='+turma+'&assresp='+assresp+'&impfrequencia='+impfrequencia+'&integral='+integral+'&obs1='+btoa(obs1)+'&calendario='+document.form1.grupo.value,'rel',
...
/**
 * Ler observação do boletim integral
 *
 * @return void
 */
function js_lerObservacaoBoletim(){

  var oParametro = new Object();

  oParametro.exec = 'lerObservacaoBoletim';
  oParametro.escola = <?php if (isset($escola)) { echo $escola; } else { echo '0'; } ?>;
  oParametro.turma = <?php if (isset($turma)) { echo $turma; } else { echo '0'; } ?>;

  AjaxRequest.create("edu_educacaobase.RPC.php",oParametro, js_retornoLerObservacaoBoletim).execute();

}

/**
 * Rertono da leitura da observação do boletim integral
 * @returns string com a observação
 */
function js_retornoLerObservacaoBoletim(oRetorno)
{
    if (oRetorno.status != 1) {
        alert('Erro ao ler a observação do boletim integral.');
        return false;
    }

    //var obs =  JSON.parse(oRetorno.obs);

    js_removeObj("msgBox");


    console.log(oRetorno.obs.obs);

    document.getElementById("ctx_observacao").value = oRetorno.obs.obs;
    document.getElementById("chk_observacao").checked = oRetorno.obs.imprimirObservacao == 's' ? true : false;
...
function js_pesquisa2( turma ) {
  ...
  if (document.form1.modelo.value == 'M1') {
    ...
    var e1 = document.getElementById("cboAtividades");
    var value = e1.options[e1.selectedIndex].value;
    var text = e1.options[e1.selectedIndex].text;

    var e2 = document.getElementById("cboAtividades2");
    var value2 = e2.options[e2.selectedIndex].value;
    var text2 = e2.options[e2.selectedIndex].text;


    sParametros = '&iAssinaturaAdicional=' + $F('z01_nome');
    sParametros += '&iAssinaturaAdicional2=' + $F('z01_nome2');
    sParametros += '&iAtividade=' + text;
    sParametros += '&iAtividade2=' + text2;
  ...
  if(document.form1.modelo.value == "M1"){
    jan = window.open(sUrlBoletim+'?padraotipo='+document.form1.padraotipo.value+
                    ...
                    '&disciplinas='+disciplinas+'&turma='+turma+'&assinaturaregente='+assinaturaregente+sParametros+
                    '&alunos='+alunos+'&obs1='+btoa(document.form1.obs.value)+
					'&impfrequencia='+impfrequencia+'&obs1='+btoa(document.form1.obs.value),'',
                    'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  }else{
...
function js_pesquisaRecHumano2(lMostra) {

if (lMostra) {

  js_OpenJanelaIframe('CurrentWindow.corpo',
                      'db_iframe_rechumano',
                      'func_rechumanoescolanovo.php?funcao_js=parent.js_mostraRecHumano2|0|z01_nome|z01_numcgm',
                      'Pesquisa Recurso Humano',
                      true
                     );
} else if ($F('0') != '') {
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo',
                      'db_iframe_rechumano',
                      'func_rechumanoescolanovo.php?funcao_js=parent.js_mostraRecHumano12&pesquisa_chave='+$F('02'),
                      'Pesquisa Recurso Humano',
                      false
                     );
} else {
  ...
  $('z01_nome2').value      = '';
  $('z01_numcgm2').value    = '';
  oCboAtividades2.clearItens();
  oCboAtividades2.setDisable(true);
}
}

function js_mostraRecHumano2() {

$('02').value = arguments[0];
$('z01_nome2').value      = arguments[1];
$('z01_numcgm2').value    = arguments[2];
db_iframe_rechumano.hide();
js_atividadesDocente2();
}

function js_mostraRecHumano12() {

$('z01_nome2').value   = arguments[0];
$('z01_numcgm2').value = arguments[1];
...
oCboAtividades2 = new DBComboBox("cboAtividades2", "oCboAtividades2", null, "605px");
oCboAtividades2.addItem("", "");
oCboAtividades2.show($('ctnAtividades2'));
oCboAtividades2.setDisable(true);
...
function js_atividadesDocente2() {

var oParametro     = new Object();
oParametro.exec    = 'buscaAtividadesServidor';
oParametro.iNumCgm = $F('z01_numcgm2');
...
var oAjax = new Ajax.Request(
                             'edu_educacaobase.RPC.php',
                             {
                               method: 'post',
                               parameters: 'json='+Object.toJSON(oParametro),
                               onComplete: js_retornaAtividadesDocente2
                             }
                            );
}


function js_salvaObservacaoBoletim() {


  if (! confirm("Deseja realmente salvar a observação do boletim?")) {
     return;
  }

  var campoObservacao = document.getElementById("ctx_observacao").value;
  var imprimirObservacao = document.getElementById("chk_observacao").checked ? "s" : "n";
  ...
  oParametro.exec = 'salvarObservacaoBoletim';
  oParametro.escola = <?= isset($escola) ? $escola : '0' ?>;
  oParametro.turma = <?= isset($turma) ? $turma : '0' ?>;

  oParametro.obs = campoObservacao
  oParametro.imprimirObservacao = imprimirObservacao;

  js_divCarregando("Aguarde, salvando a observação do boletim.", "msgBox");
  ...
  var oAjax = new Ajax.Request(
                               'edu_educacaobase.RPC.php',
                               {
                                 method: 'post',
                                 parameters: 'json=' + Object.toJSON(oParametro),
                                 onComplete: js_retornoSalvaObservacaoBoletim
                               }
                    );
}

function js_retornoSalvaObservacaoBoletim(oRetorno) {
  ...
  if (oRetorno.status) {
    alert("Observação do boletim salva com sucesso.");
  } else {
    alert("Erro ao salvar a observação do boletim: " + oRetorno.message);
  }
}

/*
  Implementado por Wanderlei Silva do Carmo (Wander)
  para exibir o campo observação quando for marcado
  o checkbox de imprimir boletim integral.
*/
function js_mostrarCampoObservacao() {

  if (document.form1.integral.checked == true) {
    document.getElementById("biCampoObservacao").style.display = "block";
  } else {
    document.getElementById("biCampoObservacao").style.display = "none";
  }
}
/* ------------------------------------------------------------------- */

function js_retornaAtividadesDocente2(oResponse) {

oCboAtividades2.setEnable(true);
oCboAtividades2.clearItens();
oCboAtividades2.addItem("", "");
js_removeObj("msgBox");
var oRetorno = eval('('+oResponse.responseText+')');
...
if (oRetorno.aAtividades.length > 0) {
 ...
 oRetorno.aAtividades.each(function(oLinha, iSeq) {
   ...
   oCboAtividades2.addItem(oLinha.iCodigo, oLinha.sDescricao.urlDecode());
   if (oRetorno.aAtividades.length == 1) {
     oCboAtividades2.setValue(oLinha.iCodigo);
   }
 });
}
}

document.getElementById("cboAtividades").style.marginLeft = "-327px";
document.getElementById("cboAtividades2").style.marginLeft = "-327px";
</script>
