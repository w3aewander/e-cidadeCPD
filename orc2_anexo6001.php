    ...
    <script>
        ...
        function js_emite(opcao, origem) {
            ...
            if (valor_nivel == 0) {
                ...
                let url = "orc2_anexo6002.php?perfin=" + perfin + "&perini=" + perini + "&opcao=" + opcao + "&origem=" + origem;
                url += `&origemRecurso=${document.getElementById('fonte-recurso').value}`
            ...
            <td align="center" colspan="3">
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <input name="seleciona" id="seleciona" type="button" value="Selecionar"
                                   onclick="js_abre();">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><label class="bold" for="fonte-recurso">Fonte de Recurso: </label></td>
                        <td colspan="2">
                            <select name="fonte-recurso" id="fonte-recurso">
