...
function js_pesquisay16_codauto(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?funcao_js=parent.js_mostraauto1|y50_codauto|y50_codauto','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y16_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisay16_codandam(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fandam','func_fis_fandam.php?pesquisa_chave='+document.form1.y16_codandam.value+'&funcao_js=parent.js_mostrafandam','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autoultandam','func_fis_autoultandam.php?funcao_js=parent.js_preenchepesquisa|y16_codauto|1','Pesquisa',true);
}
