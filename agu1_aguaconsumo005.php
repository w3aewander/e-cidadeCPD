 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguaconsumorec.location.href='agu1_aguaconsumorec001.php?x20_codconsumo=".@$x19_codconsumo."&x19_descr=".@$x19_descr."';
     ";
         if(isset($liberaaba)){
