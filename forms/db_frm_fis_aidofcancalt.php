...
function js_pesquisay03_aidof(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_aidof','func_fis_aidofalt.php?funcao_js=parent.js_mostraaidof1|y08_codigo|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.y03_aidof.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_aidof','func_fis_aidofalt.php?pesquisa_chave='+document.form1.y03_aidof.value+'&funcao_js=parent.js_mostraaidof','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_aidofcanc','func_fis_aidofcanc.php?funcao_js=parent.js_preenchepesquisa|y03_codigo','Pesquisa',true);
}
