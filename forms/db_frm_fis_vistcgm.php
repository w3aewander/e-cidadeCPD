...
function js_pesquisay73_codvist(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y73_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistcgm','func_fis_vistcgm.php?funcao_js=parent.js_preenchepesquisa|y73_codvist','Pesquisa',true);
}
