...
/**
 * Entidade que modela a tabela acertter do banco de dados.
 *
 * @author Matheus.lino <matheus.lino@dbseller.com.br>
 */
class ACertidaoTermo
{
    /**
     * @var Integer
     */
     ...
     * @return int
     */
    public function getCodigoAcertid()
    {
        return $this->codigoAcertid;
    }

    /**
     * @param int $codigoAcertid
     * @return ACertidaoTermo
     */
    public function setCodigoAcertid($codigoAcertid)
    {
        $this->codigoAcertid = $codigoAcertid;
        return $this;
    }
    ...
    public static function fromState($state)
    {
        ...
        if (array_key_exists('v14_parcel', $state)) {
            $self->setParcelamento($state['v14_parcel']);
        }
        ...
        if (array_key_exists('v14_codacertid', $state)) {
            $self->setCodigoAcertid($state['v14_codacertid']);
        }
