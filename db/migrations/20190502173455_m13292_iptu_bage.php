...
class M13292IptuBage extends PostgresMigration
{
    public function up()
    {
        $sql = "
            ...
            DECLARE
              ...
              V_TAXALIXOVALMAIOR	FLOAT8 DEFAULT 0;
            ...
            --    END IF;
                ...
                FOR R_CONSTR IN SELECT *
                  ...
                  IF V_TAXALIXOVAL > V_TAXALIXOVALMAIOR THEN
                      V_TAXALIXOVALMAIOR := V_TAXALIXOVAL;
                  END IF;
                ...
                V_TAXALIXOVAL := V_TAXALIXOVALMAIOR;
