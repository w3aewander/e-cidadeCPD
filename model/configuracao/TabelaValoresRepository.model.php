...
class TabelaValoresRepository {
  ...
  */
   ...
   */
  public function make (TabelaValores $oTabelaIRRF, $sTipoTabela) {
    ...
    static::getInstancia()->add($oTabelaIRRF, $sTipoTabela);
    return $oTabelaIRRF;
  }

  public function add(TabelaValores $oTabela, $sTipoTabela) {

    $sChave     = "TabelaValoresRepository{$sTipoTabela}:" . $oTabela->getCodigo();
    return DBRegistry::add($sChave, $oTabela);
  }

  public static function getByCodigo($iCodigo, $sTipoTabela='') {

    $sChave     = "TabelaValoresRepository{$sTipoTabela}:" . $iCodigo;
    $oInstancia = DBRegistry::get($sChave);

    if (!$oInstancia) {
      static::getInstancia()->make( static::getInstancia()->getTabela($iCodigo), $sTipoTabela );
    }
