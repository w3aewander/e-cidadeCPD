...
class cl_empage {
   ...
   public $e80_codage = 0;
   public $e80_data_dia = null;
   public $e80_data_mes = null;
   public $e80_data_ano = null;
   public $e80_data = null;
   public $e80_cancelado_dia = null;
   public $e80_cancelado_mes = null;
   public $e80_cancelado_ano = null;
   public $e80_cancelado = null;
   public $e80_instit = 0;
   ...
   public function incluir ($e80_codage){
      $this->atualizacampos();
   ...
   public function alterar ($e80_codage=null) {
      $this->atualizacampos();
   ...
   public function excluir ($e80_codage=null,$dbwhere=null) {
   ...
   public function sql_query ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_cons ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_cons_novo ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
    ...
    $sql .= "      inner join empagemov on empagemov.e81_codmov = empagedadosretmov.e76_codmov";
    $sql .= "      inner join empage on empage.e80_codage = empagemov.e81_codage";
    $sql .= "      left join corempagemov on corempagemov.k12_codmov = empagemov.e81_codmov";
    $sql .= "      left join empageconf  on empageconf.e86_codmov = empagemov.e81_codmov";
    $sql .= "      left join empageconfgera on empageconfgera.e90_codmov = empageconf.e86_codmov ";
   ...
   public function sql_query_file ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_pagam ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_rel_arqretorno ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_rel ( $e80_codage=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
