...
require_once(modification("classes/db_autousu_classe.php"));

$clenderecopecas = db_utils::getDao("enderecopecas");


parse_str($HTTP_SERVER_VARS['QUERY_STRING']);
if(!isset($abas)){

  echo "<script>location.href='fis1_auto005.php?como=$optionComo'</script>";
  exit;
}
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Incluir"){
  ...
  if( $sqlerro == true && $y14_codigo != "" && $y14_codi != "" ){
...
if(!isset($pri)){
  ...
  //include(modification("fis1_auto004.php?como=$optionComo"));
  exit;
}
?>
<html>
  ...
  if($sqlerro==true){
    ...
    echo "
         ...
         function js_src(){
           ...
           parent.iframe_respons.location.href      = 'fis1_autorespons001.php?y24_codauto=".$clauto->y50_codauto."&abas=1';\n
           // parent.iframe_calculo.location.href     = 'fis1_autocalc001.php?y50_codauto=".$clauto->y50_codauto."&abas=1';\n
           parent.iframe_precalculo.location.href  = 'fis1_autoprecalc001.php?y50_codauto=".$clauto->y50_codauto."&abas=1';\n
