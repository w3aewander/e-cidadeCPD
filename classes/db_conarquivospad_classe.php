...
class cl_conarquivospad
{
   ...
   // cria variaveis do arquivo
    public $c54_codarq = 0;
    public $c54_nomearq = null;
    public $c54_arquivo = null;
    public $c54_codtrib = 0;
    public $c54_anousu = 0;
   ...
   //funcao construtor da classe
    public function cl_conarquivospad()
    {
   ...
   // funcao para inclusao
    public function incluir($c54_codarq)
    {
        $this->atualizacampos();
   ...
   // funcao para alteracao
    public function alterar($c54_codarq = null)
    {
        $this->atualizacampos();
   ...
   // funcao para exclusao
    public function excluir($c54_codarq = null, $dbwhere = null)
    {
   ...
   // funcao do sql
    public function sql_query($c54_codarq = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "
        select {$campos}
            from conarquivospad
   ...
   // funcao do sql
    public function sql_query_file($c54_codarq = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
