...
try {
  ...
  switch ($oParametro->exec) {
    ...
    case 'salvar':
      ...
      $eventoModel->setConsiderarHorarioTrabalhado($evento->considerarHorarioTrabalhado);
      ...
      foreach ($evento->matriculas as $matricula) {
        $eventoModel->adicionarServidor(ServidorRepository::getInstanciaByCodigo($matricula));
      }
    ...
    case 'excluir':
      ...
      EventoRepository::getInstance()->excluir($evento);
