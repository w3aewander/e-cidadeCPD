...
*/
class FisLancamentoTaxaDiversosRepository extends BaseClassRepository {
  ...
  protected function make($iCodigo) {
    ...
    $sCamposLancamentoTaxaDiversos .= "(select dv14_data_calculo
                                         ...
                                         where dv14_lancamentotaxadiversos = fis_lancamentotaxadiversos.y120_sequencial
    ...
    $oLancamentoTaxaDiversos = new FisLancamentoTaxaDiversos;
    ...
    db_utils::makeFromRecord($rsLancamentoTaxadiversos, function ($oDados) use ($oLancamentoTaxaDiversos) {
      ...
      $oLancamentoTaxaDiversos->setNaturezaTaxa   (FisNaturezaTaxaDiversosRepository::getInstanciaPorCodigo($oDados->y120_taxadiversos));
  ...
  public static function getObservacoesTaxas($iNumcgm = null, $iNumnov, $iInscricao = null) {
    ...
    $sUnidade          = FisLancamentoTaxaDiversos::getDescricaoUnidade($oRetornoDiversos->y119_unidade);
