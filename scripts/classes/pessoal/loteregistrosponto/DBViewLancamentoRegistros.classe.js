...
DBViewLancamentoRegistros.prototype.loadLookups = function() {
  ...
  this.oLookupMatricula.setCallBack("onClick", function(servidor) { oSelf.carregarDadosLotacao(servidor, false); });
  this.oLookupMatricula.setCallBack("onChange",function(lErro, servidor) { oSelf.carregarDadosLotacao(servidor, lErro); });
...
DBViewLancamentoRegistros.prototype.carregarDadosLotacao = function(servidor, lErro) {
    $("codLotacao").value   = "";
    $("descrLotacao").value = "";
