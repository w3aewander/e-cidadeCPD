...
class ArquivoRPLiquidacao extends ArquivoBase
{
    ...
    10 => 1500
        ...
        foreach ($empenhos as $empenho) {
            if($empenho->e60_codemp != 768){continue;}
            ...
            */
            ...
            //$tipoDocumento = $empenho->e178_sigfistipodocliquidacao;
            //$tipoDocumento = $this->tabelaSigfis($vt);
            $tipoDocumento = $vt;

            
            //echo "Identificador: {$empenho->e69_codnota} ||| Empenho: {$empenho->e60_codemp}/{$empenho->e60_anousu} ||| Tipo: {$tipoDocumento}  "; echo "<br>";
            ...
            $verificaretencoes = $this->voltaRetencoes2($empenho->e60_numemp);
