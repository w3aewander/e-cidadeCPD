...
//$xxx = pg_fetch_all($this->recorddositens);
//echo "<pre>";
//print_r($xxx);
//echo "</pre>";
//die("Confere");
...
//Quebrar o nome da unidade para 48 caracteres (3 parametro) 
  ...
  $this->objpdf->text($xcol + 10, $xlin + 62, 'ITEM');
  $this->objpdf->text($xcol + 22, $xlin + 62, 'QUANT.');
  $this->objpdf->text($xcol + 70, $xlin + 62, 'MATERIAL OU SERVIÇO'); //AQUI
  $this->objpdf->text($xcol + 145, $xlin + 62, 'VALOR UNITÁRIO');
  $this->objpdf->text($xcol + 176, $xlin + 62, 'VALOR TOTAL');
  $maiscol = 0;
...
//die("x: $descricaoitem");
    ...
    $obsitem2 = str_replace("\\", "", $obsitem);
      
    //var_dump(utf8_decode($obsitem)); die("Confere");
    //Erro aqui
    //$obsitem = $this->objpdf->Row_multicell(array('','','', $obsitem), 3, false, 5, 0, true, true, 3, $seta_altura_pagina_row, null, null);
      $obsitem = $this->objpdf->Row_multicell(array('','','', $obsitem2), 3, false, 5, 0, true, true, 3, $seta_altura_pagina_row, null, null);
