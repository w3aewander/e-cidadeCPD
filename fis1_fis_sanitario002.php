...
if(!isset($y80_codsani) && !isset($chavepesquisa)){
  db_redireciona("fis1_fis_sanitario001.php?db_opcao=2&entrar=1");
  exit;
}
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  ...
  $clsanitario->erro(true,false);
   ?>
    <script>
     function js_src(){
      parent.iframe_sanitario.location.href='fis1_fis_sanitario002.php?chavepesquisa=<?=$clsanitario->y80_codsani?>&y83_codsani=x';
      parent.iframe_observacoes.location.href='fis1_fis_saniatividade006.php?y83_codsani=<?=$clsanitario->y80_codsani?>';
  ...
  echo "
       <script>
       function js_src(){
         parent.iframe_observacoes.location.href='fis1_fis_sanitario006.php?y80_codsani=$chavepesquisa';\n
         parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=$chavepesquisa';\n
         parent.iframe_resptecnico.location.href='fis1_fis_resptecnico001.php?y22_codsani=".$chavepesquisa."';\n
         parent.iframe_calculo.location.href='fis1_fis_sanicalc001.php?y80_codsani=".$chavepesquisa."';\n
       }
       js_src();
       </script>
   ";
