...
class cl_fis_autonumpre {
   ...
   public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_autonumpre");
   ...
   public function incluir (){
     ...
     $sql = "insert into fiscalizacao.fis_autonumpre(
                                       y17_numpre
                                      ,y17_codauto
                       )
                values (
   ...
   public function alterar ( $oid=null ) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_autonumpre set ";
     $virgula = "";
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
   ...
   public function excluir ( $oid=null ,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_autonumpre
                    where ";
     $sql2 = "";
   ...
   public function sql_query ( $oid = null,$campos="fis_autonumpre.oid,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_autonumpre ";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_autonumpre.y17_codauto";
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where fis_autonumpre.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   public function sql_query_val ( $oid = null,$campos="fis_autonumpre.oid,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_precalculo ( $oid = null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from fiscalizacao.fis_calculoauto ";
     $sql2 = "";
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where fis_calculoauto.y122_codauto = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
  ...
  public function sql_query_val_precalculo ( $oid = null,$campos="fis_calculoauto.oid,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
     ...
     $sql .= " from fiscalizacao.fis_calculoauto ";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_calculoauto.y50_codauto";
     $sql .= "      inner join configuracao.db_depart  on  configuracao.db_depart.coddepto = fis_auto.y50_setor";
     $sql2 = "";
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where fis_calculoauto.y50_codauto.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   */
/*
  public function sql_query_paga ( $iCodigoAuto ){
    ...
    $sSql .= "       end as valor                                                             ";
    $sSql .= "  from fiscalizacao.fis_autonumpre                                                               ";
    $sSql .= "       inner join fiscalizacao.fis_auto on fis_auto.y50_codauto = fis_autonumpre.y17_codauto             ";
    $sSql .= "       inner join db_depart on db_depart.coddepto = fis_auto.y50_setor              ";
    $sSql .= "       inner join fiscalizacao.fis_tipofiscaliza on fis_tipofiscaliza.y27_codtipo = fis_auto.y50_codtipo ";
