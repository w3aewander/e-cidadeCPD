...
if ($anoSessao >= 2018) {
    $codigoRelatorio = AnexoV2018::CODIGO_RELATORIO;
} else {
    if ($anoSessao >= 2017) {
        $codigoRelatorio = AnexoV2017::CODIGO_RELATORIO;
    } else {
        $codigoRelatorio = AnexoVDisponibilidadeCaixaRestosAPagar::CODIGO_RELATORIO;
    }
}
?>
<html>
