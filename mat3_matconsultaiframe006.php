...
?>
  ...
  if (isset($codmater)&&$codmater!="") {
    ...
    $sql= "select distinct m45_codigo,
            ...
            m45_hora,
            m91_codigo,
            deposito.descrdepto as dl_depósito,
            db_depart.coddepto,
	  ...
	  from matestoquedev
          ...
          inner join matrequi ON matrequi.m40_codigo = matrequiitem.m41_codmatrequi
          inner join db_almox ON db_almox.m91_codigo = m40_almox
          inner join db_depart as deposito ON deposito.coddepto = db_almox.m91_depto
          inner join configuracoes.db_depart ON db_depart.coddepto = matrequi.m40_depto
