...
class cl_assentadb_cadattdinamicovalorgrupo {
   ...
   var $campos = "
    ...
    /**
     * cl_assentadb_cadattdinamicovalorgrupo constructor.
     */
  ...
  public function sql_campos_dinamicos_por_assentamento($assetamento = null, $where = null)
  {
      $sql = "
            select db109_nome as campo, db110_valor as valor
              from assentadb_cadattdinamicovalorgrupo
              join db_cadattdinamicoatributosvalor on db110_cadattdinamicovalorgrupo = h80_db_cadattdinamicovalorgrupo 
              join configuracoes.db_cadattdinamicoatributos on db110_db_cadattdinamicoatributos = db109_sequencial
