...
class PreferenciaUsuario
{
     ...
     */
    public function __construct(UsuarioSistema $oUsuarioSistema)
    {
        ...
        $this->visulizarEmOutraJanela = isset($oPreferencias->visulizarEmOutraJanela) && $oPreferencias->visulizarEmOutraJanela;
