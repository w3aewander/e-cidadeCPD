...
<div><?php MsgAviso(db_getsession("DB_coddepto"), "escola"); ?></div>
...
<div id='ctnAbaSubstituto'>
    ...
    <center>
        <div id="ctnButtonSubstituto">
            <input type="button" id='btnSubstituto' name='btnSubstituto' value='Salvar'
                   onclick='js_vincularSubstituto()'/>
