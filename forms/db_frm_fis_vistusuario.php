...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_fiscais.location.href='fis1_fis_vistusuario002.php?chavepesquisa=$y75_codvist&chavepesquisa1=$y75_id_usuario&y39_codandam=$y39_codandam'</script>";}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_fiscais.location.href='fis1_fis_vistusuario003.php?chavepesquisa=$y75_codvist&chavepesquisa1=$y75_id_usuario&y39_codandam=$y39_codandam'</script>";
}
?>
 ...
 <table border="0" align=center>
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_vistusuario001.php?y75_codvist=<?=$y75_codvist?>&y79_codandam=<?=$y39_codandam?>'" >
      <?php
      }
      ?>
    </td>
         ...
         echo "<script>
           ...
           for(i=0;i<tam.length;i++){
            if(tam[i].name == 'calculo'){
               parent.iframe_calculo.location.href = 'fis1_fis_calculo001.php?y70_codvist=$y75_codvist';
...
function js_pesquisay75_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist|y70_data','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y75_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_vistusuario','func_fis_vistusuario.php?funcao_js=parent.js_preenchepesquisa|y75_codvist|1','Pesquisa',true);
}
...
if(isset($y75_codvist)){
  echo "<script>js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave=$y75_codvist&funcao_js=parent.js_mostravistorias','Pesquisa',false);</script>";
}else{
