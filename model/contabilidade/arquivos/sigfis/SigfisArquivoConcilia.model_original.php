  ...
  public function gerarDados() {
    ...
    $sSqlContasConciliacao = "select distinct on (k68_contabancaria)
                                ...
                                from ( select k68_contabancaria,
                                              ...
                                              c61_reduz,
                                              c61_instit,
                                              c60_estrut,c61_anousu, c60_anousu, c56_anousu, c56_sequencial
                                         from concilia
                               ...
                               group by k68_contabancaria,
                                        ...
                                        c61_reduz,
                                        c60_estrut,
                                        c61_instit, c56_sequencial";

    $this->addLog($sSqlContasConciliacao);
    ...
    for ($iRowConciliacao = 0; $iRowConciliacao < $iTotalLinhasConciliacao; $iRowConciliacao++) {
      ...
      $SeqContaCorrente     = $oStdContaConciliacao->c56_sequencial;
...
//         echo "C : $oStdLinhaArquivo->nu_sequencialconciliacao -- $oStdLinhaArquivo->vl_movconciliado\n";
       ...
       if( $iAnoUsu < 2013 ){
	    ...
	    $oStdLinhaArquivo->Cd_Conta_Corrente        = str_pad($SeqContaCorrente, 30, ' ', STR_PAD_LEFT);
