...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  if($clorcreserva->erro_status=="0"){
    ...
    if(isset($momenulibera)){
      ...
      echo "<script>(window.CurrentWindow || parent.CurrentWindow).corpo.db_iframe_orcreservaalt.hide();</script>";
      echo "<script>(window.CurrentWindow || parent.CurrentWindow).corpo.db_iframe_dotac.jan.document.form1.submit();</script>";
      exit;
    }
