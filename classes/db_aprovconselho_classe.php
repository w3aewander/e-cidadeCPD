...
class cl_aprovconselho {
   ...
   var $ed253_notaanterior = null;
   var $ed253_periodoalterado = null;
   var $ed253_conceitoanterior = null;
   var $ed253_pareceranterior = null;
   var $ed253_tipoalteracao = null;
   ...
   var $campos = "
                 ...
                 ed253_notaanterior = float8 = Nota Anterior
                 ed253_periodoalterado = int4 = Período Alterado
                 ed253_conceitoanterior = char(3) = Conceito Anterior
                 ed253_pareceranterior = text = Parecer Anterior
                 ed253_tipoalteracao = char(1) = Tipo de Alteração
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ed253_notaanterior = ($this->ed253_notaanterior == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_notaanterior"]:$this->ed253_notaanterior);
       $this->ed253_periodoalterado = ($this->ed253_periodoalterado == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_periodoalterado"]:$this->ed253_periodoalterado);
       $this->ed253_conceitoanterior = ($this->ed253_conceitoanterior == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_conceitoanterior"]:$this->ed253_conceitoanterior);
       $this->ed253_pareceranterior = ($this->ed253_pareceranterior == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_pareceranterior"]:$this->ed253_pareceranterior);
       $this->ed253_tipoalteracao = ($this->ed253_tipoalteracao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_tipoalteracao"]:$this->ed253_tipoalteracao);
     }else{
       $this->ed253_i_codigo = ($this->ed253_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed253_i_codigo"]:$this->ed253_i_codigo);
     }
   }
   ...
   function incluir ($ed253_i_codigo){
     ...
     $sql = "insert into aprovconselho(
                                      ...
                                      ,ed253_notaanterior
                                      ,ed253_periodoalterado
                                      ,ed253_conceitoanterior
                                      ,ed253_pareceranterior
                                      ,ed253_tipoalteracao
                       )
                values (
                                $this->ed253_i_codigo
                               ...
                               ,".($this->ed253_notaanterior == "null" || $this->ed253_notaanterior == "" ? "null" : $this->ed253_notaanterior)."
                               ,".($this->ed253_periodoalterado == "null" || $this->ed253_periodoalterado == "" ? "null" : $this->ed253_periodoalterado)."
                               ,'".($this->ed253_conceitoanterior == "null" || $this->ed253_conceitoanterior == "" ? "" : $this->ed253_conceitoanterior)."'
                               ,'".($this->ed253_pareceranterior == "null" || $this->ed253_pareceranterior == "" ? "" : $this->ed253_pareceranterior)."'
                               ,'".($this->ed253_tipoalteracao == "null" || $this->ed253_tipoalteracao == "" ? "" : $this->ed253_tipoalteracao)."'
                      )";
     $result = db_query($sql);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function alterar ($ed253_i_codigo=null) {
     ...
     if(trim($this->ed253_t_obs)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_t_obs"])){
       ...
       if(trim($this->ed253_t_obs) == null ){
         $this->erro_sql = " Campo Justificativa na2o Informado.";
         $this->erro_campo = "ed253_t_obs";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     ...
     if(trim($this->ed253_notaanterior)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_notaanterior"])){
        if(trim($this->ed253_notaanterior)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed253_notaanterior"])){
           $this->ed253_notaanterior = "null" ;
        }
       $sql  .= $virgula." ed253_notaanterior = ".($this->ed253_notaanterior == "null" ? "null" : $this->ed253_notaanterior)." ";
       $virgula = ",";
     }
     if(trim($this->ed253_periodoalterado)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_periodoalterado"])){
        if(trim($this->ed253_periodoalterado)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed253_periodoalterado"])){
           $this->ed253_periodoalterado = "null" ;
        }
       $sql  .= $virgula." ed253_periodoalterado = ".($this->ed253_periodoalterado == "null" ? "null" : $this->ed253_periodoalterado)." ";
       $virgula = ",";
     }
     if(trim($this->ed253_conceitoanterior)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_conceitoanterior"])){
       $sql  .= $virgula." ed253_conceitoanterior = '$this->ed253_conceitoanterior' ";
       $virgula = ",";
     }
     if(trim($this->ed253_pareceranterior)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_pareceranterior"])){
       $sql  .= $virgula." ed253_pareceranterior = '$this->ed253_pareceranterior' ";
       $virgula = ",";
     }
     if(trim($this->ed253_tipoalteracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed253_tipoalteracao"])){
       $sql  .= $virgula." ed253_tipoalteracao = '$this->ed253_tipoalteracao' ";
       $virgula = ",";
     }
     $sql .= " where ";
