...
function emiteDoc(){  
   ...
   if (obj.o46_codlei.value ==''){
      ...
      if (obj.modelo.value=='1'){  
          jan = window.open('orc2_orcprojeto002doc.php?o46_codlei='+obj.o46_codlei.value+'&timbre=s','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0');
          jan.moveTo(0,0);
      } else if (obj.modelo.value=='2') {
          alert("Disponível para modelos 1 e 4.");
      } else if (obj.modelo.value=='3') {
          alert("Disponível para modelos 1 e 4.");
      } else if (obj.modelo.value=='4') {
          jan = window.open('orc2_orcprojeto002doc.php?o46_codlei='+obj.o46_codlei.value+'&timbre=n','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0');
          jan.moveTo(0,0);
      }
   }
}
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
 ...
 <br><br>
  <table  align="center" border="0" >
   ...
   <tr>
      <td> &nbsp;  </td>
      <td nowrap align="center"> <input name="emitir" type="button" value="Emitir Projeto" onclick="emite();" ></td>
      <td nowrap align="center"> <input name="emitir" type="button" value="Emitir Projeto em .doc" onclick="emiteDoc();" ></td>
   </tr>
