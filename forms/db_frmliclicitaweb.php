        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        db_input(
                            ...
                            'text',
                            3,
                            " onchange='js_pesquisal29_liclicita(false);'"
                        )
                        ?>
                        <?php
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('l29_email', 60, $Il29_email, true, 'text', $db_opcao, "")
                        ?>
                    </td>
                </tr>
                <tr>
...
<script>
    function js_pesquisal29_liclicita(mostra) {
        if (mostra == true) {
            js_OpenJanelaIframe(
                'CurrentWindow.corpo',
                'db_iframe_liclicita',
                'func_liclicita.php?funcao_js=parent.js_mostraliclicita1|l20_codigo|l20_codigo',
                'Pesquisa',
                true
            );
        } else {
    ...
    function js_pesquisa() {
        js_OpenJanelaIframe(
            'CurrentWindow.corpo',
            'db_iframe_liclicitaweb',
            'func_liclicitaweb.php?funcao_js=parent.js_preenchepesquisa|l29_sequencial',
            'Pesquisa',
            true
        );
    }
