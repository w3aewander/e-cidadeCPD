...
function js_emite(){
    ...
    jan = window.open('lic2_relitenhtml_pregao_002_v2.php?l20_codigo='+codigo+'&separador='+separador+'&delimitador='+delimitador+'&layout='+layout,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);
