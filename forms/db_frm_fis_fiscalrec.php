...
$clfiscalrec1 = new cl_fis_fiscalrec;
...
if(isset($receita) && $receita != "" && isset($valor) && $valor != ""){
  echo "<script>parent.iframe_receitas.location.href = 'fis1_fis_fiscalrec002.php?y42_codnoti=$y42_codnoti&y42_receit=$receita&valor=$valor&y42_descr=$descr&abas=1&db_opcao=Alterar'</script>";
  exit;
} else if(isset($excluir)) {
  echo "<script>parent.iframe_receitas.location.href = 'fis1_fis_fiscalrec003.php?y42_codnoti=$y42_codnoti&y42_receit=$receita&abas=1&db_opcao=Excluir'</script>";
  exit;
}
?>
...
function js_pesquisay42_codnoti(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y42_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_fiscalrec','func_fis_fiscalrec.php?funcao_js=parent.js_preenchepesquisa|y42_codnoti|1','Pesquisa',true);
}
