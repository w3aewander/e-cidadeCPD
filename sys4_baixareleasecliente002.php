...
$verificadbpref=`cd $dbpref; cd .. ; find . -name dbpref`;
  ...
  $erro = file_get_contents("$log");
  if (trim($erro)<>''){
       db_msgbox("Atenção.Não foi possível atualizar os fontes no diretório do dbpref.Entre em contato com o suporte.") ;
     }
...
if ($aborta==2){
db_msgbox("Verificar os registros na tabela db_config.Atualização abortada! Entre em contato com o suporte.");

}

if ($aborta==3){
db_msgbox("Erro ao descompactar o arquivo.Atualização abortada! Entre em contato com o suporte");
}
...
if ($aborta==5){
db_msgbox("Erro ao descompactar o menus.Atualização abortada! Entre em contato com o suporte.");
}

if ($aborta==6){
db_msgbox("Não foi encontrado o arquivo menus8.sql.Atualização abortada! Entre em contato com o suporte.");
}

if ($aborta==7){
db_msgbox("Não foi encontrado o arquivo db_versaoant.Atualização abortada! Entre em contato com o suporte.");
}

if ($aborta==8){
db_msgbox("Não existe registro no arquivo dbversaoant.sql.Atualização abortada! Entre em contato com o suporte.");
}

if ($aborta==9){
db_msgbox(" Não foi encontrado o arquivo $db21_codcli.sql. Atualização abortada! Entre em contato com o suporte. ");
}

if ($aborta==10){
 db_msgbox(" Problema na atualização do banco de dados,verificar o log $log.Atualização abortada! Entre em contato com o suporte");
}
