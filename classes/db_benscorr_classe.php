...
class cl_benscorr { 
   ...
   var $t63_agregarvalor = 0;
   var $t63_corrigirvalor = 0;
   var $t63_processoadm = "";
   var $t63_justificativa = "";
   ...
   var $campos = "
                 ...
                 t63_agregarvalor = float8 = Agregar Valor
                 t63_corrigirvalor = float8 = Corrigir Valor
                 t63_processoadm = varchar(10) = Processo Administrativo
                 t63_justificativa = varchar(500) = Justificativa
                 t63_exercicio = integer = Exercício                 
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->t63_agregarvalor = ($this->t63_agregarvalor == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_agregarvalor"]:$this->t63_agregarvalor);
       $this->t63_corrigirvalor = ($this->t63_corrigirvalor == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_corrigirvalor"]:$this->t63_corrigirvalor);
       $this->t63_processoadm = ($this->t63_processoadm == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_processoadm"]:$this->t63_processoadm);
       $this->t63_justificativa = ($this->t63_justificativa == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_justificativa"]:$this->t63_justificativa);
       $this->t63_exercicio = ($this->t63_exercicio == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_exercicio"]:$this->t63_exercicio);
     }else{
       $this->t63_codcor = ($this->t63_codcor == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_codcor"]:$this->t63_codcor);
       $this->t63_codbem = ($this->t63_codbem == ""?@$GLOBALS["HTTP_POST_VARS"]["t63_codbem"]:$this->t63_codbem);
     }
   ...
   function incluir ($t63_codcor,$t63_codbem){ 
     ...
     $sql = "insert into benscorr(
                ...
                values (
                               ...
                               ,$this->t63_valcor 
                               ,$this->t63_deprec 
                               ,$this->t63_agregarvalor
                               ,$this->t63_corrigirvalor
                               ,'$this->t63_processoadm'
                               ,'$this->t63_justificativa'
                               ,$this->t63_exercicio 
   ...
   function alterar ($t63_codcor=null,$t63_codbem=null, $t63_agregarvalor=null, $t63_corrigirvalor=null, $t63_processoadm=null, $t63_justificativa=null) {
      $this->atualizacampos();
     ...
     $sql .= $virgula."t63_agregarvalor = $this->t63_agregarvalor, t63_corrigirvalor = $this->t63_corrigirvalor, t63_processoadm = '$this->t63_processoadm', t63_justificativa = '$this->t63_justificativa' ";
