    ...
    try {
        ...
        switch ($oPost->ano_opcao) {
            ...
            case '2018':
                ...
                $oCenso = new importacaoCenso2018($iAnoEscolhido, $iCodigoInepEscola);
                $oCenso->setCodigoEscola($iEscola);
                break;
        ...
        <fieldset>
            ...
            <table class="form-container">
                <tr>
                    ...
                    <td>
                        <select name="ano_opcao">
                            <option
                                value="<?= $iAnoAtual ?>" <?= @$ano_opcao == $iAnoAtual ? "selected" : "" ?>><?= $iAnoAtual ?></option>
                            <option
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="codigoinep_banco" value="<?= $iCodigoInepBanco ?>" size="8" readonly
                ...
                <tr>
                    ...
                    <td>
                        <?= db_input('arquivo', 50, 1, true, 'file', 3, "") ?>
                    </td>
                </tr>
                <tr>
