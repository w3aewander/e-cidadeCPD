...
$rsContas = $clempagetipo->sql_record($clempagetipo->sql_query(
    null,
    "e83_codtipo as codtipo, e83_descr, e83_conta, c61_codigo",
    "e83_conta")
);
        ...
        <table width="80%">
                    ...
                    <fieldset>
                        ...
                        <table border="0">
                            <tr>
                                ...
                                <td nowrap>
                                    <?php db_input('e82_codord2', 10, $Ie82_codord, true, 'text', $db_opcao, " onchange='js_pesquisae82_codord02(false);'", "e82_codord02") ?>
                                </td>
                                <td align="right" nowrap title="<?= $Te60_numemp ?>">
                                    <?php db_ancora(@$Le60_codemp, "js_pesquisae60_codemp(true);", $db_opcao); ?>
                                </td>
                                <td nowrap>
                                    <input name="e60_codemp" id='e60_codemp' title='<?= $Te60_codemp ?>' size="10"
                                           type='text'
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <input name="k17_codigo" id='k17_codigo' title='<?= $Tk17_codigo ?>' size="10"
                                           type='text'>
                                </td>
                                <td align="right" nowrap title="<?= $Tk17_codigo ?>">
                                ...
                                <td nowrap>
                                    <input name="k17_codigo2" id='k17_codigo2' title='<?= $Tk17_codigo ?>' size="10"
                                           type='text'>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan='6' style='text-align: center'>
                                    <input name="pesquisar" type="button" id="pesquisar" value="Pesquisar Ordens"
                                           onclick='js_pesquisarOrdens(1)'>
                                    <input name="pesquisar" type="button" id="pesquisar" value="Pesquisar Slips"
                                           onclick='js_pesquisarOrdens(2)'>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <table border=0>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type='checkbox' id="imprimirverso" name='imprimirverso'
                                           value='imprimirverso'>
                                    <label for="imprimirverso">Imprimir Verso</label>
                                    <input type='checkbox' id="imprimircomplemento" name='imprimircomplemento'
                                           value='1'>
            ...
            <tr>
                <td colspan='2' align='center'>
                    <input name="processar" type="button" id="processar" value="Emitir Cheque"
                           onclick='js_emiteCheques()' );'>
                    <input name="prever" id='prever' type="button" value="Visualizar verso"
                           onclick='return js_verVerso();'>
                    <input name="cancelar_cheque" type="button" id="cancelar_cheque" value="Cancelar Cheque"
                           onclick='js_anularCheque()'>
                    <input name="manut" type="button" id="manut" value="Manutenção de Pagamentos"
                           onclick='location.href="emp4_empageforma001.php"'>
                    <b>Total: </b>
...
<script>
    ...
    function js_verVerso() {
        ...
        url = 'emp4_agendaPagamentoRPC.php';
        var sJson = `{"exec":"getVersoCheque","params":[{"aMovimentos":${JSON.stringify(aMovimentos)}}]}`;
    ...
    function js_emiteCheques() {
        ...
        sJson += `"aNotasLiquidacao":[${sJsonItens}],"aTotCheques":${JSON.stringify(aQtdCheques)}}]}`;
        url = 'emp4_agendaPagamentoRPC.php';
        var oAjax = new Ajax.Request(
            url,
            {
    ...
    function js_imprimirVerso(iChequeAtivo) {
        ...
        var sJson = `{"exec":"emitirVersoCheque","params":[{"sStringVerso":"${sVerso}","aMovimentos":${JSON.stringify(aMovimentos)}`;
