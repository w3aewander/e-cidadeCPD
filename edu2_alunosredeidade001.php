...
<fieldset style="width: 470px;" class="container">
  <legend>Alunos da Rede Municipal Por Idade</legend>
  ...
  <!-- **************************************************
       ...
       ************************************************** -->
  <div hidden id='campos' style="float:left; width:400px; ">
    <fieldset class="separator">
      ...
      <table class="form-container" >
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="ed11_i_codigo" onclick="VerificaTamanho(3);" checked> Etapa
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="ed60_d_datamatricula" onclick="VerificaTamanho(4);" checked> Data Matrícula
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xturno" onclick="VerificaTamanho(5);" checked> Turno
            <input type="hidden" name="cabecalho" value="Turno"><br>
          </td>
          <td>
            <select name="alinhamento">
              <option value="L">ESQUERDO</option>
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xturma" onclick="VerificaTamanho(6);" checked> Turma
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="ed47_d_nasc" onclick="VerificaTamanho(7);" checked> Data de Nascimento
            <input type="hidden" name="cabecalho" value="Dt. Nascimento"><br>
          </td>
          <td>
            <select name="alinhamento">
              <option value="L">ESQUERDO</option>
  ...
  <!-- **************************************************************************
       ...
       ************************************************************************** -->
  <div hidden style="float:right; width:400px;">
      ...
      <legend>Orientação e Ordenação</legend>
        <table class="form-container" >
          ...
          <tr>
            ...
            <td >
             <select name="camposordenados" id="camposordenados" size="8" >
             </select>
            </td>
...
function js_pesquisa() {
  ...
  iIdade = parseInt(document.getElementById("inputIdade").value, 10);

  // Validação de idades
  if (isNaN(iIdade) || iIdade < 0) {
  ...
  var dataInicial = new Date(hoje.getFullYear() - iIdade - 1, hoje.getMonth(), hoje.getDate());
  var dataFinal   = new Date(hoje.getFullYear() - iIdade, hoje.getMonth(), hoje.getDate() + 1);

  var formatarData = (data) => data.toISOString().split("T")[0];

  var dtDataInicial = formatarData(dataInicial);
  var dtDataFinal   = formatarData(dataFinal);
  ...
  jan = window.open('edu2_alunosredeidade002.php?dDataMatriculaInicial='+document.form1.dDataMatriculaInicial.value
