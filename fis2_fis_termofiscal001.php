...
include(modification("classes/db_fis_termovist_classe.php"));
   ...
   if( ( inscricao == '' ) && ( logradouro == '' ) ){
      ...
      obj.q02_inscr.focus();
	   ...
	   if(document.form1.reemis.value == 'n'){
		   ...
		   if (confirma){
		   	jan2 = window.open('fis2_fis_termofiscal003.php?inscricao='+inscricao+'&logradouro='+logradouro+'&tipo='+document.form1.tipo.value+'&classes='+document.form1.codigos.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
				jan2.moveTo(0,0);
		   	jan = window.open('fis2_fis_termofiscal002.php?reemis='+document.form1.reemis.value+'&inscricao='+inscricao+'&logradouro='+logradouro+'&tipo='+document.form1.tipo.value+'&classes='+document.form1.codigos.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
				jan.moveTo(0,0);
