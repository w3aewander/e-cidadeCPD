...
use App\Domain\Financeiro\Planejamento\Requests\CalcularValoresSinteticosRequest;
use App\Domain\Financeiro\Planejamento\Services\CalcularValoresSinteticosService;
...
class CalcularValoresSinteticosController extends Controller
{
    ...
    {
        $this->service->recalcular($request->get('planejamento_id'));
        return new DBJsonResponse([], 'Cálculo processado com sucesso.');
    }
}
