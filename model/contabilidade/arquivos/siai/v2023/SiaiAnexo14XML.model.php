...
class SiaiAnexo14XML extends SiaiArquivoBase
{
  ...
  */
    public function gerarDados()
    {
      ...
      //          throw new Exception("Nenhum registro de Empenho encontrado");
        ...
        foreach ($aDadosEmpenho as $oDados) {
            ...
            $oDadosEmpenho->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
      ...
      */
            ...
            switch ($oDados->c57_sequencial) {
               ...
               */
                case 11:
                    ...
                    $oDadosAnulacaoEmpenho->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
              ...
              */
                case 20:
                    ...
                    $oDadosLiquidacao->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
            ...
            */
                case 21:
                    $oNodeAnulacaoLiquidacao = $this->oDocumento->createElement("AnulacaoLiquidacao");
                      ...
                      $oDadosAnulacaoLiquidacao->NumeroClassificacaoInstitucional  = $this->getNumeroClassificacaoInstitucional($oDados);
            ...
            */
                case 30:
                    $oNodePagamento = $this->oDocumento->createElement("Pagamento");
                      ...
                      $oDadosPagamento->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
          ...
          */
                case 31:
                    $oNodeAnulacaoPagamento = $this->oDocumento->createElement("AnulacaoPagamento");
                      ...
                      $oDadosAnulacaoPagamento->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
        ...
        foreach ($aLancamentosRetencoes as $oDados) {
            ...
            if (in_array($oDados->c53_tipo, array(100,160))) {
                ...
                $oDadosRetencaoPagamento->NumeroClassificacaoInstitucional       = $this->getNumeroClassificacaoInstitucional($oDados);
            ...
            if (in_array($oDados->c53_tipo, array(162))) {
                ...
                $oDadosAnulacaoRetencao->NumeroClassificacaoInstitucional = $this->getNumeroClassificacaoInstitucional($oDados);
    ...
    private function getNumeroClassificacaoInstitucional($dados)
    {
        if ($dados->o58_orgao == "24" && $dados->o58_unidade == "20") {
            return "24220";
        } elseif ($dados->o58_orgao == "39" && $dados->o58_unidade == "01") {
            return "39010";
        }
        return str_pad($dados->o58_orgao, 2, "0", STR_PAD_LEFT).str_pad($dados->o58_unidade, 3, "0", STR_PAD_LEFT);
    }
}
