...
<form name="form1" method="post" action="">
    <fieldset>
        <legend>Cadastro de Subgrupos</legend>
        <table>
            <tr>
                <td title="<?= @$Tpc04_codsubgrupo ?>">
                    <?= @$Lpc04_codsubgrupo ?>
                </td>
                <td>
                    <?php
            ...
            <tr>
                <td title="<?= @$Tpc04_descrsubgrupo ?>">
                    <?= @$Lpc04_descrsubgrupo ?>
                </td>
                <td>
                    <?php
                    db_input('pc04_descrsubgrupo', 50, $Ipc04_descrsubgrupo, true, 'text', $db_opcao, "")
                    ?>
                </td>
            </tr>
            <tr>
                <td title="<?= @$Tpc04_codgrupo ?>">
                    <?php
