...
const MSGTFD4_VEICULOS_RPC = 'saude.tfd.tfd4_veiculosRPC.';
...
try {
    ...
    switch ($oParam->exec) {
        case "buscaVericulosTFD":
            ...
            $sWhere .= " and ve36_coddepto = {$_SESSION['DB_coddepto']}";

            $oDaoVeiculos = new cl_veiculos;
            $sSqlLivres   = $oDaoVeiculos->sql_query_central(null, $sCampos, $sOrder, $sWhere);
