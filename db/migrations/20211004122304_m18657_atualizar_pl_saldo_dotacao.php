...
class M18657AtualizarPlSaldoDotacao extends PostgresMigration
{
    public function up()
    {
        $this->execute(<<<SQL
drop function if exists fc_saldo_dotacao(int, int, date, date);
...
create or replace function fc_saldo_dotacao(
    ...
    returns table
            (
                ...
                total_creditos              numeric(17, 2), -- (saldo inicial + sumplementado + suplementado_especial - reducoes)
...
begin
    ...
    loop
        ...
        if rs_dotacao.principal is true then
            ...
            total_creditos = saldo_inicial + rs_suplementacao.saldo_alteracoes_orcamentarias;
