...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_sanitarioinscr");
...
public function incluir ($y18_codsani,$y18_inscr){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_sanitarioinscr(
                                       y18_codsani
                                      ,y18_inscr
                       )
                values (
...
public function alterar ($y18_codsani=null,$y18_inscr=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_sanitarioinscr set ";
     $virgula = "";
...
public function excluir ($y18_codsani=null,$y18_inscr=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_sanitarioinscr
                    where ";
     $sql2 = "";
...
public function sql_query ( $y18_codsani=null,$y18_inscr=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_sanitarioinscr ";
     $sql .= "      inner join issbase  on  issbase.q02_inscr = fis_sanitarioinscr.y18_inscr";
     $sql .= "      inner join fiscalizacao.fis_sanitario  on  fis_sanitario.y80_codsani = fis_sanitarioinscr.y18_codsani";
     ...
     $sql .= "      inner join cgm  as a on   a.z01_numcgm = fis_sanitario.y80_numcgm";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_sanitario.y80_depto";
     $sql2 = "";
     if($dbwhere==""){
       if($y18_codsani!=null ){
         $sql2 .= " where fis_sanitarioinscr.y18_codsani = $y18_codsani ";
       }
       if($y18_inscr!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_sanitarioinscr.y18_inscr = $y18_inscr ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y18_codsani=null,$y18_inscr=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
