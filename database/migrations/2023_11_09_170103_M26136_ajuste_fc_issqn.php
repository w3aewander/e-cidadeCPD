...
class M26136AjusteFcIssqn extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement(<<<SQL1
        CREATE OR REPLACE FUNCTION public.fc_issqn(integer, integer, date, integer, date, boolean, boolean, integer, character varying, integer, integer, integer DEFAULT 0)
