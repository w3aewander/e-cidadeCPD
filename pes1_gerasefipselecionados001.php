...
function js_buscaMatriculas() {
  ...
  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_gerasefip.$('matriculasselecionadas').value = '';
...
function js_confirmar() {
  ...
  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_gerasefip.$('matriculasselecionadas').value = js_retornaMatriculasSelecionados();
