...
include(modification("classes/db_fis_vistoriaslotevist_classe.php"));
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_vistoriaslotevist.php")==true){
             include(modification("funcoes/db_func_fis_vistoriaslotevist.php"));
           }else{
           $campos = "fis_vistoriaslotevist.*";
           }
        }
