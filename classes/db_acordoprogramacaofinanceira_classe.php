...
class cl_acordoprogramacaofinanceira
{
    ...
    public $ac34_sequencial = 0;
    public $ac34_programacaofinanceira = 0;
    public $ac34_acordo = 0;
    ...
    public function __construct()
    {
        ...
        $this->pagina_retorno = $_SERVER["PHP_SELF"];
    }
    ...
    public function incluir($ac34_sequencial)
    {
        $this->atualizacampos();
        ...
        if ($ac34_sequencial == "" || $ac34_sequencial == null) {
            ...
            $this->ac34_sequencial = pg_fetch_result($result, 0, 0);
        } else {
            $result = db_query("select last_value from acordoprogramacaofinanceira_ac34_sequencial_seq");
            if (($result != false) && (pg_fetch_result($result, 0, 0) < $ac34_sequencial)) {
        ...
        if (($resaco != false) || ($this->numrows != 0)) {
            ...
            $resac = db_query("insert into db_acount values($acount,3040,17197,'','" . AddSlashes(pg_fetch_result($resaco, 0, 'ac34_sequencial')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
            $resac = db_query("insert into db_acount values($acount,3040,17198,'','" . AddSlashes(pg_fetch_result($resaco, 0, 'ac34_programacaofinanceira')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
            $resac = db_query("insert into db_acount values($acount,3040,17199,'','" . AddSlashes(pg_fetch_result($resaco, 0, 'ac34_acordo')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
        }
        return true;
    }

    public function alterar($ac34_sequencial = null)
    {
        $this->atualizacampos();
        ...
        if ($this->numrows > 0) {
            for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["ac34_sequencial"]) || $this->ac34_sequencial != "") {
                    $resac = db_query("insert into db_acount values($acount,3040,17197,'" . AddSlashes(pg_fetch_result($resaco, $conresaco, 'ac34_sequencial')) . "','$this->ac34_sequencial'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["ac34_programacaofinanceira"]) || $this->ac34_programacaofinanceira != "") {
                    $resac = db_query("insert into db_acount values($acount,3040,17198,'" . AddSlashes(pg_fetch_result($resaco, $conresaco, 'ac34_programacaofinanceira')) . "','$this->ac34_programacaofinanceira'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["ac34_acordo"]) || $this->ac34_acordo != "") {
                    $resac = db_query("insert into db_acount values($acount,3040,17199,'" . AddSlashes(pg_fetch_result($resaco, $conresaco, 'ac34_acordo')) . "','$this->ac34_acordo'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                }
            }
        }
        $result = db_query($sql);
    ...
    public function excluir($ac34_sequencial = null, $dbwhere = null)
    {
        ...
        if (($resaco != false) || ($this->numrows != 0)) {
            for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
                ...
                $resac = db_query("insert into db_acount values($acount,3040,17197,'','" . AddSlashes(pg_fetch_result($resaco, $iresaco, 'ac34_sequencial')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                $resac = db_query("insert into db_acount values($acount,3040,17198,'','" . AddSlashes(pg_fetch_result($resaco, $iresaco, 'ac34_programacaofinanceira')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                $resac = db_query("insert into db_acount values($acount,3040,17199,'','" . AddSlashes(pg_fetch_result($resaco, $iresaco, 'ac34_acordo')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
            }
        }
    ...
    public function sql_query($ac34_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_file($ac34_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_parcelas(
        $ac34_sequencial = null,
        $campos = "*",
        $ordem = null,
        $dbwhere = "",
        $limit = null)
