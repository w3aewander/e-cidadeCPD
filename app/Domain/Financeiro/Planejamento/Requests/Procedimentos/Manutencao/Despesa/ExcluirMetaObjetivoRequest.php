...
class ExcluirMetaObjetivoRequest extends FormRequest
{
    /**
     * @return bool
     */
    ...
    {
        return [
            'pl21_codigo' => 'required|integer|filled'
        ];
    }
    ...
    {
        return [
            'pl21_codigo.integer' => 'O campo "Código" deve ser um inteiro.',
            'pl21_codigo.filled' => 'O campo "Código" deve ser preenchido.',
            'pl21_codigo.required' => 'O campo "Código" deve ser informado.',
        ];
    }
}
