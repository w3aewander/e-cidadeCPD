...
/**
 * Classe com as fundamentações da modalidade 'Concorrência Lei 14.133 Presencial'
 *
 * @author Matheus Silva <matheus.silva@dbseller.com.br>
 */
final class CCP implements DeparaInterface
{
    /**
