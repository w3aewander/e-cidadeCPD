  ...
  <td valign="top" align="center" >
   ...
   if(isset($pesquisar)){
    ...
    if (isset($ed47_v_nome) && (trim($ed47_v_nome) !="" )) {
      ...
      $sql .= " AND upper(to_ascii(ed47_v_nome)) like '".TiraAcento($ed47_v_nome)."%'";
//$sql .= " {$sWhere} upper(to_ascii(ed47_v_nome)) like '".TiraAcento( $chave_ed47_v_nome )."%'";
    }
    ...
    ?></fieldset>
    <script>
      var campocodigo = document.getElementsByClassName("DBLovrotInputCabecalho");      
      campocodigo[0].value = "Matrícula";
    </script>
