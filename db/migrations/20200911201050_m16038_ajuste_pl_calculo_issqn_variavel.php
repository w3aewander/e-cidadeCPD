...
class M16038AjustePlCalculoIssqnVariavel extends PostgresMigration
{
    public function up()
    {
        $this->execute(<<<SQL
        ...
        loop
            IF extract(year from dInicioAtividade)::integer = iAnousu THEN
                IF v_record_cadvenc.q82_parc < extract(month from dInicioAtividade)::integer THEN
                    perform fc_debug('N�o existia atividade no m�s '||v_record_cadvenc.q82_parc||' do ano de '||iAnousu,lRaise,false,false);
