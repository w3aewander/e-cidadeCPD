      ...
      <fieldset style="min-width: 600px;">
        ...
        <table>
          ...
          <tr>
            ...
            -->
            <td>
              <select id="calcAulasPrevistas" class="field-size-max">
                <!--<option value="qs">(QUANTIDADE DE HORAS x SEMANAS LETIVAS) </option>-->
                <option value="dl">Anos Iniciais, EJA Iniciais e Educação Infantil</option><!-- DIAS LETIVOS -->
                <option value="ad">Anos Finais e EJA Finais</option> <!-- AULAS DADAS -->
              </select>
            </td>
            <!-- // -->
          </tr>
...
$('btnProcessar').onclick = function() {
  ...
  var sParametros  = '?iCalendario='       + oCalendario.getSelecionados().iCalendario;
      ...
      // Data: 27/03/2025
      sParametros += '&lCalcAulasPrevistas=' + $F('calcAulasPrevistas');
