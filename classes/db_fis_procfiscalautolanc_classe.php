...
class cl_fis_procfiscalautolanc {
   ...
   public $campos = "
                 ...
                 nl09_auto = int4 = Código do Auto de Infração
                 ";
   //funcao construtor da classe
   public function __construct() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("fis_procfiscalauto");
   ...
   public function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->nl09_auto = ($this->nl09_auto == ""?@$GLOBALS["HTTP_POST_VARS"]["nl09_auto"]:$this->nl09_auto);
     }else{
       $this->nl09_sequencial = ($this->nl09_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["nl09_sequencial"]:$this->nl09_sequencial);
     }
   }
   ...
   public function incluir ($nl09_sequencial){
     ...
     if($nl09_sequencial == "" || $nl09_sequencial == null ){
       $result = db_query("select nextval('procfiscalauto_nl09_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: procfiscalauto_nl09_sequencial_seq do campo: nl09_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from procfiscalauto_nl09_sequencial_seq");
     ...
     $sql = "insert into fiscalizacao.fis_procfiscalauto(
                                       nl09_sequencial
                                      ,nl09_procfiscal
                                      ,nl09_auto
                       )
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "procfiscalauto ($this->nl09_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function alterar ($nl09_sequencial=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_procfiscalauto set ";
     $virgula = "";
     ...
     if(trim($this->nl09_auto)!="" || isset($GLOBALS["HTTP_POST_VARS"]["nl09_auto"])){
       $sql  .= $virgula." nl09_auto = $this->nl09_auto ";
       $virgula = ",";
       if(trim($this->nl09_auto) == null ){
         $this->erro_sql = " Campo Código do Auto de Infração nao Informado.";
         $this->erro_campo = "nl09_auto";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function excluir ($nl09_sequencial=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_procfiscalauto
                    where ";
     $sql2 = "";
   ...
   public function sql_query ( $nl09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from fiscalizacao.fis_procfiscalauto ";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_procfiscalauto.nl09_auto";
     $sql .= "      inner join fiscalizacao.fis_procfiscal  on  fis_procfiscal.y100_sequencial = fis_procfiscalauto.nl09_procfiscal";
     ...
     if($dbwhere==""){
       if($nl09_sequencial!=null ){
         $sql2 .= " where fis_procfiscalauto.nl09_sequencial = $nl09_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
