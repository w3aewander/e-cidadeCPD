...
<head>
    ...
    <script rel="script" type="text/javascript" src="scripts/widgets/dbtextFieldData.widget.js"></script>
            ...
            <table class="form-container">
                <tr>
                    ...
                    <td nowrap>
                        ...
                        <b>Sequencial:</b>
                        <input name="e60_numemp" id='e60_numemp' type="text" size="10" readonly
                               class="readonly"/>
                    </td>
                </tr>
            </table>
    ...
    <script>
        ...
        function js_retornoAlterarLancamento(oAjax) {
            ...
            if (oRetorno.status == 2) {
                ...
                let msg = 'Lançamento Alterado com sucesso!';
                if (oRetorno.msgLog != '') {
                    msg += '\n' + oRetorno.msgLog;
                }
