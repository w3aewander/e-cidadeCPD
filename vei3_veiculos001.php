      ...
      <tr>
        <td>
          <fieldset>
            ...
            <table>
              <tr>
                <td nowrap title="<?php echo  $Tve01_codigo ?>">
                    <?php
                ...
                <td>
                    <?php
                    $script = " onchange='js_pesquisave01_codigo(false);'";
                    db_input('ve01_codigo', 10, $Ive01_codigo, true, 'text', 4, $script);
              ...
              <tr>
                <td nowrap title="<?php echo  $Tve40_veiccadcentral ?>">
                    <?php
                ...
                <td>
                    <?php
                    $script = " onchange='js_pesquisacentral(false);'";
                    db_input('ve40_veiccadcentral', 10, $Ive40_veiccadcentral, true, 'text', $db_opcao, $script);
