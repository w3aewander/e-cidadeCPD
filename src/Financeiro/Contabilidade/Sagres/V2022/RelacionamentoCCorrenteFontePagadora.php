...
/**
 * Arquivo 4.24
 * Class RelacionamentoCCorrenteFontePagadora
 * @package ECidade\Financeiro\Contabilidade\Sagres\V2022
 */
class RelacionamentoCCorrenteFontePagadora extends OutrosArquivosSagresFiscal
{
    const TAG = 'RelacionamentoCCorrenteFontePagadora';
