...
if (isset($excluir)) {
    ...
    $sCampos = "juros.k02_descr as descr_jur,multa.k02_descr as descr_mul,desconto.k02_descr as descr_des";
    ...
    echo "
        <script>
          function js_db_libera(){
            ...
            (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_tabrecregrasjm.location.href='cai1_receitaregrasjm001.php?k04_receit=" . @$k02_codigo . "&db_opcaoal=true';
						(window.CurrentWindow || parent.CurrentWindow).corpo.iframe_tabrecdepto.location.href='cai1_tabrec_depto001.php?k98_receit=" . @$k02_codigo . "&k02_descr=$k02_descr&db_opcao=3';
