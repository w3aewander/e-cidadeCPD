...
for ($i = 0; $i < $numrows; $i++) {
  ...
  $sql_orcam = $clpcorcamjulg->sql_query_adjudicacao(null, null, "distinct z01_numcgm,z01_nome,pcorcam.pc20_dtate,pcorcam.pc20_hrate", "z01_nome", "l17_situacao = 1 and l20_codigo=$l20_codigo and pc24_pontuacao=1 and pc10_instit=".db_getsession("DB_instit"));
  $result_orcam     = $clpcorcamjulg->sql_record($sql_orcam);
  $numrows_orcam    = $clpcorcamjulg->numrows;
  $sqlvalorcam = $clpcorcamjulg->sql_query_adjudicacao(null, null, "sum(pc23_valor)as valor_adj", "", "l17_situacao = 1 and l20_codigo=$l20_codigo and pc24_pontuacao=1 and pc10_instit=".db_getsession("DB_instit"));
  $result_valorcam  = $clpcorcamjulg->sql_record($sqlvalorcam);
    ...
    if (in_array($l20_licsituacao, $aSituacoes)) {
      ...
      $sSql = "select
                 ...
                 from liclicita
                      ...
                      inner join pcorcamfornelic on pcorcamfornelic.pc31_orcamforne = pcorcamforne.pc21_orcamforne 
                      inner join pcorcamfornelichabilitacao on pcorcamfornelichabilitacao.l17_pcorcamfornelic = pcorcamfornelic.pc31_orcamforne 
                 ...
                 where liclicita.l20_codigo = {$l20_codigo} and l17_situacao = 1
