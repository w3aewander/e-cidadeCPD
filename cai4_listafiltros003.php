...
<?php
  db_app::load("scripts.js, strings.js, numbers.js, prototype.js, estilos.css, widgets/DBToogle.widget.js");
?>
</head>
    ...
    <form class="container" name="form1" method="post"  >
      <fieldset style="width: 400px">
        ...
        <table class="form-container">
          <tr>
            <td>
              <label for="selContribuinte">Tipo de Filtro :</label>
            ...
            <td>
              <?php
                ...
                switch ($_GET['iFiltro']){
                  ...
                  break;
                    case "A" :
                    echo "<input id='contribuinte' style='display: none;'>";
                break;
                }
              ?>
            </td>
      ...
      <div id='dv_filtros' style="<?php echo $sStyleDvFiltros?>">

        <fieldset id='field_bairros'>
          <legend><strong> Bairros</strong> </legend>
          <table width="auto" border="0"  cellspacing="2" cellpadding="0">
            <tr>
              <td align="left">
                <strong for="selBairro">Tipo de Filtro :</strong>
                <select id='selBairro' >
                  <option value='1'>Selecionados</option>
                  <option value='2'>Sem Selecionados</option>
                </select>
        ...
        <fieldset id='field_logradouros'>
          <legend><strong> Logradouros</strong> </legend>
          <table width="auto" border="0"  cellspacing="2" cellpadding="0">
            <tr>
              <td align="left">
                <label for="selLogradouro"><strong> Tipo de Filtro :</strong></label>
        ...
        <fieldset id='field_zona'>
          <legend><strong> Zonas</strong> </legend>
          <table width="auto" border="0"  cellspacing="2" cellpadding="0">
            <tr>
              <td align="left">
                <label for="selZona"><strong> Tipo de Filtro :</strong></label>
                <select id='selZona' >
                  <option value='1'>Selecionados</option>
                  <option value='2'>Sem Selecionados</option>
                </select>
