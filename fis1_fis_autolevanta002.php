...
<body>
  <div class="container">
    <?php
      include(modification("forms/db_frm_fis_autolevanta.php"));
    ?>
  </div>
</body>
</html>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  ...
  if($clautolevanta->erro_status=="0"){
    ...
    $clautolevanta->erro(true,false);
    echo "<script>parent.iframe_autolevanta.location.href='fis1_fis_autolevanta001.php?y50_codauto=$y50_codauto';</script>";
  }
}
?>
