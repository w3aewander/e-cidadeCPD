...
if ($resnumpref == false || $clnumpref->numrows == 0) {
  throw new ResponseException("Tabela de parâmetro (numpref) não configurada! Verifique com administrador");
...
function js_mostramatricula(mostra, nome_func){
    ...
    if(nome_func != "func_iptubase.php") {
    	...
    	js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_matric',nome_func+'?funcao_js=parent.js_preenchematricula3|0|1|z01_nome','Pesquisa',true);
    }
  }else {
