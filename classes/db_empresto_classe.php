...
class cl_empresto
{
    ...
    public $e91_vlrliq = 0;
    public $e91_vlrpag = 0;
    public $e91_elemento = null;
    public $e91_recurso = 0;
    public $e91_codtipo = 0;
    public $e91_rpcorreto = 'f';
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->e91_rpcorreto = ($this->e91_rpcorreto == "f" || empty($this->e91_rpcorreto) ? 'f' : $this->e91_rpcorreto);
        } else {
            $this->e91_anousu = ($this->e91_anousu == "" ? @$GLOBALS["HTTP_POST_VARS"]["e91_anousu"] : $this->e91_anousu);
            $this->e91_numemp = ($this->e91_numemp == "" ? @$GLOBALS["HTTP_POST_VARS"]["e91_numemp"] : $this->e91_numemp);
        }
    ...
    public function incluir($e91_anousu, $e91_numemp)
    {
        $this->atualizacampos();
        if ($this->e91_vlremp == null) {
            $this->erro_sql = " Campo valor do empenho não informado.";
        ...
        if ($this->e91_vlranu == null) {
            $this->erro_sql = " Campo valor anulado não informado.";
        ...
        if (($this->e91_anousu == null) || ($this->e91_anousu == "")) {
            $this->erro_sql = " Campo e91_anousu não declarado.";
        ...
        if (($this->e91_numemp == null) || ($this->e91_numemp == "")) {
            $this->erro_sql = " Campo e91_numemp não declarado.";
            $this->erro_banco = "Chave Primaria zerada.";
            $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = " ($this->e91_anousu." - ".$this->e91_numemp) não Incluído. Inclusão Abortada.";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    public function alterar($e91_anousu = null, $e91_numemp = null)
    {
        $this->atualizacampos();
        ...
        if (trim($this->e91_numemp) != "" || isset($GLOBALS["HTTP_POST_VARS"]["e91_numemp"])) {
            ...
            if (trim($this->e91_numemp) == null) {
                $this->erro_sql = " Campo numero empenho não informado.";
        ...
        if (trim($this->e91_rpcorreto) != "" || isset($GLOBALS["HTTP_POST_VARS"]["e91_rpcorreto"])) {
            ...
            if (trim($this->e91_rpcorreto) == null) {
                $this->erro_sql = " Campo RP Correto não informado.";
    ...
    public function excluir($e91_anousu = null, $e91_numemp = null, $dbwhere = null)
    {
        $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
                && ($lSessaoDesativarAccount === false))) {
    ...
    public function sql_query($e91_anousu = null, $e91_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select {$campos}";
        $sql .= "  from empresto ";
        $sql .= "      inner join orctiporec  on  orctiporec.o15_codigo = empresto.e91_recurso";
        $sql .= "      inner join complementofonterecurso on o200_sequencial = o15_complemento";
    ...
    public function sql_query2($e91_anousu = null, $e91_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "
        select {$campos}
         from empresto
         ...
         join emprestotipo on emprestotipo.e90_codigo = empresto.e91_codtipo
         ";
        $sql2 = "";
        if (empty($dbwhere)) {
            if (!empty($e91_anousu)) {
    ...
    public function sql_query_file($e91_anousu = null, $e91_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_empenho($e91_anousu = null, $e91_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_rp($anousu = "", $instit = "1", $dtini = "", $dtfim = "", $sql_where = "", $sql_where_externo = "", $order = "")
    {
    ...
    public function sql_rp2($anousu = "", $instit = "1", $dtini = "", $dtfim = "", $sql_where = "", $order = "")
    {
        //##// função usada no relatorio de rp, não esta cadastrada como classe externa
        //##// $sql_where : caso queira filtrar por recurso, por exemplo
        //##//
    ...
    public function sql_rp_novo($anousu = "", $instit = "1", $dtini = "", $dtfim = "", $sql_where = "", $sql_where_externo = "", $order = "")
    {
        //##// função usada no relatorio de rp, não esta cadastrada como classe externa
        //##// $sql_where : caso queira filtrar por recurso, por exemplo
        //##//
          ...
          from ( select e91_numemp,
                   ...
                   from empresto
                        ...
                        inner join fonterecurso on fonterecurso.orctiporec_id = orctiporec.o15_codigo
                                               and fonterecurso.exercicio = {$anousu}
                        left outer join ( select c75_numemp,
                                                 ...
                                                 sum( round(case when c71_coddoc in (35, 6008) then c70_valor else ( case when c71_coddoc in (36, 6009) then c70_valor*-1 else  0 end) end,2) ) as vlrpag,
                                                 sum( round( case when c71_coddoc in (37, 6010) then c70_valor else ( case when c71_coddoc in (38, 6011) then c70_valor*-1 else  0 end) end ,2) ) as vlrpagnproc
                                            from conlancamemp
                                                 inner join conlancamdoc on c71_codlan = c75_codlan
                                                 inner join conhistdoc   on c53_coddoc = c71_coddoc
                                                 inner join conlancam    on c70_codlan = c75_codlan
                                           ...
                                           where e60_anousu < {$anousu} and c75_data {$where_datas}
                                             and {$instit}
                                             and c70_anousu = {$anousu} /* adicionado anousu pois estava repetindo */
                                           group by c75_numemp,c70_anousu ) as x on x.c75_numemp = e91_numemp
                  where e91_anousu = {$anousu} {$sql_where}
                ) as x
              ...
              inner join orcelemento   on e64_codele = o56_codele
               ...
               left join origemcomplementorecurso on o15_codigo  = o206_recurso
                                                 and o206_numero = e60_numemp
                                                 and o206_origem = 10

              where 1 = 1 {$sql_where_externo}
              {$order}
        ";
     ...
     * @return string
     */
    public function sql_query_restosPag($e91_anousu = null, $e91_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
     ...
     * @return string
     */
    public function sql_query_restos($sCampos = "*", $sOrder = null, $sWhere = null)
    {
     ...
     * @param string $sql_where_externo
     * @param string $order
     * @return string
     */
    public function sqlRpRecursoLancamento($anousu = "", $instit = "1", $dtini = "", $dtfim = "", $sql_where = "", $sql_where_externo = "", $order = "")
    {
        $where_datas = "";
        if ($dtini == "") {
            $where_datas = "  <  '$dtfim'  ";
        ...
        $sqlperiodo = "
            ...
            from (
              select
                 e91_numemp,
                 o15_codigo as recurso_rp,
                 case when o201_orctiporec is null then o15_codigo else o201_orctiporec end as recurso_lancamento,
                 o15_loaespecificacao,
                   e91_anousu,
                   e91_codtipo,
                   e90_descr,
              ...
              from empresto
                   ...
                   inner join orctiporec on e91_recurso = o15_codigo
                   left outer join (
                     select c75_numemp,c70_anousu, o201_orctiporec,
                         sum( round( case when c53_tipo   = 11 then c70_valor else 0 end,2) ) as vlranu,
                         sum( round(case when c71_coddoc = 31 then c70_valor else 0 end,2) ) as vlranuliq,
                         sum( round(case when c71_coddoc = 32 then c70_valor else 0 end,2) ) as vlranuliqnaoproc,
                         sum( round(case when c53_tipo   = 20 then c70_valor else ( case when c53_tipo = 21 then c70_valor*-1 else  0 end) end,2) ) as vlrliq,
                     ...
                     from conlancamemp
                         ...
                         inner join conlancam    on c70_codlan = c75_codlan
                         inner join empempenho   on e60_numemp = c75_numemp
                         join contabilidade.conlancamcomplementorecurso on o201_codlan = c75_codlan
                     where e60_anousu < " . $anousu . " and c75_data $where_datas
                          and $instit
                          and c70_anousu = $anousu /* adicionado anousu pois estava repetindo */
                     group by c75_numemp,c70_anousu,o201_orctiporec
                   ) as x on x.c75_numemp = e91_numemp
                 where e91_anousu = " . $anousu . " $sql_where
            ) as x
        inner join empempenho    on e60_numemp    = e91_numemp and $instit
