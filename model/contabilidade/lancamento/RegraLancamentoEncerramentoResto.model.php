 ...
 */
class RegraLancamentoEncerramentoResto implements IRegraLancamentoContabil
{

    /**
     * @param int $iCodigoDocumento
     * @param int $iCodigoLancamento
     * @param ILancamentoAuxiliar| LancamentoAuxiliarEncerramentoExercicio $oLancamentoAuxiliar
                                       ...
                                       ILancamentoAuxiliar $oLancamentoAuxiliar)
    {
        ...
        foreach ($aRegrasDoLancamento as $oRegraLancamento) {
            ...
            if ($oLancamentoAuxiliar->isInversaoContas()) {
                $regra = clone $oRegraLancamento;
                $contaCredito = $oRegraLancamento->getContaCredito();
                $contaDebito = $oRegraLancamento->getContaDebito();
                $regra->setContaDebito($contaCredito);
                $regra->setContaCredito($contaDebito);
                return $regra;
            }
