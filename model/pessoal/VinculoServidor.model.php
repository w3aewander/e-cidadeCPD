...
class VinculoServidor {
   ...
   * @var Integer
   */
  private $tpProvimento;

  /**
   * Tipo de Admissao servidor.
   * @var int
   */
  ...
  public function getTpProvimento() {
    return $this->tpProvimento;
  }

  public function setTpProvimento($tpProvimento) {
    $this->tpProvimento = $tpProvimento;
  }
  ...
  public function setTipoAdmissao($tipoAdmissao) {
