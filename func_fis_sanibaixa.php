...
include(modification("classes/db_fis_sanibaixa_classe.php"));
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_sanibaixa.php")==true){
             include(modification("funcoes/db_func_fis_sanibaixa.php"));
           }else{
           $campos = "fis_sanibaixa.*";
           }
        }
