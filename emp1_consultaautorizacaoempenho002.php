...
$oDaoEmpAutDot = new cl_empautidot();
$oDaoCGM = new cl_cgm();
$oDaoDbDepart = new cl_db_depart();
$oDaoEmpAutHist = new cl_empauthist();
...
<fieldset>
  ...
  <table border="0">
    ...
    <tr>
      ...
      <td class="valores" colspan="5">
        <textarea style="width:100%; border:0; resize: none;" rows="4"
                  readonly><?= $oDadoAutorizacao->e54_resumo; ?></textarea>
      </td>
    </tr>
  </table>
</fieldset>
<fieldset>
  <legend><b>Informações da Autorização</b></legend>
    ...
    $oVerticalTab->add('dadosItensAutorizacao', 'Itens',
      "emp1_empempitem005.php?{$sQueryString}&e60_numemp={$oDadoAutorizacao->e60_numemp}");
    $oVerticalTab->add('dadosItensAutorizacao', 'Solicitação de Compras',
      "func_solicita001.php?{$sQueryString}&lNovaConsulta=true");
    $oVerticalTab->add('dadosItensAutorizacao', 'Processo de Compras',
      "func_pcproc001.php?{$sQueryString}&lNovaConsulta=true");
    $oVerticalTab->show();
    ?>
</fieldset>
</body>
