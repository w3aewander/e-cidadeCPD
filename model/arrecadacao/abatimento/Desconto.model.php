...
class Desconto extends Abatimento {
  ...
  public static function getDescontosPorOrigem($sTipoOrigem, $iChavePesquisa) {
    ...
    if(isset($y50_codauto) && $y50_codauto != ''){
        $sWhere.= " inner join arreauto on arre{$aTiposOrigem[$sTipoOrigem]}.k00_numpre = arreauto.k00_numpre and arreauto.k00_auto =".$y50_codauto;
    }
    if(isset($nl01_codlanc) && $nl01_codlanc != ''){
        $sWhere.= " inner join arrelanc on arre{$aTiposOrigem[$sTipoOrigem]}.k00_numpre = arrelanc.k00_numpre and arrelanc.k00_codlanc =".$nl01_codlanc;
    }
    ...
    $sWhere.= "                                                           ";
    $sSqlDescontos = $oDaoAbatimento->sql_queryDescontos('distinct k125_sequencial', $sWhere);
