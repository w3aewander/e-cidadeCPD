...
if (isset($oGet->pc34_pctipocertif)) {

  echo "
   <script>
     function js_db_libera(){
       parent.document.formaba.pctipocertifdepartamento.disabled=false;
       (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_pctipocertifdepartamento.location.href='com1_pctipocertifdepartamento001.php?pc34_pctipocertif=".@$oGet->pc34_pctipocertif."';
  ";
