...
$sSql .= "       tipo,            \n";
$sSql .= "       descricao,       \n";
$sSql .= "       gestao, o15_recurso, o15_complemento, \n";
$sSql .= "       descr_recurso,                                                                                                                                                         \n";
$sSql .= "       round(sum(case                                                                                                                                                         \n";
...
$sSql .= "               gestao,                                                                \n";
$sSql .= "               o15_recurso,                                                              \n";
$sSql .= "               o15_complemento,                                                              \n";
$sSql .= "               fonterecurso.descricao as descr_recurso,                                       \n";
$sSql .= "                rh73_pd      as pd,                                                                                                                                           \n";
...
$sSql .= "                left  join fonterecurso on orctiporec_id = o15_codigo and exercicio = rh72_anousu \n";
$sSql .= "          where rh72_anousu   = {$oGet->iAno}                                                                                                                                 \n";
$sSql .= "            and rh72_mesusu   = {$oGet->iMes}                                                                                                                                 \n";
$sSql .= "            and rh72_siglaarq = '$sSigla'                                                                                                                                     \n";
$sSql .= "            and rh27_pd not in (3,4,5)                                                                                                                                                  \n";
...
$sSql .= "                left  join fonterecurso on orctiporec_id = o15_codigo and exercicio = rh79_anousu \n";
...
if ($oGet->sPonto == 's') {
    ...
    $sSql .= "        o15_recurso,                                                              \n";
    $sSql .= "        o15_complemento,                                                              \n";
    $sSql .= "        fonterecurso.descricao as o15_descr,                                       \n";
    $sSql .= "        r14_pd,                                                                    \n";
    $sSql .= "        r14_valor                                                                  \n";
    $sSql .= "   from gerfsal                                                                    \n";
    ...
    $sSql .= "        left  join fonterecurso on orctiporec_id = o15_codigo and exercicio = r14_anousu \n";
    $sSql .= "  where rh27_pd not in (3,4,5)                                                               \n";
...
$sSql .= "           ) as x         \n";
$sSql .= "  group by rubric, tipo, descricao, gestao, o15_recurso, o15_complemento, descr_recurso  \n";
$sSql .= "  order by gestao, o15_recurso, o15_complemento, rubric \n";
...
for ($iCont = 0; $iCont < pg_num_rows($rsResultado); $iCont++) {
    ...
    $recurso = sprintf('%s - %s - %s - %s', $gestao, $o15_recurso, $o15_complemento, $descr_recurso);
    $hash = sprintf('%s#%s#%s', $gestao, $o15_recurso, $o15_complemento);
    if ($iContsec != $hash) {
    ...
    if ($oPdf->gety() > $oPdf->h - 30 || $iTroca != 0) {
        ...
        $oPdf->ln(3);
        $oPdf->cell(0, $iAltura, $recurso, 0, 1, "L", 0);
        $iTroca = 0;
        $iPre = 1;
    }
