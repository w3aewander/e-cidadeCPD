...
<div class="container">
    <form name="form1" method="post" action="lic4_geraautorizacaoprocessos.php">
        ...
        <input name="emite2" id="emite2" type="submit"
               value="Processar" <?= ($db_botao == true ? "disabled" : "") ?>>
    </form>
</div>
<?php
db_menu();
...
<script>
    function js_pesquisa_liclicita(mostra) {
        if (mostra == true) {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_liclicita', 'func_liclicita_gera_autorizacao.php?lContratos=1&situacao=1,6,7&validasaldo=1&funcao_js=parent.js_mostraliclicita1|l20_codigo', 'Pesquisa', true);
        } else {
            if (document.form1.l20_codigo.value != '') {
                js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_liclicita', 'func_liclicita_gera_autorizacao.php?lContratos=1&situacao=1,6,7&validasaldo=1&pesquisa_chave=' + document.form1.l20_codigo.value + '&funcao_js=parent.js_mostraliclicita', 'Pesquisa', false);
            } else {
