...
function js_pesquisap30_procapensado(mostra){
  ...
  if(mostra == true){
    var sUrl = 'func_protprocesso.php?grupo=1&apensado='+p58_codproc+'&esta_no_departamento=true&funcao_js=parent.js_mostratipoproc1|0|3';
      js_OpenJanelaIframe("", "db_iframe_proc", sUrl, "Pesquisa", true);

  } else {
    var sUrl = 'func_protprocesso.php?grupo=1&apensado='+p58_codproc+'&esta_no_departamento=true&pesquisa_chave='+p30_procapensado+
