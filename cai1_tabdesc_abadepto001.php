...
include(modification("classes/db_tabdesc_classe.php"));
include(modification("classes/db_tabdescarretipo_classe.php"));
include(modification("classes/db_tabdescdepto_classe.php"));
