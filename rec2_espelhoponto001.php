...
<body>
<div class="container">
  <form id="formEspelhoPonto" action="rec2_processamentoespelhoponto.php">
    <fieldset>
      ...
      <table class="form-container" cellspacing="1">
        ...
        <tr>
          ...
          <td colspan="2" class="field-size-max">
            <select id="exibeMarcacoes" name="iEmiteTodosAfastamentos">
        ...
        <tr>
          ...
          <td>
            <input id="observacoesSim" name="lMostraObservacoes" type="radio" value="S" checked="checked" />Sim
            <input id="observacoesNao" name="lMostraObservacoes" type="radio" value="N" />Não
          </td>
        </tr>
        ...
        <tr id="linhaSelecao">
          ...
          <td>
            <input id="r44_selec" name="iCodigoSelecao" type="text" value="" class="field-size2" />
          </td>
          <td>
    ...
    <input id="aMatriculas" name="aMatriculas" type="hidden"/>
...
<script>
  ...
  oPeriodo.__initDataSugerida(<?=DBPessoal::getCompetenciaFolha()->getAno()?>,<?=DBPessoal::getCompetenciaFolha()->getMes()-1?>);
  ...
  function imprimirEspelhoPonto() {
    ...
    $('aMatriculas').value = aMatriculas.join(',');
    $('formEspelhoPonto').submit();
  }
  ...
  (function() {
    ...
    if(get.imprime) {
      ...
      var oRelatorio = new EmissaoRelatorio('rec2_espelhoponto002.php', {'id': get.id});
      oRelatorio.open();
    }
  }());
</script>
