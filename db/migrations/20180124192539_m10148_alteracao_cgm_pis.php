...
class M10148AlteracaoCgmPis extends PostgresMigration
{
    public function up()
    {
      $sSql = "
      CREATE OR REPLACE FUNCTION fc_cgm_altexc() RETURNS TRIGGER AS $$
        ...
        IF (TG_OP = 'DELETE') THEN    
          ...
          INSERT 
            ...
            INTO cgmalt (
              ...
              IF new.z01_pis != '' AND new.z01_pis !='0' THEN
...
drop trigger tg_cgm_altexc on cgm;

CREATE TRIGGER tg_cgm_altexc
AFTER UPDATE OR DELETE ON cgm
    FOR EACH ROW EXECUTE PROCEDURE fc_cgm_altexc();
