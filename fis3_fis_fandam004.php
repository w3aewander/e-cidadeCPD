...
function js_testacamp(){
  ...
  document.form1.action = 'fis3_fis_fandam00<?=$db_opcao?>.php?pri=true&abas=1&y70_codvist='+vist;
...
function js_vistoria(mostra){
  var vist=document.form1.y70_codvist.value;
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe','func_fis_vistorias.php?funcao_js=parent.js_mostravist|y70_codvist|y70_id_usuario','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe','func_fis_vistorias.php?pesquisa_chave='+vist+'&funcao_js=parent.js_mostravist1','Pesquisa',false);
  }
}
