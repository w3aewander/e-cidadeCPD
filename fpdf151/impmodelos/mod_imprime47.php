...
$this->objpdf->cell(50,3,$GLOBALS['RLj40_refant'] . ': '.$this->refant,0,1,"L",0);
...
if ($this->tipoitbi == "urbano") {
  ...
  $this->objpdf->SetFont('Arial','',8);
  $this->objpdf->cell(15,$altura,@$this->it06_matric,1,0,"L",0);
  ...
  $this->objpdf->cell(41,$altura,(count($this->areaterrenomat)==1?db_formatar($this->areatran,'f',' ',' ',' ',10).($this->tipoitbi=="urbano"?'m2':'ha'):(strlen($this->areaterrenomat[1])>2?$this->areatran:db_formatar($this->areatran,'f',' ',' ',' ',10).($this->tipoitbi=="urbano"?'m2':'ha'))),1,1,"R",0);
  $this->objpdf->setx(100);
  $this->objpdf->SetFont('Arial','B',8);
...
if (isset($this->dataLiberado) && $this->dataLiberado != ""){
  ...
  $this->objpdf->SetFont('Arial','',6);
  $this->objpdf->cell(23,$altura, $this->dataLiberado,1,0,"R",0);
}
...
if ($this->lLiberado && $this->imprimefichacompensacao) {
