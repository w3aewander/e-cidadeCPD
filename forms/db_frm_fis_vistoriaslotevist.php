...
function js_pesquisay05_vistoriaslote(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistoriaslote','func_fis_vistoriaslote.php?funcao_js=parent.js_mostravistoriaslote1|y06_vistoriaslote|y06_usuario','Pesquisa',true);
  }else{
     if(document.form1.y05_vistoriaslote.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistoriaslote','func_fis_vistoriaslote.php?pesquisa_chave='+document.form1.y05_vistoriaslote.value+'&funcao_js=parent.js_mostravistoriaslote','Pesquisa',false);
     }else{
...
function js_pesquisay05_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist|y70_id_usuario','Pesquisa',true);
  }else{
     if(document.form1.y05_codvist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y05_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistoriaslotevist','func_fis_vistoriaslotevist.php?funcao_js=parent.js_preenchepesquisa|y05_vistoriaslotevist','Pesquisa',true);
}
