 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_benstransfcodigo.location.href='pat1_benstransfcodigo001.php?db_opcaoal=33&t95_codtran=".@$t93_codtran."';
     ";
         if(isset($liberaaba)){
