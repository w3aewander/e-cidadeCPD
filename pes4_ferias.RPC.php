...
try {
  ...
  switch ($oParametros->sExecucao) {
    ...
    case 'cadastrarPeriodoGozo' :
      ...
      if ($oParametros->iDiasPecunia > 0 && $oParametros->iDiasGozo == 0) {

          $mes = str_pad(DBPessoal::getMesFolha(), "0", 2, STR_PAD_LEFT);;
          $ano = DBPessoal::getAnoFolha();
          $oParametros->sDataPeriodoInicial = "{$ano}/{$mes}/{01}";
          $oParametros->sDataPeriodoFinal   = "{$ano}/{$mes}/{01}";
      }
      ...
      if ($oParametros->iDiasPecunia > 0 && $oParametros->iDiasGozo == 0) {
          ...
          $ano = DBPessoal::getCompetenciaFolha()->getAno();
          $mes = DBPessoal::getCompetenciaFolha()->getMes();
          $iCompetenciaPagamento = strtotime("{$ano}-{$mes}-01");
      }
      ...
      $oPeriodoGozo->setDiasAPagar($oParametros->iDiasAPagar);
      $oPeriodoGozo->salvar();
