...
class cl_cgmalt {
   ...
   var $campos = "
                 ...
                 z05_nome = varchar(40) = Nome/Raz�o Social
                 z05_nacion = int4 = Nacionalidade
                 z05_munic = varchar(20) = Munic�pio
                 ...
                 z05_ender = varchar(100) = Endere�o
                 ...
                 z05_ultalt = date = Ultima Altera��o
                 z05_mae = varchar(40) = M�e
   ...
   function incluir ($z05_sequencia){
     ...
     if($this->z05_nome == null ){
       $this->erro_sql = " Campo Nome/Raz�o Social nao Informado.";
     ...
     if($z05_sequencia == "" || $z05_sequencia == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $z05_sequencia)){
         $this->erro_sql = " Campo z05_sequencia maior que �ltimo n�mero da sequencia.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cgm's Alterados ou Excluidos ($this->z05_sequencia) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Cgm's Alterados ou Excluidos j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Cgm's Alterados ou Excluidos ($this->z05_sequencia) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($z05_sequencia=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cgm's Alterados ou Excluidos nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cgm's Alterados ou Excluidos nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$z05_sequencia;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
