...
<body class="body-default">
  ...
  $('btnProcessar').observe('click', function() {
    ...
    var procedimento = oGet.lDesprocessar == 'true' ? 'desprocessamento' : 'processamento';
    var mensagem = "Este "+procedimento+" pode demorar algum tempo para execução devido a quantidade de empenhos envolvidos.\n\nDeseja continuar?";
    if (!confirm(mensagem)) {
        return false;
    }
