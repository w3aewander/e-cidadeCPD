  ...
  <fieldset>
    ...
    <table class="form-container">
      ...
      <tr>
        ...
        <td>
            ...
            if ($clparprojetos->numrows > 0) {
                ...
                db_msgbox("Configurar parâmetros para o Exercício de " . db_getsession('DB_anousu'));
                $db_opcao_habite = 3;
                $db_opcao = 3;
            }
      ...
      <tr>
        ...
        <td>
            <?php
            db_input('ob09_codconstr', 15, $Iob09_codconstr, true, 'text', ($db_opcao == 2 ? 3 : $db_opcao),
    ...
    <table class="form-container">
      ...
      <tr>
        ...
        <td>
            <?php
            db_inputdata('ob09_datafinalobra', '', '', '', true, 'text', $db_opcao);
            ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td align="left">
            ...
            db_input('ob09_area', 15, $Iob09_area, true, 'text', $db_opcao,
              "onChange='js_verificaarea();' onkeypress='return validaMonetario(this, event)'")
            ?>
        </td>
      </tr>
    </table>
