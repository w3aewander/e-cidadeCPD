...
<form id="formPesquisarEsocial" method="POST" action="eso4_alteradadoscadastrais002.php" class="container">
    <fieldset>
        <legend>Confer&ecirc;ncia dos dados informados pelo servidor:</legend>
        <table class="form-container">
            ...
            <tr>
                ...
                <td>
                    <?php db_input('z01_nome', 50, $Iz01_nome, true, "text", $db_opcao); ?>
                    <input type="hidden" id="semVinculo" name="semVinculo" value=""/>
                </td>
            </tr>
        </table>
    </fieldset>
...
<script>
    (function () {
        ...
        var oLookUpCgm = new DBLookUp($('lbl_rh01_regist'), $('rh01_regist'), $('z01_nome'), {
            ...
            'fCallBack': function (matricula, nome, vinculoEmpregaticio) {
                $('semVinculo').value = (vinculoEmpregaticio != 1);
            },
            'aCamposAdicionais': ['rh30_vinculoemprego']
        });
    })();
</script>
