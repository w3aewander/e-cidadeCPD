                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <table>
                                            <tr>
                                                <td nowrap><?php
                                                    db_ancora(@$Lla22_i_cgs, "js_pesquisala22_i_cgs(true);", 3); ?></td>
                                                <td nowrap>
                                                    <?php
                                                    db_input(
                                                        'la22_i_cgs',
                    ...
                    <fieldset style='width: 95%;'>
                        ...
                        <table style='width: 95%;' border="0">
                            <tr>
                                <td>
                                    <?php
                                    $rResult = $cllab_laboratorio->sql_record(
                                        $cllab_laboratorio->sql_query(
                                            "",
                                            " la02_i_codigo as chave, la02_c_descr as descricao",
                                            "",
                                            ""
                                        )
                                    );
                                ...
                                <td>
                                    ...
                                    if ($cllab_laboratorio->numrows > 0) {
                                        ...
                                        $rResult = $cllab_setorexame->sql_record(
                                            $cllab_setorexame->sql_query(
                                                "",
                                                " la09_i_codigo as chave,la08_c_descr as descricao",
                                                "",
                                                " la24_i_laboratorio=$chave "
                                            )
                                        );
                                        $aExames = array();
...
<script>
    ...
    if (isset($alinhasgrid)) {
        if (count($alinhasgrid) > 0) {
            $xMax = count($alinhasgrid);

            for ($x = 0, $xMax; $x < $xMax; $x++) {
    ...
    function retornaIdadePaciente(retorno) {
        ...
        $('linhaIdade').innerHTML = `<p>Idade: <span style="color: red;">${idadeCompleta}</span></p>`;
