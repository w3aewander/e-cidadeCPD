...
if (isset($incluir)) {
    ...
    for ($i = 0; $i < $oPost->quantidade; $i++) {
        ...
        $oDaoExemplar->bi23_isbn = $oPost->bi23_isbn;
        $oDaoExemplar->bi23_paginacao = $oPost->bi23_paginacao;
        $oDaoExemplar->bi23_volume = $oPost->bi23_volume;
        $oDaoExemplar->bi23_tomo = $oPost->bi23_tomo;
