...
class cl_processoforopartilhacusta {
   ...
   public function cl_processoforopartilhacusta() {
   ...
   public function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->v77_dispensalancamentorecibo = ($this->v77_dispensalancamentorecibo == ""?@$GLOBALS["HTTP_POST_VARS"]["v77_dispensalancamentorecibo"]:$this->v77_dispensalancamentorecibo);
     }else{
       $this->v77_sequencial = ($this->v77_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["v77_sequencial"]:$this->v77_sequencial);
     }
   }
   // funcao para inclusao
   public function incluir ($v77_sequencial){
      $this->atualizacampos();
     ...
     if($this->v77_dispensalancamentorecibo == null ){
     ...
     $sql = "insert into processoforopartilhacusta(
                ...
                values (
                               ...
                               ,$this->v77_valor
                               ,$this->v77_numnov
                               ,'$this->v77_dispensalancamentorecibo'
                      )";
   ...
   public function alterar ($v77_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($v77_sequencial=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ($v77_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") {
   ...
   // funcao do sql
   public function sql_query_file ($v77_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
 ...
 */
public function getProcessoForoByNumpreRecibo($iNumpreRecibo) {
   ...
   */
  public function getCustasProcesso($iNumpreRecibo, $iCodigoProcessoForo, $dtVencimento, $iCadTipo){
   ...
   * @return  integer
   */
  public function getProcessoForoByNumprePacelamento($iNumpre, $iCadTipo) {
   ...
   * @return string
   */
   public function sql_query_recibo( $v77_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
   ...
   */
  public function getNumpresOrigemProcessoForo($iProcessoForo, $iCadTipo) {
   ...
   * @return string - sql
   */
  public function sql_query_taxasFavorecidos($iCodigoProcesso, $sCampos = '*', $iNumnov=null ) {
   ...
   * @return string - $sSql
   */
  public function sql_query_recibo_banco( $v77_sequencial = null, $sCampos = "*", $sOrdem = null, $sWhere = "") {
   ...
   * @param string $campos
   */
  public function sql_buscaPartilhasPorProcessoForo($sequencialProcessoForo, $campos = 'v77_sequencial')
  {
    $sql = "select $campos
              from processoforopartilhacusta
            where v77_processoforopartilha in (
              select v76_sequencial from processoforopartilha where v76_processoforo = $sequencialProcessoForo
              and v76_tipolancamento <> 3
            )";
    return $sql;
  }
}
