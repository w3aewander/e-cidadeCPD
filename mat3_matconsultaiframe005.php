...
?>
  ...
  if (isset($codmater)&&$codmater!="") {
    ...
    $sql= "select distinct m42_codigo,
                ...
                m42_hora,
                m91_codigo,
                db_depart.descrdepto as dl_depósito,
                depto_solicitante.coddepto as dl_código_Departamento,
                depto_solicitante.descrdepto as dl_departamento_solicitante,
                m42_login,
                nome,
                m40_codigo
	  from atendrequi
         ...
         inner join db_almox ON db_almox.m91_codigo = matrequi.m40_almox
         inner join db_depart on db_depart.coddepto = db_almox.m91_depto
         inner join configuracoes.db_depart depto_solicitante ON depto_solicitante.coddepto = matrequi.m40_depto
         inner join db_usuarios on m42_login = id_usuario
		$inner
	where m41_codmatmater = $codmater $where order by 2 desc";
