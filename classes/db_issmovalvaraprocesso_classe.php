...
class cl_issmovalvaraprocesso {
   ...
   public function incluir ($q124_sequencial){
      $this->atualizacampos();
   ...
   public function alterar ($q124_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($q124_sequencial=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $q124_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $q124_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
