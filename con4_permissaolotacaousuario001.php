...
if (isset($oGet->iCodigoUsuario)) {
    $iCodigoUsuario = $oGet->iCodigoUsuario;
}
...
<html>
  ...
  <body class="body-default">
    <form class="container" id="form1" name="form1" method="post">
      <fieldset>
        ...
        <table>
          ...
          ?>
            <tr>
              ...
              <?php 
                  ...
                  if (pg_num_rows($rsInstituicoes) > 0) {
          ...
          <?php
            ...
            if (isset($rsInstituicoes)) {
              for ($iLotacao = 0; $iLotacao < pg_num_rows($rsInstituicoes); $iLotacao++) { 
      ...
      <?php 
        if (isset($oGet->lPesquisa) || !isset($iCodigoUsuario) ) { 
      ?>
        <input type="button" value="Pesquisar" onclick="pesquisaUsuario()" />
      <?php 
        }
      ?>
    </form>
...
<?php
  if (isset($iCodigoUsuario)) { 
     echo "var iCodigoUsuario = {$iCodigoUsuario};";
     echo "buscaDados();";
  } else { 
     echo "pesquisaUsuario();"; 
  }
?>
...
function pesquisaUsuario() {
    ...
    js_OpenJanelaIframe( '',
                         ...
                         'func_db_usuariosalt.php?funcao_js=parent.retornoPesquisa|id_usuario',
                         'Pesquisa',
                         true,
                         '0' );
}

function retornoPesquisa(iUsuario) {
	location.href = 'con4_permissaolotacao001.php?lPesquisa=true&iCodigoUsuario='+iUsuario;
}
