...
<script type="text/javascript">
    ...
    function js_criarLancadorAlmoxarifado() {
        ...
        oLancadorAlmoxarifado.setLabelAncora("Depósito: ");
        oLancadorAlmoxarifado.setTextoFieldset("Selecione os Depósitos");
    ...
    function js_processar() {
        ...
        var dataInicial = $F('dtInicial');
        var dataFinal   = $F('dtFinal');
        if (dataInicial == '') {
        ...
        var oDataInicial      = new Date(partesDataInicial[2], partesDataInicial[1] - 1, partesDataInicial[0]);
        var partesDataFinal   = dataFinal.split("/");
        var oDataFinal        = new Date(partesDataFinal[2], partesDataFinal[1] - 1, partesDataFinal[0]);
        if (oDataInicial > oDataFinal) {
            return alert('Campo Data Inicial deve ser menor que o Campo Data Final.');
        }
        ...
        dtInicial = js_formatar(dataInicial, "d");
        dtFinal = js_formatar(dataFinal, "d");
