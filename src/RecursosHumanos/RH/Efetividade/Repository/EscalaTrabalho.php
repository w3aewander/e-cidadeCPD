...
class EscalaTrabalho {
    ...
    public static function getInstanciaPorCodigo($iGradeHorario) {
        ...
        $sCamposEscalaServidor  = "distinct";
        $sCamposEscalaServidor .= "  gradeshorarios.rh190_sequencial";
        $sCamposEscalaServidor .= " ,gradeshorarios.rh190_descricao";
        ...
        $oEscalaTrabalho->setExtraAutomaticaFeriado($oDadosEscala->rh190_extra_autorizada_feriado);
