...
class Empresa extends Base
{
  ...
  private function montaDadosEmpresa()
  {
    ...
    $dataCadastro = $oDadosEmpresa->data_cadastro;
    if (empty($oDadosEmpresa->data_cadastro)) {
        $dataCadastro = date("Ymd");
    }

    $this->empresa->setDataCadastramento(new \Datetime($dataCadastro));
