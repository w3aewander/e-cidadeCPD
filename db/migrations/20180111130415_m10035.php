...
class M10035 extends PostgresMigration
{

    public function up()
    {
      $this->execute($this->fc_baixabanco());
      $this->execute($this->fc_altera_conta_baixabanco());
    }

    public function down()
    {
       $this->execute($this->fc_baixabanco_down());
       $this->execute($this->fc_executa_baixa_banco_down());
    }

    private function fc_executa_baixa_banco_down()
    {
        $sSql = <<<'STRING'
...
STRING;
    ...
    private function fc_baixabanco_down()
    {
        $sSql = <<<'STRING'
...
STRING;
  ...
  return $sSql;
    ...
    private function fc_baixabanco()
    {
            ...
            if not found then
             ...
             exception
              when raise_exception then
                ...
                raise exception '% | Error : 100035', sMensagemErro;
                return;  
              end;
...
STRING;
    ...
    private function fc_altera_conta_baixabanco()
    {
              ...
              if lAtivaPgtoParcial is false then
                ...
                exception
                  when raise_exception then
                    ...
                    if strpos(sMensagemErro , '100035') > 0 then 
                        raise  exception '%', sMensagemErro;  
                    end if;
