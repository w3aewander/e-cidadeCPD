...
class cl_conplanoexe
{
    ...
    public function sql_query_implantacao_saldos($sDataInicio, $sDataFim, $iInstituicao, $iExercicio, $where = null)
    {
        ...
        $sSql .= " 		    c61_reduz, ";
        $sSql .= " 		    c61_codigo, ";
        $sSql .= " 		    c60_saldocontinuo, ";
        $sSql .= "        round(saldo_anterior, 2)  as saldo_anterior,                 ";
        $sSql .= " 		    round(valor_debito, 2) :: float8 as saldo_anterior_debito,   ";
        $sSql .= " 		    round(valor_credito, 2) :: float8 as saldo_anterior_credito, ";
        $sSql .= " 		    round(saldo_final, 2) :: float8 as saldo_final,              ";
        $sSql .= " 		    natureza_saldo_anterior         as sinal_anterior,   ";
        $sSql .= " 		    natureza_saldo_final            as sinal_final               ";
        $sSql .= " from ( ";
        $sSql .= " 	     select ";
        $sSql .= " 	            c60_anousu, ";
        $sSql .= "              c61_reduz, ";
        ...
        $sSql .= " 	          inner join fc_planosaldonovo_record(c60_anousu, c61_reduz, '{$sDataInicio}', '{$sDataFim}', true) as saldos on saldos.reduzido = c61_reduz";
