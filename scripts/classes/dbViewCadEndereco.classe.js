DBViewCadastroEndereco = function(sId, sNameInstance, iCodigoEndereco, aCamposObrigatorios=[]) {
  ...
  this.aCamposObrigatorios = aCamposObrigatorios;

  // Campos que podem ser obrigatórios
  this.oCamposEndereco = {};

  this.oCamposEndereco[`txtDescrBairro${sId}`] = 1;
  this.oCamposEndereco[`txtDescrRuap${sId}`] = 1;
  this.oCamposEndereco[`txtCodigoNumero${sId}`] = 1;
  this.oCamposEndereco[`txtCepEnd${sId}`] = 1;
  this.oCamposEndereco[`txtDescrPontoReferencia${sId}`] = 1;
...
//  var iWidth = document.width / 1.7;
  ...
  sContent += "           <a id='pesquisacep' href='#' onclick='"+me.sNameInstance+".lookupCep();' tabIndex='1'><b>Pesquisa Cep:</b></a>";
  sContent += "         </td>"
  ...
  sContent += "           <b><a onclick='"+ me.sNameInstance +".lookupMunicipio()' id='ancora-municipio' href='#' onclick=''>Município</a></b>";
  sContent += "         </td>"
  sContent += "         <td id='ctnCodigoMunicipio"+sId+"' colspan='4'>";
  sContent += "           <input id='input-municipio" + sId + "' type='text' style='width:100%;background-color:#DEB887;' readonly  />";
  sContent += "           <input id='cboCodigoMunicipio" + sId + "' type='hidden' />";
  sContent += "         </td>"
  sContent += "       </tr>";
  sContent += "       <tr>";
  sContent += "         <td id='ctnLabelBairro"+sId+"' >";
  sContent += "           <label id='txtDescrBairropri-label' for='txtDescrBairropri"+sId+"'><b>Bairro:</b></label>";
  sContent += "         </td>"
  sContent += "         <td id='ctnCodigoBairro"+sId+"' style='display:none;'>"
  sContent += "         </td>";
  sContent += "         <td id='ctnDescrBairro"+sId+"' colspan='4'>";
  sContent += "         </td>";
  sContent += "       </tr>";
  sContent += "       <tr valign='top'>";
  sContent += "         <td id='ctnLabelRua"+sId+"' style='width:10%;'>";
  sContent += "           <label id='txtDescrRuapri-label' for='txtDescrRuapri' ><b>Rua:</b></label>";
  sContent += "         </td>"
  sContent += "         <td id='ctnCodigoRua"+sId+"' style='width:25%;  display:none; '>"
  sContent += "         </td>";
  sContent += "          <td id='ctnCboRuasTipo"+sId+"' style='width:15%;'>";
  sContent += "          </td>";
  sContent += "          <td id='ctnDescrRua"+sId+"'  style='width:50%;' colspan='3'>";
  sContent += "          </td>";
  sContent += "         </tr>";
  sContent += "       <tr>";
  ...
  sContent += "           <label id='txtCepEndpri-label' for='txtCepEndpri'><b>Cep:</b></label>";
  sContent += "         </td>"
  ...
  sContent += "           <label id='txtDescrPontoReferencia"+sId+"-label' for='txtDescrPontoReferencia"+sId+"'><b>Ponto Referência:</b></label>";
  sContent += "         </td>"
  ...
  this.aCamposObrigatorios.map((campo => {
    var el = document.getElementById(campo.id + '-label');
  ...
  */
  ...
  this.lookupMunicipio = function() {
    var idPais = $('cboCodigoPais' + sId).value;
    var idEstado = $('cboCodigoEstado' + sId).value;

    js_OpenJanelaIframe(
      '',
      'db_iframe_municipio',
      'func_municipio.php?funcao_js=parent.' + me.sNameInstance + '.retornoLookupMunicipio|db72_sequencial|db72_descricao&id_pais='+ idPais +'&id_estado=' + idEstado,
      'Consultar Município',
      true
    );

    $('Jandb_iframe_municipio').style.zIndex = 100000;
  }

  this.retornoLookupMunicipio = function() {
    this.setMunicipio(arguments[0]);
    $('cboCodigoMunicipio' + sId).value = arguments[0];
    $('input-municipio' + sId).value = arguments[1];
    me.setNomeMunicipio(arguments[1]);

    db_iframe_municipio.hide();
  }
  ...
  this.lookupCep = function() {
    ...
    js_OpenJanelaIframe('', 'db_iframe_cep',
                        'func_cadenderruacep_personalizada.php?funcao_js=parent.'+me.sNameInstance+'.retornoLookupCep|db86_cep|db73_descricao',
                        'Consultar CEP', true);
  ...
  this.retornoLookupCep = function() {
    ...
    me.pesquisaCep();
    document.getElementById('txtCodigoNumeropri').focus();
  }
  ...
  this.retornoFindCep = function (oAjax) {
    ...
    $('txtDescrRua'+me.sId).disabled = "";
    $('txtCodigoRua'+me.sId).disabled = "";
    $('txtDescrBairro'+me.sId).disabled = "";
    $('txtCodigoBairro'+me.sId).disabled = "";
    $('txtCepEnd'+me.sId).disabled = "";

    $('txtDescrRua'+me.sId).setAttribute('class', '');
    $('txtCodigoRua'+me.sId).setAttribute('class', '');
    $('txtDescrBairro'+me.sId).setAttribute('class', '');
    $('txtCodigoBairro'+me.sId).setAttribute('class', '');
    $('txtCepEnd'+me.sId).setAttribute('class', '');
    ...
    if (oRetorno.endereco != false) {
      ...
      //if (iNumReg == 1) {
        ...
        me.setNomeMunicipio(oRetorno.endereco[0].smunicipio.urlDecode());
        $('input-municipiopri').value = oRetorno.endereco[0].smunicipio.urlDecode();
...
//-------------------------------------Início da Manipulação da Rua-----------------------------------------------------
  ...
  me.oCboRuasTipo.addStyle('width', '140px');
...
//-------------------------------------Fim da Manipulação do Ponto de Referência----------------------------------------
  ...
  this.show = function() {
    ...
    document.getElementById('pesquisacep').focus();
  }
  ...
  */
  this.buscaEndereco = function() {
    ...
    if (me.getCgmMunicipio() == true && me.getCodigoRuaMunicipio() != "") {
      ...
      if($('cgsMunicipio')) {
        ...
        oEndereco.ismunicipio     = $F('cgsMunicipio');
      }
  ...
  this.retornoBuscaBairroRuaMunicipio = function (oAjax) {
    ...
    if (!oRetorno) {
      ...
      var iRuasTipo2 = oRetorno.bairroRuaMunicipio[0].iruatipo;

      me.preencheCboEstados(oRetorno.estados, iEstado);
      me.preencheCboRuasTipo(oRetorno.tiposRua, iRuasTipo2);
      ...
      $('txtCepEnd'+sId).value = oRetorno.bairroRuaMunicipio[0].iruascep!=""?oRetorno.bairroRuaMunicipio[0].iruascep:oRetorno.cepmunic[0].cep;
      $('txtCepEnd'+sId).disabled = "disabled";
      me.setCepEndereco($F('txtCepEnd'+sId));
  ...
  this.retornoBuscaValoresPadrao = function (oAjax) {
    ...
    if (!oRetorno) {
      ...
      if (me.getCodigoRuaMunicipio().trim().length <= 0) {
  ...
  this.retornoBuscaEndereco = function (oAjax) {
    ...
    if (oRetorno.status == 2) {
      ...
      $('cboCodigoMunicipio'+sId).value            = oRetorno.endereco.iMunicipio;
      $('input-municipio'+sId).value               = oRetorno.endereco.sMunicipio.urlDecode();

      me.setMunicipio(oRetorno.endereco.iMunicipio);
      me.setNomeMunicipio(oRetorno.endereco.sMunicipio.urlDecode());
      ...
      /**
       * Validação implementada devido a insconsistências que ocorriam ao instalar o plugin CadastroCgmNov, responsável
       * por filtrar os municípios a serem apresentados
       */
      if(js_search_in_array(me.municipios, oRetorno.iCodigoMunicipio)) {
 ...
 /**
  ...
  this.salvarEndereco = function() {
    ...
    let string = me.getComplemento().toUpperCase();
    let result = string.includes("'");
    let result1 = string.includes('"');

    if(result || result1){
      alert("Caracteres especiais como ' e \" não são permitidos");
      return ;
    }
    
    for (var i = 0; i < aCamposObrigatorios.length; i++) {
      var id = aCamposObrigatorios[i].id;
      var label = aCamposObrigatorios[i].label;

      if (!this.oCamposEndereco[id]) {
        continue;
      }
      ...
      if (el && el.value === '') {
        mensagem += mensagem ? ', ' + label : label;
      }
    }

    if (mensagem) {
      return alert(`Os seguintes campos devem ser preenchidos: ${mensagem}`);
    }
    ...
    //verifica se o Bairro tem mais de 40 caracteres

    if ($F('txtDescrBairro'+sId).length > 40) {
        alert("Campo Bairro está preenchido com mais de 40 caracteres. Abrevie as informações!");
        return false;
    }
    ...
    if(me.getNomeRua() == '' && $F('txtDescrRua'+sId) != '') {

       me.setNomeRua($F('txtDescrRua'+sId))
    }

    if(me.getNumero() == '' && $F('txtCodigoNumero'+sId) != '') {
    ...
    oEndereco.descricaoMunicipio       = me.getNomeMunicipio();
  ...
  this.retornoSalvaEndereco = function (oAjax) {
    ...
    if (oRetorno.status == 1) {
      ...
      if($(`janela-${sId}-id-municipio`)) {

        $(`janela-${sId}-id-municipio`).value        = oRetorno.icodigoMunicipio;
      }

      if($(`janela-${sId}-descricao-municipio`)) {

        $(`janela-${sId}-descricao-municipio`).value = oRetorno.sDescricaoMunicipio;
      }
      ...
      me.objRetorno.parentNode.children[2].focus();
      me.close();
      me.callBackFunction();
      return false;
      //alert(oRetorno.message.urlDecode().replace(sExpReg,'\n'));
  ...
  this.setEnderecoMunicipio = function(lEnderecoMunicipio) {
    ...
    $('btnPesquisarCep'+sId).disabled = lEnderecoMunicipio;
    $('cboCodigoMunicipio'+sId).value = me.getMunicipio() ? me.getMunicipio : '';
  }
