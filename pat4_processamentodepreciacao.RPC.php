  ...
  case "getMesesDepreciadosParaCancelamento":
   ...
   case 'cancelarProcessamento':
     ...
     try {
        ...
        * pela contabilidade
        * Caso foi não deixa desprocessar a depreciação
        */
       ...
       if($oDaoBensDepreciacaoLancamento->numrows > 0) {
         throw new Exception("Depreciação já contabilizada para a competência {$oParam->iMesDesprocessar}/{$iAnoSessao} na contabilidade.");
       }
