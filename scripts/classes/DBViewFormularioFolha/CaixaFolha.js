...
/**
 * Cria os elementos de mês e ano para exibição da Caixa, é possivel escolher se quer que realize a busca de Apuração atual.
 *
 * @param lExibeDataAtual Valor logico, se true carrega a Caixa atual caso contrário fica em branco.
 * @constructor
 */
DBViewFormularioFolha.CaixaFolha = function( lExibeDataAtual ) {
 ...
 */
DBViewFormularioFolha.CaixaFolha.prototype.criaFormularioCaixa = function () {
  
  var oFormularioCaixa                     = document.createElement('div');
   ...
   */
  this.oAno = new DBTextField('anoCaixa', 'anoCaixa', this.iAno, 4);
  this.oMes = new DBTextField('mesCaixa', 'mesCaixa', this.iMes, 2);
   ...
   */
  oFormularioCaixa.appendChild(this.oElementosHTML.oSpanAno);
  oFormularioCaixa.appendChild(this.oElementosHTML.oTextoSeparador);
  oFormularioCaixa.appendChild(this.oElementosHTML.oSpanMes);
  
  //js_ValidaCampos
  
  return oFormularioCaixa;
};
 ...
 */
DBViewFormularioFolha.CaixaFolha.prototype.criaLabelCaixa = function () {
 
  var oLabelCaixa           = document.createElement('label');
  this.oElementosHTML.oTextoLabel = document.createTextNode('Período de Apuração (Dta Pagamento): ');
  oLabelCaixa.appendChild(this.oElementosHTML.oTextoLabel);
  return oLabelCaixa;
};
 ...
 * @returns void
 */
DBViewFormularioFolha.CaixaFolha.prototype.buscaMesAnoFolha = function() {
  this
  var oParam = {
...
/**
 * Retorna um objeto com o HTML contendo o Input das Caixas
 * @return [HTMLElement DIV] - Com os elementos do componente
 */
DBViewFormularioFolha.CaixaFolha.prototype.getElementosFormulario = function() {
  return this.criaFormularioCaixa();
};

/**
 * Retorna um obejeto contendo o Label da Caixa
 * @return label
 */
DBViewFormularioFolha.CaixaFolha.prototype.getElementoLabel = function() {
  return this.criaLabelCaixa();
};
 ...
 */
DBViewFormularioFolha.CaixaFolha.prototype.renderizaFormulario = function(oContainer) {
  ...
  this.oAno.getElement().onchange = function(event) { 
    if (js_ValidaCampos(this, 1, 'Ano de Apuração', true, false, event)) {
  ...
  this.oMes.getElement().onchange = function(event) { 
    ...
    if (js_ValidaCampos(this, 1, 'Mês de Apuração', true, false, event)) {
 ...
 */
DBViewFormularioFolha.CaixaFolha.prototype.renderizaLabel = function(oContainer) {
 ...
 * @return void
 */
DBViewFormularioFolha.CaixaFolha.prototype.desabilitarFormulario = function() {
 ...
 * @return void
 */
DBViewFormularioFolha.CaixaFolha.prototype.habilitarFormulario = function() {
 ...
 */
DBViewFormularioFolha.CaixaFolha.prototype.setCallBack = function( fFuncao ){
  
  if ( fFuncao == null) {
    fFuncao =  DBViewFormularioFolha.CaixaFolha.callBackPadrao;   
  }
...
/**
 * Valida se a Caixa é igual a informada
 *
 * @param {Caixa} oCaixa
 * @returns {Boolean}
 */
DBViewFormularioFolha.CaixaFolha.prototype.equalsTo = function (oCaixa) {
  ...
  if (oCaixa != 'undefined' || oCaixa != undefined) {
    if (iAnoAtual == oCaixa.iAno && iMesAtual == oCaixa.iMes) {
      return true;
    }
  }
 ...
 * @returns {Boolean}
 */
DBViewFormularioFolha.CaixaFolha.prototype.isCaixaValida = function (iAno, iMes) {
 ...
 */
DBViewFormularioFolha.CaixaFolha.callBackPadrao = function() {};
