...
class RegraLancamentoContabil
{
     ...
     * @var integer
     */
    const COMPARA_TIPO_RETENCAO = 15;
    ...
    public function __construct($iSequencialRegra = null)
    {
        ...
        if (!empty($iSequencialRegra)) {
            ...
            $oDaoRegraLancamento = new cl_contranslr;
    ...
    public function salvar()
    {
        ...
        if ($oDaoConTransLr->erro_status == 0) {
            throw new Exception("Não foi possível salvar as regras do lançamento. {$oDaoConTransLr->erro_msg}");
        }
    ...
    public function excluir()
    {
        ...
        $oDaoRegraEventoContabil = new cl_contranslr;
    ...
    public function salvarVinculoEventoInverso($iRegraLancamentoEventoInverso, $lEventoInclusao)
    {
         ...
         */
        $oDaoContranslrvinculo = new cl_contranslrvinculo;
