...
<script>
  ...
  /*function js_imprimirDespachos(){
    window.open('ouv1_controleatendlistadesprel002.php?aObjDespachos='+$F('despachos')+'&iCodProc='+$F('p58_codproc'),'Relatório de Processo',false);
  }*/

  function js_imprimirDespachos(){
    window.open('ouv1_reldetalhesprocesso002.php?iAtendimento='+<?=$oGet->iAtendimento?>+'&iProcesso='+$F('p58_codproc')+'&sAtendimentosVinculados=1&sDespachos=1&permissao=true', 'Relatório de Processo',false);
  }
