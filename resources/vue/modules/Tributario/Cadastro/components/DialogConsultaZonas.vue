    ...
    >
        <section style="width: 100%" class="m-auto">
            ...
            >
                    ...
                    <form class="flex flex-row justify-center m-auto flex-wrap" ref="form">
                        <span class="p-input-icon-left m-2 flex flex-column">
                            ...
                            <InputText
                                ...
                                v-model="data.form.j225_sequencial"
                            />
                        </span>
                        <span class="p-input-icon-left m-2 flex flex-column">
                            <label for="j225_sigla">{{
                                'Sigla'
                            }}</label>
                            <InputText
                                :useGrouping="false"
                                placeholder=""
                                class="padding-custom p-inputtext-md shadow-4"
                                v-model="data.form.j225_sigla"
                            />
                        </span>
                        <span class="p-input-icon-left m-2 flex flex-column">
                            <label for="j225_descricao">{{
                                'Descrição'
                            }}</label>
                            <InputText
                                :useGrouping="false"
                                placeholder=""
                                class="padding-custom p-inputtext-md shadow-4"
                                v-model="data.form.j225_descricao"
                            />
                        </span>
                        <span class="p-input-icon-left m-2 flex flex-column">
                            <label for="j224_localizacao">{{
                                'Localização Macrozona'
                            }}</label>
                            <InputText
                                :useGrouping="false"
                                placeholder=""
                ...
                />
                <Column
                    field="j225_descricao"
                    header="Descrição"
                />
                <Column
                    field="j224_localizacao"
                    header="Localização Macrozona"
                />
                <Column
                    field="j224_sigla"
                    header="Sigla Macrozona"
                />
            </DataTable>
...
function onRowSelect(event) {
    ...
    emit("selectRow", {
        j225_sequencial: event.data.j225_sequencial,
        j225_sigla: event.data.j225_sigla,
        j224_localizacao: event.data.j224_localizacao,
        j225_descricao: event.data.j225_descricao,
...
function limparCampos() {
    data.data = [];
    data.form.j225_sequencial = "";
    data.form.j225_sigla = "";
    data.form.j224_localizacao = "";
    data.form.j225_descricao = "";
}
...
function pesquisaListaZonas(parametros) {
    return window.axios.post(
        "v4/api/tributario/cadastro/get-zonas",
        parametros
    );
}
...
async function carregaResultados() {
    ...
    const sequencial = data.form.j225_sequencial;
    const sigla = data.form.j225_sigla;
    const localizacao = data.form.j224_localizacao;
    const descricao = data.form.j225_descricao;
    ...
    pesquisaListaZonas(parametrosPesquisa)
        .then((response) => {
