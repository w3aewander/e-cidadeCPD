...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmissarqsimples.php"));
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_issarqsimplesreg.location.href='iss1_issarqsimplesreg001.php?db_opcaoal=33&q23_sequencial=".@$q17_sequencial."';
     ";
         if(isset($liberaaba)){
