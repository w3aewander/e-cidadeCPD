...
switch ($oParam->exec){
  ...
  case 'buscaContas': 
    ...
    $sWhereContas .= "                     inner join contabancaria on db83_sequencial = k68_contabancaria ";
    $sWhereContas .= "                     inner join conplanocontabancaria on c56_contabancaria = db83_sequencial and c56_anousu = " . db_getsession("DB_anousu");
    $sWhereContas .= "                     inner join conplanoreduz on c61_reduz = c56_reduz  and c56_anousu = c61_anousu  ";
    $sWhereContas .= "               where k68_contabancaria = x.db83_sequencial ";
    $sWhereContas .= "                 and k68_data = x.k68_data ";
    $sWhereContas .= "                 and c61_instit = ".db_getsession("DB_instit");
    ...
    $sqlConta   .= "        coalesce((select c61_reduz::varchar ";
    ...
    $sqlConta   .= "                                      and c61_reduz  = c56_reduz  ";
    $sqlConta   .= "                                      and c61_anousu = c56_anousu ";
    $sqlConta   .= "         where contabancaria.db83_sequencial = x.db83_sequencial limit 1 ),' ')||' - '||db83_descricao as db83_descricao,       ";
    $sqlConta   .= "        k68_data                                                                                         ";
    $sqlConta   .= "   from (                                                                                                ";
    $sqlConta   .= " select db83_sequencial,                                                                                 ";
