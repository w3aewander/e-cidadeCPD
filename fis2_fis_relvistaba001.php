...
$sanitario = new cl_fis_sanitario;
      ...
      <tr>
        <td colspan=2 >
	      <?php
				...
				$aux->sql_exec  = "";
				$aux->func_arquivo = "func_fis_tipovistorias.php";
...
function js_pesquisay76_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_abreconsulta|y70_codvist','Pesquisa',true);
  }else{
