...
include(modification("classes/db_lab_entrega_classe.php"));
...
//AO UTILIZAR ESSA FUNC, LEVAR EM CONSIDERAÇÃO O CAMPO la33_ativo PARA O MÉTODO $cllab_entrega->sql_query. TAREFA REDMINE:29303
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_lab_entrega.php")==true){
             include(modification("funcoes/db_func_lab_entrega.php"));
           }else{
           $campos = "lab_entrega.*";
           }
        }
