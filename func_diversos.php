      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_diversos.php")==true){
             include(modification("funcoes/db_func_diversos.php"));
           }else{
             $campos = "diversos.*";
           }
        }
        ...
        if(isset($chave_dv05_coddiver) && (trim($chave_dv05_coddiver)!="") ){
	         $sql = $cldiversos->sql_query_func("",$campos,"dv05_coddiver"," dv05_coddiver = $chave_dv05_coddiver and dv05_instit = ".db_getsession('DB_instit')."");
        }else if(isset($chave_dv05_numcgm) && (trim($chave_dv05_numcgm)!="") ){
	         $sql = $cldiversos->sql_query_func("",$campos,"dv05_numcgm"," dv05_numcgm = $chave_dv05_numcgm and dv05_instit = ".db_getsession('DB_instit')." ");
	    /////// inscrição /////////////////////
        }else if(isset($chave_k00_inscr) && (trim($chave_k00_inscr)!="") ){
	         $sql = $cldiversos->sql_query_func("",$campos,"k00_inscr"," k00_inscr = $chave_k00_inscr and dv05_instit = ".db_getsession('DB_instit')." ");
	    /////// matricula /////////////////////
	    }else if(isset($chave_k00_matric) && (trim($chave_k00_matric)!="") ){
           $sql = $cldiversos->sql_query_func("",$campos,"k00_matric"," k00_matric = $chave_k00_matric and dv05_instit = ".db_getsession('DB_instit')." ");
	    //////////////////////////////////////*/
