            ...
            if (!isset($pesquisa_chave)) {
                if (isset($campos) == false) {
                    if (file_exists("funcoes/db_func_matordem.php") == true) {
                        include(modification("funcoes/db_func_matordemanulada.php"));
                    } else {
                        $campos = "matordem.*";
                    }
                }
                ...
                $sql = $clmatordem->sql_query_anu("", $campos, "m51_codordem", implode(' and ', $where));
                db_lovrot($sql, 15, "()", "", $funcao_js);
            } else {
                if ($pesquisa_chave != null && $pesquisa_chave != "") {
                    $result = $clmatordem->sql_record($clmatordem->sql_query_anu($pesquisa_chave . " and " . implode(' and ', $where)));
