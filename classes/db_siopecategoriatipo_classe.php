   ...
   // cria propriedade com as variaveis do arquivo 
    ...
    public function incluir($si02_id)
    {
     ...
     if($si02_id == "" || $si02_id == null ){
       ...
       $this->si02_id = pg_result($result,0,0); 
     }else{
       $result = db_query("select last_value from siopecategoriatipo_id_seq");
       if(($result != false) && (pg_result($result,0,0) < $si02_id)){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,222747221,231694548,'','".AddSlashes(pg_result($resaco,0,'si02_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,222747221,80666448,'','".AddSlashes(pg_result($resaco,0,'si02_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
    ...
    public function alterar($si02_id=null)
    {
     ...
     $virgula = "";
     if(trim($this->si02_id)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si02_id"])){ 
       $sql  .= $virgula." si02_id = $this->si02_id ";
       $virgula = ",";
       if(trim($this->si02_id) == null ){ 
     ...
     if(trim($this->si02_descricao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si02_descricao"])){ 
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["si02_id"]) || $this->si02_id != "")
             $resac = db_query("insert into db_acount values($acount,222747221,231694548,'".AddSlashes(pg_result($resaco,$conresaco,'si02_id'))."','$this->si02_id',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["si02_descricao"]) || $this->si02_descricao != "")
             $resac = db_query("insert into db_acount values($acount,222747221,80666448,'".AddSlashes(pg_result($resaco,$conresaco,'si02_descricao'))."','$this->si02_descricao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,222747221,231694548,'','".AddSlashes(pg_result($resaco,$iresaco,'si02_id'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,222747221,80666448,'','".AddSlashes(pg_result($resaco,$iresaco,'si02_descricao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
