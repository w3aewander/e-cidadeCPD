...
$rsConsultaProc = db_query(" select y112_procfiscal as procfiscal from fiscalizacao.fis_procfiscallevanta where y112_levanta = $y61_codlev");
if( pg_num_rows( $rsConsultaProc ) > 0 ){
    db_fieldsmemory($rsConsultaProc,0);
} 

?>
<form name="form1" method="post" action="fis1_fis_levusu001.php">
<center>
<table border="0">
  <tr>
  <td align='center'>
...
<?php }?> 
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_levusu','db_iframe_db_usuarios','func_fis_cadfiscais.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome'+sUrl,'Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_levusu','db_iframe_db_usuarios','func_fis_cadfiscais.php?pesquisa_chave='+document.form1.y61_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios'+sUrl,'Pesquisa',false);
  }
}
