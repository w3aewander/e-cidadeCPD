...
if(isset($excluir)){
  ...
  if(isset($r54_regist) && $r54_regist != ""){
  	$dbwhere .= " and trim(r54_regist) = ".$r54_regist;
  }
  if(isset($r54_codeve) && $r54_codeve != ""){
  	$dbwhere .= " and trim(r54_codeve) = '".$r54_codeve."' ";
  }
  $result_dados_importados = $clmovrel->sql_record($clmovrel->sql_query_file(null,"r54_sequencial as sequencial, r54_codrel as codrel, r54_regist as regist, r54_codeve as codeve","",$dbwhere));
  $sqlerro = false;
...
//    echo "<BR> ".$clrelac->sql_query_file($codeve,db_getsession("DB_instit"),"r55_rubr01 as rub01,r55_rubr02 as rub02,r55_rubr03 as rub03");exit;
      ...
      $clmovrel->r54_sequencial = $sequencial;
      $clmovrel->alterar($sequencial);
