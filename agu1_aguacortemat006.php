...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmaguacortemat.php"));
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguacortematmov.location.href='agu1_aguacortematmov001.php?db_opcaoal=33&x42_codmov=".@$x42_codmov."&x42_codcortemat=".@$x41_codcortemat."';
         parent.document.formaba.aguacortematnumpre.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguacortematnumpre.location.href='agu1_aguacortematnumpre001.php?db_opcaoal=33&x44_codcortematnumpre=".@$x41_codcortematnumpre."&x44_codcortemat=".@$x41_codcortemat."';
     ";
         if(isset($liberaaba)){
