...
require_once("scripts/classes/DBViewLancamentoAvaliacaoTurma2.classe.js");
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2 = function (sId, nameInstance ) {
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.renderizaCabecalhoGrid = function (iCodigoTurma, iCodigoEtapa) {
 ...
 * @param {String} oAjax
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.retornoCabecalhoGrig = function (oAjax) {
 ...
 * @param {integer} iCodigoEtapa
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.buscaDadosDaTurma = function(iCodigoTurma, iCodigoEtapa) {
 ...
 * @param {string} oAjax
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.retornoDadosDaTurma = function(oAjax) {
  ...
  /**
   * variável oSelf identifica a instância da classe DBViewFiltroLancamentoAvaliacaoTurma2
   */
  var oSelf    = this;
  var oRetorno = eval('('+oAjax.responseText+')');
...
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.criarInstanciaLancamentoAvaliacoes = function (oDadosTurma) {  
  this.oInstanceAvaliacaoTurma = new DBViewLancamentoAvaliacaoTurma2(oDadosTurma);  
};
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.salvarAulasDadas = function (iRegencia, iPeriodoAvaliacao, iTotalAulas) {
 ...
 * @param {string} oAjax
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.retornoSalvarAulasDadas = function(oAjax) {
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.getDados = function(iCodigoTurma, iCodigoEtapa) {
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.show = function(oElement) {
 ...
 * 2 - Cancelar
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.encerramentoAvaliacoes = function( iAcao ) {
 ...
 */
DBViewFiltroLancamentoAvaliacaoTurma2.prototype.setaFuncaoCelula = function( aIdDadosEventosDisciplina ) {
