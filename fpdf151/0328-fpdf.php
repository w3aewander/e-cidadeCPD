...
function Header()
{
  ...
  $menu = db_getsession("DB_itemmenu_acessado");
  
  
  if($modulo == 1100747 && $menu == 1100956){
    global $conn;
    global $result;
    global $url;
    global $iEscola;
    ...
    if(db_getsession("DB_instit") == 96){
      $this->Text(33,7,"ESTADO DO RIO DE JANEIRO");
      $this->Text(33,10,"PREFEITURA MUNICIPAL DE VOLTA REDONDA");
      $this->Text(33,13,"SECRETARIA MUNICIPAL DE EDUCAÇÃO");
      $this->Text(33,18,$nomeescola);
      $this->SetFont('Arial','I',8);
      $this->Text(33,21,$ruaescola.", ".$numescola." - ".$bairroescola);
      $this->Text(33,24,$cidadeescola." - ".$estadoescola);
      $this->Text(33,27,$telefoneescola);
    }else{
      $this->Text(33,9,$nome);  
    ...
    $this->Text(33,31,($emailescola!=""?$emailescola:""));
...
function Hextra($xx, $yy){    
  ...
  //$this->cell(192, 4, "TESTES", 1, 1, "C", 1);
  $this->Image('imagens/files/'.pg_result($dados,0,"logo"),$xx,$yy,20);
  ...
  */
  ...
  $this->SetFont('Arial','BI',$TamFonteNome);  
  $this->Text(33,7+$yy,"ESTADO DO RIO DE JANEIRO");
  $this->Text(33,10+$yy,"PREFEITURA MUNICIPAL DE VOLTA REDONDA");
  $this->Text(33,13+$yy,"SECRETARIA MUNICIPAL DE EDUCAÇÃO");
  $this->Text(33,18+$yy,$nomeescola);
  $this->SetFont('Arial','I',8);
  $this->Text(33,21+$yy,$ruaescola.", ".$numescola." - ".$bairroescola);
  $this->Text(33,24+$yy,$cidadeescola." - ".$estadoescola);
  $this->Text(33,27+$yy,$telefoneescola);
  
  

  $comprim = ($this->w - $this->rMargin - $this->lMargin);
  //$this->Text(33,32+$yy,($emailescola!=""?$emailescola." - ":"").$url);
  $this->Text(33,31+$yy,($emailescola!=""?$emailescola:""));
  $Espaco = $this->w - 80 ;
  $this->SetFont('Arial','',7);
  $margemesquerda = $this->lMargin;
  $this->setleftmargin($Espaco);
  ...
  if(db_getsession("DB_itemmenu_acessado") == 7011){
    $this->line(10,33+$yy,$comprim,33);    
  }else{
    $this->setfillcolor(235);
    $this->roundedrect($Espaco - 3,5+$yy,75,28,2,'DF','123');
    $this->line(10,33+$yy,$comprim,33+$yy);
    //$this->line(10,33,$comprim,33);    
    $this->setfillcolor(255);
    $this->multicell(0,3,@$GLOBALS["head1"],0,1,"J",0);
    $this->multicell(0,3,@$GLOBALS["head2"],0,1,"J",0);
