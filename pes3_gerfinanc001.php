...
if ( empty($ano) || empty($mes) ) {
  ...
  $ano = !empty($oPost->ano) ? $oPost->ano : DBPessoal::getAnoFolha();
  $mes = !empty($oPost->mes) ? $oPost->mes : DBPessoal::getMesFolha();
}
...
$iAnoLimite      = DBPessoal::getAnoFolha();
$iMesLimite      = DBPessoal::getMesFolha();
...
<html>
  ...
  <body bgcolor=#CCCCCC onload='validaForm();'>
    <div id="DDD"></div>

    <div id="processando" style="position:absolute; left:27px; top:126px; width:957px; height:344px; z-index:1; visibility: hidden; background-color: #FFFFFF; border: 1px none #000000;">
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      if(isset($HTTP_POST_VARS["pesquisar"]) || isset($matricula) ) {
        ...
        if(!empty($HTTP_POST_VARS["r01_regist"])) {
         ...
         $matricula = $HTTP_POST_VARS["r01_regist"];
          ...
          if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
            ...
            if ($resultgerfsal && pg_num_rows($resultgerfsal) != 0 ) {
              $temsalario = true;
            } else {
              $temsalario = false;
            }
            ...
            if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
              ...
              if ($rsQuerySuplementar && pg_num_rows($rsQuerySuplementar) != 0 ) {
           ...
           $resultgerfs13 = db_query("select *
            ...
            ///////// VERIFICA SE A MATRÍCULA POSSUI ADIANTAMENTO 13 SALÁRIO
          $resultgerfsad13 = db_query("select *
                                    from gerfsad13
                                where     r95_regist = $matricula
                                      and r95_anousu = $ano
                                      and r95_mesusu = $mes
                                      and r95_instit = ".db_getsession("DB_instit"));
            if(pg_num_rows($resultgerfsad13) != 0){
            $temadiantamento13salario = true;
          }else{
              $temadiantamento13salario = false;
          }
          ...
          if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
           ...
           $resultpreviden = db_query("select *
                                       from rhpessoalmov
                                            ...
                                            where     rh02_regist = $matricula
                                                  ...
                                                  and rh02_mesusu = $mes
                                                   and rh02_instit = ".db_getsession("DB_instit")." limit 1");
            if(pg_num_rows($resultpreviden) != 0){
           ...
           $resultajusteir = db_query("select *
                                        ...
                                        where     rh02_regist = $matricula
                                              ...
                                              and rh02_mesusu = $mes
                                               and rh02_instit = ".db_getsession("DB_instit")." limit 1");
            if(pg_num_rows($resultajusteir) != 0){
            $temajusteir = true;
          }else{
              $temajusteir = false;
          }
           ...
           $resultgerfprovfer = db_query("select *
            ...
            if(pg_num_rows($resultgerfprovfer) != 0){
            $temgerfprovfer = true;
          }else{
           ...
           $resultgerfprovs13 = db_query("select *
            ...
            if(pg_num_rows($resultgerfprovs13) != 0){
            $temgerfprovs13 = true;
          }else{
        ...
        $sWhere  = "     z01_numcgm  = " . pg_fetch_result($result,0,"k00_numcgm");
                              ...
                              <fieldset>
                                ...
                                <?php
                                  ...
                                  if (@$tem13salario == true ) {
                                    ...
                                    $aCalculos['13salario'] = array("sLabel" => "13º SALÁRIO");
                                  }

                                  if (@$temadiantamento13salario == true ) {

                                    if (empty($xopcao)) {
                                      $xopcao = 'adiantamento13salario';
                                    }
                                    $aCalculos['adiantamento13salario'] = array("sLabel" => "ADIANT. 13º SALÁRIO");
                                  }
    ...
    function js_pensoes() {
      var iMatricula = $F('r01_regist');
      js_OpenJanelaIframe('top.corpo','db_iframe_ponto','pes1_pensao001.php?r52_regist='+iMatricula+'&chavepesquisa='+iMatricula+'&chavepesquisa2='+iMatricula+'&funcao_js=parent.js_preenche|0|1|2|3','Pensoes',true);
    }
    ...
    $campos_pessoal_ = "RH02_ANOUSU as r01_anousu,
                ...
                if ( $xopcao == 'salario' ){
                  ...
                  $sigla   = 'r35_';
                }elseif ($xopcao == 'adiantamento13salario'){
                  $result = &$resultgerfsad13;
                  $sigla   = 'r95_';
                ...
                if(isset($sigla)){
                  ...
                  $arr_formula  = array();
                  $conta_base   = 1;
                  $iRegistros   = $result ? pg_num_rows($result) : 0;
            ...
            <tr>
              ...
              <fieldset id="calculoFolha" style="padding: 0 0 5px 0; overflow: hidden;">
                ...
                <table border="0" height="100%" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center">
                      <iframe id="debitos" height="100%" width="100%" name="debitos" border="0" src="pes3_gerfinanc018.php?opcao=<?php echo $xopcao?>&numcgm=<?php echo $z01_numcgm?>&matricula=<?php echo $matricula?>&ano=<?php echo $ano?>&mes=<?php echo $mes?>&tbprev=<?php echo $r01_tbprev?>&bases=<?php echo @$bases?>&rub_bases=<?php echo @$rub_bases?>&rub_cond=<?php echo @$rub_cond?>&rub_formula=<?php echo @$rub_formula?>"></iframe>
                      <input type="hidden" name="matricula"  value="<?php echo $matricula?>">
                      <input type="hidden" name="numcgm"  value="<?php echo $z01_numcgm?>">
                      <input type="hidden" name="opcao"  value="<?php echo $xopcao?>">
                      <input type="hidden" name="tbprev"  value="<?php echo $r01_tbprev?>">
      ...
      if (!$lReadOnly) {
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <input class="field-size2" type="button"    name="vars4" value="Pensões"          onclick="js_pensoes();" >
              <input class="field-size3" name="retornar"  type="button" id="retornar"           value="Nova Pesquisa" title="Inicio da Consulta" onclick="location.href='<?php echo ($novapesquisa)?>'">
    ...
    ?>
        <form name="form1" id='form1' method="post">
          <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="right" title="<?php echo $Tr01_regist?>">
                  <?php
                    $iDbOpcao = 1;
                    if(isset($_GET['lConsulta'])){
                      $iDbOpcao = 3;
...
var iAnoAtual       = null;
if ($F('ano')) {
    iAnoAtual       = parseFloat($F('ano'));
}
var iMesAtual = null;
if ($F('mes')) {
    iMesAtual       = parseFloat($F('mes'));
}
...
var iAnoLimite      = null;
if ($F('anoLimite')) {
    iAnoLimite      = parseFloat($F('anoLimite'));
}
var iMesLimite = null;
if ($F('mesLimite')) {
    iMesLimite      = parseFloat($F('mesLimite'));
}
/**
 * Ano e Mês de implantação do sistema
 */
var iAnoImplantacao = null
if ($F('anoImplantacao')) {
    iAnoImplantacao = parseFloat($F('anoImplantacao'));
}
var iMesImplantacao = null;
if ($F('mesImplantacao')) {
    iMesImplantacao = parseFloat($F('mesImplantacao'));
}
/**
...
function js_mostracgm() {
  ...
  db_iframepessoal.jan.location.href = 'prot3_conscgm002.php?fechar=func_nome&numcgm=<?php echo @$z01_numcgm?>';
  db_iframepessoal.mostraMsg();
  db_iframepessoal.show();
  db_iframepessoal.focus();
}
...
function js_mostrapessoal() {
  ...
  db_iframepessoal.jan.location.href = 'pes3_conspessoal002.php?regist=<?php echo @$matric?>';
  db_iframepessoal.mostraMsg();
  db_iframepessoal.show();
  db_iframepessoal.focus();
}
...
function js_chama_link(ponto){
  ...
  debitos.location.href = 'pes3_gerfinanc018.php?opcao='+ponto+'&numcgm='+$F('z01_numcgm')+'&matricula='+document.formatu.matricula.value+'&ano=<?php echo @$ano?>&mes=<?php echo @$mes?>&tbprev=<?php echo @$r01_tbprev?>&bases='+sBases+'&rub_bases='+document.formatu.rub_bases.value+'&rub_cond='+document.formatu.rub_cond.value+'&rub_formula='+document.formatu.rub_formula.value;
}
...
function js_chama_link2(ponto) {
  ...
  debitos.location.href = 'pes3_consponto021.php?opcao='+ponto+'&numcgm='+$F('z01_numcgm')+'&matricula='+document.formatu.matricula.value+'&ano=<?php echo @$ano?>&mes=<?php echo @$mes?>&tbprev=<?php echo @$r01_tbprev?>&bases='+sBases+'&rub_bases='+document.formatu.rub_bases.value+'&rub_cond='+document.formatu.rub_cond.value+'&rub_formula='+document.formatu.rub_formula.value;
}
...
function js_relatorio(){
  ...
  jan = window.open('pes3_gerfinanc017.php?opcao='+document.formatu.opcao.value+'&numcgm='+document.formatu.numcgm.value+'&matricula='+document.formatu.matricula.value+'&ano=<?php echo $ano?>&mes=<?php echo $mes?>&tbprev='+document.formatu.tbprev.value,'sdjklsdklsdf','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}

function js_Pesquisa(solicitacao) {
  var descricao_janela = 'CONSULTAS';
  js_OpenJanelaIframe('CurrentWindow.corpo','func_pesquisa','pes3_conspessoal002_detalhes.php?solicitacao='+solicitacao+'&parametro=<?php echo $r01_regist?>&ano=<?php echo $ano?>&mes=<?php echo $mes?>',descricao_janela,true,'20');
}

function validaForm()
{
    if (document.form1) {
        if (document.form1.r01_regist) {
            js_tabulacaoforms("form1","r01_regist",true,1,"r01_regist",true);
        }
    }
}
