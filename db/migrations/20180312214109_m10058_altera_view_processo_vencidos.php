...
class M10058AlteraViewProcessoVencidos extends PostgresMigration
{

    public function up()
    {
        $this->execute("
            CREATE OR REPLACE VIEW ultimas_movimentacoes_processos_vencidos AS
    ...
    public function down()
    {
        ...
        DROP VIEW ultimas_movimentacoes_processos_vencidos;
            CREATE OR REPLACE VIEW ultimas_movimentacoes_processos_vencidos AS
                SELECT DISTINCT ON (codigo_processo)
                    codigo_processo,
                    p58_numero AS numero_processo,
