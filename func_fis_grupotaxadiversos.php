...
include(modification("classes/db_fis_grupotaxadiversos_classe.php"));
db_postmemory($HTTP_POST_VARS);
parse_str($HTTP_SERVER_VARS["QUERY_STRING"]);
$clgrupotaxadiversos = new cl_fis_grupotaxadiversos;
    ...
    <fieldset>
      ...
      <table width="35%" border="0" align="center" cellspacing="3" class="form-container">
        <tr>
          ...
          <td><?php db_input("y118_sequencial",19,$Iy118_sequencial,true,"text",4,"","chave_y118_sequencial"); ?></td>
        </tr>
        <tr>
          <td><label><?=$Ly118_sequencial?></label></td>
          <td><?php db_input("y118_sequencial",19,$Iy118_sequencial,true,"text",4,"","chave_y118_sequencial");?></td>
    ...
    <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_grupotaxadiversos.hide();">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_grupotaxadiversos.php")==true){
             include(modification("funcoes/db_func_fis_grupotaxadiversos.php"));
           }else{
           $campos = "fis_grupotaxadiversos.*";
           }
        }
