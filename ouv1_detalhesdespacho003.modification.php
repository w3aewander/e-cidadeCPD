          ...
          <fieldset>
            ...
            <table>
              ...
              <tr>
                ...
                <td id="tipoDespacho">
                  <div>
                    <input type="radio" name="tipodesp" value="d" onChange="js_validaTelaTransf();" checked><b>Observações</b></input>
                  </div>

                  <div id="desp156normal">
                    <input type="radio" name="tipodesp" value="t" onChange="js_validaTelaTransf();"><b>Despachar e Transferir</b></input>
                  </div>

                  <div id="desp156">
                    <input type="radio" name="tipodesp" value="t" onChange="js_validaTelaTransf();" onClick='js_mostraDepartamento156(false);'><b>Despachar para o CAC 156</b></input>
                  </div>
                </td>
              </tr>
            </table>
            ...
            <table>
              <tr>
                <td>
                  <b>
                  <?php
                    if (db_getsession('DB_coddepto') == 1279){
                ...
                <td>
                  <?php
                    if (db_getsession('DB_coddepto') == 1279){
                      ...
                      db_input('ordem'        ,10,'',true,'hidden',1,"");
                      db_input('deptorec'     ,10,'',true,'text',3,'');
                      db_input('descrdeptorec',50,'',true,'text',3,'');
                    }
                  ?>
                </td>
...
<script>
  ...
  if (<?=db_getsession('DB_coddepto');?> == 1279){
    $('desp156').style.display = 'none';
  } else {
    $('desp156normal').style.display = 'none';
  }
  ...
  /**
   * { js_mostraDepartamento156 }
   *
   * @param      {<type>}  lMostra  The l mostra
   */
  function js_mostraDepartamento156(lMostra){
    js_OpenJanelaIframe('','db_iframe_db_depart','func_db_depart_transferencias.php?pesquisa_chave=1279&funcao_js=parent.js_mostradb_depart156&todasinstit=1&instituicao=0','Pesquisa',false);
  }
  ...
  /**
   * { Despachar automaticamente para o CAC 156 }
   *
   * @param      {string}  chave   The chave
   * @param      {<type>}  erro    The erro
   */
  function js_mostradb_depart156(chave,erro){
    $('descrdeptorec').value = chave;
    $('deptorec').value = 1279;
    js_pesquisaUsuarios(1279);
  }
