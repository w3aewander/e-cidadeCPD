...
<template>
    <div class="filter">
        <div class="filter-inputs" @keyup.enter="emitSearch">
            ...
            <InputText placeholder="Solicitante" class="m-2" v-model="filter.solicitante"/>
            ...
            <InputText placeholder="Descrição" class="m-2" v-model="filter.descricao"/>
