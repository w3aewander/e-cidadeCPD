...
// $this->addLog($oDadosRecurso->o15_codtri);
...
//      $oRecurso->cd_FonteGestor = str_pad($oDadosRecurso->o15_codtri, 4, " ", STR_PAD_LEFT);
      ...
      //$oRecurso->cd_Fonte       = str_pad($oDadosRecurso->o15_codtri, 4, " ", STR_PAD_LEFT);
      ...
      $oRecurso->cd_FonteGestor = str_pad(" ", 4, " ", STR_PAD_LEFT);
            $oRecurso->Nm_FonteRecurso        = str_pad($oDadosRecurso->o15_codtri,    8, " ", STR_PAD_LEFT); 
            $oRecurso->Nm_FonteRecursoGestor        = str_pad($oDadosRecurso->o15_codigo,    8, " ", STR_PAD_LEFT); 
      }      
