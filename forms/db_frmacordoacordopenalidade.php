    ...
    <table>
                    ...
                    <table>
                        <tr style='display: none'>
                            ...
                            <td>
                                ...
                                db_input(
                                    ...
                                    'text',
                                    $db_opcao,
                                    " onchange='js_pesquisaac15_acordo(false);'"
                                )
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td nowrap title="<?= @$Tac15_acordopenalidade ?>">
                                <?php
                                db_ancora(
                                    @$Lac15_acordopenalidade,
                                    "js_pesquisaac15_acordopenalidade(true);",
                                    $db_opcao
                                );
                                ?>
                            </td>
        ...
        <tr>
            <td colspan="2" style="text-align:center">
                <input name="<?= ($db_opcao == 1
                    ? "incluir"
                    : ($db_opcao == 2 || $db_opcao == 22
                        ? "alterar"
                        : "excluir")) ?>" type="button" id="db_opcao" value="Incluir">
...
<script>
    ...
    function js_pesquisaac15_acordopenalidade(mostra) {
        if (mostra) {
            js_OpenJanelaIframe(
                'CurrentWindow.corpo.iframe_acordopenalidade',
            ...
            if (document.form1.ac15_acordopenalidade.value != '') {
                ...
                document.form1.ac15_texto.value = '';
                document.form1.ac13_descricao.value = '';
            }
        }
    }
    ...
    function js_main() {
        ...
        oGridPenalidades.setCellWidth(new Array('12%', '90%', '10%'));
        ...
        if (oRetorno.status == 1) {
            if (!oRetorno.isUpdate) {
                ...
                oRetorno.itens.each(function (oRow, id) {
                    ...
                    var sTexto = oRow.texto.urlDecode().replaceAll(/'|"/gi, '');
                ...
                let inputAcordoPenalidade = $('ac15_acordopenalidade');
                inputAcordoPenalidade.value = oRetorno.itens[0].codigo;
                inputAcordoPenalidade.readOnly = true;
                inputAcordoPenalidade.style.backgroundColor = "#DEB887";

                $('db_opcao').value = 'Alterar';
                $('btnNovo').style.display = '';
                $('ac13_descricao').value = oRetorno.itens[0].descricao.urlDecode();
                $('ac15_texto').value = oRetorno.itens[0].texto.urlDecode().replaceAll(/'|"/gi, '');
            }
        } else {
    ...
    function js_limpar() {
        let inputAcordoPenalidade = $('ac15_acordopenalidade');
        inputAcordoPenalidade.value = '';
        inputAcordoPenalidade.readOnly = false;
        inputAcordoPenalidade.style.backgroundColor = "#fff";
    ...
    function js_setAjuda(sTexto, lShow) {
        if (lShow) {
            ...
            $('ajudaItem').style.display = '-webkit-box';
