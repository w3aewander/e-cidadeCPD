...
function js_abre () {
  ...
  var codMotivo = d.t55_motivo.value;
...
<form class="container" name="form1" method="post" >
  <fieldset>
    ...
    <table class="form-container">
      ...
      <tr>
        <td colspan="1" title="<?=@$Tt55_motivo?>">
          <?
...
document.getElementById("t55_motivo").style.marginTop = "3px";
document.getElementById("t55_motivo").style.marginBottom = "3px";
