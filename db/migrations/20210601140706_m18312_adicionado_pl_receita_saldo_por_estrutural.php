...
class M18312AdicionadoPlReceitaSaldoPorEstrutural extends PostgresMigration
{
    public function change()
    {
        $this->execute(<<<SQL
create or replace function fc_receitasaldo_estrutural(integer, varchar, integer, date, date)
  returns numeric[]
language plpgsql
as $$
DECLARE
