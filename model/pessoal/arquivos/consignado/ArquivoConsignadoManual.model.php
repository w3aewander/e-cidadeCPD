...
class ArquivoConsignadoManual extends ArquivoConsignado {
   ...
   * @return int
   */
   public function getNumeroeConsignado() {
    return $this->numeroeConsignado;
   }

   /**
    * @param int $numeroeConsignado;
    */
   public function setNumeroeConsignado($numeroeConsignado) {
    $this->numeroeConsignado = $numeroeConsignado;
   }
