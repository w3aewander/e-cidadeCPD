...
<form name="form1" method="post" action="geracertificadoconformidadelote.php">
  ...
  <fieldset style="width: 780px;margin-left: -145px">
    ...
    <input size="15" type="text" name="nonotafiscal[]" required maxlength="10">

    <label>Valor da Nota Fiscal</label>
    <input size="15" type="text" name="valornotafiscal[]" id="valornotafiscal" required maxlength="13" onkeyup="mascaraMoeda(this, event)"><br>

    <div id="divinha"></div>

    <button type="button" id="novanota">Adicionar Nota</button>
    

  </fieldset>

  <fieldset>
    <legend><strong>Dados Certificado - Dados Comuns a todos do lote</strong></legend>
    ...
    <input class="primeiro" type="text" name="noprocesso" id="noprocesso" required maxlength="13" placeholder="xxxxx/xxxx" onkeypress="return valida1(event)"><br>
...
<?php */ ?>
  ...
  <p>
    ...
    Folha: <input type="text" id="g11f" name="g11f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g12f" name="g12f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g13f" name="g13f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g14f" name="g14f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g15f" name="g15f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g16f" name="g16f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g17f" name="g17f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g18f" name="g18f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g19f" name="g19f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g110f" name="g110f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g111f" name="g111f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g112f" name="g112f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g113f" name="g113f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g114f" name="g114f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g115f" name="g115f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g116f" name="g116f" size="30" maxlength="30" required><br>
</p>
...
<p>
    ...
    Folha: <input type="text" id="g117f" name="g117f" size="30" maxlength="30" required><br>
</p>
...
var novanota = document.querySelector('#novanota');
var contador = 1;
var certificado = document.getElementById("nocertificado").value;
var explode;
var novocer;

explode = certificado.split(".");  
explode[2] = "0" + "2";
...
novanota.addEventListener("click", function(){
  ...
  novocer = explode.join(".");  
  console.log(novocer);

  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function(){
    if((xhr.readyState === 4) && (xhr.status === 200)){
      document.getElementById("divinha").innerHTML = xhr.responseText;
    }
  }
    xhr.open("GET","novalinhalote.php?certificado="+certificado, true);
    xhr.send(null);
...
pc1 = explode[0];
pc2 = explode[1];
pc3 = Number(explode[2]);
pc4 = explode[3];


var conta = 0;
var divinha = document.getElementById("divinha");
novanota.addEventListener("click", function(){

  conta++;
  var novopc3 = 0;
  novopc3 = pc3 + conta;
  novopc3 = novopc3.toString();
  if(novopc3.length == 1){
    novopc3 = "0" + novopc3;
  }
  novocer = pc1 + "." + pc2 + "." + novopc3 + "." + pc4;
  

  var input1 = document.createElement("input");
  //input1.name = "nocertificado" + conta;
  input1.name = "nocertificado[]";
  input1.type = "text";  
  input1.setAttribute("style", "background-color:#DEB887" );
  input1.setAttribute("readonly", true);
  input1.value = novocer;
  var label1 = document.createElement("label");
  label1.setAttribute("for", "text" + conta);
  label1.innerHTML = "Nº Certificado ";

  var input2 = document.createElement("input");
  //input2.name = "nonotafiscal" + conta;
  input2.name = "nonotafiscal[]";
  input2.type = "text";
  input2.setAttribute("size", 15);
  input2.setAttribute("required", true);
  var label2 = document.createElement("label");
  label2.setAttribute("for", "text" + conta);
  label2.innerHTML = " Nº da Nota Fiscal ";

  var input3 = document.createElement("input");
  //input3.name = "valornotafiscal" + conta;
  input3.name = "valornotafiscal[]";
  input3.type = "text";
  input3.setAttribute("size", 15);
  input3.setAttribute("required", true);
  var label3 = document.createElement("label");
  label3.setAttribute("for", "text" + conta);
  label3.innerHTML = " Valor da Nota Fiscal ";  

  var espaco = document.createElement("br");
  divinha.appendChild(label1);
  divinha.appendChild(input1);

  divinha.appendChild(label2);
  divinha.appendChild(input2);

  divinha.appendChild(label3);
  divinha.appendChild(input3);

  


  divinha.appendChild(espaco);
...
<?php /* ?>
<label>Nº Certificado</label>
    <input size="20" type="text" name="nocertificado" readonly value="<?=$certificado;?>" style="background-color:#DEB887">
