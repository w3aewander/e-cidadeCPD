...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  if ($solicitacao == "Ferias") {
    $sql_cadferia = $clcadferia->sql_query_file(null, "distinct *", "r30_perai", "r30_anousu = " . $ano . " and r30_mesusu = " . $mes . " and r30_regist = " . $parametro);
  ...
  <?php
    ...
    $sql = $clrhpeslocaltrab->sql_query_rhpessoalmov(
      null,
      "distinct 
                                         rh56_localtrab, 
                                         rh55_estrut,
  ...
  ?>
    ...
    $anoAnterior = ($mes == 1) ? $ano - 1 : $ano;
      ...
      r17_difere,
      case when r17_situac = 'I' then 'Inativo' else 'Ativo' end as r17_situac,
      case when r17_tipo = 'f' then 'Diário' else 'Mensal' end as r17_tipo,
      (
          SELECT rh67_valor 
          FROM rhteutri AS ant 
          WHERE ant.rh67_regist = vtffunc.r17_regist 
            AND ant.rh67_anousu = $anoAnterior 
            AND ant.rh67_mesusu = $mesAnterior 
          ORDER BY ant.rh67_sequencial DESC 
          LIMIT 1
      ) AS rh67_valor",
        " r17_codigo ",
        " r17_anousu = $ano 
      and r17_mesusu = $mes 
      and r17_regist = $parametro"
      );
          ...
          <fieldset>
            ...
            <table border=0>
              <tr>
                ...
                <td align="center" class="bordasAqui" nowrap title="<?= "Valor Vale Transporte Mês Anterior" ?>"><strong><?= "Valor Vale Transporte Mês Anterior" ?></strong></td>
              </tr>
              <?php
              ...
              ?>
                <tr>
                  ...
                  <td align="left" class="<?= $bordas ?>" nowrap bgcolor="#CCCCCC">
                    <?= number_format($rh67_valor / 100, 2, ',', '.') ?>
                  </td>
                </tr>
              <?php } ?>
            </table>
          ...
          <td>
            <fieldset>
              ...
              <table border=0>
                ...
                ?>
                  <td align="left" class="bordasAqui" nowrap>
                    <strong>F050 - Dias úteis do mês regente</strong>
                  </td>
                  <td align="right" class="bordasCor1" nowrap bgcolor="#CCCCCC">
                    <?php echo $oVariaveis->f050; ?>
                  </td>
                <?php
                }
                ?>
