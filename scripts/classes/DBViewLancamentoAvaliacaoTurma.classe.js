...
DBViewLancamentoAvaliacaoTurma.prototype.buscaAlunos = function () {
  ...
  oParametro.iEtapa          = this.oDadosTurmaSelecionada.iEtapa;
  oParametro.iTurma          = this.oDadosTurmaSelecionada.iTurma;
  oParametro.iMaiorPermissao = this.oDadosTurmaSelecionada.iMaiorPermissao;
  oParametro.iRegencia       = $F('disciplina');
...
DBViewLancamentoAvaliacaoTurma.prototype.populaGrid = function (oAjax) {
  ...
  oRetorno.aAlunos.each(function (oAluno) {
    ...
    oAluno.oDisciplina.aAproveitamentos.each(function (oAproveitamento, iSeq) {
      ...
      /**
       * Removido código que forçava resultado para "A" se nota >= 5
       * O resultado correto já vem do banco de dados, considerando frequência E nota
       * Correção: Demanda frequência - Uemerson Santana - 18/12/2025
       */
    ...
    //console.log(oAluno.oDisciplina.oResultadoFinal);
    //console.log("YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY");

    //console.log("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW");
    //console.log(oAluno.oDisciplina.oResultadoFinal.nValor);
    //console.log("WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW");
