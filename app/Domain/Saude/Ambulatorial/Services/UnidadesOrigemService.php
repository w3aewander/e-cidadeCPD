...
use App\Domain\Saude\Ambulatorial\Repositories\UnidadesOrigemRepository;

class UnidadesOrigemService extends UnidadesOrigemRepository
{
    ...
    {
        $this->repository = new UnidadesOrigemRepository();
    }
