 ...
 *
 */
class SigfisArquivoComplementoDePagamentos extends SigfisArquivoBase implements iPadArquivoTXTBase {

    protected $iCodigoLayout     = 206;
    protected $sNomeArquivo      = 'CompPag';
    protected $aMovimentoContabil = array();
        ...
        $RetencaoReceitas = new \cl_retencaoreceitas;
        ...
        $sSqlvalorPagoRetencoes    = $RetencaoReceitas->getSsqlBuscaRetencoes($this->iAnoUso,$this->dtDataInicial,$this->dtDataFinal, $iInstituicaoSessao);
        ...
        if ($RetencaoReceitas->numrows > 0 ) {
            ...
            for ($i = 0; $i < $RetencaoReceitas->numrows; $i++) {
                ...
                */
                ...
                $aContasCodcon = array_unique((explode(',',$oDadosvalorPagoRetencoes->c61_reduz_codcon)));
                ...
                $oDados->cd_ContaContabil2      = str_pad($aContas[1], 34, ' ', STR_PAD_RIGHT); // str_repeat(' ', 34); // Nï¿½o usado no e-cidada
                $oDados->cd_ContaContabil3      = str_pad($aContas[2], 34, ' ', STR_PAD_RIGHT); // str_repeat(' ', 34); // Nï¿½o usado no e-cidada
