...
<script type="text/javascript">
  function js_relatorio() {
    ...
    jan = window.open(
      'fis2_levantamento002.php?codlev=' + document.form1.y60_codlev.value,
      '',
  ...
  function js_lev(mostra) {
    ...
    if(mostra == true) {
      js_OpenJanelaIframe(
        'CurrentWindow.corpo',
        'db_iframe',
        'func_levanta02.php?funcao_js=parent.js_mostralev1|y60_codlev|DBtxtnome_origem&todos=true',
      ...
      if(lev != '') {
        js_OpenJanelaIframe(
          'CurrentWindow.corpo',
          'db_iframe',
          'func_levanta02.php?pesquisa_chave=' + lev + '&funcao_js=parent.js_mostralev&todos=true',
          'Pesquisa Levantamento',
          mostra
        );
      } else {
