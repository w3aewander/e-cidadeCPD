...
class cl_fis_fiscalcgm {
   ...
   public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalcgm");
   ...
   public function incluir ($y36_codnoti){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalcgm(
                                       y36_codnoti
                                      ,y36_numcgm
                       )
                values (
   ...
   public function alterar ($y36_codnoti=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalcgm set ";
     $virgula = "";
   ...
   public function excluir ($y36_codnoti=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalcgm
                    where ";
     $sql2 = "";
   ...
   public function sql_query ( $y36_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalcgm ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_fiscalcgm.y36_numcgm";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalcgm.y36_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y36_codnoti!=null ){
         $sql2 .= " where fis_fiscalcgm.y36_codnoti = $y36_codnoti ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   public function sql_query_file ( $y36_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
