...
require_once(modification("classes/db_db_tipoinstit_classe.php"));
...
<table align = "center" style="margin-top: 15px;">
  ...
  <fieldset style="width: 790px;"><legend>
     <a  id='esconderinstituicao' style="-moz-user-select: none;user-select:none;cursor: pointer" onClick="js_escondeInstituicao('');">
       <b>Dados da Instituição</b>
       <img src='imagens/setabaixo.gif' id='toggleinstituicao' border='0'>
     </a></legend>

  <table border="0" align="center" id="tabInstituicao">
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_codsiconfi?>">
              <?=@$Ldb21_codsiconfi?>
          </td>
          <td>
              <?php
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_unidade_gestora_rpps?>">
      ...
      <tr>
        <td nowrap title="<?=@$Tdb21_esfera_op?>">
           <?=@$Ldb21_esfera_op?>
        </td>
        <td>
          <?php
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_valor_teto_remuneratorio?>">
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_ente_federativo_resp?>">
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_cnpj_efr?>">
              <?=@$Ldb21_cnpj_efr?>
          </td>
          <td>
              <?php
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_efr_previdencia_compl?>">
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_possui_rpps?>">
              <?=@$Ldb21_possui_rpps?>
          </td>
          <td>
              <?php
      ...
      <tr>
          <td nowrap title="<?=@$Tdb21_permiteinscricaocgf?>">
              <?=@$Ldb21_permiteinscricaocgf?>
          </td>
          <td>
              <?php
		      $x = array("t"=>"SIM", "f"=>"NAO");
		      db_select('db21_permiteinscricaocgf',$x,true,$db_opcao,"");
              ?>
          </td>
      </tr>
  ...
  <td>
  <fieldset><legend>
     <a  id='esconderfinanceiro' style="-moz-user-select: none;user-select:none;cursor: pointer" onClick="js_escondeFinanceiro('');">
  ...
  <table border="0" id="tabFinanceiro" style="display: none;">
    ...
    <tr>
        ...
        <!-- tributario -->
			 ...
			 <td>
			 <fieldset><legend>
			  <a  id='escondertributario' style="-moz-user-select: none;user-select:none;cursor: pointer" onClick="js_escondeTributario('');">
...
function js_validaForm(){
  ...
  // Se o cnpjEfr está preenchido e não for válido...
  if (inputCnpjEfr.getValue() != "" && !inputCnpjEfr.valid) {
    alert("usuário:\n\n Campo CNPJ do Ente Federativo Responsável não é válido!\n\n");
    return false;
  }

  // Prestes a enviar o form, vamos formatar o cpf
  $('db21_cnpj_efr').value = inputCnpjEfr.getValue();
...
var inputCnpjEfr = new DBInputCNPJ($('db21_cnpj_efr'));
