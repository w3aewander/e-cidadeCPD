...
namespace ECidade\Tributario\Arrecadacao\Custas\Interfaces;

use ECidade\Tributario\Juridico;
use \Recibo as ReciboModel;

interface PartilhaRecibo extends Partilha
{
    ...
    public function processarIsencaoPartilha(array $partilhas);
}
