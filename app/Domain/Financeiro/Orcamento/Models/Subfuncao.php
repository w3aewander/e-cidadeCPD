...
{
    protected $table = 'orcamento.orcsubfuncao';
    protected $primaryKey = 'o53_subfuncao';
    ...
    {
        return str_pad($this->o53_subfuncao, 3, 0, STR_PAD_LEFT);
    }
    ...
    {
        return $this->hasMany(DetalhamentoDespesa::class, 'pl20_orcsubfuncao', 'o53_subfuncao');
    }
}
