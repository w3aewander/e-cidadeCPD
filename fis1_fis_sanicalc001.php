...
try {
  ...
  if(isset($calcular)){
     ...
     */
     $oDaoSanitarioInscr = db_utils::getDao("fis_sanitarioinscr");
    ...
    SELECT DISTINCT Y83_CODSANI, 't'::BOOLEAN AS Q07_PERMAN, '*'::CHAR(1) AS Q07_CALCULA, Y83_ATIV, Q03_DESCR, Y83_DTINI, Y83_DTFIM, Y83_DTFIM AS Y83_DATABX, 1 AS Q07_QUANT FROM fiscalizacao.fis_SANIATIVIDADE INNER JOIN ATIVTIPO ON Y83_ATIV = Q80_ATIV INNER JOIN TIPCALC ON Q80_TIPCAL = Q81_CODIGO INNER JOIN ATIVID ON Y83_ATIV = Q03_ATIV INNER JOIN CADCALC ON Q81_CADCALC = Q85_CODIGO WHERE Y83_CODSANI  = $y80_codsani";
  // echo $sql01;
     db_query($sql01);
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
  <?php
  include(modification("forms/db_frm_fis_sanicalc.php"));
  ?>
    </center>
  </td>
  </tr>
