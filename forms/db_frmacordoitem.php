...
?>
            ...
            <fieldset id='FormularioManual'>
              ...
              <table border="0" width="100%">
                <tr>
                  ...
                  <td>
                      <?php
                      db_input('ac20_acordo', 10, '', true, 'text', $db_opcao,
                        " onchange='js_pesquisaac20_acordo(false);'");
                      db_input('ac16_sequencial', 10, $Iac16_sequencial, true, 'text', 3, '');
                      ?>
                  </td>
                </tr>
                <tr>
                  <td id='tdMatMater' nowrap title="<?php echo $Tac20_pcmater ?>">
                      <?php
                  ...
                  <td colspan="4">
                      <?php
                      db_input('ac20_pcmater', 10, $Iac20_pcmater, true, 'text', $db_opcao,
                        " onchange='js_pesquisaac20_pcmater(false);'");
                ...
                <tr>
                  <td nowrap title="<?php echo $Tac20_quantidade ?>">
                      <?php echo $Lac20_quantidade ?>
                  </td>
                  <td>
                      <?php
                  ...
                  <td nowrap title="<?php echo $Tac20_matunid ?>">
                  ...
                  <td>
                      ...
                      db_select("ac20_matunid", $aUnidades, true, 1,
                        "onchange='js_desabilitaItemSelecionar();' style='width:100%'");
                      ?>
                  </td>
                </tr>
                <tr>
                  <td nowrap title="<?php echo $Tac20_valorunitario ?>">
                      <?php echo $Lac20_valorunitario ?>
                  </td>
                  <td colspan="3">
                      <?php
                ...
                <tr>
                  <td nowrap title="<?php echo $Tac20_elemento ?>">
                      <?php echo $Lac20_elemento ?>
                  </td>
                  <td colspan="3">
                      <?php
                      ...
                      <table cellpadding="0" border="0" width="100%">
                        <tr>
                          ...
                          <td>
                              ...
                              //Define valores para a data inicial, preechendo com o periodo de vigencia inserido na aba acordo caso não existam valores.
                              $dataInicio = explode('-', $oAcordo->ac16_datainicio);
                              $anoInicio = $dataInicio[0];
                              $mesInicio = $dataInicio[1];
                              $diaInicio = $dataInicio[2];

                              $sDiaDataInicial = isset($ac41_datainicial_dia) ? $ac41_datainicial_dia : $diaInicio;
                              $sMesDataInicial = isset($ac41_datainicial_mes) ? $ac41_datainicial_mes : $mesInicio;
                              $sAnoDataInicial = isset($ac41_datainicial_ano) ? $ac41_datainicial_ano : $anoInicio;
                          ...
                          <td>
                              ...
                              //Define valores para a data final, preechendo com o periodo de vigencia inserido na aba acordo caso não existam valores.
                              $dataFim = explode('-', $oAcordo->ac16_datafim);
                              $anoFim = $dataFim[0];
                              $mesFim = $dataFim[1];
                              $diaFim = $dataFim[2];

                              $sDiaDataFinal = isset($ac41_datafinal_dia) ? $ac41_datafinal_dia : $diaFim;
                              $sMesDataFinal = isset($ac41_datafinal_mes) ? $ac41_datafinal_mes : $mesFim;
                              $sAnoDataFinal = isset($ac41_datafinal_ano) ? $ac41_datafinal_ano : $anoFim;
              ...
              <table style="width: 100%;">
                <tr>
                  <td nowrap colspan="4">
                    <fieldset>
                      <legend><?php echo $Lac20_resumo ?></legend>
                        <?php
  ...
  <script>
    ...
    iCodigoItem = '';
    iElementoDotacao = '';
    iCasasDecimais = <?php echo $iCasasDecimais ?>;
    sTipoOrigem = null;
    ...
    function js_retornoSaveItem(oAjax) {
      ...
      $("ac41_datainicial").value = localStorage.getItem('ac41_datainicial');
      $("ac41_datafinal").value = localStorage.getItem('ac41_datafinal');
    }
    ...
    function js_bloqueiaCampos(iTipoContrato) {
      ...
      if(iTipoContrato == CONTRATO_LICITACAO || iTipoContrato == CONTRATO_PROCESSO_COMPRAS || iTipoContrato == CONTRATO_EMPENHO) {
        ...
        /*
          Solicitado pelo Henrique para habilitar os campos, pois há muita solicitação de acerto em base
        */
    ...
    function js_retornoEditar(oAjax) {
      ...
      if(oRetorno.status == 1) {
        with(oRetorno.item) {
          ...
          var auxResumo = resumo.urlDecode();
          $('ac20_resumo').value = auxResumo.replace(/&#(\d+);/g, function (m, n) { return String.fromCharCode(n); })
    ...
    function js_montaGridItensOrigens() {
      console.log('js_montaGridItensOrigens');
    ...
    function js_preencheLicitacao() {
      ...
      aLicitacoes.licitacoes.each(function(oLicitacao, iLic) {
        ...
        var oOption = new Option(`${oLicitacao.numero}/${oLicitacao.ano} - Modalidade: ${oLicitacao.modalidade.urlDecode().toUpperCase()}   `, oLicitacao.licitacao);
    ...
    function js_preencheLicitacaoItens() {
      console.log('js_preencheLicitacaoItens');
    ...
    function js_montaGridLicitacaoItens() {
      console.log('js_montaGridLicitacaoItens');
    ...
    function js_preencheItensOrigem(oRetorno) {
      ...
      oRetorno.itens.each(function(oRow, iSeq) {
        ...
        if (isPB) {
            oRow.valorunitario = Number(oRow.valorunitario.toString().match(/^\d+(?:.\d{0,2})?/));
            oRow.valortotal = Number(oRow.valortotal.toString().match(/^\d+(?:.\d{0,2})?/));
        }
    ...
    function js_validaValorUnitario() {
      ...
      if(oTxtQuantidade.getValue() != oRow.aCells[5].getValue()) {
        ...
        if (isPB) {
            oTxtValorUnitario.setValue(Number(nValorUnitario.toString().match(/^\d+(?:.\d{0,2})?/)))
        } else {
    ...
    function js_validaValorTotal() {
      ...
      if (isPB) {
          oTxtValor.setValue(Number(nValorTotal.toString().match(/^\d+(?:.\d{0,2})?/)));
      }else {
    ...
    function addPeriodo() {
      ...
      localStorage.setItem('ac41_datainicial', oDtInicial.value);
      localStorage.setItem('ac41_datafinal', oDtFinal.value);
    ...
    function js_preencheGridItensEmpenhos(oAjax) {
      ...
      if(oRetorno.aItensEmpenhos == null) {
        ...
        oRetorno.aItensEmpenhos.each(function(oItem, iLinha) {
          ...
          var oDBTextFieldDataInicial = new DBTextFieldData("oDBTextFieldDataInicial" + iLinha, "oDBTextFieldData", $("ac41_datainicial").value, 10);
          var oDBTextFieldDataFinal = new DBTextFieldData("oDBTextFieldDataFinal" + iLinha, "oDBTextFieldData", $("ac41_datafinal").value, 10);
