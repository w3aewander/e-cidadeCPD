...
<html>
  ...
  <body onload="$('lbl_rh01_regist').click()">
    <form id="formPesquisarEsocial" method="POST" action="eso02_preenchimentoavisoprevio.php" class="container">
      <fieldset>
      ...
      <input type="button" id="pesquisar" name="pesquisar" value="Selecionar" />
    </form>
