...
if(!isset($abas)){
  echo "<script>location.href='fis3_fis_fandamnoti005.php?db_opcao=3".((isset($intimacao)) ? '&intimacao=1' : '')."'</script>";
  exit;
}
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  ...
  $db_opcao = 3;
  $db_botao = false;
  echo "<script>parent.iframe_fiscais.location.href='fis3_fis_fandamnotiusu001.php?primeira=1';</script>";
...
if($clfiscalultandam->numrows > 0){
  ...
  echo "<script>parent.iframe_fiscais.location.href='fis3_fis_fandamnotiusu001.php?abas=1';</script>";
}
?>
<html>
<head>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  if($clfandam->erro_status=="0"){
    ...
    if(@$sqlerro==true){
      ...
      $clfandam->erro(true,false);
      echo "<script>parent.document.formaba.fiscais.disabled=true;</script>";
      echo "<script>parent.iframe_fandam.location.href='fis3_fis_fandamnoti003.php?abas=1&y30_codnoti=$y30_codnoti$getIntimacao';</script>";
    }
  };
};
