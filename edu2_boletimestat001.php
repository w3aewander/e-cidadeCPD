       ...
       <table border="0">
        <tr>
          ...
          <?    
            if ($iModulo == 7159) {   
              ...
              echo '<td>';       
                      ...
                      $sSqlEscola     = $oDaoEscola->sql_query_file("", "ed18_i_codigo, ed18_c_nome", "", "ed18_i_tipoescola = 1");                                                                      
         ...
         <tr>
          ...
          <td valign='bottom'>
            <input type="button" name="exportar" value="Exportar para Excel" 
            onclick="js_exportar_excel($('calendario').value, $('mes').value, $('ensino').value, $('escola').value)">
          </td>
         </tr>
        </table>
       </fieldset>
...
function js_exportar_excel(calendario, mes, ensino, escola) {
  if (calendario != "" && mes != "") {
    ...
    jan = window.open('edu2_boletimestatXLS002.php?iCalendario='      + $('calendario').value +
                                                      '&iMes='        + $('mes').value        +
                                                      '&sEnsino='     + $('ensino').value     +
                                                      '&sImprimeLista=' + imprime_lista       +
                                                      '&iEscola='     + $('escola').value,'',
