...
class Rubrica
{
    ...
    const TIPO_BASE = 3;
    const TIPO_BASE_INFORMATIVA = 4;
    const TIPO_BASE_DEDUTORA = 5;
    const TIPO_BASES = [
        self::TIPO_BASE,
        self::TIPO_BASE_INFORMATIVA,
        self::TIPO_BASE_DEDUTORA        
    ];
     ...
     * @var float
     */
    private $valorAtualServidor = 0;

    /**
     * @var float
     */
    private $quantidadeAtualServidor = 0;

    /**
     * @var string
     */
    private $tabelaServidor;
     ...
     * @return float
     */
    public function getValorAtualServidor()
    {
        return $this->valorAtualServidor;
    }

    /**
     * @param float $valorAtualServidor
     */
    public function setValorAtualServidor($valorAtualServidor)
    {
        $this->valorAtualServidor = $valorAtualServidor;
    }

    /**
     * @return float
     */
    public function getQuantidadeAtualServidor()
    {
        return $this->quantidadeAtualServidor;
    }

    /**
     * @param float $quantidadeAtualServidor
     */
    public function setQuantidadeAtualServidor($quantidadeAtualServidor)
    {
        $this->quantidadeAtualServidor = $quantidadeAtualServidor;
    }

    /**
     * @return string
     */
    public function getTabelaServidor()
    {
        return $this->tabelaServidor;
    }

    /**
     * @param string $tabelaServidor
     */
    public function setTabelaServidor($tabelaServidor)
    {
    ...
    public function getTipoEmpenho()
    {
        ...
        $oDaoRHRubElemento = new cl_rhrubelemento;
        $sSqlTipoEmpenho = $oDaoRHRubElemento->sql_query_file($this->getCodigo(), $this->getInstituicao(), 'rh23_codele');
        $rsTipoEmpenho = $oDaoRHRubElemento->sql_record($sSqlTipoEmpenho);

        if (!$rsTipoEmpenho && $oDaoRHRubElemento->erro_sql == "Erro ao selecionar os registros.") {
    ...
    public function toArray()
    {
        ...
        switch ($this->getTipo()) {
            case 1:
                $tipoDescricao = "Provento";
                break;
            case 2:
                $tipoDescricao = "Desconto";
                break;
            case 3:
            case 4:
            case 5:
