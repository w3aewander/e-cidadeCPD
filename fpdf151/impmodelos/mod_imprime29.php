...
$this->objpdf->Multicell(170,8,$this->isenmsg1,$borda,"C",0);
$this->objpdf->cell(170,8,"",$borda,1,"C",0);
$this->objpdf->Multicell(180,8,$this->isenmsg2,$borda,"C",0);
$this->objpdf->cell(170,8,"",$borda,1,"C",0);
...
$this->objpdf->Multicell(170,5,"           		".$this->isenmsg4,$borda,"J",0);
$this->objpdf->Ln(2);
$linha = $this->objpdf->gety();
if(isset($this->isenmsg3) && $this->isenmsg3 != ""){

 $this->objpdf->sety($linha+5);
 $this->objpdf->Multicell(170,8," OBS : ".$this->isenmsg3,$borda,"C",0);
 $linha = $this->objpdf->gety();
 $this->objpdf->sety($linha);
}
...
if ((isset($this->isenassinatura) && $this->isenassinatura != "") || (isset($this->isenassinatura2) && $this->isenassinatura2 != "")){
