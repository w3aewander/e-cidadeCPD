...
include(modification("classes/db_disbancotxtreg_classe.php"));
include(modification("classes/db_disbancotxt_classe.php"));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmdisbancotxt.php"));
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_disbanco.location.href='cai1_disbanco001.php?db_opcaoal=33&idret=".@$k34_sequencial."';
     ";
         if(isset($liberaaba)){
