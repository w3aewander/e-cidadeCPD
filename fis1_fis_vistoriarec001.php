...
include(modification("classes/db_fis_tipovistoriasrec_classe.php"));
include(modification("dbforms/db_funcoes.php"));
db_postmemory($HTTP_POST_VARS);
$clvistoriarec = new cl_fis_vistoriarec;
$cltipovistoriasrec = new cl_fis_tipovistoriasrec;
$db_opcao = 1;
$db_botao = true;
global $y76_codvist;
...
if(isset($y76_codvist) && $y76_codvist != ""){
  ...
  if($clvistoriarec->numrows == 0){
    $result = $cltipovistoriasrec->sql_record($cltipovistoriasrec->sql_query_tipovist("","","*",""," fis_vistorias.y70_codvist = $y76_codvist"));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?php
	include(modification("forms/db_frm_fis_vistoriarec.php"));
	?>
    </center>
	</td>
  </tr>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Incluir"){
  if($clvistoriarec->erro_status=="0"){
    ...
    $clvistoriarec->erro(true,false);
    echo "<script>parent.iframe_receitas.location.href='fis1_fis_vistoriarec001.php?y76_codvist=$y76_codvist';</script>";
  };
};
?>
