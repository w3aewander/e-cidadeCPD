...
class RelatorioDisponibilidadeFinanceira
{
    ...
    public function getDadosSimplificado()
    {
        ...
        $nSaldoInicialContaCredito = 0;
        $nSaldoInicialContaDebito = 0;
        // calcula o saldo inicial da movimentação
        foreach ($dados->aContaCorrenteDetalhe as $contaCorrente) {
            $nSaldoInicialContaCredito += $contaCorrente->nTotalInicialRecursoCredito;
            $nSaldoInicialContaDebito += $contaCorrente->nTotalInicialRecursoDebito;
        }
