    ...
    <form name="form1" method="post" action="">
        <fieldset>
            ...
            <table class="form-container">
                ...
                <tr>
                    <td nowrap title="<?= $Tla22_i_codigo ?>">
                        <label for="la22_i_codigo">
                            <?php
                            db_ancora('Requisição:', "js_pesquisala22_i_codigo(true);", "");
                            ?>
                        </label>
                    </td>
                    <td>
                ...
                <tr style="height: 25px;">
                    <td>
                        <label for='dataAutoriza'>Data Autorização:</label>
                    </td>
                    <td colspan="2">
                        <?php
                        db_inputdata('data-autoriza', '', '', '', true, 'text', 3);
                        ?>
                    </td>
                    <td colspan="3" id="linhaIdade">
                    </td>
                </tr>
...
<script>
    ...
    $('data-autoriza').addClassName('field-size2');
    ...
    const inputDataAut = document.getElementById('data-autoriza');

    inputDataAut.value = dataHoje.toLocaleDateString();
    ...
    var viewNumeroControleInterno = new ViewNumeroControleInterno('viewNumeroControleInterno')
    ...
    function js_retornocarregaexames(oAjax, lErro) {
        ...
        if (oAjax.status == 1) {
            ...
            F.la22_i_cgs.dispatchEvent(new Event('change'));
    ...
    $('db_opcao').onclick = function () {
        ...
        oParametros.dataAutoriza = js_formatar(inputDataAut.value, 'd');
    ...
    function retornaIdadePaciente(retorno) {
        ...
        $('linhaIdade').innerHTML = `<p id="idadeCompleta" style="margin-right: 420px; font-weight: normal;" >Idade: <span style="color: red;">${idadeCompleta}</span></p>`;
