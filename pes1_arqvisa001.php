...
if (isset($gerarq)) {
  ...
  if ($cldb_config->numrows > 0) {
    ...
    $nomearquivo_impressao = "GreenCard_" . db_formatar($pedido_dia, "s", "0", 2, "e", 0) .
    ...
    $nomearquivo = "GreenCard_" . db_formatar($pedido_dia, "s", "0", 2, "e", 0) .
      db_formatar($pedido_mes, "s", "0", 2, "e", 0) .
      db_formatar($pedido_ano, "s", "0", 4, "e", 0) .
      "_" .
      db_formatar($efetiv_dia, "s", "0", 2, "e", 0) .
    ...
    $ANME_COMPET = db_formatar(\DBPessoal::getMesFolha(), "s", "0", 2, "e", 0) . "/" . db_formatar(\DBPessoal::getAnoFolha(), "s", "0", 4, "e", 0);
    ...
    */
    ...
    //                                                                                           ",
    //                                                                                           "z01_nome",
    //                                                                                           "rh49_anousu = ".\dbpessoal::getanofolha()." and rh49_mesusu = ".\dbpessoal::getmesfolha()));

    $result_dadosarq = $clrhvisavalecad->sql_record($clrhvisavalecad->sql_query_documentos(null,
                                                                                          ...
                                                                                          ",
                                                                                          "z01_nome",
                                                                                          "rh49_anousu = " . \DBPessoal::getAnoFolha() . " 
                                                                                          and rh49_mesusu = " . \DBPessoal::getMesFolha() . "
                                                                                          and rh49_instit = " . db_getsession("DB_instit") . "
                                                                                          and rh49_valormes $lstzerado 0 "));

    //$result_dadosarq = $clcgm->sql_record($clgeradorsql->gerador_sql("r14",\dbpessoal::getanofolha(),2,"",$rubrica,"z01_nome","rh05_recis is null"));
    /*
...
from (select rh01_regist,
      ...
      where rh49_anousu = " . \DBPessoal::getAnoFolha() . " and rh49_mesusu = " . \DBPessoal::getMesFolha() . " and rh49_valormes $lstzerado 0
     ) as x
order by z01_nome
) as y
