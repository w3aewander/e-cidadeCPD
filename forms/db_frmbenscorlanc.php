...
var iCodigoCorrecao = document.getElementById("t62_codcor").value;
if(iCodigoCorrecao){
  parent.document.formaba.benscorr.disabled = false;
  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_benscorr.location.href   = 'pat1_benscorr001.php?db_opcao=22&t62_codcor='+iCodigoCorrecao;
}
</script>