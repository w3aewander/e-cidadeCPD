...
class cl_iptuconstr {
  ...
  public $validar_j39_ano = false;
  
  /**
   * Retorna os parametro para cadastro ou alteração
   *
   * @return void
   */
  ...
  {
    $query = db_query(
      'select * from cadastro.cfiptu where j18_anousu = ' .
    ...
    if ($result) {
      $this->validar_j39_ano = ($result->j18_validarano == 'f') ? true : false; 
    }
  }
