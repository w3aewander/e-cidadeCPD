...
<div class="container">
    <form enctype="multipart/form-data" name="vinculaRecursos" id="vinculaRecursos">
        <fieldset style="width: 600px;">
            <legend class="bold">Vinculação de Complemento de Recursos/Dotações</legend>
...
<script>
    var fonteRpc = "con4_sigapvincularcomplemento.RPC.php";
        ...
        function () {
            ...
            new AjaxRequest(
                ...
                function (oRetorno, lErro) {
                    ...
                    oDownload.addGroups("csv", "Vinculação Dotação/Complento Recurso");
                    oDownload.addFile(oRetorno.sNomeArquivo.urlDecode(), oRetorno.sNome.urlDecode(), "csv");
                    oDownload.show();
                }).setMessage('Aguarde, efetuando o download do arquivo...')
                .execute();
        });
