...
class ParametrosPessoal {
  ...
  */
  ...
  private $sRubricaPensaoAlimenticia;
    ...
    /**
     * Mes de pagamento do saldo do 13
     *
     * @var int
     */
    private $mes13;
    ...
    private $ano;
  /**
   * Rubrica utilizada para reajuste salarial
   *
   * @var String
   */
  private $rubricadifsalario;
  ...
  public function getRubricaPensaoAlimenticia() {
     ...
     * @return Rubrica
     */
    public function getRubricaAbonoPecunia()
    {
        return $this->rubricaAbonoPecunia;
    }
     ...
     * @param int $mes13
     */
    public function setMes13($mes13)
    {
        $this->mes13 = $mes13;
    }
  ...
  /**
   * Set rubrica utilizada para reajuste salarial
   *
   * @param  String  $rubricadifsalario  Rubrica utilizada para reajuste salarial
   *
   * @return  self
   */ 
  public function setRubricadifsalario($rubricadifsalario)
  {
    $this->rubricadifsalario = $rubricadifsalario;
  }

  /**
   * Get rubrica utilizada para reajuste salarial
   *
   * @return  String
   */ 
  public function getRubricadifsalario()
  {
    return $this->rubricadifsalario;
  }
}
