 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_iptucalcpadrao.location.href='cad1_iptucalcpadrao001.php?j10_sequencial=".@$j01_matric."';
         parent.document.formaba.iptutaxamatric.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_iptutaxamatric.location.href='cad1_iptutaxamatric001.php?j09_iptutaxamatric=".@$j01_matric."';
         parent.document.formaba.iptucalcpadraoconstr.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_iptucalcpadraoconstr.location.href='cad1_iptucalcpadraoconstr001.php?j11_sequencial=".@$j01_matric."';
     ";
         if(isset($liberaaba)){
