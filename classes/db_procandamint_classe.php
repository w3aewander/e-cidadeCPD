...
class cl_procandamint
{
    ...
    public function incluir($p78_sequencial, $flagMensagemOuvidoria = false)
    {
        $this->atualizacampos();
        if ($this->p78_codandam == null) {
            $this->erro_sql = " Campo Código do Andamento não informado.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = " ($this->p78_sequencial) não Incluído. Inclusão Abortada.";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
