...
<?php
/*
$result = $clfiscaltipo->sql_record($clfiscaltipo->sql_query("","","y29_dias","y31_codnoti limit 1"," fis_fiscaltipo.y31_codnoti = $y30_codnoti"));
...
if(isset($salvar) && $salvar == "Salvar"){
  if($clfiscal->erro_status=="0"){
    ...
    echo "
         <script>
           parent.iframe_venc.location.href='fis1_fis_vencimento001.php?y30_codnoti=".$y30_codnoti."&abas=1';\n
         </script>
       ";
  };
};
