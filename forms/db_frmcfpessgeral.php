...
<table border="0">
      ...
      <fieldset>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <?
              db_input('r11_mes13',4,$Ir11_mes13,true,'text',3,"")
              ?>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td nowrap align="left" title="<?=$Tr11_filtralotacaousuario?>">
            ...
            <tr>
                <td nowrap align="left" title="<?=$Tr11_utilizarhlotavincrubrica?>">
            ...
            <tr>
                <td nowrap title="<?=$Tr11_emissaocontracheque?>">
          ...
          <tr>
            <td nowrap align="left" title="<?=$Tr11_bloqueiocompetenciaaberta?>">
  ...
  <tr>
    <td>
      <fieldset>
        <legend align="left"><b>Dados Datas Envios eSocial</b></legend>
        <table>
          <tr>
            <td nowrap align="left" title="Fase 01 (Eventos Tabela)">
              <b>
                Fase 01 (Eventos Tabela)
              </b>
            </td>
            <td>
              <?php
                db_inputdata( 'r11_dataenviofase1',
                              $r11_dataenviofase1_dia,
                              $r11_dataenviofase1_mes,
                              $r11_dataenviofase1_ano,
                              true, 'text', $db_opcao );
              ?>
            </td>
          </tr>
          <tr>
            <td nowrap align="left" title="Fase 01 (Eventos Tabela)">
              <b>
                Fase 02 (Eventos Não Periódicos)
              </b>
            </td>
            <td>
              <?php
                db_inputdata( 'r11_dataenviofase2',
                              $r11_dataenviofase2_dia,
                              $r11_dataenviofase2_mes,
                              $r11_dataenviofase2_ano,
                              true, 'text', $db_opcao );
              ?>
            </td>
          </tr>
          <tr>
            <td nowrap align="left" title="Fase 01 (Eventos Tabela)">
              <b>
              Fase 03 (Eventos Periódicos)
              </b>
            </td>
            <td>
              <?php
                db_inputdata( 'r11_dataenviofase3',
                              $r11_dataenviofase3_dia,
                              $r11_dataenviofase3_mes,
                              $r11_dataenviofase3_ano,
                              true, 'text', $db_opcao );
              ?>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <?php
                db_inputdata( 'r11_dataenviofase4',
                            $r11_dataenviofase4_dia,
                            $r11_dataenviofase4_mes,
                            $r11_dataenviofase4_ano,
                              true, 'text', $db_opcao );
              ?>
            </td>
          </tr>
