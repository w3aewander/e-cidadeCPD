...
include modification("classes/db_fis_fiscalinscr_classe.php");
include modification("classes/db_fis_fiscalmatric_classe.php");
include modification("classes/db_fis_fiscalsanitario_classe.php");
include modification("classes/db_fis_fiscalcgm_classe.php");
...
include modification("classes/db_fis_fisctestem_classe.php");
include modification("classes/db_fis_fiscarquivos_classe.php");
include modification("classes/db_fis_fiscalvistorias_classe.php");
...
// -------------
if(!isset($abas)){
  echo "<script>location.href='fis1_fis_fiscal005.php?db_opcao=3".$getIntimacao."'</script>";
  exit;
}
parse_str($HTTP_SERVER_VARS["QUERY_STRING"]);
...
$clfisctestem      = new cl_fis_fisctestem;
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  if($clfiscal->erro_status=="0"){
    ...
    echo "
         <script>
         function js_src(){
         parent.iframe_fiscal.location.href='fis1_fis_fiscal003.php?abas=1".$getIntimacao."';\n
         }
         js_src();
         </script>
       ";
