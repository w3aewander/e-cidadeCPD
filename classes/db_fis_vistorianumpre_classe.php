...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_vistorianumpre");
...
public function incluir ($y69_codvist){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_vistorianumpre(
                                       y69_codvist
                                      ,y69_numpre
                       )
                values (
...
public function alterar ($y69_codvist=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_vistorianumpre set ";
     $virgula = "";
...
public function excluir ($y69_codvist=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_vistorianumpre
                    where ";
     $sql2 = "";
...
public function sql_query ( $y69_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_vistorianumpre ";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_vistorianumpre.y69_codvist";
     ...
     if($dbwhere==""){
       if($y69_codvist!=null ){
         $sql2 .= " where fis_vistorianumpre.y69_codvist = $y69_codvist ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y69_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
