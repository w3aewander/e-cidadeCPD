        ...
        if (isset($solicitacao)) {
            if ($solicitacao == "1") {
                ...
                for ($i = 0; $i < $numrows_itensdotac; $i++) {
                    ...
                    echo "    <td colspan='3' nowrap='nowrap' align='right' bgcolor='#CCCCCC'><strong>Código material: </strong></td>\n";
                    echo "    <td colspan='2' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc01_codmater</font></td>\n";
                    echo "  </tr>\n";
                    $servico = "Não";
                    $servicoquantidade = "Não";

                    if ($pc01_servico == 't') {
                        $servico = "Sim";
                    }
                    if ($pc11_servicoquantidade == "t") {
                        $servicoquantidade = "Sim";
                    }
                    echo " <tr>\n";
                    echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Serviço: </strong></td>\n";
                    echo "    <td colspan='1' align='left' bgcolor='#FFFFFF'><font color='#333333'>$servico</td>\n";

                    echo "    <td colspan='3' nowrap='nowrap' align='right' bgcolor='#CCCCCC'><strong>Controla Quantidade: </strong></td>\n";
                    echo "    <td colspan='2' align='left' bgcolor='#FFFFFF'><font color='#333333'>$servicoquantidade</td>\n";
                    echo "  <tr>\n";
                    ...
                    echo "    <td colspan='1' nowrap='nowrap' align='right' bgcolor='#CCCCCC'><strong>    Valor Unitário: </strong></td>\n";
                    echo "    <td colspan='1' align='left'  bgcolor='#FFFFFF'><font color='#333333'> R$" . db_formatar($pc11_vlrun, "v") . "</font></td>\n";
                    echo "    <td colspan='1' align='right' bgcolor='#CCCCCC'><strong>Valor Total: </strong></td>\n";
                    $valorTotal = $pc11_vlrun * $pc11_quant;
                    echo "    <td colspan='1' align='left' bgcolor='#FFFFFF'><font color='#333333'> R$" . db_formatar($valorTotal, "f") . "</strong></td>\n";
                    echo "  </tr>\n";
                    ...
                    if (isset($pc01_codmater) && trim($pc01_codmater) != "") {
                        ...
                        echo "  <tr>\n";
                        echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Descrição Material: </strong></td>\n";
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc01_descrmater</font></td>\n";
                        echo "  </tr>\n";
                        echo "  <tr>\n";
                        echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Sub. Elemento: </strong></td>\n";
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>" . db_formatar($o56_elemento, "elemento") . "</font></td>\n";
                        echo "  </tr>\n";
                        echo "  <tr>\n";
                        echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Descrição Elemento: </strong></td>\n";
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$o56_descr</font></td>\n";
                        echo "  </tr>\n";
                        if (isset($pc17_codigo) && trim($pc17_codigo) != "") {
                            ...
                            echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$m61_descr</font></td>\n";
                            echo "  </tr>\n";
                        } else if ($pc01_servico == 't') {
                            echo "  <tr>\n";
                            echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Referência: </strong></td>\n";
                            echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>SERVIÇO</font></td>\n";
                            echo "  </tr>\n";
                        }
                    }
                    if (isset($pc11_resum) && trim($pc11_resum) != "") {
                        ...
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc11_resum</font></td>\n";
                        echo "  </tr>\n";
                    }
                    if (isset($pc11_prazo) && trim($pc11_prazo) != "") {
                        ...
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc11_prazo</font></td>\n";
                        echo "  </tr>\n";
                    }
                    if (isset($pc11_just) && trim($pc11_just) != "") {
                        ...
                        echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc11_just</font></td>\n";
                        echo "  </tr>\n";
                    }
                    if (isset($pc11_pgto) && trim($pc11_pgto) != "") {
                        ...
                        echo "    <td colspan='5' align='left'  bgcolor='#FFFFFF'><font color='#333333'>$pc11_pgto</font></td>\n";
                        echo "  </tr>\n";
                    }
                    ...
                    if ($clpcdotac->numrows > 0) {
                        ...
                        echo "  <tr>\n";
                        echo "    <td colspan='6' align='center'  bgcolor='#CCCCCC'>";
                ...
                if ($numrows_orcamsol > 0) {
                    echo "<fieldset>";
                    echo "<legend><strong>Orçamento</strong></legend>";
                    echo "<table width='70%' border='0'>\n";
                    $antigorcam = "";
                    $antigoforn = "";
                    $julgar = false;
			        ...
			        $m61_descr";
                                    ...
                                    echo "  <tr>\n";
                                    echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Referência: </strong></td>\n";
                                    echo "    <td colspan='5' nowrap='nowrap' align='left' bgcolor='#FFFFFF'><font color='#333333'>SERVIÇO</font></td>\n";
                                    echo "  </tr>\n";
                                }
                                echo "  <tr>\n";
                    ...
                    if ($numrows_processos > 0) {
                        ...
                        for ($i = 0; $i < $numrows_processos; $i++) {
                            ...
                            if ($pc80_codproc != $pc80_codproc_ant) {
                                ...
                                echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#FFFFFF'><font color='#333333'>
                                        <a href='#' class='DBAncora' onClick='js_consultaProcCompras($pc80_codproc)'>$pc80_codproc</a></font></td>\n";
                                ...
                                echo "  <tr>\n";
                                echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Resumo: </strong></td>\n";
                                echo "    <td colspan='5' align='left' bgcolor='#FFFFFF'><font color='#333333'>$pc80_resumo</font></td>\n";
                                echo "  </tr>\n";
                                echo "</table>\n";
                                echo "</fieldset>";
                                echo "<fieldset>";
			...
			<font color='#333333'>" . db_formatar($o56_elemento, "elemento") . " - $o56_descr</font>
			      ...
			      $m61_descr";
                                ...
                                echo "  <tr>\n";
                                echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Referência: </strong></td>\n";
                                echo "    <td colspan='5' nowrap='nowrap' align='left' bgcolor='#FFFFFF'><font color='#333333'><strong>SERVIÇO</strong></font></td>\n";
                                echo "  </tr>\n";
                            }
                            echo "  <tr>\n";
                            echo "    <td colspan='1' nowrap='nowrap' align='left' bgcolor='#CCCCCC'><strong>Usuário: </strong></td>\n";
...
<script>
    ...
    function js_consultaProcCompras(codproc) {
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_infproc', 'com3_pesquisaprocessocompras003.php?pc80_codproc=' + codproc, 'Pesquisa Processo de Compras', true);
