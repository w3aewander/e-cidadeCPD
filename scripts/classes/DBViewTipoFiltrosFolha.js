...
DBViewFormularioFolha.DBViewTipoFiltrosFolha.prototype.trocaTipoRelatorio = function (iTipoRelatorio) {
    ...
    switch (iTipoRelatorio) {
        ...
        case '6':
            ...
            break;
        case '7':
            sNomeLancador = 'FonteRecurso';
            this.sFuncaoPesquisa = 'func_fonterecurso.php';
            this.sCampoRetorno = 'o15_recurso';
            break;
        default:
    ...
    if (!(this.oInstanciaLancador[sNomeLancador])) {
        ...
        switch (sNomeLancador) {
            ...
            case 'Recurso':
                ...
                break;
            case 'FonteRecurso':
                oLancadorFonteRecurso = new DBLancador('LancadorFonteRecurso');
                oLancadorFonteRecurso.setNomeInstancia('oLancadorFonteRecurso');
                oLancadorFonteRecurso.setGridHeight(150);
                oLancadorFonteRecurso.setLabelAncora('Recurso:');
                oLancadorFonteRecurso.setParametrosPesquisa('func_fonterecurso.php',
                    ['o15_recurso', 'o15_descr'],
                    'instit=' + this.iInstituicao);
                oLancadorFonteRecurso.show(this.oElementosHTML.oDivFonteRecurso);
                oLancador = oLancadorFonteRecurso;
                break;
            default:
        ...
        console.log(this.oInstanciaLancador)
    }
...
DBViewFormularioFolha.DBViewTipoFiltrosFolha.prototype.gerarElementosHTML = function () {
    ...
    this.oElementosHTML.oDivFonteRecurso = document.createElement("div");
    ...
    this.oElementosHTML.oColunaLancadores.appendChild(this.oElementosHTML.oDivFonteRecurso);
...
var ComboTipoRelatorio = function (aTipos) {
    ...
    aDescricaoTipos[7] = 'Fonte de Recurso';
