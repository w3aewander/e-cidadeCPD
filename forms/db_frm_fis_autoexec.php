...
function js_pesquisay15_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y15_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autoexec','func_fis_autoexec.php?funcao_js=parent.js_preenchepesquisa|y15_codauto','Pesquisa',true);
}
