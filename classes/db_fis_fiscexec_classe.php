...
class cl_fis_fiscexec {
   ...
   public $y13_codnoti = 0;
   public $y13_codigo = 0;
   public $y13_codi = 0;
   public $y13_numero = 0;
   public $y13_compl = null;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscexec");
...
public function incluir ($y13_codnoti){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscexec(
                                       y13_codnoti
                                      ,y13_codigo
                                      ,y13_codi
                                      ,y13_numero
...
public function alterar ($y13_codnoti=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscexec set ";
     $virgula = "";
...
public function excluir ($y13_codnoti=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscexec
                    where ";
     $sql2 = "";
...
public function sql_query ( $y13_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscexec ";
     $sql .= "      inner join bairro  on  bairro.j13_codi = fis_fiscexec.y13_codi";
     $sql .= "      inner join ruas  on  ruas.j14_codigo = fis_fiscexec.y13_codigo";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscexec.y13_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y13_codnoti!=null ){
         $sql2 .= " where fis_fiscexec.y13_codnoti = $y13_codnoti ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y13_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
