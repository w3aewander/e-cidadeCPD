...
class cl_escola_professores { 
   ...
   function incluir ($ed04_i_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1005004,1006044,'','".AddSlashes(pg_result($resaco,0,'ed04_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005004,1006056,'','".AddSlashes(pg_result($resaco,0,'ed04_i_professores'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005004,1006054,'','".AddSlashes(pg_result($resaco,0,'ed04_i_escolas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005004,1006042,'','".AddSlashes(pg_result($resaco,0,'ed04_f_ch'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed04_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1005004,1006044,'".AddSlashes(pg_result($resaco,$conresaco,'ed04_i_codigo'))."','$this->ed04_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed04_i_professores"]))
           $resac = db_query("insert into db_acount values($acount,1005004,1006056,'".AddSlashes(pg_result($resaco,$conresaco,'ed04_i_professores'))."','$this->ed04_i_professores',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed04_i_escolas"]))
           $resac = db_query("insert into db_acount values($acount,1005004,1006054,'".AddSlashes(pg_result($resaco,$conresaco,'ed04_i_escolas'))."','$this->ed04_i_escolas',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed04_f_ch"]))
           $resac = db_query("insert into db_acount values($acount,1005004,1006042,'".AddSlashes(pg_result($resaco,$conresaco,'ed04_f_ch'))."','$this->ed04_f_ch',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed04_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1005004,1006044,'','".AddSlashes(pg_result($resaco,$iresaco,'ed04_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005004,1006056,'','".AddSlashes(pg_result($resaco,$iresaco,'ed04_i_professores'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005004,1006054,'','".AddSlashes(pg_result($resaco,$iresaco,'ed04_i_escolas'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005004,1006042,'','".AddSlashes(pg_result($resaco,$iresaco,'ed04_f_ch'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
