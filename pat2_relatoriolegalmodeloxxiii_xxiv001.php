...
<form class="container" name="form1" method="post">
	<fieldset>
  	<legend>Arrolamento das Exist&ecirc;ncias</legend>
    <table class="form-container">
      <tr>
        <td title="Data inicial para Filtro do relatorio">
          <b>Data inicial:</b>
        </td>
        <td>
          <?php
      ...
      <tr>
        <td title="Data final para Filtro do relatorio">
          <b>Data final:</b>
        </td>
        <td>
          <?php
      ...
      <tr>
        ...
        <td>
          <?php
            $aTipoBem = array( 1 => "Moveis" , 2 => "Imoveis");
            db_select("iTipoBem", $aTipoBem, true, 1);
          ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <?php
            $aTipoRelatorio = array( "pdf" => "PDF", "xls" => "XLS");
  ...
  <?php if(db_getsession("DB_instit") == 45) : ?>
    <input name="relatorio" type="button" onclick='js_abre2();'  value="Emitir">	 
  <?php else : ?>  
...
function js_abre(){
  ...
  var sFonte = "";
  if (iTipoBem == 1){
	sFonte = "pat2_relatoriolegalmodeloxxiii002.php";
  }else{
  	sFonte = "pat2_relatoriolegalmodeloxxiv002.php";
  }
  ...
  if (sDataInicial == "" || sDataFinal == ""){
    ...
    alert("Per�odo precisa ser preenchido.");
    return false;
  }
...
function js_abre2(){
  ...
  var sFonte = "";
  if (iTipoBem == 1){
  sFonte = "pat2_relatoriolegalmodeloxxiii002saae.php";
  }else{
    sFonte = "pat2_relatoriolegalmodeloxxiv002saae.php";
  }
