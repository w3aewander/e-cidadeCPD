...
class M13837CalculaBuscaEnvolvidos extends PostgresMigration
{
    public function up()
    {
        $sql = <<<DEBITOZ
            ...
            select distinct
              ...
              from (
                  select arrecad.k00_numpre,
                         ...
                         arrecad.k00_dtvenc,
                         arrecad.k00_dtoper,
                         (select rinumcgm from fc_busca_envolvidos('t', db_config.db21_regracgmiptu, 'M', arrematric.k00_matric)) as k00_numcgm,
                         arrematric.k00_matric,
                         arrematric.k00_perc as k00_percmatric,
                         cast(0 as integer)  as k00_inscr,
                         cast(0 as float8)   as k00_percinscr,
