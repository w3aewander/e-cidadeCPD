...
function a_saldo_disponivel_produto($string_column, $array_row, $array_last_row, $row_num, $col_num)
{
// echo "cell : $string_column - array_row : " . $array_row[9] . "\n";
