    ...
    <form action="" method="post" class="form-container">
      <fieldset>
        ...
        <table>
          ...
          <tr>
            <td>
              <label class="bold">Exibir apenas alunos com frequência menor ou igual a 75%</label>
            </td>
            <td>
              <select id="exibirFrequencia75">
                <option value="N">Não</option>
                <option value="S">Sim</option>
              </select>
            </td>
...
$('exibirFrequencia75').className = 'field-size-max';
...
var oCache = new DBFormCache( 'oCache', 'edu2_qdresultadofinal001.php' );
    oCache.setElements( [ $('brasao'), $('exibirTrocaTurma'), $('exibirFrequencia75') ] );
    oCache.load();
...
function geraRelatorio() {
  ...
  var sParametros  = '?iEscola='           + oEscola.getSelecionados().codigo_escola;
      ...
      sParametros += '&sExibirFrequencia75=' + $F('exibirFrequencia75');
