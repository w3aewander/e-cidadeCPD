...
function js_consultasani(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_consultasani','fis3_fis_consultasani002.php?y80_codsani='+document.form1.y80_codsani.value+'&y80_numcgm='+document.form1.y80_numcgm.value+'&ativ='+document.form1.ativ.value+'&dataini='+document.form1._ano.value+'-'+document.form1._mes.value+'-'+document.form1._dia.value+'&datafim='+document.form1.a_ano.value+'-'+document.form1.a_mes.value+'-'+document.form1.a_dia.value+'&funcao_js=parent.js_abreconsulta|y80_codsani','Pesquisa',true);
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sanitario','func_fis_sanitario.php?lMostarTodos=true&funcao_js=parent.js_preenchepesquisa|y80_codsani','Pesquisa',true);
}
function js_preenchepesquisa(chave){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_consulta','fis3_fis_consultasani002.php?y80_codsani='+chave,'Pesquisa',true);
}
...
function js_abreconsulta(chave){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_consulta','fis3_fis_consultasani002.php?y80_codsani='+chave,'Pesquisa',true,25);
}
</script>