 ...
 <center>
  <table border="0">
   ...
   <tr>
    ...
    <td>
     <?db_input('ed06_abreviatura', 3,$Ied06_abreviatura,true,'text',$db_opcao,"oninput=js_validaInput(this);")?>
    </td>
   </tr>
...
// Validação para permitir apenas letras e números. Sem caracteres especiais
function js_validaInput(inputField) {
    if (/[^a-zA-Z0-9]/.test(inputField.value)) {
        alert('Não é permitido caracteres especias. Somente letras e números!');
