...
<head>
    ...
    <script type="text/javascript">
        ...
        function js_emite() {
            ...
            qry += '&particiona=' + document.form1.particiona.value;
        ...
        function js_detectaarquivo(arquivo1, pdf1, arquivo2, pdf2) {

            (window.CurrentWindow || parent.CurrentWindow).corpo.db_iframe_gerarais.hide();
            
            if (arquivo2 != "") {
              listagem = arquivo1 + "#Download Arquivo TXT A-L (.dec) |";
              listagem += pdf1 + "#Download Relatório A-L |";
              listagem += arquivo2 + "#Download Arquivo TXT M-Z (.dec) |";
              listagem += pdf2 + "#Download Relatório M-Z";
            } else {
              listagem = arquivo1 + "#Download Arquivo TXT (.dec) |";
              listagem += pdf1 + "#Download Relatório ";
            }
    ...
    <form name="form1" method="post" action="">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td nowrap title="Particiona geração do arquivo?">
                        <label class="bold">Particiona geração:</label>
                    </td>
                    <td>
                        <div class="ajuste-style-fieldset-1">
                            <?php
