...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tt52_dtinclusao?>">
       <?=@$Lt52_dtinclusao?>
    </td>
    <td>
<?
...
function js_pesquisa_bens(){
  ...
  erro_abasimov=0;
  erro_abasmat=0;
  if((window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensimoveis.document.form1.t54_idbql.value==""){
    erro_abasimov++;
  }
  x = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1;
  for(i = 0;i < x.length;i++){
    if(x.elements[i].type == "text"){
      nome=x.elements[i].name;
  ...
  if(erro_abasimov==0 && erro_abasmat==0){
    ...
    if(erro_abasmat!=0){
      document.form1.dadimovlot.value = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensimoveis.document.form1.t54_idbql.value;
      document.form1.dadimovobs.value = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensimoveis.document.form1.t54_obs.value;
    }else if(erro_abasimov!=0){
      t53_garant_dia = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_garant_dia.value;
      t53_garant_mes = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_garant_mes.value;
      t53_garant_ano = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_garant_ano.value;
      t53_garant = t53_garant_ano+'-'+t53_garant_mes+'-'+t53_garant_dia;
      document.form1.dadmat.value = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_ntfisc.value;
      document.form1.dadmat.value += ","+(window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_empen.value;
      document.form1.dadmat.value += ","+(window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.document.form1.t53_ordem.value;
