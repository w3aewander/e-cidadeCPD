...
db_postmemory($HTTP_POST_VARS);
 ...
 if(isset($opcao) && $opcao == "alterar"){
   echo "<script>parent.iframe_autolevanta.location.href='fis1_fis_autolevanta002.php?chavepesquisa=$y50_codauto&chavepesquisa1=$y117_levanta'</script>";
 }
 if(isset($opcao) && $opcao == "excluir"){
   echo "<script>parent.iframe_autolevanta.location.href='fis1_fis_autolevanta003.php?chavepesquisa=$y50_codauto&chavepesquisa1=$y117_levanta'</script>";
 }
?>
    ...
    <td align="center" colspan="2">
      ...
      <input name="db_opcao" type="submit" id="db_opcao" value="<?php echo $sValorBotao?>" <?php echo ($db_botao==false?"disabled":"")?> >
        <?php
          if ( ($db_opcao==2||$db_opcao==22||$db_opcao==3||$db_opcao==33) ) {
        ?>
            <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_autolevanta001.php?y50_codauto=<?php echo $y50_codauto?>'">
        <?php
          }
        ?>
    </td>
    ...
    <td align="top" colspan="2">
      <?php
       if(isset($y50_codauto) && $y50_codauto != ""){
         ...
         $cliframe_alterar_excluir->sql      = $clautolevanta->sql_query(""," fis_autolevanta.*",""," y117_auto = $y50_codauto");
...
function js_lev(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe','func_fis_levanta.php?todos=true&responsavel=true&'+nomeVar+'='+z01_nomecgminscr+'&z01_numcgm='+z01_numcgm+'&q02_inscr='+q02_inscr+'&funcao_js=parent.js_mostralev1|y60_codlev|dbtxtnome_origem','Pesquisa',true);
  }else{

    console.log(z01_numcgm);
    console.log(q02_inscr);

    js_OpenJanelaIframe('','db_iframe','func_fis_levanta.php?todos=true&responsavel=true&'+nomeVar+'='+z01_nomecgminscr+'&pesquisa_chave='+y60_codlev+'&z01_numcgm='+z01_numcgm+'&q02_inscr='+q02_inscr+'&funcao_js=parent.js_mostralev','Pesquisa',false);
  }
}
...
function js_pesquisay50_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y50_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
