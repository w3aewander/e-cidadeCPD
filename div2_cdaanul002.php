...
include(modification("classes/db_acertid_classe.php"));
...
$sOrderBy = null;
if (isset($sOrdenacao)   &&  $sOrdenacao != "" ) {
  ...
  $sOrderBy = $sOrdenacao;
  $head6 = "Ordenado por: $sOrdena";
}

$result = $clacertid->sql_record($clacertid->sql_query_info(null,"distinct v15_certid,v15_data,v14_coddiv,v01_exerc,v14_parcel,v15_parcial,nome", $sOrdenacao, $where));
