...
/**
 * Class cl_avaliacaogruporespostaobras
 */
class cl_avaliacaogruporespostaobras extends DAOBasica
{
    public function __construct()
    {
        parent::__construct("esocial.avaliacaogruporespostaobras");
    }
    ...
    public function buscaRespostasPorPergunta($pergunta, $preenchimento, $campos = "*", $ordem = null)
    {
        ...
        $sql .= "      inner join avaliacaogruporesposta on db107_sequencial = eso35_avaliacaogruporesposta";
    ...
    public function buscaPreenchimento(array $campos, array $where, array $order, $instit = null)
    {
        ...
        $sql .= " from avaliacaogruporespostaobras ";
        $sql .= " join avaliacaogruporesposta on avaliacaogruporesposta.db107_sequencial = avaliacaogruporespostaobras.eso35_avaliacaogruporesposta ";
        ...
        $sql .= " join cgm on cgm.z01_numcgm = avaliacaogruporespostaobras.eso35_empregador ";
    ...
    public function avaliacaoPreenchida(array $campos = array('*'), array $where = array(), $outrosComandos = null)
    {
        $sql = " select " . implode(', ', $campos);
        $sql .= "  from avaliacaogruporespostaobras ";
        $sql .= "  join avaliacaogruporesposta on db107_sequencial = eso35_avaliacaogruporesposta ";
