...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td valign="top" bgcolor="#CCCCCC">
   <fieldset style="width:97%"><legend><b>Consulta de Rotas</b></legend>
       ...
       <table border="0" width="100%" bgcolor="#f3f3f3" cellspacing="0" cellpading="0">
        <tr>
         <td style="font-size:18px;font-weight:bold;font-family:verdana;">
          &nbsp;&nbsp;<?=$ed217_i_codigo?>&nbsp;&nbsp;-&nbsp;&nbsp;<?=$ed217_c_origem?>
         </td>
         <td align="right">
          <input type="button" value="Fechar" onclick="parent.db_iframe_linha.hide();">&nbsp;&nbsp;
      ...
      <td>
       <table border="0" width="100%" cellspacing="0" cellpading="0">
        <tr>
         ...
         <td valign="top">
          <fieldset style="background:#f3f3f3;border:2px solid #000000"><legend class="cabec"><b>Linhas</b></legend>
          <table border="1" width="100%" bgcolor="#f3f3f3" cellspacing="0" cellpading="4">
           <tr>
            <td>
            <?=@$Led217_c_destino?> <?=@$ed217_c_destino==""?"Não Informado":$ed217_c_destino?>
             &nbsp;&nbsp;
          ...
          <table border="0" width="100%">
           <tr>
            <td id="menu1" bgcolor="#444444" style="border:2px outset #f3f3f3" onmouseover="document.getElementById('menu1').style.border='2px inset #f3f3f3'" onmouseout="document.getElementById('menu1').style.border='2px outset #f3f3f3'">
             <a style="color:#DEB887;font-weight:bold;" href="edu3_rota002.php?chavepesquisa=<?=$chavepesquisa?>&evento=1"  target="iframe_dados">
             Itinerários
             </a>
            </td>
           </tr>
           <tr>
            <td id="menu2" bgcolor="#444444" style="border:2px outset #f3f3f3" onmouseover="document.getElementById('menu2').style.border='2px inset #f3f3f3'" onmouseout="document.getElementById('menu2').style.border='2px outset #f3f3f3'">
             <a style="color:#DEB887;font-weight:bold;" href="edu3_rota002.php?chavepesquisa=<?=$chavepesquisa?>&evento=2"  target="iframe_dados">
             Alunos por rota
             </a>
            </td>
           </tr>
            ...
            <td id="menu3" bgcolor="#444444" style="border:2px outset #f3f3f3" onmouseover="document.getElementById('menu3').style.border='2px inset #f3f3f3'" onmouseout="document.getElementById('menu3').style.border='2px outset #f3f3f3'">
             <a style="color:#DEB887;font-weight:bold;" href="edu3_rota002.php?chavepesquisa=<?=$chavepesquisa?>&evento=3"  target="iframe_dados">
             Movimentação de rotas
             </a>
            </td>
           </tr>
          </table>
...
function js_imprimir(chave){
 jan = window.open('edu2_linha002.php?chavepesquisa='+chave,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
 jan.moveTo(0,0);
}
</script>