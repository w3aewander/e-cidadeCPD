...
define('ECIDADE_PATH_TABELA_ESOCIAL', __DIR__ . DS . 'arquivos' . DS . 'esocial' . DS . 'tabelas' . DS);
define('ECIDADE_TEMP_MPDF_PATH', __DIR__ . DS . 'tmp'. DS . 'mpdf');
