...
include(modification("classes/db_benscomissaousu_classe.php"));
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_benscomissaousu.location.href='pat1_benscomissaousu001.php?db_opcaoal=33&t61_codcom=".@$t60_codcom."';
     ";
         if(isset($liberaaba)){
