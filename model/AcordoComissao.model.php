...
class AcordoComissao {
  ...
  protected $sObservacao;
	...
	/**
	 * Membros da comissão. (acordocomissaomembros)
	 *
    ...
    /**
	 * Instituição da comissão. (instit)
	 *
	 * @var Integer
	 */
  ...
  function __construct($iCodigo = null) {
  	...
  	if ($iCodigo) {
  		...
  		if ($oDaoComissao->numrows == 0) {
            ...
            $this->setInstituicao($oComissao->ac08_instit);
            $this->setTipo($oComissao->ac08_acordocomissaotipo);
  ...
  function save() {
    ...
    $oDaoComissao->ac08_instit      = $this->getInstituicao();
    $oDaoComissao->ac08_acordocomissaotipo = $this->getTipo();

    if ($this->iCodigo) {
        $codigo = $this->getCodigo();
        $oDaoComissao->ac08_sequencial = $codigo;
  		$oDaoComissao->alterar($codigo);
