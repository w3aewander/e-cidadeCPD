...
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Campos\ExisteContratoTermo\ExisteContratoTermoCampo;
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Campos\TipoInstrumentoContratual\TipoInstrumentoContratualCampo;
  ...
  public function processa($instit=1,$data_ini="",$data_fim="",$tribinst=null,$subelemento="") {
    ...
    for ($x = 0; $x < $rows; $x++) {
      ...
      if ($oContratosPADRS) {
        ...
        $line .= $existeContratoTermoCampo->getValor() . $sNumeroContrato . $sNumeroAnoContrato . $sAnoContrato;
      ...
      if ($oStdInformacao->verifica_nota == 't' && preg_match('/^\d{5}(30|32|35|36|37|39|51|52|62)/', $oStdInformacao->estrutural)) {
        ...
        $line .= $sExisteNota . $sNumeroNota . $sSerieNota . $tipoInstrumentoContratualCampo->getValor();
