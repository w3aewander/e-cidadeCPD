    ...
    function sql_query_emiteordem(
      ...
      $joinDotacao = false
        ...
        if ($joinDotacao === true) {
            ...
            $sql .= "                       and o58_instit = " . db_getsession("DB_instit") . " ";
            $sql .= "                       and o58_anousu = e60_anousu ";
            $sql .= " inner join orcorgao on o58_orgao = o40_orgao and o40_anousu = e60_anousu ";
            $sql .= " inner join orcunidade  on o58_unidade = o41_unidade ";
            $sql .= "                       and o58_orgao = o41_orgao ";
            $sql .= "                       and o41_anousu = o58_anousu ";
            $sql .= " inner join orcfuncao on o58_funcao = o52_funcao ";
            $sql .= " inner join orcsubfuncao on o58_subfuncao = o53_subfuncao ";
            $sql .= " inner join orcprograma on o58_programa = o54_programa and o54_anousu = o58_anousu ";
            $sql .= " inner join orcprojativ on o58_projativ = o55_projativ and o55_anousu = o58_anousu ";
            $sql .= " inner join orctiporec on o58_codigo = o15_codigo ";
        }
