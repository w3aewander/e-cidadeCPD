  ...
  <fieldset>
    ...
    <table>
      ...
      ?>
        <tr>
          <td>
            <?=$Lo41_codigotribunalxml?>
          </td>
          <td>
            <?php
              db_input('o41_codigotribunalxml',15,$Io41_codigotribunalxml,true,'text',$db_opcao,"");
            ?>        
          </td>
        </tr>
        <tr>
          ...
          <td>
            <?php
              db_input('o41_nometribunal',50,$Io41_nometribunal,true,'text',$db_opcao,"");
            ?>        
          </td>
        </tr>
      <?php } ?>
      <tr>
        ...
        <td>
          <?php
          $x = array('01'=>'Prefeitura Municipal',
              '02'=>'Câmara Municipal',
...
function js_pesquisao41_anousu(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo',
    	                'db_iframe_orcorgao',
    	                'func_orcorgao.php?funcao_js=parent.js_mostraorcorgao1|o40_anousu|o40_descr',
    	                'Pesquisa',
    	                true);
  }else{
     if(document.form1.o41_anousu.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo',
                            'db_iframe_orcorgao',
                            'func_orcorgao.php?pesquisa_chave='+document.form1.o41_anousu.value+'&funcao_js=parent.js_mostraorcorgao',
                            'Pesquisa',
                            false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo',
     ...
     if(document.form1.o41_orgao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo',
                            'db_iframe_orcorgao',
                            'func_orcorgao.php?pesquisa_chave='+document.form1.o41_orgao.value+'&funcao_js=parent.js_mostraorcorgao',
                            'Pesquisa',
                            false);
     }else{
       document.form1.o40_descr.value = '';
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo',
		              ...
		              'func_orcunidade.php?funcao_js=parent.js_preenchepesquisa|o41_anousu|o41_orgao|o41_unidade',
		              'Pesquisa',
		              true);
}
