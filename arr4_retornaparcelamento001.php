...
if (isset($oPost->processar)) {
    ...
    try {
         ...
         */
        $sSqlDadosParcelamento  = "select                                                            ";
        $sSqlDadosParcelamento .= "  termo.v07_numpre as numpre,                                     ";
        $sSqlDadosParcelamento .= "  termo.v07_dtlanc,                                               ";
        $sSqlDadosParcelamento .= "  case                                                            ";
        $sSqlDadosParcelamento .= "  when v08_parcel is not null and termoini.parcel is not null     ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      1                                                           ";
        $sSqlDadosParcelamento .= "  when v08_parcel is not null and termodiv.parcel is not null     ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      2                                                           ";
        $sSqlDadosParcelamento .= "  when v08_parcel is not null and dv10_parcel is not null         ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      3                                                           ";
        $sSqlDadosParcelamento .= "  when  v08_parcel is not null                                    ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      4                                                           ";
        $sSqlDadosParcelamento .= "  when  termoini.parcel is not null                               ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      5                                                           ";
        $sSqlDadosParcelamento .= "  when termodiv.parcel is not null                                ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      6                                                           ";
        $sSqlDadosParcelamento .= "  when dv10_parcel is not null                                    ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      7                                                           ";
        $sSqlDadosParcelamento .= "  when termocontrib.parcel is not null                            ";
        $sSqlDadosParcelamento .= "    then                                                          ";
        $sSqlDadosParcelamento .= "      8                                                           ";
        $sSqlDadosParcelamento .= "  end as tipo_parcelamento,                                       ";
        ...
        $sSqlDadosParcelamento .= "  left join termoreparc on v08_parcel = v07_parcel                ";
        $sSqlDadosParcelamento .= "  left join termodiver on dv10_parcel = v07_parcel                ";
        $sSqlDadosParcelamento .= "  left join termoini on termoini.parcel = v07_parcel              ";
        $sSqlDadosParcelamento .= "  left join termodiv on termodiv.parcel = v07_parcel              ";
        $sSqlDadosParcelamento .= "  left join termocontrib on termocontrib.parcel = v07_parcel      ";
        $sSqlDadosParcelamento .= "where termo.v07_parcel = {$oPost->parcelamento}                   ";
        $sSqlDadosParcelamento .= "limit 1                                                           ";
        ...
        switch ($oDadosParcelamento->tipo_parcelamento) {
            case 1: //Reparcelamento com  Inicial do foro
                $sCadTipoValidos = "13,12,18";
                break;
            case 2: //Reparcelamento com Divida
                $sCadTipoValidos = "6,5";
                break;
            case 3: //Reparcelamento com Diversos
                $sCadTipoValidos = "16, 7";
                break;
            case 4: //Reparcelamento
                $sCadTipoValidos = "6,13,16,17";
                break;
            case 5: //Parcelamento de Inicial do Foro
                $sCadTipoValidos = "12,18";
                break;
            case 6: //Parcelamento de Divida
                $sCadTipoValidos = "5";
                break;
            case 7: //Parcelamento de Diversos
                $sCadTipoValidos = "7";
                break;
            case 8: //Parcelamento de Contribuição de Melhoria
                $sCadTipoValidos = "4";
                break;
        }
        ...
        for ($iInd = 0; $iInd < $iLinhasOrigem; $iInd++) {
            ...
            $sSqlDadosNumpreArrecad = $oArrecad->sql_query_file(null, "*", "",
              "k00_numpre = {$oDados->origem_numpre} and k00_numpar = {$oDados->origem_numpar} and k00_receit = {$oDados->receita_origem}");
             ...
             */
            $rsDatausu = db_query("select fc_putsession('DB_datausu', '" . date('Y-m-d', db_getsession('DB_datausu')) . "')");
        ...
        $sSqlParcelasParcelamento = $oArreold->sql_query_file(null, "*", "k00_numpre, k00_numpar, k00_receit",
          "k00_numpre = {$oDadosParcelamento->numpre}");
        ...
        $oTermoAnuProc->excluir(null,
          "v22_termoanu in (select v09_sequencial from termoanu where v09_parcel = {$oPost->parcelamento})");
 ...
 *
 * 
 *    retirado a validação conforme solicitado no redmine 17260
 * 
 * 
