...
abstract class AcordoMovimentacao {
  ...
  public function save() {
    ...
    if (!empty($iCodigo)) {
       ...
       */
      $date = empty($this->dtMovimento) ? date("Y-m-d",db_getsession("DB_datausu")) : $this->dtMovimento;
	    $oDaoAcordoMovimentacao->ac10_id_usuario        = db_getsession('DB_id_usuario');
	    $oDaoAcordoMovimentacao->ac10_datamovimento     = $date;
