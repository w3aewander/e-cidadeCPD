...
<form name="form1" method="post" action="" id="frmFisicoFinanceiro">
    <table style="border: 0; width: 100%;">
        <tr>
            ...
            if (empty($iSelectControle) || $iSelectControle < 1 || $iSelectControle > 4) {
                ?>
        <tr>
            <td nowrap title="Selecione um tipo de controle." style="text-align: center">
                <?php
                $aX = [
            ...
            <td style="text-align: left; width: 20%;" nowrap>
                <fieldset style='width: 10%;'>
                    <legend><b>Controle por:</b></legend>
        ...
        // Nenhum tipo de controle foi informado ainda, então, não exibo o iframe também
            if (isset($iSelectControle) && !empty($iSelectControle) && $iSelectControle > 0 && $iSelectControle < 5) {
                ?>
            <tr> <!-- IFRAME -->
                <td colspan="4" style="width: 100%; height: 370px;">
                    <iframe src=""
                            style="overflow: auto; overflow-y: hidden; border: 0; width: 100%; height: 100%"
