...
function js_pesquisak17_codigo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_slip','func_slip.php?funcao_js=parent.js_mostraslip1|k17_codigo','Pesquisa',true);
     ...
     if(document.form1.k17_codigo.value != ''){ 
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_slip','func_slip.php?pesquisa_chave='+document.form1.k17_codigo.value+'&funcao_js=parent.js_mostraslip','Pesquisa',false);
     }else{
