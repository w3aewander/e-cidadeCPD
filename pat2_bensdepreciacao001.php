...
<body class="body-default">
  <div class="container">
    <form name="form1">
        ...
        <table>
          <tr>
            <td colspan="2"><div id="oLancadorOrgao"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <?php db_inputdata('periodoInicial','01', '01', db_getsession('DB_anousu'), true,'text',1,""); ?>
              <label class="bold" for="periodoFinal">a</label>
              <?php $dDataAtual = date("d/m/Y");              
                    $diaf = date("d", db_getsession("DB_datausu"));
                    $mesf = date("m", db_getsession("DB_datausu"));
              ?>
              <?php db_inputdata('periodoFinal',$diaf, $mesf, db_getsession('DB_anousu'), true,'text',1,""); ?>
            </td>
       	  </tr>
          <tr>
          ...
          <tr>
            <td nowrap style="width: 1%">
              <label class="bold" for="tipoTotal">Totalizar por:</label>
            </td>
            <td>
              <?php
  ...
  <script type="text/javascript">
    ...
    var oLancadorOrgao = new DBLancador("oLancadorOrgao");
    oLancadorOrgao.setNomeInstancia("oLancadorOrgao");
    oLancadorOrgao.setLabelAncora("Órgão:");
    oLancadorOrgao.setLabelValidacao("Órgão");
    oLancadorOrgao.setTextoFieldset("Órgãos");
    oLancadorOrgao.setParametrosPesquisa("func_orcorgao.php", ['o40_orgao', 'o40_descr', 'o40_instit'], 'instit=' + <?php echo db_getsession('DB_instit'); ?>);
    oLancadorOrgao.setGridHeight("75px");
    oLancadorOrgao.setTituloJanela("Pesquisar Órgãos");
    oLancadorOrgao.show($("oLancadorOrgao"));
    ...
    oLancadorDepartamento.setGridHeight("75px");
    ...
    oLancadorContas.setGridHeight("75px");
