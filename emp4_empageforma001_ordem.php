...
include(modification("classes/db_empageforma_classe.php"));
...
//            die("ord: $e50_codord - disp: $disponivel\n");
              ...
              if($e60_anousu == db_getsession("DB_anousu") && $recursos != 'todos'){
                ...
                $sSqlContas = $clempagetipo->sql_query_contas_vinculadas(
                  null,
                ...
                $result05  = $clempagetipo->sql_record($sSqlContas);
