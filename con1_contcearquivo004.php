...
require_once(modification("classes/db_contcearquivoresp_classe.php"));
require_once(modification("classes/db_contcearquivorespcgm_classe.php"));
require_once(modification("classes/db_concadtce_classe.php"));
