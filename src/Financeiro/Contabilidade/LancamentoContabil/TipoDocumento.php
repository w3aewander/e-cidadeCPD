...
class TipoDocumento
{
    ...
    /**
     * Documentos que envolvem empenho (conlancamemp)
     * @var int[]
     */
    public static $documentosEmpenho = [
          10,
          11,
          20,
          21,
    ...
    /**
     * Documentos que envolvem receita (conlancamrec)
     * @var int[]
     */
    public static $documentosReceita = [
        40,
        100,
        101,
        110,
