 ...
 */
  ...
  try {
    ...
    if (isset($incluir)) {
      ...
      $sSqlTipoAsseFinanceiro  = $cltipoassefinanceiro->sql_query_file(null, "rh165_tipoasse", null, "rh165_tipoasse = {$rh165_tipoasse} and rh165_instit = {$iInstituicao} and rh165_mesusu = {$mesFolha} and rh165_anousu = {$anoFolha}");
      ...
      if (!$lErro) {
        ...
        $cltipoassefinanceiro->rh165_anousu           = $anoFolha;
        $cltipoassefinanceiro->rh165_mesusu           = $mesFolha;
