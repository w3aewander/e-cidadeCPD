...
<body>
    ...
    <form class="container" name="form1" method="post" action="" onsubmit="return js_verifica();">
        <fieldset>
            <Legend align="left">Arquivo de Cadastro de Vale Transporte Sindpass</Legend>
...
<script>
    ...
    function js_gerarArquivo() {
        ...
        var url = 'pes2_pedidosindpassrhteutri002.php';
        ...
        var objAjax = new Ajax.Request(url, {
            ...
            onComplete: function(response) {
                ...
                oDownload.addFile(data.arquivo, 'valefunc');
                oDownload.show();
