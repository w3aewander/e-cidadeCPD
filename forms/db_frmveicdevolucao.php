...
<body class="container">
    ...
    <form name="form1" id="form1" method="post" action="" onsubmit="return js_verificaDataDevolucao();">
        <div class="container">
            ...
            <tr>
                <td colspan="2">
                    <input name="<?= ($db_opcao == 1 ? "incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "alterar" : "excluir")) ?>" type="submit" id="db_opcao" value="<?= ($db_opcao == 1 ? "Incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "Alterar" : "Excluir")) ?>" <?= ($db_botao == false ? "disabled" : "") ?> onclick="return js_verificamedida(1);">
...
<script>
    ...
    <?php if ($db_opcao != 3) { ?>
        ...
        function js_verificamedida(op) {
            ...
            var ultimamedida = new Number(document.form1.ultimamedida.value);

            if (ultimamedida > medidadevol) {
    ...
    function js_pesquisa_medida() {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_proximamedida',
            ...
            '&data=' + databanco +
            '&hora=' + document.form1.ve61_horadevol.value +
            '&devolucao=' + devolucao, 'Pesquisa Proxima Medida', false);
        return true;
    }
    ...
    function js_formataHora() {
        ...
        new MaskedInput("#ve60_horasaida", "00:00", {
            placeholder: "0"
        });
        new MaskedInput("#ve61_horadevol", "00:00", {
            placeholder: "0"
        });
    }
