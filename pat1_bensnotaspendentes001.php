          ...
          <fieldset class="separator">
            ...
            <table>
                ...
                <td>
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                          <?php
                          db_input('placa', 10, 1, true, "text", 1, "onkeypress=\"return js_mask(event, '0-9')\"", "", "", "", 10);
                          ?>
              ...
              <tr>
                ...
                <td>
                  <?php
                    ...
                    db_input('descricao_classificacao', 84, $It64_descr, true, 'text', 3, '');
                  ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <?php
                    ...
                    db_input('descricao_fornecedor', 84, $Iz01_nome, true, 'text', 3, '');
                  ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <?php
                    ...
                    db_input("descricao_aquisicao", 84, $It45_descricao, true, 'text', 3, '');
                  ?>
                </td>
              </tr>
              ...
              <tr style="display: none;">
                ...
                <td>
                  <?php db_input("orgao", 98, "", true, 'text', 3); ?>
                </td>
              </tr>
              ...
              <tr style="display: none;">
                ...
                <td>
                  <?php db_input("unidade", 98, "", true, 'text', 3); ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <?php
                    ...
                    db_input('descricao_departamento', 84, $Idescrdepto, true, 'text', 3, '');
                  ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td nowrap>
                  <?php
                    ...
                    db_input("descricao_convenio", 84, '', true, 'text', 3, '');
                  ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td nowrap>
                  <?php
                    ...
                    db_input("descricao_situacao",84,$It70_descr,true,'text',3,'');
  ...
  <script type="text/javascript">
    ...
    (function(exports) {
      ...
      oViewNotas.setCallBackConfirmar(function(aLinhas) {
        ...
        new AjaxRequest("pat1_bensnovo.RPC.php", { exec : "getDadosItemNota", iCodigoItemNota : aNotasItem.join(',')}, function(oRetorno, lErro) {
          ...
          oDadosNotas = {
            ...
            data : oRetorno.aNotas[0].dataAquisicao.getDate()
          };
      ...
      function carregarDadosPlaca() {
        ...
        new AjaxRequest(RPCConsulta, { exec : "carregaInclusao"}, function(oRetorno, lErro) {
          ...
          if (lErro) {
            ...
            $('placa').setAttribute('disabled', 'disabled');
            return false;
          }
      ...
      $("lancar").observe("click", function() {
        ...
        let nameImage = '';
        if (oCampos.foto.getValue()) {
            nameImage = oCampos.foto.inputFileElement.files[0].name;
        }
        var oBem = {
      ...
      $("salvar").observe("click", function() {
        ...
        let valorBens = new Number(nValorBens.toFixed(2));
        let valorTotal = new Number(oDadosNotas.valorTotal.toFixed(2));
        let diferencaValor = new Number((valorBens.valueOf() - valorTotal.valueOf()).toFixed(2));
        let diferencaCentavosValida = new Number(0.01);
        let recalcularCentavoBem = false;

        if(Math.abs(diferencaValor.valueOf()) === diferencaCentavosValida.valueOf()) {
          recalcularCentavoBem = true;
        }

        if (oDadosNotas.valorTotal.toFixed(2) != nValorBens.toFixed(2) && recalcularCentavoBem === false) {
          return alert( _M(MENSAGENS + "valor_bem_nota") );
        }

        var oParametros = {
          exec : "salvar",
          recalcularCentavoBem: recalcularCentavoBem,
      ...
      var pesquisa = {
        classificacao : {
          busca : function(lMostra) {
            ...
            if (lMostra) {
              sFuncao += "preenche|t64_class|t64_descr|t64_codcla|t64_benstipodepreciacao|t46_descricao|t64_vidautil|t64_valorresidual";
            } else {
          ...
          preenche : function(sLabel, sDescricao, iCodigo, iCodigoDepreciacao, sDescricaoDepreciacao, iVidaUtil, iValorResidual) {
            ...
            oCampos.perc_residual.value         = iValorResidual;
            oCampos.perc_residual.dispatchEvent(new Event('change'));

            db_iframe_clabens.hide();
            (iParametroPlaca == 2) && carregarPlacaClassificacao(oCampos.classificacao.label.value);
          },
          completa : function(sDescricao, lErro, iCodigo, iCodigoDepreciacao, sDescricaoDepreciacao, iVidaUtil, iValorResidual) {
