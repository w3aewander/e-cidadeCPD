...
$pdf->text(85,$pdf->h - 17,'______________________________',0,4);
$pdf->text(98,$pdf->h - 14,'Claudionor de Souza',0,4);
$pdf->text(98,$pdf->h - 11,' DIRETOR DE DF/SMF',0,4);

$pdf->text(150,$pdf->h - 17,'______________________________',0,4);
$pdf->text(155,$pdf->h - 14,'   Jorge Luis dos Santos',0,4);
$pdf->text(155,$pdf->h - 11,'SUBSECRETÁRIO DE FAZENDA',0,4);

$pdf->text(210,$pdf->h - 17,'______________________________',0,4);
$pdf->text(220,$pdf->h - 14,' Norma Lydia Borba Chaffin',0,4);
$pdf->text(220,$pdf->h - 11,'SECRETÁRIA DE FAZENDA',0,4);
