...
class ProfissionalEscolaRegistry
{
    /**
     ...
     */
    public static function set(ProfissionalEscola $profissionalEscola)
    {
        self::$storage[$profissionalEscola->getCodigoVinculoEscola()] = $profissionalEscola;
    }
