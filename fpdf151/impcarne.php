...
public $historicoSemHistParcerlas = "";
...
var $possuiRubricaEspecial = null;
...
//      $this->objpdf->text(40,$xlin+2,'Continuaï¿½ï¿½o da Pï¿½gina '.($contapagina-1));
 ...
 function imprime(){
  ...
  for($ii = 0; $ii < $this->linhasenvelope; $ii++) {
    if (pg_fetch_result($this->recordenvelope, $ii, $this->tipo_rubrica) == 4) {
        $this->possuiRubricaEspecial = true;
        break;
    }
  }

   if ($this->lUtilizaModeloDefault) {
      if ($this->possuiRubricaEspecial) {
          $this->impmodelo  = "2017";
      }
