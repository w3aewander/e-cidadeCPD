...
include(modification("classes/db_fis_vistoriasanu_classe.php"));
...
$clvistoriasanu   = new cl_fis_vistoriasanu;
...
if(isset($incluir)){
  ...
  if ($sqlerro==false){
    ...
    if ($sqlerro==false){
    	...
    	$sSqlDebitosVistoria .= "   from fiscalizacao.fis_vistorianumpre  ";
    	$sSqlDebitosVistoria .= "        inner join arrecad on arrecad.k00_numpre = fis_vistorianumpre.y69_numpre ";
   	  $sSqlDebitosVistoria .= "   where fis_vistorianumpre.y69_codvist = {$y28_codvist} ";
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?php 
	include(modification("forms/db_frm_fis_vistoriasanu.php"));
	?>
    </center>
	</td>
  </tr>
