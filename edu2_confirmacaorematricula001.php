...
<br>
<fieldset style="width:95%"><legend><b>Lista de confirmação de rematricula</b></legend>
...
function js_procurar(calendario,curso) {
  location.href = "edu2_confirmacaorematricula001.php?calendario="+calendario+"&curso="+curso;
}
...
function js_pesquisa(turma) {
  ...
  var sUrl  = 'edu2_confirmacaorematricula002.php?turmas='+turmas+'&active='+document.form1.active.value;
