...
<body class="abas">
  <div class="container">
  	<?php
  	  include(modification("forms/db_frm_fis_autousu.php"));
  	?>
  </div>
</body>
</html>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  if($clautousu->erro_status=="0"){
    ...
    echo "<script>parent.iframe_fiscais.location.href='fis1_fis_autousu001.php?y59_codauto=$y59_codauto&y39_codandam=$y39_codandam';</script>";
  }else{
    $clautousu->erro(true,false);
    echo "<script>parent.iframe_fiscais.location.href='fis1_fis_autousu001.php?y59_codauto=$y59_codauto&y39_codandam=$y39_codandam';</script>";
  };
