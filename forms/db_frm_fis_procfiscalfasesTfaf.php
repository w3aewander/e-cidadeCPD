...
$clrotulo->label("z01_nome");
      if($db_opcao==1){
 	   $db_action="fis1_fis_procfiscalfasesTfaf004.php";
      }else if($db_opcao==2||$db_opcao==22){
 	   $db_action="fis1_fis_procfiscalfasesTfaf005.php";
      }else if($db_opcao==3||$db_opcao==33){
 	   $db_action="fis1_fis_procfiscalfasesTfaf006.php";
      }
?>
...
function js_pesquisay108_procfiscal(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_procfiscalfases','db_iframe_procfiscal','func_fis_procfiscal_tfaf.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.y108_procfiscal.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_procfiscalfases','db_iframe_procfiscal','func_fis_procfiscal_tfaf.php?pesquisa_chave='+document.form1.y108_procfiscal.value+'&funcao_js=parent.js_mostraprocfiscal','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_procfiscalfases','db_iframe_procfiscalfases','func_fis_procfiscalfasesTfaf.php?funcao_js=parent.js_preenchepesquisa|y108_sequencial','Pesquisa',true,'0','1','775','390');
}
