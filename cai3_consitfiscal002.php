 ...
 */
  ...
  $urlDetalheFiscal = (CheckUseModuloFiscalizacaoService::verify())
    ? 'cai3_fis_consitfiscal_detalhes.php'
    : 'cai3_consitfiscal_detalhes.php';
}
    ...
    <td colspan="4" align="left"><table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr valign="bottom">
          <td width="12%"><table width="80%" border="0" cellspacing="2" cellpadding="0">
	          <tr>
                <td align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand" ><a href="<?= $urlDetalheFiscal ?>?solicitacao=VISTORIA&cod=<?=$cod?>&tipo=<?=$tipo?>" target="iframeDetalhes">&nbsp;Vistorias&nbsp;</a></td>
              </tr>
              <tr>
                <td align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="<?= $urlDetalheFiscal ?>?cod=<?=$cod?>&solicitacao=NOTIFICA&tipo=<?=$tipo?>" target="iframeDetalhes">&nbsp;Notificação&nbsp;</a></td>
              </tr>
              <tr>
                <td align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="<?= $urlDetalheFiscal ?>?cod=<?=$cod?>&solicitacao=AUTO&tipo=<?=$tipo?>" target="iframeDetalhes">&nbsp;Auto de Infração&nbsp;</a></td>
              </tr>
              <tr>
                <td align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="<?= $urlDetalheFiscal ?>?cod=<?=$cod?>&solicitacao=LEVANTA&tipo=<?=$tipo?>" target="iframeDetalhes">&nbsp;Levantamento&nbsp;</a></td>
              </tr>
            </table></td>
