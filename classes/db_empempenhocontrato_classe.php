...
class cl_empempenhocontrato
{
   ...
   // cria variaveis do arquivo
    public $e100_sequencial = 0;
    public $e100_numemp = 0;
    public $e100_acordo = 0;
   ...
   // funcao para inclusao
    public function incluir($e100_sequencial)
    {
        $this->atualizacampos();
        ...
        if ($e100_sequencial == "" || $e100_sequencial == null) {
            ...
            $this->e100_sequencial = pg_fetch_result($result, 0, 0);
        } else {
            $result = db_query("select last_value from empempenhocontrato_e100_sequencial_seq");
            if (($result != false) && (pg_fetch_result($result, 0, 0) < $e100_sequencial)) {
        ...
        if ($resaco ||($this->numrows!=0)) {
            ...
            $resac = db_query("insert into db_acount values($acount,3500,19700,'','".addslashes(pg_fetch_result($resaco, 0, 'e100_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,3500,19703,'','".addslashes(pg_fetch_result($resaco, 0, 'e100_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,3500,19701,'','".addslashes(pg_fetch_result($resaco, 0, 'e100_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        }
        return true;
    }
   // funcao para alteracao
    public function alterar($e100_sequencial = null)
    {
        $this->atualizacampos();
        ...
        if ($this->numrows>0) {
            for ($conresaco=0; $conresaco<$this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["e100_sequencial"]) || $this->e100_sequencial != "") {
                    $resac = db_query("insert into db_acount values($acount,3500,19700,'".addslashes(pg_fetch_result($resaco, $conresaco, 'e100_sequencial'))."','$this->e100_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["e100_numemp"]) || $this->e100_numemp != "") {
                    $resac = db_query("insert into db_acount values($acount,3500,19703,'".addslashes(pg_fetch_result($resaco, $conresaco, 'e100_numemp'))."','$this->e100_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["e100_acordo"]) || $this->e100_acordo != "") {
                    $resac = db_query("insert into db_acount values($acount,3500,19701,'".addslashes(pg_fetch_result($resaco, $conresaco, 'e100_acordo'))."','$this->e100_acordo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
        $result = db_query($sql);
   ...
   // funcao para exclusao
    public function excluir($e100_sequencial = null, $dbwhere = null)
    {
        ...
        if ($resaco ||($this->numrows!=0)) {
            for ($iresaco=0; $iresaco<$this->numrows; $iresaco++) {
                ...
                $resac = db_query("insert into db_acount values($acount,3500,19700,'','".addslashes(pg_fetch_result($resaco, $iresaco, 'e100_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,3500,19703,'','".addslashes(pg_fetch_result($resaco, $iresaco, 'e100_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,3500,19701,'','".addslashes(pg_fetch_result($resaco, $iresaco, 'e100_acordo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
   ...
   // funcao do sql
    public function sql_query($e100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
   ...
   // funcao do sql
    public function sql_query_file($e100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_empenhos_contrato($e100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_itensContratoEmpenho($e100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_empenho_acordo($e100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
