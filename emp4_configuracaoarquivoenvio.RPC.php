    ...
    switch ($oParam->exec) {
        ...
        case 'getDetalhes' :
            ...
            if ($oDaoEmpAgeMovDetalheTransmissao->numrows > 0) {
                ...
                for ($iDetahes = 0; $iDetahes < $oDaoEmpAgeMovDetalheTransmissao->numrows; $iDetahes++) {
                    ...
                    $oDadosDetalhe->e74_valorabatimento = $oValorDetalhe->e74_valorabatimento;
                    $oDadosDetalhe->e74_valormulta = $oValorDetalhe->e74_valormulta;
        ...
        case "salvarDetalhes":
            ...
            foreach ($aDetalhes as $oDetalhes) {
                ...
                $nMulta = str_replace(",", ".", (str_replace(".", "", $oDetalhes->nMulta)));
                $nAbatimento = str_replace(",", ".", (str_replace(".", "", $oDetalhes->nAbatimento)));
                ...
                $oDaoEmpAgeMovDetalheTransmissao->e74_valorabatimento = number_format($nAbatimento, 2, '.', '');
                $oDaoEmpAgeMovDetalheTransmissao->e74_valormulta = number_format($nMulta, 2, '.', '');
