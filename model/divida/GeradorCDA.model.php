...
class GeradorCDA
{
            ...
            foreach ($oDocumentoAgrupador->aParagrafos as $oParagrafo) {
                ...
                switch (trim(strtolower($oParagrafo->db02_descr))) {
                    ...
                    case "quadro_debito_origem" :
                        ...
                        $this->drawDebitos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, $tipo);
                        break;

                    case "quadro_debito_origem_corrigido" :

                        $this->drawDebitosOrigemCorrigido($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, true, $tipo);
                        break;
                    case "quadro_debito_origem_corrigido_resumido" :
                        $this->drawDebitosOrigemCorrigidoResumido($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                        $reemissao == "t" ? true : false, true, $tipo);
                        break;
                    case "quadro_debito_origem_corrigido_data" :

                        $this->drawDebitosOrigemCorrigidoData($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, true, $tipo);
                        break;

                    case "quadro_debito_origem_composicao" :

                        $this->drawDebitosComposicao($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, false, $tipo);
                        break;
                    ...
                    case "quadro_debito_origem_composicao_anterior_primeiro_nivel" :
                        ...
                        $this->drawDebitosOrigemComposicaoAnteriorPrimeiroNivel($pdf, $oCDA, $oPardiv, $oCertid,
                            ($reemissao == "t" ? true : false));
                        break;

                    case "total_debito_origem" :

                        $this->drawTotalizacaoDebitos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false);
                        break;
                    ...
                    case "total_debito_origem_composicao" :
                        ...
                        $this->drawTotalizacaoDebitos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, true);
                        break;

                    case "total_debito_origem_composicao_corrigido" :

                        $this->drawTotalizacaoDebitos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, true, true, $tipo);
                        break;

                    case "totalizacao_demonstrativo" :

                        $this->drawTotalizacaoDemonstrativos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, $oCertid, false, "vertical", $oCertid->v13_dtemi, $tipo);
                        break;

                    case "totalizacao_demonstrativo_corrigido" :

                        $this->drawTotalizacaoDemonstrativos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, $oCertid, true, "vertical", $oCertid->v13_dtemis, $tipo);
                        break;

                    case "totalizacao_demonstrativo_corrigido_horizontal" :

                        $this->drawTotalizacaoDemonstrativos($pdf, $oCDA, $oPardiv, $totexe == "t" ? true : false,
                            $reemissao == "t" ? true : false, $oCertid, true, "horizontal", $oCertid->v13_dtemis,
                            $tipo);
                        break;
                    ...
                    case "quadro_debito_parcelamento" :
                        ...
                        if ($tipo == 1) {
                            $this->drawParcelamentos($pdf, $oCDA, $oPardiv, $oCertid, $reemissao == "t" ? true : false,
                                false);
                        }
                        break;
                    ...
                    case "quadro_debito_parcelamento_pagamentos" :
                        ...
                        if ($tipo == 1) {
                            $this->drawParcelamentosPago($pdf, $oCDA, $oPardiv, $oCertid,
                                $reemissao == "t" ? true : false, false);
                        }
                        break;
                    ...
                    case "cda_valor_inflator" :
                        ...
                        $this->drawDebitosInflator($pdf, $oCDA, $oPardiv, $oParagrafo->db02_texto,
                            $totexe == "t" ? true : false, $reemissao == "t" ? true : false, $tipo);
                        break;
                    case "movimentacoes_extrajudiciais" :

                        $this->drawMovimentacoes($pdf, $oCDA);
                        break;
                }
            }
        }
        ...
        foreach ($aImoveis->aImoveis as $oOrigem) {
            ...
            if ($tipo == 1) {
                ...
                if ($oCfiptu->j18_utilizaloc == 't' 
                        && ((isset($oOrigem->setorloc) 
                                && trim($oOrigem->setorloc) != '') 
                        || (isset($oOrigem->descrsetorloc) 
                                && trim($oOrigem->descrsetorloc) != '' ) 
                        || (isset($oOrigem->quadraloc) 
                                && trim($oOrigem->quadraloc) != '') 
                        || (isset($oOrigem->loteloc) 
                                && trim($oOrigem->loteloc) != ''))) {
                    $pdf->cell(60, 5,
        ...
        if (count($aImoveis->aEmpresas) > 0) {
            ...
            foreach ($aImoveis->aEmpresas as $oOrigem) {
                ...
                if ($pdf->gety() > $pdf->h - 68) {
                    ...
                    $pdf->multicell(0, 5,
                        "CERTIDÃO DE DÍVIDA ATIVA N" . CHR(176) . " " . $oCertidao->getCodigo() . "/{$oCertidao->getAno()}",
                        0, "C", 0, 0);
                    $pdf->setfont('', 'B', 9);
                    $pdf->ln(8);
    ...
    /**
     * Escreve o quadro de Movimentaçoes Extrajudicias
     * @param pdf3 $pdf
     * @param cda $oCertidao
     */
    private function drawMovimentacoes(pdf3 $pdf, cda $oCertidao)
    {

        $ocorrencias = $oCertidao->getOcorrenciasCRA();

        if(count($ocorrencias) > 0 && $ocorrencias != false){
            $pdf->ln(3);
            $pdf->setfont('', 'B', 9);
            $pdf->MultiCell(0, 5, "Movimentações Extrajudiciais", 0, "C", 0);

            $pdf->SetFont('', 'B', 6);
            $pdf->Cell(30, 5, "Data", 1, 0, "C", 1);
            $pdf->Cell(160, 5, "Descricão", 1, 1, "C", 1);

            foreach ($ocorrencias as $ocorrencia) {
                $pdf->SetFont('', 'B', 6);
                $pdf->Cell(30, 5, $ocorrencia['data_ocorrencia'], 1, 0,
                    "L", 0);
                $pdf->Cell(160, 5, $ocorrencia['descricao'], 1, 1,
                    "L", 0);
                $pdf->setfont('', 'B', 9);
            }
        }
     ...
     * @return [type]               [description]
     */
    private function drawTotalizacaoDebitos(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
     ...
     * @param cda $oCertidao
     */
    private function drawDebitosOrigemCorrigido(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
        ...
        foreach ($aDebitosOrdenado as $iTipo => $aTipo) {
            ...
            foreach ($aTipo as $oDebito) {
                ...
                $bIssvar = false;
                $dDtLanc = $oDebito->dataoperacao;

                if (isset($oDebito->codigodivida)) {
                    $sSqlIssvar = "select k163_data
                                     from divold inner join issvar
                                       on k10_numpre = q05_numpre
                                      and k10_numpar = q05_numpar
                               inner join informacaodebito
                                       on k163_numpre = divold.k10_numpre
                                      and k163_numpar = divold.k10_numpar
                                    where k10_coddiv = {$oDebito->codigodivida}";
                    $rsIssvar = db_query($sSqlIssvar);

                    if (pg_num_rows($rsIssvar) > 0) {
                        $dDtLanc  = db_utils::fieldsMemory($rsIssvar, 0)->k163_data;
                        $bIssvar  = true;
                    }
                }

                if ($bIssvar) {
                    $pdf->Cell(13, 5, db_formatar($dDtLanc, 'd'), 1, 0, "C", 0);
                } else {
    ...
    private function drawDebitosOrigemCorrigidoResumido(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
        ...
        foreach ($aDebitos as $oDebito) {
            ...
            if ($lCorrigido) {
              ...
              if(!array_key_exists($oDebito->numpre, $aDebitosOrdenado[$oDebito->procedenciatributaria])) {
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre] = $oDebito;
              } else {

                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->valorhistorico += $oDebito->valorhistorico;
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->valorcorrigido += $oDebito->valorcorrigido;
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->valormulta     += $oDebito->valormulta;
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->valorjuros     += $oDebito->valorjuros;
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->folha          .= $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->folha == $oDebito->folha?"":",{$oDebito->folha}";
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->numpar         .= $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->numpar == $oDebito->numpar?"":",{$oDebito->numpar}";
                $aDebitosOrdenado[$oDebito->procedenciatributaria][$oDebito->numpre]->valortotal     += $oDebito->valortotal;
              }
        ...
        foreach ($aDebitosOrdenado as $iTipo => $aTipo) {
            ...
            foreach ($aTipo as $oDebito) {
                ...
                if ($iY > 272 || $lImprimeCab) {
                    ...
                    $pdf->Cell(13, 5, "DT LANC", 1, 0, "C", 1);
                    $pdf->Cell(9, 5, "EXERC", 1, 0, "C", 1);
                    $pdf->Cell(20, 5, "PARCELAS", 1, 0, "C", 1);
                    $pdf->Cell(15, 5, "LIV/FOL", 1, 0, "C", 1);
                    $pdf->Cell(12, 5, "ORIG", 1, 0, "C", 1);
                    $pdf->Cell(30, 5, "PROCEDÊNCIA", 1, 0, "C", 1);
                    $pdf->Cell(20, 5, "ORIGEM DÉBITO", 1, 0, "C", 1);
                    $pdf->Cell(12, 5, "DT INSCR", 1, 0, "C", 1);
                    $pdf->Cell(10, 5, "VLR HIST", 1, 0, "C", 1);
     ...
     * @param cda $oCertidao
     */
    private function drawDebitosOrigemCorrigidoData(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
     ...
     * @param cda $oCertidao
     */
    private function drawDebitosComposicao(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
     ...
     * @return [type]                  [description]
     */
    private function drawTotalizacaoDemonstrativos(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $lTotaliza = false,
        ...
        if ($tipo == 1) {
            ...
            if ($lReemissao) {
                ...
                $dataemis = mktime(0, 0, 0, substr($v13_dtemis, 5, 2), substr($v13_dtemis, 8, 2),
                    substr($v13_dtemis, 0, 4));
     ...
     * @return [type]                 [description]
     */
    private function drawDebitosOrigemComposicaoAnteriorPrimeiroNivel(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $oDadosCertidao,
        ...
        foreach ($aTermo as $oTermo) {
            ...
            foreach ($aTermoReparc as $iInd => $oTermoReparc) {
                ...
                if ($iLinhasDebitos > 0) {
                    ...
                    $pdf->Cell(0, 5,
                        'PARCELAMENTO : ' . $oTermoReparc->v07_parcel . ' NUMPRE: ' . $oTermoReparc->v07_numpre, 0, 1,
                        'L', 0);
                    $pdf->SetFont('', 'B', $iFont);
     ...
     * @return [type]                 [description]
     */
    private function drawParcelamentosPago(
        pdf3 $pdf,
        cda $oCertidao,
        $oPardiv,
        $oDadosCertidao,
    ...
    private function drawDadosParcelamento($pdf, $oCertidao, $sTexto)
    {
        ...
        foreach ($aNumpres as $oParcelamento) {
            ...
            if ($iNumRows == 1) {
                ...
                $dt_parcelamento .= $virgula . "Parc: " . $oParcelamento->v07_parcel . " - Data: " . db_formatar($oParcelamento->v07_dtlanc,
                        'd');
                $virgula = ", ";
            }
                ...
                foreach ($aDebitosOrdenado as $iTipo => $aTipo) {
                    ...
                    foreach ($aTipo as $oDebito) {
                        ...
                        if ($oDebito->exercicio != $iExercicioAnterior && $lEscreveTotal && $lTotaliza) {
                            ...
                            $pdf->Cell(15, 5,
                                db_formatar(($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrhis / $nVlrInfla), 'f'), 1, 0,
                                "R", 0);
                            $pdf->Cell(15, 5,
                                db_formatar(($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrcor / $nVlrInfla), 'f'), 1, 0,
                                "R", 0);
                            $pdf->Cell(10, 5,
                                db_formatar(($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrmul / $nVlrInfla), 'f'), 1, 0,
                                "R", 0);
                            $pdf->Cell(10, 5,
                                db_formatar(($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrjur / $nVlrInfla), 'f'), 1, 0,
                                "R", 0);
                            $pdf->Cell(15, 5,
                                db_formatar(($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrtot / $nVlrInfla), 'f'), 1, 1,
                                "R", 0);
                            $pdf->setfont('', 'B', 9);
                    ...
                    $pdf->Cell(20, 5, db_formatar(($oTotalGeral[$iTipo]->valorhistorico / $nVlrInfla), 'f'), 1, 0, "R",
                        0);
                    $pdf->Cell(20, 5, db_formatar(($oTotalGeral[$iTipo]->valorcorrigido / $nVlrInfla), 'f'), 1, 0, "R",
                        0);
    ...
    {
        // Caso CDA esteja na Certdiv, não é parcelamento
        $sqlBuscaCertdiv = "SELECT * FROM certdiv WHERE v14_certid = {$certid}";
        $result = db_query($sqlBuscaCertdiv);
