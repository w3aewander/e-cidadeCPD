...
class Calendario {
  ...
  /**
   * Código do calendario originário no caso de ser escola
   */
  private $iCodigoCalendarioBase = null;
  ...
  public function __construct($iCodigoCalendario = null) {
    ...
    if (!empty($iCodigoCalendario)) {
      ...
      $sSqlCalendario = $oDaoCalendario->sql_query_file(null, '*', null, "ed52_i_codigo IN ($iCodigoCalendario)");
      ...
      if ($oDaoCalendario->numrows > 0 ) {
        ...
        $this->sObs = $oCalendario->ed52_t_obs;
  ...
  public function getPeriodos() {
    ...
    if (count($this->aPeriodos) == 0 && $this->iCodigo != "") {
       ...
       $sSqlPeriodos          = $oDaoPeriodoCalendario->sql_query(null,
                                                                       $sCampos,
                                                                       "ed09_i_sequencia",
                                                                       $sWhere
                                                                      );
  ...
  /**
   * atribui observações ao calendario
   * @param string $sObs
   */
  ...
  /**
   * Retorna observações do calendario
   *  @return string
   */
  ...
  /**
   * atribui código base ao calendario atual
   * @param integer $iCodigoCalendarioBase
   */
  public function setCodigoCalendarioBase($iCodigoCalendarioBase) {

    $this->iCodigoCalendarioBase = $iCodigoCalendarioBase;
  }

  /**
   * Retorna código base do calendario atual
   * @return integer
   */
  public function getCodigoCalendarioBase() {

    return $this->iCodigoCalendarioBase;
  }
  ...
  public function save() {
    ...
    $oDaoCalendario->ed52_t_obs = $this->sObs;
    ...
    if (!is_null($this->getEscola())) {
      ...
      if ($oDaoCalendario->numrows == 0) {
        ...
        $oDaoCalendario->ed38_calendariobase = $this->iCodigoCalendarioBase;
        $oDaoCalendario->incluir(null);
    ...
    if ($this->getTipoOperacao() == "Salvar") {
      /**
  ...
  public function getDatasLetivoNoPeriodo ( PeriodoAvaliacao $oPeriodoAvaliacao ) {
    ...
    /**
     * Retorna as datas dos feriados
     * @return DBDate[]
     */
  public function getDataFeriados()
  {
      $eventos = $this->getEventos();
      $datas = [];
      foreach ($eventos as $calendarioEvento) {
          if (!$calendarioEvento->isDiaLetivo()) {
              $datas[] = $calendarioEvento->getDataEvento();
          }
      }
