...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  ...
  db_inicio_transacao();
  $db_opcao = 2;
  $clautorespons->excluir($y124_codauto,$y124_numcgm_old);
  $clautorespons->incluir($y124_codauto,$y124_numcgm,$y124_tipo);
  db_fim_transacao();
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  ...
  if($clautorespons->erro_status=="0"){
    ...
    if($clautorespons->erro_campo!=""){

      echo "<script> document.form1.".$clautorespons->erro_campo.".style.backgroundColor='#99A9AE';</script>";
      echo "<script> document.form1.".$clautorespons->erro_campo.".focus();</script>";
    }
  }else{
