...
<tr>
   ...
   <?php
     ...
     $clcriaabas->src        = array("registro" => "com4_registroprecocompilacao011.extension.php",
                                     "itens"    => "com4_solicitacompilacaoitens.extension.php");
...
var oAjax   = new Ajax.Request('com4_solicitacaoCompras.RPC.extension.php',
                               {
                                method: "post",
