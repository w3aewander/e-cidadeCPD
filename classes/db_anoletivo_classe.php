...
class cl_anoletivo { 
   ...
   function incluir ($ed28_i_codigo){ 
     ...
     if($ed28_i_codigo == "" || $ed28_i_codigo == null ){
       $result = @db_query("select nextval('anoletivo_ed28_i_codigo_seq')"); 
       if($result==false){
       ...
       $result = @db_query("select last_value from anoletivo_ed28_i_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acountkey values($acount,1006183,'$this->ed28_i_codigo','I')");
       $resac = db_query("insert into db_acount values($acount,1006018,1006183,'','".AddSlashes(pg_result($resaco,0,'ed28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006018,1006184,'','".AddSlashes(pg_result($resaco,0,'ed28_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006018,1006185,'','".AddSlashes(pg_result($resaco,0,'ed28_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006018,1006186,'','".AddSlashes(pg_result($resaco,0,'ed28_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006018,1006187,'','".AddSlashes(pg_result($resaco,0,'ed28_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1006018,1006188,'','".AddSlashes(pg_result($resaco,0,'ed28_l_encerrado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed28_i_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1006183,'$this->ed28_i_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006183,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_i_codigo'))."','$this->ed28_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006184,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_i_escola'))."','$this->ed28_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_i_ano"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006185,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_i_ano'))."','$this->ed28_i_ano',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_d_inicio"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006186,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_d_inicio'))."','$this->ed28_d_inicio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_d_fim"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006187,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_d_fim'))."','$this->ed28_d_fim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed28_l_encerrado"]))
           $resac = db_query("insert into db_acount values($acount,1006018,1006188,'".AddSlashes(pg_result($resaco,$conresaco,'ed28_l_encerrado'))."','$this->ed28_l_encerrado',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed28_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1006183,'$ed28_i_codigo','E')");
         $resac = db_query("insert into db_acount values($acount,1006018,1006183,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006018,1006184,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006018,1006185,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_i_ano'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006018,1006186,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_d_inicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006018,1006187,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_d_fim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1006018,1006188,'','".AddSlashes(pg_result($resaco,$iresaco,'ed28_l_encerrado'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
