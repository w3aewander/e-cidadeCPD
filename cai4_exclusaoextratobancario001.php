...
<html>
  ...
  <center>
    ...
    <div style="width:800px">
      ...
      <input type="button" value="Exclusão Duplicados" onclick="js_processar2()" />
  ...
  var oAjax = new Ajax.Request(sUrl,
                               {
                                 method:     'post',
                                 parameters: 'json='+Object.toJSON(oParametro),
                                 onComplete: js_retornoProcessar2
                               }
                              );

}

function js_retornoProcessar2(oResponse) {  
  js_removeObj('msgBox');
  var oRetorno = eval('('+oResponse.responseText+')');
