...
if (isset($l20_codigo) && trim($l20_codigo) != "") {
  ...
  if ($oDaoAcordoliclicitem->numrows > 0) {
    ...
    $sqlerro       = true;
    $erro_msg      = "A licitação selecionada está vinculada ao acordo {$iNumeroAcordo}, ";
    $erro_msg     .= "não será possível cancelar o julgamento";
  }
  ...
  if ($sqlerro == false){
    $erro_msg = "Cancelamento de Julgamento realizado com sucesso!";
  }
...
function js_confirmar(){
  if(document.form1.l20_codigo.value == ""){
    ...
    if (confirm("O julgamento de todos os itens será excluído. Tem certeza?")){
