...
<form name="form1">
        ...
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <input type="button" id="btnLancarAreaConhecimento" name="btnLancarAreaConhecimento" value="Lançar Area de Conhecimento" <?= ($db_botao == false ? "disabled" : "") ?> onclick="parent.js_lancarAreasConhecimento($F('ed65_i_historicomps'), 1, iEnsino, iHistoricomps, $F('ed61_i_curso'), $F('ed62_i_anoref'));" />
                    <input type="button" id="btnLancarDisciplina" name="btnLancarDisciplina" value="Lançar Disciplina" <?= ($db_botao == false ? "disabled" : "") ?> onclick="parent.js_lancarDisciplina($F('ed65_i_historicomps'), 1, iEnsino, iHistoricomps, $F('ed61_i_curso'), $F('ed62_i_anoref'));" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
          ...
          -->
                        ...
                        <input type="hidden" name="ed65_i_codigo" value="<?php if (isset($ed65_i_codigo))  echo $ed65_i_codigo;
                                                                            else echo ""; ?>">
                        <input type="hidden" name="ed65_i_disciplina" value="<?php if (isset($ed12_i_codigo))  echo $ed12_i_codigo;
                                                                                else echo ""; ?>">
                        <input type="hidden" name="ed65_c_tiporesultado" value="<?php if (isset($ed65_c_tiporesultado))  echo $ed65_c_tiporesultado;
                                                                                else echo ""; ?>">
                        ...
                        ?>
                            ...
                            <tr onmouseover="Mostra('disc<?= $iTotalLinhas ?>')" onmouseout="Oculta('disc<?= $iTotalLinhas ?>')">
                                ...
                                <td style="font-size:10px;">
                                    <input type="checkbox" name="individual" value="true" <?= $ed65_i_codigo != "" ? "checked" : "" ?> onclick="MarcaIndividual(this.value, <?= $iTotalLinhas ?>)">
                                    ...
                                    <table id="resultado<?= $iTotalLinhas ?>" style="visibility:<?= $visivel ?>;position:absolute;" border="0" cellspacing="2" cellpading="2">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <input type="text" name="ed65_t_resultobtido" value="<?= @$aprov_resultado ?>" size="10" <?= @$ed65_i_codigo == "" ? "disabled" : "" ?>>
                                            </td>
                                            <td>
                                                <?php
    ...
    ?>
            ...
            <input name="incluir" id="botao" type="button" value="Incluir" onclick="Salvar(<?= $iLinhasHistMpsDisc ?>, true);" <?= ($db_botao == false ? "disabled" : "") ?>>
        <?php
        } else {
        ?>
            <input name="alterar" id="botao" type="button" value="Alterar" onclick="Salvar(<?= $iLinhasHistMpsDisc ?>, true);" <?= ($db_botao == false ? "disabled" : "") ?>>
    <?php
        }
    }
    ?>
...
<script>
    ...
    <?php
        $isCondicao1 = ($iLinhasHistMpsDisc == 0);
        $isCondicao2 = in_array($ed62_c_situacao, ['CONCLUÍDO', 'RECLASSIFICADO', 'AVANÇO']);
