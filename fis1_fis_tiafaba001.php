...
include(modification("classes/db_fis_tiafprazo_classe.php"));
include(modification("classes/db_fis_tiafcgm_classe.php"));
include(modification("classes/db_fis_tiafinscr_classe.php"));
include(modification("dbforms/db_funcoes.php"));
include(modification("dbforms/db_classesgenericas.php"));
//db_postmemory($HTTP_SERVER_VARS,2);exit;
$cltiaf = new cl_fis_tiaf;
$cltiafcgm = new cl_fis_tiafcgm;
$cltiafinscr = new cl_fis_tiafinscr;
$cltiafprazo = new cl_fis_tiafprazo;
$cltiaf->rotulo->label();
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
	    <?php
	    	include(modification("forms/db_frm_fis_tiaf001.php"));
	    ?>
	</td>
  </tr>
</table>
