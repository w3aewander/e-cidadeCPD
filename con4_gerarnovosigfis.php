        ...
        <fieldset id='sigfis'>
            ...
            <div>
                <div style="display: block; height:48px;">
                    <table>
                        <tr>
                            <td><span style="font-weight: bold;">Layout:</span></td>
                            <td>
                                <select id="anoexe" name="anoexe" onchange="libera26();">
                                    <option value="2026" <?=(db_getsession("DB_anousu") == 2026) ? 'selected' : ''?>>2026</option>
                                    <option value="2025" <?=(db_getsession("DB_anousu") == 2025) ? 'selected' : ''?>>2025</option>
                                    <option value="2024" <?=(db_getsession("DB_anousu") == 2024) ? 'selected' : ''?>>2024</option>
...
<script type="text/javascript">
    ...
    var aArquivosLiberados2026 = [
        'PPAPrograma',
        'PPAProgramaIndicador',
        'Empenho',
    ];
    ...
    function libera26() {
        ...
        aCheckboxes.each(function(oCheckbox) {
            if (ano == '2026') {
                if (aArquivosLiberados2026.indexOf(oCheckbox.value) !== -1) {
