...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_artigos.location.href='fis1_fis_fiscarquivos002.php?chavepesquisa=$y26_codnoti&chavepesquisa1=$y26_idparag".$getIntimacao."'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_artigos.location.href='fis1_fis_fiscarquivos003.php?chavepesquisa=$y26_codnoti&chavepesquisa1=$y26_idparag".$getIntimacao."'</script>";
}
// Ticket 108335
if(isset($intimacao) && $intimacao == 1){
  $Ty26_codnoti = 'Código da Intimação
...
Campo:y30_data                             ';
  ...
  $Ly26_codnoti = '<strong>Código da Intimação:</strong>';
...
db_input('db02_descr',40,$Idb02_descr,true,'text',3,'')
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_fiscarquivos001.php?y26_codnoti=<?=$y26_codnoti?>&abas=1&y39_codandam=10911<?=$getIntimacao?>'">
      <?php 
      }
      ?>
    </td>
  ...
  <tr>
   ...
   <?php 
    ...
    $cliframe_alterar_excluir->legenda="ARTIGOS DA ".mb_strtoupper($getLabel);
...
function js_pesquisay26_codnoti(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_fiscal','func_fis_fiscal.php?funcao_js=parent.js_mostrafiscal1|y30_codnoti|y30_data','Pesquisa',true);
  }else{
     if(document.form1.y26_codnoti.value != ''){ 
        js_OpenJanelaIframe('','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y26_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
     }else{
