...
//        $oDados->cd_Elemento        = str_pad($oElementoTCE->despesatce,                  8, ' ', STR_PAD_LEFT);
        if ( substr($oDadosQuery->o56_elemento, 1, 8) == "33200100") {
          $oDados->cd_Elemento        = "31900100";
        } elseif ( substr($oDadosQuery->o56_elemento, 1, 8) == "33190340") {
          $oDados->cd_Elemento        = "33241000";
        } elseif ( substr($oDadosQuery->o56_elemento, 1, 8) == "33900501") {
          $oDados->cd_Elemento        = "32911000";
        } else {
          $oDados->cd_Elemento        = str_pad(substr($oDadosQuery->o56_elemento, 1, 8),   8, ' ', STR_PAD_LEFT);
        }

        if ( $oElementoTCE->despesatce != "" ) {
          $oDados->cd_Elemento = str_pad($oElementoTCE->despesatce,8, ' ', STR_PAD_LEFT);
        }
