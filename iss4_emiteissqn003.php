...
} elseif (isset($imprimir) && $imprimir == 'soparcela') {
...
try {
    ...
    $oRegraEmissao = new regraEmissao($tipo_debito, 17, db_getsession('DB_instit'),
...
if (isset($emis) && $emis == "comescr") {
    ...
    if (isset($cgmescrito) && $cgmescrito != "") {
        ...
        $whereescrito_ativo = " and ( q10_dtfim is null or q10_dtfim >= '" . date('Y-m-d',
    ...
    if (isset($emis) && $emis == "semescr") {

        $join = " left ";
        $whereescrito = " and q10_numcgm is null";
        $whereescrito_ativo = "";
    } else {
        if (isset($emis) && $emis == "geral") {
...
if (isset($ord) && $ord == "escritorio") {
    ...
    if (isset($ord) && $ord == "inscricao") {

        $ordenaescrito = " q02_inscr, ";
        $ordena = " z01_nome ";
    } else {
        if (isset($ord) && $ord == "nome") {
...
for ($inti = 0; $inti < $intNumrowsNumpre; $inti++) {
    ...
    for ($volta = 0; $volta < sizeof($numpres); $volta++) {
        ...
        if ($intixxx >= $QuebraPag) {
            ...
            $arquivo = "tmp/" . $nomeTipoMod . "_" . str_replace(" ", "",
                $k00_descr) . "_de_" . $iIniPag . "_ate_" . $iFimPag . "_" . date('His') . ".pdf";
            $nomearquivos .= "tmp/" . $nomeTipoMod . "_" . str_replace(" ", "",
                $k00_descr) . "_de_" . $iIniPag . "_ate_" . $iFimPag . "_" . date('His') . ".pdf#Dowload dos " . $nomeTipoMod . " de " . $iIniPag . " ate " . $iFimPag . "|";
        ...
        if ($lImprimeUnicas) {
            ...
            if ($unica == 1) {
                ...
                $sql .= "        (substr(fc_calcula,54,13)::float8 * -1)as uvlrdesconto,                                                  ";
                ...
                $sql .= "            and r.k00_dtvenc >= '" . date('Y-m-d',
                    db_getsession("DB_datausu")) . "'::date ) as unica	  ";
                ...
                if ($resultfin != false) {
                    ...
                    for ($unicont = 0; $unicont < pg_numrows($resultfin); $unicont++) {
                        ...
                        if ($tipo_debito == "3") {
                            ...
                            $DadosPgtoUnica = debitos_numpre_carne_recibopaga($k00_numpre, 0, $H_DATAUSU, $H_ANOUSU,
                              db_getsession('DB_instit'), $sWhere);
                        }
                        ...
                        $vlrbar = db_formatar(str_replace('.', '',
                          str_pad(number_format($utotal, 2, "", "."), 11, "0", STR_PAD_LEFT)), 's', '0', 11, 'e');

                        if ($uvlrcor != 0) {
                            $pdf1->arraycodtipo[] = "";
                            $pdf1->arraycodreceitas[] = "";
                            $pdf1->arrayvalreceitas[] = $uvlrcor;
                        }

                        if ($uvlrjuros != 0) {
                            $pdf1->arraycodtipo[] = "t";
                            $pdf1->arraycodreceitas[] = "";
                            $pdf1->arrayvalreceitas[] = $uvlrjuros;
                        }

                        if ($uvlrmulta != 0) {
                            $pdf1->arraycodtipo[] = "t";
                            $pdf1->arraycodreceitas[] = "";
                            $pdf1->arrayvalreceitas[] = $uvlrmulta;
                        }

                        if ($uvlrdesconto != 0) {
                            $pdf1->arraycodtipo[] = "t";
                            $pdf1->arraycodreceitas[] = "";
                            $pdf1->arrayvalreceitas[] = $uvlrdesconto;
                        }
                        ...
                        if ($k00_impval == 't') {
                            ...
                            $k00_valor = $utotal;
                            $vlrbar = db_formatar(str_replace('.', '',
                              str_pad(number_format($k00_valor, 2, "", "."), 11, "0", STR_PAD_LEFT)), 's', '0', 11,
                              'e');
                            $ninfla = '';
                        ...
                        try {
                            $valorConvenio = !empty($valorTaxaExpediente) ? $k00_valor + $valorTaxaExpediente : $k00_valor;
                            
                            $oConvenio = new convenio($oRegraEmissao->getConvenio(), $oDadosPgtoUnica->k00_numnov, 0,
                              $valorConvenio, $vlrbar, $dtvencunic, $iTercDig);
                        ...
                        if ($oRegraEmissao->isCobranca()) {
                            ...
                            if (strlen(trim($oConvenio->getConvenioCobranca())) == 7) {
                                $pdf1->nosso_numero = trim($oConvenio->getConvenioCobranca()) . str_pad($oDadosPgtoUnica->k00_numnov . "00",
                                    10, 0, STR_PAD_LEFT);
                            } else {
                        ...
                        $pdf1->descr2 = db_numpre($oDadosPgtoUnica->k00_numnov,
                            0) . ($tipo_debito == "3" ? db_formatar($oDadosPgtoUnica->k00_numpar, "s", "0", 3,
                            "e") : "000");
                        ...
                        $pdf1->descr9 = db_numpre($oDadosPgtoUnica->k00_numnov,
                            0) . ($tipo_debito == "3" ? db_formatar($oDadosPgtoUnica->k00_numpar, "s", "0", 3,
                            "e") : "000");
                        $pdf1->predescr9 = db_numpre($oDadosPgtoUnica->k00_numnov,
                            0) . ($tipo_debito == "3" ? db_formatar($oDadosPgtoUnica->k00_numpar, "s", "0", 3,
                            "e") : "000");
                        $pdf1->descr10 = 'UNICA';
                        ...
                        if (!empty($HTTP_POST_VARS ["ver_matric"])) {
                            ...
                            if ($impmodelo == 2) {
                                ...
                                $pdf1->numpre = db_numpre($oDadosPgtoUnica->k00_numnov,
                                    0) . ($tipo_debito == "3" ? db_formatar($oDadosPgtoUnica->k00_numpar, "s", "0", 3,
                                    "e") : "000");
                                ...
                                if ($k03_tipo == 2 && $k00_tipoagrup != 2) {
                                     ...
                                     */
                                } elseif ($k03_tipo == 3 && $k00_tipoagrup != 2) {
                                    ...
                                    $histant = pg_result($result, 0, "k00_origem") . "-" . pg_result($result, 0,
                                        "k00_descr");
                                    $histparcela .= pg_result($result, 0, "k00_descr") . "=>" . pg_result($result,
                                        0, "k00_origem") . " / PARCELAS: ";

                                    for ($xy = 0; $xy < pg_numrows($result); $xy++) {

                                        if (pg_result($result, $xy, "k00_origem") . "-" . pg_result($result, $xy,
                                            "k00_descr") != $histant) {

                                            $histparcela .= "-" . pg_result($result, $xy,
                                                "k00_descr") . "=>" . pg_result($result, $xy,
                                                "k00_origem") . " / PARCELAS: ";
                                            $histant = pg_result($result, $xy,
                                                "k00_origem") . "-" . pg_result($result, $xy, "k00_descr");
                                        }
                        ...
                        if ($oRegraEmissao->isCobranca()) {
                            ...
                            $pdf1->descr12_1 .= $pdf1->tipodebito . "\n" . $pdf1->titulo1 . " - " . $pdf1->descr1 . " / " . $pdf1->titulo4 . " Parcela Única \n";
                        ...
                        if ($iTercDig == '7') {
                            ...
                            if ($tipo_debito == 3 && $emiteVal == 2) {
                                ...
                                if (!empty($valorTaxaExpediente)) {
                                    $k00_valor = $k00_valor + $valorTaxaExpediente;
                                    $pdf1->taxaExpediente = TaxaEspecificaModel::DESCRICAO_TAXA_EXPEDIENTE . " = " . trim(db_formatar($valorTaxaExpediente, 'f'));
                                }
                        ...
                        $pdf1->tipo_exerc = '';
                        if (!empty($k00_tipo)) {
                            $tipoExercicio[] = $k00_tipo;
                        }

                        if (!empty($k00_dtoper)) {
                            $tipoExercicio[] = substr($k00_dtoper, 0, 4);
                        }

                        if (!empty($tipoExercicio)) {
                            $pdf1->tipo_exerc = implode(' / ', $tipoExercicio);
                        }
        ...
        if ($lImprimeParcelas) {
            ...
            if ($tipo_debito == "3") {
                ...
                $sWhere = "arreinscr.k00_inscr = $q02_inscr and arrecad.k00_tipo = $k00_tipo ";
                $DadosPagamento = debitos_numpre_carne_recibopaga($onumpres->numpre_recibo, $k00_numpar, $H_DATAUSU,
                  $H_ANOUSU, db_getsession('DB_instit'), $sWhere);
            }
            ...
            if ($k00_impval == 't') {
                ...
                if ($k03_tipo == 3) {
                    ...
                    if ($intAnoissvar > 0 && $q05_ano <= date("Y", $H_DATAUSU)) {
                        ...
                        $k00_valor = $total;
                        $vlrbar = db_formatar(str_replace('.', '',
                          str_pad(number_format($k00_valor, 2, "", "."), 11, "0", STR_PAD_LEFT)), 's', '0', 11, 'e');
                        $ninfla = '';
                    }
                } else {
            ...
            try {
                ...
                $valorConvenio = !empty($valorTaxaExpediente) ? $k00_valor + $valorTaxaExpediente : $k00_valor;
                $oConvenio = new convenio($oRegraEmissao->getConvenio(), $k00_numnov, $iParcela, $valorConvenio, $vlrbar,
                $dtvenc, $iTercDig);
            } catch (Exception $eExeption) {
            ...
            if ($oRegraEmissao->isCobranca()) {
                ...
                if (strlen(trim($oConvenio->getConvenioCobranca())) == 7) {
                    $pdf1->nosso_numero = trim($oConvenio->getConvenioCobranca()) . str_pad($k00_numnov . "00", 10, 0,
                        STR_PAD_LEFT);
                } else {
                    $pdf1->nosso_numero = $oConvenio->getNossoNumero();
                }
            ...
            $pdf1->titulo1 = $descr;
            $pdf1->descr1 = $numero;
            $pdf1->descr2 = db_numpre($k00_numnov, 0) . ($tipo_debito == "3" ? db_formatar($k00_numpar, "s", "0", 3,
                "e") : "000");
            ...
            if ($impmodelo == 2) {
                ...
                $pdf1->ddreceita = 'k02_drecei';
                $pdf1->historico = $k00_descr;
                $pdf1->numpre = db_numpre($k00_numnov, 0) . ($tipo_debito == "3" ? db_formatar($k00_numpar, "s", "0", 3,
                    "e") : "000");
                $pdf1->codigobarras = $codigo_barras;
                $pdf1->linhadigitavel = $linha_digitavel;
                ...
                if ($k03_tipo == 2 && $k00_tipoagrup != 2) {
                    ...
                    $histparcela .= pg_result($result, 0, "k00_descr") . "=>" . pg_result($result, 0,
                        "k00_origem") . " / PARCELAS: ";
                    ...
                    for ($xy = 0; $xy < pg_numrows($result); $xy++) {
                        ...
                        if (pg_result($result, $xy, "k00_origem") . "-" . pg_result($result, $xy,
                            ...
                            $histparcela .= "-" . pg_result($result, $xy, "k00_descr") . "=>" . pg_result($result,
                                $xy, "k00_origem") . " / PARCELAS: ";
                            $histant = pg_result($result, $xy, "k00_origem") . "-" . pg_result($result, $xy,
                                "k00_descr");
                        }
            ...
            $pdf1->descr8 = $numero;
            $pdf1->predescr8 = $numero;
            $pdf1->descr9 = db_numpre($k00_numnov, 0) . ($tipo_debito == "3" ? db_formatar($k00_numpar, "s", "0", 3,
                "e") : "000");
            $pdf1->predescr9 = db_numpre($k00_numnov, 0) . ($tipo_debito == "3" ? db_formatar($k00_numpar, "s", "0", 3,
                "e") : "000");
            ...
            if ($total == 0) {
                ...
                if ($tipo_debito == 3 && $emiteVal == 2) {
                    ...
                    $pdf1->descr15 = ($ninfla == '' ? 'R$  ' . db_formatar($k00_valor,
                        'f') : $ninfla . '  ' . $k00_valor);
                    $pdf1->valtotal = db_formatar($k00_valor, 'f');
                    $pdf1->descr7 = ($ninfla == '' ? 'R$  ' . db_formatar($k00_valor,
                        'f') : $ninfla . '  ' . $k00_valor);
                }

                $pdf1->predescr7 = ($ninfla == '' ? 'R$  ' . db_formatar($k00_valor,
                    'f') : $ninfla . '  ' . $k00_valor);
            }

            if ($oRegraEmissao->isCobranca()) {

                $pdf1->predescr12_1 .= $pdf1->pretipodebito . "\n" . $pdf1->titulo1 . " - " . $pdf1->descr1 . " / " . $pdf1->titulo4 . " Parcela - " . $k00_numpar . "/" . $k00_numtot . "\n" . (isset($bql) && $bql != "" ? " - " . $bql . "\n" : "\n") . (isset($obsdiver) && $obsdiver != "" ? $obsdiver : "") . "\n";

                if (isset($pdf1->tipodebito) && trim($pdf1->tipodebito) != '') {
                    $pdf1->descr12_1 .= $pdf1->tipodebito . "\n";
                }

                $pdf1->descr12_1 .= $pdf1->titulo1 . " - " . $pdf1->descr1 . " / " . $pdf1->titulo4 . " Parcela - " . $k00_numpar . "/" . $k00_numtot . "\n";
            ...
            if (isset($datavencimento) && (str_replace('-', '', $datavencimento) < date("Ymd",
                  db_getsession("DB_datausu"))) && $k00_valor > 0) {
            ...
            if ($imprimeparcelas == "s") {
                ...
                $dataAtual = date('d/m/Y', $H_DATAUSU);
                $sql = "SELECT substr(fc_calcula,15,13)::float8 AS valor_corrigido,
                  ...
                  FROM (SELECT fc_calcula($k00_numpre, $k00_numpar, $k00_receit, '{$dataAtual}', '{$k00_dtvenc}', {$H_ANOUSU})) as x;";
                ...
                for ($i = 0; $i < $linhas; $i++) {
                    ...
                    $pdf1->arraycodtipo[$i] = "";
                    $pdf1->arraycodreceitas[$i] = "";
                    $pdf1->arrayvalreceitas[$i] = $dados->valor_corrigido;

                    $uvlrjuros += $dados->valor_juros;
                    $uvlrmulta += $dados->valor_multa;
