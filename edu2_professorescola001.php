...
<div class="container">
  ...
  <fieldset style="width: 500px;">
    ...
    <table class="form-container">
      ...
      <tr>
          <td nowrap='nowrap' colspan="2">
              <input type="checkbox" name="servidoresAtivos" id="servidoresAtivos" value="" checked>
              <label for="servidoresAtivos">Mostrar somente servidores ativos.</label>
          </td>
      </tr>
...
$('imprimir').observe('click', function() {
  ...
  if( !validaCampos() ) {
    ...
    var servidoresAtivos = "S";
    if (!$('servidoresAtivos').checked) {
        servidoresAtivos = "N";
    }
  ...
  var oParametros         = 'escola='        + oEscolaSelecionada.codigo_escola;
      ...
      oParametros        += '&servidoresAtivos=' + servidoresAtivos;
