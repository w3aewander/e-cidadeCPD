...
class cl_tarefaprevisaofase { 
   ...
   var $campos = "
                 ...
                 at82_qtdhoras = char(5) = Quantidade de horas 
                 at82_dataini = date = Data inicial 
                 at82_horaini = char(5) = Hora inicial 
                 at82_datafim = date = Data final 
                 at82_horafim = char(5) = Hora final 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->at82_sequencial = ($this->at82_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_sequencial"]:$this->at82_sequencial);
       $this->at82_tarefaprevisao = ($this->at82_tarefaprevisao == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_tarefaprevisao"]:$this->at82_tarefaprevisao);
       $this->at82_tarefaprevisaocadfase = ($this->at82_tarefaprevisaocadfase == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_tarefaprevisaocadfase"]:$this->at82_tarefaprevisaocadfase);
       $this->at82_qtdhoras = ($this->at82_qtdhoras == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_qtdhoras"]:$this->at82_qtdhoras);
       if($this->at82_dataini == ""){
         $this->at82_dataini_dia = ($this->at82_dataini_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_dataini_dia"]:$this->at82_dataini_dia);
         $this->at82_dataini_mes = ($this->at82_dataini_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_dataini_mes"]:$this->at82_dataini_mes);
         $this->at82_dataini_ano = ($this->at82_dataini_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_dataini_ano"]:$this->at82_dataini_ano);
         if($this->at82_dataini_dia != ""){
            $this->at82_dataini = $this->at82_dataini_ano."-".$this->at82_dataini_mes."-".$this->at82_dataini_dia;
         }
       }
       $this->at82_horaini = ($this->at82_horaini == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_horaini"]:$this->at82_horaini);
       if($this->at82_datafim == ""){
         $this->at82_datafim_dia = ($this->at82_datafim_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_datafim_dia"]:$this->at82_datafim_dia);
         $this->at82_datafim_mes = ($this->at82_datafim_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_datafim_mes"]:$this->at82_datafim_mes);
         $this->at82_datafim_ano = ($this->at82_datafim_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_datafim_ano"]:$this->at82_datafim_ano);
         if($this->at82_datafim_dia != ""){
            $this->at82_datafim = $this->at82_datafim_ano."-".$this->at82_datafim_mes."-".$this->at82_datafim_dia;
         }
       }
       $this->at82_horafim = ($this->at82_horafim == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_horafim"]:$this->at82_horafim);
       $this->at82_ativo = ($this->at82_ativo == "f"?@$GLOBALS["HTTP_POST_VARS"]["at82_ativo"]:$this->at82_ativo);
     }else{
       $this->at82_sequencial = ($this->at82_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at82_sequencial"]:$this->at82_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($at82_sequencial){ 
      $this->atualizacampos();
     if($this->at82_tarefaprevisao == null ){ 
     ...
     if($this->at82_tarefaprevisaocadfase == null ){ 
     ...
     if($this->at82_dataini == null ){ 
       $this->at82_dataini = "null";
     }
     if($this->at82_datafim == null ){ 
       $this->at82_datafim = "null";
     }
     if($this->at82_ativo == null ){ 
       $this->at82_ativo = "t";
     }
     if($at82_sequencial == "" || $at82_sequencial == null ){
       $result = db_query("select nextval('tarefaprevisaofase_at82_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tarefaprevisaofase_at82_sequencial_seq do campo: at82_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $at82_sequencial)){
         ...
         $this->at82_sequencial = $at82_sequencial; 
       }
     }
     if(($this->at82_sequencial == null) || ($this->at82_sequencial == "") ){ 
       $this->erro_sql = " Campo at82_sequencial nao declarado.";
     ...
     $sql = "insert into tarefaprevisaofase(
                                       at82_sequencial 
                                      ,at82_tarefaprevisao 
                                      ,at82_tarefaprevisaocadfase 
                                      ,at82_qtdhoras 
                                      ,at82_dataini 
                                      ,at82_horaini 
                                      ,at82_datafim 
                ...
                values (
                                $this->at82_sequencial 
                               ,$this->at82_tarefaprevisao 
                               ,$this->at82_tarefaprevisaocadfase 
                               ,'$this->at82_qtdhoras' 
                               ,".($this->at82_dataini == "null" || $this->at82_dataini == ""?"null":"'".$this->at82_dataini."'")." 
                               ,'$this->at82_horaini' 
                               ,".($this->at82_datafim == "null" || $this->at82_datafim == ""?"null":"'".$this->at82_datafim."'")." 
                               ,'$this->at82_horafim' 
                               ,'$this->at82_ativo' 
                      )";
     $result = db_query($sql); 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->at82_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($at82_sequencial=null) { 
      $this->atualizacampos();
     ...
     if(trim($this->at82_dataini)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at82_dataini_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at82_dataini_dia"] !="") ){ 
       ...
       if(isset($GLOBALS["HTTP_POST_VARS"]["at82_dataini_dia"])){ 
         $sql  .= $virgula." at82_dataini = null ";
         $virgula = ",";
       }
     }
     ...
     if(trim($this->at82_datafim)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at82_datafim_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at82_datafim_dia"] !="") ){ 
       ...
       if(isset($GLOBALS["HTTP_POST_VARS"]["at82_datafim_dia"])){ 
         $sql  .= $virgula." at82_datafim = null ";
         $virgula = ",";
       }
     }
     ...
     $sql .= " where ";
     if($at82_sequencial!=null){
       $sql .= " at82_sequencial = $this->at82_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->at82_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Fases da previsão nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->at82_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Fases da previsão nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->at82_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($at82_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($at82_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($at82_sequencial != ""){
          ...
          $sql2 .= " at82_sequencial = $at82_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Fases da previsão nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$at82_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Fases da previsão nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at82_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $at82_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tarefaprevisaofase ";
     $sql .= "      inner join tarefaprevisao  on  tarefaprevisao.at81_sequencial = tarefaprevisaofase.at82_tarefaprevisao";
     ...
     if($dbwhere==""){
       if($at82_sequencial!=null ){
         $sql2 .= " where tarefaprevisaofase.at82_sequencial = $at82_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
