...
//require_once(modification("model/contabilidade/arquivos/sigfis/model/contabilidade/arquivos/sigfis/SigfisArquivoBase.model.php"));
...
//    		$oDadosLinha->nu_ProjetoAtividade        = str_pad($oEmpenho->o58_projativ,             4, ' ', STR_PAD_LEFT);
        ...
        if(db_getsession('DB_anousu') < 2013 ){
          ...
          $oDadosLinha->st_semcpfcnpj           = (trim($oEmpenho->z01_cgccpf == '' or $oEmpenho->z01_cgccpf+0 == 0) ? '1' : '0');
