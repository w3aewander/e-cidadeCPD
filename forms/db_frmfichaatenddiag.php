      ...
      <fieldset>
        ...
        <table>
          <!-- Prontuário -->
            <tr>
                <td colspan="2">
                    <div style="padding-left: 320px" id="linhaDaIdadeCompleta"></div>
                </td>
            </tr>
          <tr>
            ...
            <td>
              ...
              db_input('z01_i_numcgs', 10 , $z01_i_numcgs, true, 'hidden', 3);
          ...
          <tr>
            ...
            <td colspan="2">
              ...
              db_textarea( 'sd24_t_diagnostico', 1, 59, $sd24_t_diagnostico, true, 'text', $db_opcao, "onKeypress=js_keypress();", "", "", 120);
              ?>
            </td>
          </tr>
...
const inputCgs = {
  id: document.getElementById('z01_i_numcgs'),
...
function js_retornoOpcao( ajxRetorno ) {
	...
	var objRetorno  = JSON.parse(ajxRetorno.responseText);
...
function existeCgsUnd() {
    let cgsUnd = document.getElementById('z01_i_numcgs').value;
