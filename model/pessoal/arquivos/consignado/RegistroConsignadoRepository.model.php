...
abstract class RegistroConsignadoRepository {
  ...
  public static function persist(RegistroConsignado $oRegistroConsignado) {
    ...
    $oDaoConsignadoMovimentoServidorRubrica->rh153_econsignado                 = $oRegistroConsignado->geteConsignado();
  ...
  public static function make($oDadosRegistroConsignado) {
    ...
    $oRegistroConsignado->seteConsignado($oDadosRegistroConsignado->rh153_econsignado);
