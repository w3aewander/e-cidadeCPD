    ...
    echo "
      <script>
        function js_db_libera(){
           ...
           (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguacondominiomat.location.href='agu1_aguacondominiomat001.php?x40_codcondominio=" . @$x31_codcondominio . "';
        ";
