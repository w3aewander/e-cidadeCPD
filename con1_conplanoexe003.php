...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    if ($login != 'dbseller' && $login != 'terezinha.saar' && $login != 'cpdmunicipal') {
        db_msgbox("Procedimento liberado apenas para alguns perfis. Contate o administrador.");
    }else{
        include(modification("forms/db_frmconplanoexe.php"));
    }
	?>
    </center>
	</td>
