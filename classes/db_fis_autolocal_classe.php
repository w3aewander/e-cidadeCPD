...
class cl_fis_autolocal {
   ...
   public function incluir ($y14_codauto){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_autolocal(
                                       y14_codauto
                                      ,y14_codigo
                                      ,y14_codi
                                      ,y14_numero
   ...
   public function alterar ($y14_codauto=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_autolocal set ";
     $virgula = "";
   ...
   public function excluir ($y14_codauto=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_autolocal
                    where ";
     $sql2 = "";
   ...
   // funcao do sql
   public function sql_query ( $y14_codauto=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_autolocal ";
     $sql .= "      inner join bairro  on  bairro.j13_codi = fis_autolocal.y14_codi";
     $sql .= "      inner join ruas  on  ruas.j14_codigo = fis_autolocal.y14_codigo";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_autolocal.y14_codauto";
     ...
     if($dbwhere==""){
       if($y14_codauto!=null ){
         $sql2 .= " where fis_autolocal.y14_codauto = $y14_codauto ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql
   public function sql_query_file ( $y14_codauto=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
