...
include(modification("classes/db_veicresp_classe.php"));
include(modification("classes/db_veicpatri_classe.php"));
...
include(modification("classes/db_veicutilizacao_classe.php"));
