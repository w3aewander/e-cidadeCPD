...
if(isset($codred)){
  ...
  $campos = " select c62_reduz,c60_descr,
			                        ...
			                        round(valor_debito, 2) as saldo_anterior_debito,
				                    round(valor_credito, 2) as saldo_anterior_credito,
						  			round(saldo_final, 2) as saldo_final,
						  			natureza_saldo_anterior as sinal_anterior,
						  			natureza_saldo_final as sinal_final
              from (
                 select c62_reduz,c60_descr,saldos.*
	            		...
	            		from conplanoreduz
	                        ...
	                        inner join conlanc
	                        inner join fc_planosaldonovo_record(".db_getsession("DB_anousu").", c61_reduz, '".db_getsession("DB_anousu")."-01-01','".$dataret."', false) as saldos on saldos.reduzido = c61_reduz
      ...
      if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          if($clconplanoexe->numrows!=0){
            db_fieldsmemory($result,0);
            $campos = "
	       select c62_reduz,c60_descr,c60_estrut,
