  ...
  */
  ...
  public function excluir() {
    ...
    public static function make(\stdClass $oDados, AvaliacaoPergunta $pergunta)
    {
        ...
        $opcao->setDescricao($oDados->db104_descricao);
        $opcao->setAceitaTexto($oDados->db104_aceitatexto == 't');
        $opcao->setIdentificador($oDados->db104_identificador);
        $opcao->setPeso($oDados->db104_peso);
        $opcao->setValorResposta($oDados->db104_valorresposta);
        $opcao->setIdentificadorCampo($oDados->db104_identificadorcampo);
