...
foreach ($aContas as $oConta) {
    ...
    $sContaCorrente = $oConta->getAttribute("conta_corrente");
    $sDescricaoContaCorrente = $oConta->getAttribute("descricao_conta_corrente");
    ...
    if (substr(str_replace(".", "", $sEstrutural), 0, $iTamanhoPesquisa) == $sName ||
        ...
        $oContaRetorno->label = $sEstrutural." - ".$sDescricao." - ".$sContaCorrente." - ".$sDescricaoContaCorrente;
