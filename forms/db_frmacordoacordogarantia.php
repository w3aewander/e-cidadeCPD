                        ...
                        <tr style='display: none'>
                            ...
                            <td>
                                ...
                                db_input(
                                    ...
                                    'text',
                                    $db_opcao,
                                    "onchange='js_pesquisaac12_acordo(false);'"
                                );
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                db_input(
                                    'ac12_acordogarantia',
                                    10,
                                    $Iac12_acordogarantia,
                                    true,
                                    'text',
                                    $db_opcao,
                                    " onchange='js_pesquisaac12_acordogarantia(false);'"
                                );
...
<script>
    ...
    function js_pesquisaac12_acordogarantia(mostra) {
        if (mostra) {
            js_OpenJanelaIframe(
                'CurrentWindow.corpo.iframe_acordogarantia',
            ...
            if (document.form1.ac12_acordogarantia.value != '') {
                ...
                document.form1.ac12_acordogarantia.value = '';
                document.form1.ac12_texto.value = '';
                document.form1.ac11_descricao.value = '';
            }
        }
    }
    ...
    function js_main() {
        ...
        oGridGarantias.setCellWidth(new Array('12%', '88%', '12%'));
    ...
    function js_retornoGetgarantias(oAjax) {
        ...
        if (oRetorno.status == 1) {
            if (!oRetorno.isUpdate) {
                ...
                let inputAcordoGarantia = $('ac12_acordogarantia');
                inputAcordoGarantia.value = oRetorno.itens[0].codigo;
                inputAcordoGarantia.readOnly = true;
                inputAcordoGarantia.style.backgroundColor = "#DEB887";

                $('db_opcao').value = 'Alterar';
                $('btnNovo').style.display = '';
                $('ac11_descricao').value = oRetorno.itens[0].descricao.urlDecode();
                $('ac12_texto').value = oRetorno.itens[0].texto.urlDecode().replaceAll(/'|"/gi, '');
            }
        } else {
    ...
    function js_limpar() {
        let inputAcordoGarantia = $('ac12_acordogarantia');
        inputAcordoGarantia.readOnly = false;
        inputAcordoGarantia.style.backgroundColor = "#fff";
        inputAcordoGarantia.value = ''
