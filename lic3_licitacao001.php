...
function js_abreconsulta2(codigo) {
	...
	js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_infolic','lic3_licitacao002.php?l20_codigo='+codigo,'Consulta Licitação',true);
}
</script>
...
function retornoConsultaRegistroPreco(pc10_numero) {
    db_iframe_infosol.hide();

    js_OpenJanelaIframe(
        '',
        'db_iframe_consultaabertura',
        `com4_consabertregistro003.php?pc10_numero=${pc10_numero}`,
        'Pesquisa',
        true
    );
}
