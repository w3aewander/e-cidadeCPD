 ...
 * @return int Codigo do laboratorio logado
 */
...
if (isset($incluir)) {
    ...
    if ($cllab_autoriza->erro_status != "0") {
        ...
        $cllab_requiitem->la21_c_situacao = "20 - Autorizado";
    ...
    if ($iLaboratorioLogado == 0) { ?>
        <div class="container">
            <table class="form-container">
                <tr>
                    <td align='center'>
                        <span style="color: #FF0000">Usuário ou departamento não consta como laboratório!</span>
                    </td>
                </tr>
            </table>
        </div>
