                                ...
                                <td valign="top">
                                    <fieldset>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <b>Fonte de Recurso:</b>
                                                </td>
                                                <td>
                                                    <select id='cboOperadorFonteRecurso'>
                                                        <option value='in'>Contendo</option>
                                                        <option value='notin'>Não Contendo</option>
                                                    </select>
                                                </td>
                                                <td id='inputfonterecurso'></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id='cboOperadorComplemento'>
                                                        <option value='in'>Contendo</option>
                                                        <option value='notin'>Não Contendo</option>
                                                    </select>
                                                </td>
                                                <td id='inputcomplemento'></td>
                                            </tr>
...
<script>
    ...
    function js_init() {
        ...
        oInputindicadorsuperavit = new DBComboBox('txtIndicadorsuperavit', 'oInputindicadorsuperavit',
            {'': '', F: 'Financeiro', P: 'Patrimonial'});
        ...
        oGridContas.setHeader(['Conta', 'Exclusão', 'Nível', 'I.S.', 'Ação']);
        oGridContas.setCellWidth(['40%', '18%', '12%', '15%', '15%']);
        oGridContas.setCellAlign(['left', 'center', 'center', 'center', 'center']);
        ...
        oTxtFonteRecurso = new DBTextField('txtFonteRecurso', 'oTxtFonteRecurso');
        oTxtFonteRecurso.addEvent('onKeyPress', 'return js_mask(event,"0-9|,| ")');
        oTxtFonteRecurso.show($('inputfonterecurso'));

        oTxtComplemento = new DBTextField('txtComplemento', 'oTxtComplemento');
        oTxtComplemento.addEvent('onKeyPress', 'return js_mask(event,"0-9|,| ")');
        oTxtComplemento.show($('inputcomplemento'));
    ...
    function addConta() {
        ...
        if (lReaOnly) {
            ...
            aNovaConta[4] = '<input type=\'button\' value=\'Excluir\' onclick=\'js_excluir(' + iContaInformada +
                ')\' style=\'width:100%\'>';
        }
        ...
        for (var i = 0; i < aContas.length; i++) {
            ...
            if (aContas[i]) {
                ...
                if (lReaOnly) {
                    ...
                    aNovaConta[4] = '<input type=\'button\' value=\'Excluir\' onclick=\'js_excluir(' + aNovaConta[0] +
                        ')\' style=\'width:100%\'>';
                }
                oGridContas.addRow(aNovaConta);
            }
    ...
    function js_salvarFiltro() {
        ...
        oParam.filters.numerolinharecurso = {};
        ...
        if (oRetorno.status == 2) {
            ...
            oFiltro.contas.each(function(oConta, id) {
                ...
                if (lReaOnly) {
                    ...
                    aNovaConta[4] = '<input type=\'button\' value=\'Excluir\' onclick=\'js_excluir(' +
                        oConta.estrutural +
                        ')\' style=\'width:100%\'>';
                }
                oGridContas.addRow(aNovaConta);
            ...
            $('cboOperadorFonteRecurso').value = oFiltro.fonterecurso.operador;
            oTxtFonteRecurso.setValue(oFiltro.fonterecurso.valor);

            $('cboOperadorComplemento').value = oFiltro.complemento.operador;
            oTxtComplemento.setValue(oFiltro.complemento.valor);
