...
from
(
select r14_regist as regist, ((B029-B030)/100*30) - B031 as margem
from
(
...
/*
  Criado a rubrica R804 pela Mariene e ajustado o calculo
*/
$sql_margem = "
update gerfsal set r14_valor = round(margem.margem,2) 
from
(
select r14_regist as regist, ((B029-B030)/100*10) - B031 as margem
from
(
select ger.r14_regist, 
       coalesce((select sum(r53_valor) 
...
where ger.r14_anousu = $anousu
  and ger.r14_mesusu = $mesusu 
  and ger.r14_rubric = 'R804'
  $where_regist_fim
) as x
) as margem

where r14_anousu = $anousu and r14_mesusu = $mesusu and r14_rubric = 'R804' and r14_regist = margem.regist
";

$res_margem = pg_query($sql_margem) or die($sql_margem);

 $sql_margem_neg = "delete from gerfsal where r14_anousu = $anousu and r14_mesusu = $mesusu and r14_rubric = 'R804' and (r14_valor <= 0 or r14_valor is null)";
 $res_margem_neg = pg_query($sql_margem_neg) or die($sql_margem_neg);
