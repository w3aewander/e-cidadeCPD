...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_vistestem");
...
public function incluir ($y25_codvist,$y25_numcgm){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_vistestem(
                                       y25_codvist
                                      ,y25_numcgm
                       )
                values (
...
public function alterar ($y25_codvist=null,$y25_numcgm=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_vistestem set ";
     $virgula = "";
...
public function excluir ($y25_codvist=null,$y25_numcgm=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_vistestem
                    where ";
     $sql2 = "";
...
public function sql_query ( $y25_codvist=null,$y25_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_vistestem ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_vistestem.y25_numcgm";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_vistestem.y25_codvist";
     ...
     if($dbwhere==""){
       if($y25_codvist!=null ){
         $sql2 .= " where fis_vistestem.y25_codvist = $y25_codvist ";
       }
       if($y25_numcgm!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_vistestem.y25_numcgm = $y25_numcgm ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y25_codvist=null,$y25_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
