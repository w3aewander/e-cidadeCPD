            ...
            for (var iResp = 0; iResp < respostas.length; iResp++) {
              ...
              with(respostas[iResp]) {
                  ...
                  if (aceitatexto) {
                    ...
                    oTextoResposta = new DBTextField(`texto${codigoresposta}`,`oTexto${codigoresposta}`,sValueInput,30);
                    oTextoResposta.setExpansible(true, 150, 250);
                    sInput = oTextoResposta.toInnerHtml();
