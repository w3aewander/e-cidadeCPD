    ...
    <div class="container">
        <table border="0">
            <tr>
                ...
                <td>
                    <?php db_input('z10_codigo', 10, $Iz10_codigo, true, 'text', 3, "") ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php db_input('z10_numcgm', 8, $Iz10_numcgm, true, 'text', $db_opcao, " onchange='js_pesquisaz10_numcgm(false);'") ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php db_input('nome', 20, $Inome, true, 'text', 3, '') ?>
                </td>
            </tr>
            <tr>
