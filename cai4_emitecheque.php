...
include(modification("classes/db_corcheque_classe.php"));
include(modification("classes/db_corchequecgm_classe.php"));
include(modification("classes/db_bancos_classe.php"));
