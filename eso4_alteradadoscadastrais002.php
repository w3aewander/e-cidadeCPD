    ...
    <form>
        ...
        <script>
            ...
            function buscarAvaliacao(Event) {
                ...
                var oAjaxRequest = new AjaxRequest('eso4_alteradadoscadastrais.RPC.php', oDados, montarAvaliacao);
            ...
            function montarAvaliacao(oResponse, lErro) {
                ...
                if (lErro) {
                    ...
                    location.href = 'eso4_alteradadoscadastrais001.php';
                }
            ...
            function salvarQuestionario(viewAvaliacao, iCodigoGrupo) {
                ...
                var oAjaxRequest = new AjaxRequest(
                    'eso4_alteradadoscadastrais.RPC.php',
                    {
            ...
            function buscarMatriculas() {
                ...
                var oAjaxRequest = new AjaxRequest('eso4_alteradadoscadastrais.RPC.php', oDados,
                    function(oResponse, lErro) {
                        ...
                        for (oMatricula of oResponse.matriculas) {
                            ...
                            var oOption = new Option(oMatricula.matricula + ' - ' + oMatricula.nome,
                                oMatricula.matricula);
