...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_resptecnico.location.href='fis1_fis_resptecnico002.php?chavepesquisa=$y22_codsani&chavepesquisa1=$y22_numcgm'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_resptecnico.location.href='fis1_fis_resptecnico003.php?chavepesquisa=$y22_codsani&chavepesquisa1=$y22_numcgm'</script>";
}
?>
...
//echo "<script>js_OpenJanelaIframe('','db_iframe_sanitario','func_fis_sanitario.php?pesquisa_chave='+document.form1.y22_codsani.value+'&funcao_js=parent.js_mostrasanitario','Pesquisa',false);</script>";
?>
       <?php
