...
class cl_liclicitem
{
    ...
    function sql_query_inf(
      $l21_codigo = null,
      $campos = "*",
      $ordem = null,
      $dbwhere = "",
      $lTrazerApenasVencedor = false
    ) {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= "      left  join pcorcamfornelic      on pc31_orcamforne                     = pc21_orcamforne ";
        $sql .= "      left  join liclicitatipoempresa on l32_sequencial                      = pc31_liclicitatipoempresa ";
    ...
    function sql_query_sol($l21_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= "      left  join solicitavinculo aberturaregistropreco on solicita.pc10_numero = aberturaregistropreco.pc53_solicitafilho ";
    ...
    function sql_query_portal_transparencia(
      $l21_codigo = null,
      $campos = "*",
      $ordem = null,
      $dbwhere = "",
      $lTrazerApenasVencedor = false
        ...
        $sql .= "      inner join liclicitacadattdinamicovalorgrupo";
        $sql .= "      on liclicitem.l21_codliclicita = liclicitacadattdinamicovalorgrupo.l16_liclicita";
        $sql .= "      inner join db_cadattdinamicoatributosvalor";
        $sql .= "      on liclicitacadattdinamicovalorgrupo.l16_cadattdinamicovalorgrupo = db_cadattdinamicoatributosvalor.db110_cadattdinamicovalorgrupo";
    ...
    function sql_query_acordos ( $l21_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from liclicitem ";
     $sql .= "      inner join acordoliclicitem on acordoliclicitem.ac24_liclicitem = liclicitem.l21_codigo ";
    ...
    public function sql_itens_fornecedores($l21_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= "  left join solicitemunid        on solicitemunid.pc17_codigo       = solicitem.pc11_codigo ";
        $sql .= "  left join matunid              on matunid.m61_codmatunid          = solicitemunid.pc17_unid ";
        $sql .= "  left join acordoliclicitem     on acordoliclicitem.ac24_liclicitem = liclicitem.l21_codigo";
        $sql .= "  left join pctipocompratribunal on pctipocompratribunal.l44_sequencial = cflicita.l03_pctipocompratribunal";
        $sql2 = "";
    ...
    public function sqlItensSemVencedor($campos = array(), $where = array(), $ordernacao = array())
    {
        ...
        $ordernacao = !empty($ordernacao) ? " order by " . implode(', ', $ordernacao) : '';

        $sql = "select {$campos}";
        $sql .= " from liclicitem ";
        $sql .= "      left join pcorcamitemlic on pc26_liclicitem = l21_codigo ";
        $sql .= "      left join pcorcamitem on pc22_orcamitem = pc26_orcamitem ";
        $sql .= "      left join pcorcamjulg on pc22_orcamitem = pc24_orcamitem ";
        $sql .= "                           and pc24_pontuacao = 1";
        $sql .= " {$where} {$ordernacao} ";
