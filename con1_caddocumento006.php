 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_documentoatributo.location.href='con1_caddocumentoatributo001.php?db_opcaoal=33&db45_caddocumento=".@$db44_sequencial."';
     ";
         if(isset($liberaaba)){
