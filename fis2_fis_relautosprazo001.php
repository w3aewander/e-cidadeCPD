...
function js_emite(){
  ...
  jan = window.open('fis2_fis_relautosprazo002.php?setorfiscal='+obj.setorfiscal.value+'&dt_ini='+dt_ini+'&dt_fin='+dt_fin+'&dt_prazo='+dt_prazo,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
</script>
  ...
  <table  align="center" border=0>
	...
	<?php   /**************************************************************************************/
	    ...
	    $select[0] = "(todos setores)";
            ...
            $resultTipoFiscaliza = db_query("SELECT coddepto, descrdepto FROM db_depart
					                                 OUTTER join fiscalizacao.fis_auto ON coddepto = y50_setor
