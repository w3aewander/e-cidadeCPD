...
<form name="form1" method="post" action="">
    <fieldset>
        ...
        <table border="0" align="left">
            <tr>
                <td nowrap title="<?php echo @$Tac03_sequencia?>">
                    <b>Grupo:</b>
                </td>
                <td>
                    <?php
            ...
            <tr>
                <td nowrap title="<?php echo @$Tac03_anousu?>">
                    <b>Ano:</b>
                </td>
                <td>
                    <?php
            ...
            <tr>
                <td nowrap title="<?php echo @$Tac03_numero?>">
                    <?php echo @$Lac03_numero?>
                </td>
                <td>
                    <?php
        ...
        <tr>
            ...
            <td>
                <input name="novo" type="button" id="cancelar" value="Novo" onclick="js_cancelar();"
                    <?php echo ($db_opcao==1||isset($db_opcaoal)?"style='visibility:hidden;'":"")?> >
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
