...
const spanPaciente = document.getElementById('paciente');
...
const validaMicroarea = () => {
  validaCgs.isCadastradoMicroarea(oGet.iCgs).then(cadastrado => {
    if(!cadastrado) {
      spanPaciente.parentElement.classList = '';
      spanPaciente.parentElement.addClassName('alert-danger');
      divAlert.hidden = '';
    }
  });
}
