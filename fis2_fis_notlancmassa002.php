...
if (isset($iCodigoProcessoFiscal) and $iCodigoProcessoFiscal != '') {
  ...
  $sSqlFis .= " where fd01_instit = ".db_getsession("DB_instit")." and y100_sequencial between {$iCodigoProcessoFiscal}  and $codprocfiscalfim limit 1";
}
...
if ($iTemplateNotiLancamento != "") {
  ...
  $sAgt = "fiscal/fis_notificacao_de_lancamento_massa.agt";

  $aParam = array();
  $aParam['$procfiscalini'] = $iCodigoProcessoFiscal;
  $aParam['$procfiscalfim'] = $codprocfiscalfim;
