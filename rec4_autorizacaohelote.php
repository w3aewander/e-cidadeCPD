...
if(!empty($aTiposAssentamento)) {
    foreach ($aTiposAssentamento as $tipoAssentamento) {
        $aAutorizacaoHorasExtras[$tipoAssentamento->getSequencial()] = $tipoAssentamento->getCodigo() .' - '. $tipoAssentamento->getDescricao();
    }
}
?>
...
<div class="container">
  <form>
    <fieldset>
      <legend>Lançamento de Autorização de Horas Extras</legend>
      ...
      <table class="form-container">
        ...
        <tr>
          <td>
            <label for="tipoassentamento">Autorização de Hora Extra:</label>
          </td>
          <td>
              <?php db_select('tipoassentamento', $aAutorizacaoHorasExtras, true, 0); ?>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="text" value="23:59" id="horasAutorizadas" name="horasAutorizadas" class="field-size2" />
          </td>
        </tr>
      </table>
    </fieldset>
...
<script type="text/javascript">
  ...
  $('limpar').observe('click', function() {
    location.href = 'rec4_autorizacaohelote.php';
  });
  ...
  $('salvar').observe('click', function () {
    ...
    var oAjaxRequest = new AjaxRequest(
      ...
      {
        'exec'                  : 'criarAssentamentosAutorizacaoHoraExtra',
        'selecao'               : $F('r44_selec'),
        ...
        'horasAutorizadas'      : $F('horasAutorizadas'),
        'porLote': true
      },
  ...
  function verificaCampos(){
    ...
    if($F('horasAutorizadas') == null || $F('horasAutorizadas') == ''){

      alert('Informe a quantidade de horas extras autorizadas.');
      return false;
    }
