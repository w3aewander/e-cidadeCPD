...
require_once(modification("classes/db_habittipogrupoprograma_classe.php"));
...
if (isset($oGet->chavepesquisa)) {
  ...
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_tipogrupoprogramaprocdoc.location.href='hab1_tipogrupoprogramaprocdoc001.php?ht02_sequencial=".@$ht02_sequencial."';
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_formaavaliacao.location.href='hab1_tipogrupoprogramaformaavaliacao001.php?ht02_sequencial=".@$ht02_sequencial."';
     ";
