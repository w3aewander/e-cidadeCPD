...
class SiaiDespesa extends SiaiArquivoBase
{
    ...
    public function gerarDados()
    {
        ...
        $arqDotacao = fopen("tmp/TESTE_DESPESA_DOTACAO.TXT", 'w+');
               ...
               $sLinhaDotacao = "tipregistro |  | codigodespesa | Brancos_2 | CodigoGrupoExercicioFonte | CodigoClassificacaoFonte | ";
               $sLinhaDotacao .= "CodigoDetalhamentoFonte | Brancos_3 | classinstitucional | classfuncional | classprograma | ";
               $sLinhaDotacao .= "classprojeto | valordotinicial | valordotacumulada | valorempbimestre | valorempexercicio | ";
               $sLinhaDotacao .= "valorliqbimestre | valorliqexercicio | valorpagoexercicio | valorrpnp | brancos | numRegistro | ";
               $sLinhaDotacao .= "dotacoes";
        ...
        if ($iLinhasDotacaoSaldo > 0) {
            ...
            for ($iInd = 0; $iInd < $iLinhasDotacaoSaldo; $iInd ++) {
                ...
                if (!empty($sWhereOrgaoUnidade)) {
                      $sSqlValorRPNP .= " and {$sWhereOrgaoUnidade} ";
                               }
...
//                }
            ...
            for ($iInd = 0; $iInd < $iLinhasDotacaoSaldo; $iInd ++) {
                ...
                if ($sHashProgramaProjetoAtividade != $sIdProgramaProjetoAtividade) {
                    ...
                    $sLinhaProjetoAtividade = $oDadosDetalhe2->tipregistro . " | " . $oDadosDetalhe2->numerodoprograma . " | " . $oDadosDetalhe2->numeroprojetoatividade . " | " . $oDadosDetalhe2->descricaoprojetoatividade . " | " . $oDadosDetalhe2->tipo . " | " . $oDadosDetalhe2->brancos . " | " . $oDadosDetalhe2->numRegistro;
...
//              }
            ...
            foreach ($aDadosDespesas as $iIdDespesa => $aDespesa) {
                ...
                fputs($arqDotacao, $sLinhaDotacao . " |>> " . $oDespesa->dotacoes. "\r\n");
