<template>
    ...
    >
        <div>
            <div v-if="cgmSelected.length !== 0" class="destinatarios-container">
            ...
            <hr
                ...
                style="width: 97%; margin: 0 auto; height: 1px; background-color: #D1D1D1; border: none;"
            >
            ...
            <div class="card" ref="containerTable">
                ...
                >
                    ...
                    <Column header="AÇÃO">
                        <template #body="{ data }">
                            <i id="caneta-editar" class="pi pi-pencil" @click="openDialogAddCgm($event, data.z01_cgccpf)"></i>
                        </template>
                    </Column>
                </DataTable>
            </div>
