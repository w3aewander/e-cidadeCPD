...
if(!isset($abas)){
  echo "<script>location.href='fis1_fis_tipovistorias005.php'</script>";
  exit;
}
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?php
	include(modification("forms/db_frm_fis_tipovistorias.php"));
	?>
    </center>
	</td>
  </tr>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Incluir"){
  if($cltipovistorias->erro_status=="0"){
    ...
    echo "<script>parent.iframe_vistrec.location.href='fis1_fis_tipovistoriasrec001.php?abas=1&y78_codtipo=".$cltipovistorias->y77_codtipo."';</script>";
    echo "<script>parent.iframe_tipovist.location.href='fis1_fis_tipovistorias002.php?abas=1&chavepesquisa=".$cltipovistorias->y77_codtipo."';</script>";
  };
};
?>
