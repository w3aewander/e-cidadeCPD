        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="top" bgcolor="#CCCCCC">
                    <fieldset style="width:95%;height:360px;">
                        <legend><b>Escolha a opção:</b></legend>
                        <input type="radio" id="ER" name="opcao" value="ER" checked><label for="ER">Escolas da rede municipal</label><br>
                        <input type="radio" id="EF" name="opcao" value="EF"><label for="EF">Outras escolas</label><br><br>
