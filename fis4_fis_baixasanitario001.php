...
function js_pesquisay80_codsani(mostra){
  if(mostra == true){
    js_OpenJanelaIframe('','db_iframe_sanitario','func_fis_sanitario.php?funcao_js=parent.js_mostrasanitario1|y80_codsani|z01_nome','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_sanitario','func_fis_sanitario.php?pesquisa_chave='+document.form1.y80_codsani.value+'&funcao_js=parent.js_mostrasanitario','Pesquisa',false);
  }
}
