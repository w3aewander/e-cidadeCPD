...
if (isset ($incluir) || (isset ($importar) && $confirma == true)) {
    ...
    if ($sqlerro == false && ($pc10_solicitacaotipo == 1 && $pc30_seltipo == 't') || $pc10_solicitacaotipo == 5) {
    ...
    if (isset ($importar) && trim($importar) != "" && $sqlerro == false) {
        ...
        for ($i = 0; $i < $numrows_importacaoitem; $i++) {
            ...
            if ($ano_imp != db_getsession("DB_anousu")) {
                ...
                if ($pc11_quant <= 1) {
                    $clsolicitem->pc11_servicoquantidade = 'f';
                }
                if (isset($param) && trim($param) != "") {
                    $liberado = "true";
                } else {
...
if (isset ($incluir) || (isset ($importar) && $confirma == true)) {
    ...
    if ($sqlerro == true) {
        ...
        if (isset ($importar) && trim($importar) != "") {
            ...
            db_redireciona("com1_solicita005.php?db_opcaoBtnRegistroPreco=1&liberaaba=true&chavepesquisa=$pc10_numero$parametro&tipoSolicitacao={$pc10_solicitacaotipo}");
        }
    }
}
