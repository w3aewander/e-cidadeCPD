        ...
        if(!isset($pesquisa_chave)){
          if(isset($campos)==false){
            if(file_exists("funcoes/db_func_orcreserva.php")==true){
              include(modification("funcoes/db_func_orcreserva.php"));
            }else{
              $campos = "orcreserva.*";
            }
          }
            ...
            $sql = $clorcreserva->sql_query_reservas($chave_o80_codres,
              ...
              "o80_codres=$chave_o80_codres and o80_codres not in
						 ( select o81_codres from orcreservasup
						  ...
						  ) and o80_anousu = $anousu and o58_instit = $instit ");
          ...
          if (isset($_GET['flagAlterarDotacao']) && $_GET['flagAlterarDotacao']) {
            $funcao_js = '';
          }
          ...
          if($pesquisa_chave!=null && $pesquisa_chave!=""){
            ...
            $sql =  $clorcreserva->sql_query_reservas($pesquisa_chave,
              "",
              "",
              "o80_codres not in
						     ( select o81_codres from orcreservasup
            ...
            $result = $clorcreserva->sql_record($sql);
