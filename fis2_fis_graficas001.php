...
<script>
function js_emite(){
  jan = window.open('fis2_fis_graficas002.php?ordem='+document.form1.ordem.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
</script>
