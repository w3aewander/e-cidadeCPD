  ...
  <center>
    ...
    -->
      ...
      <?php
        ...
        $record_select3 = db_query("select distinct d.id_perfil from db_permherda d
          where d.id_usuario = $usuario and d.id_perfil not in (select distinct d.id_perfil from db_permherda d
          where d.id_usuario in ($db_id_usuario))");

        $record_select2 = db_query("select distinct d.id_perfil from db_permherda d
          where d.id_usuario in($db_id_usuario, $usuario)");
