 ...
 */
class Anexo4 extends Base implements In22
{

    const CODIGO_RELATORIO = 209;
    const TEMPLATE = 'config/templates/IN22/anexo4.xlsx';
    ...
    private function processarDados()
    {
        ...
        $campos = [
            ...
            "to_char(c70_data, 'DD/MM/YYYY') as data",
            $campoProjeto,
            $campoContaCorrente,
