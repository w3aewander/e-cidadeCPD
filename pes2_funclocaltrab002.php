...
$subQuery  = "select rh01_regist, ";
$subQuery .= "       z01_nome, ";
$subQuery .= "       case when rh55_estrut is null then '0' else rh55_estrut end as rh55_estrut, ";
$subQuery .= "       case when rh55_estrut is null then 'SEM LOCAL CADASTRADO' else rh55_descr end as rh55_descr, ";
$subQuery .= "       r70_estrut, ";
$subQuery .= "       r70_descr ";
$subQuery .= "  from rhpessoal ";
$subQuery .= "       inner join rhpessoalmov    on rh02_anousu = {$anofolha} ";
$subQuery .= "                                 and rh02_mesusu = {$mesfolha} ";
$subQuery .= "                                 and rh02_regist = rh01_regist ";
$subQuery .= "                                 and rh02_instit = " . db_getsession("DB_instit") . " ";
$subQuery .= "       inner join cgm             on rh01_numcgm = z01_numcgm ";
$subQuery .= "       inner join rhlota          on r70_codigo  = rh02_lota and r70_instit = " . db_getsession("DB_instit") . " ";
$subQuery .= "       left  join rhpeslocaltrab  on rh56_seqpes = rh02_seqpes and rh56_princ = 't' ";
$subQuery .= "       left  join rhlocaltrab     on rh55_codigo = rh56_localtrab and rh55_instit = " . db_getsession("DB_instit") . " ";
$subQuery .= "       inner join rhregime        on rh30_codreg = rh02_codreg ";
$subQuery .= "		                             and rh30_instit = rh02_instit ";
$subQuery .= "       left join rhpesrescisao    on rh05_seqpes = rh02_seqpes ";
$subQuery .= " where rh05_seqpes is null ";
$subQuery .= " {$whereregime} ";
...
for ($x = 0; $x < $totalLinhas; $x++) {
    ...
    if ($orgao != $rh55_estrut && !$tipoGeral) {
        if ($x != 0) {
            $pdf->setfont('arial', '', 8);
