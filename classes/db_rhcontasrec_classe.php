...
class cl_rhcontasrec
{
    ...
    /**
     * @deprecated não vai na tabela fonterecurso
     * @uses sql_query2
     * @param $rh41_conta
     * @param $rh41_codigo
     * @param $rh41_instit
     ...
     * @return string
     */
    function sql_query2($rh41_conta = null, $rh41_codigo = null, $rh41_instit = null, $rh41_anousu = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "
        select $campos
          from rhcontasrec
          join db_config  on  db_config.codigo = rhcontasrec.rh41_instit
          join saltes  on  saltes.k13_conta = rhcontasrec.rh41_conta
          join orctiporec  on  orctiporec.o15_codigo = rhcontasrec.rh41_codigo
          join fonterecurso on fonterecurso.orctiporec_id = orctiporec.o15_codigo
               and fonterecurso.exercicio = rhcontasrec.rh41_anousu
    ...
    function sql_query_contas($rh41_conta = null, $rh41_codigo = null, $rh41_instit = null, $rh41_anousu = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= "      inner join db_config  on  db_config.codigo = rhcontasrec.rh41_instit";
        $sql .= "      inner join saltes  on  saltes.k13_conta = rhcontasrec.rh41_conta";
        $sql .= "      inner join conplanoreduz on conplanoreduz.c61_reduz = saltes.k13_reduz and c61_anousu= {$anousu}";
        ...
        $sql .= "      inner join orctiporec  on  orctiporec.o15_codigo = rhcontasrec.rh41_codigo";
        $sql .= "      inner join fonterecurso on fonterecurso.orctiporec_id = orctiporec.o15_codigo
