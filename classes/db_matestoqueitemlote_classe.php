...
class cl_matestoqueitemlote {
   ...
   public $m77_sequencial = 0;
   public $m77_lote = null;
   public $m77_dtvalidade_dia = null;
   public $m77_dtvalidade_mes = null;
   public $m77_dtvalidade_ano = null;
   public $m77_dtvalidade = null;
   public $m77_matestoqueitem = 0;
   ...
   public function incluir ($m77_sequencial){
      $this->atualizacampos();
   ...
   public function alterar ($m77_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($m77_sequencial=null,$dbwhere=null) {
   ...
   public function sql_query ( $m77_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $m77_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_informacoes_lote ( $m77_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
     $campos_sql = explode("#",$campos);
      $virgula = "";
