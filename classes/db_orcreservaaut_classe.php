...
class cl_orcreservaaut
{
   ...
   public function erro($mostra, $retorna)
    ...
    public function incluir($o83_codres)
    {
        $this->atualizacampos();
    ...
    public function alterar($o83_codres = null)
    {
        $this->atualizacampos();
    ...
    public function excluir($o83_codres = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query_orcreserva($o83_codres = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query($o83_codres = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= "      inner join empautorizacaoautorizada
                                                  on empautorizacaoautorizada.empautoriza_id = empautoriza.e54_autori";
    ...
    public function sql_query_file($o83_codres = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
