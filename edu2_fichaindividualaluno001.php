  ...
  <td colspan="4">
    ...
    ?>
     ...
     <?if (trim($ed37_c_tipo) == "PARECER" || $veja == "EJA ANOS INICIAIS" || $veja == "EJA INICIAIS 2024" )  {?>
         ...
         <input name="pesquisarb" type="button" id="pesquisarb" value="Gerar WORD"
                onclick="js_pesquisa2b(document.form1.subgrupo.value);" disabled>
     ...
     <?} else {?>
         ...
         <input name="pesquisarb" type="button" id="pesquisarb" value="Gerar WORD"
                onclick="js_pesquisab(document.form1.subgrupo.value);" disabled>
...
//      sParametros += '&iAtividade2='                + oCboAtividades2.getValue();
 ...
 jan = window.open('edu2_fichaindividualalunoPDF002.php?' + sParametros,'',
         'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0');
...
function js_pesquisa2b(turma) {
 ...
 jan = window.open( 'edu2_fichaindividualalunoWord003.php?' + sParametros,
                    '',
                    'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
