          ...
          for ($iRowLancamento = 0; $iRowLancamento < $oDaoContranslan->numrows; $iRowLancamento++) {
            ...
            if ($oDaoContranslr->numrows > 0) {
              ...
              for ($iRowRegrasLancamento = 0; $iRowRegrasLancamento < $oDaoContranslr->numrows; $iRowRegrasLancamento++) {
                ...
                if($oTransacao->c45_coddoc == 31 || $oTransacao->c45_coddoc == 32 || $oTransacao->c45_coddoc == 33 || $oTransacao->c45_coddoc == 34 || $oTransacao->c45_coddoc == 35 || $oTransacao->c45_coddoc == 36 || $oTransacao->c45_coddoc == 37 || $oTransacao->c45_coddoc == 38){
                  $oXmlWriter->writeAttribute('c47_anousu', $oConta->c47_anousu);
                }else{
                  if($oConta->c47_anousu == 2020){
                    $oXmlWriter->writeAttribute('c47_anousu', 2021);
                  } elseif($oConta->c47_anousu == 2022){
                    $oXmlWriter->writeAttribute('c47_anousu', 2023);
                  } else{
                    $oXmlWriter->writeAttribute('c47_anousu', $oConta->c47_anousu);
                  }
                }
