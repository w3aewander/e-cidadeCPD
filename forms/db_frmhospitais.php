  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.cm18_i_hospital.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_cgm.php?pesquisa_chave='+document.form1.cm18_i_hospital.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
