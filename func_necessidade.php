...
require_once(modification("classes/db_necessidade_classe.php"));
   ...
   if(!isset($pesquisa_chave)){
    ...
    if(isset($campos)==false){
     ...
     if(file_exists("funcoes/db_func_necessidade.php")==true){
       include(modification("funcoes/db_func_necessidade.php"));
     }else{
       $campos = "necessidade.*";
     }
    }
    ...
    db_lovrot($sql,15,"()","",$funcao_js);
     ...
     if($pesquisa_chave!=null && $pesquisa_chave!=""){
       $sWhere .= " and ed48_i_codigo = {$pesquisa_chave}";
       $result = $clnecessidade->sql_record($clnecessidade->sql_query(null, "*", null, $sWhere));
