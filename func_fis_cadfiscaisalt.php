    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
        	 $where = " and fis_cadfiscais.id_usuario = $chave_id_usuario ";
        	 ...
        	 $where = " and nome like '$chave_nome%' ";
				...
				$sql = "
				select distinct fis_cadfiscais.*,db_usuarios.nome 
				...
				left join fiscalizacao.fis_datalimitefiscal on fiscal = fis_cadfiscais.id_usuario
...
//echo $sql;
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          if($clcadfiscais->numrows!=0){
            ...
            echo "<script>".$funcao_js."('$id_usuario','$nome');</script>";
          }else{
