...
function js_consulta(valor1){
  ...
  var sQuery = '';
  sQuery += 'e50_codord='+valor1;
  
  js_OpenJanelaIframe('top.corpo','db_iframe_pesquisa',
                      'emp1_empconsultaprocesso003.php?'+sQuery,
                      'Pesquisa',true);  
  
}

function js_imprimirPDF(){
  var sQuery = '';
  sQuery += 'e60_codemp='+$F('e60_codemp');
  sQuery += '&z01_numcgm='+$F('z01_numcgm');
  sQuery += '&situacao='+$F('situacao');
  sQuery += '&e03_numeroprocesso='+   encodeURIComponent($F('e03_numeroprocesso'));
  ...
  var oJanela = window.open('emp1_empconsultaprocesso0011.php?'+sQuery, 'relatorioacordotipificado', 'width='+(screen.availWidth-5)+', height='+(screen.availHeight-40)+', scrollbars=1, location=0');
  oJanela.moveTo(0,0);
}
...
function js_abre(){
  ...
  js_OpenJanelaIframe('top.corpo','db_iframe_pesquisa',
                      'emp1_empconsultaprocesso002.php?'+sQuery+'&funcao_js=parent.js_consulta|e50_codord',
                      'Pesquisa',true);
}
</script>  
...
<table width="790" style="margin-top: 20px;" align="center">
  <tr>
  <td>
  <fieldset><legend><b>Consulta por processo</b></legend>
    <table>
      ...
      <tr> 
        ...
        <td align="left" nowrap>
          <? 
            db_input("e03_numeroprocesso", 10, null,true,"text",4, null, null, null, null,15);
          ?>
        </td>
      </tr>
  ...
  <tr>
    <td align="center">
	    <input name="imprime" type="button" onclick='js_imprimirPDF()' value="Imprimir">
