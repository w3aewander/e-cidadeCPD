 ...
 */
class Anexo10A extends Base implements In22
{
    const CODIGO_RELATORIO = 235;
    const TEMPLATE = 'config/templates/IN22/anexo10_A.xlsx';
    ...
    private function processarDados()
    {
        ...
        $campos = [
            ...
            "(case when substr(o56_elemento, 1, 3)  = '331' then 1
                  else 2 end) as tipo"
        ];
        $where = [
