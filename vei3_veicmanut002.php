...
include(modification("classes/db_veicmanutitem_classe.php"));
include(modification("classes/db_veicmanutoficina_classe.php"));
include(modification("classes/db_veicmanutretirada_classe.php"));
