    ...
    <table>
        <tr>
            <td valign="top" bgcolor="#CCCCCC">
                <input id="escolaRede" type="radio" name="opcao" value="ER" onclick="js_direciona1();" <?= $db_opcao == 1 ? "checked" : "" ?>><label for="escolaRede">Escolas da rede municipal</label><br>
            </td>
            <td>
...
<form name="form1" method="post" action="" class="container">
                ...
                <div name="situacao" id="situacao">
                    <fieldset>
                        <legend>
                            ...
                            ?>
                            <input type="text" name="legenda" value="<?= $ed62_c_situacao ?>" size="15" style="border: 0px; background: #cccccc; font-weight: bold; text-align: center;" readonly>
                        </legend>
                        <table>
                            <tr id="justificativa">
    ...
    ?>
        ...
        <input name="incluir" type="submit" id="btnIncluir" value="Incluir" <?= ($db_botao == false ? "disabled" : "") ?> onclick="return js_minimoaprov();">
    <?php
    } else {
    ?>

        <input name="alterar" type="submit" id="btnAlterar" value="Alterar" <?= ($db_botao == false ? "disabled" : "") ?> onclick="return js_minimoaprov();">

        <input name="excluir" type="button" id="btnExcluir" value="Excluir" <?= ($db_botao == false ? "disabled" : "") ?> onclick="js_confirmaExclusao();">
    <?php
    }
    ?>
</form>
