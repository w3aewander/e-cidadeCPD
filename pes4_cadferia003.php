...
if(isset($excluir)){
  ...
  try {
    ...
    if (!$lFolhaFechada) {
      ...
      /**
       * Excluindo dados do Ajuste caso exista
       */
      $sExclusaoIRRF        = "delete                                        "; 
      $sExclusaoIRRF       .= "  from previden                               ";
      $sExclusaoIRRF       .= " where r60_folha  = 'F'                       ";
      $sExclusaoIRRF       .= "   and r60_regist = {$oServidor->getMatricula()} ";
      $sExclusaoIRRF       .= "   and r60_anousu = ". DBPessoal::getAnoFolha();
      $sExclusaoIRRF       .= "   and r60_mesusu = ". DBPessoal::getMesFolha();
      $sExclusaoIRRF       .= "   and r60_numcgm = {$oServidor->getCgm()->getCodigo()}  ";

      $sExclusaoPrevidencia = "delete                                        "; 
      $sExclusaoPrevidencia.= "  from ajusteir                               ";
      $sExclusaoPrevidencia.= " where r61_folha  = 'F'                       ";
      $sExclusaoPrevidencia.= "   and r61_regist = {$oServidor->getMatricula()} ";
      $sExclusaoPrevidencia.= "   and r61_anousu = ". DBPessoal::getAnoFolha();
      $sExclusaoPrevidencia.= "   and r61_mesusu = ". DBPessoal::getMesFolha();
      $sExclusaoPrevidencia.= "   and r61_numcgm = {$oServidor->getCgm()->getCodigo()}  ";

      if ( !db_query($sExclusaoPrevidencia) || !db_query($sExclusaoIRRF) ) {
        throw new DBException("Erro ao excluir os ajustes de previdencia" );
      }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="430" align="left" valign="top" bgcolor="#CCCCCC"> 
      <center>
      <?
      include(modification("forms/db_frmexcferia.php"));
      ?>
      </center>
    </td>
  </tr>
