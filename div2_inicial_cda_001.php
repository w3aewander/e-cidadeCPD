    ...
    <script>
        function js_AbreJanelaRelatorio() {
            if (document.form1.v50_inicial.value != '' || document.form1.v50_inicial.value != '') {
                jan = window.open('div2_inicial_cda_002.php?tamanho=' + document.form1.tamanho.value +
                    ...
                    '&DBtxt14=' + document.form1.DBtxt14.value +
                    '&DBtxt16=' + document.form1.DBtxt16.value +
                    '&totexe=' + document.form1.totexe.value +
                    '&endaimp=' + document.form1.endaimp.value +
...
<body bgcolor=#CCCCCC>
<form class="container" name="form1" method="post" action="div2_inicial_cda_002.php">
    <fieldset>
        <legend>Relatórios - Emissão de Inicial com CDA</legend>
    ...
    <input  size='10' 
            ...
            type="button" 
            id="exibir_relatorio" 
            value="Exibir relat&oacute;rio"
            onClick="js_AbreJanelaRelatorio()">
</form>
<?php
if (!isset($oGet->iInicialIni) && !isset($oGet->iInicialFim)) {
...
<script>
    ...
    function js_pesquisaparcel_certidao(mostra) {

        if (mostra == true) {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe', 'func_certdiv.php?funcao_js=parent.js_mostratermo1_certidao|0', 'Pesquisa', true);
        } else {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe', 'func_certdiv.php?pesquisa_chave=' + document.form1.v14_certid.value + '&funcao_js=parent.js_mostratermo_certidao', 'Pesquisa', false);
        }
    }

    function js_mostratermo_certidao(chave, erro) {
    ...
    function js_mostratermo1_certidao(chave1) {

        document.form1.v14_certid.value = chave1;
        db_iframe.hide();
    }

    function js_pesquisaparcel1_certidao(mostra) {

        if (mostra == true) {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe', 'func_certdiv.php?funcao_js=parent.js_mostratermo11_certidao|0', 'Pesquisa', true);
        } else {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe', 'func_certdiv.php?pesquisa_chave=' + document.form1.v14_certid1.value + '&funcao_js=parent.js_mostratermo2_certidao', 'Pesquisa', false);
        }
    }

    function js_mostratermo2_certidao(chave, erro) {
    ...
    function js_mostratermo11_certidao(chave1) {
