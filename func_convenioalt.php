    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?php echo $Tr56_codrel; ?>">
              <?php echo $Lr56_codrel; ?>
            </td>
          ...
          <tr> 
            <td width="4%" align="right" nowrap title="<?php echo $Tr56_descr;?>">
              <?php echo $Lr56_descr; ?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?php
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_convenio.php")==true){
             include(modification("funcoes/db_func_convenio.php"));
           }else{
           $campos = "convenio.*";
           }
        }
        if(isset($chave_r56_codrel) && (trim($chave_r56_codrel)!="") ){
	         ...
	         $sql = $clconvenio->sql_query("",db_getsession('DBS_instit'),$campos,"r56_descr"," r56_instit = ".db_getsession('DB_instit')." and r56_descr like '$chave_r56_descr%' ");
        }else{
