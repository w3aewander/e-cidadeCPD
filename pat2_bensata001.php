...
$sCamposFrom .= " sum(vlrmovelproprio::numeric)::money::varchar   as vlrmovelproprio,  ";
$sCamposFrom .= " sum(vlrmovelconvenio::numeric)::money::varchar  as vlrmovelconvenio, ";
$sCamposFrom .= " sum(vlrimovelproprio::numeric)::money::varchar  as vlrimovelproprio, ";
$sCamposFrom .= " sum(vlrimovelconvenio::numeric)::money::varchar as vlrimovelconvenio,";
$sCamposFrom .= " sum(vlrimovelconvenio::numeric+vlrmovelproprio::numeric+vlrmovelconvenio::numeric+vlrimovelproprio::numeric)::money::varchar as vlrtotal ";
