...
class M14650AjusteAnulacaoParcelamento extends PostgresMigration
{
    public function up()
    {
        $this->execute(<<<SQL
            ...
            and ((iTipoParcelamento <> 3) OR (v23_tipo IN (SELECT a.k00_tipo
                                                                                                                                                        FROM arretipo a 
            ...
            ******************************************************************************************************************/
                ...
                delete from arreold where k00_numpre = rTermoSimulaReg.v23_numpre and k00_tipo = rTermoSimulaReg.v23_tipo;
