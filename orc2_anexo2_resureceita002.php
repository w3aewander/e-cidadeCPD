...
$xinstit = explode("-", $_GET['db_selinstit']);
$resultinst = db_query(
    sprintf('select codigo,nomeinstabrev from db_config where codigo in (%s)', implode(',', $xinstit))
);
$descr_inst = '';
$xvirg = '';
...
if (EMENTARIO_RECEITA) {
    ...
    $result = ReceitaSaldo(11, 1, 3, true, $where, db_getsession("DB_anousu"), $dataini, $datafin);
} else {
