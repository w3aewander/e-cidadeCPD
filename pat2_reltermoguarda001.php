...
function js_imprime() {
  ...
  sUrl      = 'pat2_emitetermodeguarda002.php?iCodigoTermo='+$F('t21_codigo');
  if (oGet.devolucao) {    
      sUrl = 'pat2_emitedevolucaotermodeguarda002i.php?iCodigoTermo='+$F('t21_codigo');
  }  
  

  var jan = window.open(sUrl, '','location=0, width='+(screen.availWidth - 5)+',height='+(screen.availHeight - 40)+', scrollbars=1');
