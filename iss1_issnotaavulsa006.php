...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmissnotaavulsa.php"));
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_issnotaavulsaservico.location.href='iss1_issnotaavulsaservico001.php?db_opcaoal=33&q62_sequencial=".@$q51_sequencial."';
     ";
         if(isset($liberaaba)){
