 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_sysfuncoesparam.location.href='con1_db_sysfuncoesparam001.php?db_opcaoal=33&db42_funcao=".@$codfuncao."';
     ";
         if(isset($liberaaba)){
