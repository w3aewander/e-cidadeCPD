...
$oDaoCfpess->rotulo->label("r11_rubricaabonopecuniario");
$sMensagem = "";
if (!empty($_POST["btnSalvar"])) {
  ...
  try {
    ...
    $oDaoCfpess->r11_rubricaabonopecuniario = $_POST["r11_rubricaabonopecuniario"];
...
$sSqlRubricaFerias  = $oDaoCfpess->sql_query_parametro($iAnoFolha,
                                                       ...
                                                       n.rh27_descr as rh27_descrpecunia"
                                                      );
      ...
      <fieldset>
        ...
        <table>
          <tr>
            ...
            <tr>
                <td>
                    <label for="r11_rubricaabonopecuniario">
                        <a id='lblRubricasPecunia' href="javascript:void(0)"><?=$Lr11_rubricaabonopecuniario?></a>
                    </label>
                </td>
                <td>
                    <?php
                    db_input('r11_rubricaabonopecuniario',4,$Ir11_rubricaabonopecuniario,true,'text', 1,"onchange='js_pesquisa_rubricas(false)'");
                    db_input("rh27_descrpecunia",30,$Irh27_descr,true,"text",3);
                    ?>
                </td>
            </tr>
        </table>
...
<script>
  ...
  $('btnSalvar').observe("click", function(event) {
    ...
    if ($F('r11_rubricaabonopecuniario') == '') {

      alert('Campo Rubrica para Abono em Pecúnia deve ser informado');
      event.stopPropagation();
      event.preventDefault();
      return false;
    }
  ...
  $('r11_rubricaabonopecuniario').lang = 'rh27_rubric';
  $('rh27_descrpecunia').lang = 'rh27_descr';
  new DBLookUp($('lblRubricasPecunia'), $('r11_rubricaabonopecuniario'), $('rh27_descrpecunia'), oParametros);
