...
<head>
    ...
    db_app::load("classes/educacao/escola/ListaCalendarioAnoAtual.classe.js");
    ...
    <form id="formPadrao" action="">
        <fieldset>
            ...
            <fieldset class='separator'>
                ...
                <div id="ctnAlunos" style="padding-left: 200px; width:600px;"></div>
            </fieldset>
        ...
        <button type="button" value="Imprimir" id="imprimir" name="imprimir" disabled>
...
<script type="text/javascript">
    ...
    var oCalendario = new DBViewFormularioEducacao.ListaCalendarioAnoAtual();
    ...
    var fFunctionLoadEscola = function () {
        // Mensagem de explicação sobre o que a página se trata,
        // o json da página no servidor se encontra no caminho e-cidade>mensagem>educacao>escola
        alert(_M("educacao.escola.edu2_declaracaoanosatuais.alertando_usuario"));
    ...
    function js_buscaAlunosTurma() {
        ...
        var oParametros = {};
        // Criada uma nova condição para apenas alunos não matriculados
        oParametros.exec = 'pesquisaAlunosTurmaNaoMatriculados';
    ...
    function js_retornoAlunos(oAjax) {
        ...
        if (oRetorno.aAlunos.length == 0) {
            ...
            alert(_M("educacao.escola.edu2_declaracaoanosatuais.nenhum_aluno_encontrado"));
            return false;
        }
    ...
    $('imprimir').observe("click", function () {
        ...
        var sUrl = "edu2_declaracaoanosatuais002.php";
