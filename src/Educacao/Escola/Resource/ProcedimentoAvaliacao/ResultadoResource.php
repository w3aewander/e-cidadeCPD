...
class ResultadoResource
{
    ...
    /**
     * @param TipoResultado $resultado
     * @return object
     */
    public static function toObject(TipoResultado $resultado)
    {
        return (object)[
            'codigo' => $resultado->getCodigo(),
            'descricao' => $resultado->getDescricao(),
            'abreviatura' => $resultado->getDescricaoAbreviada()
        ];
    }
}
