...
$sqlrec = "
select distinct o15_codigo, o15_recurso, o15_recurso || ' - ' || o15_descr as o15_descr, o200_descricao
    from orctiporec
    ...
    <script>
        ...
        function js_emite() {
            ...
            for (i = 0; i < document.form2.elements.length; i++) {
                if (document.form2.elements[i].value == 'on') {
                    continue;
                }
        ...
        function md() {
            el = document.form2;
            if (document.form2.mtodos.checked == true) {
...
<div class="container">
    <fieldset>
        <legend><b> Escolha os recursos</b></legend>
        <form name="form2" method="post">
            <table id='tbgrid' width='' cellspacing=0>
                <thead id='tbhead'>
                <tr>
                    <th bgcolor="#eeeee2"
                        style="border-bottom:1px solid threedshadow;border-right:1px solid threedshadow;text-align:left">
                        <input type="checkbox" onclick='md();' name='mtodos' title="Marcar/Desmarcar todos">
                    </th>

                    <th bgcolor="#eeeee2"
                        style="border-bottom:1px solid threedshadow;border-right:1px solid threedshadow;">
                        Recurso
                    </th>
                    <th bgcolor="#eeeee2"
                        style="border-bottom:1px solid threedshadow;border-right:1px solid threedshadow;">
                ...
                while ($lnrec = pg_fetch_array($rsrec)) {
                    ...
                    echo "<td style='border-bottom:1px solid threedshadow;border-right:1px solid threedshadow;'>" . $lnrec["o200_descricao"] . "</td>\n";
                    echo "</tr>";
                    $i++;
                }
