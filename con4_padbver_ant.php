...
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Factories\BalanceteVerificacaoAnteriorFactory;
...
class bver_ant
{
    ...
    public function bver_ant($header)
    {
    ...
    public function processa($instit = 1, $data_ini = "", $data_fim = "", $tribinst, $subelemento = "")
    {
        ...
        if ($anousu >= 2024) {
            ...
            $service = BalanceteVerificacaoAnteriorFactory::getService($anousu, $instituicoes, $data_ini, $data_fim);
        ...
        if ($oDaoArquivosPad->numrows > 0) {
            ...
            $result = db_planocontassaldo_matriz($anousu, $data_ini, $data_fim, false, $where, '', true, 'true');
            $contador = 0;
            $teste_debito = 0;
            $teste_credito = 0;
