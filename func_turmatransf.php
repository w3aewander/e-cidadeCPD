    ...
    <tr>
        <td align="center" valign="top">
            ...
            if (!isset($pesquisa_chave)) {
                $filtroCalendario = " ed57_i_calendario = {$ed57_i_calendario}";
                if (isset($_GET['filtrarPorAnoCalendario'])) {
                    $filtroCalendario = " ed52_i_ano = {$ed52_i_ano}";
                }

                $where[] = $filtroCalendario;
                $where[] = "ed10_i_codigo = {$ed10_i_codigo}";
                $where[] = "ed57_i_codigo not in ({$turma})";
            } else {
                $where[] = "ed52_i_ano = {$ed52_i_ano}";
                $where[] = "ed10_i_codigo != {$ed10_i_codigo}";
            }
