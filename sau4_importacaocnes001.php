...
function hideWindowVinculos(lTemInconsistencia) {
...
function retornoProcessar( oRetorno, lErro ) {
  ...
  if( oRetorno.aCNES.length > 0 ) {
    ...
    var sConteudoWindowAux  = "<div>";
        ...
        sConteudoWindowAux += "      <input id='btnFechar' type='button' value='Fechar' onclick='hideWindowVinculos(lTemInconsistencia);'>";
    ...
    oWindowAuxVinculos.setShutDownFunction(function () {
        hideWindowVinculos(lTemInconsistencia);
    });
