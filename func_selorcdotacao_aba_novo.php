...
function atualizarPaginaParametros(aInstituicoes, lDesdobramento) {
  ...
  if (sInstituicoes != document.form1.db_selinstit.value) {
    ...
    location.href = "func_selorcdotacao_aba_novo.php?" + query;
  }
}
...
function js_atualiza_instit(){
  ...
  location.href='func_selorcdotacao_aba_novo.php?instit='+lista;
//  alert(lista);
}
  ...
  for(i=0;i<camada.length;i++){
    ...
    for(ii=0;ii<qcamada.length;ii++){
      if(qcamada[ii].checked==true){
        ...
        selecionados = selecionados + qcamada[ii].value + '-';
...
<!--      <input id="unidade" type="button" value="Unidade" onclick="js_marca_orgaos('unidade');return false" >
  ...
  <div id='div_orgao' style='visibility:hidden' >
     ...
     for($i=0;$i<$clorcdotacao->numrows;$i++){
       ...
       if (isset($orgaos_liberados[$o58_orgao])) {
            ...
            <!--<td align='right'><input type='checkbox' name='orgao_<?//=$o58_orgao?>' value='<?//=$o58_orgao?>'<?//=($porgao==$o58_orgao?"checked":"") ?> checked ></td> -->
                        <td align='right'><input type='checkbox' name='orgao' value='<?=$o58_orgao?>'<?=($porgao==$o58_orgao?"checked":"") ?> checked ></td>
	    ...
	    ?>
            <tr>
            <!--<td align='right'><input type='checkbox' name='orgao_<?//8=$o58_orgao?>' value='<?//=$o58_orgao?>'<?//=($porgao==$o58_orgao?"checked":"") ?> disabled ></td>-->
            <td align='right'><input type='checkbox' name='orgao' value='<?=$o58_orgao?>'<?=($porgao==$o58_orgao?"checked":"") ?> disabled ></td>
