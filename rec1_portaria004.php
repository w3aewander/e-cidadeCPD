    ...
    if (!$sqlerro) {
        ...
        if (isset($h31_sequencial) && trim(@$h31_sequencial)==""){
            ...
            if ($clportaria->erro_status == "0"){
                ...
                if($clportaria->h31_portaria != null && $clportaria->h31_status != null){
                    $clportaria->altera_status_portaria();
                }
            }
        }
...
<?php $GLOBALS["anula_revoga_portaria"] = true;?>
...
if(isset($incluir)){
    ...
    if ($sqlerro) {
        ...
        <script>
            ...
            js_consultaPortarias(js_incluiPortaria);

            function js_incluiPortaria(oAjax){
                console.log('inclui portaria');
