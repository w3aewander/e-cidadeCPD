...
class cl_db_relatoriousuario {
   ...
   public $db09_sequencial = 0;
   public $db09_db_relatorio = 0;
   public $db09_db_usuarios = 0;
   ...
   public function incluir ($db09_sequencial){
      $this->atualizacampos();
   ...
   public function alterar ($db09_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($db09_sequencial=null,$dbwhere=null) {
   ...
   public function sql_query ( $db09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $db09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
