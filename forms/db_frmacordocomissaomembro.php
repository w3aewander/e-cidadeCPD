...
$tipoComissao = 1;
if (db_getsession("DB_modulo") == 439) {
    $tipoComissao = 2;
}
$monstaQuadroLicitacon = $tipoComissao === 1 ? 'block' : 'none';
...
<form name="form1" method="post" enctype="multipart/form-data" id="membroForm">
    <div style="margin: 50px auto; width: 750px;">
        ...
        <fieldset style="display: <?=$monstaQuadroLicitacon?>">
...
<script>
    ...
    function js_init() {
        ...
        oGridMembrosComissao.setCellWidth(['70px',
            '70px',
            '280px',
            '200px',
            '80px']);

        oGridMembrosComissao.setCellAlign(["center",
            "center",
            "left",
            "left",
            "center"]
        );
        oGridMembrosComissao.setHeader(["Código",
            "Cgm",
            "Membro",
            "Responsabilidade",
            "Ação"]
