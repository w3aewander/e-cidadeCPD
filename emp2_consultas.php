...
$pdf->setfont('arial', 'b', 7);
$pdf->cell(279, $alt, "Movimentação", 0, 1, "C", 1);
$pdf->cell(30, $alt, "{$RLe60_vlremp}:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlremp, 'f'), 0, 0, "R", 0);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "{$RLe60_vlranu}:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlranu + 0, 'f'), 0, 0, "R", 0);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "{$RLe60_vlrliq}:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlrliq, 'f'), 0, 0, "R", 0);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "{$RLe60_vlrpag}:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlrpag, 'f'), 0, 1, "R", 0);
$pdf->ln(2);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(279, $alt, "Saldo a Pagar", 0, 1, "C", 1);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "Saldo empenhado a pagar:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlremp - $e60_vlranu - $e60_vlrpag, 'f'), 0, 0, "R", 0);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "Saldo liquidado a pagar:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar($e60_vlrliq - $e60_vlrpag, 'f'), 0, 0, "R", 0);

$pdf->setfont('arial', 'b', 7);
$pdf->cell(30, $alt, "Saldo a liquidar:", 0, 0, "L", 0);
$pdf->setfont('arial', '', 7);
$pdf->cell(30, $alt, db_formatar(($e60_vlremp - $e60_vlranu - $e60_vlrliq), 'f', ' ', 10), 0, 1, "R", 0);
$pdf->ln(2);
