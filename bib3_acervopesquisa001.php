...
require_once(modification("classes/db_autoracervo_classe.php"));
require_once(modification("classes/db_localexemplar_classe.php"));
...
<fieldset style="width:95%">
    <legend><b>Consulta de Acervo</b></legend>
    <table valign="top" marginwidth="0" width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td width="40%" align="center" valign="top">
                <table bgcolor="#f3f3f3" valign="top" marginwidth="0" width="100%" border="1" cellspacing="0"
                       cellpadding="0">
                    <tr>
                ...
                <table bgcolor="#f3f3f3" valign="top" marginwidth="0" width="100%" border="1" cellspacing="0"
                    ...
                    for ($x = 0; $x < $clexemplar->numrows; $x++) {
                        ...
                        <td>
                            ...
                            <br>
                            &nbsp;&nbsp;Situação: <?= $bi23_situacao == "S" ? "ATIVO" : "INATIVO" ?> &nbsp;&nbsp;
                              Aquisicao: <?= $bi04_forma ?>
                            <br>
                            &nbsp;&nbsp;Ano Edição: <?=$bi23_anoedicao?> &nbsp;&nbsp;&nbsp;&nbsp;
                              Edição: <?=$bi23_edicao?>
                            <br>
                            &nbsp;&nbsp;Empréstimo:
                            <?php
                            ...
                            if ($linhas1 == 0 || $bi23_situacao == 'N') {
                                ...
                                ?>
                                <a href="#" onclick="js_retornoExemplar('<?= $bi23_codigo ?>','<?= $bi06_titulo ?>','')"
                ...
                <table bgcolor="#f3f3f3" valign="top" marginwidth="0" width="100%" border="1" cellspacing="0"
                    ...
                    if ($linhas > 0) {
                        for ($x = 0; $x < $linhas; $x++) {
                            ...
                            <tr>
                                <td>
                                    &nbsp;&nbsp;Retirada:<?= db_formatar($bi18_retirada, 'd') ?> -
                                    Devolução:<?= db_formatar($bi18_devolucao, 'd') ?>
                                </td>
                            </tr>
                            <?php
                        }
