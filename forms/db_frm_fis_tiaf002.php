...
function js_pesquisay98_tiafdoc(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_tiaftipodoc','func_fis_tiaftipodoc.php?funcao_js=parent.js_mostratiafdoc1|y98_tiafdoc|y98_descr','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_tiaftipodoc','func_fis_tiaftipodoc.php?pesquisa_chave='+document.form1.y98_tiafdoc.value+'&funcao_js=parent.js_mostratiafdoc','Pesquisa',false);
  }
}
