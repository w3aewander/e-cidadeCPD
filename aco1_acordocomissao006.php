...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clacordocomissaomembro->excluir(null, "ac07_acordocomissao = " . $ac08_sequencial);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_acordocomissaomembro.location.href='aco1_acordocomissaomembro001.php?db_opcaoal=33&ac07_acordocomissao=".@$ac08_sequencial."';
     ";
         if(isset($liberaaba)){
