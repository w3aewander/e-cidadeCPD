 ...
 */
class CadastroBeneficio extends ProcessamentoAbstract implements ProcessamentoInterface
{
    /**
     * @var
     */
    ...
    public function processar()
    {
        ...
        $formatter = FormatterFactory::get(Tipo::S2410);
        ...
        foreach ($cadastroBeneficiario as $iIndice => $oDados) {
            $oEvento = new Evento(Tipo::S2410, $this->cgm, $oDados->referencia, $oDados);
