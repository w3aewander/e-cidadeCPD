...
/**
 * Arquivo 4.39
 * Class RelacionamentoLiquidacaoCodigoAgrupamentoFolhaPagamento
 * @package ECidade\Financeiro\Contabilidade\Sagres\V2022
 */
class RelacionamentoLiquidacaoCodigoAgrupamentoFolhaPagamento extends OutrosArquivosSagresFiscal
{
    const TAG = 'RelacionamentoLiquidacaoCodigoAgrupamentoFolhaPagamento';
