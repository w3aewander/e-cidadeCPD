 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_disbanco.location.href='cai1_disbanco001.php?k34_sequencial=".@$k34_sequencial."&k35_disbancotxt=".@$k34_sequencial."';
     ";
         if(isset($liberaaba)){
