...
function js_emite(){
  ...
  jan = window.open('fis2_fis_relnotific002.php?setorfiscal='+obj.setorfiscal.value+'&dt_ini='+dt_ini+'&dt_fin='+dt_fin+'&dt_prazo='+dt_prazo+'<?=$getIntimacao?>','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
</script>  
	...
	<?php   /**************************************************************************************/
	    ...
	    $select[0] = "(todos setores)";
            ...
            $resultTipoFiscaliza = pg_query("SELECT coddepto, descrdepto 
						                                   FROM db_depart 
           				                                  OUTTER join fiscalizacao.fis_fiscal ON coddepto = y30_setor
