...
class cl_lab_medico {
   ...
   public $la38_i_codigo = 0;
   public $la38_i_medico = 0;
   public $la38_i_requisicao = 0;
   ...
   public function incluir ($la38_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($la38_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($la38_i_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $la38_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $la38_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_medico_fora_rede ( $la38_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
