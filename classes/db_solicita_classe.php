...
class cl_solicita
{
    ...
    var $campos = "
                 ...
                 pc10_processado = bool = Processado
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->pc10_processado = ($this->pc10_processado == "f" ? @$GLOBALS["HTTP_POST_VARS"]["pc10_processado"] : $this->pc10_processado);
        } else {
            $this->pc10_numero = ($this->pc10_numero == "" ? @$GLOBALS["HTTP_POST_VARS"]["pc10_numero"] : $this->pc10_numero);
        }
    }
    ...
    public function incluir($pc10_numero = null)
    {
        $this->atualizacampos();
    ...
    public function alterar($pc10_numero = null)
    {
        $this->atualizacampos();
        ...
        if (trim($this->pc10_processado) != "" || isset($GLOBALS["HTTP_POST_VARS"]["pc10_processado"])) {
            $sql .= $virgula . " pc10_processado = '$this->pc10_processado' ";
            $virgula = ",";
            if (trim($this->pc10_processado) == null) {
                $this->erro_sql = " Campo Processado nao Informado.";
                $this->erro_campo = "pc10_processado";
                $this->erro_banco = "";
                $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "0";
    ...
    public function excluir($pc10_numero = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
...
//     $sql .= "      inner join db_config  on  db_config.codigo = solicita.pc10_instit";
    ...
    public function sql_query_estregistro($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
...
//     $sql .= "      inner join db_config  on  db_config.codigo = solicita.pc10_instit";
    ...
    public function sql_query_andsol($campos = "*", $dbwhere = "")
    {
 ...
 from ( select pc11_numero,
    ...
    public function sql_query_file($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_func($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_numero_solicita($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_estregistrosemquantidade($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_prot($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_rel($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_reserv($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_solicita($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_tipo($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_solprot($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_estimativa($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
...
//     $sql .= "      inner join db_config     on  db_config.codigo = solicita.pc10_instit";
    ...
    public function sql_query_solicitaanulada($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_compilacao($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "", $lVerificaVinculos = false)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_licitacao_dotacao($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
...
//     $sql .= "      inner join db_config  on  db_config.codigo = solicita.pc10_instit";
     ...
     * @return string
     */
    public function sql_query_processo_orcamento($sCampos = "*", $sOrdem = null, $sWhere = null)
    {
    ...
    public function sql_query_consulta($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= " LEFT  JOIN solicitatipo         ON solicitatipo.pc12_numero = solicita.pc10_numero ";
        $sql .= " LEFT  JOIN pctipocompra         ON solicitatipo.pc12_tipo = pc50_codcom";
    ...
    public function sql_query_liberadas($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_tipocompra($pc10_numero = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_estimativa_por_compilacao($codigoCompilacao = null,$campos = "*",$where="")
    {
        $sql = " select $campos ";
        $sql .= "   from solicita comp ";
        $sql .= "        inner join solicitavinculo on pc53_solicitafilho = comp.pc10_numero ";
        $sql .= "        inner join solicita aber on pc53_solicitapai = aber.pc10_numero ";
        $sql .= "        inner join solicitem item_aber on item_aber.pc11_numero = aber.pc10_numero ";
        $sql .= "        inner join solicitemvinculo on pc55_solicitempai = item_aber.pc11_codigo ";
        $sql .= "        inner join solicitem item_esti on item_esti.pc11_codigo = pc55_solicitemfilho ";
        $sql .= "        inner join solicitempcmater ON pc16_solicitem = item_esti.pc11_codigo ";

        $sql .= "  where comp.pc10_numero = {$codigoCompilacao} $where";

        return $sql;
    }

    public function possuiFornecedorSugerido($numeroSolicitacao)
    {
        $sSql = "
            SELECT
            ...
            FROM
                pcsugforn
            WHERE
                pc40_solic = {$numeroSolicitacao}
        ";

        $oPostgresResourse = db_query($sSql);
        $rs = pg_fetch_assoc($oPostgresResourse);

        return $rs['total_fornecedores'] > 0 ? true : false;
    }
}
