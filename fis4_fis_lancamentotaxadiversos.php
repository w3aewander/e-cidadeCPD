...
if(isset($oGet->codigo) && !empty($oGet->codigo)) {
  ...
  $oLancamentoAlterar   = FisLancamentoTaxaDiversosRepository::getInstanciaPorCodigo($oGet->codigo);
...
<div class="container">
  <form method="POST" id="formLancamentoTaxa" action="fis4_fis_lancamentotaxadiversos_processamento.php">
    ...
    <input type="button" value="Novo"          id="btnNovo"      onclick="location.href='fis4_fis_lancamentotaxadiversos.php'" style='display:none'>
...
<script type="text/javascript">
  ...
  var oAncoraTaxa = new DBLookUp( $('lbl_taxa'),
    ...
    $('taxa_natureza'),
    {
      sArquivo  : 'func_fis_taxadiversos.php',
  ...
  function pesquisar () {
    ...
    var sQueryStringJanelaPesquisa  = 'func_fis_lancamentotaxadiversos.php';
  ...
  function js_retornoPesquisar(y120_sequencial, y120_cgm, y120_taxadiversos, y120_unidade, y120_datafim, z01_nome, y119_natureza, y120_periodo, y120_datainicio, y120_issbase, dv05_obs, taxa_tem_calculo) {
    ...
    var sBbloqueia    = 'cgm';
    var sUrlRedirect  = 'fis4_fis_lancamentotaxadiversos.php?';
  ...
  function getConfiguracoesTaxa () {
    ...
    if($F('taxa')) {
      ...
      AjaxRequest.create( 'fis1_fis_taxadiversos.RPC.php',
        {
    ...
    if(codigo) {
      ...
      AjaxRequest.create(
        ...
        function (retorno) {
          ...
          location.href = 'fis4_fis_lancamentotaxadiversos.php';
        }
