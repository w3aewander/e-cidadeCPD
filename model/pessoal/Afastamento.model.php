...
class Afastamento
{
  ...
  const AFASTADO_PRORROGACAO_MATERNIDADE = 9;
  const AFASTADO_CUIDAR_FAMILIAR = 10;
  const LICENCA_PREMIO = 11;

    /**
     * Quantidade de dias afastado que o servidor continuara recebendo o salario
     */
  const QUANTIDADE_DIAS_RECEBE_FAMILIAR = 60;
