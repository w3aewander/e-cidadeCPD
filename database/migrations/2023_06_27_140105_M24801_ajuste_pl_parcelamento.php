...
class M24801AjustePlParcelamento extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        declare
          ...
          begin
            ...
            -- ajustado separacao de juros e multas pelo parametro k40_separajuremul ligado a
            --propria regra de parcelamento utilizada
            select
              case
                when (k40_separajuremul or k40_separajuremul = 't')
                  then 1 
                  else 2
                end as k40_separajuremul
              into lSeparaJuroMulta
            from cadtipoparc
            where k40_codigo::integer = v_desconto::integer;
