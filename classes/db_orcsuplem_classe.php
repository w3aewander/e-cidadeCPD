...
class cl_orcsuplem {
  ...
  public function sql_query_suplementacoes_receita ( $o46_codsup=null,$campos="*",$ordem=null,$dbwhere="",$groupBy =null){
    ...
    $sql  = "select {$campos}
      ...
      inner join orcreceita on o70_codrec = o85_codrec
                           and o70_anousu = o85_anousu
  ...
  public function sql_query_suplementacoes_receita_modificado ( $o46_codsup=null,$campos="*",$ordem=null,$dbwhere="",$groupBy =null){
  ...
  public function sql_query_suplementacoes_despesa ( $o46_codsup=null,$campos="*",$ordem=null,$dbwhere=""){

    $sql  = "select $campos
            from orcsuplem
      inner join orcsuplemtipo  on o48_tiposup = o46_tiposup
      inner join orcprojeto on o39_codproj = o46_codlei
      ...
      inner join conplanoorcamento on conplanoorcamento.c60_anousu = o58_anousu
      ...
      inner join planodespesa on planodespesa.id = planodespesa_id
                             and planodespesa.exercicio = o58_anousu
                             and planodespesa.uniao = 't'
  ...
  public function sql_query_suplementacoes_despesaSigfis ( $o46_codsup=null,$campos="*",$ordem=null,$dbwhere=""){
