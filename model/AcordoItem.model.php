...
class AcordoItem
{
    ...
    /**
     * Numero da Posição do Acordo
     * @var integer
     */
    protected $iNumeroPosicao;
    ...
    public function __construct($iCodigoItem = null)
    {
        if (!empty($iCodigoItem) != null) {
            ...
            $sCamposItens .= "case                                                      ";
            $sCamposItens .= "  when solicitem_licitacao.pc11_servicoquantidade is not null ";
            $sCamposItens .= "	   then                                                 ";
            $sCamposItens .= "       solicitem_licitacao.pc11_servicoquantidade           ";
            $sCamposItens .= "	   else                                                 ";
            $sCamposItens .= "       case                                               ";
            $sCamposItens .= "       when solicitem_compras.pc11_servicoquantidade is null";
            $sCamposItens .= "       then";
            $sCamposItens .= "         ac20_servicoquantidade                               ";
            $sCamposItens .= "       else                                                   ";
            $sCamposItens .= "         solicitem_compras.pc11_servicoquantidade           ";
            $sCamposItens .= "       end                                                    ";
            $sCamposItens .= "end  as pc11_servicoquantidade                                ";

            $sSqlAcordoitem = $oDaoAcordoItem->sql_query_completo(null, $sCamposItens, null,
              "ac20_sequencial = $iCodigoItem");
    ...
    /**
     * @param bool $semReservaDotacao
     * @return array|stdClass[]
     * @throws Exception
     */
    public function getDotacoes($semReservaDotacao = false)
    {
        if (count($this->aDotacoes) == 0) {
            ...
            $campos = "ac22_coddot as dotacao, {$sSqlSomaExecucao} ac22_quantidade as quantidade";
            $campos .= ", ac22_sequencial  as codigodotacaoitem, ac22_valor as valor, o84_orcreserva as reserva";
            $campos .= ", o80_valor as valorreserva, ac22_anousu as ano, o15_complemento as complemento";

            $where = "ac22_acordoitem = {$this->getCodigo()}";

            if ($semReservaDotacao === true) {
                $where .= " and o84_sequencial is null ";
            }

            $sSqlDotacoes = $oDaoAcordoItemDotacao->sql_query_reserva(null, $campos, "ac22_coddot", $where);
    ...
    public function removerDotacao($iDotacao = '')
    {
        if ($iDotacao == '') {
            ...
            if ($iChaveExcluir != null || $iChaveExcluir == 0) {
                array_splice($this->aDotacoes, $iChaveExcluir, 1);
            }
        }
    }
    ...
    public function save($lReservarSaldo = true)
    {
        ...
        $oDaoAcordoItem->ac20_servicoquantidade = $this->getControlaQuantidade();
        ...
        if ($this->getCodigo() != "") {
            ...
            if ($this->iCodigoItemLicitacao != "") {
                $oDaoVinculoLicitacao = new cl_acordoliclicitem();
            ...
            if ($this->iCodigoItemProcesso != "") {
                $oDaoVinculoProcesso = new cl_acordopcprocitem();
        ...
        if (!empty($this->iCodigoItemEmpenho)) {
            $oDaoVinculoProcesso = new cl_acordoempempitem();
        ...
        $oDaoAcordoItemVinculo = new cl_acordoitemvinculo();
         ...
         */
        $oDaoAcordoItemDotacaoReserva = new cl_orcreservaacordoitemdotacao();
        ...
        if ($this->getCodigo() != '') {
                ...
                switch ($this->getTipocontrole()) {
                    case 2:
                        ...
                        */
                        ...
                        $sSqlBuscaPrevisaoItem = $oDaoAcordoItemPrevisao->sql_query_file(null, "*", null,
                          $sWhereExistenciaItemPrevisao);
                        ...
                        $oDaoAcordoItemPrevisao->ac37_valor = "" . (round($oPeriodoExecucao->quantidade * $this->getValorTotal(),
                            2)) / $nQuantidadeTotal . "";
                        break;
                    ...
                    default:
                        $oDaoAcordoItemPrevisao->ac37_valor = "" . round(($oPeriodoExecucao->quantidade * $this->getValorUnitario()),
                            2) . "";
            ...
            if ($nTotalSemRound > $nTotalComRound) {
                $oAcordoItemPrevisao = new cl_AcordoItemPrevisao();
     ...
     * @return stdClass - Objeto com a origem do item ->tipo:tipo da origem ->codigo: codigo da origem
    ...
    public function remover()
    {
        ...
        $oDaoVinculoLicitacao = new cl_acordoliclicitem();
        $oDaoVinculoProcesso = new cl_acordopcprocitem();
        $oDaoItemPeriodo = new cl_acordoitemperiodo();
        $oDaoItemEmpenho = new cl_acordoempempitem();
        $oDaoItemExecutado = new cl_acordoitemexecutado();
        $oDaoItemExecutadoDot = new cl_acordoitemexecutadodotacao();
        $oDaoItemExecutadoAut = new cl_acordoitemexecutadoempautitem();
        ...
        $sSqlItemDotacao = $oDaoAcordoItemDotacao->sql_query_file(null, "*", null,
          "ac22_acordoitem = {$this->getCodigo()}");
        ...
        if ($oDaoAcordoItemDotacao->numrows > 0) {
            ...
            $sSqlBuscaReserva = $oDaoOrcreservaAcordoItemDotacao->sql_query_file(null, "distinct o84_orcreserva", null,
              "o84_acordoitemdotacao = {$iItemDotacao}");
         ...
         */
        $sSqlExecucoes = $oDaoItemExecutado->sql_query_file(null, "ac29_sequencial", null,
          "ac29_acordoitem = {$this->getCodigo()}");
    ...
    {
        $oDaoReserva = new cl_orcreserva();
        $oDaoReservaContrato = new cl_orcreservaacordoitemdotacao();
     ...
     * @throws Exception
     */
    public function baixarMovimentacaoManual(
      $oPeriodo,
      $iTipo,
      $nQuantidade,
      $nValor,
      $lRecalculaValor = true,
      $sNotaFiscal = null,
      ...
      $sObservacao = null
        ...
        if ((round($nQuantidade, 2) > round($oDadosPeriodo->saldo,
              2)) && $this->getTipocontrole() != self::CONTROLE_VALOR && $this->getTipocontrole() != self::CONTROLE_QUANTIDADE) {

            $sMsg = "Quantidades para o período {$oDadosPeriodo->descricao} já executadas! {$nQuantidade} round " . round($oDadosPeriodo->saldo,
                2);
            throw new Exception($sMsg);
        }

        $oDaoAcordoItemExecutadoPeriodo = new cl_acordoitemexecutadoperiodo();
        ...
        if ($lRecalculaValor) {
            if ($this->getTipoControle() == 2 || $this->getTipoControle() == self::CONTROLE_DIVISAO_VALOR) {
                ...
                if ($this->getTipoControle() == self::CONTROLE_VALOR) {
        ...
        if ($nValor > 0) {
            ...
            $oDaoAcordoItemExecutadoEmpenho = new cl_acordoitemexecutadoempenho();
    ...
    public function excluirMovimentacaoManual($iPeriodo, $iCodigoExecucao)
    {
         ...
         */
        $oDaoAcordoItemExecutadoEmpenho = new cl_acordoitemexecutadoempenho();
        $oDaoAcordoItemExecutadoEmpenho->excluir(null,
          "ac39_acordoitemexecutadoperiodo = {$oDadosExecucao->ac38_sequencial}");
            ...
            foreach ($aPeriodos as $oDados) {
                ...
                switch ($this->getTipocontrole()) {
                    case self::CONTROLE_DIVISAO_VALOR:
                        $nValor = round(($oDados->quantidade_executada * $this->getValorTotal()) / $nQuantidadeTotal,
                          2);
                        break;
    ...
    public function setPeriodosExecucao($iAcordo, $lPeriodoComercial = false, $iTipoAditamento = null)
    {
        ...
        foreach ($aPeriodosItem as $iIndicePeriodo => $oPeriodo) {
            ...
            $iDiferencaPeriodo = AcordoPosicao::calculaDiferencaMeses($iAcordo, $oPeriodo->dtDataInicial,
              $oPeriodo->dtDataFinal);
            $oDaoAcordoPosicao = new cl_acordoposicaoperiodo();
     ...
     * @return AcordoItemPrevisao[]|array
     * @throws Exception
     */
    ...
    /**
     * @param $sDescricaoEstruturalElemento
     * @return $this
     */
    ...
    public function moverPrevisaoPeriodo($iPeriodoOrigem, $iPeriodoDestino)
    {
        ...
        $oDaoAcordoItemPrevisaoOrigem = new cl_acordoitemprevisao();
        $oDaoAcordoItemPrevisaoDestino = new cl_acordoitemprevisao();
        $oDaoItemExecutadoPeriodo = new cl_acordoitemexecutadoperiodo();
        ...
        $sSqlAcordoPrevisaoOrigem = $oDaoAcordoItemPrevisaoOrigem->sql_query(null, "*", null,
          $sWhereAcordoPrevisaoOrigem);
        ...
        $sSqlAcordoPrevisaoDestino = $oDaoAcordoItemPrevisaoDestino->sql_query_file(null, "*", null,
          $sWhereAcordoPrevisaoDestino);
         ...
         */
        $sSqlBuscaExecutadoDestino = $oDaoItemExecutadoPeriodo->sql_query_file(null, "*", null,
          "ac38_acordoitemprevisao = {$oAcordoPrevisaoOrigem->ac37_sequencial}");
    ...
    public function getExecucoes()
    {
        ...
        $sSqlExecucoes = $oDaoExecucoes->sql_query(null, "acordoitemexecutado.*", "ac29_datainicial, ac29_datafinal",
          $sWhere);
    ...
    private function getValoresAtualizados()
    {
        ...
        $sCampos = "coalesce(sum(ac20_quantidade), 0) as quantidade,";
        $sCampos .= "coalesce(sum(ac20_valortotal),0) as valortotal,";
        $sCampos .= "coalesce(sum(case when ac26_numero >= {$iNumeroAditamento} then ac20_quantidade else 0 end),0) as quantidadetotalrenovacao,";
        $sCampos .= "coalesce(sum(case when ac26_numero >= {$iNumeroAditamento} then ac20_valortotal else 0 end),0) as valortotalrenovacao";
        $sWhere = "ac16_sequencial = {$this->getPosicao()->getAcordo()} and ac20_ordem = {$this->getOrdem()} and ac20_valortotal <> 0 group by ac20_sequencial";
        $sOrdem = "ac20_sequencial desc limit 1";
        $sSqlItens = $oDaoAcordoitem->sql_query_transparencia($sCampos, $sOrdem, $sWhere);
        $rsItem = $oDaoAcordoitem->sql_record($sSqlItens);
     ...
     */
    public function setICodigoItemLicitacao($iCodigoItemLicitacao)
    {
        $this->iCodigoItemLicitacao = $iCodigoItemLicitacao;
    }

    /**
     * @return int
     */
    public function getICodigoItemLicitacao()
    {
        return $this->iCodigoItemLicitacao;
    }
}
