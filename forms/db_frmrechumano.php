        ...
        <table border="0" width="100%">
          <tr>
            ...
            <td>
              ...
              db_input( 'z01_nomecomple',          50, @$z01_nomecomple,           true, 'text', 3 );
              if(!empty($z04_nomesocial) && $z04_nomesocial != ""){
                  echo @$Lz04_nomesocial;
                  db_input( 'z04_nomesocial',          50, @$z04_nomesocial,           true, 'text', 3 );
              }
              ?>
            </td>
          </tr>
            ...
            <fieldset>
                ...
                <table>
                    ...
                    if( isset( $ed20_i_tiposervidor ) && $ed20_i_tiposervidor == 1 ) {
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                ...
                                db_input( 'z01_nomecomple',    33, $Iz01_nomecomple,    true, 'text', 3 );
                                ?>
                            </td>
                        </tr>
                        <?php
                    ...
                    <tr>
                        ...
                        <td nowrap title="<?=$Ted20_tipoensinomedio?>" id="labelTipoensinomedio">
                            <?=$Led20_tipoensinomedio?>
                        </td>
                        <td>
                            <?php
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            db_selectrecord("ed20_i_censoufnat", $rsResultUF, "", "", "", "", "", "  ", "", 1);
                            ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            ?>
                            <iframe name="ed20_i_censomunicnat" src="" framedorder="0" width="0" height="0" style="visibility:hidden;position:absolute;"></iframe>
                        </td>
                    </tr>
                </table>
            </fieldset>
                    ...
                    <table border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $sSqlUF = $clcensouf->sql_query_file("", "ed260_i_codigo, ed260_c_nome", "ed260_c_nome");
                                $rsResultUF = $clcensouf->sql_record($sSqlUF);
                                db_selectrecord("ed20_i_censoufender", $rsResultUF, "", "", "", "", "", "  ", "", 1);
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <iframe name="ed20_i_censomunicender" src="" framedorder="0" width="0" height="0" style="visibility:hidden;position:absolute;"></iframe>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td nowrap title="<?=$Ted20_paisresidencia?>">
                                <?=$Led20_paisresidencia?>
                            </td>
                            <td>
                                <?php
                                $x = array( '' => '',
                        ...
                        <tr>
                            <td nowrap title="<?=$Ted20_localizacaodiferenciada?>" id="labelLocalizacaodiferenciada">
                                <?=$Led20_localizacaodiferenciada?>
                            </td>
                            <td>
                                <?php
...
<script>
    ...
    (function(){
        js_validaPaisResidenciaOutrasInformacoes($F('ed20_paisresidencia'));
        js_validaEscolaridade($F('ed20_i_escolaridade'));
    })();
    ...
    $('ed20_paisresidencia').addEventListener('change', function(){
        js_validaPaisResidenciaOutrasInformacoes(this.value)
    });
    $('ed20_i_escolaridade').addEventListener('change', function(){
        js_validaEscolaridade(this.value)
    });
    ...
    var elementUFEnd = document.getElementById('ed20_i_censoufender');
    var elementUFNat = document.getElementById('ed20_i_censoufnat');

    elementUFEnd.addEventListener('change', function (event) {
        carregarMunicipios(event.target.value, 'ed20_i_censomunicender');
    });

    elementUFNat.addEventListener('change', function (event) {
        carregarMunicipios(event.target.value, 'ed20_i_censomunicnat');
    });
    ...
    function js_valida() {
        ...
        if (empty($F('ed20_paisresidencia').trim())) {
            alert('Selecione um  País de Residência.');
            return false
        }
    ...
    function js_pesquisaed20_i_codigo(mostra) {
        ...
        js_OpenJanelaIframe('','db_iframe_rhpessoal','func_rhpessoaleducacao.php?funcao_js=parent.js_mostrarhpessoal1|'+
            'rh01_regist|z01_nomecomple|z04_nomesocial','Pesquisa de Funcionários na Prefeitura',true);
    }
    ...
    function js_pesquisaz01_numcgm(mostra) {
        ...
        js_OpenJanelaIframe('','func_nome','func_cgmrechumano.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nomecomple|z04_nomesocial',
    ...
    function js_tiposervidor(tipo) {
        ...
        document.form1.z01_nomecomple[0].value       = "";
        document.form1.z01_nomecomple[1].value       = "";
        document.form1.z04_nomesocial[0].value       = "";
    ...
    function js_validaEscolaridade(valor) {
        document.getElementById("labelTipoensinomedio").style.visibility = "visible"
        document.getElementById("ed20_tipoensinomedio").style.visibility = "visible"

        if (!['5', '6'].in_array($F('ed20_i_escolaridade'))) {
            document.getElementById("labelTipoensinomedio").style.visibility = "hidden"
            document.getElementById("ed20_tipoensinomedio").style.visibility = "hidden"
        }
    }

    function js_validaPaisResidenciaOutrasInformacoes(valor) {
        document.getElementById("labelLocalizacaodiferenciada").style.visibility = "visible"
        document.getElementById("ed20_localizacaodiferenciada").style.visibility = "visible"
        if ($F('ed20_paisresidencia') !==  '10'){
            document.getElementById("labelLocalizacaodiferenciada").style.visibility = "hidden"
            document.getElementById("ed20_localizacaodiferenciada").style.visibility = "hidden"
        }
    }
