...
require_once(modification("classes/db_obrastecnicos_classe.php"));
...
function js_mostracgm(){
    ...
    func_nome.jan.location.href = 'prot3_consultacgmnovo002.php?fechar=func_nome&numcgm=<?php echo $oTecnicos->ob15_numcgm; ?>';
    func_nome.mostraMsg();
    func_nome.show();
    func_nome.focus();
}
