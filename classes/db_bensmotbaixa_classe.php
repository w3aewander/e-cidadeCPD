...
class cl_bensmotbaixa
{
    ...
    function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->t51_anexoobrigatorio = ($this->t51_anexoobrigatorio == "" ? @$GLOBALS["HTTP_POST_VARS"]["t51_anexoobrigatorio"] : $this->t51_anexoobrigatorio);
        } else {
            $this->t51_motivo = ($this->t51_motivo == "" ? @$GLOBALS["HTTP_POST_VARS"]["t51_motivo"] : $this->t51_motivo);
        }
    }
    ...
    function incluir($t51_motivo)
    {
        ...
        $sql = "insert into bensmotbaixa(
                                       t51_motivo 
                                      ,t51_descr 
                                      ,t51_anexoobrigatorio 
                       )
                values (
                                $this->t51_motivo 
                               ,'$this->t51_descr' 
                               ,'$this->t51_anexoobrigatorio' 
                      )";
        $result = db_query($sql);
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
