...
class cl_matestoqueitemnota {
   ...
   public function incluir ($m74_codmatestoqueitem,$m74_codempnota){
      $this->atualizacampos();
   ...
   public function alterar ($m74_codmatestoqueitem=null,$m74_codempnota=null) {
      $this->atualizacampos();
   ...
   public function excluir ($m74_codmatestoqueitem=null,$m74_codempnota=null,$dbwhere=null) {
   ...
   public function sql_query ( $m74_codmatestoqueitem=null,$m74_codempnota=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $m74_codmatestoqueitem=null,$m74_codempnota=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_itens ( $m74_codmatestoqueitem=null,$m74_codempnota=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_itensunid ( $m74_codmatestoqueitem=null,$m74_codempnota=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
