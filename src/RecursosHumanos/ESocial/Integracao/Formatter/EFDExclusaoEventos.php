 ...
 */
class EFDExclusaoEventos extends Formatter
{
    ...
    public function formatar($dados)
    {
        ...
        $dadosFormatado = array_map(function ($dadoFormatado) use ($dados) {

            array_map(function ($dado) use ($dadoFormatado) {
                if ($dadoFormatado->referencia == $dado->responsavel) {
                    $dadoFormatado->data = $dado->dadosPreenchimento->data;
                }
            }, $dados);
