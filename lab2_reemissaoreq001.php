...
if (isset($chavepesquisa)) {
    ...
    $sSql = $cllab_requisicao->sql_query_requiitem(
        "",
        "lab_requiitem.*,lab_exame.*,lab_laboratorio.*",
        "",
    ...
    $result = $cllab_medico->sql_record(
        $cllab_medico->sql_query(
            "",
            " la38_i_medico,z01_nome as  la22_c_medico,sd03_i_crm ",
            "",
            " la38_i_requisicao = $chavepesquisa "
        )
    );
