...
class cl_fis_fiscalusuario {
   ...
   public $y38_codnoti = 0;
   public $y38_id_usuario = 0;
   public $y38_obs = null;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalusuario");
...
public function incluir ($y38_codnoti,$y38_id_usuario){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalusuario(
                                       y38_codnoti
                                      ,y38_id_usuario
                                      ,y38_obs
                       )
...
public function alterar ($y38_codnoti=null,$y38_id_usuario=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalusuario set ";
     $virgula = "";
...
public function excluir ($y38_codnoti=null,$y38_id_usuario=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalusuario
                    where ";
     $sql2 = "";
...
public function sql_query ( $y38_codnoti=null,$y38_id_usuario=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalusuario ";
     $sql .= "      inner join db_usuarios  on  db_usuarios.id_usuario = fis_fiscalusuario.y38_id_usuario";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalusuario.y38_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y38_codnoti!=null ){
         $sql2 .= " where fis_fiscalusuario.y38_codnoti = $y38_codnoti ";
       }
       if($y38_id_usuario!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fiscalusuario.y38_id_usuario = $y38_id_usuario ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y38_codnoti=null,$y38_id_usuario=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
