...
/**
 * Arquivo 4.37
 * Class RelacionamentoEmpenhoObra
 * @package ECidade\Financeiro\Contabilidade\Sagres\V2022
 */
class RelacionamentoEmpenhoObra extends OutrosArquivosSagresFiscal
{
    const TAG = 'RelacionamentoEmpenhoObra';

    protected $colunasTemplate = [
        'codUnidadeGestora',
        'codUnidadeOrcamentaria',
        'numEmpenho',
        'codUnidadeGestoraObra',
        'numObra',
        'reservado',
    ];
