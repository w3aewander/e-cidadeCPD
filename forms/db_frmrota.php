...
<table border="0">
 ...
 <tr>
  <td nowrap title="<?=@$Ted217_c_descr?>">
   <?=@$Led217_c_descr?>
  </td>
  <td>
...
function js_pesquisa(){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rota','func_rota.php?funcao_js=parent.js_preenchepesquisa|ed217_i_codigo','Pesquisa',true);
}
