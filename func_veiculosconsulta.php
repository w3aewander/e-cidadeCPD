    ...
    <td height="63" align="center" valign="top">
      <table width="35%" border="0" align="center" cellspacing="0">
        <form name="form1" method="post" action="">
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo  $Tve01_codigo ?>">
                <?php echo  $Lve01_codigo ?>
            </td>
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo  $Tve01_placa ?>">
                <?php echo  $Lve01_placa ?>
            </td>
            <td width="96%" align="left" nowrap>
                <?php
          ...
          <tr>
            <td nowrap align="right" title="<?php echo  $Tve37_veiccadcentral ?>"><?php echo  $Lve37_veiccadcentral ?></td>
            <td nowrap align="left">
                <?php
                $sql = $clveiccadcentral->sql_query(null, "ve36_sequencial,descrdepto" , null, "");
                $res_veiccadcentral = $clveiccadcentral->sql_record($sql);
    ...
    <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
            ...
            if (isset($chave_ve01_codigo) && (trim($chave_ve01_codigo) != "")) {
                $sql = $clveiculos->sql_query($chave_ve01_codigo, $campos, "ve01_codigo",
                  "ve01_codigo=$chave_ve01_codigo and instit = {$iInstituicao} ");
            } else {
                if (isset($chave_ve01_placa) && (trim($chave_ve01_placa) != "")) {
                    $sql = $clveiculos->sql_query("", $campos, "ve01_placa",
                      " trim(ve01_placa) like '$chave_ve01_placa%' and instit = {$iInstituicao} ");
                } else {
            ...
            if ($pesquisa_chave != null && $pesquisa_chave != "") {
                ...
                $result = $clveiculos->sql_record($clveiculos->sql_query($pesquisa_chave, "*", null,
                  "ve01_codigo=$pesquisa_chave $where and instit = {$iInstituicao} "));
