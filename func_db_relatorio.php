...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      if (isset($relatoriosPortaria) && $relatoriosPortaria) {
          $sWhere .= ' and exists(select 1 from portariatipodocindividual where h37_modportariaindividual = db_relatorio.db63_sequencial) ';
      }
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_db_relatorio.php")==true){
             include(modification("funcoes/db_func_db_relatorio.php"));
           }else{
           $campos = "db_relatorio.*";
           }
        }
