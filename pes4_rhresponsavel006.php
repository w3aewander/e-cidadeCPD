...
require_once(modification("classes/db_rhresponsavel_classe.php"));
require_once(modification("classes/db_rhresponsavelregist_classe.php"));
...
if (isset($oGet->chavepesquisa)) {
  ...
  echo "   (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_rhresponsavelregist.location.href   = 'pes4_rhresponsavelregist001.php?rh107_sequencial={$rh107_sequencial}';";
