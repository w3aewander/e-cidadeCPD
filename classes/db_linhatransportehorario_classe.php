...
class cl_linhatransportehorario
{
   // cria variaveis de erro 
    ...
    public $tre07_sequencial = 0; 
    public $tre07_linhatransporteitinerario = 0; 
    public $tre07_horasaida = null; 
    public $tre07_horachegada = null; 
   // cria propriedade com as variaveis do arquivo 
    ...
    public function incluir($tre07_sequencial)
    {
      $this->atualizacampos();
     ...
     if($this->tre07_horasaida == null ){ 
       $this->erro_sql = " Campo Hora de Saída não informado.";
     ...
     if($tre07_sequencial == "" || $tre07_sequencial == null ){
      ...
      if(($result != false) && (pg_result($result,0,0) < $tre07_sequencial)){
        $this->erro_sql = " Campo tre07_sequencial maior que ltimo nmero da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Linha de Transporte Horário ($this->tre07_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    public function alterar($tre07_sequencial=null)
    {
      $this->atualizacampos();
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Linha de Transporte Horário não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->tre07_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Linha de Transporte Horário não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->tre07_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function excluir($tre07_sequencial=null, $dbwhere = null)
    {
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Linha de Transporte Horário não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Linha de Transporte Horário não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$tre07_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function sql_query($tre07_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 
    ...
    public function sql_query_file($tre07_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
