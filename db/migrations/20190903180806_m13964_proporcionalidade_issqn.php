...
class M13964ProporcionalidadeIssqn extends PostgresMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $this->execute(<<<SQL
            ...
            drop function fc_issqn_proporcionalidade(numeric,char(1),date,date,integer,date) cascade;

            drop   type tp_issqn_proporcionalidade cascade;
            create type tp_issqn_proporcionalidade as ( rnValorProporcional      numeric,
                                                        rsTipoProporcionalidade  varchar );
            ...
            begin
              ...
              -- se o ano do calculo é o mesmo, e senão a variavel recebe 12, para que a proporcionalidade fique correta;
              -- ocorria erro por exemplo se a data inicial for 10/09/2011 e a data final fosse 10/09/2012 numa inscricao provisoria
              -- e o ano do cálculo for 2011, o sistema calculava 1 mes ao inves de 4 de proporcionalidade, justamente porque
