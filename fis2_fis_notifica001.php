...
function js_mandadados(){
  if(document.form1.y30_codnoti.value == ""){
   ...
   jan = window.open('fis2_fis_notifica002.php?codfiscal='+document.form1.y30_codnoti.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
   jan.moveTo(0,0);
  }
}
...
function js_codfiscal(mostra){
    if(mostra==true){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscalalt.php?funcao_js=parent.js_mostracodfiscal1|y30_codnoti|z01_nome','Pesquisa',true);
    }else{
      y30_codnoti = document.form1.y30_codnoti.value;
      if(y30_codnoti!=""){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscalalt.php?pesquisa_chave='+y30_codnoti+'&funcao_js=parent.js_mostracodfiscal','Pesquisa',false);
      }else{
