  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiaf','func_fis_tiaf.php?funcao_js=parent.js_mostratiaf1|y90_codtiaf|y90_codtiaf','Pesquisa',true);
     ...
     if(document.form1.y96_codtiaf.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiaf','func_fis_tiaf.php?pesquisa_chave='+document.form1.y96_codtiaf.value+'&funcao_js=parent.js_mostratiaf','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafprazo','func_fis_tiafprazo.php?funcao_js=parent.js_preenchepesquisa|y96_codigo','Pesquisa',true);
}
