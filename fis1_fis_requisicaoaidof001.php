...
require_once(modification("classes/db_fis_requisicaoaidof_classe.php"));
...
<html>
  ...
  <body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" >
    <form name="form1" action="fis4_fis_aidof004.php" class="container" method="get">
...
<script>
  ...
  function js_pesquisa() {
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_requisicaoAidof', 'func_fis_requisicaoaidof.php?iNumCgm=' + document.form1.q86_numcgm.value +
  ...
  function js_carregarequisicao(chave1) {
    ...
    location.href = 'fis1_fis_requisicaoaidof002.php?idRequisicao='+chave1;
  }
