...
function js_pesquisay06_codtipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tipovistorias','func_fis_tipovistorias.php?funcao_js=parent.js_mostratipovistorias1|y77_codtipo|y77_descricao','Pesquisa',true);
  }else{
     if(document.form1.y06_codtipo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tipovistorias','func_fis_tipovistorias.php?pesquisa_chave='+document.form1.y06_codtipo.value+'&funcao_js=parent.js_mostratipovistorias','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistoriaslote','func_fis_vistoriaslote.php?funcao_js=parent.js_preenchepesquisa|y06_vistoriaslote','Pesquisa',true);
}
