...
class cl_slipempagemovslips {
   ...
   function sql_query_file ( $k108_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    // funcao do sql
    function sql_query_retencao ( $k108_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
        $sql = "select ";
        if($campos != "*" ){
            $campos_sql = split("#",$campos);
            $virgula = "";
        ...
        $sql .= "      inner join slip  on  slip.k17_codigo = slipempagemovslips.k108_slip";
        $sql .= "      inner join empagemovslips  on  empagemovslips.k107_sequencial = slipempagemovslips.k108_empagemovslips";
        $sql .= "      inner join retencaoreceitas on  empagemovslips.k107_retencao = retencaoreceitas.e23_sequencial";
        $sql .= "      inner join retencaopagordem on  retencaopagordem.e20_sequencial = retencaoreceitas.e23_retencaopagordem";
        $sql .= "      inner join retencaotiporec on  retencaoreceitas.e23_retencaotiporec = e21_sequencial";
