...
abstract class DisciplinaHistorico
{
   ...
   *
   */
    abstract public function __construct($iCodigo);


    abstract public function salvar($iCodigoEtapa = null);
   ...
   */
    ...
    /**
     * Retorna o Tipo de Base
     * @return int
     */
    public function getTipoBase()
    {
        return $this->lTipoBase;
    }
