  ...
  public static function getInstance($iTransferenciaTipo = null, $iCodigoSlip = null) {
    ...
    switch ($iTransferenciaTipo) {
      ...
      case 1:
        ...
        require_once(modification("model/caixa/slip/TransferenciaFinanceira.model.php"));
      ...
      break;
        ...
        require_once(modification("model/caixa/slip/TransferenciaBancaria.model.php"));
        ...
        require_once(modification("model/caixa/slip/Caucao.model.php"));
        ...
        require_once(modification("model/caixa/slip/DepositoDiversos.model.php"));
