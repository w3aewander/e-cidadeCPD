...
$where .= " $and q02_dtbaix is null and y91_exerc = '".db_getsession("DB_anousu")."'
            group by classe.q12_descr,
	             classe.q12_classe,
	             cgm.z01_nome,
		     fis_termovist.y91_datatermo,
		     fis_termovist.y91_inscr,
		     fis_termovist.y91_termovist
...
select classe.q12_descr,
       ...
       fis_termovist.y91_datatermo
from issbase
      inner join fiscalizacao.fis_termovist on fis_termovist.y91_inscr = issbase.q02_inscr
