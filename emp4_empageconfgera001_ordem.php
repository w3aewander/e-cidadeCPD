...
$sqlSlips  = $clempageslip->sql_query_txtbanco(null,"e98_contabanco,
                                                    ...
                                                    (case when z01_nome is  not null then z01_nome
                                                     ...
                                                     0 as vlrretencao,
                                                     2 as tipo","","{$dbwhere} and k17_situacao <> 4");
            ...
            if($numrows09){
              ...
              <table style='border:2px inset white' bgcolor="white" cellspacing='0'>
                ...
                for($i=0; $i<$numrows09; $i++){
                  ...
                  if (($e25_empagetipotransmissao == OBN && $numrows_movconta == 0) ||
                      ($e25_empagetipotransmissao == PAGFOR) ||
                      ((string)$db_banco === '104' && $e25_empagetipotransmissao === CNAB240)
                  ) {
