...
class cl_fis_fiscalbaixa {
   ...
   public $y47_codnoti = 0;
   public $y47_data_dia = null;
   public $y47_data_mes = null;
   public $y47_data_ano = null;
   public $y47_data = null;
   public $y47_motivo = 0;
   public $y47_obs = null;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalbaixa");
...
public function incluir ($y47_codnoti){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalbaixa(
                                       y47_codnoti
                                      ,y47_data
                                      ,y47_motivo
                                      ,y47_obs
...
public function alterar ($y47_codnoti=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalbaixa set ";
     $virgula = "";
...
public function excluir ($y47_codnoti=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalbaixa
                    where ";
     $sql2 = "";
...
public function sql_query ( $y47_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalbaixa ";
     $sql .= "      inner join fiscalizacao.fis_fiscalmotivo  on  fis_fiscalmotivo.y46_motivo = fis_fiscalbaixa.y47_motivo";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalbaixa.y47_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y47_codnoti!=null ){
         $sql2 .= " where fis_fiscalbaixa.y47_codnoti = $y47_codnoti ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y47_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
...
public function sql_query_proc ( $y47_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
     ...
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalbaixa.y47_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql .= "      left join fiscalizacao.fis_fiscalbaixaproc  on  fis_fiscalbaixa.y47_codnoti=fis_fiscalbaixaproc.y48_codnoti";
     $sql .= "      left join protprocesso  on fis_fiscalbaixaproc.y48_codproc = protprocesso.p58_codproc";
     $sql2 = "";
     if($dbwhere==""){
       if($y47_codnoti!=null ){
         $sql2 .= " where fis_fiscalbaixa.y47_codnoti = $y47_codnoti ";
