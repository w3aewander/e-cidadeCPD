...
class cl_fis_fandamvenc {
   ...
   public $y44_codandam = 0;
   public $y44_dtvenc_dia = null;
   public $y44_dtvenc_mes = null;
   public $y44_dtvenc_ano = null;
   public $y44_dtvenc = null;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fandamvenc");
...
public function incluir ($y44_codandam){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fandamvenc(
                                       y44_codandam
                                      ,y44_dtvenc
                       )
                values (
...
public function alterar ($y44_codandam=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fandamvenc set ";
     $virgula = "";
...
public function excluir ($y44_codandam=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fandamvenc
                    where ";
     $sql2 = "";
