...
$this->objpdf->SetLeftMargin(20);
$this->objpdf->sety(55);
$this->objpdf->roundedrect(15, 50, 180, 70, 2, 'df', 1234);
$this->objpdf->cell(35, 5, "PROTOCOLO Nº: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->cell(50, 5, $sNumeroProtocolo, 0, 0, 'L');
$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(30, 5, "Nº CONTROLE: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->cell(40, 5, $this->p58_codproc, 0, 1, 'L');
$this->objpdf->Setfont("Times", "B", 11);
if ($this->p58_dtproc  != "") {
  $this->objpdf->Setfont("Times", "B", 11);
  $this->objpdf->cell(35, 5, ("DATA: "), 0, 0, 'L');
  $this->objpdf->Setfont("Times", "", 12);
  $this->objpdf->cell(50, 5, db_formatar($this->p58_dtproc , 'd'), 0, 0, 'L');
}

$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(12, 5, "CGM: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->cell(75, 5, $this->p58_numcgm , 0, 1, 'L');
$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(35, 5, "TITULAR: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
...
if ($this->z01_telef  != "") {
  $this->objpdf->Setfont("Times", "B", 11);
  $this->objpdf->cell(24, 5, "TELEFONE: ", 0, 0, 'L');
  $this->objpdf->Setfont("Times", "", 12);
...
// }
$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->Cell(35, 5, "TIPO PROCESSO:", 0, 0, "L");
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->multicell(100, 5, $this->p51_descr , 0, 1, 'L');
$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(35, 5, "ENDEREÇO: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->cell(75, 5, substr($this->z01_ender . ($this->z01_numero  != "" ? ", " : "").$this->z01_numero . ($this->z01_compl  != "" ? " - " : "").$this->z01_compl. " - ".$this->z01_bairro,0,55) , 0, 1, 'L');
$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(35, 5, "MUNICÍPIO: ", 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->cell(75, 5, $this->z01_munic , 0, 1, 'L');

$this->objpdf->Setfont("Times", "B", 11);
$this->objpdf->cell(35, 5, ("ASSUNTO: "), 0, 0, 'L');
$this->objpdf->Setfont("Times", "", 8);

// $this->objpdf->multicell(0, 5, mb_strtoupper(substr($this->p58_obs,0, 290)), 0, 1, 'L');

$this->objpdf->cell(75, 5, mb_strtoupper(substr($this->p58_obs,0,75)), 0, 1, 'L');
if( substr($this->p58_obs,0,75) != "" ) {
   //$this->objpdf->cell(50, 5, (" "), 0, 0, 'L');
   $this->objpdf->cell(170, 5, mb_strtoupper(substr($this->p58_obs, 75, 75)), 0, 1, 'L');
   $this->objpdf->cell(170, 5, mb_strtoupper(substr($this->p58_obs, 150, 100)), 0, 1, 'L');
   $this->objpdf->cell(170, 5, mb_strtoupper(substr($this->p58_obs, 250, 100)), 0, 1, 'L');
   $this->objpdf->cell(170, 5, mb_strtoupper(substr($this->p58_obs, 350, 100)), 0, 1, 'L');
   $this->objpdf->cell(170, 5, mb_strtoupper(substr($this->p58_obs, 450, 50)), 0, 1, 'L');
}
...
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->roundedrect(15, 125, 180, 110, 2, 'df', 1234);
$this->objpdf->roundedrect(15, 125, 180, 5, 2, 'DF', 12);
...
if ($numrows_doc < 27 ) {
    ...
    for ($y = 0; $y < $numrows_doc; $y ++) {
      ...
      $this->objpdf->cell(90, 4, substr($p56_descr, 0, 35), 0, $m, "L");
      if ($m == 0) {
        $m = 1;
      } else {
        $m = 1;
...
if($numrows_doc > 12){
  ...
  $this->objpdf->sety(60);
  $this->objpdf->roundedrect(10, 120, 190, 140, 2, 'df', 1234);
  $this->objpdf->roundedrect(10, 120, 190, 5, 2, 'DF', 12);
  $this->objpdf->Setfont("Times", "", 12);
  $this->objpdf->cell(180, 5, 'DOCUMENTOS', 0, 1, "C");
...
$this->objpdf->setfillcolor(255);
$this->objpdf->Setfont("Times", "", 12);
$this->objpdf->roundedrect(15, 243, 180, 31, 2, 'df', 1234);
$this->objpdf->roundedrect(15, 243, 180, 5, 2, 'DF', 12);
$this->objpdf->sety(243);
$this->objpdf->cell(180, 5, 'ASSINATURA RETIRADA DE DOCUMENTOS', 0, 1, "C");
$this->objpdf->cell(168, 7, 'DATA: ___ / ___ / ___', 0, 1, "R");
$this->objpdf->cell(180, 7, 'NOME:', 0, 1, "L");
$this->objpdf->cell(180, 7, 'CI/CPF: ', 0, 1, "L");
