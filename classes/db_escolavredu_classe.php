...
class cl_escolavredu
{
   // cria variaveis de erro
    ...
    public $ed18_v_sigla_concessionaria = null;
    public $ed18_v_codigo_energia = null;
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 ed18_i_esferaadministrativa = int4 = Esfera Administrativa 
                 ed18_i_tipoescola = int4 = Tipo Escola ou Uso Interno
                 ed18_v_sigla_concessionaria = varchar(10) = Sigla Concessionária 
                 ed18_v_codigo_energia = varchar(20) = Código Energia 
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->ed18_i_esferaadministrativa = ($this->ed18_i_esferaadministrativa == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed18_i_esferaadministrativa"] : $this->ed18_i_esferaadministrativa);
            $this->ed18_i_tipoescola = ($this->ed18_i_tipoescola == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed18_i_tipoescola"] : $this->ed18_i_tipoescola);
            $this->ed18_v_sigla_concessionaria = ($this->ed18_v_sigla_concessionaria == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed18_v_sigla_concessionaria"] : $this->ed18_v_sigla_concessionaria);
            $this->ed18_v_codigo_energia = ($this->ed18_v_codigo_energia == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed18_v_codigo_energia"] : $this->ed18_v_codigo_energia);
        } else {
            $this->ed18_i_codigo = ($this->ed18_i_codigo == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed18_i_codigo"] : $this->ed18_i_codigo);
        }
    }
    ...
    public function incluir($ed18_i_codigo)
    {
        $this->atualizacampos();
        ...
        if ($this->ed18_i_esferaadministrativa == null) {
            $this->ed18_i_esferaadministrativa = "null";
        }
        if ($this->ed18_i_tipoescola == null) {
        ...
        $sql = "insert into escola(
                                      ...
                                      ,ed18_i_esferaadministrativa 
                                      ,ed18_i_tipoescola 
                                      ,ed18_v_sigla_concessionaria 
                                      ,ed18_v_codigo_energia 
                       )
                values (
                                $this->ed18_i_codigo 
                               ,$this->ed18_i_rua 
                               ...
                               ,$this->ed18_i_esferaadministrativa 
                               ,$this->ed18_i_tipoescola 
                               ,'$this->ed18_v_sigla_concessionaria' 
                               ,'$this->ed18_v_codigo_energia' 
                      )";
        $result = db_query($sql);
        if ($result == false) {
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco != false) || ($this->numrows != 0)) {
                ...
                $resac = db_query("insert into db_acount values($acount,1010031,1015619,'','".AddSlashes(pg_result($resaco, 0, 'ed18_v_sigla_concessionaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010031,1015620,'','".AddSlashes(pg_result($resaco, 0, 'ed18_v_codigo_energia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
        return true;
    }
    ...
    public function alterar($ed18_i_codigo = null)
    {
        ...
        if (trim($this->ed18_i_censodistrito) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed18_i_censodistrito"])) {
            ...
            $virgula = ",";
            if (trim($this->ed18_i_censodistrito) == null) {
                $this->erro_sql = " Campo Distrito não informado.";
                $this->erro_campo = "ed18_i_censodistrito";
                $this->erro_banco = "";
                $this->erro_msg = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        ...
        if (trim($this->ed18_v_sigla_concessionaria) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed18_v_sigla_concessionaria"])) {
            $sql .= $virgula." ed18_v_sigla_concessionaria = '$this->ed18_v_sigla_concessionaria' ";
            $virgula = ",";
        }
        if (trim($this->ed18_v_codigo_energia) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed18_v_codigo_energia"])) {
            $sql .= $virgula." ed18_v_codigo_energia = '$this->ed18_v_codigo_energia' ";
            $virgula = ",";
        }
        $sql .= " where ";
            ...
            if ($this->numrows > 0) {
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed18_i_tipoescola"]) || $this->ed18_i_tipoescola != "") {
                        $resac = db_query("insert into db_acount values($acount,1010031,1014417,'".AddSlashes(pg_result($resaco, $conresaco, 'ed18_i_tipoescola'))."','$this->ed18_i_tipoescola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed18_v_sigla_concessionaria"]) || $this->ed18_v_sigla_concessionaria != "") {
                        $resac = db_query("insert into db_acount values($acount,1010031,1015619,'".AddSlashes(pg_result($resaco, $conresaco, 'ed18_v_sigla_concessionaria'))."','$this->ed18_v_sigla_concessionaria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed18_v_codigo_energia"]) || $this->ed18_v_codigo_energia != "") {
                        $resac = db_query("insert into db_acount values($acount,1010031,1015620,'".AddSlashes(pg_result($resaco, $conresaco, 'ed18_v_codigo_energia'))."','$this->ed18_v_codigo_energia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                }
            }
        }
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco != false) || ($this->numrows != 0)) {
                for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
                    ...
                    $resac = db_query("insert into db_acount values($acount,1010031,1010423,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed18_i_esferaadministrativa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    ...
                    $resac = db_query("insert into db_acount values($acount,1010031,1015619,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed18_v_sigla_concessionaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac = db_query("insert into db_acount values($acount,1010031,1015620,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed18_v_codigo_energia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
    ...
    public function sql_query_dados($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_cardapioescola($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "", $iCodUsuario = null)
    {
    ...
    public function sql_query_consumoescola($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "", $iCodCardapio = '')
    {
    ...
    public function sql_query_telefone($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_deptousuario($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "", $iNutricionista = '')
    {
    ...
    public function sql_query_estado($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
     ...
     */
    public function sql_query_procedimentos($ed18_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_mapa_estatistico($sOrdem = null, $sWhereTurma = null, $sWhereTurmaAC = null)
    {
    ...
    public function sql_censo($where = array())
    {
        $campos = "
            ed18_i_codigo,
            trim(ed18_c_codigoinep) as ed18_c_codigoinep,
            ed18_i_funcionamento,
            trim(ed18_c_nome) as ed18_c_nome,
            trim(ed18_c_cep) as ed18_c_cep,
            trim(j14_nome) as j14_nome,
            ed18_i_numero,
            trim(ed18_c_compl) as ed18_c_compl,
            trim(j13_descr) as j13_descr,
            ed18_i_censouf,
            ed18_i_censomunic,
            ed262_i_coddistrito,
            trim(ed18_c_email) as ed18_c_email,
            ed263_i_codigocenso,
            trim(ed18_c_mantenedora::varchar) as ed18_c_mantenedora,
            trim(ed18_c_local) as ed18_c_local,
            ed18_i_categprivada,
            ed18_i_conveniada,
            trim(ed18_c_mantprivada) as ed18_c_mantprivada,
            ed18_i_cnpjprivada,
            ed18_i_credenciamento,
            ed18_i_cnpjmantprivada,
            ed18_i_esferaadministrativa,
        ...
        $sql = "
            select {$campos}
              from escola
              join bairro on bairro.j13_codi = escola.ed18_i_bairro
              join ruas on ruas.j14_codigo = escola.ed18_i_rua
              join db_depart on db_depart.coddepto = escola.ed18_i_codigo
              join db_config on db_config.codigo = db_depart.instit
              join censouf on censouf.ed260_i_codigo = escola.ed18_i_censouf
              join censomunic on censomunic.ed261_i_codigo = escola.ed18_i_censomunic
              left join censodistrito on censodistrito.ed262_i_codigo = escola.ed18_i_censodistrito
              left join censoorgreg on censoorgreg.ed263_i_codigo = escola.ed18_i_censoorgreg
    ...
    public function sqlDatasCalendario($escola, $ano)
    {
        $sql = "
            select min(ed52_d_inicio) as data_inicio,
                   max(ed52_d_fim) as data_final
              from calendarioescola
              join calendario ON calendario.ed52_i_codigo = calendarioescola.ed38_i_calendario
             where ed38_i_escola = {$escola} and calendario.ed52_i_ano = {$ano}
        ";

        return $sql;
    }

    public function sqlLinguaIndigena($escola)
    {

        $sql = "
            select ed18_i_tipolinguapt, ed18_i_tipolinguain,
                   ed144_i_linguaindigena1, ed144_i_linguaindigena2, ed144_i_linguaindigena3
              from escola
              left join escolacensolinguaindigena on escolacensolinguaindigena.ed144_i_escola = escola.ed18_i_codigo
