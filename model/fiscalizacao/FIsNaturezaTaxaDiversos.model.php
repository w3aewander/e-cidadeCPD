...
class FisNaturezaTaxaDiversos
{
   ...
   */
  public function setGrupoTaxaDiversos (FisGrupoTaxaDiversos $grupoTaxaDiversos) {
  ...
  public function getLancamentos() {
    ...
    $oDaoLancamentos    = new cl_fis_lancamentotaxadiversos();
    ...
    return \db_utils::makeCollectionFromRecord($rsLancamentos, function($oLancamento) {
      return FisLancamentoTaxaDiversosRepository::getInstanciaPorCodigo($oLancamento->y120_sequencial);
    });
  }
}
