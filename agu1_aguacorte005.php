 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguacortemat.location.href='agu1_aguacorte007.php?x41_codcortemat=".@$x41_codcortemat."&x41_codcorte=".@$x40_codcorte."&x40_dtinc=".@$x40_dtinc."';
         parent.document.formaba.aguacortetipodebito.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguacortetipodebito.location.href='agu1_aguacortetipodebito001.php?x45_codcortetipodebito=".@$x45_codcortetipodebito."&x45_codcorte=".@$x40_codcorte."&x40_dtinc=".@$x40_dtinc."';
     ";
         if(isset($liberaaba)){
