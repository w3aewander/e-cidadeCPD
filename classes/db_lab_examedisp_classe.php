...
class cl_lab_examedisp {
   ...
   public $la50_i_codigo = 0;
   public $la50_i_atributo = 0;
   public $la50_i_exameatributo = 0;
   ...
   public function incluir ($la50_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($la50_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($la50_i_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $la50_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $la50_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
