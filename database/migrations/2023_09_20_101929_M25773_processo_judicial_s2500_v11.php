...
class M25773ProcessoJudicialS2500V11 extends Migration
{
    /**
     * Run the migrations.
     *
...
SQL;
    ...
    private function upDicionarioTabelaRhpessoalProcessoContrato() {
        $sql  = <<<SQL
            ...
            insert into configuracoes.db_syscampo values(1014838,'rh273_indmotdeslig ','varchar(1)','Indicativo se houve reconhecimento de motivo de desligamento diferente do informado pelo declarante.','', 'Motivo Desligamento',1,'f','t','f',0,'text','Motivo Desligamento');
            insert into configuracoes.db_syscampo values(1014839,'rh273_indunic','varchar(1)','Indicativo se houve reconhecimento de unicidade contratual (declaração da continuidade do contrato de trabalho, considerando como único dois ou mais vínculos sucessivos informados no eSocial).','', 'Unicidade contratual ',1,'t','t','f',0,'text','Unicidade contratual ');
            ...
            insert into configuracoes.db_syscampo values(1014847,'rh273_repercproc ','int4','Repercussão do processo trabalhista ou de demanda submetida à CCP ou ao NINTER.','0', 'Repercussão do processo ',1,'t','f','f',1,'text','Repercussão do processo ');
            insert into configuracoes.db_syscampo values(1014848,'rh273_vrremunc ','float4','Valor total das verbas remuneratórias a serem pagas ao trabalhador.','0', 'Valor total',14,'t','f','f',4,'text','Valor total');
            insert into configuracoes.db_syscampo values(1014849,'rh273_vrapi ','float4','Valor do aviso prévio indenizado pago ao empregado.','0', 'Valor do aviso prévio ',14,'t','f','f',4,'text','Valor do aviso prévio ');
            insert into configuracoes.db_syscampo values(1014850,'rh273_vr13api','float4','Valor da projeção do aviso prévio indenizado sobre o 13º salário.','0', 'Valor da projeção 13º',14,'t','f','f',4,'text','Valor da projeção 13º');
            insert into configuracoes.db_syscampo values(1014851,'rh273_vrinden','float4','Valor total das demais verbas indenizatórias a serem pagas ao trabalhador.','0', 'Valor total das demais',14,'t','f','f',4,'text','Valor total das demais');
            insert into configuracoes.db_syscampo values(1014852,'rh273_baseindenfgts ','float4','Valor da base de cálculo para recolhimento da indenização compensatória (multa rescisória) do FGTS, para geração de guia.','0', 'Valor da base FGTS',14,'t','f','f',4,'text','Valor da base FGTS');
            insert into configuracoes.db_syscampo values(1014853,'rh273_pagdiretoresc ','varchar(1)','A indenização compensatória (multa rescisória) do FGTS transacionada foi paga diretamente ao trabalhador mediante decisão/autorização judicial?','', ' Indenização compensatória ',1,'t','t','f',0,'text',' Indenização compensatória ');
            ...
            insert into configuracoes.db_sysarqcamp values(1011034,1014839,10,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014840,11,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014841,12,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014842,13,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014845,14,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014846,15,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014847,16,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014848,17,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014849,18,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014850,19,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014851,20,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014852,21,0);
            insert into configuracoes.db_sysarqcamp values(1011034,1014853,22,0);
...
SQL;
    ...
    private function downDicionarioTabelaRhpessoalProcessoContrato() {
        $sql  = <<<SQL
            ...
            delete from configuracoes.db_syscampodef where codcam in (1014830, 1014831, 1014832, 1014833, 1014834, 1014835, 1014836, 1014837, 1014838, 1014839, 1014840, 1014841, 1014842, 1014843, 1014844, 1014845, 1014846, 1014847, 1014848, 1014849, 1014850, 1014851, 1014852, 1014853);
            delete from configuracoes.db_syscampodep where codcam in (1014830, 1014831, 1014832, 1014833, 1014834, 1014835, 1014836, 1014837, 1014838, 1014839, 1014840, 1014841, 1014842, 1014843, 1014844, 1014845, 1014846, 1014847, 1014848, 1014849, 1014850, 1014851, 1014852, 1014853);
            delete from configuracoes.db_syscampo where codcam in (1014830, 1014831, 1014832, 1014833, 1014834, 1014835, 1014836, 1014837, 1014838, 1014839, 1014840, 1014841, 1014842, 1014843, 1014844, 1014845, 1014846, 1014847, 1014848, 1014849, 1014850, 1014851, 1014852, 1014853);
...
SQL;
    ...
    private function upEstruturaTabelaRhpessoalProcessoContrato() {
        $sql  = <<<SQL
            ...
            rh273_indmotdeslig		varchar(1)   default '',
            rh273_indunic		varchar(1)   default '',
            ...
            rh273_repercproc		int4  default 0,
            rh273_vrremunc		float4  default 0,
            rh273_vrapi		float4  default 0,
            rh273_vr13api		float4  default 0,
            rh273_vrinden		float4  default 0,
            rh273_baseindenfgts		float4  default 0,
            rh273_pagdiretoresc		varchar(1)  default '',
...
SQL;
    ...
    private function upEstruturaTabelaRhpessoalProcessoVinculo() {
        $sql  = <<<SQL
            ...
            -- Criando  sequences
            CREATE SEQUENCE recursoshumanos.rhpessoalprocessovinculo_rh274_sequencial
              INCREMENT 1
              MINVALUE 1
              MAXVALUE 9223372036854775807
              START 1
            ...
            rh274_sequencial		int4 NOT NULL default 0,
            rh274_sequencialprocessoservidor		int4 NOT NULL default nextval('rhpessoalprocessovinculo_rh274_sequencial'),
...
SQL;
    ...
    private function downEstruturaTabelaRhpessoalProcessoVinculo() {
        $sql  = <<<SQL
            ...
            DROP SEQUENCE recursoshumanos.rhpessoalprocessovinculo_rh274_sequencial ;
SQL;
...
SQL;
    ...
    private function upDicionarioTabelaRhpessoalProcessoEstatutario() {
        $sql  = <<<SQL
            insert into db_sysarquivo values (1011042, 'rhpessoalprocessoestatutario', 'Grupo de informações da sucessão de vínculo trabalhista/estatutário.', 'rh278', '2023-03-21', 'Sucessão de vínculo', 0, 'f', 'f', 'f', 'f' );
            insert into db_sysarqmod values (29,1011042);
            insert into db_sysarqarq values (1011036,1011042);
            insert into db_syscampo values(1014877,'rh278_sequencial','int4','Código único sequencial da tabela.','0', 'Número Sequencial',10,'f','f','f',1,'text','Número Sequencial');
            insert into db_syscampo values(1014878,'rh278_sequencialprocessovinculo','int4','Código que vincula a tabela rhpessoalprocessovinculo (FK).','0', 'Processo vínculo',10,'f','f','f',1,'text','Processo vínculo');
            insert into db_syscampo values(1014879,'rh278_tplnsc','int4','Código correspondente ao tipo de inscrição','0', 'Tipo de inscrição',1,'f','f','f',1,'text','Tipo de inscrição');
            insert into db_syscampo values(1014880,'rh278_nrlnsc','varchar(14)','Informar o número de inscrição do empregador anterior.','', 'Inscrição do empregador',14,'f','t','f',0,'text','Inscrição do empregador');
            insert into db_syscampo values(1014881,'rh278_matricant','varchar(30)','Matrícula do trabalhador no empregador anterior.','', 'Matrícula Anterior',30,'f','t','f',0,'text','Matrícula Anterior');
            insert into db_syscampo values(1014882,'rh278_dttransf','date','Data da transferência do empregado para o empregador declarante.','null', 'Data da transferência',10,'t','f','f',1,'text','Data da transferência');
            insert into db_sysarqcamp values(1011042,1014877,1,0);
            insert into db_sysarqcamp values(1011042,1014878,2,0);
            insert into db_sysarqcamp values(1011042,1014879,3,0);
            insert into db_sysarqcamp values(1011042,1014880,4,0);
            insert into db_sysarqcamp values(1011042,1014881,5,0);
            insert into db_sysarqcamp values(1011042,1014882,6,0);
            insert into db_sysprikey (codarq,codcam,sequen,camiden) values(1011042,1014877,1,1014877);
            insert into db_sysforkey values(1011042,1014878,1,1011036,0);
SQL;
        DB::connection()->getPdo()->exec($sql);
    }
    ...
    private function downDicionarioTabelaRhpessoalProcessoEstatutario() {
        $sql  = <<<SQL
            ...
            delete from configuracoes.db_syscampodef where codcam in (1014877, 1014878, 1014879, 1014880, 1014881, 1014882);
            delete from configuracoes.db_syscampodep where codcam in (1014877, 1014878, 1014879, 1014880, 1014881, 1014882);
            delete from configuracoes.db_syscampo where codcam in (1014877, 1014878, 1014879, 1014880, 1014881, 1014882);
...
SQL;
    ...
    private function upEstruturaTabelaRhpessoalProcessoEstatutario() {
        $sql  = <<<SQL
            -- Criando  sequences
            CREATE SEQUENCE recursoshumanos.rhpessoalprocessoestatutario_rh278_sequencial
              INCREMENT 1
              MINVALUE 1
              MAXVALUE 9223372036854775807
              START 1
            ...
            rh278_sequencial		int4 NOT NULL default nextval('rhpessoalprocessoestatutario_rh278_sequencial'),
            rh278_sequencialprocessovinculo		int4 NOT NULL default 0,
            rh278_tplnsc		int4 NOT NULL default 0,
            rh278_nrlnsc		varchar(14) NOT NULL  default '',
            rh278_matricant		varchar(30) NOT NULL  default '',
...
SQL;
    ...
    private function downEstruturaTabelaRhpessoalProcessoEstatutario() {
        $sql  = <<<SQL
            ...
            DROP SEQUENCE recursoshumanos.rhpessoalprocessoestatutario_rh278_sequencial;
SQL;
...
SQL;
    ...
    private function downDicionarioTabelaRhpessoalProcessoDesligamento() {
        $sql  = <<<SQL
            ...
            delete from configuracoes.db_syscampodef where codcam in (1014883, 1014884, 1014885, 1014886, 1014887);
            delete from configuracoes.db_syscampodep where codcam in (1014883, 1014884, 1014885, 1014886, 1014887);
            delete from configuracoes.db_syscampo where codcam in (1014883, 1014884, 1014885, 1014886, 1014887);
...
SQL;
    ...
    private function downEstruturaTabelaRhpessoalProcessoDesligamento() {
        $sql  = <<<SQL
            ...
            DROP SEQUENCE recursoshumanos.rhpessoalprocessodesligamento_rh279_sequencial_seq;
SQL;
...
SQL;
    ...
    private function downDicionarioTabelaRhpessoalProcessoPeriodo() {
        $sql  = <<<SQL
            ...
            delete from configuracoes.db_syscampodef where codcam in (1014898, 1014899, 1014900, 1014901, 1014902, 1014903, 1014904, 1014905, 1014906, 1014907, 1014908, 1014909, 1014910);
            delete from configuracoes.db_syscampodep where codcam in (1014898, 1014899, 1014900, 1014901, 1014902, 1014903, 1014904, 1014905, 1014906, 1014907, 1014908, 1014909, 1014910);
            delete from configuracoes.db_syscampo where codcam in (1014898, 1014899, 1014900, 1014901, 1014902, 1014903, 1014904, 1014905, 1014906, 1014907, 1014908, 1014909, 1014910);
...
SQL;
    ...
    private function upEstruturaTabelaRhpessoalProcessoPeriodo() {
        $sql  = <<<SQL
            ...
            rh282_vrbcfgts		float4  default 0,
            rh282_vrbcfgts13		float4  default 0,
            rh282_grauexp		int4  default 0,
            rh282_vrbcfgtsguia		float4  default 0,
            rh282_vrbcfgts13guia		float4  default 0,
            rh282_pagdireto		varchar(1)   default '',
...
SQL;
    ...
    private function upEventoEsocial() {
        $sql  = <<<SQL
        insert into recursoshumanos.esocialformulariotipo values(49, 'S-2500 - Processo Trabalhista');
        ...
        insert into habitacao.avaliacao values (4000122, 5, 'S-2500 - Processo Trabalhista', 'S-2500 - Processo Trabalhista', true, 's2500_processo_trabalhista', null, false);
        insert into recursoshumanos.esocialversaoformulario values (nextval('recursoshumanos.esocialversaoformulario_rh211_sequencial_seq'), 'S1.1', 4000122, 49);
SQL;
        DB::connection()->getPdo()->exec($sql);
    }
    ...
    {
        $sql = <<<SQL
            delete from recursoshumanos.esocialversaoformulario where  rh211_esocialformulariotipo = 49 and rh211_versao = 'S1.1';
            delete from recursoshumanos.esocialformulariotipo where rh209_sequencial = 49;
            delete from habitacao.avaliacao where db101_sequencial = 4000122;
SQL;
        DB::connection()->getPdo()->exec($sql);
    }
