...
/**
 * Class RegraLancamentoEncerramentoOrcamentarioReceita
 */
class RegraLancamentoEncerramentoOrcamentarioReceita implements IRegraLancamentoContabil
{
    ...
    public function getRegraLancamento($iCodigoDocumento, $iCodigoLancamento, ILancamentoAuxiliar $oLancamentoAuxiliar)
    {
        ...
        $regra = new RegraLancamentoContabil(null);
