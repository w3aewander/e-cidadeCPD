...
if(!isset($pesquisa_chave)){
  ...
  <script>
    function js_recebe_click(value){
      ...
      obj.setAttribute('value','<?php echo $funcao_js?>');
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Tr52_regist?>">
              <?php echo $Lr52_regist?>
            </td>
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo $Tr52_numcgm?>">
              <?php echo $Lr52_numcgm?>
            </td>
            <td width="96%" align="left" nowrap>
              <?php
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($campos)==false) {
           ...
           if (file_exists("funcoes/db_func_pensao.php") == true) {
             include(modification("funcoes/db_func_pensao.php"));
           } else {
             $campos = "pensao.*";
           }
        }
