...
<div style="width: 800px;height: 1200px; border: 1px solid black;position:relative">
  ...
  <div style="width: 100%;text-align: center; border-top: 1px solid black; border-bottom: 1px solid black;padding: 5px 0 5px 0"><i><b>TERMO DE RESPONSABILIDADE</b></i></div>

  <div style="width: 95%; padding: 20px;border-bottom: 1px solid black">
    Eu,'.$nomeresponsavel.' , assumo inteira responsabilidade<br>
      perante a '.$nomeinstituicao.', pelo(s) patrimônio(s) abaixo<br>
      relacionado(s), que doravante ficará(ão) em disponibilidade no(a) '.$nomedivisao.'.
  </div>
...
<div style="width:100%;font-size:12px; line-height:25px;border-top: 1px solid black;border-bottom:1px solid black">
  <div style="border: 1px solid black;width: 53px;height: 161px;float:left;"><img style="width: 52px;height:160px " src="obs.jpg"></div>
  
  <div style="width: 92%;float:right">
    <i>
    1- Não poderá haver transferência nem empréstimo de móveis, equipamentos ou utensílios, sem o prévio conhecimento do Setor de Patrimônio, caso contrário é de inteira responsabilidade do cedente tal ato;<br>
    2- Todo material danificado ou insersível deverá ser devolvido ao Setor de Patrimônio com o pedido de baixa;<br>
    3- Prestar conta ao Setor de Patrimônio, sempre que solicitado, de todo material discriminado nesta ficha;<br>
    4- A dispensa do responsável pela carga de Bens Patrimoniais acima não o exime da responsabilidade sobre o mesmo, só se efetivando a respectiva baixa, após a conferência pelo Setor de Patrimônio.
    </i>
  </div>
...
<div style="width:59%; display:inline-block; border:2px solid black;height:30px;float:left;height:88px;">
  ...
  <div style="width:69%;display:inline-block;float:right;font-size:12px;vertical-allign:bottom">
    ...
    <br>
    <hr>
    '.$dados["matricula"] .' - '.$nomeresponsavel.'
  </div>
</div>
