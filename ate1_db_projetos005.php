 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_projetosgrupos.location.href='ate1_db_projetosgrupos001.php?at63_projeto=".@$at60_codigo."';
         parent.document.formaba.db_projetosusu.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_projetosusu.location.href='ate1_db_projetosusu001.php?at65_projeto=".@$at60_codigo."';
         parent.document.formaba.db_projetosclientes.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_projetosclientes.location.href='ate1_db_projetosclientes001.php?at64_projeto=".@$at60_codigo."';
     ";
         if(isset($liberaaba)){
