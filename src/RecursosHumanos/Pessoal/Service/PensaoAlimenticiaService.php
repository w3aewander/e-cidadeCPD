...
class PensaoAlimenticiaService
{
    ...
    /**
     * PensaoAlimenticiaService constructor.
     */
    public function __construct()
    {
        $this->repositorio = new PensaoAlimenticiaRepository();
     ...
     */
    public function buscarPensoesPorServidorCompetencia(Servidor $servidor)
    {
