...
class M8671AtivarCgs extends PostgresMigration
{
  public function up() {

    $sSqlCreateTableFalecidos  = "create table if not exists w_cgs_falecidos_8671 as ";
    ...
    $sSqlCreateTableMaeDesconhecida  = "create table if not exists w_cgs_mae_desconhecida_8671 as ";
