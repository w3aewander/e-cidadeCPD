...
/**
 * Class SalvarOrgaosProgrmaEstrategicoextends
 * @package App\Domain\Financeiro\Planejamento\Requests\Procedimentos\Manutencao\Despesa
 */
class SalvarOrgaosProgramaEstrategico extends FormRequest
{
    /**
     * @return bool
     */
    ...
    public function messages()
    {
        return [
            ...
            'orgaos.required' => 'Deve ser informado uma coleção de órgãos.',
            'orgaos.array' => 'A propriedade "órgãos" deve ser um array.',
        ];
    }
}
