  ...
  <form name="form1" method="post">
    ...
    <fieldset style="width:500px">
      ...
      <fieldset class='legend-hr'>
            ...
            <td nowrap = "nowrap" >
              <?
                ...
                $sCamposDiretor    = " 'DIRETOR' as funcao, ";
  	            ...
  	            $sCamposDiretor   .= "          case when ed20_i_tiposervidor = 1 then ";
  	            $sCamposDiretor   .= "                  cgmrh.z01_numcgm ";
  	            $sCamposDiretor   .= "               else cgmcgm.z01_numcgm ";
  	            $sCamposDiretor   .= "            end as cgm";
              ...
              <select name="diretor" style="width:330px;">
                ...
                <?
                  for ($iCont = 0; $iCont < $iLinhasDiretor; $iCont++) {
                    ...
                    $sValor     = $oDadosDiretor->funcao."|".$oDadosDiretor->nome."|".$oDadosDiretor->descricao."|".$oDadosDiretor->cgm;
            ...
            <td>
              <?
                ...
                $sCamposSec        = " DISTINCT ed01_c_descr as funcao, ";
          	    ...
          	    $sCamposSec       .= "          case when ed20_i_tiposervidor = 1 then ";
          	    $sCamposSec       .= "                  cgmrh.z01_numcgm ";
          	    $sCamposSec       .= "               else cgmcgm.z01_numcgm ";
          	    $sCamposSec       .= "            end as cgm";
          	    //$sWhereSec         = " ed75_i_escola = ".$escola." AND ed01_i_funcaoadmin = 3 ";
                $sWhereSec         = " ed75_i_escola = ".$escola." AND ed01_c_descr like 'SECRET%' ";
              ...
              <select name="secretario" style="width:330px;">
                ...
                <?
                  for ($iCont = 0; $iCont < $iLinhasSecretario; $iCont++) {
                    ...
                    $sValor     = $oDadosSec->funcao."|".$oDadosSec->nome."|".$oDadosSec->descricao."|".$oDadosSec->cgm;
        ...
        <tr>
            <td nowrap = "nowrap" style = "width: 150px;"> <b>Responsável por assinar a Ata</b></td>
            <td>
                <select id="ataResp" name="ataResp" style="width:330px;">
         ...
         <?php */ ?>
          ...
          <tr>
              ...
              <td>
                 <textarea maxlength="300" id='sObservacao' name="sObservacao" value=""
                           style="width:100%; height:100px; resize: none;" ></textarea><br>
                 <span>Caracteres: </span><span id="iContagemCaracteres">300</span>
              </td>
          </tr>
...
function js_pesquisa() {
  ...
  // Extrai CGMs dos valores dos selects
  /**
   * Autor: Uemerson Santana
   * Data: 07/10/2025
   * Demanda: 17874
   */
  var aDiretor = document.form1.diretor.value.split('|');
  var aSecretario = document.form1.secretario.value.split('|');
  var cgmDiretor = aDiretor.length >= 4 ? aDiretor[3] : '';
  var cgmSecretario = aSecretario.length >= 4 ? aSecretario[3] : '';
  ...
  jan = window.open(sUrl+'?transfer='+transfer+
                    ...
                    '&cgmDiretor='+cgmDiretor+
                    '&cgmSecretario='+cgmSecretario+
                      /**
                       * Autor: Uemerson Santana
                       *
                       * Data: 03/04/2025
                       ...
                       *    para escolher o nome do
                       *    responsável por lavrar a
                       *    ATA, tem escola que
                       *    temos secretária e outras
                       *    a própria direção.
                       */
                    '&ataResp='+document.form1.ataResp.value+
                    ...
                    '&imprimirNomeRegente=1'+
                    '&iRegente='+$F('ed20_i_codigo')+
                    '&iAtividade='+oCboAtividades.getValue()+
		            '&sObservacao='+document.form1.sObservacao.value+
  ...
  jan.moveTo(0,0);
    ...
    function caracterObservacao(){

        var campoObservacao = document.getElementById("sObservacao");
        var contagemCaracteres = document.getElementById('iContagemCaracteres');
        if(campoObservacao.value.length > 450){
            campoObservacao.value = campoObservacao.value.substring(0,450);
        }
        contagemCaracteres.innerHTML = 450 - (campoObservacao.value.length);
    }
