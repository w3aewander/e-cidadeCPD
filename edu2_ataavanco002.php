...
define('CATEGORIA_ATA_AVANCO', 6002);
...
try {
    ...
    where db_documentopadrao.db60_tipodoc = ".CATEGORIA_ATA_AVANCO;
    ...
    $pdf->MultiCell($larguraUtil, 7, "Ata de Resultados dos Exames de Avanço do Ano Letivo de {$dataPartes[2]}.", 1, "C", 0);
