	...
	<center>
		<fieldset style="width:300px;">
			...
			<table border=0>
				...
				<tr>
					<td><b>Slip:</b></td>
					<td align="left" nowrap><?php    db_input("k17_codigo",8,$Ik17_codigo,true,"text",4,"","chave_k17_codigo", "", "", 7);	 ?></td>
				</tr>
			</table>
		</fieldset>
...
<div id="resultadoLovRot">
	...
	if (!isset ($pesquisa_chave)) {
       ...
       */
       ...
       /**
	   * Em campina grande, só dever ser permitido a importação de slips com situação 3 ou 4;
	   * Além disso, o vinculo só pode ser feito uma vez. 
	   */

		if(isset($importacaoCG) && $importacaoCG == true){

	       $situacaoSlip = "3,4";

		   $sql = "select * from ({$sql}) as x where k17_situacao IN (".$situacaoSlip.") and k17_codigo not in ( ";
		   $sql .= $clslip->sql_querySlipVinculo($situacaoSlip) ;
		   $sql .= " )";
		}
