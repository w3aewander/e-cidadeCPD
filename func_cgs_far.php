            ...
            <form name="form2" method="post" action="">
                <table width="100%" border="0" align="center" cellspacing="0">
                    <tr>
                        <td>
                            <b>CGS:</b>&nbsp;&nbsp; <?php
                            db_input('z01_i_cgsund', 6, $Iz01_i_cgsund, true, 'text', 4, "", "chave_z01_i_cgsund"); ?>
                            <br>
                            <b>Nasc:</b> <?php
                            db_inputdata(
                                'z01_d_nasc',
                        ...
                        <td>
                            <b>Identidade:</b>&nbsp;&nbsp; <?php
                            db_input('z01_v_ident', 15, $Iz01_v_ident, true, 'text', 1, "", "chave_z01_v_ident"); ?><br>
                            <b>Cartão SUS:</b> <?php
                            db_input(
                                's115_c_cartaosus',
                                15,
                                ...
                                4,
                                "",
                                'chave_s115_c_cartaosus'
                            ); ?>
                        </td>
                        <td>
                            <b>Micro:</b>&nbsp;&nbsp;&nbsp;
                            <select name="chave_z01_v_micro"
               ...
               ORDER BY sd34_v_descricao";
                                ...
                                while ($row = pg_fetch_array($sql_result)) {
                                    ...
                                    ?>
                                    <option
                                        value="<?= $cod_micro; ?>" <?= $cod_micro == @$chave_z01_v_micro ? "selected" : "" ?>><?= $desc_micro; ?></option>
                                    <?php
                                }
                                ?>
                            </select><br>
                            <b>Família:</b>
                            <select name="chave_z01_i_familiamicroarea" style="font-size:9px;width:200px;height:18px;"
            ...
            if (!isset($pesquisa_chave)) {
                ...
                if (isset($chave_z01_i_cgsund) && (trim($chave_z01_i_cgsund) != "")) {
                    ...
                    if (isset($chave_z01_v_nome) && (trim($chave_z01_v_nome) != "")) {
                        $sql = $clcgs_und->sql_query(
                            "",
                            $campos,
                            "z01_v_nome",
                            " to_ascii(z01_v_nome) like to_ascii('$chave_z01_v_nome%') "
                        );
                    } else {
                        if (isset($chave_z01_v_ident) && (trim($chave_z01_v_ident) != "")) {
                            $sql = $clcgs_und->sql_query(
                                ...
                                $campos,
                                "z01_v_nome",
                                " z01_v_ident = '$chave_z01_v_ident' "
                            );
                        } else {
                            if (isset($chave_z01_v_ident) && (trim($chave_z01_d_nasc) != "")) {
                                $chave_z01_d_nasc = substr($chave_z01_d_nasc, 6, 4) . "-" . substr(
                                        $chave_z01_d_nasc,
                                        3,
                                        2
                                    ) . "-" . substr($chave_z01_d_nasc, 0, 2);
                                $sql = $clcgs_und->sql_query(
                                    "",
                                    $campos,
                                    "z01_v_nome",
                                    " z01_d_nasc = '$chave_z01_d_nasc' "
                                );
                            } else {
                                if (isset($chave_s115_c_cartaosus) && (trim($chave_s115_c_cartaosus) != "")) {
                                    $sql = $clcgs_und->sql_query_ext(
                                        "",
                                        $campos,
                                        "z01_v_nome",
                                        " s115_c_cartaosus = '$chave_s115_c_cartaosus' "
                                    );
                                } else {
                                    if (isset($chave_z01_i_familiamicroarea) && (trim(
                                                $chave_z01_i_familiamicroarea
                                            ) != "")) {
                                        $sql = $clcgs_und->sql_query(
                                            "",
                                            $campos,
                                            "z01_v_nome",
                                            " z01_i_familiamicroarea = '$chave_z01_i_familiamicroarea' "
                                        );
                                    } else {
                                        if (isset($chave_z01_v_micro) && (trim($chave_z01_v_micro) != "")) {
                                            $sql = $clcgs_und->sql_query(
                                                "",
                                                $campos,
                                                "z01_v_nome",
                                                " familiamicroarea.sd35_i_microarea = $chave_z01_v_micro "
                                            );
                                        } else {
