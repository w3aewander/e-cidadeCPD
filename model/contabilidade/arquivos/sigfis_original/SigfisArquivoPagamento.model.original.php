...
class SigfisArquivoPagamento extends SigfisArquivoBase implements iPadArquivoTXTBase {
  ...
  */
  public function gerarDados() {
    ...
    $sCampos .= "left  join corgrupotipo on k106_sequencial = k105_corgrupotipo	where k12_empen = empempenho.e60_numemp and k106_sequencial = 2 and k12_codord = min(pagordem.e50_codord)),0) as valor_pago      ";
