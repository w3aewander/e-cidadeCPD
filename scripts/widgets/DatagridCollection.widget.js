(function (exports, Collection, DBGrid) {
            ...
            for (var action of this.actions.get()) {
                if (action.asButton) {
                    ...
                    if (action.withIcon) {
                        ...
                        if (action.withIcon.indexOf(" ") !== -1) {
                            var classes = action.withIcon.split(" ");

                            for (var cl of classes) {
                                icon.classList.add(cl);
                            }
                        } else {
                            icon.classList.add(action.withIcon);
                        }
                ...
                this._events.onaftercreatebutton(button, this.collection.get(id));
            ...
            for (var oRegistro of this.collection.get()) {
                ...
                for (var sColuna in this.columns) {
                    ...
                    if (coluna.transformCallback) {
                        sValor = coluna.transformCallback(sValor, oRegistro, sColuna, iRegistroAtual);
                    }
    ...
    DatagridCollection.prototype._events = {
        ...
        "onaftercreatebutton": function (button, itemCollection = null) {
        }
    };
    ...
    Object.freeze(DatagridCollection.defaultTransformers = {
        ...
        "cnpj": function (data) {
            return js_formatar(data, "cpfcnpj");
        },
        "cpf": function (data) {
            return js_formatar(data, "cpfcnpj");
        },
