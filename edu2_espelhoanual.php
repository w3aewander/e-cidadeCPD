...
<div class="container">
    <fieldset>
        <legend>Filtros - Espelho Anual</legend>
        ...
        <div id="ctnDisciplinas" style="display: none">
...
<script type="text/javascript">
    ...
    const routes = {
        ...
        espelho: `v4/api/educacao/escola/relatorios/espelho-anual`
    }
    ...
    const cboModelo = document.getElementById('modelo');
    const ctnDisciplinas = document.getElementById('ctnDisciplinas');
    ...
    cboModelo.addEventListener('change', () => {
        const modelo = cboModelo.value;
        if (modelo === '2') {
            ctnDisciplinas.style.display = 'block';
            cboTurma.dispatchEvent(new Event('change'));
        } else {
            ctnDisciplinas.style.display = 'none';
        }
    });
