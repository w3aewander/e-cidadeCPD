...
if (isset($atualizar)) {
	...
	db_msgbox('Subgrupos atualizados.');
				...
				<td align="center" valign="top">
					...
					<table border='1' width="100%" nowrap>
						...
						if (isset($pc76_pcforne)) {
							$result01 = $clpcsubgrupo->sql_record($clpcsubgrupo->sql_query(null, "*", "pc04_descrsubgrupo", "(pc04_tipoutil=2 or pc04_tipoutil=3) and pc04_ativo = true"));
