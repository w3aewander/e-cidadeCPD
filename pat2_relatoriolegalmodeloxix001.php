...
<form class="container" name="form1" method="post">
	<fieldset>
  	<legend>Modelo XIX -  Termo de Transfer&ecirc;ncias de Responsabilidade</legend>
...
function js_abre(){
  ...
  var sFonte       = "pat2_relatoriolegalmodeloxix002.php";
  ...
  if ((sExercicio == "") && (sDataInicial == "" || sDataFinal == "")){
  
    alert("Per�odo ou Exerc�cio precisa ser preenchido.");
    return false;
  }
