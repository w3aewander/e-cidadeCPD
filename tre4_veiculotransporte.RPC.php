...
try {
  ...
  switch ($oParam->exec) {
    ...
    case "salvar":
      ...
      $oTipoVeiculo = new TipoVeiculo($oParam->iTipoVeiculo);
      $oVeiculoTransporte->setTipoVeiculo($oTipoVeiculo);
      $oVeiculoTransporte->setModalidade($oParam->modalidade);
      $oVeiculoTransporte->setAcessibilidade  ($oParam->acessibilidade);
      $oVeiculoTransporte->setAno($oParam->ano);
      ...
      if (!empty($oParam->iVinculoCgm)) {
        ...
        $oVeiculoTransporte->setPlaca($oParam->placa);
        $oVeiculoTransporte->setRenavam($oParam->renavam);
      }
    ...
    case 'getDados':
        ...
        $oDadosRetorno->iTipoVeiculo          = $oVeiculoTransporte->getTipoVeiculo()->getCodigo();
        $oDadosRetorno->sDescricaoTipoTransporte = urlencode($oVeiculoTransporte->getTipoVeiculo()->getDescricao());
        $oDadosRetorno->iVinculoVeiculo          = '';
        $oDadosRetorno->sMarcaVinculoTransporte  = '';
        $oDadosRetorno->iVinculoCgm              = '';
        $oDadosRetorno->sNomeEmpresa             = '';
        $oDadosRetorno->ano             = $oVeiculoTransporte->getAno();
        $oDadosRetorno->modalidade             = $oVeiculoTransporte->getModalidade();
        $oDadosRetorno->acessibilidade             = $oVeiculoTransporte->getAcessibilidade();
        ...
        if ($oVeiculoTransporte->getEmpresaResponsavel() != "") {
          ...
          $infoTerceiro = $oVeiculoTransporte->getInfoVeiculoTerceiro();
          $oDadosRetorno->placa = $infoTerceiro['placa'];
          $oDadosRetorno->renavam = $infoTerceiro['renavam'];
        }
