...
class cl_rhpessoalmov
{
   // cria variaveis de erro
    ...
    public $rh02_instit = 0;
    public $rh02_seqpes = 0;
    public $rh02_anousu = 0;
    public $rh02_mesusu = 0;
    public $rh02_regist = 0;
    public $rh02_codreg = 0;
    public $rh02_tipsal = null;
    public $rh02_folha = null;
    public $rh02_fpagto = 0;
    public $rh02_tbprev = 0;
    public $rh02_hrsmen = 0;
    public $rh02_hrssem = 0;
    public $rh02_ocorre = null;
    public $rh02_equip = 'f';
    public $rh02_tpcont = 0;
    public $rh02_vincrais = 0;
    public $rh02_salari = 0;
    public $rh02_lota = 0;
    public $rh02_funcao = 0;
    public $rh02_rhtipoapos = null;
    public $rh02_validadepensao_dia = null;
    public $rh02_validadepensao_mes = null;
    public $rh02_validadepensao_ano = null;
    public $rh02_validadepensao = null;
    public $rh02_deficientefisico = 'f';
    public $rh02_portadormolestia = 'f';
    public $rh02_datalaudomolestia_dia = null;
    public $rh02_datalaudomolestia_mes = null;
    public $rh02_datalaudomolestia_ano = null;
    public $rh02_datalaudomolestia = null;
    public $rh02_tipodeficiencia = 0;
    public $rh02_abonopermanencia = 'f';
    public $rh02_diasgozoferias = 0;
    public $rh02_horasdiarias = 0;
    public $rh02_cedencia = null;
    public $rh02_onus = null;
    public $rh02_ressarcimento = null;
    public $rh02_datacedencia_dia = null;
    public $rh02_datacedencia_mes = null;
    public $rh02_datacedencia_ano = null;
    public $rh02_datacedencia = null;
    public $rh02_cnpjcedencia = null;
    public $rh02_dataabonopermanencia_dia = null;
    public $rh02_dataabonopermanencia_mes = null;
    public $rh02_dataabonopermanencia_ano = null;
    public $rh02_dataabonopermanencia = null;
    public $rh02_descinstrumento = null;
    public $rh02_sitpagbeneficio = 'f';
    public $rh02_regimejornadatrabalho = null;
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 rh02_rhtipoapos = varchar(4) = Tipo de Apos./Pensão
                 ...
                 rh02_tipodeficiencia = int4 = Tipo de Deficiência
                 ...
                 rh02_onus = char(1) = Ônus
                 rh02_ressarcimento = char(1) = Ressarcimento
                 rh02_datacedencia = date = Data Movimentação
                 rh02_cnpjcedencia = varchar(20) = CNPJ Origem/Destino
                 rh02_regimejornadatrabalho = int8 = Regime da Jornada de Trabalho
                 rh02_dataabonopermanencia = date = Data de início abono permanência
                 rh02_descinstrumento = varchar(255) = Descrição do instrumento
                 rh02_sitpagbeneficio = bool = Pensão concedida Judicial
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao==false) {
            ...
            $this->rh02_regimejornadatrabalho = ($this->rh02_regimejornadatrabalho == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_regimejornadatrabalho"]:$this->rh02_regimejornadatrabalho);
            if ($this->rh02_dataabonopermanencia == "") {
                $this->rh02_dataabonopermanencia_dia = ($this->rh02_dataabonopermanencia_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_dataabonopermanencia_dia"]:$this->rh02_dataabonopermanencia_dia);
                $this->rh02_dataabonopermanencia_mes = ($this->rh02_dataabonopermanencia_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_dataabonopermanencia_mes"]:$this->rh02_dataabonopermanencia_mes);
                $this->rh02_dataabonopermanencia_ano = ($this->rh02_dataabonopermanencia_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_dataabonopermanencia_ano"]:$this->rh02_dataabonopermanencia_ano);
                if ($this->rh02_dataabonopermanencia_dia != "") {
                    $this->rh02_dataabonopermanencia = $this->rh02_dataabonopermanencia_ano."-".$this->rh02_dataabonopermanencia_mes."-".$this->rh02_dataabonopermanencia_dia;
                }
            }
            $this->rh02_descinstrumento = ($this->rh02_descinstrumento == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_descinstrumento"]:$this->rh02_descinstrumento);
            $this->rh02_sitpagbeneficio = ($this->rh02_sitpagbeneficio == "f"?@$GLOBALS["HTTP_POST_VARS"]["rh02_sitpagbeneficio"]:$this->rh02_sitpagbeneficio);
        } else {
            $this->rh02_instit = ($this->rh02_instit == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_instit"]:$this->rh02_instit);
            $this->rh02_seqpes = ($this->rh02_seqpes == ""?@$GLOBALS["HTTP_POST_VARS"]["rh02_seqpes"]:$this->rh02_seqpes);
        }
    ...
    public function incluir($rh02_seqpes, $rh02_instit)
    {
        $this->atualizacampos();
        ...
        if ($this->rh02_codreg == null) {
            $this->erro_sql = " Campo Cod. Regime não informado.";
        ...
        if ($this->rh02_regimejornadatrabalho === null || $this->rh02_regimejornadatrabalho === '') {
            $this->rh02_regimejornadatrabalho = "0";
        }
        if ($this->rh02_dataabonopermanencia == null) {
            $this->rh02_dataabonopermanencia = "null";
        }
        if ($this->rh02_sitpagbeneficio == null) {
            $this->rh02_sitpagbeneficio = 'f';
        }
        ...
        $sql = "insert into rhpessoalmov(
                ...
                values (
                               ...
                               ,'$this->rh02_cnpjcedencia'
                               ," . ($this->rh02_regimejornadatrabalho === null || $this->rh02_regimejornadatrabalho === '' ? 'NULL' : $this->rh02_regimejornadatrabalho) . "
                               ,".($this->rh02_dataabonopermanencia == "null" || $this->rh02_dataabonopermanencia == ""?"null":"'".$this->rh02_dataabonopermanencia."'")."
                               ,'$this->rh02_descinstrumento'
                               ,'$this->rh02_sitpagbeneficio'
                      )";
        $result = db_query($sql);
        if ($result==false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco!=false)||($this->numrows!=0)) {
                ...
                $resac = db_query("insert into db_acount values($acount,1158,1010558,'','".AddSlashes(pg_result($resaco, 0, 'rh02_regimejornadatrabalho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1158,1013571,'','".AddSlashes(pg_result($resaco, 0, 'rh02_dataabonopermanencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1158,1013963,'','".AddSlashes(pg_result($resaco, 0, 'rh02_descinstrumento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1158,1013964,'','".AddSlashes(pg_result($resaco, 0, 'rh02_sitpagbeneficio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
        return true;
    }
    ...
    public function alterar($rh02_seqpes = null, $rh02_instit = null)
    {
        ...
        if ($this->rh02_rhtipoapos!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh02_rhtipoapos"])) {
            if ($this->rh02_rhtipoapos=="" && isset($GLOBALS["HTTP_POST_VARS"]["rh02_rhtipoapos"])) {
                $this->rh02_rhtipoapos = "0" ;
            }
        ...
        if (trim($this->rh02_regimejornadatrabalho) !== '' && $this->rh02_regimejornadatrabalho !== null) {
            $sql .= "{$virgula} rh02_regimejornadatrabalho = {$this->rh02_regimejornadatrabalho} ";
        } else {
            $sql .= "{$virgula} rh02_regimejornadatrabalho = NULL ";
        }

        if (trim($this->rh02_dataabonopermanencia) !== '' && $this->rh02_dataabonopermanencia !== null) {
            $sql .= "{$virgula} rh02_dataabonopermanencia = '{$this->rh02_dataabonopermanencia}' ";
        } else {
            $sql .= "{$virgula} rh02_dataabonopermanencia = NULL ";
        }
        if (trim($this->rh02_descinstrumento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh02_descinstrumento"])) {
            $sql  .= $virgula." rh02_descinstrumento = '$this->rh02_descinstrumento' ";
            $virgula = ",";
        }
        if (trim($this->rh02_sitpagbeneficio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh02_sitpagbeneficio"])) {
            $sql  .= $virgula." rh02_sitpagbeneficio = '$this->rh02_sitpagbeneficio' ";
            $virgula = ",";
            if (trim($this->rh02_sitpagbeneficio) == null) {
                $this->rh02_sitpagbeneficio = 'f';
            }
        }
        $sql .= " where ";
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if ($this->numrows > 0) {
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["rh02_regimejornadatrabalho"]) || $this->rh02_regimejornadatrabalho != "") {
                        $resac = db_query("insert into db_acount values($acount,1158,1010558,'".AddSlashes(pg_result($resaco, $conresaco, 'rh02_regimejornadatrabalho'))."','$this->rh02_regimejornadatrabalho',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["rh02_dataabonopermanencia"]) || $this->rh02_dataabonopermanencia != "") {
                        $resac = db_query("insert into db_acount values($acount,1158,1013571,'".AddSlashes(pg_result($resaco, $conresaco, 'rh02_dataabonopermanencia'))."','$this->rh02_dataabonopermanencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["rh02_descinstrumento"]) || $this->rh02_descinstrumento != "") {
                        $resac = db_query("insert into db_acount values($acount,1158,1013963,'".AddSlashes(pg_result($resaco, $conresaco, 'rh02_descinstrumento'))."','$this->rh02_descinstrumento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["rh02_sitpagbeneficio"]) || $this->rh02_sitpagbeneficio != "") {
                        $resac = db_query("insert into db_acount values($acount,1158,1013964,'".AddSlashes(pg_result($resaco, $conresaco, 'rh02_sitpagbeneficio'))."','$this->rh02_sitpagbeneficio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                }
            }
        }
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco != false) || ($this->numrows!=0)) {
                for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
                    ...
                    $resac  = db_query("insert into db_acount values($acount,1158,1010558,'','".AddSlashes(pg_result($resaco, $iresaco, 'rh02_regimejornadatrabalho'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1158,1013571,'','".AddSlashes(pg_result($resaco, $iresaco, 'rh02_dataabonopermanencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1158,1013963,'','".AddSlashes(pg_result($resaco, $iresaco, 'rh02_descinstrumento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1158,1013964,'','".AddSlashes(pg_result($resaco, $iresaco, 'rh02_sitpagbeneficio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
...
// funcao do sql
    public function sql_query_file($rh02_seqpes = null, $rh02_instit = null, $campos = "*", $ordem = null, $dbwhere = "", $validaRhPessoal = false)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
   ...
   */
    ...
    function sql_query_baseServidores($iMesFolha, $iAnoFolha, $iInstituicao, $sCampos = "", $sWhere = "", $sOrdem = "", $sAgrupamento = "")
    {
        ...
        $sSQLBase = "with pensao as (select rhpesorigem.*, ";
        $sSQLBase.= "                       z01_nome as nome_instituidor_pensao";
        $sSQLBase.= "                  from rhpesorigem ";
        $sSQLBase.= "                       inner join rhpessoal on rhpessoal.rh01_regist = rhpesorigem.rh21_regpri ";
        ...
        $sSQLBase.= "                                              and rh02_anousu = {$iAnoFolha} ";
        $sSQLBase.= "                                              and rh02_mesusu = {$iMesFolha} ), ";
    
        $sSQLBase.= "     rhipe  as (select distinct rhipe.*, ";
        ...
        $sSQLBase.= "       inner join cgm                  on cgm.z01_numcgm                = rhpessoal.rh01_numcgm        \n";
        $sSQLBase.= "       left  join cgmfisico            on cgmfisico.z04_numcgm          = cgm.z01_numcgm               \n";
        $sSQLBase.= "       inner join rhpessoalmov         on rhpessoalmov.rh02_regist      = rhpessoal.rh01_regist        \n";
        ...
        $sSQLBase.= "       left  join rhlotaexe            on rhlotaexe.rh26_codigo         = rhlota.r70_codigo            \n";
        $sSQLBase.= "                                      and rhlotaexe.rh26_anousu         = rhpessoalmov.rh02_anousu     \n";
        $sSQLBase.= "       left  join orcorgao             on orcorgao.o40_orgao            = rhlotaexe.rh26_orgao         \n";
        $sSQLBase.= "                                      and orcorgao.o40_anousu           = rhpessoalmov.rh02_anousu     \n";
        $sSQLBase.= "                                      and orcorgao.o40_instit           = rhpessoalmov.rh02_instit     \n";
        $sSQLBase.= "       left  join rhlotavinc           on rhlotavinc.rh25_codigo        = rhlota.r70_codigo            \n";
        $sSQLBase.= "                                      and rhlotavinc.rh25_anousu        = rhpessoalmov.rh02_anousu     \n";
        $sSQLBase.= "       left  join orctiporec           on orctiporec.o15_codigo         = rhlotavinc.rh25_recurso      \n";
        ...
        $sSQLBase.= "       left  join rhipe                on rhipe.rh62_regist             = rhpessoal.rh01_regist        \n";
        $sSQLBase.= "       left  join pensao               on pensao.rh21_regist            = rhpessoal.rh01_regist        \n";
        ...
        $sSQLBase.= "       left  join rhtipoapos           on rhtipoapos.rh88_sequencial    = rhpessoalmov.rh02_rhtipoapos \n";
        $sSQLBase.= "       left  join rhcedencia           on rhcedencia.rh261_regist       = rhpessoal.rh01_regist        \n";
        $sSQLBase.= "       left  join rhpesprop            on rhpesprop.rh19_regist         = rhpessoal.rh01_regist        \n";
   ...
   */
    ...
    function sql_query_rescisao_afastamento($iAno, $iMes, $sWhere = "")
    {
        ...
        $sSql .= "        rh05_aviso,                                                                                                                                 \n";
        $sSql .= "        rh05_recis,                                                                                                                                 \n";
        $sSql .= "        rh01_observacao,                                                                                                                            \n";
        $sSql .= "        rh05_mremun,                                                                                                                                \n";
        $sSql .= "        rh05_feriasavos,                                                                                                                            \n";
        $sSql .= "        rh05_feriasvencidas,                                                                                                                        \n";
        $sSql .= "        rh05_13salarioavos,                                                                                                                         \n";
        $sSql .= "        h13_tpcont,                                                                                                                                 \n";
        $sSql .= "        r59_descr,                                                                                                                                  \n";
        $sSql .= "        o55_projativ,                                                                                                                               \n";
        $sSql .= "        o55_descr,                                                                                                                                  \n";
  ...
  /**
   * Retorna os servidores, juntamente com os duplos vinculos ativos.
   *
  ...
  /**
   * Retorna os servidores, juntamente com os duplos vinculos ativos ou rescindidos na ccompetencia informada por parâmetro.
   *
   * @param  string $sMatriculasMatriculas Sql que retorna uma lista de matriculas para ser buscado seus duplos vinculos.
   * @param  integer $iAnoUsu
   * @param  integer $iMesUsu
   ...
   * @return String sql
   */
    public function sql_servidores_duplo_vinculo_rescindidos($sMatriculasMatriculas, $iAnoUsu, $iMesUsu, $iInstit = null, $iOpcaoCalculo = null)
    {
        ...
        $sSql .= "        AND rh02_instit  = {$iInstit}                                                      ";
        if ($iOpcaoCalculo != 4) {
            $sSql .= "        and (rh05_recis is null or to_char(rh05_recis, 'yyyymm') >= '{$iAnoUsu}{$iMesUsu}') ";
        }

        return $sSql;
    }

    public function sql_query_matricula_cgm($rh02_seqpes = null, $rh02_instit = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= "  from rhpessoalmov ";
        $sql .= "      inner join rhpessoal  on rhpessoal.rh01_regist = rhpessoalmov.rh02_regist ";
        $sql .= "                           and rhpessoal.rh01_instit = rhpessoalmov.rh02_instit ";
    ...
    // funcao do sql
    public function sql_query_file_regime($rh02_seqpes = null, $rh02_instit = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= " from rhpessoalmov ";
        $sql  .= " inner join rhregime on rh30_codreg = rh02_codreg and rh30_instit = rh02_instit ";
    ...
    public function sql_query_movimentacao($regist, $ano = null, $mes = null, $instituicao = null)
    {

        if (empty($ano)) {
            $ano = DBPessoal::getMesFolha();
        }
        if (empty($mes)) {
        ...
        $sql = "select rhpessoalmov.*,
                       ...
                       padroes.r02_descr,
                       rh03_padraoprev,
                       padraoprev.r02_descr as r02_descrprev,
                       h13_tpcont,
                       h13_descr,
                       rh02_regimejornadatrabalho,
                       rh19_propi,
                       rh163_sequencial as contrato_emergencial,
                       rh164_datafim,
                       db90_codban,
                       db90_descr,
                       db89_codagencia,
                       ...
                       rh05_trct,
                       rh216_numcgm as tomador,
                       tomadorcgm.z01_nome as tomador_nome
                  from rhpessoal
                       ...
                       inner join rhregime on rhregime.rh30_codreg = rhpessoalmov.rh02_codreg
                                          and rhregime.rh30_instit  = rhpessoalmov.rh02_instit
                       left  join tipodeficiencia on tipodeficiencia.rh150_sequencial = rhpessoalmov.rh02_tipodeficiencia
                       ...
                       left join padroes as padraoprev on padraoprev.r02_anousu = rhpespadrao.rh03_anousu
                                                      and padraoprev.r02_mesusu = rhpespadrao.rh03_mesusu
                                                      and padraoprev.r02_regime = rhpespadrao.rh03_regime
                                                      and padraoprev.r02_codigo = rhpespadrao.rh03_padraoprev
                                                      and padraoprev.r02_instit = rhpessoalmov.rh02_instit
                       left join tpcontra on tpcontra.h13_codigo = rhpessoalmov.rh02_tpcont
                       left join rhpesprop on rhpesprop.rh19_regist = rhpessoalmov.rh02_regist
                       ...
                       left join rhcontratoemergencial on rhcontratoemergencial.rh163_matricula = rhpessoalmov.rh02_regist
                       left join rhcontratoemergencialrenovacao on rhcontratoemergencialrenovacao.rh164_contratoemergencial = rhcontratoemergencial.rh163_sequencial
                       left join rhpessoalmovcontabancaria on rhpessoalmovcontabancaria.rh138_rhpessoalmov = rhpessoalmov.rh02_seqpes
                                                          and rhpessoalmovcontabancaria.rh138_instit = rhpessoalmov.rh02_instit
                       left join contabancaria on contabancaria.db83_sequencial = rhpessoalmovcontabancaria.rh138_contabancaria
                       left join bancoagencia on bancoagencia.db89_sequencial = contabancaria.db83_bancoagencia
                       left join db_bancos on db_bancos.db90_codban = bancoagencia.db89_db_bancos
                       left join tomador on tomador.rh216_seqpes = rhpessoalmov.rh02_seqpes
                       left join cgm as tomadorcgm on tomadorcgm.z01_numcgm = tomador.rh216_numcgm
  ...
  *@return bool
  *@throws Exception*
  *Retorna true se o servidor tiver desconto de IRRF na competencia
  */

  public function temDescontoIRRF ($rh02_regist,$mesCompetencia, $anoCompetencia) {
    $sql = "SELECT rh02_regist from pessoal.rhpessoalmov
              LEFT JOIN pessoal.gerfsal on r14_regist = rh02_regist and r14_mesusu = rh02_mesusu and r14_anousu = rh02_anousu
              LEFT JOIN pessoal.gerfcom on r48_regist = rh02_regist and r48_mesusu = rh02_mesusu and r48_anousu = rh02_anousu
              LEFT JOIN pessoal.gerfres on r20_regist = rh02_regist and r20_mesusu = rh02_mesusu and r20_anousu = rh02_anousu
              LEFT JOIN pessoal.gerfs13 on r35_regist = rh02_regist and r35_mesusu = rh02_mesusu and r35_anousu = rh02_anousu
              WHERE rh02_regist = $rh02_regist and rh02_mesusu = $mesCompetencia and rh02_anousu = $anoCompetencia
              AND ( r14_rubric IN ('R913','R915')
                        OR r48_rubric IN ('R915')
                        OR r20_rubric in ('R913','R914','R915')
                        OR r35_rubric in ('R914')
              );
              ";
    ...
    if (!$rsIRRF) {
        throw new Exception("Erro ao verificar se o servidor tem desconto de IRRF");
    }

    return (bool) pg_num_rows($rsIRRF);
