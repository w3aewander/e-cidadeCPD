    ...
    <td height="63" align="center" valign="top">
      <form name="form2" method="post" action="" >
        <fieldset style="width: 35%">
          <legend>Pesquisa da Função</legend>
          <table width="35%" border="0" align="center" cellspacing="0">
            <tr>
              <td width="4%" align="left" nowrap title="Função">
                <strong>C&oacute;digo:</strong>
              </td>
              <td width="96%" align="left" nowrap>
                <?php
  		            db_input("rh241_sequencial", 5, "Codigo", true, "text", 4, "", "chave_rh37_funcao");
  		          ?>
              </td>
            </tr>
            <tr>
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (!isset($campos)) {
          ...
          if (file_exists("funcoes/db_func_rhfuncao.php")) {
            include(modification("funcoes/db_func_rhfuncao.php"));
          } else {
            $campos = "rhfuncao.*";
          }
        }
