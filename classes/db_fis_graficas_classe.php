...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_graficas");
...
public function incluir ($y20_grafica){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_graficas(
                                       y20_grafica
                                      ,y20_id_usuario
                                      ,y20_data
...
public function alterar ($y20_grafica=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_graficas set ";
     $virgula = "";
...
public function excluir ($y20_grafica=null,$dbwhere=null) {



     $sql = " delete from fiscalizacao.fis_graficas
                    where ";
     $sql2 = "";
...
public function sql_record($sql) {
   ...
   // funcao do sql
public function sql_query ( $y20_grafica=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_graficas ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_graficas.y20_grafica";
     $sql .= "      inner join db_usuarios  on  db_usuarios.id_usuario = fis_graficas.y20_id_usuario";
     $sql2 = "";
     if($dbwhere==""){
       if($y20_grafica!=null ){
         $sql2 .= " where fis_graficas.y20_grafica = $y20_grafica ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql
public function sql_query_file ( $y20_grafica=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
