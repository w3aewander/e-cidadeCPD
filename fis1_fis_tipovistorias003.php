...
//echo ("select * from fiscalizacao.fis_vistorias where y77_codtipo = $y77_codtipo limit 1");

if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  $excluir = 'excluir';
  $rsVerificaTipo = pg_query("select * from fiscalizacao.fis_vistorias where y70_tipovist = $y77_codtipo limit 1");
  if ( pg_numrows($rsVerificaTipo) > 0 ) {
    db_msgbox("Existe vistorias lancada para este tipo, exclusão abortada ");
	  db_redireciona("fis1_fis_tipovistorias003.php");
	  exit;
  }
  db_inicio_transacao();
  $db_opcao = 3;
