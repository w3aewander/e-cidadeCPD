...
for($contador=0;$contador<$numrows_matestoqueini;$contador++){
  ...
  // Verifica se é uma transferência cancelada
  $sSqlVerificaCancelada = $clmatestoqueinil->sql_query_file(null, "1", "", "m86_matestoqueini = {$m80_codigo}");
  $rsVerificaCancelada = $clmatestoqueinil->sql_record($sSqlVerificaCancelada);
...
//$pdf1->Rhora       = $m80_hora;
    ...
    $sSqlItensCampos = "m60_codmater,m60_descr,m61_descr,sum(m82_quant) as m82_quant, m77_lote, m77_dtvalidade";
    $sSqlItens = $clmatestoqueini->sql_query_qua($m80_codigo, $sSqlItensCampos, "m60_descr", "matestoqueini.m80_codigo = $m80_codigo group by m60_codmater,m60_descr,m61_descr, m77_lote, m77_dtvalidade ");
