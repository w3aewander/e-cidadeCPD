    ...
    <form method="post" name="form1">
      <fieldset>
        ...
        <table class="form-container">
          ...
          <tr>
			...
			<tr>
				...
				<td>
				   <input type='text' name='codigo1' id='codigo1' size="10" style="background: #dcc594;" readonly>
        ...
        <fieldset class='separator'>
          <legend></legend>
          <div style="visibility: hidden;" id='listaDisciplinas' style="padding-left: 10%;"></div>
        </fieldset>
        ...
        <table class="form-container">
                  ...
                  <tr>
                    ...
                    <td class="field-size-max">
                      <select id="listaModelos" onchange="liberaFiltrosPorModelo();">
                        ...
                        <option value="3" disabled>Modelo 3 - Duas páginas por disciplina (Página 1 - Presenças / Página 2 - Avaliações)</option>
          ...
          <tr>
            <td colspan="2">
              <fieldset class="separator" style="visibility: hidden;">
                <legend>Exibir Capa</legend>
                <table>
                <tr>
                    <td>
                      <label for="capa">
                        <input id="capa" type="checkbox" name="colunas">
                        Capa
                      </label>
                </tr>
                  ...
                  <tr style="visibility:hidden">
                    <td>
                      <label for="avaliacoes">
                        <input id="avaliacoes" type="checkbox" name="colunas" checked >
                        Avaliações
                      </label>
                      <label for="dataPeriodo">
                        <input id="dataPeriodo" type="checkbox" name="colunas" checked>
                        Data do Período
                      </label>
                      <label for="totalFaltas">
                        <input id="totalFaltas" type="checkbox" name="colunas" checked>
                        Total de Faltas
                      </label>
                      <label for="sexo">
          ...
          <tr style="visibility:hidden">
            ...
            <td>
              <select id="registro">
                <option value="M" disabled>Manual</option>
                <option value="F" selected disabled>Frequência / Conteúdo</option>
              </select>
            </td>
          </tr>
          ...
          <tr style="visibility:hidden">
            ...
            <td>
              <select id="exibirPontos">
                <option value="S" selected disabled>SIM</option>
          ...
          <tr style="visibility:hidden">
            ...
            <td>
              <select id="alunosAtivos">
                <option value="S" disabled>SIM</option>
                <option value="N" selected disabled>NÃO</option>
              </select>
            </td>
          </tr>
          <tr style="visibility:hidden">
...
var oPeriodo             = new DBViewFormularioEducacao.ListaPeriodoAvaliacao();
    ...
    oPeriodo.somentePeriodoCalculaCargaHoraria( false );
...
function imprimir() {
  ...
  var iPeriodoSelecionado     = oPeriodo.getSelecionado().iCodigo;
  var nPeriodo                = oPeriodo.getSelecionado().sDescricao;
  var aDisciplinaSelecionadas = oDisciplina.getSelecionados();
  var aRegencias              = [];
  var aRegenciasSemGrade      = [];
  document.form1.z01_numcgm.value;
  var sUrl         = "edu2_diarioclasseobs002.php";
  var sParametros  = "?iCalendario=" + iCalendarioSelecionado;
	  ...
	  sParametros += "&nPeriodo="    + nPeriodo;
	  sParametros += "&iAdicion="    + document.form1.z01_numcgm.value;
	  sParametros += "&nAdicion="    + document.form1.z01_nome.value;
      sParametros += "&iDisciplina=" + document.form1.codigo1.value;
...
function js_mostra2(chave2,chave3){
  document.form1.codigo1.value    = chave2;
