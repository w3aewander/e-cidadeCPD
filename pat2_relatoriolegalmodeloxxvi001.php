...
<form class="container" name="form1" method="post">
	<fieldset>
  	<legend>Demonstrativo da Movimentacao - Bens Patrimoniais no Exercicio</legend>
...
function js_abre(){ 
  var sFonte = "pat2_relatoriolegalmodeloxxvi002.php";  
...
function js_abre2(){   
  var sFonte = "pat2_relatoriolegalmodeloxxvi002novo.php";
  var sExercicio = $F('db_exercicio');
  var iTipoRelatorio     = $F("iTipoRelatorio");
  var sMatricula = $F('db_matricula');
  var sNome = $F("db_nome");
