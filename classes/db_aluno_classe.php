...
class cl_aluno
{
   ...
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 registropai = int4 = Registrado no nome do pai
                 aimagem = int4 = Autorização de Imagem
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao==false) {
            ...
            $this->registropai = ($this->registropai == ""?@$GLOBALS["HTTP_POST_VARS"]["registropai"]:$this->registropai);
            $this->aimagem = ($this->aimagem == ""?@$GLOBALS["HTTP_POST_VARS"]["aimagem"]:$this->aimagem);
        } else {
            $this->ed47_i_codigo = ($this->ed47_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_codigo"]:$this->ed47_i_codigo);
        }
    }
    ...
    public function alterar($ed47_i_codigo = null)
    {
        ...
        if (trim($this->registropai) != "" || isset($GLOBALS["HTTP_POST_VARS"]["registropai"])) {
            $sql  .= $virgula." registropai = '$this->registropai' ";
            $virgula = ",";
        }
        if (trim($this->aimagem) != "" || isset($GLOBALS["HTTP_POST_VARS"]["aimagem"])) {
            $sql  .= $virgula." aimagem = '$this->aimagem' ";
            $virgula = ",";
        }
