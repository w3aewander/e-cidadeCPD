...
class cl_matestoqueitem
{
    ...
    public function incluir($m71_codlanc)
    {
        $this->atualizacampos();
    ...
    public function alterar($m71_codlanc = null)
    {
        $this->atualizacampos();
    ...
    public function excluir($m71_codlanc = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query($m71_codlanc = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    // funcao do sql
    public function sql_query_file($m71_codlanc = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_unid($m71_codlanc = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_lote($m71_codlanc = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_farmacia($m71_codlanc = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
        ...
        $sql .= "      left join matestoqueitemfabric  on  m71_codlanc = m78_matestoqueitem";
        $sql .= "      left join matfabricante  on  m78_matfabricante = m76_sequencial";
        $sql .= "      left join cgm  on  m76_numcgm = cgm.z01_numcgm";
        $sql .= "      left join distribuidor on m105_matestoqueitem = m71_codlanc";
        $sql .= "      left join cgm as cgmdistribuidor on cgmdistribuidor.z01_numcgm = m105_cgm";
        $sql2 = " where ";
        if ($dbwhere == "") {
            if ($m71_codlanc != null) {
                $sql2 .= " matestoqueitem.m71_codlanc = $m71_codlanc ";
