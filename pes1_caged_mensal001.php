...
if (isset($gerar)) {
  ...
  if ($cldb_config->numrows == 0) {
    ...
    if ($clcfpess->numrows == 0) {
      ...
      $sCampos = " distinct rh02_instit, rh01_regist, rh05_recis, rh16_ctps_uf, rh01_sexo, rh02_salari, r02_valor, ";
      $sCampos .= "rh05_causa, rh01_tipadm, rh02_tpcont, rh01_raca, rh01_admiss,  rh02_hrssem, z01_nome, ";
      $sCampos .= "z01_cep, z01_cgccpf, rh37_cbo, rh16_ctps_s, rh16_ctps_n, rh01_instru, rh01_nasc, rh16_pis ";
      ...
      $sCampos .= ",
       ...
       $sql_dad = $clgera_sql_folha->gerador_sql("", $anousu, $mesusu, null, null, $sCampos,
                                                 " rh01_admiss, rh05_recis ", "rh30_regime = 2",
