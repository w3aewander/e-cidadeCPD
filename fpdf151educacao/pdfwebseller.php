...
//#99#//}
    ...
    //var_dump(db_getsession("DB_instit")); ==96
    ...
    if ($_SESSION["DB_modulo"] == 1100747) {
      ...
      */
      ...
      if(db_getsession("DB_instit") == 96){
        $this->Text(33,9,"ESTADO DO RIO DE JANEIRO");
        $this->Text(33,12,"PREFEITURA MUNICIPAL DE VOLTA REDONDA");
        $this->Text(33,15,"SECRETARIA MUNICIPAL DE EDUCAÇÃO");
        $this->Text(33,20,$nomeescola);
        $this->SetFont('Arial','I',8);
        //$this->Text(33,23,$ruaescola.", ".$numescola." - ".$bairroescola);
        $this->Text(33,26,$cidadeescola." - ".$estadoescola);
        $this->Text(33,29,$telefoneescola);
      }else{
        $this->Text(33,9,$nome);  
      ...
      $this->Text(33,32,($emailescola!=""?$emailescola." - ":"").$url);
      $Espaco = $this->w - 80 ;
      ...
      if(db_getsession("DB_itemmenu_acessado") == 7011 || db_getsession("DB_itemmenu_acessado") == 1100923){
  ...
  function Hextra($xx, $yy){    
    ...
    */
    ...
    $this->SetFont('Arial','BI',$TamFonteNome);
      ...
      $this->Text(33,9+$yy,"ESTADO DO RIO DE JANEIRO");
      $this->Text(33,12+$yy,"PREFEITURA MUNICIPAL DE VOLTA REDONDA");
      $this->Text(33,15+$yy,"SECRETARIA MUNICIPAL DE EDUCAÇÃO");
      $this->Text(33,20+$yy,$nomeescola);
      $this->SetFont('Arial','I',8);
      //$this->Text(33,23,$ruaescola.", ".$numescola." - ".$bairroescola);
      $this->Text(33,26+$yy,$cidadeescola." - ".$estadoescola);
      $this->Text(33,29+$yy,$telefoneescola);
