...
if (isset($incluir)) {
  ...
  db_inicio_transacao();
  $clsec_parametros->ed290_permite_alteracao_proc_avaliacao = $_POST['ed290_permite_alteracao_proc_avaliacao'];
  $clsec_parametros->ed290_habilitarcampostransescolar = $_POST['ed290_habilitarcampostransescolar'];
