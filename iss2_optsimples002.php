...
$sCamposSimples  .= "    when isscadsimples.q38_categoria = 3 then 'MEI'                      ";
$sCamposSimples  .= "    when isscadsimples.q38_categoria = 4 then 'EIRELI'                   ";
$sCamposSimples  .= "    else 'Soc. Profissionais'                                            ";
...
switch ($oGet->categoria) {
  ...
  break;
  case '4':
   $aListaHead[] = " Somente EIRELI";
  break;
  case '5':
   $aListaHead[] = " Somente Soc. Profissionais";
  break;
}
