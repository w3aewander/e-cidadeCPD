    ...
    if ($iModulo != 7159) {
      ...
      if ( !empty($iBaseCurricularImportacao) ) {
        ...
        for( $iContador = 0; $iContador < $iTotalDisciplinas; $iContador++ ) {
          ...
          $oDaoBaseMps->ed34_tipobase               = $oDadosDisciplina->ed34_tipobase;
          $oDaoBaseMps->ed34_areaconhecimento       = empty($oDadosDisciplina->ed34_areaconhecimento) ? "null" : 
                                                      $oDadosDisciplina->ed34_areaconhecimento;
