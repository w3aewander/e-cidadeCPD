...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_resptecnico");
...
public function incluir ($y22_codsani,$y22_numcgm){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_resptecnico(
                                       y22_codsani
                                      ,y22_numcgm
                       )
                values (
...
public function alterar ($y22_codsani=null,$y22_numcgm=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_resptecnico set ";
     $virgula = "";
...
public function excluir ($y22_codsani=null,$y22_numcgm=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_resptecnico
                    where ";
     $sql2 = "";
...
public function sql_query ( $y22_codsani=null,$y22_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_resptecnico ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_resptecnico.y22_numcgm";
     $sql .= "      inner join fiscalizacao.fis_sanitario  on  fis_sanitario.y80_codsani = fis_resptecnico.y22_codsani";
     ...
     $sql .= "      inner join cgm a  on  a.z01_numcgm = fis_sanitario.y80_numcgm";
     $sql2 = "";
     if($dbwhere==""){
       if($y22_codsani!=null ){
         $sql2 .= " where fis_resptecnico.y22_codsani = $y22_codsani ";
       }
       if($y22_numcgm!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_resptecnico.y22_numcgm = $y22_numcgm ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y22_codsani=null,$y22_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
