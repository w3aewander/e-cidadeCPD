...
<script>
    function validaCgmMatricula() {
        var sRpc = "pes1_rhipe001.RPC.php";
        var iNumCgm = $F('rh63_numcgm');
        var params = {};
            params.exec = 'cgmFolha';
            params.iNumCgm = iNumCgm;
        var request = new AjaxRequest(sRpc, params, function (oRetorno, oErro) {
            if (oRetorno.hasMatricula == false) {
        ...
        }).setMessage("Verificando matrícula...").execute();
    }
