  ...
  */
  ...
  if(isset($e87_codgera)){
    ...
    echo "
      <td align='left' nowrap>
    ";
    $sqlInf = $clempageconfgera->sql_query_inf(null,@$e87_codgera,"distinct e83_codtipo,e83_descr");
    $result_empagetipo = $clempageconfgera->sql_record($sqlInf);
...
<div style="margin-top: 10px;">
 ...
 <input name="act" id="act" type="button" <?=$desabilita?> onclick='js_gerarel();'  value="Mostrar retorno">
</div>
...
function js_gerarel() {
  ...
  if (document.form1.e75_codret && document.form1.e75_codret.value != "") {
    ...
    query = "retorno="+document.form1.e75_codret.value+"&codgera="+document.form1.e87_codgera.value;
