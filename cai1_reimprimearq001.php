...
$sqlSlip  = "select distinct k153_slipoperacaotipo as codigo_operacao_slip,
                    ...
                    ( case when pc63_banco is not null and k17_numcgm != (select numcgm from db_config where codigo = ".db_getsession('DB_instit').")
	                  ...
	                  e83_codigocompromisso,
                      conplanoconta.c63_identificador as c63_identificador
               from empageconfgera
    ...
    $conveniobb .= '0126';
     ...
     if ($pc63_banco == $banco) {
      ...
      db_setaPropriedadesLayoutTxt($db_layouttxt,2);
	    ...
	    $registro += 1;
	    $compensacao = "   ";
	    if ($pc63_banco == $banco || $valorori < 1000) {
	      if ($banco=="001") {
		      //$compensacao = "700";
		      $compensacao = "018";
	      } else {
	  ...
	  if ($banco == "104") {
        ...
        if (empty($pc63_codigooperacao)) {        	        	
          ...
          //$conta_fav  = $pc63_codigooperacao . str_pad($conta_fav, 7, 0, STR_PAD_LEFT);
