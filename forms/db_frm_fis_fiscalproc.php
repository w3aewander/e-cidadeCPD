    ...
    <table>
      ...
      <tr>
       <td nowrap>
        ...
        <td nowrap>
           <?php 
    	       $tipo = array("N"=>"Notificação","I"=>"Intimação","A"=>"Auto", "L" => "Notificação de Lançamento");
...
function js_pesquisay29_tipoandam(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_tipoandam','func_fis_tipoandam.php?funcao_js=parent.js_mostratipoandam1|y41_codtipo|y41_descr','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_tipoandam','func_fis_tipoandam.php?pesquisa_chave='+document.form1.y29_tipoandam.value+'&funcao_js=parent.js_mostratipoandam','Pesquisa',false);
  }
}
...
function js_pesquisa_tipofisc(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_tipofiscaliza','func_fis_tipofiscaliza.php?funcao_js=parent.js_mostratipo1|y27_codtipo|y27_descr','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_tipofiscaliza','func_fis_tipofiscaliza.php?pesquisa_chave='+document.form1.y29_tipofisc.value+'&funcao_js=parent.js_mostratipo','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_fiscalprocdepto','func_fis_fiscalprocdepto.php?funcao_js=parent.js_preenchepesquisa|y29_codtipo','Pesquisa',true);
}
function js_preenchepesquisa(chave){
  ...
  if($db_opcao == 2 || $db_opcao == 22){
    echo " location.href = 'fis1_fis_fiscalproc002.php?abas=1&chavepesquisa='+chave;";
  }elseif($db_opcao == 33 || $db_opcao == 3){
    echo " location.href = 'fis1_fis_fiscalproc003.php?abas=1&chavepesquisa='+chave;";
  }
 ?>
}
...
function js_pesquisa_codpa(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_fiscalprocdepto','func_fis_fiscalprocdepto.php?funcao_js=parent.js_mostrafiscalprocpa1|y29_codtipo|y29_descr','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_fiscalprocdepto','func_fis_fiscalprocdepto.php?pesquisa_chave='+document.form1.y61_codtipo.value+'&funcao_js=parent.js_mostrafiscalprocpa','Pesquisa',false);
  }
}
