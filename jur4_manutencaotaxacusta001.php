    ...
    <body bgcolor=#CCCCCC>
        <form class="container" name="form1" method="post">
            <fieldset>
                ...
                <fieldset>
                    <legend><label for="motivoIsencao">Justificativa da Isenção:</label></legend>
                    <textarea id="motivoIsencao" style="width: 100%; height: 60px;"></textarea>
            </fieldset>
            </fieldset>
...
function mostraInicial(iInicial, lErro) {
    ...
    if (lErro == true) {
        ...
        var ajaxCallBack = function(oRetorno, lErro) {
            ...
            $('motivoIsencao').value = oRetorno.oDados.sJustificativa;
...
function processar() {
    ...
    var aParametros = {
        ...
        "aTaxas": aTaxas,
        "sJustificativa": $F('motivoIsencao')
    };
