...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      if ($itemMenuSessao === 3389 || $itemMenuSessao === 3388) {
        $aWhere[] = ' c53_tipo in (3000) ';
        $aWhere[] = " not exists (select 1 from conlancamretificacao where c135_codlaninclusao = c70_codlan or c135_codlanestorno = c70_codlan or c135_codlannovo = c70_codlan) ";
      }
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_c69_sequen) && (trim($chave_c69_sequen) != "")) {
          ...
          if (isset($pesquisar)) {
            ...
            $iChave   = null;
            $sOrder   = "c69_data, c69_sequen desc";
