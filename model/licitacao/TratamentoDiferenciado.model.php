...
class TratamentoDiferenciado {
  ...
  private function incluirItemRegistroPreco(itemSolicitacao $oItemSolicitacaoReserva, itemSolicitacao $oItemSolicitacaoOrigem) {
     ...
     */
    $oItemCompilacaoOrigem = new itemCompilacao($oItemSolicitacaoOrigem->getCodigoItemSolicitacao());
    $oItemCompilacaoOrigem->setQuantidadeMaxima($oItemSolicitacaoOrigem->getQuantidade());
    $oItemCompilacaoOrigem->carregarItensEstimativa();
    $oItemCompilacaoOrigem->save();

    $oItemCompilacaoReserva = new itemCompilacao($oItemSolicitacaoReserva->getCodigoItemSolicitacao());
    $oItemCompilacaoReserva->carregarItensEstimativa();
    $oItemCompilacaoReserva->save();
  }
