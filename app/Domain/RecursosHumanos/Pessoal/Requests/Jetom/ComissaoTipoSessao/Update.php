...
class Update extends BaseFormRequest
{
    ...
    {
        $tiposessao_original = ComissaoTipoSessao::where(
            'rh249_sequencial',
            $this->id
        )
        ->first()
        ...
        return [
            'id' => 'required|integer|exists:jetomcomissaotiposessao,rh249_sequencial',
            'comissao' => [
                'required',
                'integer',
            ...
            'tiposessao' => [
                ...
                Rule::unique("jetomcomissaotiposessao", "rh249_tiposessao")
                    ...
                    ->whereNot("rh249_tiposessao", $tiposessao_original)
            ],
            'quantidade' => [
                'integer',
                'required'
