...
function js_pesquisay21_codnoti(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscal.php?funcao_js=parent.js_mostrafiscal1|y30_codnoti|y30_data','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y21_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
...
function js_pesquisay21_codvist(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y21_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscalvistorias','func_fis_fiscalvistorias.php?funcao_js=parent.js_preenchepesquisa|y21_codnoti|1','Pesquisa',true);
}
