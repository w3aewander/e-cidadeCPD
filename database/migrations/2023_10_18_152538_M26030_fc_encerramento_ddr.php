...
class M26030FcEncerramentoDdr extends Migration
{
    /**
     * @return void
     */
          ...
          and c45_instit = instituicaoSessao
            ...
            for rRecursoEncerrar in (
                ...
                select 1 as tipo_recurso,
                       ...
                       round( sum(case when conlancamval.c69_debito = resourceContas.c47_debito then c70_valor else 0 end) +
                              coalesce( ( select c62_vlrdeb
                                          from conplanoexe
                                          where c62_reduz = resourceContas.c47_debito
                                            and c62_anousu = anoSessao ),0) ,2)
                         as valor_debito,
                       round(sum(case when conlancamval.c69_credito = resourceContas.c47_debito then c70_valor else 0 end) +
