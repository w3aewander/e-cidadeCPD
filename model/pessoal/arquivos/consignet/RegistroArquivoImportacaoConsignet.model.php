...
class RegistroArquivoImportacaoConsignet extends RegistroArquivoImportacao {
  ...
  public function persist(RegistroArquivoImportacaoConsignet $oRegistro = null){
    ...
    $oDaoConsignadoMovimentoServidorRubrica->rh153_econsignado                 = $oRegistro->geteConsignado();
    ...
    $oRegistroSalvo->seteConsignado($oDaoConsignadoMovimentoServidorRubrica->rh153_econsignado);
