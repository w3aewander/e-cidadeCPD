...
class cl_cfpess
{
   // cria variaveis de erro
    ...
    public $r11_anousu = 0;
    public $r11_mesusu = 0;
    public $r11_codaec = null;
    public $r11_natest = null;
    public $r11_cdfpas = 0;
    public $r11_cdactr = 0;
    public $r11_peactr = 0;
    public $r11_pctemp = 0;
    public $r11_pcterc = 0;
    public $r11_fgts12 = 0;
    public $r11_cdcef = null;
    public $r11_cdfgts = null;
    public $r11_ultger_dia = null;
    public $r11_ultger_mes = null;
    public $r11_ultger_ano = null;
    public $r11_ultger = null;
    public $r11_ultfec_dia = null;
    public $r11_ultfec_mes = null;
    public $r11_ultfec_ano = null;
    public $r11_ultfec = null;
    public $r11_arredn = 0;
    public $r11_sald13 = 'f';
    public $r11_datai_dia = null;
    public $r11_datai_mes = null;
    public $r11_datai_ano = null;
    public $r11_datai = null;
    public $r11_dataf_dia = null;
    public $r11_dataf_mes = null;
    public $r11_dataf_ano = null;
    public $r11_dataf = null;
    public $r11_fecha = null;
    public $r11_ultreg = 0;
    public $r11_codipe = 0;
    public $r11_mes13 = 0;
    public $r11_tbprev = 0;
    ...
    public $r11_valor = 0;
    public $r11_dtipe = 0;
    public $r11_implan = null;
    public $r11_subpes = null;
    public $r11_rubmat = null;
    public $r11_eleina = null;
    public $r11_elepen = null;
    public $r11_rubnat = null;
    public $r11_rubdec = null;
    public $r11_qtdcal = 0;
    public $r11_palime = null;
    public $r11_altfer = null;
    public $r11_ferias = null;
    public $r11_fer13 = null;
    public $r11_ferant = null;
    public $r11_fer13o = null;
    public $r11_fer13a = null;
    public $r11_ferabo = null;
    public $r11_feabot = null;
    public $r11_feradi = null;
    public $r11_fadiab = null;
    public $r11_recalc = 'f';
    public $r11_pagaab = 'f';
    public $r11_fersal = null;
    public $r11_vtprop = 'f';
    public $r11_desliq = null;
    public $r11_propae = 'f';
    public $r11_propac = 'f';
    public $r11_codestrut = 0;
    public $r11_geracontipe = 'f';
    public $r11_13ferias = 'f';
    public $r11_pagarferias = null;
    public $r11_vtfer = 'f';
    public $r11_vtcons = 'f';
    public $r11_vtmpro = 'f';
    public $r11_localtrab = 0;
    public $r11_databaseatra_dia = null;
    public $r11_databaseatra_mes = null;
    public $r11_databaseatra_ano = null;
    public $r11_databaseatra = null;
    public $r11_rubpgintegral = null;
    public $r11_conver = null;
    public $r11_concatdv = 'f';
    public $r11_infla = null;
    public $r11_baseipe = null;
    public $r11_txadm = 0;
    public $r11_modanalitica = 0;
    public $r11_viravalemes = 'f';
    public $r11_histslip = 0;
    public $r11_mensagempadraotxt = null;
    public $r11_recpatrafasta = 'f';
    public $r11_relatoriocontracheque = 0;
    public $r11_relatorioempenhofolha = 0;
    public $r11_relatoriocomprovanterendimentos = 0;
    public $r11_relatoriotermorescisao = 0;
    public $r11_geraretencaoempenho = 'f';
    public $r11_percentualipe = 0;
    public $r11_datainiciovigenciarpps_dia = null;
    public $r11_datainiciovigenciarpps_mes = null;
    public $r11_datainiciovigenciarpps_ano = null;
    public $r11_datainiciovigenciarpps = null;
    public $r11_sistemacontroleponto = 0;
    public $r11_baseconsignada = null;
    public $r11_abonoprevidencia = null;
    public $r11_compararferias = 'f';
    public $r11_baseferias = null;
    public $r11_basesalario = null;
    public $r11_suplementar = 'f';
    public $r11_rubricasubstituicaoatual = null;
    public $r11_rubricasubstituicaoanterior = null;
    public $r11_rubricaescalaferias = null;
    public $r11_baserrarendimentostributaveis = null;
    public $r11_baserraprevidenciasocial = null;
    public $r11_baserrapensaoalimenticia = null;
    public $r11_baserrairrf = null;
    public $r11_baserraparcelaisenta = null;
    public $r11_tabelavaloresrra = 0;
    public $r11_basefgintegral = null;
    public $r11_basefgparcial = null;
    public $r11_rubricaabonopecuniario = null;
    public $r11_dataenviofase1_dia = null;
    public $r11_dataenviofase1_mes = null;
    public $r11_dataenviofase1_ano = null;
    public $r11_dataenviofase1 = null;
    public $r11_dataenviofase2_dia = null;
    public $r11_dataenviofase2_mes = null;
    public $r11_dataenviofase2_ano = null;
    public $r11_dataenviofase2 = null;
    public $r11_dataenviofase3_dia = null;
    public $r11_dataenviofase3_mes = null;
    public $r11_dataenviofase3_ano = null;
    public $r11_dataenviofase3 = null;
    public $r11_dataenviofase4_dia = null;
    public $r11_dataenviofase4_mes = null;
    public $r11_dataenviofase4_ano = null;
    public $r11_dataenviofase4 = null;
    public $r11_rubagrupaadiantamento = null;
    public $r11_filtralotacaousuario = 'f';
    public $r11_utilizarhlotavincrubrica = 'f';
    public $r11_emissaocontracheque = 'f';
    public $r11_bloqueiocompetenciaaberta = 'f';
    public $r11_rubricadifsalario = null;
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 r11_baserrarendimentostributaveis = varchar(255) = Total Rendimentos Tributáveis
                 ...
                 r11_rubricaabonopecuniario = varchar(10) = Rubrica para Abono em Pecúnia
                 r11_dataenviofase1 = date = Data Início fase 01 (Eventos Tabela)
                 r11_dataenviofase2 = date = Data Início fase 02 (Evt Não Periódicos)
                 r11_dataenviofase3 = date = Data Início fase 03 (Eventos Periódicos)
                 r11_dataenviofase4 = date = Data Início fase 04 (Eventos SST)
                 r11_rubagrupaadiantamento = varchar(4) = Rubrica de Agrupamento do Adiantamento do 13º Salário
                 r11_filtralotacaousuario = bool = Utiliza permissão de Lotação
                 r11_utilizarhlotavincrubrica = bool = Utiliza permissão de Lotação
                 r11_emissaocontracheque = bool = Contracheques gerados automaticamente e-storage
                 r11_bloqueiocompetenciaaberta = bool = Bloqueia competências em aberto
                 r11_rubricadifsalario = varchar(4) = Rubrica Dif. Reajuste Salarial 
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
     if($exclusao==false){
       ...
       $this->r11_rubricaabonopecuniario = ($this->r11_rubricaabonopecuniario == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_rubricaabonopecuniario"]:$this->r11_rubricaabonopecuniario);
       if($this->r11_dataenviofase1 == ""){
         $this->r11_dataenviofase1_dia = ($this->r11_dataenviofase1_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_dia"]:$this->r11_dataenviofase1_dia);
         $this->r11_dataenviofase1_mes = ($this->r11_dataenviofase1_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_mes"]:$this->r11_dataenviofase1_mes);
         $this->r11_dataenviofase1_ano = ($this->r11_dataenviofase1_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_ano"]:$this->r11_dataenviofase1_ano);
         if($this->r11_dataenviofase1_dia != ""){
            $this->r11_dataenviofase1 = $this->r11_dataenviofase1_ano."-".$this->r11_dataenviofase1_mes."-".$this->r11_dataenviofase1_dia;
         }
       }
       if($this->r11_dataenviofase2 == ""){
         $this->r11_dataenviofase2_dia = ($this->r11_dataenviofase2_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_dia"]:$this->r11_dataenviofase2_dia);
         $this->r11_dataenviofase2_mes = ($this->r11_dataenviofase2_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_mes"]:$this->r11_dataenviofase2_mes);
         $this->r11_dataenviofase2_ano = ($this->r11_dataenviofase2_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_ano"]:$this->r11_dataenviofase2_ano);
         if($this->r11_dataenviofase2_dia != ""){
            $this->r11_dataenviofase2 = $this->r11_dataenviofase2_ano."-".$this->r11_dataenviofase2_mes."-".$this->r11_dataenviofase2_dia;
         }
       }
       if($this->r11_dataenviofase3 == ""){
         $this->r11_dataenviofase3_dia = ($this->r11_dataenviofase3_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_dia"]:$this->r11_dataenviofase3_dia);
         $this->r11_dataenviofase3_mes = ($this->r11_dataenviofase3_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_mes"]:$this->r11_dataenviofase3_mes);
         $this->r11_dataenviofase3_ano = ($this->r11_dataenviofase3_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_ano"]:$this->r11_dataenviofase3_ano);
         if($this->r11_dataenviofase3_dia != ""){
            $this->r11_dataenviofase3 = $this->r11_dataenviofase3_ano."-".$this->r11_dataenviofase3_mes."-".$this->r11_dataenviofase3_dia;
         }
       }
       if($this->r11_dataenviofase4 == ""){
         $this->r11_dataenviofase4_dia = ($this->r11_dataenviofase4_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_dia"]:$this->r11_dataenviofase4_dia);
         $this->r11_dataenviofase4_mes = ($this->r11_dataenviofase4_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_mes"]:$this->r11_dataenviofase4_mes);
         $this->r11_dataenviofase4_ano = ($this->r11_dataenviofase4_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_ano"]:$this->r11_dataenviofase4_ano);
         if($this->r11_dataenviofase4_dia != ""){
            $this->r11_dataenviofase4 = $this->r11_dataenviofase4_ano."-".$this->r11_dataenviofase4_mes."-".$this->r11_dataenviofase4_dia;
         }
       }
       $this->r11_rubagrupaadiantamento = ($this->r11_rubagrupaadiantamento == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_rubagrupaadiantamento"]:$this->r11_rubagrupaadiantamento);
       $this->r11_filtralotacaousuario = ($this->r11_filtralotacaousuario == "f"?@$GLOBALS["HTTP_POST_VARS"]["r11_filtralotacaousuario"]:$this->r11_filtralotacaousuario);
       $this->r11_utilizarhlotavincrubrica = ($this->r11_utilizarhlotavincrubrica == "f"?@$GLOBALS["HTTP_POST_VARS"]["r11_utilizarhlotavincrubrica"]:$this->r11_utilizarhlotavincrubrica);
       $this->r11_emissaocontracheque = ($this->r11_emissaocontracheque == "f"?@$GLOBALS["HTTP_POST_VARS"]["r11_emissaocontracheque"]:$this->r11_emissaocontracheque);
       $this->r11_bloqueiocompetenciaaberta = ($this->r11_bloqueiocompetenciaaberta == "f"?@$GLOBALS["HTTP_POST_VARS"]["r11_bloqueiocompetenciaaberta"]:$this->r11_bloqueiocompetenciaaberta);
       $this->r11_rubricadifsalario = ($this->r11_rubricadifsalario == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_rubricadifsalario"]:$this->r11_rubricadifsalario);
     }else{
       $this->r11_instit = ($this->r11_instit == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_instit"]:$this->r11_instit);
       $this->r11_anousu = ($this->r11_anousu == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_anousu"]:$this->r11_anousu);
       $this->r11_mesusu = ($this->r11_mesusu == ""?@$GLOBALS["HTTP_POST_VARS"]["r11_mesusu"]:$this->r11_mesusu);
    ...
    public function incluir($r11_anousu,$r11_mesusu,$r11_instit)
    {
      $this->atualizacampos();
     ...
     if($this->r11_dataenviofase1 == null ){
       $this->r11_dataenviofase1 = "null";
     }
     if($this->r11_dataenviofase2 == null ){
       $this->r11_dataenviofase2 = "null";
     }
     if($this->r11_dataenviofase3 == null ){
       $this->r11_dataenviofase3 = "null";
     }
     if($this->r11_dataenviofase4 == null ){
       $this->r11_dataenviofase4 = "null";
     }
     if($this->r11_rubagrupaadiantamento == null ){
      $this->r11_rubagrupaadiantamento = "null";
    }
    if($this->r11_filtralotacaousuario == null ){
      $this->erro_sql = " Campo Utiliza permissão de Lotação não informado.";
      $this->erro_campo = "r11_filtralotacaousuario";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
    ...
    if($this->r11_utilizarhlotavincrubrica == null ){
      $this->erro_sql = " Campo Utiliza permissão de Lotação não informado.";
      $this->erro_campo = "r11_utilizarhlotavincrubrica";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
    ...
    if($this->r11_bloqueiocompetenciaaberta == null ){
       $this->erro_sql = " Campo Bloqueia competências em aberto não informado.";
       $this->erro_campo = "r11_bloqueiocompetenciaaberta";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
    ...
    if(($this->r11_mesusu == null) || ($this->r11_mesusu == "") ){
     ...
     $sql = "insert into cfpess(
                                      ...
                                      ,r11_basefgintegral
                                      ,r11_basefgparcial
                                      ,r11_rubricaabonopecuniario
                                      ,r11_dataenviofase1
                                      ,r11_dataenviofase2
                                      ,r11_dataenviofase3
                                      ,r11_dataenviofase4
                                      ,r11_rubagrupaadiantamento
                                      ,r11_filtralotacaousuario
                ...
                values (
                               ...
                               ,'$this->r11_rubricaabonopecuniario'
                               ,".($this->r11_dataenviofase1 == "null" || $this->r11_dataenviofase1 == ""?"null":"'".$this->r11_dataenviofase1."'")."
                               ,".($this->r11_dataenviofase2 == "null" || $this->r11_dataenviofase2 == ""?"null":"'".$this->r11_dataenviofase2."'")."
                               ,".($this->r11_dataenviofase3 == "null" || $this->r11_dataenviofase3 == ""?"null":"'".$this->r11_dataenviofase3."'")."
                               ,".($this->r11_dataenviofase4 == "null" || $this->r11_dataenviofase4 == ""?"null":"'".$this->r11_dataenviofase4."'")."
                               ,'$this->r11_rubagrupaadiantamento'
                               ,'$this->r11_filtralotacaousuario'
                               ,'$this->r11_utilizarhlotavincrubrica'
                               ,'$this->r11_emissaocontracheque'
                               ,'$this->r11_bloqueiocompetenciaaberta'
                               ,'$this->r11_rubricadifsalario'
                      )";
     $result = db_query($sql);
     if($result==false){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,536,1009752,'','".AddSlashes(pg_result($resaco,0,'r11_rubricaabonopecuniario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1013925,'','".AddSlashes(pg_result($resaco,0,'r11_dataenviofase1'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1013926,'','".AddSlashes(pg_result($resaco,0,'r11_dataenviofase2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1013927,'','".AddSlashes(pg_result($resaco,0,'r11_dataenviofase3'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1013928,'','".AddSlashes(pg_result($resaco,0,'r11_dataenviofase4'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014192,'','".AddSlashes(pg_result($resaco,0,'r11_rubagrupaadiantamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014231,'','".AddSlashes(pg_result($resaco,0,'r11_filtralotacaousuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014236,'','".AddSlashes(pg_result($resaco,0,'r11_utilizarhlotavincrubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014506,'','".AddSlashes(pg_result($resaco,0,'r11_emissaocontracheque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014596,'','".AddSlashes(pg_result($resaco,0,'r11_bloqueiocompetenciaaberta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,536,1014471,'','".AddSlashes(pg_result($resaco,0,'r11_rubricadifsalario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   // funcao para alteracao
    public function alterar($r11_anousu=null,$r11_mesusu=null,$r11_instit=null)
    {
     ...
     if(trim($this->r11_rubricaabonopecuniario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_rubricaabonopecuniario"])){
       $sql  .= $virgula." r11_rubricaabonopecuniario = '$this->r11_rubricaabonopecuniario' ";
       $virgula = ",";
     }
     if(trim($this->r11_dataenviofase1)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_dia"] !="") ){
       $sql  .= $virgula." r11_dataenviofase1 = '$this->r11_dataenviofase1' ";
       $virgula = ",";
     }     else{
       if(isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1_dia"])){
         $sql  .= $virgula." r11_dataenviofase1 = null ";
         $virgula = ",";
       }
     }
     if(trim($this->r11_dataenviofase2)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_dia"] !="") ){
       $sql  .= $virgula." r11_dataenviofase2 = '$this->r11_dataenviofase2' ";
       $virgula = ",";
     }     else{
       if(isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2_dia"])){
         $sql  .= $virgula." r11_dataenviofase2 = null ";
         $virgula = ",";
       }
     }
     if(trim($this->r11_dataenviofase3)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_dia"] !="") ){
       $sql  .= $virgula." r11_dataenviofase3 = '$this->r11_dataenviofase3' ";
       $virgula = ",";
     }     else{
       if(isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3_dia"])){
         $sql  .= $virgula." r11_dataenviofase3 = null ";
         $virgula = ",";
       }
     }
     if(trim($this->r11_dataenviofase4)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_dia"] !="") ){
       $sql  .= $virgula." r11_dataenviofase4 = '$this->r11_dataenviofase4' ";
       $virgula = ",";
     }     else{
       if(isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4_dia"])){
         $sql  .= $virgula." r11_dataenviofase4 = null ";
         $virgula = ",";
       }
     }
     if(trim($this->r11_rubagrupaadiantamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_rubagrupaadiantamento"])){
       $sql  .= $virgula." r11_rubagrupaadiantamento = '$this->r11_rubagrupaadiantamento' ";
       $virgula = ",";
     }
     if(trim($this->r11_filtralotacaousuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_filtralotacaousuario"])){
       $sql  .= $virgula." r11_filtralotacaousuario = '$this->r11_filtralotacaousuario' ";
       $virgula = ",";
       if(trim($this->r11_filtralotacaousuario) == null ){
         $this->erro_sql = " Campo Utiliza permissão de Lotação não informado.";
         $this->erro_campo = "r11_filtralotacaousuario";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->r11_utilizarhlotavincrubrica)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_utilizarhlotavincrubrica"])){
       $sql  .= $virgula." r11_utilizarhlotavincrubrica = '$this->r11_utilizarhlotavincrubrica' ";
       $virgula = ",";
       if(trim($this->r11_utilizarhlotavincrubrica) == null ){
         $this->erro_sql = " Campo Utiliza permissão de Lotação não informado.";
         $this->erro_campo = "r11_utilizarhlotavincrubrica";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->r11_bloqueiocompetenciaaberta)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_bloqueiocompetenciaaberta"])){
       $sql  .= $virgula." r11_bloqueiocompetenciaaberta = '$this->r11_bloqueiocompetenciaaberta' ";
       $virgula = ",";
       if(trim($this->r11_bloqueiocompetenciaaberta) == null ){
         $this->erro_sql = " Campo Bloqueia competências em aberto não informado.";
         $this->erro_campo = "r11_bloqueiocompetenciaaberta";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->r11_emissaocontracheque)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_emissaocontracheque"])){
       $sql  .= $virgula." r11_emissaocontracheque = '$this->r11_emissaocontracheque' ";
       $virgula = ",";
     }
     if(trim($this->r11_rubricadifsalario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r11_rubricadifsalario"])){ 
       $sql  .= $virgula." r11_rubricadifsalario = '$this->r11_rubricadifsalario' ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($r11_anousu!=null){
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_rubricaabonopecuniario"]) || $this->r11_rubricaabonopecuniario != "")
             $resac = db_query("insert into db_acount values($acount,536,1009752,'".AddSlashes(pg_result($resaco,$conresaco,'r11_rubricaabonopecuniario'))."','$this->r11_rubricaabonopecuniario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase1"]) || $this->r11_dataenviofase1 != "")
             $resac = db_query("insert into db_acount values($acount,536,1013925,'".AddSlashes(pg_result($resaco,$conresaco,'r11_dataenviofase1'))."','$this->r11_dataenviofase1',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase2"]) || $this->r11_dataenviofase2 != "")
             $resac = db_query("insert into db_acount values($acount,536,1013926,'".AddSlashes(pg_result($resaco,$conresaco,'r11_dataenviofase2'))."','$this->r11_dataenviofase2',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase3"]) || $this->r11_dataenviofase3 != "")
             $resac = db_query("insert into db_acount values($acount,536,1013927,'".AddSlashes(pg_result($resaco,$conresaco,'r11_dataenviofase3'))."','$this->r11_dataenviofase3',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_dataenviofase4"]) || $this->r11_dataenviofase4 != "")
             $resac = db_query("insert into db_acount values($acount,536,1013928,'".AddSlashes(pg_result($resaco,$conresaco,'r11_dataenviofase4'))."','$this->r11_dataenviofase4',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_rubagrupaadiantamento"]) || $this->r11_rubagrupaadiantamento != "")
             $resac = db_query("insert into db_acount values($acount,536,1014192,'".AddSlashes(pg_result($resaco,$conresaco,'r11_rubagrupaadiantamento'))."','$this->r11_rubagrupaadiantamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_filtralotacaousuario"]) || $this->r11_filtralotacaousuario != "")
             $resac = db_query("insert into db_acount values($acount,536,1014231,'".AddSlashes(pg_result($resaco,$conresaco,'r11_filtralotacaousuario'))."','$this->r11_filtralotacaousuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_utilizarhlotavincrubrica"]) || $this->r11_utilizarhlotavincrubrica != "")
             $resac = db_query("insert into db_acount values($acount,536,1014236,'".AddSlashes(pg_result($resaco,$conresaco,'r11_utilizarhlotavincrubrica'))."','$this->r11_utilizarhlotavincrubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_emissaocontracheque"]) || $this->r11_emissaocontracheque != "")
             $resac = db_query("insert into db_acount values($acount,536,1014506,'".AddSlashes(pg_result($resaco,$conresaco,'r11_emissaocontracheque'))."','$this->r11_emissaocontracheque',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_bloqueiocompetenciaaberta"]) || $this->r11_bloqueiocompetenciaaberta != "")
             $resac = db_query("insert into db_acount values($acount,536,1014596,'".AddSlashes(pg_result($resaco,$conresaco,'r11_bloqueiocompetenciaaberta'))."','$this->r11_bloqueiocompetenciaaberta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["r11_rubricadifsalario"]) || $this->r11_rubricadifsalario != "")
             $resac = db_query("insert into db_acount values($acount,536,1014471,'".AddSlashes(pg_result($resaco,$conresaco,'r11_rubricadifsalario'))."','$this->r11_rubricadifsalario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     if (!$result) {
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Parametros de Configuracao não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->r11_anousu."-".$this->r11_mesusu."-".$this->r11_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
      ...
      if ($this->numrows > 0) {
        ...
        for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
          ...
          if (isset($GLOBALS["HTTP_POST_VARS"]["r11_filtralotacaousuario"]) || $this->r11_filtralotacaousuario != "")
            $resac = db_query("insert into db_acount values($acount,536,1014231,'".AddSlashes(pg_result($resaco,$conresaco,'r11_filtralotacaousuario'))."','$this->r11_filtralotacaousuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
          if (isset($GLOBALS["HTTP_POST_VARS"]["r11_utilizarhlotavincrubrica"]) || $this->r11_utilizarhlotavincrubrica != "")
            $resac = db_query("insert into db_acount values($acount,536,1014231,'".AddSlashes(pg_result($resaco,$conresaco,'r11_utilizarhlotavincrubrica'))."','$this->r11_utilizarhlotavincrubrica',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        }
      }
    }
    $result = db_query($sql);
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,536,1009752,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_rubricaabonopecuniario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1013925,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_dataenviofase1'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1013926,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_dataenviofase2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1013927,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_dataenviofase3'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1013928,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_dataenviofase4'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014192,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_rubagrupaadiantamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014231,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_filtralotacaousuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014236,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_utilizarhlotavincrubrica'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014506,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_emissaocontracheque'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014596,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_bloqueiocompetenciaaberta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,536,1014471,'','".AddSlashes(pg_result($resaco,$iresaco,'r11_rubricadifsalario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
   ...
   */
   ...
   function sql_query_parametro ( $r11_anousu=null,$r11_mesusu=null,$r11_instit=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      left join rhrubricas n on n.rh27_rubric = cfpess.r11_rubricaabonopecuniario and n.rh27_instit = " . db_getsession("DB_instit") . " ";
     $sql .= "      left join rhrubricas o on o.rh27_rubric = cfpess.r11_rubagrupaadiantamento and o.rh27_instit = " . db_getsession("DB_instit") . " ";
