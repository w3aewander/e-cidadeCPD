...
function js_pesquisay77_tipoandam(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_tipoandam','func_fis_tipoandam.php?pesquisa_chave='+document.form1.y77_tipoandam.value+'&funcao_js=parent.js_mostratipoandam','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_tipovistorias','func_fis_tipovistorias.php?funcao_js=parent.js_preenchepesquisa|y77_codtipo','Pesquisa',true);
}
function js_preenchepesquisa(chave){
  db_iframe_tipovistorias.hide();
  <?php
  if($db_opcao == 2 || $db_opcao == 22){
    echo " location.href = 'fis1_fis_tipovistorias002.php?abas=1&chavepesquisa='+chave;";
