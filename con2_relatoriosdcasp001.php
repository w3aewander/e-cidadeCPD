...
if (!empty($_GET['modelo'])) {
    $_SESSION['modelo_dcasp'] = $_GET['modelo'];
}
...
if ($iAnoSessao > 2019 && $codigoRelatorio == BalancoPatrimonialDcasp::CODIGO_RELATORIO) {
    $codigoRelatorio = \ECidade\Financeiro\Contabilidade\Relatorio\DCASP\Model\BalancoPatrimonialDCASP2020::CODIGO_RELATORIO;
}
if ($iAnoSessao == 2019 && $codigoRelatorio == BalancoPatrimonialDcasp::CODIGO_RELATORIO) {
    $codigoRelatorio = \ECidade\Financeiro\Contabilidade\Relatorio\DCASP\Model\BalancoPatrimonialDCASP2019::CODIGO_RELATORIO;
}
...
if (FluxoCaixaFactory::isRelarorioFluxoCaixa($codigoRelatorio)) {
