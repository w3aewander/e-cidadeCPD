...
class AssentamentoFuncionalRepository {
  ...
  public static function getAssentamentosFuncional($iCodigoAssentamento) {
    ...
    if (DBPessoal::utilizaFiltroLotacoesPorUsuario()) {
        $oLotacoesUsuario = DBPessoal::buscaLotacoesPorUsuario(null, null, null, null, "S", true);
        $sWhereAssentamento .= " and h16_regist in (".implode(",",$oLotacoesUsuario->aMatriculas)."))";
    }
