...
<body class="abas">
  <div class="container">
  	<?php
  	  include(modification("forms/db_frmiptucalcpadrao.php"));
  	?>
  </div>
</body>
</html>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_iptucalcpadraoconstr.location.href='cad1_iptucalcpadraoconstr001.php?j11_iptucalcpadrao='+document.form1.chavepesquisa.value+'&j11_matric=$j10_matric&forma=$forma&exec=$exec';
         parent.document.formaba.iptutaxamatric.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_iptutaxamatric.location.href='cad1_iptutaxamatric001.php?j09_matric=$j10_matric&forma=$forma&exec=$exec';
     ";
         if(isset($liberaaba)){
