...
class ArquivoEConsig { 
  ...
  public function carregarRegistros() {
    ...
    $oDaoRegistrosEConsigServidor  = new cl_econsigmovimentoservidor();
    $sSqlRegistros                = $oDaoRegistrosEConsigServidor->sql_query(null, "rh134_sequencial, rh134_regist, rh135_rubrica, rh135_valor, rh134_econsigmotivo, rh134_nome", null, "rh133_sequencial = {$this->iCodigo}");
