      ...
      <form name="form1" method="post" action="">
        <fieldset>
          ...
          <fieldset class="separator item-encerramento">
            ...
            <div class="text-left">
              <input name="processar_variacoes" type="button" id="processar_variacoes" value="Processar" disabled/>
              <input name="desprocessar_variacoes" type="button" id="desprocessar_variacoes" value="Cancelar" disabled/>
            </div>
          </fieldset>
          ...
          <fieldset class="separator item-encerramento">
            ...
            <div class="text-left">
              <input name="processar_natureza" type="button" id="processar_natureza" value="Processar" disabled/>
              <input name="desprocessar_natureza" type="button" id="desprocessar_natureza" value="Cancelar" disabled/>
              <input name="regras_natureza" type="button" id="regras_natureza" value="Regras" disabled/>
            </div>
          </fieldset>
