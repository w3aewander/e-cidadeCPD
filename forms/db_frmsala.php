...
<form name="form1"  method="post" action="">
    <fieldset>
        <legend>Dependências da Escola</legend>
        <table class="form-container">
            ...
            <tr>
                <td nowrap title="<?= @$Ted16_i_tiposala ?>">
                    <?php db_ancora(@$Led16_i_tiposala, "js_pesquisaed16_i_tiposala(true);", $db_opcao); ?>
                </td>
                <td colspan="2">
                    <?php db_input('ed16_i_tiposala', 15, $Ied16_i_tiposala, true, 'text', $db_opcao, " onchange='js_pesquisaed16_i_tiposala(false);'") ?>
                    <?php db_input('ed14_c_descr', 20, @$Ied14_c_descr, true, 'text', 3, '') ?>
                    <?= @$Led14_c_aula ?>
                    <?php db_input('ed14_c_aula', 3, @$Ied14_c_aula == "S" ? "SIM" : "NÃO", true, 'text', 3, '') ?>
                </td>
            </tr>
            <tr>
                ...
                <td rowspan="4">
                    <fieldset id="capacidade" style="visibility:<?= $visible ?>">
                        <legend><b>Cálculo da capacidade</b></legend>
                        <?= @$Led16_f_metragem ?>
            ...
            <tr>
                ...
                <td>
                    <?php db_input('ed16_i_capacidade', 10, $Ied16_i_capacidade, true, 'text', $db_opcao, "") ?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr id="linhaLocalFuncionamento" style="display: none">
                <td>
                    <label for="ed16_local_funcionamento">Local de Funcionamento Diferenciado</label>
                </td>
                <td colspan="2">
                    <?php
                    $x = array(
    ...
    <div >
        ...
        $chavepri = array(
            ...
            "ed16_c_descr" => @$ed16_c_descr,
            "ed14_c_descr" => @$ed14_c_descr,
            "ed16_i_capacidade" => @$ed16_i_capacidade,
            "ed16_c_pertence" => @$ed16_c_pertence,
            "ed14_c_aula" => @$ed14_c_aula,
...
<script>
    ...
    defineVisibilidadeCampos = () => {
        $('linhaLocalFuncionamento').style.display = 'none';

        if ($F('ed16_c_pertence') === 'N') {
            $('linhaLocalFuncionamento').style.display = 'table-row';
        }
    };

    $('ed16_c_pertence').addEventListener('change', () => {
        defineVisibilidadeCampos();
    });
