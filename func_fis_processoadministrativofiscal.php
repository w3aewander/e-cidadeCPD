...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      $sLeft = "";
      $where = " p58_instit = ".db_getsession("DB_instit") . " and exists (select 1 from procandam where p61_codandam = p58_codandam  and p61_coddepto =".db_getsession("DB_coddepto").")";
      ...
      if(isset($ProcFiscal) && $ProcFiscal != ""){
        $where .= " and exists (select 1 from fiscalizacao.fis_processosfiscais where pf01_processo = p58_codproc and pf01_procfiscal = ".$ProcFiscal." )";
      }
      // 05/10/2015 //
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!="") {
          ...
          if(isset($chave_p58_numero) && $chave_p58_numero != ""){
            
            $aExplodeNumero = explode("/", $pesquisa_chave);
            
            if (count($aExplodeNumero) > 1) {
              $where = " p58_numero = '".$aExplodeNumero[0]."' and p58_ano = ".$aExplodeNumero[1];
            } else {
              $where = " p58_numero = '".$aExplodeNumero[0]."' and p58_ano = ".db_getsession("DB_anousu");
            }
          }else{
              $where = "p58_codproc = $pesquisa_chave and $where";
          }
