...
<?php
  ...
  $oDaoSaniAtividade    = db_utils::getDao("fis_saniatividade");
...
function js_imprime(chave){
    jan = window.open('fis3_fis_relatoriosani.php?y80_codsani='+chave,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
      jan.moveTo(0,0);
}
function js_imprimealvara(chave){
    jan = window.open('fis3_fis_imprimealvara.php?y80_codsani='+chave,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
      jan.moveTo(0,0);
}
</script>
<?php
