...
$clrotulo->label("nome");
?>
<form name="form1" method="post" action="" style="margin-left: 50px;">
    <fieldset>
        <legend>Cadastro de fiscais</legend>
        <center>
            <table border="0">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php db_inputdata('data',@$data_dia,@$data_mes,@$data_ano,true,'text',$db_opcao,""); ?>
                    </td>
                </tr>
            </table>
        </center>
...
<script>
    ...
    function js_pesquisa(){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cadfiscais','func_fis_cadfiscais_instit.php?funcao_js=parent.js_preenchepesquisa|id_usuario','Pesquisa',true);
    }
