...
class cl_selecao
{
   ...
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 r44_desc1 = text = descricao 1
                 r44_desc2 = text = descricao 2
                 r44_descr = char(30) = Descrição
                 r44_obs = char(50) = Observacoes
                 r44_where = text = Condição
   ...
   function incluir ($r44_selec,$r44_instit){
     ...
     if($this->r44_gruposelecao == null ){
       $this->erro_sql = " Campo Cod. Grupo não informado.";
     ...
     if(($this->r44_selec == null) || ($this->r44_selec == "") ){
       $this->erro_sql = " Campo r44_selec não declarado.";
     ...
     if(($this->r44_instit == null) || ($this->r44_instit == "") ){
       $this->erro_sql = " Campo r44_instit não declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Seleções ($this->r44_selec."-".$this->r44_instit) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Seleções já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Seleções ($this->r44_selec."-".$this->r44_instit) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   // funcao para alteracao
    public function alterar($r44_selec=null,$r44_instit=null)
    {
      $this->atualizacampos();
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Seleções não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->r44_selec."-".$this->r44_instit;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Seleções não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->r44_selec."-".$this->r44_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($r44_selec=null,$r44_instit=null,$dbwhere=null) {
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Seleções não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Seleções não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$r44_selec."-".$r44_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function sql_query($r44_selec = null,$r44_instit = null,$campos = "*", $ordem = null, $dbwhere = "") {
    ...
    public function sql_query_file($r44_selec = null,$r44_instit = null, $campos = "*", $ordem = null, $dbwhere = "") {
  ...
  function getDescricaoSelecao( $iCodigoSelecao, $iInstituicao = null ) {
