...
require_once(modification("classes/db_turmaacativ_classe.php"));
require_once(modification("classes/db_turmaacativnova_classe.php"));
require_once(modification("classes/db_turmaacprof_classe.php"));
