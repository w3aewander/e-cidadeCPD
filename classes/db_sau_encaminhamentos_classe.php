...
class cl_sau_encaminhamentos {
   ...
   public $s142_i_codigo = 0;
   public $s142_i_profissional = 0;
   public $s142_i_unidade = 0;
   public $s142_i_cgsund = 0;
   public $s142_i_prontuario = 0;
   public $s142_i_rhcbo = 0;
   public $s142_i_prestadora = 0;
   public $s142_i_tipo = 0;
   public $s142_t_dadosclinicos = null;
   public $s142_d_encaminhamento_dia = null;
   public $s142_d_encaminhamento_mes = null;
   public $s142_d_encaminhamento_ano = null;
   public $s142_d_encaminhamento = null;
   public $s142_d_retorno_dia = null;
   public $s142_d_retorno_mes = null;
   public $s142_d_retorno_ano = null;
   public $s142_d_retorno = null;
   public $s142_d_validade_dia = null;
   public $s142_d_validade_mes = null;
   public $s142_d_validade_ano = null;
   public $s142_d_validade = null;
   public $s142_i_login = 0;
   public $s142_i_profsolicitante = 0;
   ...
   public function incluir ($s142_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($s142_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($s142_i_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $s142_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $s142_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  */
  function sql_query_encaminhamentos_profissional($s142_i_codigo = null, $campos = "", $iMedico, $iUnidade,
   ...
   public function sql_query2 ( $s142_i_codigo=null,$campos="",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
   ...
   // funcao para alteracao
   public function alterar2 ($s142_i_codigo=null) {
      $this->atualizacampos();
     $sql = " update sau_encaminhamentos set ";
     $virgula = "";
     if(trim($this->s142_i_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s142_i_codigo"])){
