...
include(modification("classes/db_fis_fiscalproc_classe.php"));
...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center" valign="top">
      ...
      $w = " y29_coddepto = ".db_getsession("DB_coddepto")." and y29_tipoproced='L'";


      if($tipofisc != ""){
        $w .= "and y29_tipofisc=$tipofisc ";
      }

      if(isset($codprinc) && $codprinc != ""){
        $w .= " and y29_codtipo <> ".$codprinc; 
      }
      if($valor){
        $w .= " and y45_percentual is false";
      }
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_fiscalprocalt.php")==true){
             include(modification("funcoes/db_func_fis_fiscalprocalt.php"));
           }else{
           $campos = "y29_codtipo,y29_descr,y29_descr_obs,y45_valor,y45_vlrfixo,y45_percentual";
           }
        }
        $campos  = "y29_codtipo,y29_descr,y29_descr_obs,y45_valor,y45_vlrfixo,y45_percentual,y45_tipo";
        $campos .= ",(select true from fiscalizacao.fis_fiscalprocrecvinculo where py45_procprinc = y29_codtipo and py45_procsec = y45_receit ) as dl_Proc";
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $campos  = "y29_codtipo,y29_descr,y29_descr_obs,y45_valor,y45_vlrfixo,y45_percentual,y45_tipo";
          $campos .= ",(select true from fiscalizacao.fis_fiscalprocrecvinculo where py45_procprinc = y29_codtipo and py45_procsec = y45_receit ) as dl_Proc";
	        $result = $clfiscalproc->sql_record($clfiscalproc->sql_query_rec($pesquisa_chave,$campos,"","y29_codtipo=$pesquisa_chave and $w"));
          if($clfiscalproc->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$y29_descr',false,'$y45_vlrfixo','$y45_valor', '$y45_percentual', '$dl_proc');</script>";
          }else{
