...
if (isset($aprovminimo)) {
  ...
  $sSql              = $oDaoDiarioFinal->sql_query(null, 'ed74_c_resultadofreq, ed74_i_procresultadofreq, '.
                                                   'ed74_i_percfreq, ed74_i_codigo, ed74_c_resultadofinal', '',
  ...
  // Não sobrescrever resultado 'N' (NÃO AVALIADO) para alunos com necessidades especiais
  if (isset($oDadosDiarioFinal->ed74_c_resultadofinal) && $oDadosDiarioFinal->ed74_c_resultadofinal == 'N') {
    $sResFinal = 'N';
  } elseif ($oDadosDiarioFinal->ed74_c_resultadofreq == 'A' && $sValorAprov == 'A') {
    $sResFinal = 'A';
