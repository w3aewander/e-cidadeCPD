...
class M12316PlDescontoNfse extends PostgresMigration
{
    public function up()
    {
        $sql = <<<SQL
...
BEGIN
  ...
  IF (found AND nDescontoNFSE > 0) THEN
    ...
    IF unica THEN
      ...
      select nDescontoNFSE * (1 - (k00_percdes::decimal / 100))
        INTO nDescontoNFSE
        from recibounica
       where recibounica.k00_numpre = numpre
         and dataOperacao <= fc_proximo_dia_util(recibounica.k00_dtvenc);
    ...
    -- se o número de parcelas for menor que a quantidade de centavos, aplica tudo na primeira parcela.
