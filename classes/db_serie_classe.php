...
class cl_serie {
  ...
  public function incluir ($ed11_i_codigo){
      $this->atualizacampos();
  ...
  public function sql_query_equiv ( $ed11_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_turma ( $ed11_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_relatorio($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '') {
   ...
   public function sql_query_disciplinaescolaserie($ed11_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "SELECT ";
        ...
        $sql .= " FROM serie ";
        $sql .= " JOIN regencia ON regencia.ed59_i_serie = serie.ed11_i_codigo ";
        $sql .= " JOIN disciplina ON disciplina.ed12_i_codigo = regencia.ed59_i_disciplina ";
        $sql .= " JOIN caddisciplina ON disciplina.ed12_i_caddisciplina = caddisciplina.ed232_i_codigo";
        $sql .= " JOIN ensino ON ensino.ed10_i_codigo = serie.ed11_i_ensino ";
        $sql .= " JOIN serieregimemat ON serieregimemat.ed223_i_serie = serie.ed11_i_codigo ";
        $sql .= " JOIN turmaserieregimemat ON turmaserieregimemat.ed220_i_serieregimemat = serieregimemat.ed223_i_codigo ";
        $sql .= " JOIN turma ON turma.ed57_i_codigo = turmaserieregimemat.ed220_i_turma ";
        $sql .= " JOIN escola ON escola.ed18_i_codigo = turma.ed57_i_escola ";
        $sql .= " JOIN calendario ON calendario.ed52_i_codigo = turma.ed57_i_calendario ";
        $sql2 = "";
