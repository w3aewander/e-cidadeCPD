...
<center>
<?
include(modification("forms/db_frmentraordcom.php"));
?>
</center>
</td>
</tr>
...
if (isset($confirma)){
  ...
  if($clmatestoque->erro_campo!=""){
    ...
    echo"<script>(window.CurrentWindow || parent.CurrentWindow).corpo.location.href='mat1_entraordcom001.php';</script>";
  }
}
?>
</body>
