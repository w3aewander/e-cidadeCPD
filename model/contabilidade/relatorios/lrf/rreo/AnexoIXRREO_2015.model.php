...
class AnexoIXRREO_2015 extends RelatoriosLegaisBase implements AnexoRREO {
  ...
  protected function configurarRelatorio() {
  ...
  private function escreverRegraOuro() {
    ...
    $this->oPdf->MultiCell($this->iLargura * 0.14, $this->iAltura * 3, '(e - b)', 'TBRL', 'C');
  ...
  public function getDadosSimplificado() {
    ...
    $oDespesaCapitalLiquida->nDespesasEmpenhadas = $aLinhas[self::LINHA_DESPESA_CAPITAL]->empenhado;
