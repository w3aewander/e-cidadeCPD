...
$sSqlParam = $clparcustos->sql_query_file($iAnousu, "cc09_tipocontrole", "",
  "cc09_instit = " . db_getsession("DB_instit"));
$rsParam = $clparcustos->sql_record($sSqlParam);
...
<form name="form1" method="post" action="">
  <table align="center" border='0'>
    ...
    <tr>
      ...
      <td>
        <input type="button" name="escolheGrupo" id="escolheGrupo" value="Escolher"
               onclick="js_escolheGrupoSubgrupo();" class="inputPadrao">
      </td>
    </tr>
    ...
    <tr id='tipo'>
      <td align="left" title="Tipo de relatório">
    ...
    <tr id='totalizadepto'>
      <td align="left" title="Totalizadores por Departamentos">
        <strong>Total por Departamentos:</strong>
      </td>
      <td>
          <?php
...
<script>
  ...
  function js_escolheGrupoSubgrupo() {
    ...
    if(!(windowGrupo instanceof windowAux)) {
      ...
      sContent += "    </fieldset>";
      sContent += "    <center>";
      sContent += "      <input type='button' name='btnSalvarGrupos' id='btnSalvarGrupos' ";
      sContent += "                        value='Salvar' onclick='windowGrupo.hide();'>";
      sContent += "    </center>";
      sContent += "  </div>";
      sContent += "</div>";
  ...
  function js_mandadados() {
    ...
    query += '&iTipoRelatorio=' + $F("iTipoRelatorio");
    $pRelatorio = "mat2_relatoriosaidasmateriasdepto002.php?";
    if($F("iTipoRelatorio") == 1 || $F("iTipoRelatorio") == 2) {
      $pRelatorio = "mat2_relatoriosaidasmateriasdeptosintetico002.php?";
    }

    if ($F("iTotalizaDepto") == 1  ) {

      $pRelatorio = "mat2_relatoriosaidasmateriasdeptogrid002.php?"
    }


    jan = window.open($pRelatorio + query, '',
