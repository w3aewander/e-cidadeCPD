...
function js_processar(){
  ...
  if(document.getElementById("processar").name == "false"){
    ...
    if(confirm("Confirma cancelamento do mês?\n" +
    x.dataii_mes.value + "/" + x.dataii_ano.value + 
    "\n\nATENÇÃO: AO EFETUAR O CANCELAMENTO, TODOS OS DADOS LANÇADOS E CALCULADOS DA FOLHA EM ABERTO SERÃO EXCLUÍDOS.\n\n" +
