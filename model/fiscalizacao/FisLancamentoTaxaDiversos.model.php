...
*/
class FisLancamentoTaxaDiversos
{
   ...
   * @param Integer
   * @return FisLancamentoTaxaDiversos
   */
   ...
   * @return FisLancamentoTaxaDiversos
   */
  public function setNaturezaTaxa (FisNaturezaTaxaDiversos $naturezaTaxaDiversos) {
   ...
   * @return FisNaturezaTaxaDiversos
   */
   ...
   * @throws DBException
   */
  public function calcularTaxa($sTipoCalculo = ProcessamentoFisTaxaDiversos::CALCULO_INDIVIDUAL) {

    $formula = new DBFormulaFisLancamentoTaxaDiversos($this);
  ...
  public function getDebitosLancados() {
    ...
    $oDaoDiversos   = new cl_fis_lancamentotaxadiversos();
