...
<head>
    ...
    <link type="text/css" href="estilos/grid.style.css" rel="stylesheet">
    ...
    <script rel="script" type="text/javascript" src="scripts/widgets/dbtextField.widget.js"></script>
    ...
    <script rel="script" type="text/javascript" src="scripts/widgets/dbcomboBox.widget.js"></script>
    <script rel="script" type="text/javascript" src="scripts/datagrid.widget.js"></script>
    <script rel="script" type="text/javascript" src="ext/javascript/prototype.maskedinput.js"></script>
    <script rel="script" type="text/javascript" src="scripts/classes/DBViewEstruturaValor.js"></script>
    <script rel="script" type="text/javascript" src="scripts/classes/DBViewMaterialGrupo.js"></script>
    <script rel="script" type="text/javascript" src="scripts/widgets/DBTreeView.widget.js"></script>
    <script rel="script" type="text/javascript" src="scripts/AjaxRequest.js"></script>
    <script rel="script" type="text/javascript" src="scripts/classes/http/http.js"></script>
    <script rel="script" type="text/javascript" src="scripts/session.js"></script>
    <script rel="script" type="text/javascript" src="scripts/classes/configuracao/ConfigurarOrganograma.js"></script>
</head>
