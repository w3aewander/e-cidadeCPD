...
class cl_contrans {
   ...
   public function incluir ($c45_seqtrans){
      $this->atualizacampos();
   ...
   public function alterar ($c45_seqtrans=null) {
      $this->atualizacampos();
   ...
   public function excluir ($c45_seqtrans=null,$dbwhere=null) {
   ...
   public function sql_query ( $c45_seqtrans=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
  ...
  public function sql_query_evento_contabil ( $c45_seqtrans=null,$campos="*",$ordem=null,$dbwhere=""){
  	$sql = "select ";
  	if($campos != "*" ){
  		$campos_sql = explode("#",$campos);
  		$virgula = "";
   ...
   public function sql_query_file ( $c45_seqtrans=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_vinculo ( $c45_seqtrans=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_queryVinculoEmpRestoTipoLiquidacao ( $c45_seqtrans=null,$campos="*",$ordem=null,$dbwhere=""){
  	$sql = "select ";
  	if($campos != "*" ){
  		$campos_sql = explode("#",$campos);
  		$virgula = "";
