...
class M17942ConciliacaoBancariaManual extends PostgresMigration
{
  public function up()
  {
    ...
    $sql = <<<SQL
      ...
      update db_itensmenu set descricao = 'Conciliação Bancária com carga de extrato',
                              help = 'Conciliação Bancária com carga de extrato',
                              desctec = 'Conciliação Bancária com carga de extrato'
      where id_item = 147883;


      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228484 ,'Conciliação Bancária sem carga de extrato', 'Conciliação Bancária sem carga de extrato' ,'' ,'1' ,'1' ,'Conciliação Bancária sem carga de extrato' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228485 ,'Implantação de Conciliação por Conta' ,'Implantação de Conciliação por Conta' ,'cai4_implantaconciliacao001.php' ,'1' ,'1' ,'Implantação de Conciliação por Conta' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228486 ,'Abrir Pendências Antigas' ,'Abrir Pendências Antigas' ,'cai4_gerapendenciasant.php' ,'1' ,'1' ,'Abrir Pendências Antigas' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228487 ,'Manutenção de Conciliação' ,'Manutenção de Conciliação' ,'cai4_alteraconciliacao_manual.php' ,'1' ,'1' ,'Manutenção de Conciliação' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228488 ,'Relatório da Conciliação Dia' ,'Relatório da Conciliação Dia' ,'cai2_relconciliacaobancaria001_manual.php?dia=true' ,'1' ,'1' ,'Relatório da Conciliação Dia' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228489 ,'Relatório de Registros Conciliados' ,'Relatório de Registros Conciliados' ,'cai2_relconciliacaodetalhes001.php' ,'1' ,'1' ,'Relatório de Registros Conciliados' ,'true' );
      insert into db_itensmenu( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 228490 ,'Zera Conciliação por Dia' ,'Zera Conciliação por Dia' ,'cai1_conciliazeralog001_manual.php' ,'1' ,'1' ,'Zera Conciliação por Dia' ,'true' );
		...
		select corrente.k12_id           as caixa,
             ...
             when corrente.k12_estorn is true then
               abs(corrente.k12_valor)
				   ...
				   (\'Slip-\'||slip.k17_codigo||\'#Histórico-\'||coalesce(slip.k17_texto,\'\')||(case when k12_estorn = \'f\' then \'\' else \' Estorno: \'||coalesce(slip.k17_motivoestorno,\'\') end))::text as detalhe
			from corlanc
