...
class M24432CorrecaoFcVistoriasVariavelNPontuacaoPorArea extends Migration
{
    /**
     * Run the migrations.
     *
  ...
  BEGIN
    ...
    if iFormulaCalculoVistoria = 1 then
      ...
      if V_INSCR = false AND lIsSanitario = false then
          ...
          return '20-PROCEDIMENTO NÃƒO PREPARADO PARA CALCULO POR FORMA DIFERENTE DE 1 (NORMAL)';
    end if;
