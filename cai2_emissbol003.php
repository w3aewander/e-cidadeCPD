...
$sCampos .= "null          as cornump_numpar, ";
$sCampos .= "case                             ";
...
$sCampos .= "null as  coremp_cheque,           ";
$sCampos .= "''            as coremp_anousu,";
$sCampos .= "''          as corlanc_descr,";
$sCampos .= "null as corlanc_slip,";
$sCampos .= "null           as cornump_descr,  ";
$sCampos .= "null          as cornump_receit, ";
$sCampos .= "null           as cornump_valor,  ";
$sCampos .= "null as dtarq                           ";
...
for ($i = 0; $i < $numrows; $i++) {
    ...
    if ($tiporel == "r" && $data_ant != $corrente_data) {
        $pdf->ln();
        $data_ant = $corrente_data;
    }
    ...
    if (($cornump == true && $passa == true) || $cornump == false) {
        ...
        $pdf->Cell($CoL6, 5, str_pad(number_format($corrente_valor, 2, ",", "."), 14, " ", STR_PAD_LEFT), $sublinha, 0,
            "R", 0);
        $pdf->SetTextColor(0, 0, 0);
