...
class etceArquivoPrevisaoReceita extends SigfisArquivoBase implements iPadArquivoTXTBase {
    ...
    $fontes0 = array(
      ...
      117 => 1701
        ...
        //$this->testax($aReceitas); die("Confere");
        foreach ($aReceitas as $iInd => $aReceita) {  
            ...
            if ($oDaoOrcFontes->numrows == 1) {
                ...
                /*if($aReceita->o70_codigo == 1801){
                //var_dump($sSqlOrcFontes); die("Fonte");
                //o57_codfon = 7168
                //o57_fonte = 412180111420100
                //quant_rec = 1                    
                    //$this->testax($oVinculo);
                    $this->testax($sEstrut);
                    //[receitatce] => 12150111
                    //[receitaecidade] => 7168
                    die("Confere");
        ...
        if (count($aReceitaSoma) > 0) {
            ...
            foreach ($aReceitaSoma as $sFonte => $nValor) {
                ...
                if(db_getsession("DB_instit") == 85){
                    $oDados->FonteRecursos = $guardacodigo[$oDados->CodigoItemReceita];
                }else{
                    $oDados->FonteRecursos = $aReceita->o70_codigo;
                }
