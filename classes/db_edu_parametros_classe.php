...
class cl_edu_parametros {
  ...
  public $ed233_i_codigo = 0;
  public $ed233_i_escola = 0;
  public $ed233_c_decimais = null;
  public $ed233_c_notabranca = null;
  public $ed233_f_medidaaluno = 0;
  public $ed233_c_limitemov = null;
  public $ed233_c_database = null;
  public $ed233_c_consistirmat = null;
  public $ed233_c_avalalternativa = null;
  public $ed233_i_idadevotacao = 0;
  public $ed233_i_habilitaordemalfabeticaturma = 0;
  public $ed233_deslocamentocursor = 0;
  public $ed233_formalancamentoparecer = 0;
  public $ed233_bloqueioalteracaoavaliacao = 'f';
  public $ed233_reclassificaetapaanterior = 'f';
  public $ed233_apresentarnotaproporcional = 'f';
  public $ed233_campo_aulas_dadas_lanc_turma;
  public $ed233_alterarprocedimentonotaparcial = 'f';
  public $ed233_habilitarrecuperacaonotaparcial = 't';
  ...
  public $campos = "
                ...
                ed233_campo_aulas_dadas_lanc_turma = bool = Habilita Aulas Dadas Lançamento por Turma
                ed233_alterarprocedimentonotaparcial = bool = Permitir Alteração do Procedimento das Notas Parciais
                ed233_habilitarrecuperacaonotaparcial = bool = Habilitar Recuperação das Notas Parciais
                 ";
  ...
  public function atualizacampos($exclusao=false) {
    if ($exclusao==false) {
      ...
      $this->ed233_campo_aulas_dadas_lanc_turma = ($this->ed233_campo_aulas_dadas_lanc_turma == "t"?@$GLOBALS["HTTP_POST_VARS"]["ed233_campo_aulas_dadas_lanc_turma"]:$this->ed233_campo_aulas_dadas_lanc_turma);
      $this->ed233_alterarprocedimentonotaparcial = ($this->ed233_alterarprocedimentonotaparcial == "f"?@$GLOBALS["HTTP_POST_VARS"]["ed233_alterarprocedimentonotaparcial"]:$this->ed233_alterarprocedimentonotaparcial);
      $this->ed233_habilitarrecuperacaonotaparcial = ($this->ed233_habilitarrecuperacaonotaparcial == "t"?@$GLOBALS["HTTP_POST_VARS"]["ed233_habilitarrecuperacaonotaparcial"]:$this->ed233_habilitarrecuperacaonotaparcial);
    } else {
      $this->ed233_i_codigo = ($this->ed233_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed233_i_codigo"]:$this->ed233_i_codigo);
    }
  }
  ...
  public function incluir ($ed233_i_codigo) {
    $this->atualizacampos();
    ...
    if($this->ed233_campo_aulas_dadas_lanc_turma == null ){
      $this->ed233_campo_aulas_dadas_lanc_turma = "t";
    }
    if($this->ed233_alterarprocedimentonotaparcial == null) {
      $this->ed233_alterarprocedimentonotaparcial = 'f';
    }
    if($this->ed233_habilitarrecuperacaonotaparcial == null) {
      $this->ed233_habilitarrecuperacaonotaparcial = 't';
    }
    ...
    $sql = "insert into edu_parametros(
                                      ...
                                      ,ed233_campo_aulas_dadas_lanc_turma
                                      ,ed233_alterarprocedimentonotaparcial
                ...
                values (
                               ...
                               ,'$this->ed233_campo_aulas_dadas_lanc_turma'
                               ,'$this->ed233_alterarprocedimentonotaparcial'
                               ,'$this->ed233_habilitarrecuperacaonotaparcial'
                      )";
    $result = db_query($sql);
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
  ...
  public function alterar ($ed233_i_codigo=null) {
    ...
    if(trim($this->ed233_campo_aulas_dadas_lanc_turma)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed233_campo_aulas_dadas_lanc_turma"])){
      $sql  .= $virgula." ed233_campo_aulas_dadas_lanc_turma = '$this->ed233_campo_aulas_dadas_lanc_turma' ";
      $virgula = ",";
    }
    if (trim($this->ed233_alterarprocedimentonotaparcial != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed233_alterarprocedimentonotaparcial"]))){
      $sql  .= $virgula." ed233_alterarprocedimentonotaparcial = '$this->ed233_alterarprocedimentonotaparcial' ";
      $virgula = ",";
    }
    if (trim($this->ed233_habilitarrecuperacaonotaparcial != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed233_habilitarrecuperacaonotaparcial"]))){
      $sql  .= $virgula." ed233_habilitarrecuperacaonotaparcial = '$this->ed233_habilitarrecuperacaonotaparcial' ";
      $virgula = ",";
    }
