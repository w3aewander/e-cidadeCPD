...
/**
 * Class ColunaEstruturalRegistry
 * @package ECidade\Configuracao\RelatorioLegal\Registry
 */
class ColunaEstruturalRegistry
{
    /**
     ...
     */
    public static function set(ColunaEstrutural $colunaEstrutural)
    {
        self::$storage[$colunaEstrutural->getSequencial()] = $colunaEstrutural;
    }
}
