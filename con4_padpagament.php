    ...
    $sql = "
      ...
      select e60_anousu as ano,
       ...
       SELECT e60_anousu AS ano,
              ...
              round(c70_valor, 2) AS c70_valor,
              CASE
                WHEN c53_tipo =30 THEN '+'
                ELSE '-'
              END AS sinal,
              CASE
                  WHEN c72_complem IS NULL THEN NULL
                  ELSE c72_complem
              END || ' Ordem Pagto:' || c80_codord AS historico,
              c75_codlan AS operacao,
              c69_credito AS conta_pagadora,
              c69_debito AS contra_partida,
              db_config.codtrib AS orgao_unidade,
              e60_instit,
              c80_codord
          FROM conlancamemp
