...
class cl_fis_procfiscalnotificacao
{
   ...
   // cria variaveis do arquivo
    public $y110_sequencial = 0;
    public $y110_notificacaofiscal = 0;
    public $y110_procfiscal = 0;
   ...
   //funcao construtor da classe
    public function __construct()
    {
         ...
         $this->rotulo = new rotulo("fis_procfiscalnotificacao");
   ...
   // funcao para inclusao
    public function incluir($y110_sequencial = null)
    {
          $this->atualizacampos();
        ...
        $sql = "insert into fiscalizacao.fis_procfiscalnotificacao(
                ...
                values (
                      ...
                      ) returning y110_sequencial ";
        $result = db_query($sql);
        $this->y110_sequencial = db_utils::fieldsmemory($result, 0)->y110_sequencial;
   ...
   // funcao para alteracao
    public function alterar($y110_sequencial = null)
    {
          $this->atualizacampos();
         $sql = " update fiscalizacao.fis_procfiscalnotificacao set ";
         $virgula = "";
   ...
   // funcao para exclusao
    public function excluir($y110_sequencial = null, $dbwhere = null)
    {
         $sql = " delete from fiscalizacao.fis_procfiscalnotificacao where ";
         $sql2 = "";
   ...
   // funcao do recordset
    ...
    public function sql_query($y110_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
         $sql = "select ";
        if ($campos != "*") {
        ...
        $sql .= " from fiscalizacao.fis_procfiscalnotificacao ";
        $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_procfiscalnotificacao.y110_notificacaofiscal";
        $sql .= "      inner join fiscalizacao.fis_procfiscal  on  fis_procfiscal.y100_sequencial = fis_procfiscalnotificacao.y110_procfiscal";
        $sql .= "      inner join db_config  on  db_config.codigo = fis_fiscal.y30_instit";
        ...
        if ($dbwhere=="") {
            if ($y110_sequencial!=null) {
                $sql2 .= " where fis_procfiscalnotificacao.y110_sequencial = $y110_sequencial ";
            }
        } elseif ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
    ...
    public function sql_query_file($y110_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
         $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
