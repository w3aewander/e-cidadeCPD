 ...
 */
  ...
  this.preencheItens = function (aItens) {
    ...
    aItens.each(function (oItem, iSeq) {
      ...
      nQuantidade < 0 ? nQuantidade = 0 : nQuantidade;
    ...
    /**
    * Hints para mostrar o resumo e dotação dos itens ao passar mouse na coluna Item.
    */
