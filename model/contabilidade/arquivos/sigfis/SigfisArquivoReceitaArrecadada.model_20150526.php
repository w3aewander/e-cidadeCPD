...
//    $sSqlConLanCamRec = "select sum(c70_valor) as c70_valor, mes, substr(o57_fonte,1,9) as o57_fonte, min(o57_codfon) as o57_codfon, codigo_documento from ( $sSqlConLanCamRec ) as x group by mes, substr(o57_fonte,1,9), codigo_documento order by substr(o57_fonte,1,9)";
    $sSqlConLanCamRec = "select sum(c70_valor) as c70_valor, mes, case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,8) else substr(o57_fonte,2,8) end as o57_fonte, min(o57_codfon) as o57_codfon, codigo_documento from ( $sSqlConLanCamRec ) as x group by mes, case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,8) else substr(o57_fonte,2,8) end, codigo_documento order by case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,8) else substr(o57_fonte,2,8) end";
