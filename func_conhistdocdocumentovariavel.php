	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_conhistdocdocumentovariavel.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_conhistdocdocumentovariavel.php")==true){
             include(modification("funcoes/db_func_conhistdocdocumentovariavel.php"));
           }else{
           $campos = "conhistdocdocumentovariavel.*";
           }
        }
        if(isset($chave_c93_sequencial) && (trim($chave_c93_sequencial)!="") ){
	         $sql = $clconhistdocdocumentovariavel->sql_query($chave_c93_sequencial,$campos,"c93_sequencial");
        }else if(isset($chave_c93_descricao) && (trim($chave_c93_descricao)!="") ){
	         $sql = $clconhistdocdocumentovariavel->sql_query("",$campos,"c93_descricao"," c93_descricao like '$chave_c93_descricao%' ");
        }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clconhistdocdocumentovariavel->sql_record($clconhistdocdocumentovariavel->sql_query($pesquisa_chave));
          if($clconhistdocdocumentovariavel->numrows!=0){
