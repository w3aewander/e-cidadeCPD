        ...
        for (var iFiltros = 0; iFiltros < me.aFiltros.length; iFiltros++) {
            ...
            if (eval("oRetorno." + me.aFiltros[iFiltros] + ".length > 0")) {
                ...
                with (eval("$('dados" + me.aFiltros[iFiltros] + "')")) {
                    ...
                    sTabela += "</tr>";
                    sTabela += "  <tr>";
                    sTabela += "    <td class='table_header' colspan='10'><b>" + me.aFiltros[iFiltros].ucFirst() + "</b></td>";
                    sTabela += "  </tr>";
                    sTabela += "  <tr>";
                    ...
                    if (me.aFiltros[iFiltros] == "recurso") {
                        sTabela += "    <td width='5%' class='table_header'>";
                        sTabela += "      <b>Gestão</b>";
                        sTabela += "    </td>";
                        sTabela += "    <td width='5%' class='table_header'>";
                    ...
                    for (var i = 0; i < eval("oRetorno." + me.aFiltros[iFiltros] + ".length"); i++) {
                        ...
                        with (eval("oRetorno." + me.aFiltros[iFiltros] + "[i]")) {
                            ...
                            if (me.aFiltros[iFiltros] == "recurso") {
                                sTabela += "    <td style='text-align:left' class='linhagrid'>" + fonte + "</td>";
                                sTabela += "    <td style='text-align:left' class='linhagrid'>" + gestao + "</td>";
                                sTabela += "    <td style='text-align:left' class='linhagrid'>" + codigo_siconfi + "</td>";
                                sTabela += "    <td style='text-align:left' class='linhagrid'>" + complemento + "</td>";
                                sTabela += "    <td style='text-align:left' class='linhagrid'>"
                                    + descricao.urlDecode()
                                    + (ativo == 'f' ? '<font color=\'red\'> (INATIVO) </font>' : '')
                                    + "</td>";
                            } else {
