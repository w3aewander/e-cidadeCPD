...
$oPdf->addTableHeader('Nome', 68, $iAltura, 'C', true);
$oPdf->addTableHeader('Data de Direito', 20, $iAltura, 'C', true);
$oPdf->addTableHeader('Nº dias Afastado', 65, $iAltura, 'C', true);
$oPdf->addTableHeader('Data Prevista', 20, $iAltura, 'C', true);
...
foreach ($aServidoresComDireito as $oServidor) {
  ...
  $oPdf->Cell(68, $iAltura, $oServidor->sNome, 0, 0, "L");
  $oPdf->Cell(20, $iAltura, db_formatar($oServidor->data_direito, 'd'), 0, 0, "C");
  $oPdf->Cell(65, $iAltura, $oServidor->afastamentos, 0, 0, "R");
  $oPdf->Cell(20, $iAltura, db_formatar($oServidor->data_prevista, 'd'), 0, 1, "C");
}
