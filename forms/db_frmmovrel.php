...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <fieldset>
    <legend>Leitura de dados externos:</legend>
    <table>
      <tr>
      ...
      <tr>
        <td> <b>Valores Duplicados:</b> </td>
        <td><?php db_select("acao", ["somar" => "Somar", "substituir" => "Substituir"], true, $db_opcao) ?></td>
      </tr>
      <tr>
        <td> <b>Permitir Exclusão:</b> </td>
        <td><?php db_select("acao", ["sim" => "Sim", "nao" => "Não"], true, $db_opcao) ?></td>
      </tr>
    </table>
  </fieldset>
  <input name="<?= ($db_opcao == 1 ? "incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "alterar" : "excluir")) ?>"
    ...
    <?= ($db_botao == false ? "disabled" : "") ?> onclick="return js_verifica_campos();">
