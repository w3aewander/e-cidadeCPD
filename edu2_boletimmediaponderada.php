...
for ($x = 0; $x < $clmatricula->numrows; $x++) {
  ...
  $pdf->Cell(42, $iAlturaLinha, $oMatricula->getNumeroOrdemAluno(), 0, 0, "L");
  $pdf->Cell(30, $iAlturaLinha, "_______________________________________", 0, 1, "C");

  $pdf->Cell(35, $iAlturaLinha, "SITUAÇÃO DO ALUNO(A):", 0, 0, "L");
  $pdf->Cell(40, $iAlturaLinha, $oMatricula->getSituacao(), 0, 0, "L");
