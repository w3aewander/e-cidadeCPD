 ...
 */
 ...
 class LinhaItinerarioMeioTransporte
 {
   private $dao;
   ...
   {
     $this->dao = new cl_itinerariomeiotransporte;
   }
   
   public function setMeioTransporte($meioTransporte)
   {
   ...
   public function salvar()
   {
      ...
      $where = " tre15_linhatransporteitinerario = ".$this->getLinhaItinerario()->getCodigo();
      ...
      if(pg_num_rows($rsVerificacaoItinerario) > 0){         
         ...
         $this->dao = new cl_itinerariomeiotransporte;
         $this->dao->tre15_linhatransporteitinerario = $this->getLinhaItinerario()->getCodigo();
         $this->dao->tre15_meiotransporte = $this->getMeioTransporte();
   ...
   public function excluir()
   {
      ...
      $where = "tre15_linhatransporteitinerario = {$itinerario}";
      $this->dao->excluir(null,$where);
      if($this->dao->erro_status == '0'){
         throw new Exception("Não foi possível excluir o meio de transporte do itinerário");
      }
   }
 }