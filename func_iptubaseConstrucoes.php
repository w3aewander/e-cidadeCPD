      ...
      <td width="100%" height="63" align="center" valign="top">
        <center>
          <table width="100%" border="0" align="center" cellspacing="0">
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tj01_matric ?>">
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tj14_codigo ?>">
                  <?php
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tz01_nome ?>">
                  <?php echo $Lz01_nome ?>
              </td>
              <td width="66%" align="left" nowrap>
                  <?php
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tj34_setor ?>">
                  <?php echo "{$Lj34_setor} / {$Lj34_quadra} / {$Lj34_lote} "; ?>
              </td>
              <td width="66%" align="left" nowrap>
                  <?php
            ...
            <tr>
              <td width="34%" align="right" nowrap
                  title="<?php echo $Tj06_setorloc ?>"><?php echo $Lj06_setorloc ?></td>
              <td>
                  <?php
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tj06_quadraloc ?>">
                  <?php echo $Lj06_quadraloc ?>
              </td>
            ...
            <tr>
              <td width="34%" align="right" nowrap title="<?php echo $Tj06_lote ?>"><?php echo $Lj06_lote ?></td>
            ...
            <tr>
              ...
              <td width="34%" align="right" nowrap title="<?php echo $Tj40_refant ?>">
  ...
  <tr>
    <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
            ...
            } elseif ((isset($j34_setor) && (trim($j34_setor) != "")) or
