...
class cl_fis_autousu {
   ...
   public $y56_codauto = 0;
   public $y56_id_usuario = 0;
   public $y56_obs = null;
   ...
   public function incluir ($y56_codauto,$y56_id_usuario){
      $this->atualizacampos();
   ...
   public function alterar ($y56_codauto=null,$y56_id_usuario=null) {
      $this->atualizacampos();
   ...
   public function excluir ($y56_codauto=null,$y56_id_usuario=null,$dbwhere=null) {
   ...
   public function sql_query ( $y56_codauto=null,$y56_id_usuario=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= "      inner join db_usuarios  on  db_usuarios.id_usuario = fis_autousu.y56_id_usuario";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_autousu.y56_codauto";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_auto.y50_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y56_codauto!=null ){
         $sql2 .= " where fis_autousu.y56_codauto = $y56_codauto ";
       }
       if($y56_id_usuario!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_autousu.y56_id_usuario = $y56_id_usuario ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   public function sql_query_file ( $y56_codauto=null,$y56_id_usuario=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
