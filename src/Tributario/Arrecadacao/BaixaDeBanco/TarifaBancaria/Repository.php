  ...
  public function getDadosRelatorio(\Banco $banco, \DBDate $dataInicial, \DBDate $dataFinal)
  {
    $campos = array(
      ...
      'count(*) as quantidade'
        ...
        $where .= " group by disarq.codret, disarq.arqret, formaarrecadacao.k178_descricao, disbancotarifa.k179_valor, disbanco.dtcredito ";

        $daoTarifas = new \cl_disbancotarifa();
        $sqlBuscaTarifas = $daoTarifas->sql_query_tarifas(null, implode(',', $campos), 'disbanco.dtcredito', $where);
