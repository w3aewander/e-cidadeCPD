...
//$consolida = true;
// FIM DO TRATAMENTO DO CONSOLIDADO
    ...
    $this->oPdf->ln(15);
    assinaturas($this->oPdf, &$oAssinatura, 'BG', $consolida, false,false);
  }
  ...
  public function getDados() {
    ...
    $rsBalanceteVerificacaoAtual =  db_planocontassaldo_matriz($this->iAnoUsu,
                                                               ...
                                                               '',
                                                               'true',
                                                               ( $this->exibirQuadroRelatorio(self::QUADRO_ATIVOS_PASSIVOS) ? 'true' : 'false' )
    );
...
//      }
  ...
  private function getValorDisponibilidadeFinanceira($iAno) {
    ...
    $oDataFinal   = new DBDate("{$iAno}-{$this->oPeriodo->o114_mesfinal}-{$iDiaFinal}");
