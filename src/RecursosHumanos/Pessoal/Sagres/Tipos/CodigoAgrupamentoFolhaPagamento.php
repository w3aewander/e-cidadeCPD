...
/**
 * Arquivo 4.39
 * Class CodigoAgrupamentoFolhaPagamento
 * @package ECidade\RecursosHumanos\Pessoal\Sagres\Tipos
 */
class CodigoAgrupamentoFolhaPagamento extends OutrosArquivosSagresFiscal
{
    const TAG = 'CodigoAgrupamentoFolhaPagamento';
