...
if (isset($e54_autori) and $e54_autori != "") {
    ...
    if ($clempautoriza->numrows > 0) {
        ...
        //------
        $rhist = $clempauthist->sql_record($clempauthist->sql_query($e54_autori, "*, users.id_usuario as id_usuario_original, users.login as login_original"));
...
<head>
    ...
    <script>
        ...
        //    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_clonlancam002','func_conlancam002.php?chavepesquisa='+"<?php echo  $e54_autori  ?>",'Pesquisa',true);
        // }
        function js_abre_empempitem() {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_empempitem', 'emp1_empempitem005.php?e60_numemp=' + "<?php echo  @$e61_numemp ?>" + '&e55_autori=' + "<?php echo  @$e54_autori ?>", 'Pesquisa', true);
        }

        function pesquisa_cgm() {
            js_JanelaAutomatica('cgm', '<?php echo  @$e54_numcgm ?>');
        }

        function pesquisa_dot() {
            js_JanelaAutomatica('orcdotacao', '<?php echo  @$e56_coddot ?>', '<?php echo  @$e54_anousu ?>');
        }

        function pesquisa_emp(opc) {
            js_JanelaAutomatica('empempenho', '<?php echo  @$e61_numemp ?>');
        }

        function js_abre_solicita() {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_solicita', 'func_solicita001.php?e55_autori=' + "<?php echo  $e54_autori ?>", 'Pesquisa', true);
        }

        function js_abre_pcproc() {
            js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_pcproc', 'func_pcproc001.php?e55_autori=' + "<?php echo  $e54_autori ?>", 'Pesquisa', true);
        }
...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
 ...
 --->
    <table width="80%" border="0" align="center" cellspacing="0">
        ...
        <tr>
            <td width="25%" align="right" nowrap title="<?php echo  $Te54_autori ?>"><?php echo  $Le54_autori ?></td>
            <td colspan="2" width="10%" align="left" nowrap><?php db_input("e54_autori", 8, "", true, "text", 3); ?> </td>
        </tr>
        <tr>
            <td align="right" nowrap>
                <?php db_ancora($Le61_numemp, "pesquisa_emp();", 1);     ?>
            <td nowrap>
                <?php
        ...
        <tr>
            <td align="right" nowrap><?php echo  $Le54_destin ?></td>
            <td colspan=2 align="left" nowrap><?php db_input("e54_destin", 40, "", true, "text", 3); ?></td>
        </tr>
        <tr>
            <td align="right" nowrap><?php echo  $Le54_emiss ?></td>
            <td align="left" nowrap>
                <?php if (isset($e54_emiss) and ($e54_emiss != "")) {
                ...
                ?> </td>
            <td align="left" nowrap><?php echo  $Le54_anulad ?>
                <?php if (isset($e54_anulad) and ($e54_anulad != "")) {
        ...
        <tr>
            <td align="right" nowrap><?php echo  $Lcoddepto ?></td>
            <td nowrap>
                <?php
            ...
            <td align="left" nowrap><span style="font-weight: bold;">Login autorização original:</span>
                <?php
                db_input("id_usuario_original", 10, "", true, "text", 3);
                db_input("login_original", 20, "", true, "text", 3);
                ?>
            </td>
        </tr>
        <tr>
            <td align="right" nowrap title="<?php echo  $Te54_numcgm ?>"><b><?php db_ancora($Le54_numcgm, "pesquisa_cgm();", 1); ?></b></td>
            <td align="left" nowrap title="<?php echo  $Te54_numcgm ?>">
                <?php db_input("e54_numcgm", 8, "", true, "text", 3);
                db_input("z01_nome", 40, "", true, "text", 3); ?>
            </td>
            <td align="left" nowrap><span style="font-weight: bold;">Login última alteração:</span>
                <?php
        ...
        <tr><!---  dotacao --->
            <td align="right" nowrap title="<?php echo  $Te56_coddot ?>">
                <?php db_ancora($Le56_coddot, "pesquisa_dot();", 1); ?></td>
            <td colspan=2 align="left">
                <?php db_input("e56_coddot", 8, "", true, "text", 3);
        ...
        <tr> <!--- valor --->
            <td align="right" nowrap><?php echo  $Le54_valor ?></td>
            <td align="left" nowrap><?php db_input("e54_valor", 8, "", true, "text", 3); ?></td>
            <td align="left" nowrap>
                <?php echo  $Le54_codtipo ?>
                <?php db_input("e54_codtipo", 6, "", true, "text", 3);
                db_input("e41_descr", 20, "", true, "text", 3); ?>
            </td>
        </tr>

        <tr> <!---historico  --->
            <td align="right" nowrap> <?php echo  $Le57_codhist ?></td>
            <td align="left" nowrap colspan="2">
                <?php db_input("e57_codhist", 6, "", true, "text", 3);
                db_input("e40_descr", 40, "", true, "text", 3); ?> </td>
        </tr>
        <tr> <!--- resumo --->
            <td align="right" nowrap><?php echo  $Le54_resumo ?> </td>
            <td colspan=2 rowspan=2 align="left"><?php db_textarea("e54_resumo", 2, 40, ""); ?> </td>
        </tr>
        <tr> <!--- vlranulo --->
            <td> &nbsp; </td>
        </tr>
