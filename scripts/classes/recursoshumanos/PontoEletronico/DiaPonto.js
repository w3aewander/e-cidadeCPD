...
(function(exports) {
  ...
  DiaPonto.prototype = {
    ...
    'verificarDatasMarcacoes' : function (tipoMarcacao) {
      ...
      this.getMarcacoes().each(function (marcacao, indice) {

        if(tipoMarcacao == marcacao.tipo || marcacao.tipo > tipoMarcacao) {

          if(marcacao.tipo > MarcacaoPonto.prototype.ENTRADA1) {

            var marcacaoAnterior = this.jornada.horas.itens[indice - 1].sHora;
            ...
            if(    marcacao.hora !== null
              && marcacao.hora.trim() !== ''
              && marcacao.hora.replace(/\:/g, '') < marcacaoAnterior.replace(/\:/g, '')) {
    ...
    'moverMarcacao' : function (tipoOrigem, tipoDestino) {
      ...
      if(marcacaoOrigem.hora == null || marcacaoOrigem.hora == '') {
        return false;
      }

      if(marcacaoDestino.hora != null && marcacaoDestino.hora != '') {
        return false;
      }
