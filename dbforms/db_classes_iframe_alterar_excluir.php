            ...
            <tr>
                <td align="center" valign="top">
                    <table border='1px' width="100%" bgcolor="#cccccc" style="" cellspacing="0px"
                        ...
                        if ($db_opcao == "Incluir") {
                            $db_opcao = 1;
                        } elseif ($db_opcao == "Alterar") {
                            $db_opcao = 2;
                        } elseif ($db_opcao == "Excluir") {
                            $db_opcao = 3;
                        }
...
//    echo "   <td  class='cabec' ".($cabecnowrap=="true"?"nowrap":"")." title='".$$Tlabel."'>".str_replace(":","",$$Llabel)." </td>\n";
                            ...
                            echo "    <td class='cabec ".((isset($escondeOpcoes) AND $escondeOpcoes == true) ? "esconder" : "")."' title='Alterar ou Excluir'><b>Opções</b></td>";
                            echo "   </tr>";
                            $cabec = true;
                        } elseif (!$numrows > 0) {
