...
$clacordogrupo->rotulo->label("ac02_descricao");
?>
<html>
<head>
    ...
    <td height="63" align="center" valign="top">
      <table width="35%" border="0" align="center" cellspacing="0">
        <form name="form2" method="post" action="">
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo  $Tac02_sequencial ?>">
                <?php echo  $Lac02_sequencial ?>
            </td>
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?php echo  $Tac02_descricao ?>">
              <b>Descrição:</b>
            </td>
            <td width="96%" align="left" nowrap>
                <?php
          ...
          <tr>
            <td colspan="2" align="center">
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar"
                     onClick="parent.db_iframe_acordogrupo.hide();">
            </td>
          </tr>
        </form>
      </table>
        ...
        if (!isset($pesquisa_chave)) {
            if (isset($campos) == false) {
                if (file_exists("funcoes/db_func_acordogrupo.php") == true) {
                    include(modification("funcoes/db_func_acordogrupo.php"));
                } else {
                    $campos = "acordogrupo.*";
                }
            }
            if (isset($chave_ac02_sequencial) && (trim($chave_ac02_sequencial) != "")) {
                ...
                if (isset($chave_ac02_descricao) && (trim($chave_ac02_descricao) != "")) {

                    $sql = $clacordogrupo->sql_query("", $campos, "ac02_sequencial",
                      " ac02_descricao like '$chave_ac02_descricao%' ");
                } else {
                    $sql = $clacordogrupo->sql_query("", $campos, "ac02_sequencial", "");
                }
            }
            ...
            if (isset($chave_ac02_sequencial)) {
                $repassa = array(
                  "chave_ac02_sequencial" => $chave_ac02_sequencial,
                  "chave_ac02_descricao"  => $chave_ac02_descricao
                );
            }
