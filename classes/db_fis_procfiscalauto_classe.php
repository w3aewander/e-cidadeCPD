...
class cl_fis_procfiscalauto
{
    ...
    public $y111_sequencial = 0;
    public $y111_procfiscal = 0;
    public $y111_auto = 0;
   ...
   // funcao para inclusao
    public function incluir($y111_sequencial = null)
    {
        $this->atualizacampos();
        ...
        $sql = "insert into fiscalizacao.fis_procfiscalauto(
                ...
                values (
                               ...
                               ,$this->y111_auto
                      ) returning y111_sequencial ";
        $result = db_query($sql);
        $this->y111_sequencial = db_utils::fieldsmemory($result, 0)->y111_sequencial;
   ...
   // funcao para alteracao
    public function alterar($y111_sequencial = null)
    {
        $this->atualizacampos();
   ...
   // funcao para exclusao
    public function excluir($y111_sequencial = null, $dbwhere = null)
    {
        $sql = " delete from fis_procfiscalauto where ";
        $sql2 = "";
   ...
   // funcao do recordset
    ...
    public function sql_query($y111_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
        ...
        $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_procfiscalauto.y111_auto";
        $sql .= "      inner join fiscalizacao.fis_procfiscal  on  fis_procfiscal.y100_sequencial = fis_procfiscalauto.y111_procfiscal";
        ...
        if ($dbwhere=="") {
            if ($y111_sequencial!=null) {
                $sql2 .= " where fis_procfiscalauto.y111_sequencial = $y111_sequencial ";
            }
        } elseif ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
    ...
    public function sql_query_file($y111_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
