...
class cl_conencerramento
{
   // cria variaveis de erro
    ...
    public $c42_sequencial = 0;
    public $c42_anousu = 0;
    public $c42_encerramentotipo = 0;
    public $c42_usuario = 0;
    public $c42_data_dia = null;
    public $c42_data_mes = null;
    public $c42_data_ano = null;
    public $c42_data = null;
    public $c42_hora = null;
    public $c42_instit = 0;
    public $c42_coddoc = 0;
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 c42_coddoc = int4 = Evento Contábil
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
     if($exclusao==false){
       ...
       $this->c42_coddoc = ($this->c42_coddoc == ""?@$GLOBALS["HTTP_POST_VARS"]["c42_coddoc"]:$this->c42_coddoc);
     }else{
       $this->c42_sequencial = ($this->c42_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c42_sequencial"]:$this->c42_sequencial);
     }
   }

    public function incluir($c42_sequencial)
    {
      $this->atualizacampos();
     ...
     if($this->c42_coddoc == null ){
       $this->c42_coddoc = "null";
     }
     ...
     if(($this->c42_sequencial == null) || ($this->c42_sequencial == "") ){
       $this->erro_sql = " Campo c42_sequencial não declarado.";
    ...
    public function alterar($c42_sequencial=null)
    {
      $this->atualizacampos();
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Encerramento do Ano contabil não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c42_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Encerramento do Ano contabil não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c42_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function excluir($c42_sequencial=null, $dbwhere = null)
    {
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Encerramento do Ano contabil não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Encerramento do Ano contabil não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c42_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
