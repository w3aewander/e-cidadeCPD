...
include(modification("classes/db_debcontapedidocgm_classe.php"));
include(modification("classes/db_debcontapedidomatric_classe.php"));
include(modification("classes/db_debcontapedidoinscr_classe.php"));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmdebcontapedido.php"));
	?>
    </center>
	</td>
  </tr>
