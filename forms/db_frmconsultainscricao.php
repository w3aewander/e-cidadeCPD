...
<script>
    function mostraJanelaPesquisa() {
        ...
        } else if (F.cpfCnpj.value.length > 0) {
            frameDadosInscricao.jan.location.href = 'iss3_consinscr003.php?cpfCnpj=' + F.cpfCnpj.value;
            frameDadosInscricao.mostraMsg();
            frameDadosInscricao.show();
            frameDadosInscricao.focus();
                ...
                <td align="left" valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <input name="cpfCnpj" type="text" id="cpfCnpj" size="14" maxlength="14">
                            </td>
                        </tr>
                        <tr>
                            <td nowrap>&nbsp;</td>
...
<script>
    var cpfCnpjField = new DBInputInteger(document.querySelector('#cpfCnpj'));
</script>
