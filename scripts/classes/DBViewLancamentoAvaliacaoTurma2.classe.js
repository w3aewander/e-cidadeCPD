 ...
 * @returns {DBViewLancamentoAvaliacaoTurma2}
 */
DBViewLancamentoAvaliacaoTurma2 = function (oDadosTurmaSelecionada ) {
   ...
   * Data: 28/10/2025
   * Demanda: 17930
   * Razão da mudança: Padronizar nome do botão para "Relatório" e garantir funcionamento em todos os bimestres
   */
  this.oBtnParecer.value             = 'Relatório';
   ...
   * Data: 28/10/2025
   * Demanda: 17930
   * Razão da mudança: Permitir botão funcionar sempre, exceto quando turma estiver encerrada
   */
  if (this.lTurmaEncerrada) {
  ...
  //this.oBtnMostraRec = document.createElement( 'input' );
  //this.oBtnMostraRec.setAttribute( 'type', 'button' );
  //this.oBtnMostraRec.setAttribute( 'value', 'Ocultar Recuperação' );
  //this.oBtnMostraRec.setAttribute( 'name', 'mostrarecuperacao' );
  //this.oBtnMostraRec.setAttribute( 'id', 'mostrarrecuperacao' );
  //this.oBtnMostraRec.setAttribute('onclick', 'mostrarec()');
  //this.oBtnMostraRec.setStyle( { 'width' : '130px' } );
  ...
  //this.oColunaMostraRec = document.createElement( 'td' );
  //this.oColunaMostraRec.setAttribute( 'id', 'oColunaMostraRec' );
  ...
  this.oDBFormCache = new DBFormCache( 'oDbFormCache', 'DBViewLancamentoAvaliacaoTurma2.classe.js' );
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.setCallBackCloseWindow = function(sFunction) {
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.criarWindow = function () {
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.show = function() {
  ...
  //$('oLinhaTrocaTurmaLegenda').appendChild( this.oColunaMostraRec );
  ...
  //$('oColunaMostraRec').appendChild( this.oBtnMostraRec );
 ...
 * @returns {Boolean}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.validaSeGradeFoiAlterada = function () {
 ...
 * @returns null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.montaSelectDisciplinas = function() {
 ...
 * @returns {DBViewLancamentoAvaliacaoTurma2.retornoTermos}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.buscaTermosTurma = function () {
 ...
 * @param oAjax
 */
DBViewLancamentoAvaliacaoTurma2.prototype.retornoTermos = function (oAjax) {
 ...
 * @returns {DBViewLancamentoAvaliacaoTurma2.retornoDosPeriodos}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.getPeriodosAvaliacao = function () {
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.retornoDosPeriodos = function (oAjax) {
  ...
  var aHeader = new Array('Nº', 'Aluno', 'Situação', '', '', '');
  var aWidth  = new Array('20px', '38%', '8%', '0%', '0%', '0%');
  ...
  oRetorno.aPeriodos.each(function (oPeriodo, iPeriodo) {
    ...
    if(oPeriodo.sFormaAvaliacao == "PARECER"){
      oPeriodo.sFormaAvaliacao = "Relatório";
    }
    aHeader.push(oPeriodo.sFormaAvaliacao);
    if(oPeriodo.sFormaAvaliacao == "Relatório"){
      oPeriodo.sFormaAvaliacao = "PARECER";
    }
    aHeader.push('Falta');
  ...
  /*
  var tabelacabeca = document.getElementById("tableoGridAproveitamentoheader");
  var linhacabeca2 = tabelacabeca.getElementsByTagName("tr")[1];

  linhacabeca2.cells[7].style.visibility = "hidden";
  linhacabeca2.cells[9].style.visibility = "hidden";
  linhacabeca2.cells[11].style.visibility = "hidden";
  linhacabeca2.cells[13].style.visibility = "hidden";

  var tabelacorpo = document.getElementById("oGridAproveitamentobody");
  var linhas = tabelacorpo.rows.length;

  console.log(tabelacorpo.rows);
  console.log(linhas);
  console.log(tabelacorpo[0].getElementsByTagName("td")[7]);

  for (var i = 0; i < linhas; i++) {
      tabelacorpo.rows[i].getElementsByTagName("td")[7].style.visibility = "hidden";
      tabelacorpo.rows[i].getElementsByTagName("td")[9].style.visibility = "hidden";
      tabelacorpo.rows[i].getElementsByTagName("td")[11].style.visibility = "hidden";
    }
  */
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.buscaAlunos = function () {
  ...
  oParametro.iTurma          = this.oDadosTurmaSelecionada.iTurma;
  oParametro.iRegencia       = $F('disciplina');
  oParametro._timestamp      = new Date().getTime(); // Força dados frescos do backend
 ...
 * @param oAjax
 */
DBViewLancamentoAvaliacaoTurma2.prototype.populaGrid = function (oAjax) {
  ...
  oRetorno.aAlunos.each(function (oAluno) {
    ...
    oAluno.oDisciplina.aAproveitamentos.each(function (oAproveitamento, iSeq) {
      console.log("Sò o novo pode entrar aqui");
      ...
      oParametros.lReadOnlyFalta    = true;  // bloqueia somente o campo falta
      ...
      console.log(oParametros.lReadOnlyNota);
      console.log("XXXXXXXXXXXXXXXXX");
    ...
    if(oResultadoFinal.nValor == "Parecer"){oResultadoFinal.nValor = "Relatório";}
    aLinha.push("<div style='text-align:center;'>"+oResultadoFinal.nValor+"</div>");
    if(oResultadoFinal.nValor == "Relatório"){oResultadoFinal.nValor = "Parecer";}
  ...
  //console.log("========");
  //console.log(tabelacorpo.rows[0].getElementsByTagName("td")[7]);
  //console.log("========");
  //console.log(tabelacorpo[0].getElementsByTagName("td")[7]);
 ...
 * @returns Element
 */
DBViewLancamentoAvaliacaoTurma2.prototype.constroiInputFalta = function (oAluno, oAproveitamento, oParametros) {
 ...
 * @return {Element}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.constroiInputNota = function (oAluno, oAproveitamento, oParametros) {
 ...
 * @returns {Element}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.constroiSelectNivel = function(oAluno, oAproveitamento, oParametros) {
  console.log("========CONSTRÓI NÍVEL========");
 ...
 * @returns {Element}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.constroiInputParecer = function(oAluno, oAproveitamento, oParametros) {
 ...
 * @returns {boolean}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.preencheNotaDisciplina = function(oAluno, oAproveitamento, oElement) {
 ...
 * @return null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.setaFuncoesNota = function (oAluno, oAproveitamento, iSequencia) {
 ...
 * @return null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.setaFuncoesFalta = function (oAluno, oAproveitamento, iSequencia) {
 ...
 * @return boolean
 */
DBViewLancamentoAvaliacaoTurma2.prototype.validaAulasDoPeriodo = function (iAulasPeriodo, oElemento, iFaltasAbonadas) {
 ...
 * @return null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.preencheFaltaDisciplina = function (iPeriodo, iMatricula, oElement) {
 ...
 * @return null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.sinalizarLinhaGrid = function (oObjeto, lPintar) {
 ...
 * @return boolean
 */
DBViewLancamentoAvaliacaoTurma2.prototype.salvarResultadoFinalParecer = function (iPeriodo, iMatricula, lMinimo, oElement) {
 ...
 * @return null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.abrirParecer = function (oAproveitamento, iMatricula, sIdAlvo) {
 ...
 * @returns {DBViewLancamentoAvaliacaoTurma2.retornoSalvarGradeAproveitamento}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.salvarGradeAproveitamento = function () {
 ...
 * @returns null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.retornoSalvarGradeAproveitamento = function(oAjax) {
 ...
 * @returns {DBViewLancamentoAvaliacaoTurma2.retornoCalculo}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.calcularResultados = function (oAluno, oAproveitamento, oElemento, lAtingiuMinimo) {
 ...
 * @param {Object} oAproveitamento
 */
DBViewLancamentoAvaliacaoTurma2.prototype.retornoCalculo = function (oAjax, oAluno, oAproveitamento, oSelf) {
 ...
 * @returns null
 */
DBViewLancamentoAvaliacaoTurma2.prototype.liberarBotoes = function () {
...
DBViewLancamentoAvaliacaoTurma2.prototype.abrirParecerComplementar = function () {
 ...
 * @param oAproveitamento
 */
DBViewLancamentoAvaliacaoTurma2.prototype.ajustaDependenciaDoPeriodo = function(iPeriodo, oAluno, oAproveitamento) {
  var oSelf = this;
  oSelf.aPeriodosAvaliacao.each(function (oPeriodo) {
    if (oPeriodo.iPeriodoDependenteAprovacao == iPeriodo) {
      ...
      var campoFalta = 'falta#4#'+oAluno.iMatricula;
      ...
      if ($(sIdCampoNota)) {
        ...
        //se o tiver falta e a nota for zero
        if(sValor == 0.0){
          var aulasp = oAluno.oDisciplina.aAproveitamentos[3].iAulasPerido;
          var faltasp = oAluno.oDisciplina.aAproveitamentos[3].iFalta;
          ...
          /*
          var cf2 = $(campoFalta).value;
          var fac =  document.getElementById("gridAulasDadasrow0cell3");
          var aulasdadas = fac.getElementsByTagName('input')[0].value;
          //if(cf2 > 0){
          if(cf2 == aulasdadas){
            sValor = "Faltou";
          }
 ...
 * @param iMatricula
 */
DBViewLancamentoAvaliacaoTurma2.prototype.gradeAvalicaoAluno = function(iMatricula) {
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.bloqueiaBotoes = function() {
 ...
 * @returns {Boolean}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.limparSessao = function() {
...
DBViewLancamentoAvaliacaoTurma2.prototype.getDadosPeriodo = function(iPeriodo) {
...
DBViewLancamentoAvaliacaoTurma2.prototype.getInformacoesPeriodo = function(iPeriodo) {
 ...
 * @returns {Object}
 */
DBViewLancamentoAvaliacaoTurma2.prototype.getPeriodoDependenteDoPeriodo = function(iPeriodo) {
...
DBViewLancamentoAvaliacaoTurma2.prototype.isMatriculaValida = function (sSituacaoMatricula)  {
 ...
 */
DBViewLancamentoAvaliacaoTurma2.prototype.validaFormaAvaliacaoDisciplina = function() {
  ...
  if( !oSelf.lTurmaEncerrada ) {
    ...
    // Removida condição que desabilitava o botão para disciplinas com forma de avaliação PARECER
    // Agora o botão sempre fica habilitado para permitir relatórios complementares
    oSelf.oDadosTurmaSelecionada.aDisciplinas.each(function( oDisciplina ) {
      // Botão sempre habilitado para todas as disciplinas
    });
  }
};
