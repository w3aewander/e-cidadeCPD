 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relattabelas.location.href='con1_db_relattabelas001.php?db92_codigo=".@$db91_codrel."';
         parent.document.formaba.db_relatfiltros.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relatfiltros.location.href='con1_db_relatfiltros001.php?db94_codigo=".@$db91_codrel."';
         parent.document.formaba.db_relatcabec.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relatcabec.location.href='con1_db_relatcabec001.php?db95_codigo=".@$db91_codrel."';
         parent.document.formaba.db_relatselecionados.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relatselecionados.location.href='con1_db_relatselecionados001.php?db93_codigo=".@$db91_codrel."';
         parent.document.formaba.db_relatsoma.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relatsoma.location.href='con1_db_relatsoma001.php?db96_codigo=".@$db91_codrel."';
         parent.document.formaba.db_relatquebra.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_db_relatquebra.location.href='con1_db_relatquebra001.php?db97_codigo=".@$db91_codrel."';
     ";
         if(isset($liberaaba)){
