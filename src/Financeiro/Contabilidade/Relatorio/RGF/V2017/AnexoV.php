...
class AnexoV extends \RelatoriosLegaisBase
{
    ...
    {
        parent::__construct($anoSessao, static::CODIGO_RELATORIO, $codigoPeriodo);
    }
    ...
    protected function processarColunaCaixaBruta()
    {
        ...
        foreach ($this->linhasAnaliticas as $linha) {
            ...
            $oLinha->colunas[0]->o116_formula = "
            (substr(#estrutural, 0, 1) == 1 && #sinal_final == 'C') ||
        ...
        foreach ($this->linhasAnaliticas as $linha) {
            ...
            foreach ($instituicoesSelecionadas as $instituicao) {
                ...
                for ($rowReduzido = 0; $rowReduzido < $totalReduzidos; $rowReduzido++) {
                    ...
                    $relatorio = new \RelatorioDisponibilidadeFinanceira(
                        $instituicao,
                        $this->getDataInicial(),
                        $this->getDataFinal(),
                        \RelatorioDisponibilidadeFinanceira::AGRUPAMENTO_RECURSO
                    );
