...
class PostgreSQLUtils
{
    ...
    public function PostgreSQLUtils($conexao = null)
    {
    ...
    public function cancelQuery($pid = 0)
    {
    ...
    public static function isTableExists($sRelacao, $sType = 'tabela', $sEsquema = null)
    {
   ...
   * Return @$aIndexes
   */
    public function getTableIndexes($sNomeTabela)
    {
