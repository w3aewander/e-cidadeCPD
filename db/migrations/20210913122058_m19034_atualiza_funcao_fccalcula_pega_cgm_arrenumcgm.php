...
class M19034AtualizaFuncaoFccalculaPegaCgmArrenumcgm extends PostgresMigration
{

    public function up()
    {
        $sSqlAtualizaFuncaoUp =
<<<EOL
...
EOL;
        ...
        $this->execute($sSqlAtualizaFuncaoUp);
    }

    public function down()
    {

        $sSqlAtualizaFuncaoDown =
<<<EOL
...
EOL;
        ...
        $this->execute($sSqlAtualizaFuncaoDown);
    }
