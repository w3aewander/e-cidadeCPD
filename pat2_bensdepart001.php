...
function js_abre(){
    ...
    var z = document.getElementsByName("tipob");
    var z0, z1, z2, tipodobem = 0;
    //console.log(z);
    //console.log(z[0]);
    //console.log(z[1]);
    //console.log(z[2]);
    ...
    qry+= '&tipobem='+tipodobem;
    //console.log("---------");
    //console.log(tipodobem);
    //console.log("---------");
...
function js_abre2(){
    ...
    var z = document.getElementsByName("tipob");
    var z0, z1, z2, z3, z4, tipodobem = 0;
    console.log(z);
    //console.log(z[0]);
    //console.log(z[1]);
    //console.log(z[2]);
    ...
    jan  = window.open('pat2_bensdepart002csv.php?'+qry,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);
          //document.form1.coddepto.style.backgroundColor='';
}
...
<?php /* ?>
    ...
    <tr>
      <td nowrap align="right" title="Características adicionais do bem"><b>Dados Adicionais:</b></td>
      <td nowrap title=""><?
      $matriz = array("N"=>"NÃO","S"=>"SIM"); 
    ...
    <tr>
      <td nowrap align="right" title="tiposbens"><b>Tipo de Bens:</b></td>
      <td nowrap title="">
        <input type="checkbox" name="tipob" value="1" checked>Todos
        <input type="checkbox" name="tipob" value="2">Móveis
        <input type="checkbox" name="tipob" value="3">Imóveis
        <?php if(db_getsession("DB_instit") == 45) : ?>
          <input type="checkbox" name="tipob" value="4">Reavaliados
          <input type="checkbox" name="tipob" value="5">Não Reavaliados
        <?php endif; ?>
      </td>
    </tr>
...
<input name="relatorio" type="button" onclick='js_abre2();' value="Gerar relatório XLS">
</form>
