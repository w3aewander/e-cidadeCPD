...
include(modification("classes/db_fis_aidofcanc_classe.php"));
include(modification("classes/db_fis_aidof_classe.php"));
include(modification("dbforms/db_funcoes.php"));
db_postmemory($HTTP_POST_VARS);
$claidofcanc = new cl_fis_aidofcanc;
  ...
  if($claidof->numrows>0){
  	db_fieldsmemory($Result_Notfim,0);
  		...
  		if($claidof->numrows>0){
  			...
  			$sqlerro=true;
  			echo "<script>location.href='fis1_fis_aidofcancalt001.php';</script>";
  			exit;
  		}
  } 
  db_inicio_transacao();  
...
<body bgcolor=#CCCCCC onLoad="a=1" >
	...
	<?php 
	include(modification("forms/db_frm_fis_aidofdescancalt.php"));
	?>
...
if(isset($incluir)){
  if($sqlerro==true){  	
  	...
  	echo "<script>location.href='fis1_fis_aidofdescancalt001.php';</script>";
  	exit;
  }
}
if ($pesq==true){
