...
class cl_fis_levretnome {
   ...
   public $y65_sequencia = 0;
   public $y65_nome = null;
   public $y65_cnpj = null;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_levretnome");
...
public function incluir ($y65_sequencia){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_levretnome(
                                       y65_sequencia
                                      ,y65_nome
                                      ,y65_cnpj
                       )
...
public function alterar ($y65_sequencia=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_levretnome set ";
     $virgula = "";
...
public function excluir ($y65_sequencia=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_levretnome
                    where ";
     $sql2 = "";
