...
if($ordem == 'e'){
 ...
 $sOrdem = "e60_emiss, e50_numemp";
}else if($ordem == 'v'){
 $sOrdem = "e53_valor, e50_numemp";
}else if($ordem == 'c'){
 $sOrdem = "e60_numcgm, e50_numemp";
}
...
if($listacredor != ""){
  $where1 = "and e60_numcgm in ($listacredor)";
}
...
$result=$clpagordem->sql_record($clpagordem->sql_query_pagordemele(null,"e50_codord,e50_numemp,e60_numcgm,e50_obs,e50_data,z01_nome,sum(e53_valor-e53_vlranu) as e53_valor, e60_emiss, e60_numcgm ","$sOrdem"," e60_instit = " . db_getsession("DB_instit") .  " and $where $where1 $where2 group by e50_codord,e50_numemp,e60_numcgm,e50_obs,e50_data,z01_nome,e60_emiss,e60_numcgm"));
