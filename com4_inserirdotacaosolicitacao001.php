...
<html>
  <head>
    ...
    <?
      ...
      db_app::load("classes/DBViewSolicitacaoDotacaoInclusao.classe.js");
  ...
  <body style="background-color: #cccccc; margin-top: 25px">
    ...
    <center> 
      ...
      <input style='margin-top: 10px;' type="button" name='Inserir' value='Inserir' onclick="validarDados();">
    </center>
  </body>
</html>
<?
...
?>
<script>
var sUrl = "com4_inserirdotacaosolicitacao.RPC.php";
