...
require_once(modification("classes/db_fis_aidof_classe.php"));
require_once(modification("classes/db_fis_aidofproc_classe.php"));
...
$claidof     = new cl_fis_aidof;
$claidofproc = new cl_fis_aidofproc;
$db_opcao    = 1;
$db_botao    = true;
$y08_codigo  = '';
?>
...
<?php
  ...
  if (!empty($oGet->y08_inscr)) {
    include(modification("forms/db_frm_fis_aidof.php"));
  } else {
    include(modification("forms/db_frm_fis_aidof001.php"));
  }
?>
<?php
...
if(isset($db_opc)&& $db_opc=="Incluir"){
  ...
  try {
    ...
    $oAidof->setGrafica(new FisGrafica($y08_numcgm));
