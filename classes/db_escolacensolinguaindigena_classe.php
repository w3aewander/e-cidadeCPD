...
class cl_escolacensolinguaindigena
{
   ...
   // cria propriedade com as variaveis do arquivo 
    ...
    {
        $this->rotulo = new rotulo("escolacensolinguaindigena"); 
    ...
    public function incluir($ed144_i_codigo)
    {
     ...
     if($this->ed144_i_linguaindigena1 == null ){ 
       $this->ed144_i_linguaindigena1 = "null";
     }
     if($this->ed144_i_linguaindigena2 == null ){ 
       $this->ed144_i_linguaindigena2 = "null";
     }
     if($this->ed144_i_linguaindigena3 == null ){ 
       $this->ed144_i_linguaindigena3 = "null";
     }
     if($ed144_i_codigo == "" || $ed144_i_codigo == null ){
       $result = db_query("select nextval('escolacensolinguaindigena_ed144_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: escolacensolinguaindigena_ed144_i_codigo_seq do campo: ed144_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from escolacensolinguaindigena_ed144_i_codigo_seq");
     ...
     $sql = "insert into escolacensolinguaindigena(
                                       ed144_i_escola 
    ...
    {
      $this->atualizacampos();
     $sql = " update escolacensolinguaindigena set ";
     $virgula = "";
    ...
    public function excluir($ed144_i_codigo=null, $dbwhere = null)
    {
     ...
     $sql = " delete from escolacensolinguaindigena
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
    ...
    public function sql_record($sql)
    {
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:escolacensolinguaindigena";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
    ...
    public function sql_query($ed144_i_codigo = null,$campos = "*", $ordem = null, $dbwhere = "") { 
     ...
     $sql  = "select {$campos}";
     $sql .= "  from escolacensolinguaindigena ";
     $sql .= "      left  join censolinguaindig  on  censolinguaindig.ed264_i_codigo = escolacensolinguaindigena.ed144_i_linguaindigena1 and  censolinguaindig.ed264_i_codigo = escolacensolinguaindigena.ed144_i_linguaindigena2 and  censolinguaindig.ed264_i_codigo = escolacensolinguaindigena.ed144_i_linguaindigena3";
     $sql .= "      inner join escola  on  escola.ed18_i_codigo = escolacensolinguaindigena.ed144_i_escola";
     ...
     if (empty($dbwhere)) {
       if (!empty($ed144_i_codigo)) {
         $sql2 .= " where escolacensolinguaindigena.ed144_i_codigo = $ed144_i_codigo "; 
       } 
