...
class AvaliacaoGrupo
{
    ...
    public function __construct($iGrupo = null)
    {
        ...
        $this->iOrdem = $oDadosGrupo->db102_ordem;
        unset($oDadosGrupo);
    }
    /**
     * @return integer
    ...
    /**
     * Retorna ordem de exibição do grupo de perguntas.
     *
     * @return integer
     */
    ...
    /**
     * Define ordem de exibição do grupo de perguntas.
     *
        ...
        if (count($this->aPerguntas) == 0 && !empty($this->iGrupo)) {
            ...
            if ($oDaoPergunta->numrows > 0) {
                ...
                foreach ($aPerguntas as $oPerguntaTemp) {
                    $oPergunta          = AvaliacaoPergunta::make($oPerguntaTemp);
                    $this->aPerguntas[] = $oPergunta;
                }
            }
        }
    ...
    public function salvar()
    {
        ...
        $oDao->db102_ordem              = $this->getOrdem();
     ...
     * @throws DBException
     */
    public static function make($oDadosGrupo)
    {
       $avaliacaoGrupo = new AvaliacaoGrupo(null);

       $avaliacaoGrupo->setCodigo($oDadosGrupo->db102_sequencial);
       $avaliacaoGrupo->setDescricao($oDadosGrupo->db102_descricao);
       $avaliacaoGrupo->setIdentificador($oDadosGrupo->db102_identificador);
       $avaliacaoGrupo->setIdentificadorCampo($oDadosGrupo->db102_identificadorcampo);
       $avaliacaoGrupo->setOrdem($oDadosGrupo->db102_ordem);
       return $avaliacaoGrupo;
