...
$paty       = false;
$prefeitura = InstituicaoRepository::getInstituicaoByCodigo(db_getsession("DB_instit"));
...
$sql = <<<SQL
   ...
   from
      orcreserva
   inner join orcdotacao   on o58_coddot  = o80_coddot and o58_anousu  = o80_anousu
   inner join orcorgao     on o40_orgao   = o58_orgao and o40_anousu  = o58_anousu
   inner join orcunidade   on o41_unidade = o58_unidade and o41_orgao   = o58_orgao and o41_anousu  = o58_anousu
   ...
   inner join orcprojativ  on o58_projativ= o55_projativ and o80_anousu = o55_anousu
   inner join orctiporec   on o58_codigo  = o15_codigo
   inner join fonterecurso on orctiporec_id = o15_codigo and exercicio = o80_anousu
   where
      o80_codres = $res;
SQL;
...
for($x = 0; $x < pg_numrows($result); $x++){
   ...
   $pdf->setfont('arial','b',8);
   $pdf->cell(40,$alt,'Dotação Orçamentária',0,0,"L",0);
   $pdf->setfont('arial','',8);
   ...
   $pdf->setfont('arial','b',8);
      ...
      $pdf->setfont('arial','',8);
      $pdf->multicell(0,$alt,':  '.$gestao.' - '.$descricao,0,1,"L",0);
      $pdf->setfont('arial','b',8);
   ...
   $pdf->setfont('arial','b',8);
      ...
      $pdf->cell(40,$alt,'Função',0,0,"L",0);
      $pdf->setfont('arial','',8);
      $pdf->cell(40,$alt,':  '.$o52_descr,0,1,"L",0);
      $pdf->setfont('arial','b',8);
      $pdf->cell(40,$alt,'Sub-Função',0,0,"L",0);
      $pdf->setfont('arial','',8);
      $pdf->cell(40,$alt,':  '.$o53_descr,0,1,"L",0);
      $pdf->setfont('arial','b',8);
      $pdf->cell(40,$alt,'Programa',0,0,"L",0);
      $pdf->setfont('arial','',8);
      $pdf->cell(40,$alt,':  '.$o54_descr,0,1,"L",0);
      $pdf->setfont('arial','b',8);
      $pdf->cell(40,$alt,'Proj/Ativ',0,0,"L",0);
      $pdf->setfont('arial','',8);
      $pdf->cell(40,$alt,':  '.$o55_descr,0,1,"L",0);
      $pdf->setfont('arial','b',8);
