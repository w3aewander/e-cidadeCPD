...
<script>
	...
	function js_pesquisax19_zona(mostra) {
		if (mostra == true) {
			js_OpenJanelaIframe('CurrentWindow.corpo.iframe_aguaconsumo', 'db_iframe_zonas',
				'func_zonas.php?funcao_js=parent.js_mostrazonas1|j50_zona|j50_descr', 'Pesquisa', true);
		} else {
			if (document.form1.x19_zona.value != '') {
				js_OpenJanelaIframe('CurrentWindow.corpo.iframe_aguaconsumo', 'db_iframe_zonas',
					'func_zonas.php?pesquisa_chave=' + document.form1.x19_zona.value +
	...
	function js_mostrazonas(chave, erro) {
		...
		if (erro == true) {
			document.form1.x19_zona.focus();
			document.form1.x19_zona.value = '';
		}
	}

	function js_mostrazonas1(chave1, chave2) {
		document.form1.x19_zona.value = chave1;
