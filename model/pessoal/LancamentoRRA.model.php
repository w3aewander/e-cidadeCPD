...
class LancamentoRRA {
   ...
   *
   *  @param  Float $nNM Quantidade relativa de meses do total quanto a parcela
  ...
  private function calcularPrevidencia () {
    ...
    $oTabelaPrevidencia = TabelaValoresPrevidenciaRepository::getByCodigo($iCodigoPrevidencia, 'Prev');
  ...
  private function calcularIRRF () {
    ...
    $oTabelaIRRFRRA = TabelaValoresRRARepository::getByCodigo($oParametros->getCodigoTabelaIRRFRRA(), 'Irrf');
