            ...
            if (iNumRows > 0) {
                aDados.each(
                    function (oDado, iInd) {
                        ...
                        $('o15_descr').innerHTML = oDado.o15_descr.urlDecode() + ' - ' + oDado.complemento.urlDecode();
                        $('e83_descr').innerHTML = oDado.e83_descr.urlDecode();
                        $('banco').innerHTML = oDado.c63_banco;
                        $('recurso').innerHTML = oDado.fonteRecurso.urlDecode();
...
<table width="100%" align="center" style="margin-top: 20px;">
    ...
    <tr>
        <td colspan='2' align="center">
            ...
            <input name="fechar" id="fechar" type="button" value="Fechar"
                   onclick="parent.db_iframe_dados_cheque.hide();">
        </td>
    </tr>
</table>
</body>
