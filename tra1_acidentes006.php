 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_veiculos_env.location.href='tra1_veiculos_env001.php?db_opcaoal=33&tr08_id=".@$tr07_id."';
         parent.document.formaba.vitimas_acid.disabled=false;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_vitimas_acid.location.href='tra1_vitimas_acid001.php?db_opcaoal=33&tr10_id=".@$tr07_id."';
     ";
         if(isset($liberaaba)){
