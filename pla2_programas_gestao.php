...
<div class="container">
    <fieldset>
        <legend>Emissão dos Programas de Gestão</legend>
        ...
        <fieldset class="separator">
            ...
            <fieldset class="separator">
                <legend>Filtros para emissão do PDF</legend>
                <table class="form-container">
                    <tr>
                        <td><label class="bold" for="apresentaMetasObjetivoPrograma">
                                Objetivos e Metas do programa
                            </label>
                        </td>
                        <td>
                            <select id="apresentaMetasObjetivoPrograma" class="field-size8">
                                <option value="1">Apresentar</option>
                                <option value="0" selected><b>Não</b> apresentar</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label class="bold" for="apresentaIdentidadeOrganizacional">Identidade
                    ...
                    <tr>
                        <td>
                            <label class="bold" for="agrupaorgao">Agrupar por Órgãos</label>
                        </td>
                        <td>
                            <select id="agrupaorgao" class="field-size8">
                                <option value="1">Sim</option>
                                <option value="0"><b>Não</b></option>
                            </select>
                        </td>
                    </tr>
                </table>
...
<script>
    ...
    const rota = 'financeiro/planejamento/relatorios/programa-gestao';
    ...
    planejamento.getElement().addEventListener('change', () => {
        ...
        let filtros = ['previsao=', `ano=${planejamento.getPlano().pl2_ano_inicial}`, 'programasGestao='];
    ...
    btnEmitir.addEventListener('click', () => {
        ...
        formData.append('apresentaMetasObjetivoPrograma', $('apresentaMetasObjetivoPrograma').value);
        ...
        formData.append('agrupaorgao', $('agrupaorgao').value);
        ...
        HttpClient.post(`${PHPSession.requestApi}/${rota}`, {body: formData}).then(response => {
            ...
            download.addFile(response.data.pdf, "Programa de Gestão - PDF");
            download.addFile(response.data.xls, "Programa de Gestão - XLS");
            download.show();
        });
    });
