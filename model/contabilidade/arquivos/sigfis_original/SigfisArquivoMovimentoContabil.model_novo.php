      ...
      for ($i = 0; $i < $clConLanCam->numrows; $i++) {
       ...
       //   if (!isset($aMovimentoContabil[$sIndice])) {
           if( $iAnoSessao < 2016 ){
					...
					$sContaCorrente = "select c56_contabancaria as seq_conta_corrente from contabilidade.conplano left join conplanocontabancaria on conplano.c60_codcon = conplanocontabancaria.c56_codcon and conplano.c60_anousu   = conplanocontabancaria.c56_anousu left join configuracoes.contabancaria on db83_sequencial = c56_contabancaria where c60_anousu = $this->iAnoUso and c60_codcon = $oDadosQuery->conta ";				
				}
...
$sSql .= "               and to_char(cast('{$dtDataFinal}' as date),'mm') = '01'                                        ";
$sSql .= "            ) lanc                                                                                            ";
$sSql .= "       group by conta,                                                                                	";
$sSql .= "                competencia,                                                                                  ";
$sSql .= "                tipo_movimento,                                                                               ";
