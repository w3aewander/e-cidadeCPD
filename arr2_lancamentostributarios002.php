...
$oPdf->init(false);
$oPdf->addTitulo("Relatório de Lançamentos Tributários");
$oPdf->addTitulo("Exercício dos Lançamentos: $oGet->iAnoCalculo");
$oPdf->addTitulo("Data de Geração: " . date('d/m/Y', db_getsession('DB_datausu')));
$oPdf->AliasNbPages();
