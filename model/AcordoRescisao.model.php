...
class AcordoRescisao extends AcordoMovimentacao {
  ...
  /**
   ...
   /**
   * Remove recisao do acordo
   * @return boolean sucesso ou falha
   */
  public function removeRescisao()
  {
      ...
      if (empty(db_utils::getCollectionByRecord($rsSqlAcordoMovimentacao))) {
          return false;
      }

      $sucesso = $oDaoAcordoMovimentacao->excluir(null, $sWhere);
