                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <input name="Fechar" type="button" id="fechar" value="Fechar"
                                   onClick="parent.db_iframe_orcparamrel.hide();">
                        </td>
                    </tr>
                </form>
            </table>
            ...
            if (!isset($pesquisa_chave)) {
                if (isset($campos) == false) {
                    if (file_exists("funcoes/db_func_orcparamrel.php") == true) {
                        include(modification("funcoes/db_func_orcparamrel.php"));
                    } else {
                        $campos = "orcparamrel.*";
                    }
                }
                ...
                } elseif (isset($chave_o42_descrrel) && (trim($chave_o42_descrrel) != "")) {
                    $sql = $clorcparamrel->sql_query(
                        "",
                        $campos,
                        "o42_descrrel",
                        " o42_descrrel like '$chave_o42_descrrel%' "
                    );
                } else {
