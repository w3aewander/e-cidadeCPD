      ...
      if (!isset($pesquisa_chave)) {
        if (isset($campos)==false) {
          if (file_exists("funcoes/db_func_pcmaterele.php")==true) {
            include(modification("funcoes/db_func_pcmaterele.php"));
          } else {
        ...
        if (isset($chave_pc07_codmater) && (trim($chave_pc07_codmater)!="") ) {
          ...
          $sql = $clpcmaterele->sql_query_funcautmater(null, null,$campos,"pc07_codmater"," pc07_codmater=$chave_pc07_codmater $where_ativo and $where_libaut {$sWhereElementoAutorizacao}");
          ...
          $sql = $clpcmaterele->sql_query_funcauteledescr("","",$campos,"pc07_codmater","$chave_pc01_descrmater#$chave_o56_elemento", "$where_ativo $sWhereElementoAutorizacao");
          ...
          $sql = $clpcmaterele->sql_query_funcautele("","",$campos,"pc07_codmater"," o56_elemento like '$chave_o56_elemento%' and o56_anousu = " . db_getsession("DB_anousu"),  " $where_ativo {$sWhereElementoAutorizacao} ");
          $repassa["chave_o56_elemento"]    = $chave_o56_elemento;
