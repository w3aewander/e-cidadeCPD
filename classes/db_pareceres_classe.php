...
class cl_pareceres { 
   ...
   function incluir ($ed25_i_codigo){ 
     ...
     if($ed25_i_codigo == "" || $ed25_i_codigo == null ){
       $result = @db_query("select nextval('pareceres_ed25_i_codigo_seq')"); 
       if($result==false){
       ...
       $result = @db_query("select last_value from pareceres_ed25_i_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acountkey values($acount,1006172,'$this->ed25_i_codigo','I')");
       $resac = db_query("insert into db_acount values($acount,1000030,1006172,'','".AddSlashes(pg_result($resaco,0,'ed25_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000030,1006173,'','".AddSlashes(pg_result($resaco,0,'ed25_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000030,1006205,'','".AddSlashes(pg_result($resaco,0,'ed25_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000030,1006174,'','".AddSlashes(pg_result($resaco,0,'ed25_t_atividades'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1000030,1006175,'','".AddSlashes(pg_result($resaco,0,'ed25_l_apto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed25_i_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1006172,'$this->ed25_i_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed25_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1000030,1006172,'".AddSlashes(pg_result($resaco,$conresaco,'ed25_i_codigo'))."','$this->ed25_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed25_i_matricula"]))
           $resac = db_query("insert into db_acount values($acount,1000030,1006173,'".AddSlashes(pg_result($resaco,$conresaco,'ed25_i_matricula'))."','$this->ed25_i_matricula',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed25_d_data"]))
           $resac = db_query("insert into db_acount values($acount,1000030,1006205,'".AddSlashes(pg_result($resaco,$conresaco,'ed25_d_data'))."','$this->ed25_d_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed25_t_atividades"]))
           $resac = db_query("insert into db_acount values($acount,1000030,1006174,'".AddSlashes(pg_result($resaco,$conresaco,'ed25_t_atividades'))."','$this->ed25_t_atividades',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed25_l_apto"]))
           $resac = db_query("insert into db_acount values($acount,1000030,1006175,'".AddSlashes(pg_result($resaco,$conresaco,'ed25_l_apto'))."','$this->ed25_l_apto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed25_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1006172,'$ed25_i_codigo','E')");
         $resac = db_query("insert into db_acount values($acount,1000030,1006172,'','".AddSlashes(pg_result($resaco,$iresaco,'ed25_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000030,1006173,'','".AddSlashes(pg_result($resaco,$iresaco,'ed25_i_matricula'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000030,1006205,'','".AddSlashes(pg_result($resaco,$iresaco,'ed25_d_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000030,1006174,'','".AddSlashes(pg_result($resaco,$iresaco,'ed25_t_atividades'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1000030,1006175,'','".AddSlashes(pg_result($resaco,$iresaco,'ed25_l_apto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
