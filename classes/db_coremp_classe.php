...
class cl_coremp
{
    ...
    public function incluir($k12_id, $k12_data, $k12_autent)
    {
        $this->atualizacampos();
    ...
    public function alterar($k12_id = null, $k12_data = null, $k12_autent = null)
    {
        $this->atualizacampos();
        ...
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
            ...
            if ($this->numrows > 0) {
                ...
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["k12_empen"]) || $this->k12_empen != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["k12_cheque"]) || $this->k12_cheque != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["k12_codord"]) || $this->k12_codord != "")
    ...
    public function excluir($k12_id = null, $k12_data = null, $k12_autent = null, $dbwhere = null)
    {
        $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
            && ($lSessaoDesativarAccount === false))) {
    ...
    public function sql_query($k12_id = null, $k12_data = null, $k12_autent = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= "      inner join db_config  as a on   a.codigo = empempenho.e60_instit";
    ...
    public function sql_query_file($k12_id = null, $k12_data = null, $k12_autent = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_nome($k12_id = null, $k12_data = null, $k12_autent = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_saltes($k12_id = null, $k12_data = null, $k12_autent = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        ...
        $sql .= " from coremp ";
        $sql .= "      inner join corrente  on  corrente.k12_id = coremp.k12_id and  corrente.k12_data = coremp.k12_data and  corrente.k12_autent = coremp.k12_autent";
        $sql .= "      inner join saltes  on  saltes.k13_conta = corrente.k12_conta";
        $sql .= " where $dbwhere";
