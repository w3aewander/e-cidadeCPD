...
//    $sSqlBuscaRetencoes .= "        e50_codord,                                                                ";
    ...
    $sSqlBuscaRetencoes .= "        c60_codcon as conta,                                                       ";
//    $sSqlBuscaRetencoes .= "        k02_codigo,                                                                ";
    ...
    $sSqlBuscaRetencoes .= " group by k12_data, e60_codemp, e60_anousu, c61_codcon, c60_estrut, c60_codcon, ";
...
//	  if( $iAnoSessao < 2016 ){
            $sContaCorrente = "select (CASE WHEN $this->iAnoUso < 2016 THEN c56_sequencial ELSE c56_contabancaria END) as seq_conta_corrente from contabilidade.conplano left join conplanocontabancaria on conplano.c60_codcon = conplanocontabancaria.c56_codcon and conplano.c60_anousu   = conplanocontabancaria.c56_anousu left join configuracoes.contabancaria on db83_sequencial = c56_contabancaria where c60_anousu = $this->iAnoUso and c60_codcon = $oRetencao->conta ";
/*         } ELSE
         {
            $sContaCorrente = "select c56_contabancaria as seq_conta_corrente from contabilidade.conplano left join conplanocontabancaria on conplano.c60_codcon = conplanocontabancaria.c56_codcon and conplano.c60_anousu   = conplanocontabancaria.c56_anousu left join configuracoes.contabancaria on db83_sequencial = c56_contabancaria where c60_anousu = $this->iAnoUso and c60_codcon = $oRetencao->conta ";         
         }
*/
      //        die( $sContaCorrente );
        $rsContaCorrente = db_query($sContaCorrente);
        $oDadosContaCorrente = db_utils::fieldsMemory($rsContaCorrente, 0);
//  $this->addLog($sContaCorrente);
...
//    	$oDadosLinha->cd_UnidadeOrcamentaria  = str_pad($oRetencao->o58_orgao,    2, '0', STR_PAD_LEFT);
    ...
    //	$oDadosLinha->nu_EmpenhoSup           = str_pad(str_repeat(' ', 10),  10, ' ', STR_PAD_LEFT);
        ...
        $oDadosLinha->cd_ContaCorrente        = str_pad($oDadosContaCorrente->seq_conta_corrente, 30, ' ', STR_PAD_RIGHT);
