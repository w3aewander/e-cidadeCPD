...
<center>
    <table width="100%" cellspacing="0" cellpading="0" border="1" bordercolor="#000000">
        ...
        for ($z = 0; $z < $clperiodoescola->numrows; $z++) {
            ...
            <td align="center" style="font-weight: bold; color: #DEB887;"><?= pg_result($result1, $z, "ed15_c_nome"); ?>
                ...
                if ($cldiasemana->numrows == 0) {
                    ?>
                <tr>
                    <td><a href="javascript:parent.location.href='edu1_diasemanaabas001.php'"><b>Informe os dias lelivos
                                desta escola</b></a></td>
                </tr><?php
                }
        ...
        for ($x = 0; $x < $cldiasemana->numrows; $x++) {
            ...
            UNION
            SELECT ed20_i_codigo,case when ed20_i_tiposervidor = 1 then cgmrh.z01_nome else cgmcgm.z01_nome end as z01_nome,ed232_c_descr
                        FROM regenciahorariodiscsemreg
                         ...
                         left join rechumanocgm  on  rechumanocgm.ed285_i_rechumano = rechumano.ed20_i_codigo
                         left join cgm as cgmcgm on  cgmcgm.z01_numcgm = rechumanocgm.ed285_i_cgm
                        WHERE ed175_diasemana = $ed32_i_codigo and ed175_ativo is true
           ...
           ";
            ...
            if ($linhas2 > 0) {
                ...
                $ed232_c_descr = implode("<br>", $aDisciplinas);
                $regente = $z01_nome;
                if ($regente == null) {
                    $regente = "SEM PROFESSOR VINCULADO";
                }
                $disci = $ed232_c_descr;
                $cor = "red";
            } else {
            ...
            ?>
            <td style="font-size:11px;background:#DBDBDB;" align="left">
                <?php
