...
if (isset($lcgmalt) && $lcgmalt == "true") {
    $sCamposAlt = " z05_sequencia, z05_ufcon as z01_ufcon,z05_uf as z01_uf, z05_telef as z01_telef, z05_telcon as z01_telcon, z05_telcel as z01_telcel,z05_profis as z01_profis,
								z05_numero as z01_numero,z05_numcon as z01_numcon,z05_numcgm as z01_numcgm,z05_nome as z01_nome,z05_nome as z01_nomecomple,z05_nacion as z01_nacion,z05_munic as z01_munic,
    ...
    $sql = $clcgmalt->sql_query_file($seqalt, $sCamposAlt);
    $result = $clcgmalt->sql_record($sql);
} else {
                    ...
                    <fieldset>
                        <table border="0">
                            ...
                            db_fieldsmemory(db_query("select munic, uf from db_config where codigo = " . db_getsession("DB_instit")),
                                0);
                            if (isset($z01_numcgm)) {
                                $result = $cldb_cgmruas->sql_record($cldb_cgmruas->sql_query($z01_numcgm, "*", "",
                        ...
                        <tr align="center" valign="middle">
                            <td height="30" colspan="2" nowrap>
                                ...
                                $rsVerificaAlt = $clcgmalt->sql_record($clcgmalt->sql_query_file(null, "*", null,
                                    "z05_numcgm = $numcgm and z05_tipo_alt = 'A'"));
