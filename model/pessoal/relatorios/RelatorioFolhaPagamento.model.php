    ...
    protected function retornaSQLBaseRelatorio($sWhere = null, $sOrderBy = null, $sCampos = '*')
    {
       ...
       */
        foreach ($this->aTipoFolha as $iIndiceTipoFolha => $oTipoFolha) {
           ...
           */
            $sSqlBase1 = $oDaoRHPessoal->sql_query_baseRelatorios(
                $oTipoFolha->sTabela,
                $oTipoFolha->sSigla,
                $this->iAno,
                $this->iMes,
           ...
           */
            ...
            // Invertido funcao por cargo pela lógica no banco de dados estar errada
            $sSqlBase  .= "        rh37_funcao  as codigo_cargo,                                                    \n";
            $sSqlBase  .= "        rh37_descr   as descr_cargo,                                                     \n";
            $sSqlBase  .= "        rh55_codigo  as codigo_localtrab,                                                \n";
            $sSqlBase  .= "        rh55_estrut  as estrutural_localtrab,                                            \n";
            $sSqlBase  .= "        rh55_descr   as descr_localtrab,                                                 \n";
            $sSqlBase  .= "        r70_codigo   as codigo_lotacao,                                                  \n";
            $sSqlBase  .= "        r70_estrut   as estrutural_lotacao,                                              \n";
            $sSqlBase  .= "        r70_descr    as descr_lotacao,                                                   \n";
            // Invertido cargo por funcao pela lógica no banco de dados estar errada
            ...
            $sSqlBase  .= "                  and ( r45_dtreto is null                                               \n";
            $sSqlBase  .= "                        or r45_dtreto > '".$this->iAno."-".$this->iMes."-01')            \n";
            $sSqlBase  .= "                 )                                                                       \n";
        ...
        if ($this->sTipoFiltro == "SELECIONADOS") {
            ...
            switch ($this->iAgrupador) {
                default:
                    ...
                    break;
                case 1: //lotacao
                    $sRetorno = " r70_estrut  between '{$this->oFiltroAgrupador->sFiltroInicio}' 
                                                  and '{$this->oFiltroAgrupador->sFiltroFim}' ";
                    break;
                case 2://orgao
                    $sRetorno = " o40_orgao   between  {$this->oFiltroAgrupador->sFiltroInicio}  
                                                  and  {$this->oFiltroAgrupador->sFiltroFim}  ";
                    break;
                case 3://matricula
                    $sRetorno = " rh01_regist between  {$this->oFiltroAgrupador->sFiltroInicio}  
                                                  and  {$this->oFiltroAgrupador->sFiltroFim}  ";
                    break;
                case 4://locais de trabalho
                    $sRetorno = " rh55_estrut between '{$this->oFiltroAgrupador->sFiltroInicio}' 
                                                  and '{$this->oFiltroAgrupador->sFiltroFim}' ";
                    break;
            }
        }
