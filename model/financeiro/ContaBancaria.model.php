...
class ContaBancaria {
  ...
  /**
   * Diz se a conta bancária é uma conta unica, utilizada por mais de uma instituição
   * @var boolean
   */
  protected $lContaUnica    = false;
  ...
  public function salvar(){
    ...
    if (db_utils::inTransaction()) {
      ...
      if(($oDaoBancoAgencia->erro_status != "0" && $this->getSequencialBancoAgencia() == null) || $this->getSequencialBancoAgencia() != null){
        ...
        $oDaoContaBancaria->db83_contaunica      = $this->isContaUnica()?"true":"false";
  ...
  /**
   * Define se a conta cadastrada como conta unica
   */
  public function setContaUnica($lContaUnica) {
      
      $this->lContaUnica = $lContaUnica;
      return $this;
  }
  
  public function isContaUnica() {
      return $this->lContaUnica;
  }
