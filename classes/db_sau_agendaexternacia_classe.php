...
class cl_sau_agendaexternacia { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->s123_i_agendaveiculocgs = ($this->s123_i_agendaveiculocgs == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculocgs"]:$this->s123_i_agendaveiculocgs);
   ...
   function incluir ($s123_i_codigo){ 
      $this->atualizacampos();
     if($this->s123_i_agendaveiculocgs == null ){ 
     ...
     $sql = "insert into sau_agendaexternacia(
                                       s123_i_codigo 
                                      ,s123_i_agendaveiculocgs 
                                      ,s123_v_acompanhante 
                                      ,s123_v_tipodoc 
                                      ,s123_v_documento 
                       )
   ...
   function sql_query ( $s123_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from sau_agendaexternacia ";
     $sql .= "      inner join sau_agendaveiculocgs  on  sau_agendaveiculocgs.s122_i_codigo = sau_agendaexternacia.s123_i_agendaveiculocgs";
     $sql .= "      inner join sau_agendaexterna  on  sau_agendaexterna.s118_i_codigo = sau_agendaveiculocgs.s122_i_agendaexterna";
     $sql .= "      inner join sau_agendaveiculo  on  sau_agendaveiculo.s121_i_codigo = sau_agendaveiculocgs.s122_i_agendaveiculo";
     $sql2 = "";
     if($dbwhere==""){
       if($s123_i_codigo!=null ){
         $sql2 .= " where sau_agendaexternacia.s123_i_codigo = $s123_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
