...
//      }
        ...
        $this->calculaLinhaAdministrativa($oDataInicialAnterior, $oDataFinalAnterior);
    ...
    /**
     * Calcula os dados de superavit e deficit
     *
     * @param $oDataInicialAnterior
     * @param $oDataFinalAnterior
     */
    private function calculaLinhaAdministrativa($oDataInicialAnterior, $oDataFinalAnterior)
    {
    ...
    private function processarQuadros()
    {
        ...
        if ($this->exibirQuadroRelatorio(self::QUADRO_RECEITAS)) {
            ...
            for (
                $iIndice = self::QUADRO_RECEITAS_DERIVADAS_INICIAL; $iIndice <= self::QUADRO_RECEITAS_DERIVADAS_FINAL;
                $iIndice++
            ) {
        ...
        if ($this->exibirQuadroRelatorio(self::QUADRO_TRANSFERENCIAS)) {
            ...
            for (
                $iIndice = self::QUADRO_TRANSFERENCIAS_INICIAL; $iIndice <= self::QUADRO_TRANSFERENCIAS_FINAL;
                $iIndice++
            ) {
        ...
        if ($this->exibirQuadroRelatorio(self::QUADRO_DESEMBOLSOS)) {
            ...
            for (
                $iIndice = self::QUADRO_DESEMBOLSOS_PESSOAL_INICIAL; $iIndice <= self::QUADRO_DESEMBOLSOS_PESSOAL_FINAL;
                $iIndice++
            ) {
