...
<body bgcolor=#CCCCCC bgcolor="#cccccc">
    ...
    <form class="container" name="form1" method="post" action="">
        <fieldset>
            <legend>Débitos Suspensos</legend>
...
<script>
    ...
    function js_emite() {
        ...
        jan = window.open('arr2_debitosuspenso002.php' + qry, '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0 ');
        jan.moveTo(0, 0);
    }
