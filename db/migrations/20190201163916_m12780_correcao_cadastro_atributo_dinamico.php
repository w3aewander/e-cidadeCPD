...
class M12780CorrecaoCadastroAtributoDinamico extends PostgresMigration
{
    public function up()
    {
        $sql = "
            ...
            VALUES (nextval('db_cadattdinamicoatributos_db109_sequencial_seq'), (SELECT db17_cadattdinamico FROM db_sysarquivo JOIN db_cadattdinamicosysarquivo ON db17_sysarquivo = codarq WHERE codarq = 1260 LIMIT 1),
