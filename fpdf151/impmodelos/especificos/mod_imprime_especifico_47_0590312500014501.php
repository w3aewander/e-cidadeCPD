...
$this->objpdf->cell(50,3,'DAM Emitido em: '.db_formatar($this->dataemissao,'d'),0,1,"L",0);
...
$this->objpdf->setx(30);
$this->objpdf->SetFont('Arial','B',10);
$this->objpdf->Cell(100,3,'DAM N'.chr(176).' SMF/'.db_formatar($this->itbi,'s','0',5).'/'.$this->ano,0,0,"L",0);
...
if ($this->tipoitbi == "urbano") {
    ...
    $this->objpdf->sety(38);
    $this->objpdf->setx(55);
    $this->objpdf->Cell(100,3,"DOCUMENTO DE ARRECADAÇÃO MUNICIPAL",0,1,"C",0);
} else {
  $this->objpdf->SetFont('Arial','B',11);
  $this->objpdf->sety(31);
  $this->objpdf->setx(80);
...
if ($this->processo != null) {
    ...
    $this->objpdf->cell(15,$altura,'Processo:',0,0,"L",0);
    $this->objpdf->SetFont('Arial','',8);
    $this->objpdf->cell(25,$altura,$this->processo,0,0,"L",0);
}

if ($this->titularProcesso != null) {
    $this->objpdf->SetFont('Arial','B',8);
    $this->objpdf->cell(30,$altura,'Titular do Processo:',0,0,"L",0);
    $this->objpdf->SetFont('Arial','',8);
    $this->objpdf->cell(72,$altura,$this->titularProcesso,0,0,"L",0);
}
...
if ($this->dataProcesso != null) {
    ...
    $this->objpdf->SetFont('Arial','',8);
    $this->objpdf->cell(25,$altura,$data,0,0,"L",0);
}
...
$this->objpdf->cell(20,$altura,'',1,0,"C",$iPreencheFundo);
$this->objpdf->cell(78,$altura,'Identificação do Adquirente',1,1,"C",$iPreencheFundo);
...
$this->objpdf->cell(20,$altura,'Nome : ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(78,$altura,$this->nomecompprinc.$this->outroscompradores,1,1,"L",0);   //nome do comprador
$this->objpdf->SetFont('Arial','B',8);
...
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(50,$altura,'Fone: '.$this->fonecomprador,1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(20,$altura,'CNPJ/CPF:',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
...
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(43,$altura,'Fone: '.$this->fonecomprador,1,1,"L",0);


$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(20,$altura,'Endereço : ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(80,$altura,substr($this->z01_ender,0,46) ,1,0,"L",0);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(20,$altura,'Endereço : ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(78,$altura,substr($this->enderecocomprador.','.$this->numerocomprador.$this->complcomprador,0,50),1,1,"L",0);
$this->objpdf->SetFont('Arial','B',8);
...
$this->objpdf->cell(20,$altura,'Município : ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(78,$altura,$this->municipiocomprador.'('.$this->ufcomprador.') - CEP: '.$this->cepcomprador  ,1,1,"L",0);
$this->objpdf->sety(61.5);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(20,$altura,'Bairro: ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(80,$altura,$this->z01_bairro,1,0,"L",0);
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(20,$altura,'Bairro: ',1,0,"L",0);
$this->objpdf->SetFont('Arial','',8);
$this->objpdf->cell(78,$altura,$this->bairrocomprador,1,1,"L",0);

$this->objpdf->setfillcolor(0);
$this->objpdf->SetFont('Arial','',4);
$this->objpdf->TextWithDirection(9.5,133,"Incluído por: ".substr($this->usuarioNomeIncluido,0,34),'U');
if (isset($this->usuarioNomeLiberado) && $this->usuarioNomeLiberado != ""){
 $this->objpdf->TextWithDirection(9.5,93,"Liberado por: ".$this->usuarioNomeLiberado . ' Matricula: ' . $this->usuarioCodigoLiberado,'U');
}
...
$this->objpdf->setfillcolor(235);
  ...
  $this->objpdf->ln();
  if ($this->tipoitbi != "urbano"){
    $this->objpdf->cell(120,$altura,'Dados das Construções',1,1,"C",$iPreencheFundo);
   }
...
if($this->tipoitbi != "urbano") {
    ...
    $this->objpdf->cell(21,$altura,'Ano',1,1,"C",$iPreencheFundo);
    ...
    for ($ii = 1;$ii <= 4 ; $ii++){
      ...
      $this->objpdf->cell(20,$altura,'',1,0,"C");
      $this->objpdf->cell(21, $altura,'',1,1,"C");
    }
    $yy = $this->objpdf->gety();
    $this->objpdf->SetXY(10,$y);
  ...
  $this->objpdf->setXY(10,125);
  $this->objpdf->SetFont('Arial','B',8);
  $this->objpdf->cell(24,$altura,''	  		 ,1,0,"L",$iPreencheFundo);
  $this->objpdf->cell(35,$altura,'Real'		 ,1,0,"C",$iPreencheFundo);
  $this->objpdf->cell(24,$altura,'Transmitida',1,0,"C",$iPreencheFundo);
  $this->objpdf->cell(37,$altura,'Fração Ideal',1,1,"C",$iPreencheFundo);
  
  $this->objpdf->cell(24,$altura,'Terreno: '	   ,1,0,"L",$iPreencheFundo);
  $this->objpdf->SetFont('Arial','' ,8);
  $this->objpdf->cell(35,$altura,db_formatar($this->areaterreno+0,'f',' ',' ',' ',6).($this->tipoitbi=="urbano"?'m2':'ha')		       ,1,0,"R",0);
  $this->objpdf->cell(24,$altura,(count($this->areaterrenomat)==1?db_formatar($this->areatran,'f',' ',' ',' ',6).($this->tipoitbi=="urbano"?'m2':'ha'):(strlen($this->areaterrenomat[1])>2?$this->areatran:db_formatar($this->areatran,'f',' ',' ',' ',6).($this->tipoitbi=="urbano"?'m2':'ha'))),1,0,"R",0);
  $this->objpdf->cell(37,$altura,""  							  ,1,1,"R");
  
  
  $this->objpdf->SetFont('Arial','B',8);
  $this->objpdf->cell(24,$altura,'Construções:',1,0,"L",$iPreencheFundo);
  $this->objpdf->SetFont('Arial','' ,8);
  $this->objpdf->cell(35,$altura,(@$this->areatotal == 0?'':(count(@$this->areaedificadamat)==1?db_formatar(@$this->areatotal,'f',' ',' ',' ',6).'m2':(strlen(@$this->areaedificadamat[1])>2?db_formatar(@$this->areatotal,'f',' ',' ',' ',6).'m2':db_formatar(@$this->areatotal,'f',' ',' ',' ',6).'m2'))),1,0,"R",0);
  $this->objpdf->cell(24,$altura,(@$this->areatotal == 0?'':(count(@$this->areaedificadamat)==1?db_formatar(@$this->areatrans,'f',' ',' ',' ',6).'m2':(strlen(@$this->areaedificadamat[1])>2?db_formatar(@$this->areatrans,'f',' ',' ',' ',6).'m2':db_formatar(@$this->areatrans,'f',' ',' ',' ',6).'m2'))),1,0,"R",0);
  $this->objpdf->cell(37,$altura,""  							  ,1,0,"R");

}


$yy = $this->objpdf->gety();
// $this->objpdf->SetXY(115,$y);
$this->objpdf->setY(70);
...
$this->objpdf->SetFont('Arial','B',8);
$this->objpdf->cell(198,$altura,'Observações',1,1,"L",$iPreencheFundo);
$this->objpdf->SetFont('Arial','',8);
$y = $this->objpdf->gety();
if ($this->tipoitbi != "urbano") {
  $this->objpdf->Rect(10, 141, 0, 10);
  $this->objpdf->Rect(207.7, 141, 0, 10);
} else {
  $this->objpdf->Rect(10, 72, 0, 24);
  $this->objpdf->Rect(207.7, 72, 0, 24);
}
// $this->objpdf->cell(197,$altura,'',"LBR",0,"l",0);
// $this->objpdf->cell(27, $altura,''," LR",0,"L",0);
// $this->objpdf->cell(197,$altura,'',"LBR",0,"l",0);
// $this->objpdf->cell(27, $altura,''," LR",0,"L",0);
// $this->objpdf->cell(197,$altura,'',"LBR",0,"l",0);
// $this->objpdf->cell(27, $altura,''," LR",0,"L",0);
...
$this->objpdf->cell(25,$altura,"Tipo/Valor"			  ,1,0,"C",$iPreencheFundo);
$this->objpdf->cell(25,$altura,"Declarado"		,1,0,"C",$iPreencheFundo);
$this->objpdf->cell(25,$altura,"Avaliado"		,1,0,"C",$iPreencheFundo);
...
$this->objpdf->cell(25,$altura,db_formatar($this->it01_valorterreno,'f')   ,1,0,"R",0);
$this->objpdf->cell(25,$altura,db_formatar($this->it14_valoravalter,'f')   ,1,1,"R",0);
$this->objpdf->SetFont('Arial','B',6);
...
$this->objpdf->SetFont('Arial','',6);
$this->objpdf->cell(25,$altura,db_formatar($this->it01_valorconstr,'f')	  ,1,0,"R",0);
$this->objpdf->cell(25,$altura,db_formatar($this->it14_valoravalconstr,'f'),1,1,"R",0);
$this->objpdf->SetFont('Arial','B',6);
$this->objpdf->cell(25,$altura,"Total"	  								  ,1,0,"L",1);
$this->objpdf->SetFont('Arial','',6);
$this->objpdf->cell(25,$altura,db_formatar($this->it01_valortransacao,'f') ,1,0,"R",0);
$this->objpdf->cell(25,$altura,db_formatar($this->it14_valoraval,'f')      ,1,1,"R",0);

$iPosicaoYCodBarra = $this->objpdf->getY();
$this->objpdf->SetFont('Arial','B',6);
$this->objpdf->setXY($iPosicaoXFormaPgto,$iPosicaoYFormaPgto);
$this->objpdf->cell(39,$altura,"Venal",1,0,"C",$iPreencheFundo);
$this->objpdf->cell(28,$altura,"Base de Cálculo"		  ,1,0,"C",$iPreencheFundo);
$this->objpdf->cell(28,$altura,"Aliquota"		  ,1,0,"C",$iPreencheFundo);
$this->objpdf->cell(28,$altura,"Imposto"			  ,1,0,"C",$iPreencheFundo);
...
if( count($this->aDadosFormasPgto) > 0 ){
  foreach ( $this->aDadosFormasPgto as $iInd => $aDadosFormas ){
    if ( $iInd <= 2 ) {
      ...
      $this->objpdf->SetFont('Arial','',6);
      $this->objpdf->cell(28,$altura,db_formatar($aDadosFormas['Valor'],'f')   ,1,0,"R",0);
      $this->objpdf->cell(28,$altura,$aDadosFormas['Aliquota']."%"		      ,1,0,"R",0);
      $this->objpdf->cell(28,$altura,db_formatar($aDadosFormas['Imposto'],'f') ,1,0,"R",0);
      $this->objpdf->cell(27, $altura,''," LR",1,"L",0);
...
$this->objpdf->SetFont('Arial','',6);
$this->objpdf->cell(28,$altura,db_formatar($nTotalAvaliado,'f')     ,1,0,"R",0);
$this->objpdf->cell(28,$altura,""                       ,1,0,"R",0);
$this->objpdf->cell(28,$altura,db_formatar($nTotalImposto,'f')        ,1,0,"R",0);
...
if (isset($this->dataLiberado) && $this->dataLiberado != ""){
  ...
  $this->objpdf->SetFont('Arial','B',6);
  $this->objpdf->cell(25,$altura,"Data de Transação:",1,0,"L",$iPreencheFundo);

  $this->objpdf->SetFont('Arial','',6);
  $this->objpdf->cell(25,$altura, $this->dataLiberado,1,0,"R",0);
}

if (!empty($this->aTaxas)) {
    $this->objpdf->SetFont('Arial','B',6);
    $this->objpdf->cell(23,$altura,"",0,0,"C");
    $this->objpdf->cell(39,$altura,"Taxa",1,0,"C",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,"Calcula Sobre",1,0,"C",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,"Aliquota",1,0,"C",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,"Valor",1,1,"C",$iPreencheFundo);

    $valorTotalTaxas = 0;
    $this->objpdf->SetFont('Arial','',6);
    foreach ($this->aTaxas as $oTaxas) {
        $this->objpdf->cell(25,$altura, "",0,0,"C");
        $this->objpdf->cell(23,$altura, "",0,0,"C");
        $this->objpdf->cell(23,$altura, "",0,0,"C");
        $this->objpdf->cell(39,$altura, $oTaxas->descricao,1,0,"L");
        $this->objpdf->cell(20,$altura,$oTaxas->calculaSobre,1,0,"C");
        $this->objpdf->cell(20,$altura,($oTaxas->aliquota != "" ? $oTaxas->aliquota."%" : ""),1,0,"R");
        $this->objpdf->cell(20,$altura,db_formatar($oTaxas->valor, "f"),1,1,"C");
        
        $valorTotalTaxas += $oTaxas->valor;
    }
    $this->objpdf->SetFont('Arial','B',6);
    $this->objpdf->cell(25,$altura, "",0,0,"C");
    $this->objpdf->cell(23,$altura, "",0,0,"C");
    ...
    $this->objpdf->cell(39,$altura, "Total",1,0,"L",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,"",1,0,"C",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,"",1,0,"R",$iPreencheFundo);
    $this->objpdf->cell(20,$altura,db_formatar($valorTotalTaxas, "f"),1,1,"C",$iPreencheFundo);
    $this->objpdf->SetFont('Arial','',6);
}

$yy = $this->objpdf->gety();
$this->objpdf->sety($y);
$this->objpdf->multicell(197,$altura,substr(str_replace("\n","",$this->propri.$this->proprietarios.(strlen(trim($this->propri.$this->proprietarios)) > 0?"\n ":"").
                                            (strlen(trim($this->it01_obs)) > 0?$this->it01_obs:"").". ".$this->sMsgSituacaoImovel),0,1128)."...",0,"L",0);
...
if ($this->it14_valorpaga == 0) {
  ...
  //$sDescricaoPagar = 'Valor a Pagar : I S E N T O';
  $sDescricaoPagar = "Valor a Pagar : $this->sFormaPagamento";
  $this->objpdf->cell(60,$altura,$sDescricaoPagar,0,1,"C",0);
} else {
