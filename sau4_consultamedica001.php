...
$clsautriagemavulsa = new cl_sau_triagemavulsa();
       ...
       if ($clprontuarios->numrows > 0) {
        ...
        if ($oProntuario->sd59_i_prontuario != "") {
          ...
          if( $clprontuarios->numrows > 0  ){
            ...
            //pluginesf - operation 11 - inicio comentario
            ...
            //pluginesf - operation 11 - fim comentario e inicio de sobrescricaoo do plugin
...
$sCampos  = " z01_nome, sd03_i_codigo, sd04_v_registroconselho, z01_numcgm";
...
if ($oDaoCgm->numrows > 0) {
  ...
  $sd04_v_registroconselho = $oProfissional->sd04_v_registroconselho;
...
function jsAlterar(oProcedimento) {
  ...
  if ($('sd29_t_tratamento')) {
    $('sd29_t_tratamento').value = oProcedimento.sTratamento.urlDecode();
  }

  if ($('sd29_t_achado')) {
    $('sd29_t_achado').value = oProcedimento.sAchado.urlDecode();
  }
