...
class cl_series { 
   ...
   function incluir ($ed03_i_codigo){ 
     ...
     if($ed03_i_codigo == "" || $ed03_i_codigo == null ){
       $result = @db_query("select nextval('series_ed03_i_codigo_seq')"); 
       if($result==false){
       ...
       $result = @db_query("select last_value from series_ed03_i_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acountkey values($acount,1005005,'$this->ed03_i_codigo','I')");
       $resac = db_query("insert into db_acount values($acount,1005003,1005005,'','".AddSlashes(pg_result($resaco,0,'ed03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005003,1005006,'','".AddSlashes(pg_result($resaco,0,'ed03_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1005003,1005007,'','".AddSlashes(pg_result($resaco,0,'ed03_c_abrevia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ed03_i_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1005005,'$this->ed03_i_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed03_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1005003,1005005,'".AddSlashes(pg_result($resaco,$conresaco,'ed03_i_codigo'))."','$this->ed03_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed03_c_nome"]))
           $resac = db_query("insert into db_acount values($acount,1005003,1005006,'".AddSlashes(pg_result($resaco,$conresaco,'ed03_c_nome'))."','$this->ed03_c_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed03_c_abrevia"]))
           $resac = db_query("insert into db_acount values($acount,1005003,1005007,'".AddSlashes(pg_result($resaco,$conresaco,'ed03_c_abrevia'))."','$this->ed03_c_abrevia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed03_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountkey values($acount,1005005,'$ed03_i_codigo','E')");
         $resac = db_query("insert into db_acount values($acount,1005003,1005005,'','".AddSlashes(pg_result($resaco,$iresaco,'ed03_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005003,1005006,'','".AddSlashes(pg_result($resaco,$iresaco,'ed03_c_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1005003,1005007,'','".AddSlashes(pg_result($resaco,$iresaco,'ed03_c_abrevia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
