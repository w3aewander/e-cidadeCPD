...
//	}  
    ...
    if(isNiteroi()){
      ...
      echo " Próximo sugerido: ";// echo $projativ;
      db_input('projativ',3,'',true,'text', 3,"");
    ...
    <td>      
      ...
      <option value="0">PERSONALIZADO</option>        
        <?php
          ...
          $sqlSigfisUnidade = $clSigfisUnidadeMedida->sql_query_file(null,"o220_sequencial, o220_abreviacao");
          ...
          for($i = 0; $i < pg_num_rows($rsSigfisUnidade); $i++){
            ...
            echo "<option value = '$unidadeMedidaObjeto->o220_sequencial'>$unidadeMedidaObjeto->o220_abreviacao</option>";
          }
        ?>
      </select>    
      <?php 
      }
        db_input('o55_descrunidade',25,3,true,'text',$db_opcao,"","","","",1000); 
        db_input('o221_sequencial' ,10,"",true,'hidden',3);
      ?>
    </td>
  </tr>
  <?php if(!isNiteroi()) {?>
...
function js_controleUnidadeMedida(){
  if(document.form1.unidadeMedida.value != '0'){
    let unidadeMedidaElement = document.form1.unidadeMedida;
    document.form1.o55_descrunidade.value =  unidadeMedidaElement[unidadeMedidaElement.selectedIndex].text;
    document.form1.o55_descrunidade.style.display = 'none';
  } else {
    document.form1.o55_descrunidade.value = '';
    document.form1.o55_descrunidade.style.display = 'initial';
  }
}

js_inicializaUnidadeMedida();
function js_inicializaUnidadeMedida(){

  let unidadeMedida = "<?php echo !empty($unidadeMedida) ? $unidadeMedida : 0; ?>";
  if(unidadeMedida != 0){
    document.form1.o55_descrunidade.style.display = 'none';
    document.form1.unidadeMedida.value = unidadeMedida;
  }  
}
</script>
<?php
