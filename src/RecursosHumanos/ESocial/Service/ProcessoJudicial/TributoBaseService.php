...
class TributoBaseService
{
    /**
     * @var
     */
    private $tributoBaseRepository;
    ...
    */
    ...
    {
        $this->tributoBaseRepository = new TributoBaseRepository();
    }
     ...
     * @throws Exception
     */
    public function salvar(TributoBase $tributoBase)
    {
        return $this->tributoBaseRepository->save($tributoBase);
    }
     ...
     * @throws Exception
     */
    public function excluir(TributoBase $tributoBase)
    {
        return $this->tributoBaseRepository->delete($tributoBase);
    }
}
