    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_o15_codigo) && (trim($chave_o15_codigo)!="") ){
          ...
          //$sql = $clorctiporec->sql_query("",$campos,"o15_codigo"," 1 = 1 AND o15_codigo between 1500 AND 1899 " . $dbwhere);
          $sql = $clorctiporec->sql_query("",$campos,"o15_codigo"," 1 = 1 AND o15_recurso <> '' AND o15_recurso::integer BETWEEN 1500 AND 1899 " . $dbwhere);
