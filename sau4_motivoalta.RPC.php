...
use App\Domain\Saude\Ambulatorial\Services\ProntuarioProblemasPacienteService;
...
try {
    ...
    case 'finalizaAtendimento':
      ...
      if( (!isset( $oParam->iMotivoAlta ) || empty( $oParam->iMotivoAlta )) && $oParam->iMotivoAlta !== '0') {
      ...
      ProntuarioProblemasPacienteService::vincular($oParam->iProntuario);
      ...
      if ( !empty($oUltimaMovimentacao) ) {
        ...
        $oNovaMovimentacao->setProfissionalAtendimento($ultimaMovimentacao->sd102_profissionalatendimento);
        $oNovaMovimentacao->setProfissionalEncaminhado($ultimaMovimentacao->sd102_profissionalencaminhado);
