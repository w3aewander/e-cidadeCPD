...
try {
  ...
  if (isset($_FILES[$sInputFile])) {
    ...
    $sNomeArquivo       = \DBString::removerCaracteresEspeciais(\DBString::removerAcentuacao($_FILES[$sInputFile]["name"]));
    $sNomeArquivo = substr($sNomeArquivo, 0, -strlen($sExtensao)) . '.' . $sExtensao;
