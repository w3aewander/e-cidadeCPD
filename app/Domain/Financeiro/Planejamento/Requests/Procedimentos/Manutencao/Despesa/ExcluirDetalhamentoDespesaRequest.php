...
/**
 * Class ExcluirDetalhamentoDespesaRequest
 * @package App\Domain\Financeiro\Planejamento\Requests\Procedimentos\Manutencao\Despesa
 */
class ExcluirDetalhamentoDespesaRequest extends FormRequest
{
    /**
     * @return bool
     */
    ...
    {
        return [
            'pl20_codigo' => 'required|integer|filled'
        ];
    }
    ...
    {
        return [
            'pl20_codigo.required' => 'O campo "Código" deve ser informado.',
            'pl20_codigo.integer' => 'Código se informado deve ser um inteiro.',
            'pl20_codigo.filled' => 'O campo "Código" deve ser preenchido.',
        ];
    }
}
