...
require_once(modification("classes/db_cadescrito_classe.php"));
require_once(modification("classes/db_cadescritoresp_classe.php"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	    <?php include(modification("forms/db_frmcadescrito.php")); ?>
    </center>
	</td>
  </tr>
</table>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_cadescritoresp.location.href='iss1_cadescritoresp001.php?db_opcaoal=33&q84_cadescrito=".@$q86_numcgm."';
     ";
         if(isset($liberaaba)){
