            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($anoSessao >= 2018) {
                            $codigo = AnexoV2018::CODIGO_RELATORIO;
                        } else {
                            if ($anoSessao >= 2017) {
                                $codigo = AnexoV2017::CODIGO_RELATORIO;
                            } else {
                                $codigo = AnexoVDisponibilidadeCaixaRestosAPagar::CODIGO_RELATORIO;
                            }
                        }
...
<script type="text/javascript">
    ...
    const relatorio = <?php echo $codigo; ?>;
    ...
    AjaxRequest.create(
      ...
      function (retorno, erro) {
        ...
        if (retorno.lEmiteLista && !confirm( "Deseja emitir o relatório?" )) {
          ...
          sGetParam = "con2_rgf_disponibilidade_caixa_restos_pagar.php?instituicoes=" + oInstituicoes.join(',') +
