    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
	         ...
	         $sql = $clcadfiscais->sql_query($chave_id_usuario,$campos,"id_usuario",$where);
        }else if(isset($chave_id_usuario) && (trim($chave_id_usuario)!="") ){
	         $sql = $clcadfiscais->sql_query("",$campos,"id_usuario"," $where id_usuario like '$chave_id_usuario%' ");
        }else{
           $sql = $clcadfiscais->sql_query("",$campos,"id_usuario","$where");
        }

        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clcadfiscais->sql_record($clcadfiscais->sql_query($pesquisa_chave,"*","fis_cadfiscais.id_usuario","fis_cadfiscais.id_usuario=$pesquisa_chave and $where"));
