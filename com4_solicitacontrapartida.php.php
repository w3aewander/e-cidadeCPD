...
require(modification("classes/db_orctiporec_classe.php"));
require(modification("classes/db_orcdotacaocontr_classe.php"));
require(modification("classes/db_orcdotacao_classe.php"));
