...
<tr>
  ...
  <td colspan="3">
<?php 
db_input('r56_poscpf1', 4, $Ir56_poscpf, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição de leitura do funcionário\",\"f\",\"t\",event);'");
db_input('r56_poscpf2', 4, $Ir56_poscpf, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição de leitura do funcionário\",\"f\",\"t\",event);'");
?>
  </td>
</tr>
    </td>
...
?>
  ...
  <tr>
    ...
    <td colspan="3"> 
<?php
db_input('r56_posrubrica1', 4, 1, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição do código do relacionamento\",\"f\",\"t\",event);'");
db_input('r56_posrubrica2', 4, 1, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição de código do relacionamento\",\"f\",\"t\",event);'");
?>
    </td>
  </tr>  
  <tr>
