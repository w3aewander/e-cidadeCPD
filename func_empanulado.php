      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_empanulado.php")==true){
             include(modification("funcoes/db_func_empanulado.php"));
           }else{
           $campos = "empanulado.*";
           }
        }
        ...
        if(isset($chave_e94_codanu) && (trim($chave_e94_codanu)!="") ){
	         ...
	         $sql = $clempanulado->sql_query("",$campos,"e94_numemp"," e94_numemp like '$chave_e94_numemp%' AND e60_instit = {$instituicao} ");
        }else{
           $sql = $clempanulado->sql_query("",$campos,"e94_codanu","e60_instit = {$instituicao}");
        }
