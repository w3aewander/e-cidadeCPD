...
if(isset($excluir)){
  db_inicio_transacao();
  $db_opcao = 3;
  $clparagrafo->pl09_codigo = $pl09_codigo;
  $clparagrafo->excluir($pl09_codigo);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 3;
   $result = db_query("select * from fiscalizacao.fis_paragrafo where pl09_status = true and pl09_codigo = ".$chavepesquisa);
