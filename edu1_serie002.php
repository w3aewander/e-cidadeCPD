...
?>
 <script>
   ...
   (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_a2.location.href = 'edu1_serieregimemat001.php?ed223_i_serie=<?=$ed11_i_codigo?>&ed11_c_descr=<?=$ed11_c_descr?>';
...
<?php
include(modification("forms/db_frmserie.php"));
?>
</body>
</html>
<script>
