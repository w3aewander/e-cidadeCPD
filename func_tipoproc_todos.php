    ...
    <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
            if (isset($campos) == false) {
                $campos = 'p51_codigo, p51_descr, p51_dtlimite, p51_instit, p51_identificado, p51_tipoprocgrupo, p91_descricao,p42_descricao as "dl_forma_Reclamação" ';
            }
            if (isset($chave_p51_codigo) && (trim($chave_p51_codigo) != "")) {
                ...
                if (isset($chave_p51_descr) && (trim($chave_p51_descr) != "")) {
                    $sql = $cltipoproc->sql_query("", $campos, "p51_descr",
                      " p51_descr like '$chave_p51_descr%' and $where");
                } else {
                    //$sql = $cltipoproc->sql_query("",$campos,"p51_descr");
            ...
            $result = $cltipoproc->sql_record($cltipoproc->sql_query(null, "*", "p51_codigo",
              "p51_codigo={$pesquisa_chave} AND $where"));
