...
class M17421CorrecaoCalculoTaxaLimpezaAlegrete extends PostgresMigration
{
    /**
     * Change Method.
     *
        ...
        $this->execute(<<<SQL
            ...
            if found then
                ...
                if iCarTaxa is not null then
                    ...
                    nLimpeza     := round((nLimpeza + (nj72_valor * nAreaTotConstr)), 2);
                    nLimpezaIsen := round((nLimpezaIsen + ((nj72_valor * nAreaTotConstr) - (nj72_valor * r_Carconstr.area_isencao))), 2);
                    end if;
                    ...
                    perform fc_debug(' <calcula_taxa_limpeza> nLimpezaIsen ..............: ' || nLimpezaIsen,   lRaise);
                    perform fc_debug(' <calcula_taxa_limpeza> nAreaTotConstr ............: ' || nAreaTotConstr, lRaise);
                ...
                perform fc_debug(' <calcula_taxa_limpeza> Entrou no if bPredial is false or (iMesesPredial <> 0 and iMesesPredial <> 12)', lRaise);
                ...
                perform fc_debug(' <calcula_taxa_limpeza> Valor da Caracteristica 124 .: ' || nj72_valor,   lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> Valor da Testada ............: ' || nTestada,     lRaise);

                nTaxaTemporaria := round((nj72_valor * nTestada), 2);

                nTaxaTeritorialIsen := round(((nTaxaTemporaria / 100) * (100 - iPercIsen)), 2);
                ...
                perform fc_debug(' <calcula_taxa_limpeza> nTaxaTeritorialIsen ....................: ' || nTaxaTeritorialIsen, lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> nLimpezaIsen antes calcular ............: ' || nLimpezaIsen,        lRaise);

                if iMesesPredial <> 0 then
                    nLimpeza     := round((nLimpeza + ((nTaxaTemporaria / 12) * (12 - iMesesPredial))), 2);
                    nLimpezaIsen := round((nLimpezaIsen + ((nTaxaTeritorialIsen / 12) * (12 - iMesesPredial))), 2);
                else
                ...
                perform fc_debug(' <calcula_taxa_limpeza> ',                                              lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> Substracao das taxas abaixo',                   lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> nLimpeza antes ...........: ' || nLimpeza,      lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> nLimpezaIsen antes .......: ' || nLimpezaIsen,  lRaise);
                perform fc_debug(' <calcula_taxa_limpeza> ',                                              lRaise);

                nLimpezaIsen := nLimpeza - nLimpezaIsen;

                iPercIsen := round(((100 * nLimpezaIsen) / nLimpeza), 2);
                ...
                perform fc_debug(' <calcula_taxa_limpeza> Calculo da taxa sem plugin',  lRaise);

                if bPredial is false then
                perform fc_debug(' <calcula_taxa_limpeza> Calculo da taxa para territorial',  lRaise);
                ...
                nLimpeza := round((nj72_valor * nTestada), 2);
                ...
                perform fc_debug(' <calcula_taxa_limpeza> Calculo da taxa para predial',  lRaise);
                ...
                loop
                    ...
                    perform fc_debug(' <calcula_taxa_limpeza> Construcao ........: ' || r_Carconstr.j39_idcons, lRaise);
                    perform fc_debug(' <calcula_taxa_limpeza> Caracteristica ...: ' || iCarTaxa,                lRaise);
