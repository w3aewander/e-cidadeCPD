      ...
      <fieldset style="border:0px;">
        ...
        <table>
         ...
         <tr>
            ...
            <td>
              <?php
              $where = "l03_instit = " . db_getsession("DB_instit") . " and l03_modalidadeativa is true";
                $result_tipo=$clcflicita->sql_record($clcflicita->sql_query_numeracao(null,"l03_codigo,l03_descr", null, $where));
