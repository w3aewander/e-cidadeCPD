...
for ($i = 0; $i < $iVias; $i++) {
  ...
  $this->objpdf->Roundedrect($xcol, $xlin + 1, $xcol + 98 + 100, 19, 2, 'DF', '1234');
  ...
  if (!empty($this->RnomeSocial)) {

    $this->objpdf->text($xcol + 2, $xlin + 9, 'Nome Social ');
    $this->objpdf->Setfont('Arial', '', 8);
    $this->objpdf->text($xcol + 24, $xlin + 9, ':  ' . $this->RnomeSocial);
  }
  ...
  $this->objpdf->Setfont('Arial', 'b', 8);
  $this->objpdf->text($xcol + 110, $xlin + 5, 'Hora ');
  $this->objpdf->Setfont('Arial', '', 8);
  $this->objpdf->text($xcol + 128, $xlin + 5, ':  ' . $this->Rhora);
  $this->objpdf->Setfont('Arial', 'b', 8);
  $this->objpdf->text($xcol + 140, $xlin + 5, 'Data ');
  $this->objpdf->Setfont('Arial', '', 8);
  $this->objpdf->text($xcol + 150, $xlin + 5, ':  ' . db_formatar($this->Rdata, "d"));
  $this->objpdf->Setfont('Arial', 'b', 8);
  $this->objpdf->text($xcol + 110, $xlin + 9, 'Profissional ');
  $this->objpdf->Setfont('Arial', '', 8);
  $this->objpdf->text($xcol + 128, $xlin + 9, ': ' . $this->Rmedico);
  $this->objpdf->Setfont('Arial', 'b', 8);
  $this->objpdf->text($xcol + 110, $xlin + 13, 'Atendente ');
  $this->objpdf->Setfont('Arial', '', 8);
  $this->objpdf->text($xcol + 128, $xlin + 13, ':  ' . $this->Rusuario . " " . $this->Rnomeusuario);
  ...
  $this->objpdf->Roundedrect($xcol, $xlin + 102, $xcol + 105, 19, 2, 'DF', '1234');
  $this->objpdf->Setfont('Arial', 'b', 8);
