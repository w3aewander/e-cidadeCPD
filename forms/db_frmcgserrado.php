  ...
  <center>
    <table border="0">
      <tr>
        ...
        <td>
            <?php
            $script = " onchange='js_pesquisas128_i_codigo(false);'";
            db_input('s128_i_codigo', 10, $Is128_i_codigo, true, 'text', 3, $script);
      ...
      <tr>
        ...
        <td>
            <?php
            $script = " onchange='js_pesquisas128_i_numcgs(false);'";
            db_input('s128_i_numcgs', 8, $Is128_i_numcgs, true, 'text', $db_opcao, $script);
            if ($db_opcao == 2) {
      ...
      <tr>
        <td align="center" colspan="2">
          <input name="db_opcao" type="submit"
                 id="db_opcao"
