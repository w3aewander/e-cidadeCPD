...
class M13822CriacaoDocumentos extends PostgresMigration
{
    public function up()
    {
        $this->plEncerramento();
    ...
    public function down() {
        ...
        $this->execute("drop function fc_valores_encerramento_empenho_rp(varchar, boolean);");
        $this->execute("drop type tp_valores_encerramento");
    }

    public function plEncerramento()
    {
$sql = <<<SQL
create type tp_valores_encerramento as ( empenho                  integer,
                                         anousu                   integer,
...
begin
    ...
    tSql := 'select empenho             as empenho,
		...
		for rValoresLancamento in execute tSql loop
