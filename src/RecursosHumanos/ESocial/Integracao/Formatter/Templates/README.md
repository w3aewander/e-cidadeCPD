...
Sempre a informação (index) da esquerda na estrutura do template, deve ser como esta no e-cidade. 
Por default, é a mesma informação enviada para API, mais pode ser alterada pelo parâmetro/index *'nome_api'*
...
## Criando um subgrupo de dados
No exemplo abaixo o subgrupo **'documentos'** nao existe no ecidade, mas o subgrupo **'CTPS'** sim.
...
[nascimento] => stdClass Object
    (
        ...
        [paisNascto] => 
        [paisNac] => 
        [nmMae] => GUIOMAR DE FREITAS PINTO
        [nmPai] => RAIMUNDO DE FREITAS PINTO
    )

[documentos] => stdClass Object
    (
        [CTPS] => stdClass Object
            (
                [nrCtps] => 40597
                [serieCtps] => 4
                [ufCtps] => AC
