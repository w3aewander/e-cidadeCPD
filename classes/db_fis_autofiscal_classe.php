...
class cl_fis_autofiscal {
   ...
   public $y51_codauto = 0;
   public $y51_codnoti = 0;
   ...
   public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_autofiscal");
   ...
   public function incluir ($y51_codauto){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_autofiscal(
                                       y51_codauto
                                      ,y51_codnoti
                       )
                values (
   ...
   public function alterar ($y51_codauto=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_autofiscal set ";
     $virgula = "";
   ...
   public function excluir ($y51_codauto=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_autofiscal
                    where ";
     $sql2 = "";
   ...
   public function sql_query ( $y51_codauto=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_autofiscal ";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_autofiscal.y51_codnoti";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_autofiscal.y51_codauto";
     ...
     if($dbwhere==""){
       if($y51_codauto!=null ){
         $sql2 .= " where fis_autofiscal.y51_codauto = $y51_codauto ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   public function sql_query_file ( $y51_codauto=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
