 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_contcearquivoresp.location.href='con1_contcearquivoresp001.php?db_opcaoal=33&c12_sequencial=".@$c11_sequencial."';
     ";
         if(isset($liberaaba)){
