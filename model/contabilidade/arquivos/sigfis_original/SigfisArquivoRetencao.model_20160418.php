<?phpSigfisArquivoRetencao.model.php
/*
...
//    $sSqlBuscaRetencoes .= "        e50_codord,                                                                ";
    ...
    $SigfisArquivoRetencao.model.phpsSqlBuscaRetencoes .= "        c61_codcon,                                                                ";
...
igfisArquivoRetencao.model.php
        ...
        $sContaCorrente = "select c56_sequencial as seq_conta_corrente from contabilidade.conplano left join conplanocontabancaria on conplano.c60_codcon = conplanocontabancaria.c56_codcon and conplano.c60_anousu   = conplanocontabancaria.c56_anousu left join configuracoes.contabancaria on db83_sequencial = c56_contabancaria where c60_anousu = $this->iAnoUso and c60_codcon = $oRetencao->conta ";
//        die( $sContaCorrente );
