...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipobaixaproc','func_fis_autotipobaixaproc.php?funcao_js=parent.js_preenchepesquisa|y87_baixaproc','Pesquisa',true);
}
