      ...
      <td align="center" valign="top">
        ...
        if( !isset( $pesquisa_chave ) ) {
          ...
          if( isset( $chave_rh70_sequencial ) && ( trim( $chave_rh70_sequencial ) != "" ) ) {
            ...
            $sWhere = " rhcbo.rh70_sequencial = {$chave_rh70_sequencial} and rh70_tipo in (4,5) {$sRhcbo} ";
            ...
            $sWhere = " upper(rh70_descr) like '" . strtoupper( $chave_rh70_descr ) . "%' and rh70_tipo in (4,5) {$sRhcbo} ";
          ...
          if( $pesquisa_chave != null && $pesquisa_chave != "" ) {
            ...
            $sWhere = "rh70_estrutural = '{$pesquisa_chave}' and rh70_tipo in (4,5) {$sRhcbo} ";
