                ...
                <table align="center" border='7' height="100%" width="100%">
                    ...
                    if(isset($retornoarq) && trim($retornoarq)!=""){
						  $dbwhere = "    e80_instit = " . db_getsession("DB_instit") . "
            						  ...
            						  and e76_processado is false
            						  and (  e60_instit = ".db_getsession("DB_instit")."
            						   or ( k17_instit = " . db_getsession("DB_instit") . "))";
                        if(isset($contapaga)){
...
//                        $dbwhere .= " and corempagemov.k12_codmov is null ";
                        ...
                        $sSqlEmpAgeCons = $clempage->sql_query_cons_novo(null,
...
//                        echo ($sSqlEmpAgeCons);
                        ...
                        if ($numrows_arq > 0) {
                            ...
                            for ($i = 0; $i < $numrows_arq; $i++) {
                                ...
                                $sSqlDadosOcorrencia  .= "       join empagedadosretmov on (e76_codmov, e76_codret) = (e02_empagedadosretmov, e02_empagedadosret) ";
						    ...
						    <td class='bordas02' align='center'><b>Ação do sistema</b></td>
                        ...
                        for($i = 0;$i<$numrows_arq;$i++){
                            ...
                            $sSqlDadosOcorrencia  .= "       e92_sequencia, ";
                            $sSqlDadosOcorrencia  .= "       e92_descrerro, ";
                            $sSqlDadosOcorrencia  .= "       k12_codmov, ";
                            $sSqlDadosOcorrencia  .= "       e76_codmov, ";
                            $sSqlDadosOcorrencia  .= "       e92_processa ";
                            $sSqlDadosOcorrencia  .= "  from empagedadosretmovocorrencia  " ;
                            $sSqlDadosOcorrencia  .= "       join empagedadosretmov  on (e76_codmov, e76_codret) = (e02_empagedadosretmov, e02_empagedadosret) ";
                            $sSqlDadosOcorrencia  .= "       left  join errobanco    on e92_sequencia = empagedadosretmovocorrencia.e02_errobanco ";
                            $sSqlDadosOcorrencia  .= "       left  join corempagemov on k12_codmov    = e76_codmov ";
                            $sSqlDadosOcorrencia  .= " where empagedadosretmovocorrencia.e02_empagedadosret    in ({$e76_codret})";
                            $sSqlDadosOcorrencia  .= "   and empagedadosretmovocorrencia.e02_empagedadosretmov in ({$e81_codmov})";
                            $sSqlDadosOcorrencia  .= "   and empagedadosretmov.e76_processado = false ";
                            //$sSqlDadosOcorrencia  .= "   and e92_processa is true";
                            ...
                            $processa = true;
                            $e92_descrerro = "";
                            $dadosOcorrencias = db_utils::getCollectionByRecord($rsDadoOcorrencia);
                            foreach ($dadosOcorrencias as $ocorrencia) {
                                $e92_descrerro .= $ocorrencia->e92_descrerro . "<br>";
                                if ($ocorrencia->e92_processa == "f") {
                                    $processa = false;
                                }
                            }
                            if (!$processa) {
                            ...
                            if ( $e92_processa == "t" ) {
                                $acao_sistema = "Será efetuado pagamento";
                                if ( ! empty($k12_codmov) ) {
                                    $acao_sistema = "Pagamento já foi efetuado, será atualizado na agenda.";
                                }
                            }else if ( $e92_processa == "f" ) {
                                $acao_sistema = "Este registro retornará para agenda.";
                                if ( !empty($k12_codmov) ) {
                                    $acao_sistema = "Este registro terá o pagamento estornado e retornará para agenda.";
                                }
                            }
                            ...
                            if($pagadora!=$e83_codtipo) {
                                ...
                                echo "<tr>
						      <td colspan='8' class='bordas' align='left'>
						      <b>$e83_descr</b>
						      </td>
						    ...
						    <td class='bordas$class'><small>".$acao_sistema."</small></td>
