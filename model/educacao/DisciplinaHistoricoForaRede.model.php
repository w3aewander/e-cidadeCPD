...
require_once(modification('model/educacao/DisciplinaHistorico.model.php'));
...
class DisciplinaHistoricoForaRede extends DisciplinaHistorico
{
    ...
    public function __construct($iCodigo = '')
    {
        ...
        if (!empty($iCodigo)) {
            $oDaoDisciplina = new cl_histmpsdiscfora();
            ...
            if ($oDaoDisciplina->numrows > 0) {
                ...
                $this->setBaseComum($oDadosDisciplina->ed100_tipobase == 1);
                $this->setTipoBase($oDadosDisciplina->ed100_tipobase);
   ...
   */
    public function salvar($iCodigoEtapa = null)
    {
        ...
        $oDaoDisciplina->ed100_tipobase = $this->getTipoBase();
   ...
   */
    public function remover()
    {
        ...
        if (!empty($this->iCodigo)) {
            $oDaoHistorico = new cl_histmpsdiscfora();
