...
if((isset($HTTP_POST_VARS["opcaoExec"]) && $HTTP_POST_VARS["opcaoExec"])=="Alterar"){
  ...
  if($y83_ativprinc == 't'){
   ...
   // db_msgbox("princ = $y83_ativprinc ... seq = $y83_seq");
    $sqlpri = "select * from fiscalizacao.fis_saniatividade where y83_codsani = $y83_codsani and y83_seq <> $y83_seq";
  ...
  db_fim_transacao($sqlerro);
	...
	if (!$sqlerro) {
		echo " <script>
          	parent.iframe_calculo.location.href='fis1_fis_sanicalc001.php?y80_codsani=".$y83_codsani."';
         	 </script>";
	}
	...
	<tr>
		...
		if((isset($HTTP_POST_VARS["opcaoExec"]) && $HTTP_POST_VARS["opcaoExec"])=="Alterar"){
		  if($clsaniatividade->erro_status=="0"&&$sqlerro==true){
		    ...
		    $clsaniatividade->erro(true,false);
		    echo "<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=".$y83_codsani."';</script>";
		  };
		};
		?>
