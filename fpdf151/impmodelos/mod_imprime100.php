...
if(!empty($this->valor_corrigido)){
    $sInstrucao .= " Valor corrigido = " . trim($this->valor_corrigido);
}else{
...
if(!empty($this->refantmatric)) {
    $this->objpdf->cell(115, 3, "Referência anterior: ".$this->refantmatric, 0, 1, "C", 0);
}
if(!empty($this->refantinscr)) {
    $this->objpdf->cell(97, 3, "Referência anterior: ".$this->refantinscr, 0, 1, "C", 0);
}
