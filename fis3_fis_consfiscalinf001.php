...
function js_consulta(){
  if (document.form1.y30_codnoti.value==""){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','fis3_fis_consfiscalinf002.php?codauto='+document.form1.y30_codnoti.value,'Consulta Notificação',true);
  }
}
</script>
...
function js_noti(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_noti','func_fis_fiscalalt.php?funcao_js=parent.js_mostranoti|y30_codnoti|z01_nome','Pesquisa',true);
  }else{
    if(noti!=""){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_noti','func_fis_fiscalalt.php?pesquisa_chave='+noti+'&funcao_js=parent.js_mostranoti1','Pesquisa',false);
    }else{
