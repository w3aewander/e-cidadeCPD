...
if (isset($chavepesquisa)) {
    echo "
        <script>
          ...
          (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_rhlotavinc.location.href = 'pes1_rhlotavinc001.php?chavepesquisa=$r70_codigo&db_opcaoal=true';
       ";
    if (isset($liberaaba) && $liberaaba == "true") {
        echo "
          (window.CurrentWindow || parent.CurrentWindow).corpo.mo_camada('rhlotavinc');
         ";
    }
    echo "
	</script>
    ...
    if (isset($alterar)) {
        ...
        echo "
          ...
          (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_rhlotavinc.location.href = 'pes1_rhlotavinc001.php';
         ";
    }
    echo "
        </script>
