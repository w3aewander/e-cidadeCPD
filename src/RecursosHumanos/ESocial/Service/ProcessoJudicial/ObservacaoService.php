...
class ObservacaoService
{
    ...
    */
    ...
    {
        $this->observacaoRepository = new ObservacaoRepository();
    }
     ...
     */
    public function salvar(Observacao $tributoBase)
    {
        return $this->observacaoRepository->save($tributoBase);
    }
     ...
     * @throws BusinessException
     */
    public function excluir(Observacao $observacao)
    {
        return $this->observacaoRepository->delete($observacao);
    }
}
