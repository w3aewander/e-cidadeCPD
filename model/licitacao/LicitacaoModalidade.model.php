...
class LicitacaoModalidade
{
    ...
    public function getSiglaTipoCompraTribunal()
    {
        if ($this->sSiglaTipoCompraTribunal === null) {
            ...
            $sSqlTipoCompra = $oDaoTipoCompra->sql_query_file(
                $this->getCodigoTipoCompraTribunal(),
                'l44_sigla'
            );
    ...
    /**
     * Diz se uma modalidade de licitação é PNAE ou não
     *
     * @return bool
     */
    public function isPNAE()
    {
        return $this->getSiglaTipoCompraTribunal() === 'CPP';
    }
    ...
    {
        return $this->getSiglaTipoCompraTribunal() === 'CHP';
    }
}
