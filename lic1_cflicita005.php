 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_pccflicitapar.location.href='lic1_pccflicitapar001.php?l25_codcflicita=".@$l03_codigo."';
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_template.location.href='lic1_cflicitatemplate001.php?l35_cflicita=".@$l03_codigo."';
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_templateata.location.href='lic1_cflicitatemplateata001.php?l37_cflicita=".@$l03_codigo."';
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_templateminuta.location.href='lic1_cflicitatemplateminuta001.php?l41_cflicita=".@$l03_codigo."';
