...
<body bgcolor="#cccccc" style='margin-top: 30px'>
  ...
  <div class='container'>
    <form id='formPadrao' action="">
      <fieldset>
        <legend>Declaração de Matrícula</legend> <!-- 2018-06-18 Wallace Troca do título Atestado de Frequência para Declaração de Matrícula -->
            ...
            <tr>
              ...
              <td nowrap="nowrap" >
                <select id='gradeAluno' style="width:100%;">
                  <option value="N">Não</option> <!-- 2018-06-18 Wallace Colocar "NÃO" como padrão -->
                  <option value="S">Sim</option>
                </select>
              </td>
            </tr>
            <tr>
              <td nowrap="nowrap" class='bold field-size3'>Modelo:</td>
              <td nowrap="nowrap">
                <select id="modelo" name="modelo" style="width:100%;">
...
$('imprimir').observe("click", function() {
  ...
  var sUrl  = "edu2_declaracaomatricula002.php";
      ...
      sUrl += "&iModelo="+tagString($F('modelo'));
