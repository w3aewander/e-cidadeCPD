...
/**
 * Fonte duplicado devido a impacto de melhoria
 ...
 */
class ImportacaoDiversosDiversos {
    ...
    function __construct( $iCodigoImportacao = null ) {
        ...
        if ( !empty($iCodigoImportacao) ) {
            ...
            if ( !DBNumber::isInteger($iCodigoImportacao) ) {
                throw new ParameterException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'codigo_importacao_deve_ser_inteiro' ) );
            }
    ...
    protected function salvarDiverImporta($iTipo) {
        ...
        if (empty($iTipo)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'tipo_nao_informado'));
        }
    ...
    protected function salvarDiversos($iNumpre, $iNumpar, $iReceita, $iProcedencia, $iCodDiverImporta) {
        ...
        if (empty($iNumpre)) {
            throw new BusinessException(_M(ImportacaoDiversosDiversos::MENSAGENS . 'numpre_nao_informado'));
        }

        if (empty($iNumpar)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'numpar_nao_informado'));
        }

        if (empty($iReceita)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'receita_nao_informada'));
        }

        if (empty($iProcedencia)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'procedencia_nao_informada'));
        }
        ...
        if ( !$rsDiverImporta ) {
            ...
            throw new DBException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_buscar_importacao', $oParms));
        }

        if ( pg_num_rows($rsDiverImporta) == 0 ) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'sem_dados_importacao'));
        }
    ...
    public function adicionarDebito($iNumpre, $iNumpar, $iReceita, $iProcedencia) {
        ...
        if (empty($iNumpre)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'informe_numpre'));
        }

        if (empty($iNumpar)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'informe_numpar'));
        }

        if (empty($iReceita)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'informe_receita'));
        }
    ...
    protected function adicionarDiverImportaOld($iCodDiverso, $iNumpre, $iNumpar, $iReceita) {
        ...
        if (empty($iCodDiverso)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'cod_diversao_nao_informado'));
        }

        if (empty($iNumpre)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'numpre_nao_informado_3'));
        }

        if (empty($iNumpar)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'numpar_nao_informado_3'));
        }

        if (empty($iReceita)) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'receita_nao_informada_3'));
        }
    ...
    public function importarDiversos($iProcedencia, $iNumpre, $iNumpar, $iReceita) {
        ...
        if (!db_utils::inTransaction()) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'sem_transacao_ativa'));
        }
    ...
    public function processar ( $sObservacao ) {
        ...
        $iCodDiverImporta = $this->salvarDiverImporta(ImportacaoDiversosDiversos::PROCESSAMENTO_INDIVIDUAL);

        if (!db_utils::inTransaction()) {
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'sem_transacao_ativa_2'));
        }
    ...
    public function cancelar () {
        ...
        if ($oDaoDiverImporta->erro_status == '0') {
            ...
            throw new DBException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'nenhum_registro_tabela_diverimporta', $oParms));
        }
        ...
        if ($oDaoDiverImportaOld->numrows == '0') {
            ...
            throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'nenhum_registro_tabela_diverimportaold', $oParms));
        }
        ...
        foreach ($aDiverImportaOld as $oDiverImportaOld) {
            ...
            foreach ($aArreold as $oArreold) {
                ...
                if ($oDaoArrecad->erro_status == '0') {
                    ...
                    throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_incluir_tabela_arrecad', $oParms));
                }
                ...
                if ($oDaoArrecad->erro_status == '0') {
                    ...
                    $oParms           = new stdClass();
                    $oParms->sErroMsg = $oDaoArrecad->erro_msg;
                    throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_excluir_tabela_arrecad', $oParms));
                }
                ...
                if ($oDaoArreold->erro_status == '0') {
                    ...
                    throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_excluir_tabela_arreold', $oParms));
                }
            }
            ...
            if ($oDaoDiverImportaReg->erro_status == '0') {
                ...
                throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_excluir_tabela_diverimportareg', $oParms));
            }
            ...
            if ($oDaoDiverImportaOld->erro_status == '0') {
                ...
                $oParms           = new stdClass();
                $oParms->sErroMsg = $oDaoDiverImportaOld->erro_msg;
                throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_excluir_tabela_diverimportaold', $oParms));
            }
            ...
            if ($oDaoDiversos->erro_status == '0') {
                ...
                throw new Exception (_M( ImportacaoDiversosDiversos::MENSAGENS . 'erro_excluir_tabela_diversos', $oParms));
            }
        }

        return $lProcessamentoParcial ? ImportacaoDiversosDiversos::CANCELAMENTO_PARCIAL : ImportacaoDiversosDiversos::CANCELAMENTO_COMPLETO;
    }
    ...
    public function setQuantidadeParcelas( $iQuantidade ) {
        ...
        if( !DBNumber::isInteger($iQuantidade) ){
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'quantidade_parcelas_dever_ser_inteiro'));
        }

        if( $iQuantidade <= 0 ){
            throw new BusinessException(_M( ImportacaoDiversosDiversos::MENSAGENS . 'quantidade_parcelas_inferior_0'));
        }
