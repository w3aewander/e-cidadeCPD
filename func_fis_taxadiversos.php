...
include(modification("classes/db_fis_taxadiversos_classe.php"));
db_postmemory($HTTP_POST_VARS);
parse_str($HTTP_SERVER_VARS["QUERY_STRING"]);
$cltaxadiversos = new cl_fis_taxadiversos;
    ...
    <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_taxadiversos.hide();">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_taxadiversos.php")==true){
             include(modification("funcoes/db_func_fis_taxadiversos.php"));
           }else{
           $campos = "fis_taxadiversos.*";
           }
        }
