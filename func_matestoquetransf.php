                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <input name="Fechar" type="button" id="fechar" value="Fechar"
                                   onClick="parent.db_iframe_matestoquetransf.hide();">
                        </td>
                    </tr>
                </form>
            </table>
            ...
            if (!isset($pesquisa_chave)) {
                if (isset($campos) == false) {
                    if (file_exists("funcoes/db_func_matestoquetransf.php") == true) {
                        include(modification("funcoes/db_func_matestoquetransf.php"));
                    } else {
                ...
                if (isset($chave_m83_matestoqueini) && (trim($chave_m83_matestoqueini) != "")) {
                    $sql = $clmatestoquetransf->sql_query_inill(null, $campos, "m83_matestoqueini desc", "m83_matestoqueini=$chave_m83_matestoqueini $where_parametro");
                } else {
                    $sql = $clmatestoquetransf->sql_query_inill("", $campos, "m83_matestoqueini desc", "1=1 $where_parametro");
                }
