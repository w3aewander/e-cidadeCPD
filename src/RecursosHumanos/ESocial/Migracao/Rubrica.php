...
class Rubrica extends Migracao implements MigracaoInterface
{
    ...
    public function buscarUltimoPreenchimento($codigoFormulario)
    {
        ...
        $campos .= ' (select array_accum(db106_resposta)  ';
        $campos .= '   from (select db106_resposta ';
        ...
        $campos .= '               GROUP BY db106_resposta, db103_identificadorcampo ';
        $campos .= '               ORDER BY db103_identificadorcampo desc ';
        $campos .= ' ) as respostas_ordenadas) as pk ';
