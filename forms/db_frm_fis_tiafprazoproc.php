...
function js_pesquisay97_codprazo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafprazo','func_fis_tiafprazo.php?funcao_js=parent.js_mostratiafprazo1|y96_codigo|y96_codigo','Pesquisa',true);
  }else{
     if(document.form1.y97_codprazo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafprazo','func_fis_tiafprazo.php?pesquisa_chave='+document.form1.y97_codprazo.value+'&funcao_js=parent.js_mostratiafprazo','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafprazoproc','func_fis_tiafprazoproc.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
...
function js_pesquisay90_codtiaf(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_tiaf','func_fis_tiaf.php?funcao_js=parent.js_mostratiaf1|y90_codtiaf','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_tiaf','func_fis_tiaf.php?pesquisa_chave='+document.form1.y90_codtiaf.value+'&funcao_js=parent.js_mostratiaf','Pesquisa',false);
  }
}
...
function js_mostratiaf1(chave){
  ...
  db_iframe_tiaf.hide();
  location.href="fis1_fis_tiafprazoproc001.php?y90_codtiaf="+chave;
/*  if (passa == "s"){
     location.href="fis1_fis_tiafaba002.php?y90_codtiaf="+chave;
  }else if (passa == "n"){
     location.href="fis1_fis_tiafaba003.php?y90_codtiaf="+chave;
  } else if (passa == "e"){
     location.href="fis1_fis_tiafaba004.php?y90_codtiaf="+chave;
  }*/
}
