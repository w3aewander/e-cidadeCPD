    ...
    public function processar()
    {
       ...
       */
        ...
        if ($this->getGeraAnexo01()) {
           ...
           */
            $sSqlWork1  = " drop table if exists work1; ";
            ...
            $rsDespesa = db_dotacaosaldo(7, 3, 3, true, "", $this->iAno, $this->dtDataInicial, $this->dtDataFinal, null, null, null, 2);
            $valor      = 0;
            ...
            for ($i = 0; $i < $numreg; $i++) {
                if (isset($descra[$i])) {
                  ...
                  */
                    $sDescricao = DBString::removerAcentuacao(mb_strtoupper(trim($descra[$i])));
                    $aDescricaoElementosAceitos = array("RECEITA TRIBUTARIA",
                                              "IMPOSTOS, TAXAS E CONTRIBUICOES DE MELHORIA");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitaTributaria = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("RECEITAS DE CONTRIBUICOES",
                                              "CONTRIBUICOES");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitadeContribuicoes = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("RECEITA PATRIMONIAL");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                    ...
                    $aDescricaoElementosAceitos = array("RECEITA DE SERVICOS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitadeServicos = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("TRANSFERENCIAS CORRENTES");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->transferenciasCorrentes = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("OUTRAS RECEITAS CORRENTES");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->outrasReceitasCorrentes = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("RECEITAS INTRA-ORÇAMENTARIAS CORRENTES",
                                              "RECEITAS CORRENTES INTRAORCAMENTARIAS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitasIntraorcamentarias = $sValorA;
                    }
          
                    $aDescricaoElementosAceitos = array("(R) DEDUCOES DA RECEITA CORRENTE");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                ...
                if (isset($descrb[$i])) {
                   ...
                   */
                    $sDescricao = DBString::removerAcentuacao(mb_strtoupper(trim($descrb[$i])));
                    $aDescricaoElementosAceitos = array("PESSOAL E ENCARGOS SOCIAIS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->despesaPessoalEncargosSociais = $sValorB;
                    }
          
                    $aDescricaoElementosAceitos = array("JUROS E ENCARGOS DA DIVIDA");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->despesaJurosEncargosDivida = $sValorB;
                    }
          
                    $aDescricaoElementosAceitos = array("OUTRAS DESPESAS CORRENTES");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
            ...
            for ($i = 0; $i < $numreg; $i++) {
                if (isset($descrd[$i])) {
                   ...
                   */
                    $sDescricao = DBString::removerAcentuacao(mb_strtoupper(trim($descrd[$i])));
                    $aDescricaoElementosAceitos = array("OPERACOES DE CREDITO");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitaOperacoesCredito = $sValorD;
                    }
          
                    $aDescricaoElementosAceitos = array("ALIENACAO DE BENS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->receitaAlienacaoBens = $sValorD;
                        $oDadosAnexoDados01->receitaAmortizacaoEmprestimos = 0.00;
                    }
          
                    $aDescricaoElementosAceitos = array("TRANSFERENCIAS DE CAPITAL");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->transferenciasCapital = $sValorD;
                    }
          
                    $aDescricaoElementosAceitos = array("OUTRAS RECEITAS DE CAPITAL");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                ...
                if (isset($descre[$i])) {
                   ...
                   */
                    $sDescricao = DBString::removerAcentuacao(mb_strtoupper(trim($descre[$i])));
                    $aDescricaoElementosAceitos = array("DESPESA DE INVESTIMENTOS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->despesaInvestimentos = $sValorE;
                    }
          
                    $aDescricaoElementosAceitos = array("INVERSOES FINANCEIRAS");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
                        $oDadosAnexoDados01->despesaInversoesFinanceiras = $sValorE;
                    }
          
                    $aDescricaoElementosAceitos = array("AMORTIZACAO DA DIVIDA");
                    if (in_array($sDescricao, $aDescricaoElementosAceitos)) {
        ...
        if ($this->getGeraAnexo02()) {
           ...
           */
            ...
            $sSqlDespesas = "select rpad(substr(o58_elemento, 2, 6)::TEXT, 8, '0') as o56_elemento, 
                              sum(empenhado-anulado) as totaldespesa 
                         from ( {$sSqlDotacaoSaldo} ) as dados 
                        group by rpad(substr(o58_elemento, 2, 6)::TEXT, 8, '0')
                        having sum(empenhado-anulado) > 0 
                        order by rpad(substr(o58_elemento, 2, 6)::TEXT, 8, '0')";
                   ...
                   */
                    ...
                    for ($iIndFuncao = 0; $iIndFuncao < $iLinhasFuncoes; $iIndFuncao++) {
                        ...
                        $sSqlSubFuncoes = "select distinct 
                                      (case when o53_subfuncao = 999 then 122 else o53_subfuncao end) as o53_subfuncao
                                 from orcsubfuncao
                ...
                for ($iIndSubFuncao = 0; $iIndSubFuncao < $iLinhasSubFuncoes; $iIndSubFuncao++) {
                   ...
                   */
                    ...
                    for ($iIndPrograma = 0; $iIndPrograma < $iLinhasProgramas; $iIndPrograma++) {
                        ...
                        $sWhereDotacaoRecurso1  = "{$sWhereDotacao} and o58_codigo    = 10010000 ";
                        ...
                        $sWhereDotacaoRecurso2  = "{$sWhereDotacao} and o58_codigo    <> 10010000 ";
        ...
        if ($this->getGeraAnexo10()) {
            ...
            $rsReceitas = db_receitasaldo(7, 1, 3, true, "", $this->iAno, $this->dtDataInicial, $this->dtDataFinal, false);
            db_query("rollback");
            ...
            for ($iInd = 0; $iInd < $iLinhasReceitas; $iInd++) {
                ...
                $oDadosReceitaA10->codigoReceita   = substr($oReceita->o57_fonte, 1, 10);
                $oDadosReceitaA10->valorOrcado     = number_format(abs($oReceita->saldo_inicial_prevadic), 2, '.', '');
        ...
        if ($this->getGeraQuadro01()) {
            ...
            foreach ($aDadosLRFDemonstrativoRP as $oDadosRP) {
                ...
                $oDadosUnidadeQ01->fonteRecurso  = str_pad($oDadosRP->FonteRecurso, 8, "0", STR_PAD_LEFT);
        ...
        if ($this->getGeraQuadro02()) {
            ...
            for ($iInd = 0; $iInd < $iLinhasRP; $iInd++) {
                ...
                $sNumeroEmpenho = $oDadosRP->e60_codemp."/".$oDadosRP->e60_anousu;
                ...
                $sub = $oDadosRP->o58_subfuncao;
                if ($oDadosRP->o58_subfuncao == 999) {
                    $sub = 122;
                }
                ...
                $sClassificacaoFuncional   = substr($sCaracteristicaPeculiar, 1, 2).
                                     ...
                                     str_pad($sub, 3, '0', STR_PAD_LEFT).
                                     str_pad($oDadosRP->o58_programa, 4, '0', STR_PAD_LEFT).
                                     str_pad($oDadosRP->o58_projativ, 4, '0', STR_PAD_LEFT).
                                     str_pad($oDadosRP->o58_codigo, 8, '0', STR_PAD_LEFT).
                     str_pad(substr($oDadosRP->o56_elemento, 1, 6), 8, '0', STR_PAD_RIGHT);
                ...
                $oDadosUnidadeQ02->fonteRecurso                       = str_pad($oDadosRP->o58_codigo, 8, '0', STR_PAD_LEFT);
                $oDadosUnidadeQ02->numeroEmpenho                      = $sNumeroEmpenho;
        ...
        $oRetornoValidacao = $this->validarXML($this->oDocumento, 'model/contabilidade/arquivos/siai/v2019/xsd/XSD_ContasAnuais_ecidade.txt');
