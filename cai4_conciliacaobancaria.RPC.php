  ...
  switch($oParam->exec) {
    ...
    case 'Processar':
      ...
      foreach ($oParam->aLinhasExtrato as $iLinhaExtrato) {
        ...
        pg_query("DELETE from conciliaextrato where k87_extratolinha = {$iLinhaExtrato}");
        pg_query("DELETE from conciliapendextrato where k88_extratolinha = {$iLinhaExtrato}");
        pg_query("DELETE FROM extratolinha WHERE k86_sequencial = {$iLinhaExtrato}");
