...
try {
  ...
  switch ($oParam->exec) {
    ...
    case "salvar":
      ...
      $sql = $clliclicita->sql_query_licitantes("*","l20_codigo = {$oParam->iCodigoLicitacao}",null);
      $rsLicitantes = $clliclicita->sql_record($sql);
      if (pg_num_rows($rsLicitantes) > 0) {
          throw new Exception("Para efetuar a reserva de cotas, por favor, realize a exclusão dos fornecedores.");
      }
