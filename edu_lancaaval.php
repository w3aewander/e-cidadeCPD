...
<html>
  ...
  <body style='margin-top: 25px' bgcolor="#cccccc">
    ...
    <div class="container">
        <form method="post" action="edu_lancaavalgrade.php">
            <fieldset>
    ...
    window.addEventListener('load', async () => {
        const montaSelect = async (options, elemento) => {
            ...
            options.forEach(linha => {
                if(linha.nome.includes("INFANTIL") || linha.nome.includes("Infantil") || (linha.nome.includes("FINAIS") && !linha.nome.includes("EJA"))){
                //if(linha.nome.includes("INFANTIL") || linha.nome.includes("Infantil")){
