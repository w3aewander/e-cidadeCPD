...
class M24845FCISSQN extends Migration
{
    /**
     * Run the migrations.
     *
...
iNumeroParcelas           integer; -- Variavel auxiliar para o numero de parcelas

arrecadAuxiliar           record; -- Variavel para juntar parcelas iguais
...
-- Realizamos a conferência dos dados para sabermos se a inscrição é optante pelo SIMPLES
--
-- Caso seja optante nãoo será calculado a taxa de alvará da empresa.
--
-- Deve possui cadastro na tabela meicgm...
-- OU
-- A empresa deve ser optante com:
