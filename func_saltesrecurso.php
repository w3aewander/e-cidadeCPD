        ...
        <td align="center" valign="top">
            ...
            if (!isset($pesquisa_chave)) {
                ...
                if (isset($chave_k13_conta) && (trim($chave_k13_conta) != "")) {
                    $sql = $clsaltes->sql_query_anousu($chave_k13_conta, $campos, "", "$where k13_conta=$chave_k13_conta  and c61_instit = " . db_getsession("DB_instit") . ($recurso == "0" ? "" : " and c61_codigo = $recurso"));
                } else if (isset($chave_k13_descr) && (trim($chave_k13_descr) != "")) {
                    $sql = $clsaltes->sql_query_anousu("", $campos, "k13_descr", "$where k13_descr like '$chave_k13_descr%' and c61_instit = " . db_getsession("DB_instit") . ($recurso == "0" ? "" : " and c61_codigo = $recurso"));
                } else {
                ...
                if ($pesquisa_chave != null && $pesquisa_chave != "") {
                    ...
                    if ($clsaltes->numrows != 0) {
                        ...
                        echo "<script>" . $funcao_js . "('$k13_conta','$k13_descr','$c61_codigo',false, '$o15_recurso', '$gestao');</script>";
                    } else {
