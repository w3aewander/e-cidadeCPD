...
$oGet = db_utils::postMemory($_GET, false);
    ...
    $rs_bem = pg_exec ($conexao, "select num_processo_adm from bens where t52_bem='".$oGet->t52_bem."'");
...
$oPdf->Cell(60, $iAlturaCelula, substr($sBem, 0, 91) , 0, 1, "L", 0);
...
$oPdf->SetFont('arial', 'b', 8);
$oPdf->Cell(30, $iAlturaCelula, 'Processo :', 0, 0, "R", 0);
$oPdf->SetFont('arial', '', 7);
$oPdf->Cell(60, $iAlturaCelula, $num_processo_adm, 0, 0, "L", 0);
...
$oPdf->SetFont('arial', 'b', 8);
$oPdf->Cell(30, $iAlturaCelula, 'Placa do Bem :', 0, 0, "R", 0);
$oPdf->SetFont('arial', '', 7);
