...
<?
if (db_getsession("DB_id_usuario") == 14 or db_getsession("DB_id_usuario") == 15 or db_getsession("DB_id_usuario") == 1 or db_getsession("DB_id_usuario") == 133 or db_getsession("DB_cgm") == 1  ) {
?>
