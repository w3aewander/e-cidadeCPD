...
include(modification("classes/db_orcelemento_classe.php")); // orcelemento
...
<form name="form1" method="post" action="">
    <fieldset>
        <legend>Grupos de Material/Serviço</legend>
        <table border="0">
            <!--  -->
            <tr>
    ...
    <input name="db_opcao" type="hidden" id="db_opcao"
