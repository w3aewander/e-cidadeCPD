          ...
          <legend>Emissão do Termo de Responsabilidade</legend>
                    ...
                    <td>
                      <div class="field-size5">
                        <select name='t33_divisao' OnChange="js_divisao();">
                  			  ...
                  			  <?php
                            $where = "t30_depto = {$coddepto} AND t30_ativo = true";
                            $sql = $cldepartdiv->sql_query_file(null, "t30_codigo, t30_descr", null, $where);
                  			    $result = $cldepartdiv->sql_record($sql);
            ...
            <fieldset class="separator">
              <legend>Visualização</legend>
                ...
                <table class="form-container">
                 <!-- plugin - TermoResponsabilidade: campo para digitar numeração do termo -->
                 <tr>
