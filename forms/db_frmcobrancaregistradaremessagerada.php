...
<form action="" method="post" name="formRemessasGeradas" id="formRemessasGeradas">
  <fieldset style="width: 532px;margin-right: auto;margin-left: auto;">
  ...
  <div id="containerGridRemessaGerada" style="margin-top: 10px;width: 750px;"></div>
</form>
...
<script type="text/javascript">
  ...
  oGridRemessaGerada.setCellWidth(new Array("10%", "18%", "32%", "22%", "18%"));
  oGridRemessaGerada.setCellAlign(new Array("center", "center", "left", "left", "center"));
  oGridRemessaGerada.setHeader(new Array("Sequencial", "Data/Hora Emissão", "Convênio", "Tipo Emissão", "Ações"));
    ...
    new AjaxRequest(sRPC, oParametros, function(oRetorno, erro) {
      ...
      oRetorno.aRemessasGeradas.each(function(oDado, iIndice) {
        ...
        var aRow    = new Array();
            ...
            aRow[3] = oDado.tipos;
            aRow[4]  = "<input type='button' value='Regerar' onclick='js_regerar(" + oDado.codigo + ")'> ";
            aRow[4] += "<input type='button' value='Baixar' onclick='js_baixar(" + oDado.codigo + ")'>";
