...
<fieldset style="width: 870px;" class="container">
  <legend>Alunos com Autorizações</legend>
  ...
  <div id='campos' style="float:left; width:400px; ">
    <fieldset class="separator">
      ...
      <table class="form-container" >
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xturno" onclick="VerificaTamanho(6);" checked> Turno
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xturma" onclick="VerificaTamanho(7);" checked> Turma
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xaimagem" onclick="VerificaTamanho(8);" checked> Autorização de imagem
            <input type="hidden" name="cabecalho" value="Autorização Imagem"><br>
          </td>
          <td>
            <select name="alinhamento">
        ...
        <tr>
          <td nowrap="nowrap">
            <input type="checkbox" name="campos" value="xacoluna" onclick="VerificaTamanho(9);" checked> Autorização Projeto Coluna Reta
            <input type="hidden" name="cabecalho" value="Projeto Coluna Reta"><br>
          </td>
          <td>
            <select name="alinhamento">
              <option value="S">SIM</option>
      ...
      <legend>Orientação e Ordenação</legend>
        <table class="form-container" >
          ...
          <tr>
            ...
            <td >
             <select name="camposordenados" id="camposordenados" size="10" >
             </select>
            </td>
...
<input name="pesquisar2" type="button" id="pesquisar2" value="Planilha" onclick="js_pesquisa2(); ">
</center>
</form>
...
function js_pesquisa() {
  ...
  jan = window.open('edu2_relautorizacao.php?dDataMatriculaInicial='+document.form1.dDataMatriculaInicial.value
...
jan = window.open('edu2_relautorizacaocsv.php?dDataMatriculaInicial='+document.form1.dDataMatriculaInicial.value
                                                +'&dDataMatriculaFinal='+document.form1.dDataMatriculaFinal.value
                                                +'&iEscola='+document.form1.cboEscola.value
                                                +'&iEnsino='+document.form1.cboEnsino.value
                                                +'&iEtapa='+document.form1.cboEtapa.value
