      ...
      <table class="form-container">
        <tr>
          <td nowrap title="<?=@$Tr30_regist?>">
            <label id="lbl_r30_regist" for="r30_regist">
              <?php 
    ...
    <table class="form-container">
      <tr>
        <td nowrap title="<?=@$Tr30_proc1?>">
          <label id="lbl_r30_proc1" for="r30_proc1">
            <?php 
...
<input
  ...
  <?php echo isset($r30_regist) && !empty($r30_regist) ? "" : "disabled"; ?>>
...
//    document.form1.r30_per1i_dia.focus();
  ...
  var iAnoCompetenciaFolha          = parseInt(<?php echo DBPessoal::getCompetenciaFolha()->getAno() ?>);
  var iMesCompetenciaFolha          = parseInt(<?php echo DBPessoal::getCompetenciaFolha()->getMes() ?>);
...
//      document.form1.r30_per1i_dia.focus();
  ...
  if((iAnoCompetenciaFolha <= parseInt(document.form1.r30_per1f_ano.value)) && iMesCompetenciaFolha <= parseInt(document.form1.r30_per1f_mes.value)) {
    alert("Informe corretamente o período de gozo inicial.\nDeve ser inferior a competência da folha.");
    document.form1.r30_per1i.focus();
    retorno = false;
  }
  ...
  if(iTipoPagamento != 1 && iTipoPagamento != 5 && iTipoPagamento != 6 && iTipoPagamento != 7 && iTipoPagamento != 8) {
    if(document.form1.r30_proc2.value == "" || (iMesCompetenciaPagamentoGozo2 > 12 || iMesCompetenciaPagamentoGozo2 < 1)) {
      alert("Informe corretamente a data de pagamento do período de gozo final.");
      document.form1.r30_proc2.focus();
      retorno = false;
    }

    if((iAnoCompetenciaFolha <= parseInt(document.form1.r30_per2f_ano.value)) && iMesCompetenciaFolha <= parseInt(document.form1.r30_per2f_mes.value)) {
      alert("Informe corretamente o período de gozo final.\nDeve ser inferior a competência da folha.");
