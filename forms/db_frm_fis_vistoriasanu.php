...
function js_pesquisay28_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist','Pesquisa',true);
  }else{
     if(document.form1.y28_codvist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y28_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistoriasanu','func_fis_vistoriasanu.php?funcao_js=parent.js_preenchepesquisa|y28_codigo','Pesquisa',true);
}
