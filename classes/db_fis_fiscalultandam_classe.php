...
class cl_fis_fiscalultandam {
   ...
   public $y19_codnoti = 0;
   public $y19_codandam = 0;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalultandam");
...
public function incluir ($y19_codnoti,$y19_codandam){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalultandam(
                                       y19_codnoti
                                      ,y19_codandam
                       )
                values (
...
public function alterar ($y19_codnoti=null,$y19_codandam=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalultandam set ";
     $virgula = "";
...
public function excluir ($y19_codnoti=null,$y19_codandam=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalultandam
                    where ";
     $sql2 = "";
...
public function sql_query ( $y19_codnoti=null,$y19_codandam=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalultandam ";
     $sql .= "      inner join fiscalizacao.fis_fandam  on  fis_fandam.y39_codandam = fis_fiscalultandam.y19_codandam";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalultandam.y19_codnoti";
     ...
     if($dbwhere==""){
       if($y19_codnoti!=null ){
         $sql2 .= " where fis_fiscalultandam.y19_codnoti = $y19_codnoti ";
       }
       if($y19_codandam!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fiscalultandam.y19_codandam = $y19_codandam ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y19_codnoti=null,$y19_codandam=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
