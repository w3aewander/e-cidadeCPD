                                    ...
                                    <fieldset>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $mascara = '0.0.0.0.0.00.0.0.00.00.00';
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php db_input('c60_descr', 60, @$Ic60_descr, true, 'text', $db_opcao)?>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr id="linha_vinculo_pcasp">
                                                <td nowrap="nowrap">
                                                    <?php db_ancora('<b>Vinculo PCASP:</b>', 'js_pesquisaContaPCASP(true);', $db_opcao)?>
                                                </td>
                                                <td>
                                                    <?php
                                            ...
                                            <tr style="display: <?=$displayrecursoUniao?>;">
                                                <td nowrap="nowrap"><b>Identificador Resultado Primário:</b></td>
                                                <td>
                                                    <?php

                                                    db_select('c60_identificadorresultadoprimario', $tiposresultadoPrimario, true, $db_opcao);
                                                    ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td nowrap="nowrap" title="Finalidade do plano de contas" valign="top" colspan="2">
                                                    <fieldset>
                                                        ...
                                                        <?php db_textarea('c60_finali', 0, 70, $Ic60_finali, true, 'text', $db_opcao, "");?>
                                                    </fieldset>
                                                </td>
                                            </tr>
...
<script>
  ...
  function js_acaoConta() {
    ...
    if (oGet.db_opcao == 3) {
      ...
      oParam.iIdentificadorResultado  = $F('c60_identificadorresultadoprimario');
  ...
  function js_pesquisaContaPCASP(mostra) {
    ...
    if (mostra === true) {
      js_OpenJanelaIframe('CurrentWindow.corpo.iframe_conta',
        ...
        'func_conplano.php?funcao_js=parent.js_mostraContaPcasp|c60_codcon|c60_descr|c60_estrut|c60_identificadorfinanceiro',
        'Pesquisar', true, '10');
    } else {
      ...
      if (sValorCampo !== '') {
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_conta',
          'db_iframe_contaPcasp',
          'func_conplano.php?identificador_financeiro='+true+'&pesquisa_chave='+sValorCampo+'&funcao_js=parent.js_mostraContaPcasp',
          'Pesquisa', false);
      } else {
        $('c72_conplano').value = '';
      }
  ...
  function js_mostraContaPcasp () {
    ...
    if (arguments[1] === true){
      ...
      // O array abaixo  contem o numero inicial do estrutural para definir se o PCASP é ativo/passivo 
      var PCASPAtivoPassivo = ['1','2'];
      var estrutural = arguments[2];
      var indicador_superavit = arguments[3];
  
      if(PCASPAtivoPassivo.includes(estrutural[0]) && indicador_superavit == 'F'){
        $("c72_conplano").value = "";
        alert('Não é possível realizar o vínculo PCASP a uma Conta do Ativo F ou Passivo F em uma Receita/Despesa!');
      } else {
        if (arguments[1] === false) {
          $("c60_descrPcasp").value = arguments[0];
          $("c60_estrut_pcasp").value = estrutural;
        } else {
  ...
  function js_preencheDadosConta(oResponse) {
    ...
    var grupoEstrutural = Number($('c90_estrutcontabil').value.substr(0,1));
    if (grupoEstrutural === 4 || grupoEstrutural === 9) {
        $('mascara').value = '0.0.0.0.0.00.0.0.00.00.00';
    }
  }
