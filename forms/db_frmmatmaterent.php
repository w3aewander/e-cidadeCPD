...
db_input('descr_uni',40,'',true,'text',3)
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
            <select name="servico" id="servico" disabled class="readonly">
                <option value="t"<?=$lServico=='t'?' selected':''?>>SIM</option>
                <option value="f"<?=$lServico=='f'?' selected':''?>>NÃO</option>
            </select>
            <input type="hidden" id="m60_servico" name="m60_servico" value="<?=isset($lServico)&&$lServico=='t'?'t':'f'?>">
        </td>
    </tr>
  <tr>
