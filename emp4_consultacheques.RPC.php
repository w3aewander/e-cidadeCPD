...
if (isset($oParam->exec) && $oParam->exec == 'getCheques') {
    ...
    if (isset($oParam->o15_codigo) && trim($oParam->o15_codigo) != "") {
        if ($sWhere != "") {
            $sWhere .= " and (o58_codigo = {$oParam->o15_codigo} or cpreduzslip.c61_codigo = {$oParam->o15_codigo})";
            $sWhere2 .= " and (o58_codigo = {$oParam->o15_codigo} or cpreduzslip.c61_codigo = {$oParam->o15_codigo}) ";
        } else {
            $sWhere .= " (o58_codigo = {$oParam->o15_codigo} or cpreduzslip.c61_codigo = {$oParam->o15_codigo}) ";
            $sWhere2 .= " (o58_codigo = {$oParam->o15_codigo} or cpreduzslip.c61_codigo = {$oParam->o15_codigo}) ";
        }
    }
}
...
switch ($oParam->exec) {
    case 'getCheques':
        ...
        $sql .= "  case when cpreduzslip.c61_reduz is null then o58_codigo else cpreduzslip.c61_codigo end as id_recurso,	";
        $sql .= "  e91_valor,	";
        $sql .= "  c63_banco,	";
        $sql .= "  c63_conta,	";
        $sql .= "  e83_descr,	";
        ...
        $sql .= "                          and contareduz.c61_reduz = c63_reduz ";
        $sql .= " " . $sWhere . " ";
        ...
        $sql = "select x.*, o15_recurso as recurso from ($sql) as x
