...
class cl_db_itensmenu {
   ...
   public function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->api = (@$GLOBALS["HTTP_POST_VARS"]["api"] != null?@$GLOBALS["HTTP_POST_VARS"]["api"]:$this->api);
     }else{
       $this->id_item = ($this->id_item == ""?@$GLOBALS["HTTP_POST_VARS"]["id_item"]:$this->id_item);
     }
   }
   // funcao para inclusao
   public function incluir ($id_item){
      $this->atualizacampos();
   ...
   public function alterar ($id_item=null) {
      $this->atualizacampos();
     ...
     if(trim($this->api)!="" || isset($GLOBALS["HTTP_POST_VARS"]["api"])){
        $sql  .= $virgula." api = '$this->api' ";
        $virgula = ",";
        if(trim($this->api) == null ){
            $this->erro_sql = " Campo  API no foi informado.";
            $this->erro_campo = "api";
            $this->erro_banco = "";
   ...
   public function excluir ($id_item=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $id_item=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $id_item=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
         $campos_sql = explode("#", $campos);
       $virgula = "";
    ...
    * @return string
    */
   public function sql_queryArvoreMenus( $sCampos = null, $iIdItem = null, $iModulo = null ) {
   ...
   public function sql_query_menus ( $id_item=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
         $campos_sql = explode("#", $campos);
       $virgula = "";
   ...
   * @return string
   */
  public function sql_query_menus_principais ( $id_item = null, $campos = "*", $ordem = null, $dbwhere = "" ) {
