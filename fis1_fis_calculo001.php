...
require_once(modification("classes/db_fis_vistorianumpre_classe.php"));
require_once(modification("classes/db_fis_vistorias_classe.php"));
...
if ( isset($calcular) ) {
  ...
  try {
    ...
    $oDaoVistinscr = db_utils::getDao("fis_vistinscr");
  ...
  $sSqlVist = "select   y69_numpre ,
                                   ...
                                   from fiscalizacao.fis_vistorianumpre where fis_vistorianumpre.y69_codvist = $y70_codvist";
