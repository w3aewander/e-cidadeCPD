...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_receitas.location.href='fis1_fis_autorec002.php?chavepesquisa=$y57_codauto&chavepesquisa1=$y57_receit&y59_codauto=$y59_codauto'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_receitas.location.href='fis1_fis_autorec003.php?chavepesquisa=$y57_codauto&chavepesquisa1=$y57_receit&y59_codauto=$y59_codauto'</script>";
}
?>
...
?>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_autorec001.php?y59_codauto=<?=$y59_codauto?>'">
      <?php
      }
      ?>
    </td>
...
function js_pesquisay57_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y57_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_autorec','func_fis_autorec.php?funcao_js=parent.js_preenchepesquisa|y57_codauto|1','Pesquisa',true);
}
