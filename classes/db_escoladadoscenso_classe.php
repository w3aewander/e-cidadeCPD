...
class cl_escoladadoscenso
{
    ...
    public function sql_censo($escola)
    {
        $sql = "
            select  avaliacaogrupopergunta.db102_identificadorcampo as grupo,
              ...
              join avaliacaogruporesposta on avaliacaogruporesposta.db107_sequencial = escoladadoscenso.ed308_avaliacaogruporesposta
             ...
             where  ed308_escola = {$escola}
              and db102_avaliacao = 3000000
            order by 1,2,3
        ";
