...
class cl_orcparamrel
{
    ...
    public $o42_codparrel = 0;
    public $o42_orcparamrelgrupo = 0;
    public $o42_descrrel = null;
    public $o42_notapadrao = null;
    ...
    public function incluir($o42_codparrel)
    {
        $this->atualizacampos();
        ...
        if (!empty($o42_codparrel)) {
            db_query("select setval('orcparamrel_o42_codparrel_seq', (select max(o42_codparrel) from orcparamrel));");
        }
        return true;
    }
    // funcao para alteracao
    public function alterar($o42_codparrel = null)
    {
        $this->atualizacampos();
    ...
    public function excluir($o42_codparrel = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query($o42_codparrel = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    // funcao do sql
    public function sql_query_file($o42_codparrel = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_nivel($relatorio, $parametro = "", $anousu = null)
    {
        //#10#//
    ...
    public function sql_nivelexclusao($relatorio, $parametro = "")
    {
        //#10#//
        $nivel = 0;
    ...
    public function sql_parametro($relatorio, $parametro = "", $exclusao = 'f', $instituicao = "1", $anousu = null, $obrig = true)
    {
    ...
    public function sql_parametro_instit($relatorio, $parametro = "", $exclusao = 'f', $instituicao = "1", $anousu = null, $obrig = true)
    {
        $sql_instit      = "select codigo from db_config where prefeitura is true limit 1";
        $res_instit      = @db_query($sql_instit);
        $num_rows_instit = @pg_numrows($res_instit);
