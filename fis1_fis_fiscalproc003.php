...
if(!isset($abas)){
  ...
  echo "<script>location.href='fis1_fis_fiscalproc005.php?db_opcao=3'</script>";
  exit;
}
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  ...
  if($clfiscalproc->erro_status=="0"){
    ...
    $clfiscalproc->erro(true,false);
    echo "<script>parent.iframe_fiscalproc.location.href='fis1_fis_fiscalproc003.php?abas=1';</script>";
  }
}
if($db_opcao==33){
