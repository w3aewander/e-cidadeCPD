...
class ServidorOperadoraSaudeRepository
{
    ...
    {
        $id = $servidorOperadoraSaude instanceof ServidorOperadoraSaude ?
            $servidorOperadoraSaude->getSequencial() :
            null;
    ...
    {
        $this->scopes['rubricaemp'] = "rh222_rubricaempregador {$operator} '%{$rubrica->getCodigo()}%'";
        return $this;
    }
    /**
     * @param $id
    ...
    {
        $this->scopes['servidor'] = "rh222_servidor {$operator} {$matricula}";
        return $this;
    }
     ...
     * @return $this
     */
    public function scopeNumeroCGM($numeroCgm, $operator = '=')
    {
        $this->scopes['cgm'] = "rhpessoal.rh01_numcgm {$operator} {$numeroCgm}";
        return $this;
    }

    /**
     * @param $numeroInstituicao
     * @param string $operator
     * @return $this
     */
    public function scopeNumeroInstituicao($numeroInstituicao, $operator = '=')
    {
        $this->scopes['nuneroinstituicao'] = "rh222_instituicao {$operator} {$numeroInstituicao}";
        return $this;
    }
}
