                            ...
                            <center>
                                <table border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php db_input('d40_codigo', 10, $Id40_codigo, true, 'text', 3, "");?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap title="<?=@$Td40_codlog?>">
                                            <?php db_ancora(@$Ld40_codlog, "js_pesquisad40_codlog(true);", $db_opcao);?>
                                        </td>
                                        <td>
                                            <?php db_input('d40_codlog', 10, $Id40_codlog, true, 'text', $db_opcao, " onchange='js_pesquisad40_codlog(false);'");?>
                                            <?php db_input('j14_nome', 40, $Ij14_nome, true, 'text', 3, '');?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap title="<?=@$Td42_numcgm?>">
                                            <?php db_ancora(@$Ld42_numcgm, "js_pesquisad42_numcgm(true);", $db_opcao);?>
                                        </td>
                                        <td>
                                            <?php db_input('d42_numcgm', 10, $Id42_numcgm, true, 'text', $db_opcao, " onchange='js_pesquisad42_numcgm(false);'");?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php db_input('d40_profun', 10, $Id40_profun, true, 'text', $db_opcao, "");?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?php db_input('d40_trecho',54,$Id40_trecho,true,'text',$db_opcao,"");?>
                                        </td>
                                    </tr>
                                </table>
                                <table>
                        ...
                        <script>
                            ...
                            function js_pesquisaimporta() {
                                js_OpenJanelaIframe(
                                    'CurrentWindow.corpo',
                                    'db_iframe_importa',
                                    'func_projmelhorias.php?funcao_js=parent.js_mostraimporta|d40_codigo',
                                    'Pesquisa',
                                    true
                                );
                            }
