...
if((isset($HTTP_POST_VARS["opcaoExec"]) && $HTTP_POST_VARS["opcaoExec"])=="Incluir"){
  ...
  if($clsanitario->numrows > 0){
	...
	echo " <script>
			     parent.iframe_sanitario.location.href='fis1_fis_sanitario002.php?chavepesquisa=".$clsaniatividade->y83_codsani."';
	       </script>
	     ";
$db_opcao = 1;
      }
  ...
  if (!$sqlerro)	{
	echo " <script>
					parent.iframe_calculo.location.href='fis1_fis_sanicalc001.php?y80_codsani=".$clsaniatividade->y83_codsani."';
				 </script>";
	}
}
?>
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<?php
        //$db_opcao = 1;
	include(modification("forms/db_frm_fis_saniatividade.php"));
	?>
    </center>
	</td>
  </tr>
...
if((isset($HTTP_POST_VARS["opcaoExec"]) && $HTTP_POST_VARS["opcaoExec"])=="Incluir"){
  if($clsaniatividade->erro_status=="0"){
    echo "<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=".$clsaniatividade->y83_codsani."&opcao=Incluir';\n</script>";
    ...
    echo "
         <script>
         function js_src(){
         parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=".$y83_codsani."&opcao=Incluir';\n
         }
         js_src();
         </script>
     ";
