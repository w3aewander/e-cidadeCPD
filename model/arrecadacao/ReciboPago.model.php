...
class ReciboPago {
  ...
  private function getReciboPago($sSqlInnerArreIdRet, $sSqlInnerArrePaga, $sSqlWhere){
    ...
    $sSql .= "                  left  join db_reciboweb on db_reciboweb.k99_numpre_n = disbanco.k00_numpre                                                                 ";
    ...
    $sSql .= "                  left  join db_reciboweb on db_reciboweb.k99_numpre_n = abatimentorecibo.k127_numpreoriginal                                                ";
    ...
    $sSql .= "                  left  join cornump on cornump.k12_numpre = arrepaga.k00_numpre                                                                             ";
