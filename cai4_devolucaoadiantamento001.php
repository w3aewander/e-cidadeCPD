      ...
      <form method="POST" action="cai4_devolucaoadiantamento002.php" id="frmDevolucaoAdiantamento">
        <fieldset style="width: 490px;">
          ...
          <table class="table-default" style="width: 490px;">
            ...
            <tr>
              <td><label for="iCodigoOrdem"><strong>Ordem de Pagamento:</strong></label></td>
              <td>
                <?php db_input('iCodigoOrdem', 15, null, true, "text", 3, "", "", "", "width: 80px;", 3); ?>
              </td>
            </tr>
            <tr>
  ...
  <script>
    ...
    function pesquisaCodigoMovimento() {
        js_OpenJanelaIframe( 'CurrentWindow.corpo',
                             'db_iframe_empagemov',
                             'func_empagemov_prestacao.php?funcao_js=parent.exibeCodigoMovimento|e81_codmov',
                             'Pesquisa Movimento', true );
    }
    ...
    function preencheCampos(oValores) {
      ...
      $('iCodigoOrdem').value         = oValores ? oValores.iCodigoOrdem : '';
