    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_procfiscalfases.php")==true){
             include(modification("funcoes/db_func_fis_procfiscalfases.php"));
           }else{
           $campos = "fis_procfiscalfases.*,cgm.z01_nome";
           }
        }
				...
				$sql = "
								select y100_sequencial,
								  ...
								  from fiscalizacao.fis_procfiscal
								       ...
								       inner join fiscalizacao.fis_procfiscalfases on y108_procfiscal = y100_sequencial
