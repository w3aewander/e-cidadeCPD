...
function js_emite(){
  ...
  jan = window.open('con2_diariobancos002.php?&db_selinstit='+document.form1.db_selinstit.value+'&movimento='+document.form1.movimento.value+'&tipo='+document.form1.tipo.value+'&perini='+perini+'&perfin='+perfin+'&considerarlancgenericos='+document.form1.considerarlancgenericos.value+'&somentediferenca='+document.form1.diferenca.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
</script>
