...
class bvmovant
{
    ...
    public function bvmovant($header)
    {
        umask(74);
    ...
    public function db_planocontassaldo_matriz_mes($anousu, $dataini, $datafim, $retsql = false, $where = '', $estrut_inicial = '', $acumula_reduzido = 'true', $encerramento = 'false')
    {
        if ($anousu == null) {
