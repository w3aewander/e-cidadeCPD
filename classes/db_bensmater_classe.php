...
class cl_bensmater {
   ...
   function incluir ($t53_codbem){
      $this->atualizacampos();
     if($this->t53_ntfisc == null || trim($this->t53_ntfisc) === ''){
       $this->erro_sql = PHP_EOL . " Campo Nota fiscal nao Informado." . PHP_EOL;
       $this->erro_campo = "t53_ntfisc";
       $this->erro_banco = "";
       $this->erro_msg   = PHP_EOL . "Usuário:" . PHP_EOL . "$this->erro_sql" . PHP_EOL;
       $this->erro_msg   .= str_replace('"',"",str_replace("'","",  "Administrador:" . PHP_EOL . "$this->erro_banco" . PHP_EOL));
       $this->erro_status = "0";
       return false;
     }
   ...
   function alterar ($t53_codbem=null) {
     ...
     if(trim($this->t53_ntfisc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t53_ntfisc"])){
       ...
       if(trim($this->t53_ntfisc) == null ){
         ...
         $this->erro_campo = "t53_ntfisc";
         $this->erro_banco = "";
           $this->erro_msg   = "Usuário:" . PHP_EOL . "$this->erro_sql" . PHP_EOL;
           $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador:" . PHP_EOL . "$this->erro_banco" . PHP_EOL));
         $this->erro_status = "0";
         return false;
       }
