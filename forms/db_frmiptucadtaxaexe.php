        ...
        <fieldset>
            ...
            <table class="form-container">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('j08_iptucadtaxa', 8, $Ij08_iptucadtaxa, true, 'text', 3, " onchange='js_pesquisaj08_iptucadtaxa(false);'");
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('j08_tabrec', 8, $Ij08_tabrec, true, 'text', $db_opcao, " onchange='js_pesquisaj08_tabrec(false);'");
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('j08_iptucalh', 8, $Ij08_iptucalh, true, 'text', $db_opcao, " onchange='js_pesquisaj08_iptucalh(false);'");
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('j08_db_sysfuncoes', 8, $Ij08_db_sysfuncoes, true, 'text', $db_opcao, " onchange='js_pesquisaj08_db_sysfuncoes(false);'");
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('j08_histisen', 8, $Ij08_histisen, true, 'text', $db_opcao, " onchange='js_pesquisaj08_histiseni(false);'");
                ...
                <tr>
                    <td><label for="j08_cadvencdesc"><a href="#" id="ancoraVencimentos">Vencimentos:</a></label></td>
                    <td>
                        <?php
                            db_input('j08_cadvencdesc', 8, $Ij08_cadvencdesc, true, 'text', $db_opcao);
                ...
                <tr>
                    <td><label for="j08_arretipo"><a href="#" id="ancoraTipoDebito">Tipo de Débito:</a></label></td>
                    <td>
                        <?php
                        db_input('j08_arretipo', 8, $Ij08_arretipo, true, 'text', $db_opcao);
            ...
            <fieldset class="separator">
                <legend>Recalculo</legend>
                <table class="form-container">
                    <tr>
                        <td><label for="j08_procdiver"><a href="#" id="ancoraProcedencia">Procedência:</a></label></td>
                        <td>
                            <?php
                            db_input('j08_procdiver', 8, $Ij08_procdiver, true, 'text', $db_opcao);
            ...
            <tr>
                <td valign="top" align="center">
                    ...
                    $sql = $cliptucadtaxaexe->sql_query_file(
                        ...
                        "*",
                        null,
                        " j08_iptucadtaxa = $j08_iptucadtaxa and j08_anousu = $j08_anousu "
                    );

                    $cliframe_alterar_excluir->chavepri = $chavepri;
                    $cliframe_alterar_excluir->sql = $sql;
                    $cliframe_alterar_excluir->campos = "j08_iptucadtaxaexe, j08_iptucadtaxa,j08_tabrec,j08_valor,j08_aliq,j08_anousu,j08_iptucalh,j08_db_sysfuncoes,j08_histisen, j08_cadvencdesc, j08_arretipo, j08_procdiver";
...
<script>
    ...
    $('j08_iptucadtaxa').removeAttribute('size');
    $('j08_tabrec').removeAttribute('size');
    $('j08_iptucalh').removeAttribute('size');
    $('j08_db_sysfuncoes').removeAttribute('size');
    $('j08_histisen').removeAttribute('size');
    $('j07_descr').removeAttribute('size');
    $('k02_descr').removeAttribute('size');
    $('j17_descr').removeAttribute('size');
    $('nomefuncao').removeAttribute('size');
    $('j17_descr2').removeAttribute('size');

    $('j08_iptucadtaxa').addClassName('field-size2');
    $('j08_tabrec').addClassName('field-size2');
    $('j08_iptucalh').addClassName('field-size2');
    $('j08_db_sysfuncoes').addClassName('field-size2');
    $('j08_histisen').addClassName('field-size2');
    $('j07_descr').addClassName('field-size8');
    $('k02_descr').addClassName('field-size8');
    $('j17_descr').addClassName('field-size8');
    $('nomefuncao').addClassName('field-size8');
    $('j17_descr2').addClassName('field-size8');

    $('j08_cadvencdesc').setAttribute("lang", "q92_codigo");
    $('j08_arretipo').setAttribute("lang", "k00_tipo");
    $('j08_procdiver').setAttribute("lang", "dv09_procdiver");
    ...
    new DBLookUp($('ancoraProcedencia'), $('j08_procdiver'), $('dv09_descr'), {
        'sArquivo': 'func_procdiver.php',
        'sObjetoLookUp': 'db_iframe_procdiver',
        'sLabel': 'Pesquisar Procedência'
    });

    new DBLookUp($('ancoraVencimentos'), $('j08_cadvencdesc'), $('q92_descr'), {
        'sArquivo': 'func_cadvencdesc.php',
        'sObjetoLookUp': 'db_iframe_cadvencdesc',
        'sLabel': 'Pesquisar Vencimentos'
    });

    new DBLookUp($('ancoraTipoDebito'), $('j08_arretipo'), $('k00_descr'), {
        'sArquivo': 'func_arretipo.php',
        'sObjetoLookUp': 'db_iframe_arretipo',
        'sLabel': 'Pesquisar Tipos de Débitos',
        'aParametrosAdicionais': ['k03_tipo=1']
    });
</script>
