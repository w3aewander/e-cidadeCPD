 ...
 */
class FisRequisicaoAidofWebService extends FisRequisicaoAidof {
  ...
  public function setNota($iNota) {
    ...
    /**
     * Libera ou não a Aidof automaticamente
     * @param bool $bLiberar
     * @return FisRequisicaoAidofWebService|void
     */
  ...
  public function validaNumeracao () {
  	...
  	$oDaoNumeracaoAidof  = new cl_fis_aidof();
