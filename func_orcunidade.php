...
<table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <input name="Fechar" type="button" id="fechar" value="Fechar"
                                   onClick="parent.db_iframe_orcunidade.hide();">
                        </td>
                    </tr>
                </form>
            </table>
    ...
    <tr>
        <td align="center" valign="top">
            ...
            $whInstit = '';
            if (isset($instit)) {
                $whInstit = " and o41_instit = {$instit} ";
            }
            ...
            if (!isset($pesquisa_chave)) {
                ...
                if (isset($chave_o41_orgao) && (trim($chave_o41_orgao) != "")) {
                    ...
                    $sql = $clorcunidade->sql_query(null, " {$chave_o41_orgao} ", $chave_o41_unidade, $campos, "o41_orgao", $wh1 . " o41_anousu=" . db_getsession("DB_anousu") . $whInstit);
                }
                if (isset($chave_o41_unidade) && trim($chave_o41_unidade) != "") {
                    $sql = $clorcunidade->sql_query(null, "", "", $campos, "o41_descr", " $wh o41_unidade = $chave_o41_unidade and o41_anousu=" . db_getsession("DB_anousu") . $whInstit);
                } else if (isset($chave_o41_descr) && (trim($chave_o41_descr) != "")) {
                    $sql = $clorcunidade->sql_query(null, "", "", $campos, "o41_descr", " $wh o41_descr like '$chave_o41_descr%' and o41_anousu=" . db_getsession("DB_anousu") . $whInstit);
                } else {

                    if (isset($orgao) && $orgao != "") {
                        $wh1 = " o41_orgao in  ($orgao) and ";
                    }
                    $sql = $clorcunidade->sql_query(null, "", "", $campos, "o41_anousu#o41_orgao#o41_unidade", $wh1 . " o41_anousu=" . db_getsession("DB_anousu") . $whInstit);
                }
                ...
                if ($pesquisa_chave != null && $pesquisa_chave != "") {
                    ...
                    $result = $clorcunidade->sql_record($clorcunidade->sql_query(null, '', null, $campos, '', $wh1 . " o41_anousu=" . db_getsession("DB_anousu") . "
					                             and o41_unidade = $pesquisa_chave" . $whInstit));
