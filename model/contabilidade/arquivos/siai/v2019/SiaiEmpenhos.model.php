...
class SiaiEmpenhos extends SiaiArquivoBase
{
  ...
  */
    public function gerarDados()
    {
        ...
        $lMostraValores           = false;

        $nTotalEmpenho            = 0;
        $nTotalLiquidacao         = 0;
        $nTotalPago               = 0;
        $nTotalPagoRet            = 0;
        $nTotalAnulacaoEmpenho    = 0;
        $nTotalAnulacaoLiquidacao = 0;
        $nTotalAnulacaoPagamento  = 0;
        ...
        $sCampos .= " (select o15_codtri 
	             from orctiporec 
		    where o15_codigo = orcdotacao.o58_codigo) as o58_codigo, ";
       ...
       */
        ...
        if ($iLinhasEmpenhos > 0) {
            ...
            for ($iInd = 0; $iInd < $iLinhasEmpenhos; $iInd++) {
                ...
                $oDadosDetalhe10->NumeroDocumentoCredor         = str_pad(($oDados->z01_cgccpf == "99999999999999" ? "08241747000143" : $oDados->z01_cgccpf), 14, "0", STR_PAD_LEFT);
                ...
                $oDadosDetalhe10->Brancos_1                     = " ";
                $oDadosDetalhe10->Brancos_2                     = " ";
                $oDadosDetalhe10->CodigoGrupoExercicioFonte     = substr($oDados->o58_codigo, 0, 1);
                $oDadosDetalhe10->CodigoClassificacaoFonte      = substr($oDados->o58_codigo, 1, 3);
                $oDadosDetalhe10->CodigoDetalhamentoFonte       = substr($oDados->o58_codigo, 4, 4);
                $oDadosDetalhe10->Brancos_3                     = " ";
                $oDadosDetalhe10->NumeroDocumentoOrdenador      = str_pad($oDados->numerodocumentoordenador, 11, "0");
                ...
                $sLinhaDetalhe10 = $oDadosDetalhe10->TipoRegistro
                                ...
                                .$oDadosDetalhe10->Brancos_1
                                .$oDadosDetalhe10->Brancos_2
                                .$oDadosDetalhe10->CodigoGrupoExercicioFonte
                                .$oDadosDetalhe10->CodigoClassificacaoFonte
                                .$oDadosDetalhe10->CodigoDetalhamentoFonte
                                .$oDadosDetalhe10->Brancos_3
                ...
                $nTotalEmpenho += $oDados->e60_vlremp;
            }
        }
        ...
        if ($iLinhasDados > 0) {
           ...
           */
            ...
            for ($iIndLiq = 0; $iIndLiq < $iLinhasDados; $iIndLiq++) {
                ...
                $oDadosDetalhe20->DocumentoRespons    = str_pad($oDados->numerodocumentoordenador, 11, "0", STR_PAD_LEFT);
                ...
                $nTotalLiquidacao += $oDados->c70_valor;
            }
           ...
           */
            ...
            for ($iIndLiq = 0; $iIndLiq < $iLinhasDados; $iIndLiq++) {
                ...
                $oDadosDetalhe21->ProcessoDespesa     = str_pad($oDados->processo_despesa, 20, "0", STR_PAD_LEFT);
                ...
                $oDadosDetalhe21->Brancos1            = str_repeat(" ", 303);
                ...
                $sLinhaDetalhe21 =  $oDadosDetalhe21->TipRegistro
                             ...
                             .$oDadosDetalhe21->ProcessoDespesa
          ...
          //        if ($oDados->k105_corgrupotipo != 2 && $oDados->c57_sequencial == 30 && !in_array($oDados->e50_codord, $aPagamentosImportados)) {
                if ($oDados->c57_sequencial == 30 && !in_array($oDados->c70_codlan, $aPagamentosImportados)) {
                      $codUnidade = str_pad($oDados->o58_orgao, 2, "0", STR_PAD_LEFT);
                    if ($oDados->o58_orgao == "24" && $oDados->o58_unidade == "20") {
                        $codUnidade .= "220";
                    } else {
      ...
      /*
              ...
              $nTotalPagoRet += $oDadosRetencoes->e23_valorretencao;
              }
              }
          }*/
            }
          ...
          //Array de empenhos que nao devem ser incluidos
            ...
            for ($iIndAnu = 0; $iIndAnu < $iLinhasDados; $iIndAnu++) {
                ...
                $nTotalAnulacaoEmpenho += $oDados->c70_valor;
            }
           ...
           */
            ...
            for ($iIndAnuLiq = 0; $iIndAnuLiq < $iLinhasDados; $iIndAnuLiq++) {
                ...
                $nTotalAnulacaoLiquidacao += $oDados->c70_valor;
            }
          ...
          //Como nao existe tabela de anulacao de pagamento, utilizamos os dados dos lancamentos
            ...
            for ($iIndAnuPag = 0; $iIndAnuPag < $iLinhasDados; $iIndAnuPag++) {
                ...
                $nTotalAnulacaoPagamento += $oDados->c70_valor;
            }
        }
      ...
      //TRAILLER
        ...
        if ($lMostraValores) {
            echo "nTotalEmpenho            = $nTotalEmpenho<br>\n";
            echo "nTotalLiquidacao         = $nTotalLiquidacao<br>\n";
            echo "nTotalPago               = $nTotalPago<br>\n";
            echo "nTotalPagoRet            = $nTotalPagoRet<br>\n";
            echo "nTotalAnulacaoEmpenho    = $nTotalAnulacaoEmpenho<br>\n";
            echo "nTotalAnulacaoLiquidacao = $nTotalAnulacaoLiquidacao<br>\n";
            echo "nTotalAnulacaoPagamento  = $nTotalAnulacaoPagamento<br>\n";
        }
    }
}
