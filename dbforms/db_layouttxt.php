   ...
   */
    ...
    function carregaLinhasMemoria()
    {
        ...
        $sql = "
                ...
                from db_layouttxt
                     join db_layoutlinha on db51_layouttxt = db50_codigo
        ...
        for ($i = 0; $i < pg_num_rows($this->_linhasMemoria); $i ++) {
            ...
            $sql = " select db_layoutcampos.*, db_layoutformat.*
                     from db_layoutcampos
                          join db_layoutformat on db52_layoutformat = db53_codigo
    ...
    function formatarCampo($tipoFormat, $valor, $tamanho, $mascara)
    {
        ...
        switch ($tipoFormat) {
            ...
            case 3: // Para Decimal
                ...
                break;
            case 4: // Para Data
                $arr_data ['Y'] = str_pad(db_subdata($valor, 'a'), 4, '0');
                $arr_data ['y'] = str_pad(substr(db_subdata($valor, 'a'), - 2), 2, '0');
                $arr_data ['m'] = str_pad(db_subdata($valor, 'm'), 2, '0');
