...
function js_pesquisay74_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist|y70_data','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y74_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisay74_codsani(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sanitario','func_fis_sanitario.php?funcao_js=parent.js_mostrasanitario1|y80_codsani|y80_numcgm','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sanitario','func_fis_sanitario.php?pesquisa_chave='+document.form1.y74_codsani.value+'&funcao_js=parent.js_mostrasanitario','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistsanitario','func_fis_vistsanitario.php?funcao_js=parent.js_preenchepesquisa|y74_codvist','Pesquisa',true);
}
