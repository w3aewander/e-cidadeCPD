        ...
        <table align="center">
            ...
            <tr>
                <td>
                    <fieldset>
                        <Legend align="left">
                            <b>Cadastro de Vale Transporte</b>
                        </Legend>
                        <table border="0">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if (!isset($rh67_anousu)) {
                                        $rh67_anousu = DBPessoal::getAnoFolha();
                                    }
                                    if (!isset($rh67_mesusu)) {
                                        $rh67_mesusu = DBPessoal::getMesFolha();
                                    }
                                    db_input('rh67_anousu', 4, $rh67_anousu, true, 'text', 3, "")
                                    ?>
                                    &nbsp;/&nbsp;
                                    <?php
                                    db_input('rh67_mesusu', 2, $rh67_mesusu, true, 'text', 3, "")
                                    ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    db_input('rh67_grupo', 6, $Irh67_grupo, true, 'text', 3, "")
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    db_input('rh67_dias', 6, $Irh67_dias, true, 'text', 3, "")
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap title="<?= @$Trh67_vales ?>">
                                <b>Dias de Desconto: </b>
                                </td>
                                <td>
                                    <?php
                                    db_input('rh67_vales', 6, $Irh67_vales, true, 'text', 3, "")
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap title="<?= @$Trh67_valor ?>">
                                    <b>Valor: </b>
                                </td>
                                <td>
                                    <?php
                                    db_input('rh67_valor', 6, $Irh67_valor, true, 'text', 3, "")
                                    ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            $rh67_data = date("Y/m/d", db_getsession('DB_datausu'));
