  ...
  <tr>
    <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
            ...
            } elseif (isset($chave_j14_nome) && (trim($chave_j14_nome) != "")) {
                $sql = $clruas->sql_query("", $campos, "j14_nome", " j14_nome ilike '%$chave_j14_nome%' ");
            } else {
            ...
            if ($pesquisa_chave != null && $pesquisa_chave != "") {
                ...
                if ($clruas->numrows != 0) {
                   ...
                   echo "<script>" . $funcao_js . "('$pesquisa_chave', '$j14_nome');</script>";
                } else {
                    // echo "<script>" . $funcao_js . "('Chave(" . $pesquisa_chave . ") não Encontrado', true, false);</script>";
                    echo "<script>" . $funcao_js . "('$pesquisa_chave', 'Chave(" . $pesquisa_chave . ") não Encontrada' , false);</script>";
                }
