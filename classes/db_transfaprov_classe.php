...
class cl_transfaprov {
   ...
   public $ed251_i_codigo = 0;
   public $ed251_i_diarioorigem = 0;
   public $ed251_i_diariodestino = 0;
   ...
   public function incluir ($ed251_i_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($ed251_i_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($ed251_i_codigo=null,$dbwhere=null) {
   ...
   public function sql_query ( $ed251_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $ed251_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
