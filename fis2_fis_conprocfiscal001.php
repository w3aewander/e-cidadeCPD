...
<tr> 
  ...
  <tr> 
    <td nowrap> 
		  <?php 
 			db_ancora($Lp58_numero,' js_mostracodproc(true); ',5);
			 ?>
		   </td>
       <td> 
        <?php 
        db_input('p58_numero',10,$Ip58_numero,true,'text',4,'onchange="js_mostracodproc(false);"');
...
function js_pesquisar(){
  ...
  // }
    if (datainicial != '' && datafinal != '' ) {
      js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?'+sQueryString,'Pesquisa',true);
  }
  ...
  if(erro==true){ 
    ...
    document.form1.z01_numcgm.value = ""; 
  	...
  	document.form1.j01_matric.value = "";
		...
		js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&cgm='+document.form1.z01_numcgm.value,'Pesquisa',true);
	}
}
function js_mostracgm1(chave1,chave2){
  ...
  document.form1.z01_nome.value = chave2;
	document.form1.q02_inscr.value  = "";
 	document.form1.j01_matric.value = "";
  db_iframe_cgm.hide();
  js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&cgm='+chave1,'Pesquisa',true);
}
...
function js_preencheinscricao(chave,chave1,chave2){
  ...
  db_iframe_issbase.hide();
	js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&inscr='+chave,'Pesquisa',true);
}
...
function js_preencheinscricao2(chave,erro,chave2,chave3){
  ...
  document.form1.z01_nome.value = chave;
	if(erro==true){
		...
		js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&inscr='+document.form1.q02_inscr.value,'Pesquisa',true);
	}
  db_iframe_issbase.hide();
}
...
function js_preenchematriculas(chave,chave1,chave2){
  ...
  db_iframe_iptubase.hide();
	js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&matric='+chave,'Pesquisa',true);
}
  ...
  document.form1.z01_numcgm.value = chave2;
	...
	if(erro==true){
		...
		document.form1.z01_numcgm.value = "";
			...
			js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&matric='+document.form1.j01_matric.value,'Pesquisa',true);
	}
...
//  if(mostra==true){
//     js_OpenJanelaIframe('','db_iframe_proc','func_protprocessoalt.php?funcao_js=parent.js_mostraproc1|p58_codproc|p58_numcgm|z01_nome|p58_numero','Pesquisa',true,'15');
//   }else{
//     if(document.form1.p58_numero.value != '') {
//         js_OpenJanelaIframe('','db_iframe_proc','func_protprocessoalt.php?pesquisa_chave='+document.form1.p58_numero.value+'&funcao_js=parent.js_mostraproc&chave_p58_numero=1','Pesquisa',false);
//     }
//   }
// }
function js_mostracodproc(erro){
  // if(erro==true){ 
  //   document.form1.p58_codproc.focus(); 
  //   document.form1.p58_numero.value = ''; 
  // }else{
    var processo = document.form1.p58_numero.value; 
    js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&processo='+processo,'Pesquisa',true);
  // }   
}
function js_mostraproc1(chave1,n,z,chave2){  
  ...
  document.form1.p58_numero.value  = chave2;
  db_iframe_proc.hide();
	js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome&processo='+chave1,'Pesquisa',true);
}

function js_pesquisay108_procfiscal(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?funcao_js=parent.js_mostraprocfiscal1|y100_sequencial|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.y100_sequencial.value != ''){ 
        js_OpenJanelaIframe('','db_iframe_procfiscal','func_fis_procfiscal_consulta.php?pesquisa_chave='+document.form1.y100_sequencial.value+'&funcao_js=parent.js_mostraprocfiscal','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_mostraprocfiscal(chave,erro){
  ...
  if(erro==true){ 
    ...
    document.form1.y100_sequencial.value = ''; 
		...
		location.href='fis2_fis_conprocfiscal002.php?procfiscal='+document.form1.y100_sequencial.value;
	}
}
function js_mostraprocfiscal1(chave1,chave2){
  ...
  db_iframe_procfiscal.hide();
	location.href='fis2_fis_conprocfiscal002.php?procfiscal='+chave1;
}
