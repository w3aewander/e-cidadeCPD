...
class cl_prontuarios
{
   // cria variaveis de erro 
    ...
    public $sd24_i_codigo = 0; 
    public $sd24_i_ano = 0; 
    public $sd24_i_mes = 0; 
    public $sd24_i_seq = 0; 
    public $sd24_i_unidade = 0; 
    public $sd24_i_numcgs = 0; 
    public $sd24_v_motivo = null; 
    public $sd24_d_cadastro_dia = null; 
    public $sd24_d_cadastro_mes = null; 
    public $sd24_d_cadastro_ano = null; 
    public $sd24_d_cadastro = null; 
    public $sd24_c_cadastro = null; 
    public $sd24_v_pressao = null; 
    public $sd24_f_peso = 0; 
    public $sd24_f_temperatura = 0; 
    public $sd24_i_profissional = 0; 
    public $sd24_t_diagnostico = null; 
    public $sd24_i_siasih = 0; 
    public $sd24_c_digitada = null; 
    public $sd24_i_login = 0; 
    public $sd24_i_motivo = 0; 
    public $sd24_i_tipo = 0; 
    public $sd24_i_acaoprog = 0; 
    public $sd24_setorambulatorial = 0; 
    public $sd24_idadegestacional = 0; 
    public $sd24_dum_dia = null; 
    public $sd24_dum_mes = null; 
    public $sd24_dum_ano = null; 
    public $sd24_dum = null; 
    public $sd24_unidadeencaminhadora = null;
   // cria propriedade com as variaveis do arquivo 
    public $campos = "
                 ...
                 sd24_idadegestacional = int4 = Idade Gestacional (Semanas) 
                 sd24_dum = date = DUM 
                 sd24_unidadeencaminhadora = int4 = Unidade Origem 
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
     if($exclusao==false){
       ...
       $this->sd24_idadegestacional = ($this->sd24_idadegestacional == ""?@$GLOBALS["HTTP_POST_VARS"]["sd24_idadegestacional"]:$this->sd24_idadegestacional);
       $this->sd24_dum = ($this->sd24_dum == ""?@$GLOBALS["HTTP_POST_VARS"]["sd24_dum"]:$this->sd24_dum);
       $this->sd24_unidadeencaminhadora = ($this->sd24_unidadeencaminhadora == ""?@$GLOBALS["HTTP_POST_VARS"]["sd24_unidadeencaminhadora"]:$this->sd24_unidadeencaminhadora);
     }else{
       $this->sd24_i_codigo = ($this->sd24_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd24_i_codigo"]:$this->sd24_i_codigo);
     }
   }

    public function incluir($sd24_i_codigo)
    {
      $this->atualizacampos();
     ...
     if($this->sd24_idadegestacional == null ){
      $this->sd24_idadegestacional = "null";
    }
    if($this->sd24_dum == null ){
      $this->sd24_dum = "null";
    }
     if($this->sd24_unidadeencaminhadora == null ){ 
       $this->sd24_unidadeencaminhadora = "null";
     }
     ...
     if(($this->sd24_i_codigo == null) || ($this->sd24_i_codigo == "") ){ 
       $this->erro_sql = " Campo sd24_i_codigo não declarado.";
     ...
     $sql = "insert into prontuarios(
                                      ...
                                      ,sd24_idadegestacional
                                      ,sd24_dum
                                      ,sd24_unidadeencaminhadora
                       )
                values (
                                $this->sd24_i_codigo
                               ,$this->sd24_i_ano
                               ...
                               ,$this->sd24_idadegestacional
                               ,$this->sd24_dum
                               ,$this->sd24_unidadeencaminhadora
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Prontuários ($this->sd24_i_codigo) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,1010134,1011890,'','".AddSlashes(pg_result($resaco,0,'sd24_idadegestacional'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010134,1011892,'','".AddSlashes(pg_result($resaco,0,'sd24_dum'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010134,1015662,'','".AddSlashes(pg_result($resaco,0,'sd24_unidadeencaminhadora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
    ...
    public function alterar($sd24_i_codigo=null)
    {
     ...
     if($this->sd24_idadegestacional != "" || isset($GLOBALS["HTTP_POST_VARS"]["sd24_idadegestacional"])){
      if($this->sd24_idadegestacional != ""){
        $sql  .= $virgula." sd24_idadegestacional = $this->sd24_idadegestacional";
      }else{
        $sql  .= $virgula." sd24_idadegestacional = null";
      }
     }
     if($this->sd24_dum != "" || isset($GLOBALS["HTTP_POST_VARS"]["sd24_dum"])){
      if($this->sd24_dum != "" && $this->sd24_dum != 'null'){
        $sql  .= $virgula." sd24_dum = '$this->sd24_dum'";
      }else{
        $sql  .= $virgula." sd24_dum = null";
      }
     }
     if(trim($this->sd24_unidadeencaminhadora)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd24_unidadeencaminhadora"])){ 
        if(trim($this->sd24_unidadeencaminhadora)=="" && isset($GLOBALS["HTTP_POST_VARS"]["sd24_unidadeencaminhadora"])){ 
           $this->sd24_unidadeencaminhadora = "null" ; 
        } 
       $sql  .= $virgula." sd24_unidadeencaminhadora = $this->sd24_unidadeencaminhadora ";
       $virgula = ",";
     }
     $sql .= " where ";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd24_idadegestacional"]) || $this->sd24_idadegestacional != "")
             $resac = db_query("insert into db_acount values($acount,1010134,1011890,'".AddSlashes(pg_result($resaco,$conresaco,'sd24_idadegestacional'))."','$this->sd24_idadegestacional',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd24_dum"]) || $this->sd24_dum != "")
             $resac = db_query("insert into db_acount values($acount,1010134,1011892,'".AddSlashes(pg_result($resaco,$conresaco,'sd24_dum'))."','$this->sd24_dum',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["sd24_unidadeencaminhadora"]) || $this->sd24_unidadeencaminhadora != "")
             $resac = db_query("insert into db_acount values($acount,1010134,1015662,'".AddSlashes(pg_result($resaco,$conresaco,'sd24_unidadeencaminhadora'))."','$this->sd24_unidadeencaminhadora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Prontuários não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd24_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Prontuários não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd24_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function excluir($sd24_i_codigo=null, $dbwhere = null)
    {
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,1010134,1011890,'','".AddSlashes(pg_result($resaco,$iresaco,'sd24_idadegestacional'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010134,1011892,'','".AddSlashes(pg_result($resaco,$iresaco,'sd24_dum'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010134,1015662,'','".AddSlashes(pg_result($resaco,$iresaco,'sd24_unidadeencaminhadora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Prontuários não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Prontuários não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$sd24_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
...
//     $sql .= "      left join unidades  as a on   a.sd02_i_codigo = unidademedicos.sd04_i_unidade";
  ...
  */
  function sql_query_faas_profissional($sd24_i_codigo = null, $sd04_i_medico, $sd04_i_unidade, $campos = "*",
   ...
   // funcao do sql
public function sql_query_prontuarios( $sd24_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
 $sql = "select ";
 if($campos != "*" ){
    $campos_sql = explode("#",$campos);
    $virgula = "";
...
public function sql_query_cgs($sd24_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
  $sql = "select "; 
  if($campos != "*" ){
     $campos_sql = explode("#",$campos);
     $virgula = "";
  ...
  return $sql;
   ...
   public function sql_query_faa($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '') {
