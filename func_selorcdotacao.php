...
?>
  <tr>
    <td>
        <img src="imagens/alinha.gif" width="15">
	<img src="imagens/alinha.gif" width="15">
      <input type="checkbox"  onclick="js_marcapai('pai_<?=$o41_unidade?>');" value="pai_<?=$o41_orgao?>_<?=$o41_unidade?>_<?=$o52_funcao?>" name="pai_<?=$o41_orgao?>_<?=$o41_unidade?>_<?=$o52_funcao?>" id="<?=$nivel=='3A'?'ultimo_'.$o52_funcao:'primeiro_'.$o52_funcao?>">&nbsp;&nbsp;<?=$o52_funcao?>&nbsp;&nbsp;-&nbsp;&nbsp;<?=$o52_descr?>

    <?php /* ?>
      <input type="checkbox"  onclick="js_marcapai('pai_<?=$o41_orgao?>_<?=$o41_unidade?>');" value="pai_<?=$o41_orgao?>_<?=$o41_unidade?>_<?=$o52_funcao?>" name="pai_<?=$o41_orgao?>_<?=$o41_unidade?>_<?=$o52_funcao?>" id="<?=$nivel=='3A'?'ultimo_'.$o52_funcao:'primeiro_'.$o52_funcao?>">&nbsp;&nbsp;<?=$o52_funcao?>&nbsp;&nbsp;-&nbsp;&nbsp;<?=$o52_descr?>
      <?php */ ?>
  </td>
  </tr>
  <?
