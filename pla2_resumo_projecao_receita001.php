...
<div class="container">
    <fieldset>
        <legend>Resumo da Projeção da Receita</legend>
...
<script>
    const rota = 'financeiro/planejamento/relatorios/resumo-projecao-receita';
    ...
    btnEmitir.addEventListener('click', () => {
        ...
        HttpClient.post(`${PHPSession.requestApi}/${rota}`, {body: formData}).then(response => {
            ...
            download.addFile(response.data.pdf, "Resumo da Projeção da receita - PDF");
            download.show();
        });
    });
