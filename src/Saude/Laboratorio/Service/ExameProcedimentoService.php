...
use ECidade\Saude\Laboratorio\Repository\ExameProcedimentoRepository;
...
class ExameProcedimentoService
{
    ...
    /**
     * Buscar procedimento do exame
     */
    public function buscarExameProcedimento($parametros)
    {
        return $this->repositorio->buscar("la68_labgrupoexame=".$parametros->grupoLaboratorio);
    }
}
