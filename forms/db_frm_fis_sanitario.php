...
<input name="novo" type="button" value="Novo Registro" onclick="parent.document.location.href='fis1_fis_sanitario001.php'" >
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_sanitario',
                      'func_fis_sanitario.php?lMostarTodos=true&funcao_js=parent.js_preenchepesquisa|y80_codsani',
                      'Pesquisa',true,0);
}

function js_confirmaCgm(iNumCgm) {

  var sRPC       = 'fis1_fis_sanitario.RPC.php';
...
function js_preenchepesquisa(chave){
  ...
  <?php
    if($db_opcao == 2 || $db_opcao == 22){
      echo " location.href = 'fis1_fis_sanitario002.php?chavepesquisa='+chave;";
    }elseif($db_opcao == 33 || $db_opcao == 3){
      echo " location.href = 'fis1_fis_sanitario003.php?chavepesquisa='+chave;";
    }
  ?>
}
<?php
