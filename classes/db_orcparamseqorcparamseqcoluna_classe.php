...
class cl_orcparamseqorcparamseqcoluna
{
    ...
    public $o116_sequencial = 0;
    public $o116_codseq = 0;
    public $o116_codparamrel = 0;
    public $o116_orcparamseqcoluna = 0;
    public $o116_ordem = 0;
    public $o116_periodo = 0;
    public $o116_formula = null;
    ...
    /**
     * cl_orcparamseqorcparamseqcoluna constructor.
     */
    ...
    public function incluir($o116_sequencial)
    {
        $this->atualizacampos();
        ...
        if (!empty($o116_sequencial)) {
            db_query("SELECT setval('orcparamseqorcparamseqcoluna_o116_sequencial_seq', (SELECT max(o116_sequencial) FROM orcparamseqorcparamseqcoluna))");
        }
        return true;
    }

    // funcao para alteracao
    public function alterar($o116_sequencial = null)
    {
        $this->atualizacampos();
            ...
            for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["o116_formula"]) || $this->o116_formula != "") {
                    $resac = db_query("insert into db_acount values($acount,2484,17724,'" . AddSlashes(pg_result(
                            ...
                            $conresaco,
                            'o116_formula'
                        )) . "','$this->o116_formula'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                }
            }
        }
        $result = db_query($sql);
    ...
    public function excluir($o116_sequencial = null, $dbwhere = null)
    {
    ...
    public function sql_queryValorManual($o116_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
        ...
        $sql .= "  inner join orcparamseqcoluna on o116_orcparamseqcoluna = o115_sequencial";
        $sql .= "  left join orcparamseqorcparamseqcolunavalor on o117_orcparamseqorcparamseqcoluna = o116_sequencial";
        $sql2 = "";
        if ($dbwhere == "") {
            if ($o116_sequencial != null) {
    ...
    // funcao do sql
    public function sql_query($o116_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    // funcao do sql
    public function sql_query_file($o116_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "", $group = null)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
     ...
     */
    public function alterar_where($o116_sequencial = null, $dbwhere = null)
    {
        $this->atualizacampos();
        $sql = " UPDATE orcparamseqorcparamseqcoluna SET ";
        $virgula = "";
