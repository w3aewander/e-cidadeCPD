            ...
            <form name='form1'>
                <center>
                    ...
                    if (isset ($e60_numemp) && $e60_numemp != "") {
                        ...
                        //fim
                        $sqlOrdem = $clpagordem->sql_query_pag(
                            null,
                        ...
                        $result02 = $clpagordem->sql_record($sqlOrdem);
				           ...
				           ";
                            ...
                            for ($e = 0; $e < $numrows02; $e++) {
					 			  ...
					 			  <td  class='bordas' align='right'>" . db_formatar($e50_data, "d") . "</td>";
                                    if (isset($e49_numcgm) && trim(@$e49_numcgm) != "") {
                                        if ($e49_numcgm != $z01_numcgm) {
                                            $res_cgm = $clcgm->sql_record($clcgm->sql_query_file($e49_numcgm,
                                                "z01_numcgm,z01_nome"));
                                            if ($clcgm->numrows > 0) {
                                ...
                                */
                                ...
                                echo "<td  class='bordas' align='right'>" . ($c53_tipo == "" ? "" : db_formatar($c70_valor,
                                        "f")) . "</td>
