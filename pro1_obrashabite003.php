...
if (isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"] == "Excluir") {
    ...
    $rsProt = $clobrashabiteprot->sql_record($clobrashabiteprot->sql_query(null, "*", "",
      " ob19_codhab = $chavepesquisa"));
    ...
    $rsProtoff = $clobrashabiteprotoff->sql_record($clobrashabiteprotoff->sql_query(null, "*", "",
      " ob22_codhab = $chavepesquisa"));
    ...
    if (isset($chavepesquisa)) {
        ...
        $db_botao = true;
        $nomePropri = $ob01_nomeobra;
        $p51_descr = $p58_requer;
