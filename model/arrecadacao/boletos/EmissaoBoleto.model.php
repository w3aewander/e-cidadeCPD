...
class EmissaoBoleto
{
    ...
    public function gerarRecibo()
    {
        ...
        $oGeracaoBoleto->set('geraTaxaExpediente', $this->geraTaxaExpediente);

        $oGeracaoBoleto->setHistorico($this->sHistorico);
        ...
        return $oGeracaoBoleto->getConvenio();
    }
     ...
     * @throws Exception
     */
    public function imprimir($oConvenio)
    {
        /**
        ...
        $oImpressao->setConvenio($oConvenio);
