...
<body>
<form  name="form1" style="width: 40%; text-align: center; margin: auto;" onsubmit="salvar(event)">
    <fieldset style="width: 100%; margin-top: 5%;">
        ...
        <table style="width: 100%; margin-top: 10px;">
            ...
            <tr>
                <td>
                    <label for="notificar_por_departamento">
                        <strong>Permitir o envio de notificações por departamento:</strong>
                    </label>
                </td>
                <td>
                    <select name="notificar_por_departamento" id="notificar_por_departamento"
                            onchange="validarPermitirNotificarDepartamento()">
                        <option value="0">Não</option>
                        <option value="1">Sim</option>
                    </select>
                </td>
                    ...
                    <fieldset style="margin-top: 10px;">
                        ...
                        <table style="width: 100%; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="assunto" id="assunto" style="width: 100%;"
                            ...
                            <tr>
                                <td>
                                    <label for="dias_prazo_movimentacao">
                                        <strong>Tipo de Prazo : </strong>
                                    </label>
                                </td>
                                <td>
                                    <select  onchange="validarTipoPrazo()" id="tipoprazo"  name="tipoprazo">
                                        <option value="1"> Utiliza prazo fixo</option>
                                        <option value="2"> Utiliza prazo de acordo com andamento padrão</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="usuarioremetente">
                                        <?php db_ancora("Usuário Remetente:","js_pesquisa_remetente(true);",empty($db_opcao) ? 1 : $db_opcao);?>
                                    </label>
                                </td>
                                <td>
                                    <input  onchange="validarRemetente()"  type="text" id="usuarioremetente" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
...
<script>
    ...
    var permitirNotificarDepartamento = document.getElementById('notificar_por_departamento');
    var assunto = document.getElementById('assunto');
    var mensagem = document.getElementById('mensagem');
    var diasPrazoMovimentacao = document.getElementById('dias_prazo_movimentacao');
    var tipoprazo = document.getElementById('tipoprazo');
    var usuarioremetente = document.getElementById('usuarioremetente');
    ...
    function atualizarAtributos() {
        ...
        permitirNotificarDepartamento.onchange();
        assunto.onchange();
        mensagem.onchange();
        diasPrazoMovimentacao.onchange();
        tipoprazo.onchange();
        usuarioremetente.onchange();
    ...
    function atualizarObrigatoriedade() {
        ...
        usuarioremetente.required = obrigatorio;
    }
    ...
    function buscar() {
        ...
        oReq.onload = function () {
            ...
            if (dados.p101_usuarioremetente === undefined) {
                dados.p101_usuarioremetente = '';
            }
            ...
            permitirNotificarDepartamento.value = dados.p101_permitirnotificardepartamento == 'f' ? 0 : 1;
            assunto.value = dados.p101_assunto;
            mensagem.value = dados.p101_mensagem;
            diasPrazoMovimentacao.value = dados.p101_diasprazo;
            tipoprazo.value  =  dados.p101_tipoprazo;
            usuarioremetente.value =  dados.p101_usuarioremetente;
            atualizarAtributos();
    ...
    function salvar(event) {
        ...
        requisicao.mensageria.usuarioremetente = usuarioremetente.value;
    ...
    function validarPermitirNotificarDepartamento() {
        var valor = permitirNotificarDepartamento.value;
        var mensageria = requisicao.mensageria;

        mensageria.permitirNotificarDepartamento = valor;
        requisicao.mensageria = mensageria;
    }

    function validarRemetente() {
        var valor = usuarioremetente.value;
        var mensageria = requisicao.mensageria;

        mensageria.usuarioremetente = valor;
        requisicao.mensageria = mensageria;
    }
    ...
    function validarTipoPrazo() {
        var valor = tipoprazo.value;
        var mensageria = requisicao.mensageria;

        mensageria.tipoprazo = valor;
        requisicao.mensageria = mensageria;
    }
    ...
    function js_pesquisa_remetente(mostra) {
        if (mostra==true) {
            js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_usuarioremetente','func_db_usuariosalt.php?chave_usuarioativo=1&funcao_js=parent.js_mostrarremetente|id_usuario','Pesquisa',true);
        } else{

            if (document.form1.db99_cadenderpais.value != '') {
                js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_usuarioremetente','func_db_usuariosalt.php?chave_usuarioativo=1&pesquisa_chave='+document.form1.usuarioremetente.value+'&funcao_js=parent.js_mostraremetente','Pesquisa',false);
            } else{
    ...
    function js_mostrarremetente(chave,erro) {
        document.form1.usuarioremetente.value = chave;
        db_iframe_usuarioremetente.hide();
