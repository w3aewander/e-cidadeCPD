...
class MarcacaoPonto
{
    ...
    public function getCollectionMarcacaoPonto(DiaTrabalho $oDiaTrabalho)
    {
         ...
         * Essa pesquisa, retornará os registros do dia 28, pois a query pesquisa 2 dias devido as jornadas que começam
        ...
        return MarcacoesPontoCollection::getCollectionMarcacoesFromArray($aMarcacoes, $oDiaTrabalho);
    }
    ...
    private function getMarcacoesNaData(DiaTrabalho $oDiaTrabalho)
    {
        ...
        $sSqlMarcacao = $oDaoMarcacao->sql_query(
            null,
            implode(' , ', $aCampos),
            'rh197_data, rh198_ordem',
            $sWhereMarcacao
        );
