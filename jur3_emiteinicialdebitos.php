...
if ( $oGet->sTipoConsulta == "debitos" ) {
  ...
  $sSql  .= "  from (                                                                             \n";
  $sSql  .= "        select arrecad.k00_numpre,                                                   \n";
  ...
  $sSql  .= "         union                                                                       \n";
  $sSql  .= "                                                                                     \n";
  $sSql  .= "        select arrepaga.k00_numpre,                                                  \n";
  $sSql  .= "               arrepaga.k00_numpar,                                                  \n";
  $sSql  .= "               arrepaga.k00_receit,                                                  \n";
  $sSql  .= "               arrepaga.k00_valor,                                                   \n";
  $sSql  .= "               arrepaga.k00_dtvenc,                                                  \n";
  $sSql  .= "               'Pagamentos de Parcelamento na Certidão'         as debito_origem     \n";
  $sSql  .= "          from certid                                                                \n";
  $sSql  .= "         inner join certter    on certter.v14_certid    = certid.v13_certid          \n";
  $sSql  .= "         inner join termo      on termo.v07_parcel      = certter.v14_parcel         \n";
  $sSql  .= "         inner join arrepaga    on arrepaga.k00_numpre    = termo.v07_numpre         \n";
  $sSql  .= "         where certid.v13_certid = {$iCertidao}                                      \n";
  $sSql  .= "                                                                                     \n";
  $sSql  .= "         union                                                                       \n";
  $sSql  .= "                                                                                     \n";
  ...
  $sSql  .= "               arrepaga.k00_valor,                                                   \n";
  $sSql  .= "               arrepaga.k00_dtvenc,                                                  \n";
  $sSql  .= "               'Pagamentos de Dívida na Certidão'               as debito_origem     \n";
  $sSql  .= "          from certid                                                                \n";
  $sSql  .= "               inner join certdiv    on certdiv.v14_certid    = certid.v13_certid    \n";
  $sSql  .= "               inner join divida     on divida.v01_coddiv     = certdiv.v14_coddiv   \n";
  ...
  $sSql  .= "               arrepaga.k00_valor,                                                   \n";
  $sSql  .= "               arrepaga.k00_dtvenc,                                                  \n";
  $sSql  .= "               'Pagamento de Parcelamento Anulado da Certidão' as debito_origem      \n";
  $sSql  .= "          from acertid                                                               \n";
  $sSql  .= "               inner join acertter   on acertter.v14_certid   = acertid.v15_certid   \n";
  $sSql  .= "               inner join termo      on termo.v07_parcel      = acertter.v14_parcel  \n";
  $sSql  .= "               inner join arrepaga    on arrepaga.k00_numpre    = termo.v07_numpre   \n";
...
if ( $oGet->sTipoConsulta == "desmembramento" ) {
    ...
    $sSql = "
        SELECT
             ...
             v37_data,
             db_usuarios.login
         FROM desmembramentoinicialhistorico
         INNER JOIN db_usuarios ON id_usuario = v37_usuario
         WHERE v37_cda = {$iCertidao}
    ";
}
