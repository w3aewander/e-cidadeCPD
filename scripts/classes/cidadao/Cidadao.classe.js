...
DBViewCidadao.Cidadao.prototype.montaJanela = function () {
  ...
  $('oInputNomeCidadao').observe("keyup", function () {
    ...
    let sNome = $('oInputNomeCidadao').value
    // sNome = sNome.replace(/[ÀÁÂÃÄÅ]/g, "A");
    // sNome = sNome.replace(/[àáâãäå]/g, "a");
    // sNome = sNome.replace(/[ÈÉÊË]/g, "E");
    sNome = sNome.replace(/[']/g, "");
    sNome.replace(/[^a-z0-9]/gi, '');
    $('oInputNomeCidadao').value = sNome
  });
...
DBViewCidadao.Cidadao.prototype.validacoes = function () {
  ...
  // Verifica se o CPF é válido, se estiver preenchido
