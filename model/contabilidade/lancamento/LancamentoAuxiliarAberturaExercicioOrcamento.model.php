...
class LancamentoAuxiliarAberturaExercicioOrcamento extends LancamentoAuxiliarBase implements ILancamentoAuxiliar
{
    ...
    protected function vincularReceita()
    {
        ...
        $daoConlancamREceita = new cl_conlancamrec();
        $daoConlancamREceita->c74_codlan = $this->iCodigoLancamento;
        $daoConlancamREceita->c74_anousu = $this->receita->getAno();
        $daoConlancamREceita->c74_codrec = $this->receita->getCodigo();
        $daoConlancamREceita->c74_data = $this->dtLancamento;
        $daoConlancamREceita->incluir($this->iCodigoLancamento);
        if ($daoConlancamREceita->erro_status == 0) {
            throw new \Exception('Erro ao vincular receita ' . $this->receita->getCodigo() . ' ao lançamento.');
        }
    }
    ...
    public function executaLancamentoAuxiliar($iCodigoLancamento, $dtLancamento)
    {
        ...
        $this->vincularReceita();
        $this->vinculaLancamentoDotacao();
    ...
    public function salvarVinculoAberturaExercicioOrcamento()
    {
        ...
        $oDaoConLancamAberturaExercicio = new cl_conlancamaberturaexercicioorcamento;
    ...
    public function setEstorno($estorno = false)
    {
        $this->lEstorno = $estorno;
    }
