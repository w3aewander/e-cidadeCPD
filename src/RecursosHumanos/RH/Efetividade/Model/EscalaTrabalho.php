...
class EscalaTrabalho {
    ...
    /**
     * @var bool|ExtraAutomaticaFeriado
     */
    private $lExtraAutomaticaFeriado = false;
    ...
    public function isRevezamento()
    {
        return $this->getRevezamento();
    }
    ...
    {
    if($lRevezamento === 'f' || $lRevezamento === 'false') {
      $lRevezamento = false;
    }

    if($lRevezamento === 't' || $lRevezamento === 'true') {
      $lRevezamento = true;
    }

    $this->lRevezamento = (bool)$lRevezamento;
    }

    /**
     * @param bool|ExtraAutomaticaFeriado $lExtraAutomaticaFeriado
     *
     * @return self
     */
    ...
    /**
     * @return bool|ExtraAutomaticaFeriado
     */
    public function isExtraAutomaticaFeriado()
    {
        return $this->lExtraAutomaticaFeriado;
    }
