        ...
        for ($i = 0; $i < $iTotalLinhas; $i++) {
            ...
            switch ($oDecreto->tipo_credito) {
                ...
                case  '1014':
                    ...
                    $iTipo = '1';
                    $iOrigem = '5';
                    $tipoAlteracaoOrcamentaria = 6;
                    break;
                case '1015':

                    $iTipo = '1';
                    $iOrigem = '5';
                    $tipoAlteracaoOrcamentaria = 4;
                    break;
                case '1016':

                    $iTipo = '1';
                    $iOrigem = '5';
                    $tipoAlteracaoOrcamentaria = 5;
                    break;
            }
            ...
            $oDecretoRetorno->decTipoCreditoAdicional = $tipoAlteracaoOrcamentaria;
            $oDecretoRetorno->decOrigemRecurso = $iOrigem;
            $oDecretoRetorno->decTipoAlteracaoOrcamentaria = 1;
            /**
