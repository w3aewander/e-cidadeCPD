...
class M13237FixConsistenciaAtributosPadrao extends PostgresMigration
{
...
"consistencia": "
       select conta,
       array_to_string(atributos, \',\', \'\') as atributos,
       array_to_string(padrao, \',\', \'\')    as padrao
      ...
      where c60_anousu = fc_getsession(\'DB_anousu\')::integer
        and exists(select 1
                   ...
                   where c61_codcon = c60_codcon
                     and c61_anousu = c60_anousu)) as x
where ((atributos @> padrao) is false or atributos is null)
order by conta;
",
