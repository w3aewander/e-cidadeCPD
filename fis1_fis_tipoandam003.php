...
if(isset($excluir)){
  ...
  $cldeptosparametrosandamento->excluir(null, 'parametrosandamento='.$sequencial);
  $clusuariosparametrosandamento->excluir(null, 'parametrosandamento='.$sequencial);
  $clparametrosandamento->excluir($sequencial);
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?php 
	include(modification("forms/db_frm_fis_tipoandam.php"));
	?>
    </center>
	</td>
  </tr>
