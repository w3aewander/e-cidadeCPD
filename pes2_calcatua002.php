...
from rhpessoal
     ...
     inner join (select r14_regist,
                        sum(case when r14_pd not in (3,4,5) and r14_pd = 1 then r14_valor else 0 end) as prov,
			                  sum(case when r14_pd not in (3,4,5) and r14_pd = 2 then r14_valor else 0 end) as desco,
