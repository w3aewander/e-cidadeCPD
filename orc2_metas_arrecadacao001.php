...
<script type="text/javascript">
    ...
    jQuery(document).ready(function (jQuery) {
        ...
        const linhaTipoPlano = document.getElementById('linhaTipoPlano');
        const cboAgrupar = document.getElementById('agruparPor');
        const cboEmentario = document.getElementById('ementario');
        ...
        const routs = {
            ...
            relatorio: 'financeiro/orcamento/relatorios/meta-arrecadacao'
        };
        ...
        cboAgrupar.addEventListener('change', function () {
            linhaTipoPlano.style.display = '';
            if (cboAgrupar.value !== 'receita') {
                linhaTipoPlano.style.display = 'none';
                cboEmentario.value = 'ecidade';
            }
        })
        ...
        btnEmitir.addEventListener('click', () => {
            ...
            HttpClient.post(`${PHPSession.requestApi}/${routs.relatorio}`, {body: formData}).then(response => {
                ...
                download.addFile(response.data.pdf, "Acompanhamento das Metas de Arrecadação da Receita - PDF");
                download.addFile(response.data.csv, "Acompanhamento das Metas de Arrecadação da Receita - CSV");
                download.show();
            });
        });
    });
