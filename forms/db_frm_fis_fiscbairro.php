...
function js_pesquisay32_codnoti(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y32_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
