...
}elseif(db_getsession("DB_instit") == 1){  
  $fontesnovas = array(
    200 => 1500,
    23 => 1540,
    28 => 1550,
...
if (substr($nivel, 1, 1) == 'A') {
  ...
  for ($i = 0; $i < pg_numrows($result); $i++) {
    ...
    //$o58_orgao = array_search($o58_orgao, $fontesnovas);
    ...
    if ($o58_codigo > 0) {
      ...
      if($fontesnovas[$o58_codigo]){
        $o58_codigo = $fontesnovas[$o58_codigo];
      }
      


      /*if($fontesnovas2[$o58_codigo]){
        if($o58_codigo == 200){
          if($instituicao == 1){
            $o58_codigo = 1500;
          }else{
          ...
          $o58_codigo = $fontesnovas2[$o58_codigo];
        }
      }*/
      ...
      /*if($o58_codigo == 160){
        $o58_codigo = 1749;
      }elseif($o58_codigo == 220){
        $o58_codigo = 1749;
      }else{
        $o58_codigo = array_search($o58_codigo, $fontesnovas);
      }
      //$o58_codigo = array_search($o58_codigo, $fontesnovas);
      */
  ...
  $yy = pg_fetch_all($result);

  /*
  foreach ($yy as $dado) {
    var_dump($dado["o15_descr"]); echo "<br>"; var_dump($dado["o58_codigo"]); echo "<br>";
  }
  testa($yy);
  die("Confere");
  */
  ...
  for ($iLinha = 0; $iLinha < pg_numrows($result); $iLinha++) {
    ...
    /*if($o15_descr == "VR PARKING"){
      var_dump($o58_codigo);
      die("Confere VR Parking");
    }
    die("Entrou aqui?");*/
    //$o58_codigo = $fontesnovas2[$o58_codigo];
    /*if($fontesnovas2[$o58_codigo]){
