...
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\Factory\AnexoIII as FactoryRelatorio;
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\Factory\Layout\AnexoIII as FactoryLayout;
...
try {
    ...
    $dadosAnexoXII = FactoryRelatorio::getInstance($ano, $get->periodo);
    $dadosAnexoXII->setInstituicoes($codigoInstituicoes);

    $layoutAnexoXII = FactoryLayout::getInstance($ano);
    $layoutAnexoXII->setAnexo($dadosAnexoXII);
    $layoutAnexoXII->emitir();
