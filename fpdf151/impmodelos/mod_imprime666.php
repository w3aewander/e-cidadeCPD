...
if (isset($this->sCedenteBoleto) && trim($this->sCedenteBoleto) != '') {
    ...
    $this->objpdf->Text($x + 3, $y + 23, $this->prefeitura." ".db_formatar($this->cgcpref, 'cnpj')); // cedente
}
...
$this->objpdf->Text($x + 134, $y + 37, $this->valor_cobrado);//   nosso numero
...
if ($this->descr11_2 != "") {
    $this->objpdf->Text($x + 19, $y + 83,
      $this->munic . " / " . $this->ufcgm . " / CEP-" . $this->cep); // $this->munic);    // sacado 3
}
?>
