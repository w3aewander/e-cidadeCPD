...
<?php
  $iCampoCount = 0;
  # Seleciona todos os calendarios
              ...
              <td>
                <div style="height: 570px; overflow: auto;">
                  <table>
                    ...
                    <tr>
                      <td valign="top">
                        <input type="checkbox" id="campos<?php echo $iCampoCount++ ?>" name="campos" value="ed47_c_raca"
                               onclick="VerificaTamanho(45);"> Raça/Cor
                        <input type="hidden" name="largura" id="largura" value="15">
                        <input type="hidden" name="cabecalho" value="Raça/Cor"><br/>
                      </td>
                      <td>
                        15
                      </td>
                    ...
                    <tr>
                      <td valign="top">
                        <input type="checkbox" id="campos<?php echo $iCampoCount++ ?>" name="campos" value="registropai"
                               onclick="VerificaTamanho(46);"> Registrado em nome do pai
                        <input type="hidden" name="largura" id="largura" value="20">
                        <input type="hidden" name="cabecalho" value="Registro Pai"><br/>
                      </td>
                      <td>
                        20
                      </td>
