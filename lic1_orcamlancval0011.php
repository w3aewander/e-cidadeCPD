...
<head>
    ...
    <script>
      ...
      function js_verquant (nome, val, max, param) {
        ...
        if (erro > 0) {
          ...
          if (verpos == 1) {
            ...
            vltotDocument = vltot.toFixed(numdec);
            if (isPB) {
                vltotDocument = js_truncar(vltot,numdec);
            }
            eval('document.form1.valor_' + param + '.value=\'' + vltotDocument + '\'');
          } else if (verpos == 2) {
              vltot = new Number(valpos / val);
            vltotDocument = vltot.toFixed(numdec);
            if (isPB) {
            ...
            eval('document.form1.vlrun_' + param + '.value=\'' + vltotDocument + '\'');
          }
        }
        if (isPB) {
            valorTotalDocument = js_truncar(valortotal, 4);
      ...
      function js_calcvaltot (valor, param, nome) {
        if (!isNaN(valor)) {
          ...
          if (valor != '' && quant != '') {
            ...
            if (isPB) {
                  valortotal = new Number((quant * 10) * (js_truncar(valor,numdec)*10) / 100);
            }
          }
         ...
         valorDocument = valor.toFixed(numdec);
          if (isPB){
              valorTotalDocument = js_truncar(valortotal,numdec);
              valorDocument = js_truncar(valor,numdec);
          }
          eval('document.form1.valor_' + param + '.value=\'' + valorTotalDocument + '\'');
      ...
      function js_calcvalunit (valor, param, nome) {
        if (!isNaN(valor)) {
          ...
          if (valor != '' && quant != '') {
            valor = new Number(valor);
            if (isPB) {
                valor = new Number(js_truncar(valor,numdec));
            }
            quant = new Number(quant);
          ...
          if(isPB) {
            valorunitdocument = js_truncar(valorunit,numdec)
            valordocument = js_truncar(valor,numdec);
          }
      ...
      function js_somavalor () {
        ...
        document.form1.somavalor.value = somavalor.toFixed(numdec);
        if (isPB) {
            somavalor = somavalor.toFixed(4);
            document.form1.somavalor.value = js_truncar(somavalor,numdec);
        }
      }
    </script>
                    ...
                    <table border='1' cellspacing="0" cellpadding="0">
                        ...
                        if (isset($pc20_codorc) && trim($pc20_codorc) != '') {
                            ...
                            if (isset($l20_codigo) && trim($l20_codigo) != "") {
                                $res_liclicitemlote = $clliclicitemlote->sql_record($clliclicitemlote->sql_query_licitacao(
                                    null,
                                    "l04_liclicitem",
                                    null,
                            ...
                            $sSqlTipoEmpresa = $clpcorcamfornelic->sql_query($pc21_orcamforne,
                                "pc31_liclicitatipoempresa");
                            $rsTipoEmpresa = $clpcorcamfornelic->sql_record($sSqlTipoEmpresa);

                            if (!$rsTipoEmpresa) {
                                throw new Exception("Erro ao procurar o tipo de empresa do fornecedor");
                            }

                            $tipoEmpresa = db_utils::fieldsMemory($rsTipoEmpresa,0);
                                ...
                                for ($i = 0; $i < $numrows_itens; $i++) {
                                    ...
                                    if ($codprocant != $pc81_codproc) {
                                        ...
                                        <tr class='bordas'>
                                            ...
                                            <td nowrap class='bordas' align='center' width="105px"><b>Referência</b></td>
                                    ...
                                    if (isset($pc32_orcamitem) && trim($pc32_orcamitem) != "" && isset($pc32_orcamforne) && trim($pc32_orcamitem) != "" && $pc32_orcamitem == $pc22_orcamitem && $pc32_orcamforne == $pc21_orcamforne) {
                                        ...
                                        if ($reserva == 't') {
                                            ...
                                            if ($tipoEmpresa->pc31_liclicitatipoempresa == 1) {
                                                $disabled = 'disabled';
                                            }
                                        }
                                    }
                                    ...
                                    ?>
                                    <tr class='<?= $class ?>' width='100%'>
                                        <td align='center' class='<?= $class ?>' width='8%'>
                                            <input name='chk_<?= $pc22_orcamitem ?>' type='checkbox'
                                                   value='<?= $check ?>'
                                                   onClick='js_desclassifica('<?= $descr_lote ?>')' <?= $disabled ?>>
                                        </td>
                                        <td align='left' class='<?= $class ?>' width='8%'>
                                            <?= $pc81_codprocitem ?>
                                        </td>
                                        ...
                                        <td align='center'  class='<?= $class ?>' width='15%'><?=$m61_descr?>
                                            <?php
                                            if ($m61_usaquant=="t") {
                                        ...
                                        if ($l20_usaregistropreco == 't') {
                                            $sSqlQuantidades = $clpcorcamitem->sql_query_pcmaterregistro(
                                                $pc22_orcamitem,
                                        ...
                                        <?php if ($lLicitacaoTipoObrasServicos) { ?>
                                            ...
                                            <td align='center' class='<?= $class ?> bordas_corp'>
                                                ...
                                                db_input(
                                                    "encargossociais_$pc22_orcamitem",
                                                    10,
                                                    4,
                                                    true,
                                                    'text',
