...
<body class="body-default">
  <div class="container">
    ...
    <fieldset>
      <legend>Cadastro em Conta por Banco e Agência</legend>
      <table>
        <tr>
  ...
  function js_verifica(){
    var anoi = new Number(document.form1.datai_ano.value);
        ...
        if(anoi.valueOf() > anof.valueOf()){
           ...
           return false;
        } else if(document.form1.d63_banco.value == ''){
           alert('Codigo do Banco e obrigatorio. Verifique !.');
           return false;
        } else if(document.form1.k15_codage.value == ''){
          ...
          var oParametros = {
            ...
            new EmissaoRelatorio("arr2_reldebcontapedidobcoagencia002.php", oParametros).open();
        }
