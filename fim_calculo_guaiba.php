...
from
(
select r14_regist as regist, ((B078)/100*30) - B043 as margem
from
(
...
where r14_anousu = $anousu and r14_instit = $DB_instit and r14_mesusu = $mesusu and r14_rubric = 'R803' and r14_regist = margem.regist
";
//echo $sql_margem;
$res_margem = pg_query($sql_margem) or die($sql_margem);

 $sql_margem_neg = "delete from gerfsal where r14_anousu = $anousu and r14_mesusu = $mesusu and r14_rubric = 'R803' and (r14_valor <= 0 or r14_valor is null) and r14_instit = $DB_instit ";
...
$sql_geral = ("
         delete from gerfsal
            where r14_anousu = $anousu
              ...
              and r14_regist in 
                  ( select r14_regist 
                    from 
                       ( select r14_regist, 
                                sum(case when r14_pd = 1 and r14_rubric not in ('R928', 'R918') then r14_valor else 0 end) as provento, 
                    ...
                    where desconto::numeric <= provento::numeric
                      and r14_regist in (select r14_regist 
                                         from gerfsal 
                                         where r14_anousu = $anousu 
                                           and r14_mesusu = $mesusu 
                                           and r14_rubric = 'R928'
          ...
          ");
  $res_geral = pg_query($sql_geral) or die($sql_geral);
