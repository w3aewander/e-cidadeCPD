    ...
    <form name="form1" method="post" action="">
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td title="<?= @$Ts103_usuarioapi ?>">
                        <?php
                        db_ancora(@$Ls103_usuarioapi, "js_pesquisa_usuario();", $db_opcao);
                        ?>
                    </td>
                    <td>
                        <?php
                        db_input('s103_usuarioapi', 10, $Is103_usuarioapi, true, 'hidden');
                        db_input('login', 10, '', true);
                        ?>
                    </td>
                </tr>
            </table>
...
<script>
    ...
    function js_pesquisa_usuario() {
        js_OpenJanelaIframe(
            'CurrentWindow.corpo.iframe_a1',
            'db_iframe_db_usuarios',
            'func_db_usuarios.php?funcao_js=parent.js_mostra_usuario|id_usuario|login',
            'Pesquisa Usuários',
            true
        );
    }

    function js_mostra_usuario(id_usuario, login) {
        document.form1.s103_usuarioapi.value = id_usuario;
