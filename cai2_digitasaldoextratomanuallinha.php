...
//db_input('k86_bancohistmov',10,$Ik86_bancohistmov,true,'text',$db_opcao," onchange='js_pesquisak86_bancohistmov(false);'")
      $arraytipo = array('1'=>'Extrato Bancário','2'=>'Implantação/Tesouraria'); 
...
$k86_historico = " ";
db_input('k86_historico',64,$Ik86_historico,true,'hidden',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
 ...
 <table>
  <tr>
    ...
    <?
	 ...
	 $cliframe_alterar_excluir->sql           = $clextratolinha->sql_query_file(null,"*","extratolinha.k86_data, extratolinha.k86_sequencial"," k86_contabancaria = $conta and ( k86_data = '$sDtSaldoFinal' or k86_data > (select k68_data from concilia where k68_contabancaria = $conta and  k68_data < '$sDtSaldoFinal' order by k68_data desc limit 1) ) and k86_data <= '$sDtSaldoFinal'  ");
