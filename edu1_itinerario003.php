...
if(isset($excluir)){
  db_inicio_transacao();
  $db_opcao = 3;
  $clitinerarioescola->excluir("","ed221_i_itinerario= $ed218_i_codigo");
    $clitinerarioescolaproc->excluir("","ed222_i_itinerario= $ed218_i_codigo");
      $clitinerario->excluir($ed218_i_codigo);
  db_fim_transacao();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
   ...
   <br>
    <fieldset style="width:95%"><legend><b>Exclusão de itinerário</b></legend>
     <center>
