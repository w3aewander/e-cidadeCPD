...
<script>
var sUrlRC = 'com4_solicitacaoComprasRegistroPreco.RPC.extension.php';
...
function js_preenche(solicita,reload) {
  ...
  var oAjax = new Ajax.Request('com4_solicitacaoComprasRegistroPreco.RPC.extension.php',
                               {method: 'post',
                                parameters: 'json='+Object.toJSON(oParam),
...
if ($lBtnShowBtnConsulta) {
  ...
  echo "parent.iframe_itens.location.href='com4_solicitacompilacaoitens.extension.php';\n";
  echo "js_pesquisar();\n";
