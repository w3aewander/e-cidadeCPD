...
$sCampos  = "e50_codord, e50_codord, e69_dtnota, e69_dtrecebe";
//$sCampos .= ", m72_codordem,e03_numeroprocesso";
$sWhere  = "";
if(trim($oGet->e50_codord)!=''){
	$sWhere .= "e50_codord = ".$oGet->e50_codord;
}

$sSqlNota =  $clpagordem->sql_query_notaliquidacao(null,$sCampos,null,$sWhere);
//die($sSqlNota);

$rsNota = $clpagordem->sql_record($sSqlNota);
...
<table width="100%" style="margin-top: 20px;" align="center">
  ...
  <fieldset><legend><b>Dados da Nota</b></legend>
    ...
    <?
		...
		$oTabDetalhes->add("detalhamento","Detalhamento","func_empconsultanf001.php?e50_codord={$e50_codord}&exec=detalhamento");
		$oTabDetalhes->add("lancamentos" ,"Lançamentos" ,"func_conlancam002.php?e50_codord={$e50_codord}&chavepesquisa='nota'");
		$oTabDetalhes->add("retencoes"   ,"Retenções"   ,"func_empconsultanf001.php?e50_codord={$e50_codord}&exec=retencoes");
		$oTabDetalhes->add("itens"       ,"Ítens"       ,"func_empconsultanf001.php?e50_codord={$e50_codord}&exec=itens");
		$oTabDetalhes->add("pit"         ,"PIT"         ,"func_empconsultanf001.php?e50_codord={$e50_codord}&exec=pit");
		$oTabDetalhes->show();
    ?>
