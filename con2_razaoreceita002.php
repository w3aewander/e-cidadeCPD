...
$sql_analitico = "
    select o70_codrec,
      ...
      inner join orcfontes on o57_codfon = orcreceita.o70_codfon
                          and o57_anousu = orcreceita.o70_anousu
...
if ($quebra == "g" and $tipo == "a") {
    ...
    for ($x = 0; $x < $rows; $x++) {
        ...
        if ($repete != $o70_codrec) {
            ...
            if ($x > 1) {
                $sql_resumido = "
                    select c53_coddoc as coddoc, c53_descr as descr, sum(c70_valor) as total
                      from orcreceita
                      inner join orctiporec on orctiporec.o15_codigo = orcreceita.o70_codigo
        ...
        if ($x == ($rows - 1)) {
            ...
            $pdf->Ln(10);
            $sql_total = "
                select c53_coddoc,c53_descr,sum(c70_valor) as total
                 from orcreceita
                 inner join orctiporec on orctiporec.o15_codigo = orcreceita.o70_codigo
		         inner join conlancamrec on c74_codrec=o70_codrec and c74_anousu=o70_anousu
		         inner join conlancam on c70_codlan= conlancamrec.c74_codlan and c70_anousu=conlancamrec.c74_anousu
