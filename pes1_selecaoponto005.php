...
if(isset($oGet->chavepesquisa)){
 ...
 echo "
  <script>
    ...
    (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_selecaopontorubricas.location.href='pes1_selecaopontorubricas001.php?chavepesquisa=".@$r72_sequencial."';
  </script> 
  ";
