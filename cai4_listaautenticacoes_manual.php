...
<head>
  ...
  <script>
    ...
    function js_processaRequest(data,conta){
      ...
      var url       = 'cai4_carregadadosautent_manual.php';
    ...
    function js_loadTable(resposta){
      ...
      tabela = "  <table class=grid width='100%' id='tabelaAutent'> "+
               ...
               "      <td class='cabe' align='center' nowrap > <b> Arquivo      </b></td> "+
               ...
               "      <td class='cabe' align='center' nowrap > <b> CT Pagadora  </b></td> "+
      ...
      for (i = 0; i < objJ.length; i++) {
        ...
        "   <td nowrap id='arquivo"+i+"' align='center' > "+objJ[i].arquivo+"                                                                    </td> "+
        ...
        "   <td nowrap id='cheque"+i+"'  align='center' > "+objJ[i].ctPagadora+"                                                               </td> "+
        "   <td nowrap id='credor"+i+"'  align='left'   > "+objJ[i].credor.urlDecode()+"                                                         </td> "+
        "   <td nowrap id='hist"+i+"'    align='left'   width='30px;'>";
    ...
    function js_salvarJustificativa(sIdJsonElemento, sIdJustificativa, iCaixaLinha, iAutenticacao) {
       ...
       */
       ...
       var iDataConciliacao  = parent.document.getElementById('data').value;

       var oAjax   = new Ajax.Request("cai4_processaconciliacao_manual.php",{
         method       : 'post',
         asynchronous : false,
         parameters   : {
           ...
           sDataConciliacao    : iDataConciliacao,
           sDataAutenticacao   : oJsonEstrutura.data,
