...
class cl_db_permissao {
   ...
   public function incluir ($id_usuario,$id_item,$anousu,$id_instit,$id_modulo){
      $this->atualizacampos();
   ...
   public function alterar ($id_usuario=null,$id_item=null,$anousu=null,$id_instit=null,$id_modulo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($id_usuario=null,$id_item=null,$anousu=null,$id_instit=null,$id_modulo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $id_usuario=null,$id_item=null,$anousu=null,$id_instit=null,$id_modulo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $id_usuario=null,$id_item=null,$anousu=null,$id_instit=null,$id_modulo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function alterar_where( $where=null ) {
      $this->atualizacampos();
     $sql = " update db_permissao set ";
     $virgula = "";
     if(trim($this->id_usuario)!="" || isset($GLOBALS["HTTP_POST_VARS"]["id_usuario"])){
