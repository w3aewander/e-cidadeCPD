...
function imprimir() {
  ...
  var cgmAssadiEl = document.getElementById("z01_numcgm");
  var cgmAssadi = cgmAssadiEl ? cgmAssadiEl.value : '';
  ...
  if(assadi != ""){
    sParametros += '&aa='+assadi+'&at='+assadia;
    if (cgmAssadi) {
      sParametros += '&cgmaa='+cgmAssadi;
    }
  }else{
    sParametros += '&aa=nao';
  }
  sParametros += '&mcapa='+mcapa;
