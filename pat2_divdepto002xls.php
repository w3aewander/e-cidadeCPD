...
for($x = 0; $x < $numrows_depto;$x++){
   ...
   if($numrows_div>0){
   	...
   	$p=0;
    array_push($dadosxls, "Departamento:".$coddepto." - ".$descrdepto.$mostrar);
      ...
      array_push($dadosxls, $t30_codigo."|".$t30_descr."|".$ativo."|".$t30_numcgm."|".$z01_nome);
   		if ($p==0){
   			$p=1;
   		}else{
   			$p=0;
...
header("Content-Disposition: attachment; filename=divisoes-por-departamento.xls");
header("Expires: 0");
...
foreach ($cabecaxls as $cabeca) {
  print "<tr>";
  print "<td colspan='5'>".$cabeca."</td>";  
  print "</tr>";  
}
print "<tr>";
print "<th>Cod. Divisão</th>";
print "<th colspan='5'>Descrição da Divisão</th>";
print "<th>Ativo</th>";
print "<th>Responsável</th>";
print "<th colspan='5'>Nome</th>";
print '</tr>';

foreach ($dadosxls as $linha){
  $novalinha = explode("|", $linha);
  if(count($novalinha) == 1){
    print "<th colspan='10'>".$novalinha[0]."</th>";    
  } else {
    print "<tr>";
      print "<td>" . $novalinha[0] . "</td>";
      print "<td colspan='5'>" . $novalinha[1] . "</td>";
      print "<td>" . $novalinha[2] . "</td>";
      print "<td>" . $novalinha[3] . "</td>";
      print "<td colspan='5'>" . $novalinha[4] . "</td>";
    print "</tr>";  
  }
