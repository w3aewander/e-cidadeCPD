 ...
 */
class FisGrafica extends CgmBase {
  ...
  public function validarGrafica() {
     ...
     * Verifica se o iCgm informado existe, e verifica se a data limite da grafica informada, é valida.s
     */
    $oDaoGrafica = db_utils::getDao("fis_graficas");
    $sWhere  = " fis_graficas.y20_grafica = '" . $this->iCgm . "'";
    $sWhere .= " AND (fis_graficas.y20_datalimiteimpressao >= '" . date('Y-m-d') . "'";
    $sWhere .= " OR fis_graficas.y20_datalimiteimpressao IS NULL)";
  ...
  public function salvar() {
    ...
    $oDaoGraficas = db_utils::getDao('fis_graficas');
    ...
    $oDaoGraficas                 = new cl_fis_graficas();
