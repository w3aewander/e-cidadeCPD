    ...
    <td>
        ...
        <legend>
          ...
          <table border="0">
            ...
            <tr>
              ...
              <td>
          <?
          db_input('ve70_litros',10,$Ive70_litros,true,'text',$db_opcao,"onchange='js_calculaValorAbastecido();'")
          ?>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                if (!empty($ve70_dtabast)) {
                    ...
                    $dData = $data->getDate(DBDate::DATA_EN);
                }
      ...
      ?>
        <tr>
          ...
          <td>
              <?
              db_input('ve70_vlrun',10,$Ive70_vlrun,true,'text',$db_opcao,"onchange='js_calculaValorAbastecido();'")
              ?>
          </td>
        </tr>
        <tr>
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_veiculos','func_veiculosalt.php?funcao_js=parent.js_mostraveiculos1|ve01_codigo|ve01_placa','Pesquisa',true);
     ...
     if(document.form1.ve70_veiculos.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_veiculos','func_veiculosalt.php?pesquisa_chave='+document.form1.ve70_veiculos.value+'&funcao_js=parent.js_mostraveiculos','Pesquisa',false);
     }else{
...
function js_pesquisave70_veiculoscomb(mostra){
  ...
  if(mostra==true){
    if (document.form1.ve70_veiculos.value != ""){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_veiculoscomb','func_veiculoscomb.php?filtrar_veiculo='+document.form1.ve70_veiculos.value+'&funcao_js=parent.js_mostraveiculoscomb1|ve06_sequencial|ve26_descr|ve06_veiccadcomb','Pesquisa',true);
    }
  }else{
     if(document.form1.ve70_veiculoscomb.value != '' && document.form1.ve70_veiculos.value != ""){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_veiculoscomb','func_veiculoscombabast.php?filtrar_veiculocomb='+document.form1.ve70_veiculoscomb.value+'&funcao_js=parent.js_mostraveiculoscomb&cod_veiculo='+document.form1.ve70_veiculos.value+'&pesquisa_chave='+document.form1.ve70_veiculoscomb.value,'Pesquisa',false);
     }else{
...
?>
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_veiccadposto','func_veiccadpostoalt.php?param_tipo=<?=$param_tipo?>&funcao_js=parent.js_mostraposto1|ve29_codigo|z01_nome|descrdepto','Pesquisa',true);
  }else{
...
function js_pesquisa_ultimamedida() {
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_proximamedida',
    'func_veiculos_medida.php?metodo=proximamedida&veiculo='+document.form1.ve70_veiculos.value+
                                                '&data='+databanco+
                                                '&abastecimento='+abastecimento, 'Pesquisa Proxima Medida', false);
  return true;
}
...
function js_calculaValorAbastecido() {
    let valorAbastecido = $('ve70_litros').value * $('ve70_vlrun').value;
    $('ve70_valor').value = valorAbastecido.toFixed(2);
}
</script>
