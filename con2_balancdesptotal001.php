...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
  ...
  <table  align="center">
    <form name="form1" method="post" action="orc2_balancdesptotal002.php" >
      <tr>
         <td >&nbsp;</td>
         <td >&nbsp;</td>
      </tr>
  ...
  <td align="left">
	...
	?>
      ...
      <tr>
        ...
        <td colspan="3" align="center" >
            <input  name="emite_total" type="button" value="Imprimir Totalizador" onclick="js_emite();"></td>
      </tr>
