	...
	if(isset($liberaaba) &&$liberaaba==true){
	  ...
	  */
	  echo "<script>
		  ...
		  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensimoveis.location.href='pat1_bensimoveis001.php?$parametros"."&tipo_inclui=true&db_opcaoal=22&t54_codbem=';
		  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_bensmater.location.href='pat1_bensmater001.php?$parametros"."&tipo_inclui=true&db_opcaoal=22&t53_codbem=';
                </script>";
	}
