...
function js_pesquisay76_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistoriasalt.php?funcao_js=parent.js_abreconsulta|y70_codvist','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistoriasalt.php?pesquisa_chave='+document.form1.y76_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_abreconsulta(chave){
  js_OpenJanelaIframe('','db_iframe_consulta','fis3_fis_consultavist002.php?y70_codvist='+chave,'Pesquisa',true,15);
}
