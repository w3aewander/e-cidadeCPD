    ...
    <center>
        <table border="0">
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" id="chk_masc" name="chk_masc"
                           value="1" <?= $db_opcao == 3 ? 'disabled ' : '' ?>
                           onchange="" <?= (@$la08_i_sexo == 1) || (@$la08_i_sexo == 3) ? 'checked' : '' ?> >Masculino
                    <input type="checkbox" id="chk_fem" name="chk_fem"
                           value="2" <?= $db_opcao == 3 ? 'disabled ' : '' ?>
                           onchange="" <?= (@$la08_i_sexo == 2) || (@$la08_i_sexo == 3) ? 'checked' : '' ?>>Feminino
                    <!--
     ...
     -->
            ...
            <tr>
                <td nowrap title="Outras Informações">
                    <label class="bold">Outras Informações:</label>
                </td>
                <td>
                    <input
                        type="checkbox" <?= $db_opcao == 3 ? 'disabled ' : '' ?> <?= (!empty($la08_obriga_peso) && $la08_obriga_peso === 't') ? 'checked' : '' ?>
                        value="true" name="la08_obriga_peso" id="peso"/>
                    <label for="peso">Peso</label>

                    <input
                        type="checkbox" <?= $db_opcao == 3 ? 'disabled ' : '' ?> <?= (!empty($la08_obriga_altura) && $la08_obriga_altura === 't') ? 'checked' : '' ?>
                        value="true" name="la08_obriga_altura" id="altura"/>
                    <label for="altura">Altura</label>

                    <input
                        type="checkbox" <?= $db_opcao == 3 ? 'disabled ' : '' ?> <?= (!empty($la08_obriga_volumeamostra) && $la08_obriga_volumeamostra === 't') ? 'checked' : '' ?>
                        value="true" name="la08_obriga_volumeamostra" id="volumeAmostra"/>
                    <label for="volumeAmostra">Volume amostra</label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td nowrap title="<?= @$Tla08_exibehistoricoresultados ?>">
                    <label class="bold">Laudo do Exame</label>
                </td>
                <td>
                    <input
                        type="checkbox" <?= $db_opcao == 3 ? 'disabled ' : '' ?> <?= (!empty($la08_exibehistoricoresultados) && $la08_exibehistoricoresultados === 't') ? 'checked' : '' ?>
                        value="true" name="la08_exibehistoricoresultados" id="peso"/>
                    <label>Exibir histórico dos resultados</label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="chk_mapa" id="chk_mapa" value="1"
                           <?= $db_opcao == 3 ? 'disabled ' : '' ?>onchange="" <?= ((@$la08_i_gerar == 1) || (@$la08_i_gerar == 3) || (@$la08_i_gerar == 5) || (@$la08_i_gerar == 7)) ? 'checked' : '' ?>>
                    Mapa
                    <input type="checkbox" name="chk_etiqueta1" id="chk_etiqueta1"
                           value="2" <?= $db_opcao == 3 ? 'disabled ' : '' ?>
                           onchange="" <?= ((@$la08_i_gerar == 2) || (@$la08_i_gerar == 3) || (@$la08_i_gerar == 6) || (@$la08_i_gerar == 7)) ? 'checked' : '' ?> >
                    Etiqueta na coleta
                    <input type="checkbox" name="chk_etiqueta2" id="chk_etiqueta2"
                           value="4" <?= $db_opcao == 3 ? 'disabled ' : '' ?>
                           onchange="" <?= ((@$la08_i_gerar == 4) || (@$la08_i_gerar == 5) || (@$la08_i_gerar == 6) || (@$la08_i_gerar == 7)) ? 'checked' : '' ?> >
                    Etiqueta na triagem
            ...
            <tr>
                ...
                <td colspan="2">
                    <?php
                    $rResult = db_query(
                        "select la10_i_codigo as chave, la10_c_descr as descricao from lab_sinonima"
                    ); ?>
                    <?php
                    ...
                    db_input(
                        ...
                        'text',
                        $db_opcao,
                        " onchange='js_pesquisala18_i_sinonima(false);'onFocus=\"nextfield='la08_c_sigla'\""
                    ) ?>
                    <?php
                    db_input('la10_c_descr', 35, "", true, 'text', $db_opcao, '') ?>
                    <input type="button" name="lanc" id="lanc" value="Lancar" <?= $db_opcao == 3 ? 'disabled ' : '' ?>
                           onclick="js_lanc();"><br>
                    <select name="boxsinonimia" id="boxsinonimia" size="5" value="" ondblclick="js_delete();"
                            style="width: 300" <?= $db_opcao == 3 ? 'disabled ' : '' ?>>
