...
$sql = $clbiblioteca->sql_query("", "bi17_codigo,bi17_nome", ""," bi17_coddepto = $depto");
$result = $clbiblioteca->sql_record($sql);
...
<div class="container">
    <?php
    $legenda = "Inclusão de Acervo";
    include(modification("forms/db_frmacervo.php"));
    ?>
</div>
<script>
