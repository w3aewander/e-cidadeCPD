 ...
 */
class ExclusaoTermoContratoRequest extends DBFormRequest
{
    ...
    {
        return [
            'sequencialTermoContrato.required' => 'O sequencial do termo deve ser informado.',
            'cnpj.required' => 'O CNPJ deve ser informado.',
            'numeroContrato.required' => 'O número do contrato deve ser informado.',
            'anoContrato.required' => 'O ano do contrato deve ser informado.',
        ];
    }
}
