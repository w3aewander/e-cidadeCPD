...
switch ($oParam->exec) {
    case 'itensConsulta':
        ...
        foreach ($aPosicao as $oPosicao) {
            foreach ($oPosicao->getItens() as $oDado) {
                ...
                $oItem->unidade     = $oDado->getDescricaoUnidade();
    ...
    case "licitacoesConsulta":
        ...
        foreach ($aLicitacoesVinculadas as $oLicitacao) {
            ...
            $oStdLicitacao->sLocalLicitacao      = utf8_encode($oStdDados->l20_local);
    ...
    case "processodecomprasConsulta":
        ...
        foreach ($aProcessosDeComprasVinculados as $oProcessoDeCompra) {
           ...
           */
            $oStdProcesso->sResumoProcesso        = (string)substr(utf8_encode($oProcessoDeCompra->getResumo()), 0, 65);
            ...
            $oStdProcesso->sDescricaoDepartamento = utf8_encode($oProcessoDeCompra->getDescricaoDepartamento());
