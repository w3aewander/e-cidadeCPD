...
class cl_empautoriza
{
    ...
    public $e54_login = 0;
    public $e54_codcom = 0;
    public $e54_destin = null;
    public $e54_valor = 0;
    public $e54_anousu = 0;
    public $e54_tipol = null;
    public $e54_numerl = null;
    public $e54_praent = null;
    public $e54_entpar = null;
    public $e54_conpag = null;
    public $e54_codout = null;
    public $e54_contat = null;
    public $e54_telef = null;
    public $e54_numsol = 0;
    public $e54_anulad_dia = null;
    public $e54_anulad_mes = null;
    public $e54_anulad_ano = null;
    public $e54_anulad = null;
    public $e54_emiss_dia = null;
    public $e54_emiss_mes = null;
    public $e54_emiss_ano = null;
    public $e54_emiss = null;
    public $e54_resumo = null;
    public $e54_codtipo = 0;
    public $e54_instit = 0;
    public $e54_depto = 0;
    public $e54_concarpeculiar = null;
    public $e54_logincriador = 0;
    public $e54_institlic = 0;
    ...
    public $campos = "
                 ...
                 e54_numerl = varchar(24) = Numero da licitação
                 ...
                 e54_logincriador = int4 = Login autorização original
		 e54_institlic = int4 = Instituicao da Licitacao da autorizacao
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->e54_logincriador = ($this->e54_logincriador == "" ? @$GLOBALS["HTTP_POST_VARS"]["e54_logincriador"] : $this->e54_logincriador);
            $this->e54_institlic = ($this->e54_institlic == ""?@$GLOBALS["HTTP_POST_VARS"]["e54_institlic"]:$this->e54_institlic);
        } else {
            $this->e54_autori = ($this->e54_autori == "" ? @$GLOBALS["HTTP_POST_VARS"]["e54_autori"] : $this->e54_autori);
        }
    }

    public function incluir($e54_autori)
    {
        $this->atualizacampos();
        ...
        if ($this->e54_institlic == null) {
            $this->e54_institlic = 'null';
        }
        ...
        if ($this->e54_codtipo == null) {
            $this->erro_sql = " Campo Tipo Empenho não informado.";
        ...
        if ($this->e54_logincriador == null) {
            $this->erro_sql = " Campo Login autorização original não informado.";
            $this->erro_campo = "e54_logincriador";
            $this->erro_banco = "";
            $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if (($this->e54_autori == null) || ($this->e54_autori == "")) {
            $this->erro_sql = " Campo e54_autori não declarado.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = "Autoriza empenho ($this->e54_autori) não Incluído. Inclusão Abortada.";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        ...
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
            ...
            if (($resaco != false) || ($this->numrows != 0)) {
                ...
                $resac = db_query("insert into db_acount values($acount,810,1014039,'','" . AddSlashes(pg_result($resaco, 0, 'e54_logincriador')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
            }
        }
        return true;
    }

    public function alterar($e54_autori = null)
    {
        $this->atualizacampos();
        ...
        if (trim($this->e54_anulad) != "" || isset($GLOBALS["HTTP_POST_VARS"]["e54_anulad_dia"]) && ($GLOBALS["HTTP_POST_VARS"]["e54_anulad_dia"] != "")) {
            ...
            $GLOBALS["HTTP_POST_VARS"]["e54_anulad_dia"] = " ";
        ...
        if (trim($this->e54_logincriador) != "" || isset($GLOBALS["HTTP_POST_VARS"]["e54_logincriador"])) {
            $sql .= $virgula . " e54_logincriador = $this->e54_logincriador ";
            $virgula = ",";
            if (trim($this->e54_logincriador) == null) {
                $this->erro_sql = " Campo Login autorização original não informado.";
                $this->erro_campo = "e54_logincriador";
                $this->erro_banco = "";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        ...
        if(trim($this->e54_institlic)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e54_institlic"])){
            if(trim($this->e54_institlic)=="" && isset($GLOBALS["HTTP_POST_VARS"]["e54_institlic"])){
               $this->e54_institlic = "0" ;
            }
            $sql  .= $virgula." e54_institlic = $this->e54_institlic ";
            $virgula = ",";
        }
        $sql .= " where ";
        if ($e54_autori != null) {
        ...
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
            ...
            if ($this->numrows > 0) {
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["e54_logincriador"]) || $this->e54_logincriador != "") {
                        $resac = db_query("insert into db_acount values($acount,810,1014039,'" . AddSlashes(pg_result($resaco, $conresaco, 'e54_logincriador')) . "','$this->e54_logincriador'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["e54_institlic"]) || $this->e54_institlic != "") {
                        $resac = db_query("insert into db_acount values($acount,810,1014515,'".AddSlashes(pg_result($resaco,$conresaco,'e54_institlic'))."','$this->e54_institlic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                }
            }
        }
        ...
        if (!$result) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Autoriza empenho não Alterado. Alteração Abortada.\\n";
            $this->erro_sql .= "Valores : " . $this->e54_autori;
            $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Autoriza empenho não foi Alterado. Alteração Executada.\\n";
                $this->erro_sql .= "Valores : " . $this->e54_autori;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function excluir($e54_autori = null, $dbwhere = null)
    {
        $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
                && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco != false) || ($this->numrows != 0)) {
                for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
                    ...
                    $resac = db_query("insert into db_acount values($acount,810,1014039,'','" . AddSlashes(pg_result($resaco, $iresaco, 'e54_logincriador')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
                    $resac = db_query("insert into db_acount values($acount,810,1014515,'','".AddSlashes(pg_result($resaco,0,'e54_institlic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,810,1014515,'','".AddSlashes(pg_result($resaco,$iresaco,'e54_institlic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Autoriza empenho não Excluído. Exclusão Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Autoriza empenho não Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $e54_autori;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function sql_query($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_file($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_depto($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_deptoautori($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_elementomaterial($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
        ...
        $sql .= "      inner join orcelemento element  on  element.o56_codele = orcdotacao.o58_codele
                                                    and element.o56_anousu = orcdotacao.o58_anousu
                    inner join orcelemento desdobr  on desdobr.o56_codele = empautitem.e55_codele
                                                   and desdobr.o56_anousu = empautoriza.e54_anousu ";
    ...
    public function sql_query_itemmaterial($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_solicita($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_anulaautorizacao($param_autori = null, $verifica_saldo = false, &$erro_msg = "", &$sqlerro = false, &$flag_saldo = false, $vetor_dotacao = array(), $reservar = "false")
    {
            ...
            for ($x = 0; $x < $numrows_elemt; $x++) {
                ...
                for ($xx = 0; $xx < $numrows_procitem; $xx++) {
                    ...
                    if ($numrows_dotac > 0) {
                        ...
                        $o83_autori = pg_result($result_dotac, 0, 8);
                    } else {
                    ...
                    if ($verifica_saldo == false) {
                        ...
                        if ($clorcreservasol->numrows > 0) {
                            ...
                            if ($sqlerro == false) {
                                $daoemppreautorizacaounidade = new cl_emppreautorizacaounidade();
                                if ($daoemppreautorizacaounidade->habilitadoParaLiberacaoAutorizacao($o83_autori)) {
                                    $clorcreservaaut->excluir($oOrcReservaSol->o82_codres);
    ...
    public function anulaAutorizacao($iCodAutori, $lReservar = false)
    {
        ...
        if (!empty($oDadosOrcReserva->o80_codres)) {
            ...
            if ($daoEmppreAutUnidade->habilitadoParaLiberacaoAutorizacao($oDadosOrcReserva->o83_autori)) {
                $clorcreservasol->excluir(null, "o82_codres =  $oDadosOrcReserva->o80_codres");
                if ($clorcreservasol->erro_status == 0) {
        ...
        if ($lReservar) {
            ...
            for ($x = 0; $x < $iNumRowsItens; $x++) {
                ...
                //ADICIONADO
                $sWhereDotac .= " AND (o82_solicitem = pc81_solicitem OR o82_solicitem IS NULL)";
                ...
                for ($xx = 0; $xx < $iTotalItensSolicitacao; $xx++) {
                    ...
                    $clorcreserva->o80_planoorcamentariolinhapacto = $oItensSolicitacao->pc13_planoorcamentariolinhapacto;
                    $clorcreserva->incluir(null);
                    if ($clorcreserva->erro_status == 0) {
        ...
        $sSqlSolicitacao = $this->sql_query_solicita(
            null,
            "distinct pc80_codproc, pc10_solicitacaotipo",
            null,
            " e54_autori = {$iCodAutori} "
        );
        $rsSolicitacao = db_query($sSqlSolicitacao);
        $tipoSolicitacao = db_utils::fieldsMemory($rsSolicitacao, 0)->pc10_solicitacaotipo;

        if ($rsSolicitacao && pg_num_rows($rsSolicitacao) > 0) {
            $iCodigoProcessoCompra = db_utils::fieldsMemory($rsSolicitacao, 0)->pc80_codproc;

            // Compilação registro preço
            if ($tipoSolicitacao !== '5') {
                $sSqlDeleta = "
                    DELETE FROM empautitempcprocitem
                        WHERE e73_pcprocitem IN (
                            SELECT pc81_codprocitem FROM pcprocitem
                                WHERE pc81_codproc = {$iCodigoProcessoCompra}
                        )
    ...
    public function sql_query_empenho($e54_autori = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
