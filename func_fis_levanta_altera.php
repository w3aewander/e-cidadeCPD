        ...
        if(isset($chave_y60_codlev) && (trim($chave_y60_codlev)!="")){
          ...
          from ( select fis_levanta.*,y62_inscr, y93_numcgm,empresa.z01_nome as nome_empresa,cgm.z01_nome as nome_cgm,y112_procfiscal 
           ...
           // if($linhasUser == 0){
            $sql .= "    $where2";
            // }
            $sql .="            ) as x where x.y60_codlev = $chave_y60_codlev and x.y60_importado is falseorder by y60_codlev desc ";
          ...
          from ( select fis_levanta.*,y62_inscr, y93_numcgm,empresa.z01_nome as nome_empresa,cgm.z01_nome as nome_cgm,y112_procfiscal 
           ...
           // if($linhasUser == 0){
            $sql .= "   $where2 and  y62_inscr = $q02_inscr ";
            // }
            $sql .="            ) as x where x.y60_importado is false order by y60_codlev desc ";
         ...
         $sql = "select distinct y60_codlev, 
          ...
          from ( select fis_levanta.*,y62_inscr, y93_numcgm,empresa.z01_nome as nome_empresa,cgm.z01_nome as nome_cgm,y112_procfiscal 
           ...
           // if($linhasUser == 0){
            $sql .= " $where2 and  y93_numcgm = $z01_numcgm ";
            // }
            $sql .="            ) as x where x.y60_importado is false order by y60_codlev desc ";
