        ...
        <fieldset><legend><b>&nbsp;Empenho&nbsp;</b></legend>
          <table >
            ...
            <tr>
              ...
              <td colspan=3><?php db_input('z01_nome', 52, $Iz01_nome, true, 'text', 3, "");?></td>
            </tr>
            <tr>
              ...
              <?php if(isRioDeJaneiro()){ ?>                                           
                <td  colspan='4'>
                  <fieldset>
                    ...
                    <span>
                        <b style ='color:red'>Campo obrigatório para uso no SIGFIS do TCE-RJ, 
                          com no máximo 4000 caracteres.
                        </b>
                    </span>                
                    <table>
                      <tr>
                        <td>
                           <textarea id="motivo" name="motivo" rows="2" cols="70"  onkeyup="js_verificaCaracteresMotivo()"></textarea>
                        </td>
                      </tr>
                      <tr>                        
                        <td>
                          <span> <b> N° de caracteres :</b></span>
                          <input type = 'text' size='4' id= 'motivo_caracteres' value = '' disabled/>
                        </td>                      
                        </tr>                      
                    </table>
                  </fieldset>
        ...
        <fieldset ><legend><b>&nbsp;Valores do Empenho&nbsp;</b></legend>
          <table style="width:200px;height:100%" >
            ...
            <tr>
              ...
              <td align=right>
                <?php db_input('saldoRP', 12,'', true, 'text', 3, '','','','text-align:right')?>
              </td>
            </tr>
          </table>
        </fieldset>
...
<script>
  ...
  function js_estornaRP(iTipo) {
    ...
    if (isRJ && sMotivo.length > 4000){
            
      alert('É obrigatório informar no motivo um limite de no máximo 4000 caracteres!');
      return false;
    }
     ...
     */
    js_divCarregando("Aguarde, Processando Registro...","msgBox");
  ...
  function js_verificaCaracteresMotivo(){
    $('motivo_caracteres').value = $F('motivo').length;
  }   
</script>
