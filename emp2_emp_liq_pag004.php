...
<center>
    <form name="form1" method="post">
        ...
        <table border='0'>
            ...
            <tr>
                ...
                <td>
                    ...
                    $sWhere = "o58_anousu = {$iAnousu} and o58_instit = {$iInstit} {$dbwhere} {$elemento}";
                    $sCampos = "distinct o58_codigo,
                                         o15_loaespecificacao || ' - ' || o15_descr as o15_descr,
                                         o15_loaespecificacao ";
                    $sSqlBuscaELemento = $clorcdotacao->sql_query(null,
                                                                  null,
                                                                  $sCampos,
                                                                  "o15_loaespecificacao",
                                                                  $sWhere);
                    $result = $clorcdotacao->sql_record($sSqlBuscaELemento);
                    $iTotalLinhas = $clorcdotacao->numrows;
                    db_selectrecord("o58_codigo", $result, true, 2, "", "", "", ($clorcdotacao->numrows > 1 ? "0" : ""), " js_troca('o58_codigo');", 2);
                    ?>
                </td>
            </tr>
            <tr>
      ...
      <input name="limpa" type="button" onclick='js_limpa();' value="Limpar campos" style="margin-top: 10px;">
