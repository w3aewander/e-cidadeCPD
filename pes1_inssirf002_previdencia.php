  ...
  if (db_mesfolha() == "") {
    ...
    if($sqlerro == false) {
      ...
      if($codigo > 2) {
        ...
        $clinssirf->r33_rubprorrogacaomaternidade = $r33_rubprorrogacaomaternidade;
...
if(isset($alterar)) {
  ...
  if (db_mesfolha() == "") {
    ...
    $clinssirf->r33_deduzi = $r33_deduzi;
    $clinssirf->r33_instit = db_getsession("DB_instit");
    $clinssirf->r33_codele = !empty($r33_codele) ? $r33_codele : null;
    ...
    if ($codigo > 2 && $sqlerro == false) {
      ...
      if ($sqlerro == false) {
        ...
        $clinssirf->r33_rubaci = $r33_rubaci;
        $clinssirf->r33_tinati = $r33_tinati;
        $clinssirf->r33_rubfamiliar = $r33_rubfamiliar;
        $clinssirf->r33_rublicencapremio = $r33_rublicencapremio;
