...
<script type="text/javascript">
    ...
    var aHeaders = ['Nº', 'Título', 'Cód. Barras', 'Data Aquisição', 'Ano Edição', 'Edição', 'Situação', 'Aquisição', 'Empréstimo'];
    var aCellWidth = ['5%', '26%', '10%', '15%', '7%', '7%', '10%', '10%', '10%'];
        ...
        var oAjax = new AjaxRequest('bib4_acervo.RPC.php', {exec: 'exemplaresByAcervo', iAcervo: oGet.iAcervo},
            function (oRetorno, lErro) {
                ...
                for (var oExemplar of oRetorno.aExemplares) {
                    ...
                    aLinha.push(oExemplar.ano_edicao);
                    aLinha.push(oExemplar.edicao);
