...
<html>
  ...
  <script>
    ...
    (function() {
      ...
      var oLookupContratos = new DBLookUp($('labelContrato'), $('ac16_sequencial'), $('ac16_resumoobjeto'), {
        'sArquivo': 'func_acordo.php',
        'sQueryString': '&iTipoFiltro=4&descricao=true'
      });

      oLookupContratos.setCallBack('onClick', limpaGrid);
      oLookupContratos.setCallBack('onChange', limpaGrid);
