...
for($x=0;$x<$clatestvaga->numrows;$x++){
 ...
 if(substr($ed15_c_nome, 0, 5) == "TARDE"){
  $ed15_c_nome = "TARDE";
 }elseif(substr($ed15_c_nome, 0, 5) == "MANHÃ" || substr($ed15_c_nome, 0, 5) == "MANHA"){
  $ed15_c_nome = "MANHÃ" ;
 }
 


 $head1 = "DECLARAÇÃO DE VAGA";
 $head2 = "Código: $ed102_i_codigo";
 $head3 = "Usuário Emissor: $nome";
 $pdf->setfillcolor(223);
 $pdf->addpage();
 $pdf->ln(5);
 /*$texto = "             Declaro, para os devidos fins, que dispomos de uma vaga no $ed11_c_descr, ensino $ed10_c_descr, turno $ed15_c_nome, no ano letivo de $ed52_i_ano, para o aluno(a) $ed47_v_nome neste Estabelecimento de Ensino.
               Sem mais para o momento, nos colocamos à disposição para quaisquer dúvidas.
               Este documento tem validade de 48 horas a contar desta data.
 ";*/
$texto = "Declaro, para os devidos fins, que dispomos de uma vaga no $ed11_c_descr, ensino $ed10_c_descr, turno $ed15_c_nome, no ano letivo de $ed52_i_ano, para o aluno(a) $ed47_v_nome neste Estabelecimento de Ensino.";
$texto2 = "Sem mais para o momento, nos colocamos à disposição para quaisquer dúvidas.";
$texto3 = strtoupper("Este documento tem validade de 48 horas a contar desta data.");
 
 $data = substr($ed102_d_data,8,2)." de ".db_mes(substr($ed102_d_data,5,2),1)." de ".substr($ed102_d_data,0,4).".";
 $pdf->setfont('arial','b',20);
 $pdf->cell(190,20,"DECLARAÇÃO DE VAGA",0,1,"C",0);
 $pdf->cell(190,20,"",0,1,"C",0);
 $pdf->setfont('arial','b',9);
 $pdf->multicell(190,4,$texto,0,"J",0,0);
 $pdf->ln();
 $pdf->multicell(190,4,$texto2,0,"J",0,0);
 $pdf->ln();
 $pdf->multicell(190,4,$texto3,0,"J",0,0);
 $pdf->cell(190,20,"",0,1,"C",0);
 ...
 $pdf->cell(190,6,"Assinatura Direção ou Aux. Secretaria",0,1,"C",0);
