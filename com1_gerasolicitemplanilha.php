...
if(isset($solicita) && trim($solicita)!=""){
  ...
  $sWhereSolicitem  = " pc11_numero = {$solicita}  ";
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    if($clsolicitem->numrows == 0){
      ...
      echo " <td nowrap class='tdcabecalhotabela' align='center'><b>Fonte Ref.</b></td>\n";
      echo " <td nowrap class='tdcabecalhotabela' align='center'><b>Cod. Ref.</b></td>\n";
      echo " <td nowrap class='tdcabecalhotabela' align='center'><b>Data Ref.</b></td>\n";
...
x.pc11_codigo,
	...
	//--------------------------------------------------------------------------------------------------------------------------------------
        //$kql = "SELECT pc11_fonteref, pc11_codref, pc11_dataref FROM solicitem WHERE pc11_codigo = {$pc11_codigo}";
        //var_dump($kql);
        $konsulta = pg_query("SELECT pc11_fonteref, pc11_codref, pc11_dataref FROM solicitem WHERE pc11_codigo = {$pc11_codigo}");
        $kresultado = pg_fetch_all($konsulta);
        
        
        $fonteref = (empty($kresultado[0]["pc11_fonteref"]) ? "" : $kresultado[0]["pc11_fonteref"]);
        $codref = (empty($kresultado[0]["pc11_codref"]) ? "" : $kresultado[0]["pc11_codref"]);
        $dataref = (empty($kresultado[0]["pc11_dataref"]) ? "" : $kresultado[0]["pc11_dataref"]);
        ...
        echo "  <td nowrap class='tdconteudotabela' align='center'>
          <input type='text' maxlength='20' id='pc11_fonteref' name='pc11_fonteref_".$pc11_codigo."' value='".$fonteref."'>
        </td>\n";

        echo "  <td nowrap class='tdconteudotabela' align='center'>
          <input type='text' maxlength='10' id='pc11_codref' name='pc11_codref_".$pc11_codigo."' value='".$codref."'>
        </td>\n";

        echo "  <td nowrap class='tdconteudotabela' align='center'>
          <input type='date' id='pc11_dataref' name='pc11_dataref_".$pc11_codigo."' value='".$dataref."'>
        </td>\n";
...
<input type="hidden" name="nosolicitacao" value="<?=$pc11_numero;?>">
<input type="submit" value="Gerar Planilha TCERJ" style="display: block;margin:0 auto;margin-top: 15px">
</form>
<script>
js_marcacampos();
js_marcacamposimp();
