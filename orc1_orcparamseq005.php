...
if (isset($alterar)) {
    ...
    if ($clorcparamseq->numrows > 0 && $lValidaSeq) {
        ...
        $clorcparamseq->o69_totalizador = "{$_POST['o69_totalizador']}";
        $clorcparamseq->alterar_where(
            null,
            null,
            "o69_codparamrel = $o69_codparamrel and o69_codseq = $o69_codseq_anterior"
        );
        ...
        if ($iOrigemAntiga != $iOrigemNova) {
            $oDaoOrcParamColuna = new cl_orcparamseqorcparamseqcoluna();
            $sWhere = " o116_codseq = {$o69_codseq_anterior} and  o116_codparamrel = {$o69_codparamrel} ";
            $oDaoOrcParamColuna->o116_formula = 'null';
        ...
        echo "o116_codparamrel=" . @$o69_codparamrel . "&o116_codseq=" . @$o69_codseq . "&o69_origem=" . @$o69_origem . "' </script>";
...
if (isset($o69_codparamrel) && isset($o69_codseq)) {
    $urlAbaConfiguracoes = "orc4_orcparamseqfiltropadrao.php?o116_codparamrel={$o69_codparamrel}&o116_codseq={$o69_codseq}";
}

if ($o69_origem == 5) {
    $urlAbaConfiguracoes = "orc4_configuracaopadraocontacorrente.php?URLSearchParams=true&o116_codparamrel={$o69_codparamrel}&o116_codseq={$o69_codseq}&padrao=true";
}
    ...
    if ($sqlerro == true) {
	  ...
	  <script>
	      function js_db_libera(){
	         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_configuracao.location.href='$urlAbaConfiguracoes';
		   }\n
	    js_db_libera();
	  </script>\n
	 ";
...
if (isset($chavepesquisa)) {
  ...
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_orcparamseqorcparamseqcoluna.location.href='orc1_orcparamseqorcparamseqcoluna001.php?o116_codparamrel=" . @$o69_codparamrel . "&o116_codseq=" . @$o69_codseq . "&o69_origem=" . $o69_origem . "';
