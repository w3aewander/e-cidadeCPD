...
class verticalTab {
  ...
  */
  ...
  function add ($saName, $sLabel = '', $sUrl = '', $lActive = true, $openIframe = false) {
  ...
  private function create() {
     ...
     */
     ...
     if (count($this->aAbas) == 0 ) {
       ...
       foreach ($this->aAbas as $aAba ) {
         ...
         if (!$aAba["openIframe"]) {
             ...
             $sAbas .= "   onclick='openIframeMensagem({$oGet->codproc}); js_marcaTab(this);this.blur()'";
         }
     ...
     $this->sRender .= "  <tr>\n";
     $this->sRender .= "    <td width='{$this->iWidthColunaOpcoes}%' id='td_abas' valign='top' height='100%' rowspan='2'>\n";
     $this->sRender .= $sAbas;
     $this->sRender .= "    </td>\n";
