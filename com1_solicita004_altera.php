...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmsolicita.php"));
	?>
    </center>
	</td>
  </tr>
...
if(isset($incluir) || isset($alterar)){
  ...
  if($sqlerro==true){
    ...
    echo "
          <script>
            (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_solicitem.document.form1.pc11_numero.value = ".$pc10_numero.";
