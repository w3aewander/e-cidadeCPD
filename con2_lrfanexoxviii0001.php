...
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\Factory\AnexoXIV;
...
$relatorio = AnexoXIV::getInstance(db_getsession('DB_anousu'), 1);
$codrel = $relatorio->getRelatorioContabil()->getCodigo();
