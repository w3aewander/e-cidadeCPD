...
class M10984LancamentoCreditoBoletoCustas extends PostgresMigration
{
    public function up()
    {
        $this->dicionario();
        $this->alteraTabela();
        $this->atualizaBaixaBanco();
    }
    ...
    public function down()
    {
        ...
        $this->retornaTabela();
        $this->retornaBaixaBanco();
    }

    public function dicionario()
    {
        $sql = <<<SQL
        insert into db_syscampo   values(1009816,'k02_reccredito','int4','Receita de Crédito','0', 'Receita de Crédito',10,'f','f','f',1,'text','Receita de Crédito');
        insert into db_sysarqcamp values(75,1009816,11,0);
        update db_syscampo set nomecam = 'k00_receitacredito', conteudo = 'int4', descricao = 'Receita de Crédito', valorinicial = '0', rotulo = 'Receita de Crédito', nulo = 't', tamanho = 10, maiusculo = 'f', autocompl = 'f', aceitatipo = 1, tipoobj = 'text', rotulorel = 'Receita de Crédito' where codcam = 18078;
SQL;
        $this->execute($sql);
    }
    ...
    {
        $sql = <<<SQL
          alter table caixa.tabrec add column k02_reccredito integer default null;
SQL;
        $this->execute($sql);
    }
    ...
    {
        $sql = <<<SQL
        delete from db_sysarqcamp where codcam = 1009816;
        delete from db_syscampo   where codcam = 1009816;
        update db_syscampo set nomecam = 'k00_receitacredito', conteudo = 'int4', descricao = 'Receita de Crédito', valorinicial = '0', rotulo = 'Receita de Crédito', nulo = 'f', tamanho = 10, maiusculo = 'f', autocompl = 'f', aceitatipo = 1, tipoobj = 'text', rotulorel = 'Receita de Crédito' where codcam = 18078;
SQL;
        $this->execute($sql);
    ...
    {
        $sql = <<<SQL
          alter table caixa.tabrec drop column k02_reccredito;
SQL;
        $this->execute($sql);
    }


    public function atualizaBaixaBanco()
    {
        $sql = <<<SQL
  ...
  if lAtivaPgtoParcial is true then
    ...
    loop
      ...
      --
        ...
        for rRecordCustas in 
                      select 
                        ar36_descricao as descricao,
                        v77_valor as valor
                        from processoforopartilhacusta 
        ...
        loop
          ...
          nVlrDiferencaPgto := nVlrDiferencaPgto - rRecordCustas.valor;
        ...
        if iTipoAbatimento = 3 then
          ...
          insert into abatimentorecibo ( k127_sequencial,
            ...
            for rRecord in select (
                        case 
                            when k02_reccredito is not null 
                                then k02_reccredito
                            else k00_receitacredito
                        end 
                    ) as receita_credito,
                    ...
                    from ( 
                        select 
                            ...
                            from 
                                arrecad
                            where 
                                arrecad.k00_numpre = recibopaga.k00_numpre
                                and arrecad.k00_numpar = recibopaga.k00_numpar
                            union all
                            select 
                                arrecant.k00_tipo
                            from 
                                arrecant
                            where 
                                arrecant.k00_numpre = recibopaga.k00_numpre
                                and arrecant.k00_numpar = recibopaga.k00_numpar
                            union all
                            select 
                                arreold.k00_tipo
                            from 
                                arreold
                            where 
                                arreold.k00_numpre = recibopaga.k00_numpre
                                and arreold.k00_numpar = recibopaga.k00_numpar
                            union all
                            select 
                                1
                            from 
                                arreprescr
                            where 
                                arreprescr.k30_numpre = recibopaga.k00_numpre
                                and arreprescr.k30_numpar = recibopaga.k00_numpar
                            limit 1 ) as k00_tipo, 
                        ...
                        where 
                            ...
                            and not exists (
                                ...
                                from 
                                    ...
                                    inner join taxa on taxa.ar36_sequencial = v77_taxa 
                                where 
                                    v77_numnov = recibopaga.k00_numnov and ar36_receita = recibopaga.k00_receit)
                            and not exists (
                                select 
                                    1 
                                from 
                                    ...
                                    inner join taxa on taxa.ar36_sequencial = v36_taxa 
                                where 
                                    v36_numnov = recibopaga.k00_numnov and ar36_receita = recibopaga.k00_receit)
                    ) as x
                    group by 
                        k00_numcgm,
                        x.k00_receit,
            ...
            --raise notice 'valor Credito: % | Receita: %', nVlrReceita, iReceitaCredito;
...
SQL;
    ...
    public function retornaBaixaBanco()
    {
        $sql = <<<SQL
