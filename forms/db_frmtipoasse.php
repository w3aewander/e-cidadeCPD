...
<style>
    ...
    #h30_portariatipoatodescr,
    #h30_portariaproceddescr {
        width: 300px;
    }
</style>
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td nowrap title="<?= @$Th12_tipefe ?>">
                            <label id="lbl_h12_tipefe" for="h12_tipefe"><strong>Tipo de efetividade</strong><?= @$Lh12_tipefe ?></label>
                        </td>
                        <td>
                            <?php
                            $x = array(
                    ...
                    <tr>
                        <td nowrap title="<?= @$Th12_regenc ?>">
                            <label id="lbl_h12_regenc" for="h12_regenc"><strong>Regência</strong><?= @$Lh12_regenc ?></label>
                        </td>
                        <td>
                            <?php
                            $x = array("f" => "Não", "t" => "Sim");
                    ...
                    <tr>
                        <td nowrap title="<?php echo $Th12_tiporeajuste; ?>">
                            <label id="lbl_h12_tiporeajuste" for="h12_tiporeajuste"><strong>Tipo de Reajuste Salarial</strong><?php echo $Lh12_tiporeajuste; ?></label>
                        </td>
                        <td>
                            <?php
                        ...
                        <td>
                            ...
                            if (pg_fetch_assoc($rsNaturezaTipoAssentamento) && pg_num_rows($rsNaturezaTipoAssentamento) > 0) {
                    ...
                    <tr>
                        <td>
                            <label id="lbl_h12_bloqueioassentamento" for="h12_bloqueioassentamento"><?php echo $Lh12_bloqueioassentamento; ?></label>
                        </td>
                        <td>
                            <?php
                            $aBloqueioAssentamento = array('f' => 'Não', 't' => 'Sim');
                            db_select("h12_bloqueioassentamento", $aBloqueioAssentamento, true, $db_opcao, "onchange=exibeLancamentoMensalEAnual();");
                            ?>
                        </td>
                    </tr>
                    <tr id="lancamento" style="display:<?php echo $displayLancamento; ?>">
                        <td>
                            <label id="lbl_h12_lancamentomensal" for="h12_lancamentomensal"><?php echo $Lh12_lancamentomensal; ?></label>
                        </td>
                        <td>
                            <?php
                            db_input('h12_lancamentomensal', 6, $Ih12_lancamentomensal, true, 'text', $db_opcao);
                            ?>
                        </td>
                        <td>
                            <label id="lbl_h12_lancamentoanual" for="h12_lancamentoanual"><?php echo $Lh12_lancamentoanual; ?></label>
                        </td>
                        <td>
                            <?php
                            db_input('h12_lancamentoanual', 6, $Ih12_lancamentoanual, true, 'text', $db_opcao);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td nowrap title="<?php echo $Th12_gerafaltas; ?>">
                    ...
                    <tr>
                        <td nowrap title="<?php echo $Th12_permiteduplicar; ?>">
                            <label id="lbl_h12_permiteduplicar" for="h12_permiteduplicar"><strong>Permite Duplicar</strong>
                    ...
                    <tr>
                        <td nowrap title="<?php echo $Th12_gerafaltasperiodoaquisitivo; ?>">
                            <label id="lbl_h12_gerafaltasperiodoaquisitivo" for="h12_gerafaltasperiodoaquisitivo"><strong>Geral Faltas Período Aquisitivo </strong><?php echo $Lh12_gerafaltasperiodoaquisitivo; ?></label>
                        </td>
                        <td>
                            <?php
                            db_select('h12_gerafaltasperiodoaquisitivo', $opcoesGeraFaltas, true, $db_opcao)
                            ?>
                        </td>
                    </tr>
                </table>
...
<script type="text/javascript">
    ...
    function js_validaCampos() {
        ...
        if (document.form1.h12_bloqueioassentamento.value == 't' && !document.form1.h12_lancamentomensal.value) {

            alert(_M('recursoshumanos.rh.rec1_tipoassenta.lancamento_mensal'));
            return false;
        }

        if (document.form1.h12_bloqueioassentamento.value == 't' && !document.form1.h12_lancamentoanual.value) {

            alert(_M('recursoshumanos.rh.rec1_tipoassenta.lancamento_anual'));
            return false;
        }
    ...
    window.onload = function() {
        exibeLancamentoMensalEAnual();
    };

    function exibeLancamentoMensalEAnual() {
        let bloqueioAssentamento = document.getElementById("h12_bloqueioassentamento");
        let lancamento = document.getElementById("lancamento");

        if (bloqueioAssentamento.value === 't') {
            lancamento.style.display = "table-row";
        } else {
            lancamento.style.display = "none";
            let lancamentoMensal = document.getElementById("h12_lancamentomensal");
            let lancamentoAnual = document.getElementById("h12_lancamentoanual");

            if (lancamentoMensal.value === '') {
                lancamentoMensal.value = '';
            }
            if (lancamentoAnual.value === '') {
                lancamentoAnual.value = '';
            }
        }
    }
