 ...
 */
class RgfRetornoAoLimitePessoalExtendido extends OutrosArquivosSigapFiscal
{
    const TAG = 'RGFRetornoAoLimitePessoalExtendido';
    ...
    protected $template = [
        ...
        'rlpPercDTP2',
        'rlpExercicio3',
        'rlpQuadrimestreAjuste3',
        'rlpRedResidual3Q',
        'rlpPercLimite3',
        'rlpPercDTP3',
        'rlpExercicio4',
        'rlpQuadrimestreAjuste4',
        'rlpRedResidual4Q',
        'rlpPercLimite4',
        'rlpPercDTP4',
    ];
