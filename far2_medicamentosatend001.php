              ...
              <td>
                  ...
                  <?php
                    db_input('fa01_i_codigo',
                             ...
                             db_input('m60_descr', 50, @$Im60_descr, false, 'text', 3, " onchange='descricaoVazia();'"
                            );
                  ?>
                  </td>
                  <td>
...
function descricaoVazia() {
    let descricao = document.form1.m60_descr.value;
    let codigo = document.form1.fa01_i_codigo;
