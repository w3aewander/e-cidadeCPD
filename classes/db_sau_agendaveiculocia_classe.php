...
//MODULO: Ambulatorial
//CLASSE DA ENTIDADE sau_agendaveiculocia
class cl_sau_agendaveiculocia { 
   ...
   var $campos = "
                 ...
                 s123_i_agendaveiculo = int4 = Agenda Veículo 
                 s123_v_acompanhante = varchar(40) = Acompanhante 
                 s123_v_tipodoc = varchar(10) = Tipo Documento 
                 s123_v_documento = varchar(10) = Documento 
                 ";
   //funcao construtor da classe 
   function cl_sau_agendaveiculocia() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("sau_agendaveiculocia"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->s123_i_codigo = ($this->s123_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_i_codigo"]:$this->s123_i_codigo);
       $this->s123_i_agendaveiculo = ($this->s123_i_agendaveiculo == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculo"]:$this->s123_i_agendaveiculo);
       $this->s123_v_acompanhante = ($this->s123_v_acompanhante == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_v_acompanhante"]:$this->s123_v_acompanhante);
       $this->s123_v_tipodoc = ($this->s123_v_tipodoc == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_v_tipodoc"]:$this->s123_v_tipodoc);
       $this->s123_v_documento = ($this->s123_v_documento == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_v_documento"]:$this->s123_v_documento);
     }else{
       $this->s123_i_codigo = ($this->s123_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["s123_i_codigo"]:$this->s123_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($s123_i_codigo){ 
      $this->atualizacampos();
     if($this->s123_i_agendaveiculo == null ){ 
       $this->erro_sql = " Campo Agenda Veículo nao Informado.";
       $this->erro_campo = "s123_i_agendaveiculo";
       $this->erro_banco = "";
     ...
     if($this->s123_v_acompanhante == null ){ 
     ...
     if($s123_i_codigo == "" || $s123_i_codigo == null ){
       $result = db_query("select nextval('sau_agendaexternacia_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: sau_agendaexternacia_codigo_seq do campo: s123_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $s123_i_codigo)){
         ...
         $this->s123_i_codigo = $s123_i_codigo; 
       }
     }
     if(($this->s123_i_codigo == null) || ($this->s123_i_codigo == "") ){ 
       $this->erro_sql = " Campo s123_i_codigo nao declarado.";
     ...
     $sql = "insert into sau_agendaveiculocia(
                                       s123_i_codigo 
                                      ,s123_i_agendaveiculo 
                                      ,s123_v_acompanhante 
                                      ,s123_v_tipodoc 
                                      ,s123_v_documento 
                       )
                values (
                                $this->s123_i_codigo 
                               ,$this->s123_i_agendaveiculo 
                               ,'$this->s123_v_acompanhante' 
                               ,'$this->s123_v_tipodoc' 
                               ,'$this->s123_v_documento' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->s123_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2517,14309,'','".AddSlashes(pg_result($resaco,0,'s123_i_agendaveiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($s123_i_codigo=null) { 
      $this->atualizacampos();
     $sql = " update sau_agendaveiculocia set ";
     $virgula = "";
     ...
     if(trim($this->s123_i_agendaveiculo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculo"])){ 
       $sql  .= $virgula." s123_i_agendaveiculo = $this->s123_i_agendaveiculo ";
       $virgula = ",";
       if(trim($this->s123_i_agendaveiculo) == null ){ 
         $this->erro_sql = " Campo Agenda Veículo nao Informado.";
         $this->erro_campo = "s123_i_agendaveiculo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     $sql .= " where ";
     if($s123_i_codigo!=null){
       $sql .= " s123_i_codigo = $this->s123_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->s123_i_codigo));
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["s123_i_agendaveiculo"]) || $this->s123_i_agendaveiculo != "")
           $resac = db_query("insert into db_acount values($acount,2517,14309,'".AddSlashes(pg_result($resaco,$conresaco,'s123_i_agendaveiculo'))."','$this->s123_i_agendaveiculo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Agenda Externa CIA nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->s123_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Agenda Externa CIA nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->s123_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($s123_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($s123_i_codigo));
     }else{ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2517,14309,'','".AddSlashes(pg_result($resaco,$iresaco,'s123_i_agendaveiculo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     $sql = " delete from sau_agendaveiculocia
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($s123_i_codigo != ""){
          ...
          $sql2 .= " s123_i_codigo = $s123_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Agenda Externa CIA nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$s123_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Agenda Externa CIA nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$s123_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:sau_agendaveiculocia";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $s123_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from sau_agendaveiculocia ";
     $sql .= "      inner join sau_agendaveiculo  on  sau_agendaveiculo.s121_i_codigo = sau_agendaveiculocia.s123_i_agendaveiculo";
     $sql .= "      inner join   on  . = sau_agendaveiculocia.s123_i_agendaveiculo";
     ...
     if($dbwhere==""){
       if($s123_i_codigo!=null ){
         $sql2 .= " where sau_agendaveiculocia.s123_i_codigo = $s123_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
