  ...
  <body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1">
    ...
    <form name="form1" METHOD="POST" action="">
      ...
      <fieldset style="width:95%;height:450">
        <legend><b>Importação de Aproveitamento - Aluno: <?= $ed56_i_aluno ?> - <?= $ed47_v_nome ?></b></legend>
  ...
  for ($x = 0; $x < count($periodos); $x++) {
    ...
    for ($r = 0; $r < count($regencias); $r++) {
      ...
      foreach ($aElementosOrigem as $oAvaliacaoPeriodicaOrigem) {
        ...
        if (
          $oAvaliacaoPeriodicaOrigem instanceof AvaliacaoPeriodica
      ...
      foreach ($aElementosRegencia as $oAvaliacaoPeriodicaRegencia) {
        ...
        if (
          $oAvaliacaoPeriodicaRegencia instanceof AvaliacaoPeriodica
