...
class M16002CriaDiarioAlunoAnosAnteriores extends PostgresMigration
{
    /**
     * Cria DiarioAluno para todos alunos de turmas anteriores a 2020 e Atualiza Resultado Final
     */
    public function change()
    {
        $sql = "drop table if exists w_alunos;
 ...
 from alunos
                ...
                ) update diarioalunoresultadofinal set ed165_resultado_final = rf from resultados where ed165_diarioaluno = nextval;
            ";
        $this->execute($sql);
    }
}
