...
function js_pesquisave62_veicmotoristas(lMostra) {
  ...
  js_OpenJanelaIframe( 'CurrentWindow.corpo.iframe_veicmanut',
...
function js_mostraveiculos(chave,erro){
  ...
  if(erro==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmanut','db_iframe_veiculos','func_veiculos.php?sigla=true&pesquisa_chave='+document.form1.ve62_veiculos.value+'&funcao_js=parent.js_mostraveictipoabast','Pesquisa de Veículo',false);
  }
}
function js_mostraveiculos1(chave1,chave2){
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmanut','db_iframe_veiculos','func_veiculos.php?sigla=true&pesquisa_chave='+document.form1.ve62_veiculos.value+'&funcao_js=parent.js_mostraveictipoabast','Pesquisa de Veículo',false,'0');
  db_iframe_veiculos.hide();
}
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmanut','db_iframe_veicmanut','func_veicmanut.php?funcao_js=parent.js_preenchepesquisa|ve62_codigo','Pesquisa de Manutenção',true,'0');
}
...
function js_pesquisa_medida() {
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmanut', 'db_iframe_proximamedida',
    'func_veiculos_medida.php?metodo=proximamedida&veiculo='+document.form1.ve62_veiculos.value+
                                                '&data='+databanco+
                                                '&manutencao='+manutencao, 'Pesquisa Proxima Medida', false);
  return true;
}
