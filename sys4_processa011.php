...
include(modification("classes/db_db_sysarqarq_classe.php"));
        ...
        <table width='100%' cellspacing="2" cellpadding="0" bgcolor="#cccccc">
            ...
            <tr>
                ...
                <td>Gerando Itens Menu ...
                    <input name="Seleciona" onClick="js_pesquisa();" accesskey="s" type="button" id="seleciona"
                           value="Seleciona">
                </td>
                <td>
        ...
        function processa_rotina() {
            ...
            if (document.getElementById('g_aba').checked == true) {
                ...
                if (codfilhos == '') {
                    ...
                    document.getElementById('processa008').src = 'sys4_processa008.php?codarq=' +
            ...
            if (document.getElementById('g_estrut').checked == true) {
                document.getElementById('processa002').src = 'sys4_processa002.php?codarq=' +
            ...
            if (document.getElementById('g_item').checked == true)
                document.getElementById('processa007').src = 'sys4_processa007.php?codarq=' +
                    document.form1.arquivo.value + '&itemmenu=' + document.getElementById('caditem').value +
                    '&modulomenu=' + document.getElementById('cadmodulo').value;
