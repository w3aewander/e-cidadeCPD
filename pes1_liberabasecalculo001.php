...
require_once(modification("classes/db_rhempenhofolharhemprubrica_classe.php")); //$oRhEmpenhoFolhaEmpRubrica
require_once(modification("classes/db_rhempenhofolhaempenho_classe.php")); // $oEmpFolhaEmpenho
require_once(modification("classes/db_rhempenhofolha_classe.php")); //$oEmpenhoFolha
