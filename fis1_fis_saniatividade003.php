  ...
  if($clsaniatividade->numrows == 0){
    ...
    if($clsanitario->numrows > 0){
      ...
      if($y80_dtbaixa == ""){
        ...
        echo "
	     <script>
	     parent.iframe_sanitario.location.href='fis1_fis_sanitario002.php?chavepesquisa=$y83_codsani';\n
	     </script>
	     ";
      }
    }
	...
	<tr>
		...
		if((isset($HTTP_POST_VARS["opcaoExec"]) && $HTTP_POST_VARS["opcaoExec"])=="Excluir"){
		  if($clsaniatividade->erro_status=="0"&&$sqlerro==true){
		    ...
		    echo"<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=".$y83_codsani."&abas=1'</script>;\n";
		  }else{
		    db_msgbox($erro_msg);
		    //$clsaniatividade->erro(true,false);
		    echo"<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade001.php?y83_codsani=".$y83_codsani."&abas=1'</script>;\n";
