  ...
  <tr>
     ...
     <?php
       ...
       $clcriaabas->title      = array( "issbase"    => "Manutenção de inscrição",
                                        ...
                                        "caracteristicas" => "Informações Complementares",
                                        "anexos"     => "Anexos",
                                        "endereco" => "Manutenção de Endereço"
                                       );//nome do iframe e o label
...
if($db_opcao==1){
  echo "
	 ...
	 <script>
      ...
      document.formaba.anexos.disabled=true;
      document.formaba.endereco.disabled=true;
	   }
	   js_src();
         </script>
       ";
  ...
  echo "
     ...
     function js_src(){
      ...
      document.formaba.endereco.disabled=false;
      ...
      iframe_anexos.location.href=\"iss1_anexos001.php?aba=1&q123_inscr=$q02_inscr\";\n
      iframe_endereco.location.href=\"iss1_issbaseendereco001.php?inscricao=$q02_inscr\";\n
  ...
  echo "
      ...
      iframe_anexos.location.href=\"iss1_anexos001.php?aba=1&q123_inscr=$q02_inscr\";\n
	    iframe_endereco.location.href=\"iss1_issbaseendereco001.php?inscricao=$q02_inscr&db_opcaoal=3\";\n
      }
	   js_src();
         </script>
       ";
