...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
     ...
     <?php
       ...
       $clcriaabas->src = array("fandam"=>"fis3_fis_fandam001.php?abas=1","fiscais"=>"fis3_fis_fandamusu001.php?primeira=1");
...
if(isset($db_opcao) && $db_opcao==2){
  echo "
         <script>
	   function js_src(){
            iframe_fandam.location.href='fis3_fis_fandam002.php?abas=1&db_opcao=22';\n
	   }
	   js_src();
         </script>
       ";
...
echo "
         <script>
	   function js_src(){
            iframe_fandam.location.href='fis3_fis_fandam003.php?abas=1';\n
