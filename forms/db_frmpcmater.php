...
$vaiIframe = "";
//var_dump(db_getsession("DB_id_usuario"));
?>
<script>
function js_troca(){
...
<table border="0">
  ...
  <tr>
    ...
    <td> 
    <? //db_input('pc01_descrmater',78,$Ipc01_descrmater,true,'text',$db_opcao,"") ?>
    <? db_textarea('pc01_descrmater',0,78,$Ipc01_descrmater,true,'text',$db_opcao,"") ?>    
...
?>
  <input type="hidden" name="cid" id="cid" value="<?=$idusuario?>">    

    <select name="pc01_servico" id="pc01_servico" onchange="aviso()">
      <?php if($pc01_codgrupo == 7 || $pc01_codgrupo == 11 || $pc01_codgrupo == 12) : ?>
        <option value="f" selected>Não</option>
        <?php else : ?>
          <option value="f" <?=($pc01_servico == "f") ? "selected" : "" ?>>Não</option>
        <?php endif; ?>
      <option value="t" <?=($pc01_servico == "t") ? "selected" : "" ?>>Sim</option>
    </select>

<script>
  function aviso(){
    var id = document.getElementById("cid").value;
    if(id != 1 && id != 60 && id != 412 && id != 1413){
      alert("Contactar suporte e-Cidade");
      document.getElementById("pc01_servico").value = "f";
      document.getElementById("pc01_servico").disabled = "true";
    }    
  }
</script>
...
<?
/*SELECIONA USUÁRIOS QUE PODEM INCLUIR MATERIAL*/
//if ( db_getsession("DB_cgm") == 1          //usuario
  if ( db_getsession("DB_id_usuario") == 1          //usuario
  //or db_getsession("DB_id_usuario") == 1   //usuario
  or db_getsession("DB_id_usuario") == 14  //usuario
  or db_getsession("DB_id_usuario") == 15  //usuario
  or db_getsession("DB_id_usuario") == 60  //usuario
  or db_getsession("DB_id_usuario") == 133 //usuario
  or db_getsession("DB_id_usuario") == 309 //tania.saar - TANIA FERREIRA SAAR
  or db_getsession("DB_id_usuario") == 412 //usuario
  or db_getsession("DB_id_usuario") == 816 //usuario
  or db_getsession("DB_id_usuario") == 907 //usuario
  or db_getsession("DB_id_usuario") == 370 //usuario
  or db_getsession("DB_id_usuario") == 987 //usuario
  or db_getsession("DB_id_usuario") == 967
  or db_getsession("DB_id_usuario") == 1001
  or db_getsession("DB_id_usuario") == 916
  or db_getsession("DB_id_usuario") == 558
  or db_getsession("DB_id_usuario") == 1413
  or db_getsession("DB_id_usuario") == 4239
  or db_getsession("DB_id_usuario") == 929
  ) 
{
?>
