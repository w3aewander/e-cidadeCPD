...
ALTER TABLE far_matersaude drop column if exists fa01_medicamentos;
...
drop index if exists prontprofatend_rhcbo_in;
ALTER TABLE prontprofatend DROP CONSTRAINT if exists prontprofatend_rhcbo_fk;
alter table prontprofatend drop COLUMN if exists s104_rhcbo;
...
select fc_executa_ddl('alter table condicionante add am10_tipolicenca int4 default 0');

select fc_executa_ddl('ALTER TABLE condicionante
...
alter table veicretirada drop column if exists ve60_passageiro;