...
function js_emite(){
  ...
  qry += "&aniversario="+document.form1.aniversario.value;
  jan = window.open('outros_itaqui002.php'+qry,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
</script>  
  ...
  <table  align="center" >
    <form name="form1" method="post" action="" onsubmit="return js_verifica();">
      ...
      <tr>
        ...
        <td >
         <?
           db_input('aniversario',2,'',true,'text',2,'')
         ?>
