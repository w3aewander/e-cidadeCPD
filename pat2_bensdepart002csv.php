...
if($reavaliar == 4){
  //$where .= " AND t52_valaquhist > 0 ";
  $where .= " AND t52_valaqu != t52_valaquhist AND t52_valaquhist > 0 ";
  
}

if($reavaliar == 5){
  //$where .= " AND t52_valaquhist > 0 ";
  //t52_valaquhistorico = 0 and t52_valaqu = t52_valaquhistorico
  //$where .= " AND t52_valaqu = t52_valaquhist AND t52_valaquhist = 0 ";
  //$where .= " AND t52_valaqu = t52_valaquhist ";
  $where .= " AND (t52_valaqu = t52_valaquhist OR t52_valaquhist = 0) AND t52_bem NOT IN (SELECT t55_codbem FROM bensbaix WHERE t55_codbem is not null)";
...
//var_dump($sql); die("Confere sequel");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($flag_valor == true){
    ...
    $linha2 = $t52_bem ."|;". $t52_ident ."|;". $t52_descr ."|;". $t52_dtaqu ."|;". $t52_valaqu ."|;". $num_processo_adm ."|;". $baix ."|;". $t52_depart ."|;". $descrdepto ."|;". $t30_codigo ."|;". $t30_descr . "|;" . $t52_obs ."|;".$t52_codcla ."|;". $t64_descr ."|;". $t52_valaquhist;
...
foreach ($novalinha as $linhazinha){  
  ...
  $valorhistorico = number_format($linhadentro[14], 2, '.', '');
  testa($linhadentro);
  var_dump($valorhistorico);
  echo "<hr>";
}
die("Confere");*/
//testa($novalinha[4137]);
...
print "<td>Código</td>";
print "<td>Placa</td>";
print "<td colspan='5'>Descrição</td>";
print "<td>Data Aquisição</td>";
print "<td>Vlr.Aquisição/Reavaliação</td>";
print "<td>Cod. Departamento</td>";
print "<td colspan='5'>Desc. Departamento</td>";
print "<td>Cod. Divisão</td>";
print "<td colspan='5'>Desc. Divisão</td>";
print "<td colspan='5'>OBS.:</td>";
print "<td>Baixado</td>";
print "<td>Processo</td>";

print "<td>Classificação</td>";
print "<td colspan='5'>Descrição Classificação</td>";
if($reavaliar != 5){
  print "<td>Valor Histórico de Aquisição</td>";  
}
...
$valorhistorico = number_format($linhadentro[14], 2, '.', '');
  ...
  print "<tr>";
    ...
    print "<td>" . $linhadentro[12] . "</td>";
    print "<td colspan='5'>" . $linhadentro[13] . "</td>";
    
    if($reavaliar != 5){
      print "<td>" . $valorhistorico. "</td>";
    }
  print "</tr>";
