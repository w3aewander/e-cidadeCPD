...
include(modification("classes/db_pactovalormovsolicitem_classe.php"));
include(modification("classes/db_pactovalormov_classe.php"));
include(modification("classes/db_pactovalormovempempitem_classe.php"));
include(modification("classes/db_pactovalorsaldo_classe.php"));
...
function js_incluirItens(){
  ...
  document.form1.listaitensemp.value = JSON.stringify(aListaItens);
