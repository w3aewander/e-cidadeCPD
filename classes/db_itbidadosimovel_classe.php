...
class cl_itbidadosimovel { 
   ...
   public function cl_itbidadosimovel() { 
   ...
   public function incluir ($it22_sequencial){ 
      $this->atualizacampos();
   ...
   public function alterar ($it22_sequencial=null) { 
      $this->atualizacampos();
   ...
   public function excluir ($it22_sequencial=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   public function sql_query ( $it22_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   public function sql_query_file ( $it22_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
  ...
  public function sql_query_dados( $it22_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
