...
<form name="form1" method="post" action="">
  <fieldset style="width: fit-content; margin-bottom: 5px;" class="container">
    ...
    <table border="0">
      ...
      <tr>
        <td nowrap title="<?= @$Tv11_observacao ?>">
          <?= @$Lv11_observacao ?>
        </td>
        <td>
          <?php
          db_textarea('v11_observacao', 10, 40, $Iv11_observacao, true, 'text', $db_opcao);
          ?>
        </td>
      </tr>
    </table>
