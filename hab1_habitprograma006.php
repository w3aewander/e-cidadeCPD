...
//    $sHtml .= "   (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_habitprogramalote.location.href='hab1_habitprogramalote001.php?ht05_habitprograma=".@$ht01_sequencial."';";
//  } else {
