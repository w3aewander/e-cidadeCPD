...
function js_pesquisay86_codautotipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipo','func_fis_autotipo.php?funcao_js=parent.js_mostraautotipo1|y59_codigo|y59_codigo','Pesquisa',true);
  }else{
     if(document.form1.y86_codautotipo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipo','func_fis_autotipo.php?pesquisa_chave='+document.form1.y86_codautotipo.value+'&funcao_js=parent.js_mostraautotipo','Pesquisa',false);
     }else{
...
function js_pesquisay86_codbaixaproc(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipobaixaproc','func_fis_autotipobaixaproc.php?funcao_js=parent.js_mostraautotipobaixaproc1|y87_baixaproc|y87_baixaproc','Pesquisa',true);
  }else{
     if(document.form1.y86_codbaixaproc.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipobaixaproc','func_fis_autotipobaixaproc.php?pesquisa_chave='+document.form1.y86_codbaixaproc.value+'&funcao_js=parent.js_mostraautotipobaixaproc','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotipobaixa','func_fis_autotipobaixa.php?funcao_js=parent.js_preenchepesquisa|y86_codautotipo','Pesquisa',true);
}
