...
if (!isset($r54_codrel) && isset($convenio)) {
    $r54_codrel = $convenio;
}

if (!isset($r54_codeve) && isset($relacionamento)) {
    $r54_codeve = $relacionamento;
}

$r54_codrel = trim($r54_codrel);
$r54_codeve = trim($r54_codeve);

if (isset($r54_codrel) && $r54_codrel != "") {
    $dbwhere .= " and trim(r54_codrel) = '".$r54_codrel."' ";
...
if (isset($r54_codeve) && $r54_codeve != "") {
    $dbwhere .= " and trim(r54_codeve) = '".$r54_codeve."' ";
...
for ($i = 0; $i < $numrows_dados;$i++) {
    ...
    if ($pdf->gety() > $pdf->h - 30 || $troca != 0 ) {
        $pdf->addpage();
        $pdf->setfont('arial','b',8);
        $pdf->cell(15,$alt,"Convênio",1,0,"C",1);
        $pdf->cell(23,$alt,"Relacionamento",1,0,"C",1);
        $pdf->cell(18,$alt,"Matrícula",1,0,"C",1);
        $pdf->cell(60,$alt,"Servidor",1,0,"C",1);
        $pdf->cell(15,$alt,"Qtd/Vlr 1",1,0,"C",1);
        $pdf->cell(15,$alt,"Qtd/Vlr 2",1,0,"C",1);
        $pdf->cell(15,$alt,"Qtd/Vlr 3",1,0,"C",1);
        $pdf->cell(14,$alt,"Lançado",1,0,"C",1);
    ...
    $pdf->cell(23,$alt,$r54_codeve,1,0,"C",0);
    ...
    $pdf->cell(14,$alt,$r54_lancad,1,0,"C",0);
    $pdf->cell(15,$alt,db_formatar($rh05_recis,"d"),1,1,"C",0);
...
$pdf->ln(1);
$pdf->cell(111,$alt,'Quantidade total  :  ',"TB",0,"L",1);
