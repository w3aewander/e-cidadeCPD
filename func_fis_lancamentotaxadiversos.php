...
include(modification("classes/db_fis_lancamentotaxadiversos_classe.php"));
...
$cllancamentotaxadiversos = new cl_fis_lancamentotaxadiversos;
?>
<html>
<head>
...
if(!isset($pesquisa_chave)){
  if(isset($campos)==false){
    if(file_exists("funcoes/db_func_fis_lancamentotaxadiversos.php")==true){
      include(modification("funcoes/db_func_fis_lancamentotaxadiversos.php"));
    }else{
      $campos = "fis_lancamentotaxadiversos.*";
    }
  }
