...
class cl_inicialpartilhacustas extends DAOBasica
{
    ...
    public function sql_query_recibo_custas($v36_numnov, $inicial = null)
    {
        ...
        $sSql .= "        v36_taxa as taxa,                                                          ";
        $sSql .= "        v36_dispensalancamentorecibo as dispensalancamentorecibo,                  ";
        $sSql .= "        ar36_receita as receita,                                                   ";
        $sSql .= "        ar36_descricao as descricao,                                               ";
        $sSql .= "        v35_tipolancamento as tipolancamento                                       ";
        $sSql .= "   FROM (SELECT v36_valor AS valor,                                                ";
        $sSql .= "                v36_taxa,                                                          ";
