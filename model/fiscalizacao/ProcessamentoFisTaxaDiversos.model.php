 ...
 */
class ProcessamentoFisTaxaDiversos
{
   ...
   * @return \ProcessamentoFisTaxaDiversos
   */
  public static function getInstance()
  {
    if(empty(self::$instance)) {
      self::$instance = new ProcessamentoFisTaxaDiversos;
    }
  ...
  protected function persisteTabelaArrecad() {
    ...
    if (pg_num_rows($rsArrecad) == 0 ) {
      throw new BusinessException(_M("tributario.diversos.db_frmdiversosalt.erro_geracao_diverso"));
    }
