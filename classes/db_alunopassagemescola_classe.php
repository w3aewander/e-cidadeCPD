...
class cl_alunopassagemescola { 
   ...
   function incluir ($ed226_i_codigo){ 
     ...
     if($ed226_i_codigo == "" || $ed226_i_codigo == null ){
       $result = @db_query("select nextval('alunopassagemescola_ed226_i_codigo_seq')"); 
       if($result==false){
       ...
       $result = @db_query("select last_value from alunopassagemescola_ed226_i_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,1940,11279,'','".AddSlashes(pg_result($resaco,0,'ed226_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1940,11280,'','".AddSlashes(pg_result($resaco,0,'ed226_i_alunopassagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1940,11281,'','".AddSlashes(pg_result($resaco,0,'ed226_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed226_i_codigo"]))
           $resac = db_query("insert into db_acount values($acount,1940,11279,'".AddSlashes(pg_result($resaco,$conresaco,'ed226_i_codigo'))."','$this->ed226_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed226_i_alunopassagem"]))
           $resac = db_query("insert into db_acount values($acount,1940,11280,'".AddSlashes(pg_result($resaco,$conresaco,'ed226_i_alunopassagem'))."','$this->ed226_i_alunopassagem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ed226_i_escola"]))
           $resac = db_query("insert into db_acount values($acount,1940,11281,'".AddSlashes(pg_result($resaco,$conresaco,'ed226_i_escola'))."','$this->ed226_i_escola',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @db_query($sql);
     if($result==false){ 
   ...
   function excluir ($ed226_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,1940,11279,'','".AddSlashes(pg_result($resaco,$iresaco,'ed226_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1940,11280,'','".AddSlashes(pg_result($resaco,$iresaco,'ed226_i_alunopassagem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1940,11281,'','".AddSlashes(pg_result($resaco,$iresaco,'ed226_i_escola'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
