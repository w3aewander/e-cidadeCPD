  ...
  <div class="container">
    <form name="form1" method="post">
      <table align="center" border="0" cellspacing="4" cellpadding="0">
        ...
        <tr>
          <td>
            <label class='bold m-2'>Filtro:</label>
          </td>
          <td>
            <select id="filtro" name="select">
              <option selected value="1">Todos</option>
              <option value="2">Portaria Emitida</option>
      ...
      <button type="button" onClick="js_imprimir()" class="m-2"> Emitir Relatorio</button>
    </form>
...
<script>
  ...
  function js_imprimir() {
      ...
      let object = {
        tipo:'relatorio',
        filtro: jQuery('#filtro').change().val(),
        matricula: jQuery('#rh01_regist').val(),
        rh500_sequencial: jQuery('#h12_codigo').val(),
      }
      
      openWindowWithPost("rec2_relatorioconcessao001.php", {
