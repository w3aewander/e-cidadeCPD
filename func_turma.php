      ...
      <?
        if ( !isset( $pesquisa_chave ) ) {
          ...
          if ( $pesquisa_chave != null && $pesquisa_chave != "" ) {
             ...
             * 
             * Correção:
             *  Removi os campos ed11_i_ensino,ed11_i_sequencia do ORDER BY 
             *  porque eles são referentes a tabela seria que não está mencionada 
             *  no sql.
             */
            $result = $clturma->sql_record($clturma->sql_query(null, "*","ed57_c_descr"," ed52_c_passivo = 'N' AND ed57_i_codigo = $pesquisa_chave AND ed57_i_escola = $escola"));
