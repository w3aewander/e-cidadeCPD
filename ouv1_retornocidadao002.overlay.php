...
<script>
        ...
        function (oAtendimento,iInd){
          with(oAtendimento){
            ...
            if ( eval(tiporetorno) ) {
	          ...
	          aRow[4]  = "<input type='button' value='Retorno' "+sClass+" onClick='js_retornoAtendimento("+ov01_sequencial+", "+$F('p58_codproc')+");' "+sDisabled+" />";
  ...
  function js_retornoAtendimento(iCodAtendimento, iCodProcesso){
    js_OpenJanelaIframe('','db_iframe_retorno','ouv1_retornocidadao003.php?iCodAtendimento='+iCodAtendimento + '&iCodProcesso=' + iCodProcesso,'Retorno Atendimento',true);
  }
