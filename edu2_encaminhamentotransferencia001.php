...
<html>
<head>
  <title>FHSYS Solu&ccedil;&otilde;es em TI Ltda - P&aacute;gina Inicial</title>
...
<body bgcolor="#cccccc" style='margin-top: 30px'>
  ...
  <div class='container'>
    <form id='formPadrao' action="">
      <fieldset>
        <legend>Encaminhamento de Transferência</legend>
        ...
        <fieldset class='separator'>
          ...
          <textarea id='observacao' rows="5" maxlength="700" style="width: 100%;"></textarea>  
        </fieldset>
      </fieldset>
...
$('imprimir').observe("click", function() {
  ...
  var sUrl  = "edu2_encaminhamentotransferencia002.php";
