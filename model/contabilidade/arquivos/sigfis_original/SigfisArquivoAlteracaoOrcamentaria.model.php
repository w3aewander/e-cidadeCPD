...
class SigfisArquivoAlteracaoOrcamentaria extends SigfisArquivoBase implements iPadArquivoTXTBase {
  ...
  public function gerarDados() {
    ...
    $sSqlDecreto .= "        min(o45_descr) as descricao_lei,	                                                        ";
    $sSqlDecreto .= "        min(o39_numero)    as num_decreto, 			                                                      ";    
    $sSqlDecreto .= "        min(o39_data)      as data_decreto, 		                                                      ";
    $sSqlDecreto .= "        min(o39_descr)     as descricao,    		                                                      ";
    $sSqlDecreto .= "        min(o46_codsup)    as codsup, 					                                                      ";
    $sSqlDecreto .= "  case WHEN o47_valor < 0 THEN 19 when o46_tiposup = 1001 then 6 when o46_tiposup = 1002 then 15 when o46_tiposup = 1003 then 12 when o46_tiposup = 1004 then 9 when o46_tiposup = 1005 then 18 when o46_tiposup = 1006 then 4 when o46_tiposup = 1007 then 13 when o46_tiposup = 1008 then 10 when o46_tiposup = 1009 then 7 when o46_tiposup = 1010 then 16 when o46_tiposup = 1011 then 5 when o46_tiposup = 1012 then 21 when o46_tiposup = 1013 then 22 when o46_tiposup = 1014 then 20 when o46_tiposup = 1015 then 6 when o46_tiposup = 1016 then 20 end as tipo_credito, 		                                                      ";
    $sSqlDecreto .= "        min(o46_obs) as sinopse, 				                                                        ";
//    $sSqlDecreto .= "        o58_coddot    as dotacao, 				                                                        ";
    ...
    $sSqlDecreto .= "        sum(abs(o47_valor)) as valor_suplementado,		                                                ";
    $sSqlDecreto .= "        to_char(o49_data,'YYYYmm') as competencia,                                               ";
    $sSqlDecreto .= "        min(o49_data) as data_alteracao                                                          ";
    ...
    $sSqlDecreto .= " group by                                                                                        ";
    $sSqlDecreto .= "        o45_numlei    ,                                                                          ";
    $sSqlDecreto .= "        o45_dataini   , 	   			                                                                ";
//    $sSqlDecreto .= "        o39_numero    , 			                                                                    ";
//    $sSqlDecreto .= "        o39_data      , 		                                                                      ";
////    $sSqlDecreto .= "        o46_codsup    , 					                                                                ";
    $sSqlDecreto .= "8,                    ";
//    $siSqlDecreto .= "        o58_coddot    , 				                                                                  ";
    $sSqlDecreto .= "        o58_projativ  ,					                                                                ";
    $sSqlDecreto .= "        o55_tipo      ,			                                                                    ";
    $sSqlDecreto .= "        o58_funcao    ,						                                                              ";
    $sSqlDecreto .= "        o58_orgao     , 																																          ";
    $sSqlDecreto .= "        o58_subfuncao ,				                                                                  ";
    $sSqlDecreto .= "        o58_unidade   ,					                                                                ";
    $sSqlDecreto .= "        o56_elemento  ,					                                                                ";
    $sSqlDecreto .= "        o58_codigo    ,					                                                                ";
    $sSqlDecreto .= "        o58_programa  ,					                                                                ";
    $sSqlDecreto .= "        to_char(o49_data,'YYYYmm')                                                               ";
//    $sSqlDecreto .= "        o49_data                                                                                 ";

//    $sSqlDecreto .= "  order by o45_numlei,o45_dataini,o39_numero,o39_data 																					  ";

//    die( $sSqlDecreto );
//$this->addLog($sSqlDecreto);
    ...
    for ($iSuplementacao = 0; $iSuplementacao < pg_num_rows($rsDecretos); $iSuplementacao++) {
      ...
      if ( $this->formataValor($oDadosSuplementacao->valor_suplementado ) < 0 ) {
        ...
        $iTipoSuplementacao = $oDadosSuplementacao->tipo_credito;
      }
      
      if ($iTipoSuplementacao != '0') {
        
        if ($oVinculo = SigfisVinculoRecurso::getVinculoRecurso($oDadosSuplementacao->recurso) or true) {
...
//          $UnidadeOrcamentaria  = str_pad($oDadosSuplementacao->orgao, 2, '0', STR_PAD_LEFT);
          ...
          if ($oDadosSuplementacao->tipo_projeto == 0 or $oDadosSuplementacao->tipo_projeto == 9) $oDadosSuplementacao->tipo_projeto = 3;

          $oSuplementacao->codigolinha             = 408;
          $oSuplementacao->cd_Unidade              = str_pad($this->sCodigoTribunal,             4, '0', STR_PAD_LEFT); 
          $oSuplementacao->nu_ProjetoAtividade     = str_pad(substr($oDadosSuplementacao->projativ,-3),4, " ", STR_PAD_LEFT);
          ...
          $oSuplementacao->dt_Ano                  = str_pad($this->iAnoUso,4,' ',STR_PAD_LEFT); 
          ...
          $oSuplementacao->dt_Alteracao            = str_pad($dtDataAlteracao,8,' ',STR_PAD_LEFT);
          ...
          $oSuplementacao->dt_Fundamento           = str_pad($dtDataDecreto,8,' ',STR_PAD_LEFT );
          ...
          $oSuplementacao->dt_leiautorizativa      = str_pad($dtDataLei,8,' ', STR_PAD_LEFT);
          $oSuplementacao->cd_Orgao                = str_pad($oDadosSuplementacao->orgao, 4, ' ', STR_PAD_LEFT);
          $oSuplementacao->nu_DiarioOficial        = str_pad($dtDataAlteracao,8,' ', STR_PAD_LEFT);
