...
use ECidade\Financeiro\Orcamento\Recurso\Origem as OrigemComplementoRecurso;
...
class ReceitaPlanilha
{
    ...
    public function __construct($iCodigo = null)
    {
        ...
        if (!empty($iCodigo)) {
            ...
            $oDaoReceitaPlanilha = new cl_placaixarec;
            ...
            if ($rsReceitaPlanilha && $oDaoReceitaPlanilha->numrows > 0) {
                ...
                /**
                 * busca o recurso da receita
                 */
                $receitaDao = new cl_tabrec();
                $sql = $receitaDao->sql_query_instComplementoFonteRecurso($oReceitaPlanilha->k81_receita , "*", null, null);
                $rsRecursoReceita = $receitaDao->sql_record($sql);
                if ($receitaDao->numrows <= 0) {
                    throw new BusinessException("Erro ao Buscar o Recurso da Receita.");
                }

                $recursoReceita = db_utils::fieldsMemory($rsRecursoReceita, 0)->db_id_recurso;
                ...
                $this->oRecurso = new Recurso($recursoReceita);
                ...
                $this->iComplementoRecurso = '0';
                $origem = OrigemComplementoRecurso::getPlanilhaArrecadacao($oReceitaPlanilha->k81_seqpla);
                if (!empty($origem)) {
                    $this->iComplementoRecurso = $origem->o200_sequencial;
                }
            }
        }
    ...
    /**
     * @param $iComplementoRecurso
     */
    public function setComplementoRecurso($iComplementoRecurso)
    {
        $this->iComplementoRecurso = $iComplementoRecurso;
    }

    /**
     * @return int
     */
    public function getComplementoRecurso()
    {
        return $this->iComplementoRecurso;
    }
    ...
    public function salvar($iCodigoPlanilha)
    {
        ...
        OrigemComplementoRecurso::setPlanilhaReceita(
            $this->iCodigo,
            $this->oRecurso->getCodigo(),
            $this->iComplementoRecurso
        );
        return true;
    }
    ...
    protected function vinculaComMatricula()
    {
        ...
        $oDaoReceitaMatricula = new cl_placaixarecmatric;
    ...
    protected function vincularComInscricao()
    {
        ...
        $oDaoReceitaInscricao = new cl_placaixarecinscr;
