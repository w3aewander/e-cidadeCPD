...
if(isset($emite)){
  ...
  $clsql->usar_ger  = true;
  $sqlValors = $clsql->gerador_sql($siglas, $ano, $mes, null, null, "coalesce(sum(#s#_valor),0)", "", "#s#_pd not in (3,4,5) and #s#_pd = 1 and #s#_regist = rh01_regist ");
  $sqlValorc = $clsql->gerador_sql($siglac, $ano, $mes, null, null, "coalesce(sum(#s#_valor),0)", "", "#s#_pd not in (3,4,5) and #s#_pd = 1 and #s#_regist = rh01_regist ");
