...
$lExibirApenasColunasDescricao = false;
if(!empty($_GET['lExibirApenasColunasDescricao'])) {
    $lExibirApenasColunasDescricao = true;
}
...
if (pg_numrows($result) != 0) {
    ...
    $sSqlIptucalcpadrao = " SELECT j10_vlrter , j11_vlrcons FROM iptucalcpadrao  INNER JOIN iptucalcpadraoconstr 
                          on iptucalcpadraoconstr.j11_iptucalcpadrao = iptucalcpadrao.j10_sequencial
                            where  j10_matric  = {$parametro} AND j10_anousu = {$iAnoAtual} ";
    ...
    ?>
        <fieldset>
            ...
            <table id='dadosCalculo'>
                ...
                <tr>
                    <td colspan="3" class="field-size2"></td>
                    <td nowrap class='bold'>Valor Venal Forçado Terreno:</td>
                    <td> <?= db_formatar(($oIptucalcpadrao->j10_vlrter), 'f') ?></td>
                </tr>
                <tr>
                    <td colspan="3" class="field-size2"></td>
                    <td nowrap class='bold'>Valor Venal Forçado Edific.:</td>
                    <td> <?= db_formatar($oIptucalcpadrao->j11_vlrcons, 'f') ?></td>
                </tr>
             ...
             <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
                <tr align="center">
                    ...
                    <td  align="left" colspan="3">
                        <?= !empty($dadosTestada->endereco_completo) ? $dadosTestada->endereco_completo : '' ?>
                    </td>
                </tr>
            </table>
            <?php
        ...
        <div id='aba2'>
            ...
            <legend>Lote</legend>
                ...
                if (!$rsLote || $totalLinhasLote == 0) {
                    ...
                    $dadosLote = db_utils::fieldsMemory($rsLote, 0);
                ?>

                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
                    <tr align="center">

                        <td align="left" nowrap><b>Setor:</b>
                        </td>
                        <td width="30%" align="left" nowrap>
                            <?= $dadosLote->setor ?>
                        </td>
                        <td align="left" nowrap><b>Quadra de Localização:</b>
                        </td>
                        <td width="30%" align="left" nowrap>
                            <?= $dadosLote->quadra_localizacao ?>
                        </td>
                    </tr>
                    <tr align="center">
                        ...
                        <td align="left" nowrap><b>Lote de Localização:</b>
                        </td>
                        <td width="30%" align="left" nowrap>
                            <?= $dadosLote->lote_localizacao ?>
                        </td>
                    </tr>
                    <tr align="center">
                    ...
                    <table width="95%" border="0" align="center" cellpadding="1" cellspacing="2" class='caracteristicas'>
                        ...
                        <tr align="center" bgcolor="#CCCCCC">
                            ...
                            <?php if($lExibirApenasColunasDescricao): ?>
                                <th align="left" nowrap colspan="2">Grupo</th>
                            <?php else: ?>
                                <th align="left" nowrap>Grupo</th>
                            <?php endif; ?>
                                
                            <?php if($lExibirApenasColunasDescricao): ?>
                                <th align="left" nowrap style="display: none">Descri&ccedil;&atilde;o</th>
                            <?php else: ?>
                                <th align="left" nowrap>Descri&ccedil;&atilde;o</th>
                            <?php endif; ?>
                                
                            <?php if($lExibirApenasColunasDescricao): ?>
                                <th nowrap style="display: none">C&oacute;digo</th>
                            <?php else: ?>
                                <th nowrap>C&oacute;digo</th>
                            <?php endif; ?>
                                
                            <?php if($lExibirApenasColunasDescricao): ?>
                                <th align="left" nowrap colspan="2">Característica</th>
                            <?php else: ?>
                                <th align="left" nowrap>Descri&ccedil;&atilde;o</th>
                            <?php endif; ?>
                        ...
                        foreach ($caracteristicas as $dadosCaracteristica) {
                            ...
                            <tr align="center" class="<?= $estiloCaracteristica ?>">
                                ...
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <td width="34" align="right" nowrap style="display: none;">
                                <?php else: ?>
                                ...
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <td width="215" align="left" nowrap colspan="2">
                                <?php else: ?>
                                ...
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <td width="51" style="display: none;">
                                <?php else: ?>
                                    <td width="51">
                                <?php endif; ?>
                                ...
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <td width="171" align="left" nowrap colspan="2">
                                <?php else: ?>
                ...
                for ($i = 0; $i < $totalLinhas; $i++) {
                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
                        ...
                        <tr align="center">
                            ...
                            <td align="left" nowrap><b>Pavimento:</b>
                            </td>
                            <td align="left" colspan="3">
                                <?= $dadosConstrucao->pavimentos ?>
                            </td>
                        </tr>
                        <tr align="center">
                            ...
                            <td  align="left" colspan="3">
                                <?= !empty($dadosConstrucao->endereco_completo) ? $dadosConstrucao->endereco_completo : '' ?>
                            </td>
                        </tr>
                    </table>
                    ...
                    <fieldset class="separator">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1"
                            ...
                            <tr style="font-weight:bold">
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <th align="center" colspan="2">Grupo</th>
                                <?php else: ?>
                                    <th align="center">Grupo</th>
                                <?php endif; ?>
                                    
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <th align="center" style="display: none">Descrição</th>
                                <?php else: ?>
                                    <th align="center">Descrição</th>
                                <?php endif; ?>
                                    
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <th width="17%" nowrap style="display: none">Código</th>
                                <?php else: ?>
                                    <th width="17%" nowrap>Código</th>
                                <?php endif; ?>
                                    
                                <?php if($lExibirApenasColunasDescricao): ?>
                                    <th width="50%" nowrap colspan="2">&nbsp;Caracter&iacute;sticas</th>
                                <?php else: ?>
