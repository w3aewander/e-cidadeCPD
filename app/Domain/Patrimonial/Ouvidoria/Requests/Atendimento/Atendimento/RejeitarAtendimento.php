...
class RejeitarAtendimento extends BaseFormRequest
{
    /**
     * @return bool
     */
    ...
    public function messages()
    {
        return [
            ...
            "motivo.required" => utf8_encode("Motivo não informado."),
            "motivo.filled" => utf8_encode("O motivo informado está vazio."),
