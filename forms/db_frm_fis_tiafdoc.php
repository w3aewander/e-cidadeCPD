...
function js_pesquisay99_codtiaf(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiaf','func_fis_tiaf.php?funcao_js=parent.js_mostratiaf1|y90_codtiaf|y90_codtiaf','Pesquisa',true);
  }else{
     if(document.form1.y99_codtiaf.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiaf','func_fis_tiaf.php?pesquisa_chave='+document.form1.y99_codtiaf.value+'&funcao_js=parent.js_mostratiaf','Pesquisa',false);
     }else{
...
function js_pesquisay99_tiafdoc(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafdoc','func_fis_tiafdoc.php?funcao_js=parent.js_mostratiafdoc1|y99_coddoc|y99_coddoc','Pesquisa',true);
  }else{
     if(document.form1.y99_tiafdoc.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafdoc','func_fis_tiafdoc.php?pesquisa_chave='+document.form1.y99_tiafdoc.value+'&funcao_js=parent.js_mostratiafdoc','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tiafdoc','func_fis_tiafdoc.php?funcao_js=parent.js_preenchepesquisa|y99_coddoc','Pesquisa',true);
}
