...
use ECidade\Financeiro\Contabilidade\Exportacao\Sigap\ComplementoRecurso as ComplementoRecurso;
...
final class PadArquivoSigapEmpenho extends PadArquivoSigap
{
    ...
    public function gerarDados()
    {
        ...
        $sSqlEmpenho .= "        (case when c53_tipo = 10 then '+' else '-' end)::char(1) as sinal, ";
        ...
        for ($i = 0; $i < $iTotalLinhas; $i++) {
            ...
            if ($oEmpenhoRetorno->empModalLicitacao == '00') {
                $oEmpenhoRetorno->empModalLicitacao = '99';
            }
