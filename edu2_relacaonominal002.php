...
use ECidade\Educacao\Escola\Repository\ParametrosRepository;
...
$escola = EscolaRepository::getEscolaByCodigo($iEscola);
$parametros = ParametrosRepository::getFromEscola($escola);
...
/**
 * Data base para calculo da idade
 */
$oFiltros->dataBaseCalculoIdade = $parametros->getDataBaseCalculoIdade();
...
function cabecalhoRelatorio($oPdf, $oFiltros, $oTurma)
{
    ...
    $sDadosCabecalho .= "SECRETARIA MUNICIPAL DE EDUCAÇÃO" . "\n";
...
function corpoRelatorio($oPdf, $oFiltros, $oTurma)
{
     ...
     */
    $dtAtual = DBDate::create("{$oFiltros->dataBaseCalculoIdade}/{$oFiltros->iAno}")->getDate();
