...
$obs1                = iconv('UTF-8', 'ISO-8859-1//TRANSLIT', $obs1); 
...
//      $xdiario2["disciplina"] = retornaNomeDisciplina($linha["ed59_i_disciplina"]);
  ...
  $pdf->Ln(1);
  $pdf->setfont( 'arial', '', 10 );
  $pdf->cell(40, 4, "{$ed11_c_descr} do(a) {$ed57_c_descr}, turno(s) {$ed15_c_nome}, MATRÍCULA {$ed60_i_aluno}", 0, 0, "L", 0 );
  ...
  $pdf->setfont( 'arial', '', 10 );  
  $pdf->cell(80, 4, "{$ed47_v_ender}, {$ed47_c_numero} - {$ed47_v_complemento}", 0, 0, "L", 0 );
  ...
  $pdf->setfont( 'arial', '', 10 );  
  $pdf->cell(80, 4, "{$ed47_v_cep}", 0, 0, "L", 0 );
  ...
  $pdf->Ln(15);
  $pdf->multicell(0, 4, "Obs.: {$obs1}", 0, "L", 0 );
...
//---------------------------------------------------------	
 ...
 $pdf->cell(2, 3,'' , 0, 0, "L", 0 ); 
  ...
  {	  
     $pdf->cell( 80, 3,'________________________________________' , 0, 0, "L", 0 );
  }else{
  ...
  {	  
     $pdf->cell( 10, 3,'________________________________________' , 0, 1, "L", 0 );
  }else{
