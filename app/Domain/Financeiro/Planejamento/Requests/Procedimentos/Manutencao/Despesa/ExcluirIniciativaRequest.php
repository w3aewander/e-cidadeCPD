...
class ExcluirIniciativaRequest extends FormRequest
{
    /**
     * @return bool
     */
    ...
    {
        return [
            'pl12_codigo.integer' => 'O campo "Código" deve ser um inteiro.',
            'pl12_codigo.filled' => 'O campo "Código" deve ser preenchido.',
            'pl12_codigo.required' => 'O campo "Código" deve ser informado.',
        ];
    }
}
