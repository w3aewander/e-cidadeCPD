...
{
  /**
   * @var string $sGrupoPrincipal
  */
  public $sGrupoPrincipal = "";
  ...
  */
  ...
  public function getCgm()
  {
    ...
    foreach ($this->registro as $dadosCgm){
      ...
      $cgm->setTelefone($dadosCgm->fone1);
  ...
  public function setTipoEmpresa($tipoEmpresa)
  {
     ...
     * @return string
     */
    public function getGrupoPrincipal()
    {
        return $this->sGrupoPrincipal;
    }

    /**
     * @param string $sGrupoPrincipal
     */
    public function setGrupoPrincipal($sGrupoPrincipal)
    {
        $this->sGrupoPrincipal = $sGrupoPrincipal;
    }
    ...
    {
        return $this->aIdentificadores;
    }

    /**
     * @param array $aIdentificadores
     */
    public function setIdentificadores($aIdentificadores)
    {
        $this->aIdentificadores = $aIdentificadores;
    }
  ...
  public function processar()
  {
    foreach ($this->grupo as $grupo) {
      ...
      while ($this->dicionario->next()){
        ...
        if ($grupo == $this->getGrupoPrincipal()) {
            $this->aIdentificadores[] = $indice;
        } else {
            if (!in_array($indice, $this->getIdentificadores())) {
                continue;
            }
        }
