...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  if($clfiscaltipo->erro_status=="0"){
    ...
    if($clfiscaltipo->erro_campo!=""){
      ...
      echo "<script>parent.iframe_fiscais.location.href='fis1_fis_fiscalusuario001.php?y38_codnoti=".$y31_codnoti."&y39_codandam=$y39_codandam&abas=1".$getIntimacao."';</script>\n";
      // echo "<script>parent.iframe_artigos.location.href='fis1_fis_fiscarquivos001.php?y26_codnoti=".$y31_codnoti."&y39_codandam=$y39_codandam".$getIntimacao."';</script>\n";
      // echo "<script>parent.iframe_venc.location.href='fis1_fis_vencimento001.php?y30_codnoti=".$y31_codnoti."&y39_codandam=$y39_codandam".$getIntimacao."';</script>\n";
    }
  }else{
    $clfiscaltipo->erro(true,false);
    echo "<script>parent.iframe_fiscaltipo.location.href='fis1_fis_fiscaltipo001.php?y31_codnoti=".$y31_codnoti."&abas=1".$getIntimacao."';</script>\n";
