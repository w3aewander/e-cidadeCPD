...
if(isset($chavepesquisa)) {
  ...
  try{
    ...
    if ( isset($incluir) || isset($alterar) ) {
      ...
      $oDaoAgendaassentamento->h82_formulafim           = empty($h82_formulafim) ? 'null' : $h82_formulafim;
      $oDaoAgendaassentamento->h82_formulafaltasperiodo = empty($h82_formulafaltasperiodo) ? 'null' : $h82_formulafaltasperiodo;
      $oDaoAgendaassentamento->h82_formulaprorrogafim   = empty($h82_formulaprorrogafim) ? 'null' : $h82_formulaprorrogafim;
