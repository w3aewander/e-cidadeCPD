    ...
    <table border="0">
      <tr>
        <td align="center">
          <fieldset>
            ...
            <table>
              <tr>
                <td nowrap title="<?php echo @$Tr17_regist ?>">
                  <?php
              ...
              <tr>
                <td nowrap title="<?php echo @$Tr17_lotac ?>">
                  <?php
      ...
      <tr>
        <td align="center">
          <fieldset>
            ...
            <table>
              <tr>
                <td nowrap title="<?php echo @$Tr17_codigo ?>">
                  <?php
              ...
              <tr>
                <td nowrap title="<?php echo @$Tr17_tipo ?>">
                  <?php echo @$Lr17_tipo ?>
                </td>
                <td>
                  <?php
                ...
                <td nowrap title="<?php echo @$Tr17_difere ?>" align="right">
                  <?php echo @$Lr17_difere ?>
                </td>
                <td>
                  <?php
                  $x = array("f" => "NAO", "t" => "SIM");
              ...
              <tr>
                <td nowrap title="<?php echo @$Tr17_quant ?>">
                  <?php echo @$Lr17_quant ?>
                </td>
                <td>
                  <?php
                ...
                <td nowrap title="<?php echo @$Tr17_situac ?>" align="right">
                  <?php echo @$Lr17_situac ?>
                </td>
                <td>
                  <?php
      ...
      <tr>
        <td align="center">
          ...
          <?php if (isset($opcao)) { ?>
            <input name="novo" type="button" id="novo" value="Outro vale" onclick="location.href='pes4_vtffunc001.php?r17_regist=<?php echo @$r17_regist ?>'">
      ...
      <tr>
        <td align="center">
          ...
          $cliframe_alterar_excluir->sql = $clvtffunc->sql_query(
            ...
            null,
            null,
            "distinct r17_anousu,r17_mesusu,r17_codigo,r16_descr," . $campo_quantidade . " r17_quant,r17_difere,case when r17_situac = 'I' then 'Inativo' else 'Ativo' end as r17_situac,case when r17_tipo = 'f' then 'Diário' else 'Mensal' end as r17_tipo,r17_regist",
            "r17_codigo",
            $dbwhere
          );
...
<script>
  ...
  function js_verificatipo(valor) {
    <?php if ($db_opcao != 3) { ?>
      if (valor == 't') {
        ...
        if ($db_opcao == 1) {
        ?>
          document.form1.r17_quant.value = "0";
        <?php
        }
        ?>
  ...
  function js_pesquisar17_regist(mostra) {
    if (mostra == true) {
      js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_rhpessoal', 'func_rhpessoal.php?testarescisao=raf&funcao_js=parent.js_mostrapessoal1|rh01_regist|z01_nome&instit=<?php echo db_getsession("DB_instit") ?>', 'Pesquisa', true, '20');
    } else {
      if (document.form1.r17_regist.value != '') {
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_rhpessoal', 'func_rhpessoal.php?testarescisao=raf&pesquisa_chave=' + document.form1.r17_regist.value + '&funcao_js=parent.js_mostrapessoal&instit=<?php echo db_getsession("DB_instit") ?>', 'Pesquisa', false);
      } else {
