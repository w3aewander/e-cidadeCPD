...
function js_pesquisay33_codnoti(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y33_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscalrua','func_fis_fiscalrua.php?funcao_js=parent.js_preenchepesquisa|y33_codnoti','Pesquisa',true);
}
