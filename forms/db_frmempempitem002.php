        ...
        <table>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if (!empty($e55_autori)) {
                                        $result02 = $clempautitem->sql_record(
                                            $clempautitem->sql_query_file(
                                                $e55_autori,
                                                null,
                                                "count(e55_sequen) as tot_item"
                                            )
                                        );
                                        db_fieldsmemory($result02, 0);
                                        if ($tot_item > 0) {
                                            $result = $clempautitem->sql_record(
                                                $clempautitem->sql_query_file(
                                                    $e55_autori,
                                                    null,
                                                    "sum(e55_vltot) as tot_valor"
                                                )
                                            );
                                        ...
                                        $result02 = $clempempitem->sql_record(
                                            $clempempitem->sql_query_file(
                                                $e60_numemp, null,
                                                "count(e62_sequen) as tot_item"
                                            )
                                        );
                                        db_fieldsmemory($result02, 0);
                                        if ($tot_item > 0) {
                                            $result = $clempempitem->sql_record(
                                                $clempempitem->sql_query_file(
                                                    $e60_numemp,
                                                    null,
                                                    "sum(e62_vltot) as tot_valor"
                                                )
                                            );
                                            db_fieldsmemory($result, 0);
                                            if (empty($tot_valor) || $tot_valor == "") {
            ...
            <tr>
                <td>
                                ...
                                <td colspan="4">
                                    ...
                                    if (!empty($e60_numemp)) {
                                       ...
                                       then pcorcamval.pc23_obs
                                        ...
                                        $sql = $clempautitem->sql_query(
                                            $e55_autori,
                                            "",
                                            "
                                                    e55_item,pc01_descrmater,
                                                    e55_codele,e55_descr,
                                                    e55_quant,e55_vlrun,
                                                    e55_vltot,o56_elemento,
                                                    o56_descr
                                                "
                                        );
                                        db_lovrot($sql, 20, "", "");
                    ...
                    <?php
                    if (isset($e60_numemp)) {
                        $rsItensAnulados = $clempanuladoitem->sql_record(
                            $clempanuladoitem->sql_query(
                                null,
                                "*",
                                "e62_sequen",
                                "e62_numemp = {$e60_numemp}"
                            )
                        );

                        $sCampos = "pc01_codmater,pc01_descrmater,e37_qtd, e37_vlranu,e94_data";
                        $sSqlAnulados = $clempanuladoitem->sql_query(
                            null,
                            $sCampos,
                            "e62_sequen",
                            "e62_numemp = {$e60_numemp}"
