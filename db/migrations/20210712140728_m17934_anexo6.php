...
class M17934Anexo6 extends PostgresMigration
{
    public function up()
    {
        $this->upAnexo();
        $this->execute(<<<SQL
update db_itensmenu set libcliente = 'true' where id_item = 228530
SQL
        );
    }
...
<filter>
 <contas>
  <conta estrutural="399999999000000" nivel="" exclusao="false" indicador=""/>
 </contas>
 <orgao operador="in" valor="" id="orgao"/>
 <unidade operador="in" valor="" id="unidade"/>
 <funcao operador="in" valor="" id="funcao"/>
