...
function js_pesquisaz01_i_cgsund(mostra) {
  ...
  if(mostra == true) {
    ...
    js_OpenJanelaIframe(
                         '',
                         'db_iframe_cgs_und',
                         'func_cgs_und.php?funcao_js=parent.js_mostracgs1|z01_i_cgsund|z01_v_nome&aceitaInativo',
                         sTitulo,
                         mostra
                       );
  } else {
    ...
    if($F('z01_i_cgsund') != '') {
      ...
      js_OpenJanelaIframe(
        '',
        'db_iframe_cgs_und',
        `func_cgs_und.php?pesquisa_chave=${$F('z01_i_cgsund')}&funcao_js=parent.js_mostracgs&aceitaInativo`,
        sTitulo,
        mostra
      );
    } else {
...
function js_mostracgs1(chave1, chave2) {
  ...
  $('z01_i_cgsund').dispatchEvent(new Event('change'));
