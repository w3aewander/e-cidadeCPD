...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" >
    ...
    <center>
    	<?
    	  require_once(modification("forms/db_frmtipcalcexe.php"));
    	?>
    </center>
...
if (isset($alterar) || isset($excluir) || isset($incluir)) {
    ...
    if ($sqlerro == false) {
    	...
    	if (isset($alterar) || isset($incluir)) {
    	 ...
    	 echo "
          		<script>      	
                (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_tipcalc.location.href='iss1_tipcalc005.php?chavepesquisa=".@$q83_tipcalc."';
              </script>
            ";
    	}
    }
