...
if(isset($opcao) && $opcao == "alterar"){
  ...
  echo "<script>parent.iframe_autotipo.location.href='fis1_fis_autotipo002.php?chavepesquisa=$y59_codauto&chavepesquisa1=$y59_codtipo'</script>";
  }else{
...
if(isset($opcao) && $opcao == "excluir"){
  $result = $clautotipo->sql_record($clautotipo->sql_query_baixa(null,"*",null,"y59_codauto=$y59_codauto and y59_codtipo=$y59_codtipo and y87_dtbaixa is null"));
  if ($clautotipo->numrows!=0){
    echo "<script>parent.iframe_autotipo.location.href='fis1_fis_autotipo003.php?chavepesquisa=$y59_codauto&chavepesquisa1=$y59_codtipo'</script>";
  }else{
    db_msgbox('Procedência já baixada!!');
    $y59_codtipo="";
  }
  ...
  <tr>
    ...
    <td>
      <?php 
        ...
        db_input('y45_vlrfixo',10,$Iy50_codauto,true,'hidden',3,"");
...
db_input('y29_descr',40,$Iy29_descr,true,'text',3,'')
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_autotipo001.php?y59_codauto=<?=$y59_codauto?>'">
      <?php 
      }
      ?>
    </td>
...
$clautotipo1 = new cl_fis_autotipo;
...
if($clautotipo1->numrows > 0){
  ...
  echo "<script>parent.iframe_fiscais.location.href='fis1_fis_autousu001.php?y59_codauto=".$y59_codauto."&abas=1&y39_codandam=$y39_codandam';</script>\n";
  echo "<table cellpadding='1' cellspacing='2' border='0' width='600'>";
  for($i=0;$i<$clautotipo1->numrows;$i++){
    db_fieldsmemory($result,$i);
    echo "<tr bgcolor='#999999'>
	    <td align='center' valign='center'>
	      <input  type='radio' name='tipoandam' ".($y41_codtipo == $y39_codtipo?"checked":"")." value='$y41_codtipo' onChange='document.form1.andamento.value=this.value;document.form1.action=\"fis1_fis_autotipo001.php\";document.form1.submit();'>
...
function js_validaValor() {
  ...
  if ( $F('y45_percentual') == 't') {
    ...
    if ($F('y59_valor') > 150 || $F('y59_valor') <= 0) {
...
function js_pesquisay59_codauto(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?funcao_js=parent.js_mostraauto1|y50_codauto|y50_nome','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y59_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisay59_codtipo(mostra){
  ...
  if (tipofisc!=""){
    if(mostra==true){
      js_OpenJanelaIframe('','db_iframe','func_fis_fiscalprocaltauto.php?tipofisc='+tipofisc+'&funcao_js=parent.js_mostrafiscalproc1|y29_codtipo|y29_descr|y45_vlrfixo|y45_valor|y45_percentual','Pesquisa',true);
    }else{
      js_OpenJanelaIframe('','db_iframe','func_fis_fiscalprocaltauto.php?tipofisc='+tipofisc+'&pesquisa_chave='+document.form1.y59_codtipo.value+'&funcao_js=parent.js_mostrafiscalproc','Pesquisa',false);
    }
  }else{
...
function js_mostrafiscalproc(chave,erro,fixo,valor,percentual){
  ...
  if(erro==true){
    ...
    js_OpenJanelaIframe('','db_iframe_autonome','func_fis_autonome.php?pesquisa_chave='+document.form1.y59_codauto.value+'&codtipo='+document.form1.y59_codtipo.value+'&funcao_js=parent.js_mostrare','Pesquisa',false);
  }
}
...
function js_mostrafiscalproc1(chave1,chave2,fixo,valor,percentual){
  ...
  js_atribuiMascara( percentual );
  js_OpenJanelaIframe('','db_iframe_autonome','func_fis_autonome.php?pesquisa_chave='+document.form1.y59_codauto.value+'&codtipo='+chave1+'&funcao_js=parent.js_mostrare','Pesquisa',false);
  db_iframe.hide();
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_autotipo','func_fis_autotipo.php?funcao_js=parent.js_preenchepesquisa|y59_codauto|1','Pesquisa',true);
}
function js_preenchepesquisa(chave,chave1){
  db_iframe_autotipo.hide();
  <?php 
    if($db_opcao == 2 || $db_opcao == 22){
      echo " location.href = 'fis1_fis_autotipo002.php?abas=1&chavepesquisa='+chave;";
    }elseif($db_opcao == 33 || $db_opcao == 3){
      echo " location.href = 'fis1_fis_autotipo003.php?abas=1&chavepesquisa='+chave;";
    }
  ?>
}
</script>
...
if(isset($y59_codauto) && $y59_codauto != ""){
  echo "<script>js_OpenJanelaIframe('','db_iframe_fiscal','func_fis_auto.php?pesquisa_chave=$y59_codauto&funcao_js=parent.js_mostraauto','Pesquisa',false);</script>";
