...
class AtividadeEscolar {
  ...
  /**
   * Permissao do Diário de Classe -> 0 = Sem permissão, 1 = Permissão Total 
   * @var integer
   */
  protected $iPermissaoDiario;
  ...
  public function __construct($iCodigo = null) {
    ...
    if (!empty($iCodigo)) {
      ...
      if ($oDaoAtividadeRh->numrows > 0) {
        ...
        $this->iPermissaoDiario  = $oDadosAtividadeRh->ed01_permissao_diario;
   ...
   * @return integer
   */
  public function getPermissaoDiario() {
  
    return $this->iPermissaoDiario;
  }
