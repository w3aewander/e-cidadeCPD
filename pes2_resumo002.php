...
for($x = 0;$x < pg_numrows($result);$x++){
   ...
   $sqllota .= " and r70_estrut between '$lotaini' and '$lotafin' $wherepes ";
      ...
      $pdf->cell(100,$alt,'',0,0,"C",0);
      $pdf->cell(45,$alt,'BASE INFORMATIVA  ',0,0,"L",0);
      $pdf->cell(20,$alt,'',0,0,"R",0);
      $pdf->cell(20,$alt,db_formatar($baseInformativa,'f'),0,1,"R",0);
      $pdf->cell(100,$alt,'',0,0,"C",0);
...
// echo "<BR><BR>$sqlprev";
  ...
  $criaCabecalho = false;
  $resultTipoBase = pg_num_rows($result);

  for($x = 0; $x < $resultTipoBase; $x++) {
      db_fieldsmemory($result, $x);
      ...
      if($r14_pd == "4") {
        if (!$criaCabecalho) {
          ...
          $pdf->cell(15,$alt,'N.FUNC.',1,0,"C",1);
          $pdf->cell(15,$alt,'QUANT.',1,0,"C",1);
          $pdf->cell(95,$alt,'DESCRIÇÃO',1,0,"C",1);
        ...
        $pdf->setfont('arial','',8);
        $pdf->cell(15,$alt,$r14_rubric,0,0,"R",0);
        $pdf->cell(15,$alt,$soma,0,0,"R",0);
        $pdf->cell(15,$alt,$quant,0,0,"R",0);
        $pdf->cell(95,$alt,$rh27_descr,0,0,"L",0);
        $pdf->cell(25,$alt,db_formatar($valor,'f'),0,0,"R",0);
        $pdf->cell(20,$alt,"INFORMATIVA",0,1,"R",0);

        $baseInformativa += $valor;
