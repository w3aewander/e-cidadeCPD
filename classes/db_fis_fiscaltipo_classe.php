...
class cl_fis_fiscaltipo {
   ...
   public $y31_codnoti = 0;
   public $y31_codtipo = 0;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscaltipo");
...
public function incluir ($y31_codnoti,$y31_codtipo){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscaltipo(
                                       y31_codnoti
                                      ,y31_codtipo
                       )
                values (
...
public function alterar ($y31_codnoti=null,$y31_codtipo=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscaltipo set ";
     $virgula = "";
...
public function excluir ($y31_codnoti=null,$y31_codtipo=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscaltipo
                    where ";
     $sql2 = "";
...
public function sql_query ( $y31_codnoti=null,$y31_codtipo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscaltipo ";
     $sql .= "      inner join fiscalizacao.fis_fiscalproc  on  fis_fiscalproc.y29_codtipo = fis_fiscaltipo.y31_codtipo";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscaltipo.y31_codnoti";
     ...
     if($dbwhere==""){
       if($y31_codnoti!=null ){
         $sql2 .= " where fis_fiscaltipo.y31_codnoti = $y31_codnoti ";
       }
       if($y31_codtipo!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fiscaltipo.y31_codtipo = $y31_codtipo ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y31_codnoti=null,$y31_codtipo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
