...
try {
  ...
  $campos = "i08_autoinfracao, to_char(i08_dtpagamento, 'DD/MM/YYYY') as data_pagamento, i08_vlprefeitura, i08_nossonumero, i08_codigoinfracao";
...
foreach ($relatorio->pagamentos as $pagamento) {
  ...
  $pdf->SetFont(FONT, '', 8);
  $pdf->Cell(40, HEIGHT, $pagamento->i08_autoinfracao, 1, 0, 'C');
  $pdf->Cell(38, HEIGHT, $pagamento->i08_codigoinfracao, 1, 0, 'C');
  $pdf->Cell(38, HEIGHT, $pagamento->data_pagamento, 1, 0, 'C');
  $pdf->Cell(38, HEIGHT, $valor, 1, 0, 'C');
  $pdf->Cell(38, HEIGHT, $pagamento->i08_nossonumero, 1, 1, 'C');
}
...
function cabecalho(PDF $pdf)
{
  ...
  $pdf->Cell(40, HEIGHT, 'Auto de Infração', 1, 0, 'C', 1);
  $pdf->Cell(38, HEIGHT, 'Código da Infração', 1, 0, 'C', 1);
  $pdf->Cell(38, HEIGHT, 'Data de Pagamento', 1, 0, 'C', 1);
  $pdf->Cell(38, HEIGHT, 'Valor', 1, 0, 'C', 1);
  $pdf->Cell(38, HEIGHT, 'Nosso Número', 1, 1, 'C', 1);
}
