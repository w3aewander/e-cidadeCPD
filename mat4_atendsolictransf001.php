...
require_once(modification("classes/db_matpedido_classe.php"));
...
require_once(modification("classes/db_matpedidoitem_classe.php"));
...
<br></br>
    <center>
	<?
include(modification("forms/db_frmatendsolitransf.php"));
?>
    </center>
<?
