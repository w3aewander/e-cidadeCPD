...
class M20952AtualizaFuncaoFcIssqn extends Migration
{
    /**
     * Run the migrations.
     *
...
begin
  ...
  --
    ...
    -- Se inicio das atividades da empresa no exercicio foi no segundo semestre divide valor integral por 2 se nao cobra integral
    --
    if ((dDataBaixa is not null) and (iAnousu = extract(year from dInicioCalculo))) then 
       select extract (quarter from dDataBaixa) into iTrimestre;
       nValorProporcional = nValorSemProporcionalidade / 4 * (iTrimestre);
    else 
