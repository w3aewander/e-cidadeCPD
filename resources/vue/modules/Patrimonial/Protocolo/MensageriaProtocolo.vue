...
import ChatBox from "./Components/mensageria/ChatBox";
import Mensagem from "./Components/mensageria/Mensagem";
import ModalLoading from "../../Components/ModalLoading";
import DialogDespacho from "./Components/mensageria/DialogDespacho";

const props = defineProps(['processo']);
...
async function consultaCgm (mensagem) {
  ...
  if (data.erro) {
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo', 'consulta_cgm', arquivo, 'Visualizar CGM', true);
  }
