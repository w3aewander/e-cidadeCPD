...
$ocultaDadosNaContabilidade = '';
if (isset($_GET['contabilidade'])) {
    $ocultaDadosNaContabilidade = 'display:none';
}
...
$oRotulo->label("o15_recurso");
$oRotulo->label("o200_descricao");
$oRotulo->label("gestao");
...
<form name='form1'>
                ...
                <fieldset>
                    ...
                    <table cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style='border:1px solid #999999; background-color:white; width:120px' id='tipofolha'
                                colspan="3">
                                &nbsp;
                            </td>
                        </tr>
    ...
    <div class="container">
        ...
        <table cellspacing="0" style='-moz-user-select: none'>
                    ...
                    <fieldset style="width: 1714px;">
                        ...
                        <table style='border:2px inset white;' cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class='table_header' width="70" title="Recurso e complemento">
                                    Rec/Comp
                                </td>
                            ...
                            <tbody id='listaEmpenhos'
                                   style='height: 300px;overflow: scroll; overflow-x:hidden; background-color: white'>
                            </tbody>
                        </table>
            ...
            <tr>
                <td>
                    <fieldset style="<?=$ocultaDadosNaContabilidade?>">
            ...
            <tr>
                <td colspan="7" style="text-align: center; <?=$ocultaDadosNaContabilidade?>">
    ...
    <div style='position:fixed;
        ...
        <div style='padding:3px'>
            <div class="container">
                <fieldset>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                db_input('rh72_recurso', 10, $Irh72_recurso, true, 'hidden', 1);

                                db_input('gestao', 5, $Igestao, true, 'text', 3, "onchange='js_pesquisac62_codrec(false);'");
                                db_input('o15_recurso', 5, $Io15_recurso, true, 'text', 3);
                                db_input('o15_descr', 30, 0, true, 'text', 3, "");
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select id="complementoRecurso" name="complementoRecurso">
                ...
                <input value='Confirma' type='button' id='atualizarDotacao'>
        ...
        if (oRetorno.status == 1) {
            ...
            for (var i = 0; i < oRetorno.itens.length; i++) {
                ...
                with (oRetorno.itens[i]) {
                    ...
                    oCellRecurso.innerHTML = gestao + "(" + o15_complemento + ")";
                    oCellRecurso.innerHTML += "<input type='hidden' size=5 id='recurso_" + rh72_sequencial + "' value='" + rh72_recurso + "'>";
...
//          */
    ...
    function js_alterarDotacao(iSequencial, iTipoEmpenho, iSeqPes, iTabPrev) {
        ...
        if (iTipoEmpenho == 1) {
            $('rh72_recurso').value = $("recurso_" + iSequencial).value;
        }

        buscarInformacoesRecurso($('rh72_recurso').value);
    ...
    function js_pesquisac62_codrec(mostra) {
        ...
        if (mostra) {
            js_OpenJanelaIframe(
                ...
                'func_fontesubrecurso.php?funcao_js=parent.js_mostraorctiporec1|o15_recurso|descricao|gestao',
                'Recursos', true, 0, 0,
                document.body.clientWidth - 40,
                document.body.scrollHeight - 180);
            ...
            if (document.form1.o15_recurso.value != '') {
                js_OpenJanelaIframe('',
                    'db_iframe_orctiporec',
                    'func_fonterecurso.php?pesquisa_chave='
                    + document.form1.o15_recurso.value + '&funcao_js=parent.js_mostraorctiporec',
                    'Recursos',
                    false,
                    0,
                    0,
    ...
    function js_mostraorctiporec(descricao, erro) {
        ...
        if (erro) {
            ...
            montaSelectComplemento([]);
            return;
        }

        buscarComplementosRecurso(document.form1.o15_recurso.value, gestao);
    }

    function js_mostraorctiporec1(recurso, descricao, gestao) {

        document.form1.o15_recurso.value = recurso;
        document.form1.o15_descr.value = descricao;
        document.form1.gestao.value = gestao;

        buscarComplementosRecurso(recurso, gestao);
...
//  alert(chave1+' -- '+chave2+' -- '+chave3+' -- '+chave4);
    ...
    function js_retornoGetOrigemDotacao(oRequest) {
        ...
        if (oRetorno.itens.length > 0) {
            with (oRetorno.itens[0]) {
                ...
                buscarInformacoesRecurso(o58_codigo);
                js_getUnidades();
    ...
    function js_getDotacoes() {
        ...
        for (let option of $('complementoRecurso').options) {
            if (option.value === '') {
                continue;
            }

            recursos.push(option.getAttribute('idRecurso'));
        }

        oParam.recursos = recursos;
    ...
    function js_alterarDadosEmpenho(iCodigoEmpenho, iTipo, iSeqPes, iTabPrev) {
        ...
        if ($F('complementoRecurso') === '') {
            alert('Você deve selecionar o complemento.');
            return;
        }
        ...
        if ($('orgao' + iCodigoEmpenho).innerHTML == $F('rh72_orgao')
            ...
            oParam.iRecurso = $('complementoRecurso').options[$('complementoRecurso').selectedIndex].getAttribute('idRecurso');
    ...
    const buscarComplementosRecurso = (recurso, gestao) => {

        const formData = new FormData();
        formData.append('acao', 'buscarComplementos');
        formData.append('subrecurso', recurso);
        formData.append('fonteRecurso', gestao);
        HttpClient.post('orc4_fonterecursos.RPC.php', {body: formData}).then(response => {
            ...
            montaSelectComplemento(response.complementos);
        });
    }

    const buscarInformacoesRecurso = (codigoRecurso) => {

        const formData = new FormData();
        formData.append('acao', 'infoRecurso');
        formData.append('idRecurso', codigoRecurso);
        HttpClient.post('orc4_fonterecursos.RPC.php', {body: formData}).then(response => {
            ...
            $('rh72_recurso').value = response.codigo;
            $('o15_recurso').value = response.recurso;
            $('gestao').value = response.fonte.gestao;
            $('o15_descr').value = response.fonte.descricao;

            montaSelectComplemento(response.complementos, response.complemento);

            carregaDadosTelaAlterarDotacao();
        });
    }

    const montaSelectComplemento = (complementos, complementoRecursoSelececionado) => {

        $('complementoRecurso').options.length = 0;
        $('complementoRecurso').add(new Option('Selecione', ''));

        complementos.map(complemento => {
            let selecionado = false;

            if (!complementoRecursoSelececionado != undefined) {
                selecionado = complementoRecursoSelececionado === complemento.codigo;
            }
            var novaOption = new Option(complemento.descricao, complemento.codigo, true, selecionado)
            novaOption.setAttribute('idRecurso', complemento.id_recurso);
            $('complementoRecurso').add(novaOption);
        });

        js_getDotacoes();
    }

    const carregaDadosTelaAlterarDotacao = () => {
