        ...
        <table class="form-container" >
            ...
            <tr>
                <td colspan="2">
                    ...
                    <fieldset class="separator">
                        <legend>SISOBRA:</legend>
                        <table class="form-container">
                            <tr>
                                <td><strong>Certificado A1 formato .pem</strong></td>
                                <td>
                                    <input type="file" id="file_certificadopem" name="file_certificadopem" accept=".pem">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                <? 
                                    ...
                                    $certificadopem = $oParProjetos->ob21_localcertificadoa1;
                                    $certificadopem = str_replace('.pfx', '.pem', $certificadopem);
                                    $certificadopem = basename($certificadopem);
                                    db_input('certificadopem', 85, $Iob21_localcertificadoa1, true,'text', 3);
                                ?>
                                </td>
                            </tr>
                            <tr>
                                <td><strong>Certificado A1 formato .pfx</strong></td>
                                <td>
                                    <input type="file" id="file_certificadopfx" name="file_certificadopfx" accept=".pfx">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
