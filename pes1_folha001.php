  ...
  try {
    ...
    if (isset($folhaselecion) && trim($folhaselecion) != "") {
      ...
      $grsubsql = $clsubsql->gerador_sql(
          ...
          rh44_codban,
          lpad(trim(to_char(to_number(rh44_agencia,'9999'),'9999'))::varchar(4)||rh44_dvagencia,4+length(trim(rh44_dvagencia)),'0') as rh44_agencia,
