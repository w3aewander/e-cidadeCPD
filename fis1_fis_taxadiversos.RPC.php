...
$oDaoTaxadiversos           = new cl_fis_taxadiversos;
$oDaoLancamentoTaxaDiversos = new cl_fis_lancamentotaxadiversos();
$oDaoGrupoTaxaDiversos      = new cl_fis_grupotaxadiversos();
  ...
  switch ($oParametro->exec) {
    ...
    case 'calcularTaxasGeral':
      ...
      foreach ($aLancamentosCalcular as $oLancamentoItem) {
        ...
        $oLancamentoCalcular = FisLancamentoTaxaDiversosRepository::getInstanciaPorCodigo($oLancamentoItem->idTaxa);
    ...
    case 'getTaxasCalcular':
      ...
      $aLancamentos           = FisLancamentoTaxaDiversosRepository::getLancamentosParaCalculoGeral($iNatureza, $iGrupo);
    ...
    case 'excluirLancamento':
      ...
      $oDaoLancamentotaxa         = new cl_fis_lancamentotaxadiversos;
    ...
    case 'calcularTaxasUnica':
      ...
      $oLancamentoCalcular = FisLancamentoTaxaDiversosRepository::getInstanciaPorCodigo($oParametro->codigo);
...
function calcularTaxas($oLancamento, $sObservacao = '', $lCalculoGeral = true)
{
  ...
  if($lCalculoGeral) {
    $nValorCalculado = $oLancamento->calcularTaxa(ProcessamentoFisTaxaDiversos::CALCULO_GERAL);
  } else {
    $nValorCalculado = $oLancamento->calcularTaxa(ProcessamentoFisTaxaDiversos::CALCULO_INDIVIDUAL);
  }
  ...
  $oProcessamentoTaxaDiversos = new ProcessamentoFisTaxaDiversos();
