...
class FisRequisicaoAidof {
  ...
  public function __construct($iCodigoRequisicao = null) {
    ...
    $oDaoRequisicaoAidof = db_utils::getDao('fis_requisicaoaidof');
    ...
    $this->oGrafica              = new FisGrafica($oRequisicaoAidof->y116_codigografica);
  ...
  public function setGrafica($oGrafica) {
     ...
     * @return bool
     */
    public function isLiberar()
    {
        return $this->bLiberar;
    }

    /**
     * @param bool $bLiberar
     * @return FisRequisicaoAidof
     */
    public function setLiberar($bLiberar)
    {
        $this->bLiberar = $bLiberar;
        return $this;
    }
  ...
  public function salvar() {
    ...
    try {
      ...
      $oDaoRequisicaoAidof = new cl_fis_requisicaoaidof();
      ...
      if ($this->bLiberar) {
          $this->setId($oDaoRequisicaoAidof->y116_id);
          $this->setQuantidadeLiberada($this->getQuantidadeSolicitada());
          $this->gerarAidof();
      }
  ...
  public function gerarAidof() {
    ...
    try {
       ...
       */
      $oAidof                  = new FisAidof();
      $iNotaFinalAidofAnterior = $oAidof->getNotaFinalAidof($this->oEmpresa, $this->oNota);
