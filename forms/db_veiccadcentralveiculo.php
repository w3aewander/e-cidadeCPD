...
<script>
function js_pesquisave01_codigo(){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veiccadcentralveiculo','db_iframe_veiculos','func_veiculos.php?funcao_js=parent.js_preenchepesquisa|ve01_codigo|ve01_placa|ve22_descr','Pesquisa',true,'0');
}
