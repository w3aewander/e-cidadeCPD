 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_rhestagioagendadata.location.href='rec1_rhestagioagendadata001.php?db_opcaoal=33&h64_estagioagenda=".@$h57_sequencial."';
     ";
         if(isset($liberaaba)){
