...
class cl_matestoqueitemnotafiscalmanual {
   ...
   public $m79_sequencial = 0;
   public $m79_matestoqueitem = 0;
   public $m79_notafiscal = null;
   public $m79_data_dia = null;
   public $m79_data_mes = null;
   public $m79_data_ano = null;
   public $m79_data = null;
   ...
   public function incluir ($m79_sequencial){
      $this->atualizacampos();
   ...
   public function alterar ($m79_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($m79_sequencial=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $m79_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $m79_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
