...
class cl_previden
{
    ...
    function incluir($r60_anousu, $r60_mesusu, $r60_numcgm, $r60_tbprev, $r60_rubric)
    {
        ...
        $resaco = $this->sql_record($this->sql_query_file($this->r60_anousu, $this->r60_mesusu, $this->r60_numcgm,
    ...
    function excluir(
      ...
      $dbwhere = null
        ...
        if ($dbwhere == null || $dbwhere == "") {
            $resaco = $this->sql_record($this->sql_query_file($r60_anousu, $r60_mesusu, $r60_numcgm, $r60_tbprev,
              $r60_rubric));
        } else {
