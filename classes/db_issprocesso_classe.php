...
class cl_issprocesso {
   ...
   public function incluir ($q14_inscr){
      $this->atualizacampos();
   ...
   public function alterar ($q14_inscr=null) {
      $this->atualizacampos();
   ...
   public function excluir ($q14_inscr=null,$dbwhere=null) {
   ...
   public function sql_query ( $q14_inscr=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $q14_inscr=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
