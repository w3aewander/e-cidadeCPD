...
DBViewPergunta.makeFromObject = function(oPergunta, oElemento) {
  ...
  oDBViewPergunta.identificador_campo = oPergunta.identificador_campo;
  oDBViewPergunta.setSomenteLeitura(oPergunta.somente_leitura);

  if(oPergunta.tipo_resposta == 1 && oDBViewPergunta.elementoRespostasObjetiva === "radio") {
      oDBViewPergunta.elemento.setAttribute("elemento-objetiva", "radio");
      oDBViewPergunta.elemento.setAttribute("codigo", oPergunta.codigo);
  }
...
DBViewPergunta.prototype = {
  ...
  'limparResposta' : function() {
   ...
   'setSomenteLeitura': function(somenteLeitura) {
