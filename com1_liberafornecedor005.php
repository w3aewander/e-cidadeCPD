 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_liberafornecedorsol.location.href='com1_liberafornecedorsol001.php?pc82_sequencial=".@$pc82_sequencial."';
         parent.document.formaba.liberafornecedorpcproc.disabled=$liberaabaProc;
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_liberafornecedorpcproc.location.href='com1_liberafornecedorpcproc001.php?pc82_sequencial=".@$pc82_sequencial."';
     ";
         if(isset($liberaaba)){
