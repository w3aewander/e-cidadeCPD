...
class cl_processosapensados {
  ...
  public function sql_query_informacoes_processos ($p30_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "") {
        $sql = "select ";
        if ($campos != "*" ) {
        ...
        $sql .= " from processosapensados as apensados";
        $sql .= "      join protprocesso as processo_pai on processo_pai.p58_codproc = apensados.p30_procprincipal";
        $sql .= "      join protprocesso as processo_filho on processo_filho.p58_codproc = apensados.p30_procapensado";
        $sql .= "      join procandam as andamento_pai on andamento_pai.p61_codandam = processo_pai.p58_codandam";
        $sql .= "      join procandam as andamento_filho on andamento_filho.p61_codandam = processo_filho.p58_codandam";
        $sql2 = "";
        if ($dbwhere == "") {

            if ($p30_sequencial != null) {
                $sql2 .= " where apensados.p30_sequencial = $p30_sequencial ";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
