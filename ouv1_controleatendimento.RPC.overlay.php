...
require_once(modification('classes/db_protprocesso_classe.overlay.php'));
...
if ( $oPost->sMethod == 'consultaProcessos') {
  ...
  $sCampoProcesso .= " ov01_sequencial,";
  ...
  $sCampoProcesso .= " and (p62_id_usorec is not null or p62_id_usorec = {$oPost->iUsuario}) ";
  ...
  $sCampoProcesso .= " p58_despacho, p58_dtproc,p61_dtandam, ";
  ...
  $sCampoProcesso .= "  (
    ...
    where
      processoouvidoriaprorrogacao.ov15_protprocesso = protprocesso.p58_codproc
      and processoouvidoriaprorrogacao.ov15_ativo is true
      and processoouvidoriaprorrogacao.ov15_coddepto = {$oPost->iDepto}
  ) as ov15_dtfim,
  cast('".date('Y-m-d',db_getsession('DB_datausu'))."' as date )-(
    select
      max( ov15_dtfim )
    from
      processoouvidoriaprorrogacao
  ...
  $sWhereProcesso .= "     and procarquiv.p67_codarquiv is null ";
  ...
  $sWhereProcesso .= "                   or p62_id_usorec = 15 ";
  $sWhereProcesso .= "                   or p62_id_usorec = {$oPost->iUsuario}";
  $sWhereProcesso .= "                       )";*/

  $sWhereProcesso .= " and (p62_id_usorec = 0 or p62_id_usorec = {$oPost->iUsuario}) ";
