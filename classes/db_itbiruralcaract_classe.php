...
class cl_itbiruralcaract {
   ...
   public $it19_guia = 0;
   public $it19_codigo = 0;
   public $it19_valor = 0;
   public $it19_tipocaract = 0;
   ...
   public function incluir ($it19_guia,$it19_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($it19_guia=null,$it19_codigo=null,$it19_tipocaract=null) {
      $this->atualizacampos();
   ...
   public function excluir ($it19_guia=null,$it19_codigo=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $it19_guia=null,$it19_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $it19_guia=null,$it19_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
