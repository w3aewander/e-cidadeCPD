...
class cl_rechumanoativ
{
   // cria variaveis de erro
    ...
    public $ed22_i_codigo = 0;
    public $ed22_i_rechumanoescola = 0;
    public $ed22_i_atividade = 0;
    public $ed22_i_horasmanha = 0;
    public $ed22_i_horastarde = 0;
    public $ed22_i_horasnoite = 0;
    public $ed22_i_atolegal = 0;
    public $ed22_ativo = 'f';
    public $ed22_datainicio_dia = null;
    public $ed22_datainicio_mes = null;
    public $ed22_datainicio_ano = null;
    public $ed22_datainicio = null;
    public $ed22_datafim_dia = null;
    public $ed22_datafim_mes = null;
    public $ed22_datafim_ano = null;
    public $ed22_datafim = null;
    public $ed22_turno = null;
   // cria propriedade com as variaveis do arquivo
    public $campos = "
                 ...
                 ed22_datainicio = date = Data de Início
                 ed22_datafim = date = Até
                 ed22_turno = int4 = Turno
                 ";
    ...
    public function incluir($ed22_i_codigo)
    {
      $this->atualizacampos();
     ...
     if($this->ed22_datafim == null ){
       $this->ed22_datafim = "null";
     }
     if($this->ed22_turno == null ){
     ...
     if(($this->ed22_i_codigo == null) || ($this->ed22_i_codigo == "") ){
       $this->erro_sql = " Campo ed22_i_codigo não declarado.";
     ...
     $sql = "insert into rechumanoativ(
                ...
                values (
                               ...
                               ,'$this->ed22_ativo'
                               ,".($this->ed22_datainicio == "null" || $this->ed22_datainicio == ""?"null":"'".$this->ed22_datainicio."'")."
                               ,".($this->ed22_datafim == "null" || $this->ed22_datafim == ""?"null":"'".$this->ed22_datafim."'")."
                               ,$this->ed22_turno
                      )";
     $result = db_query($sql);
     if($result==false){
    ...
    public function alterar($ed22_i_codigo=null)
    {
     ...
     if (!is_null($this->ed22_datafim)){
       $sql  .= $virgula." ed22_datafim = '$this->ed22_datafim' ";
       $virgula = ",";
     }     else{
     ...
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Atividades do Recurso Humano na escola não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed22_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Atividades do Recurso Humano na escola não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed22_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function excluir($ed22_i_codigo=null, $dbwhere = null)
    {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Atividades do Recurso Humano na escola não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Atividades do Recurso Humano na escola não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed22_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
