...
if($clprontuarios->numrows == 0){
 echo "<table width='100%'>
        <tr>
         <td align='center'><font color='#FF0000' face='arial'><b>Nenhum Registro para o RelatÃ³rio<br><input type='button' value='Fechar' onclick='window.close()'></b></font></td>
        </tr>
       </table>";
 exit;
}
...
$pdf->Open(); 
$pdf->AliasNbPages(); 
$head2 = "Relatório de Produtividade Profissional";
