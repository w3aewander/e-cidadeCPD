...
require_once(modification("classes/db_finalidadepagamentofundeb_classe.php"));
      ...
      if (!isset($pesquisa_chave) && !isset($pesquisa_codigo)) {
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_finalidadepagamentofundeb.php")==true){
             include(modification("funcoes/db_func_finalidadepagamentofundeb.php"));
           }else{
           $campos = "finalidadepagamentofundeb.oid,finalidadepagamentofundeb.*";
           }
        }
	         $sql = $clfinalidadepagamentofundeb->sql_query(null, $campos);
        $repassa = array();
