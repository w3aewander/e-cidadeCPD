...
<template>
    ...
    >
        ...
        <Column field="dados_processo.p58_numero" header="N° Processo" sortable></Column>

        <Column field="dados_processo.p58_ano" header="Ano" sortable></Column>

        <Column field="dados_processo.p58_requer" header="Requerente" sortable></Column>
        ...
        <template #expansion="slotProps">
            ...
            <Paginator
                ...
                @page="(event) => onSolicitacoesPageChange({
                    index: slotProps.data.p58_codproc,
                    event: event
                })"
            />
        </template>
