...
require_once(modification("classes/db_carface_classe.php"));
require_once(modification("classes/db_cfiptu_classe.php"));
require_once(modification("classes/db_facevalor_classe.php"));
...
<body class="body-default abas">
	<div class="container">
		<?php
			include(modification("forms/db_frmface.php"));
		?>
  </div>
</body>
</html>
	...
	echo "
	  <script>
	      function js_db_libera(){
	         ...
	         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_facevalor.location.href='cad1_facevalor001.php?j81_face=" . @ $j37_face . "';
	     ";
	if (isset ($liberaaba)) {
