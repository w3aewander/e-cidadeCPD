...
$sWhereOrdem  .= " not exists( select 1 from empageconfgera confvalidar where confvalidar.e90_codmov  = e81_codmov and e90_cancelado is false)";
...
for($x=0;$x<$numrows;$x++){
  ...
  /* Plugin PagamentoTransmissaoTED */
