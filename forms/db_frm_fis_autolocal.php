...
function js_pesquisay14_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y14_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autolocal','func_fis_autolocal.php?funcao_js=parent.js_preenchepesquisa|y14_codauto','Pesquisa',true);
}
