...
class cl_issalvara {
   ...
   public $q123_sequencial = 0;
   public $q123_isstipoalvara = 0;
   public $q123_inscr = 0;
   public $q123_dtinclusao_dia = null;
   public $q123_dtinclusao_mes = null;
   public $q123_dtinclusao_ano = null;
   public $q123_dtinclusao = null;
   public $q123_situacao = 0;
   public $q123_usuario = 0;
   public $q123_geradoautomatico = 'f';
   ...
   public function incluir ($q123_sequencial){
      $this->atualizacampos();
     ...
     if($q123_sequencial == "" || $q123_sequencial == null ){
       ...
       $this->q123_sequencial = pg_fetch_result($result,0,0);
     }else{
       $result = db_query("select last_value from issalvara_q123_sequencial_seq");
       if(($result != false) && (pg_fetch_result($result,0,0) < $q123_sequencial)){
   ...
   public function alterar ($q123_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($q123_sequencial=null,$dbwhere=null) {
   ...
   // funcao do sql
   public function sql_query ( $q123_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   public function sql_query_file ( $q123_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
    ...
    * @return string
    */
   public function sql_queryAlvara ( $q123_sequencial=null,$campos="*",$ordem=null,$dbwhere="", $iDepto = null){
   ...
   public function sql_queryBaixa ( $q123_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   * @return string
   */
  public function sql_queryConsultaRenovacao( $q123_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
   ...
   * @return string
   */
  public function sql_queryConsultaCancelamento($sCampos = "", $sWhere = "") {
