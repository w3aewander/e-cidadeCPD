...
if (isset($incluir)) {
  ...
  if ($oDaoMatricula->numrows > 0 && $ed99_c_situacao != 'TRANSFERIDO' && $ed99_c_resultadofinal != 'R') {
    ...
    $erro   = HistoricoEscolar::temInconsistenciaEtapaSelecionada( $oEtapa, $oAluno, $ed99_i_anoref, $ed99_c_resultadofinal, $ed99_i_periodoref );
    ...
    if( !$erro ) {
      ...
      if ($oDaoHistoricoMpsFora->numrows > 0) {
        ...
        } elseif (in_array($ed99_c_situacao, ["CONCLUÍDO", "RECLASSIFICADO", "AVANÇO"])) {
