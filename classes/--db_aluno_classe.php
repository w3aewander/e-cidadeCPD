...
class cl_aluno
{
   // cria variaveis de erro
    ...
    public $ed47_i_codigo = 0;
    public $ed47_v_nome = null;
    public $ed47_v_nomesocial = null;
    public $ed47_v_ender = null;
    public $ed47_c_numero = null;
    public $ed47_v_compl = null;
    public $ed47_v_bairro = null;
    public $ed47_v_cep = null;
    public $ed47_c_raca = null;
    public $ed47_v_cxpostal = null;
    public $ed47_v_telef = null;
    public $ed47_d_cadast_dia = null;
    public $ed47_d_cadast_mes = null;
    public $ed47_d_cadast_ano = null;
    public $ed47_d_cadast = null;
    public $ed47_v_ident = null;
    public $ed47_i_login = 0;
    public $ed47_c_nomeresp = null;
    public $ed47_c_emailresp = null;
    public $ed47_c_atenddifer = null;
    public $ed47_t_obs = null;
    public $ed47_c_transporte = null;
    public $ed47_c_zona = null;
    public $ed47_certidaomatricula = null;
    public $ed47_c_certidaotipo = null;
    public $ed47_c_certidaonum = null;
    public $ed47_c_certidaolivro = null;
    public $ed47_c_certidaofolha = null;
    public $ed47_c_certidaocart = null;
    public $ed47_c_certidaodata_dia = null;
    public $ed47_c_certidaodata_mes = null;
    public $ed47_c_certidaodata_ano = null;
    public $ed47_c_certidaodata = null;
    public $ed47_c_nis = null;
    public $ed47_c_bolsafamilia = null;
    public $ed47_c_passivo = null;
    public $ed47_d_dtemissao_dia = null;
    public $ed47_d_dtemissao_mes = null;
    public $ed47_d_dtemissao_ano = null;
    public $ed47_d_dtemissao = null;
    public $ed47_d_dthabilitacao_dia = null;
    public $ed47_d_dthabilitacao_mes = null;
    public $ed47_d_dthabilitacao_ano = null;
    public $ed47_d_dthabilitacao = null;
    public $ed47_d_dtvencimento_dia = null;
    public $ed47_d_dtvencimento_mes = null;
    public $ed47_d_dtvencimento_ano = null;
    public $ed47_d_dtvencimento = null;
    public $ed47_d_nasc_dia = null;
    public $ed47_d_nasc_mes = null;
    public $ed47_d_nasc_ano = null;
    public $ed47_d_nasc = null;
    public $ed47_d_ultalt_dia = null;
    public $ed47_d_ultalt_mes = null;
    public $ed47_d_ultalt_ano = null;
    public $ed47_d_ultalt = null;
    public $ed47_i_estciv = 0;
    public $ed47_i_nacion = 0;
    public $ed47_v_categoria = null;
    public $ed47_v_cnh = null;
    public $ed47_v_contato = null;
    public $ed47_v_cpf = null;
    public $ed47_v_email = null;
    public $ed47_v_fax = null;
    public $ed47_v_hora = null;
    public $ed47_v_mae = null;
    public $ed47_v_pai = null;
    public $ed47_v_profis = null;
    public $ed47_v_sexo = null;
    public $ed47_v_telcel = null;
    public $ed47_c_foto = null;
    public $ed47_o_oid = 0;
    public $ed47_c_codigoinep = null;
    public $ed47_i_pais = 0;
    public $ed47_d_identdtexp_dia = null;
    public $ed47_d_identdtexp_mes = null;
    public $ed47_d_identdtexp_ano = null;
    public $ed47_d_identdtexp = null;
    public $ed47_v_identcompl = null;
    public $ed47_c_passaporte = null;
    public $ed47_i_transpublico = 0;
    public $ed47_i_filiacao = 0;
    public $ed47_i_censoufend = 0;
    public $ed47_i_censomunicend = 0;
    public $ed47_i_censoorgemissrg = 0;
    public $ed47_i_censoufident = 0;
    public $ed47_i_censoufcert = 0;
    public $ed47_i_censomuniccert = 0;
    public $ed47_i_censoufnat = 0;
    public $ed47_i_censomunicnat = 0;
    public $ed47_i_atendespec = 0;
    public $ed47_i_censocartorio = 0;
    public $ed47_celularresponsavel = null;
    public $ed47_situacaodocumentacao = 0;
    public $ed47_cartaosus = null;
    public $ed47_tiposanguineo = 0;
    public $ed47_municipioestrangeiro = null;
    public $ed47_paisresidencia = null;
    public $ed47_localizacaodiferenciada = 0;
    public $ed47_visto = null;
    public $ed47_vistoresponsavel = null;
    public $ed47_rnm = null;
    public $ed47_rnmresponsavel = null;
    public $ed47_censoregiao = null;
    public $ed47_censoregiaonat = null;
    public $ed47_i_certidado_estorage = 0;
    public $ed47_i_cpf_estorage = 0;
    public $ed47_v_sigla_concessionaria = null;
    public $ed47_v_codigo_energia = null;
    public $ed47_i_ocupacaopai = 0; 
    public $ed47_i_ocupacaomae = 0; 
    public $ed47_i_ocupacaoresp = 0; 
    public $ed47_parentescofiliacao1 = 0; 
    public $ed47_parentescofiliacao2 = 0; 
    public $ed47_parentescoresponsavel = 0; 
   // cria propriedade com as variaveis do arquivo 
    public $campos = "
                 ed47_i_codigo = int8 = Código
                 ed47_v_nome = char(70) = Nome
                 ed47_v_ender = varchar(100) = Endereço
                 ed47_v_nomesocial = varchar(70) = Nome Social
                 ed47_c_numero = char(10) = Número
                 ed47_v_compl = varchar(70) = Complemento
                 ...
                 ed47_c_nomeresp = char(70) = Responsável
                 ...
                 ed47_paisresidencia = int4 = País de residencia
                 ed47_localizacaodiferenciada = int4 = Localização diferenciada
                 ed47_visto = varchar(20) = Visto do Aluno
                 ed47_vistoresponsavel = varchar(20) = Visto do Responsável
                 ed47_rnm = varchar(20) = Registro Nacional de Migração
                 ed47_rnmresponsavel = varchar(20) = Registro Nacional de Migração
                 ed47_censoregiao = int4 = Região Aluno
                 ed47_censoregiaonat = int4 = Região Naturalidade
                 ed47_i_certidado_estorage = float8 = id certidao e-storage
                 ed47_i_cpf_estorage = float8 = id imagem cpf e-storage
                 ed47_v_sigla_concessionaria = varchar(10) = Sigla Concessionária
                 ed47_v_codigo_energia = varchar(20) = Código Energia,
                 ed47_i_ocupacaopai = int4 = Ocupação Pai 
                 ed47_i_ocupacaomae = int4 = Ocupação Mãe 
                 ed47_i_ocupacaoresp = int4 = Ocupação Responsável 
                 ed47_parentescofiliacao1 = int4 = Grau Parentesco Filiação 1 
                 ed47_parentescofiliacao2 = int4 = Grau Parentesco Filiação 2 
                 ed47_parentescoresponsavel = int4 = Grau Parentesco Responsável                  
                 ";
    ...
    public function atualizacampos($exclusao = false)
    {
        if ($exclusao==false) {
            ...
            $this->ed47_v_nomesocial = ($this->ed47_v_nomesocial == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_v_nomesocial"]:$this->ed47_v_nomesocial);
            ...
            $this->ed47_paisresidencia = ($this->ed47_paisresidencia == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_paisresidencia"]:$this->ed47_paisresidencia);
            $this->ed47_localizacaodiferenciada = ($this->ed47_localizacaodiferenciada == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_localizacaodiferenciada"]:$this->ed47_localizacaodiferenciada);
            $this->ed47_visto = ($this->ed47_visto == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_visto"]:$this->ed47_visto);
            $this->ed47_vistoresponsavel = ($this->ed47_vistoresponsavel == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_vistoresponsavel"]:$this->ed47_vistoresponsavel);
            $this->ed47_rnm = ($this->ed47_rnm == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_rnm"]:$this->ed47_rnm);
            $this->ed47_rnmresponsavel = ($this->ed47_rnmresponsavel == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_rnmresponsavel"]:$this->ed47_rnmresponsavel);
            $this->ed47_censoregiao = ($this->ed47_censoregiao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_censoregiao"]:$this->ed47_censoregiao);
            $this->ed47_censoregiaonat = ($this->ed47_censoregiaonat == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_censoregiaonat"]:$this->ed47_censoregiaonat);
            $this->ed47_i_certidado_estorage = ($this->ed47_i_certidado_estorage == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_certidado_estorage"]:$this->ed47_i_certidado_estorage);
            $this->ed47_i_cpf_estorage = ($this->ed47_i_cpf_estorage == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_cpf_estorage"]:$this->ed47_i_cpf_estorage);
            $this->ed47_v_sigla_concessionaria = ($this->ed47_v_sigla_concessionaria == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_v_sigla_concessionaria"]:$this->ed47_v_sigla_concessionaria);
            $this->ed47_v_codigo_energia = ($this->ed47_v_codigo_energia == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_v_codigo_energia"]:$this->ed47_v_codigo_energia);
            $this->ed47_i_ocupacaopai = ($this->ed47_i_ocupacaopai == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaopai"]:$this->ed47_i_ocupacaopai);
            $this->ed47_i_ocupacaomae = ($this->ed47_i_ocupacaomae == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaomae"]:$this->ed47_i_ocupacaomae);
            $this->ed47_i_ocupacaoresp = ($this->ed47_i_ocupacaoresp == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaoresp"]:$this->ed47_i_ocupacaoresp);
            $this->ed47_parentescofiliacao1 = ($this->ed47_parentescofiliacao1 == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao1"]:$this->ed47_parentescofiliacao1);
            $this->ed47_parentescofiliacao2 = ($this->ed47_parentescofiliacao2 == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao2"]:$this->ed47_parentescofiliacao2);
            $this->ed47_parentescoresponsavel = ($this->ed47_parentescoresponsavel == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_parentescoresponsavel"]:$this->ed47_parentescoresponsavel);
     }else{
       $this->ed47_i_codigo = ($this->ed47_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed47_i_codigo"]:$this->ed47_i_codigo);
     }
   }

    public function incluir($ed47_i_codigo)
    {
        $this->atualizacampos();
        ...
        if ($this->ed47_v_nomesocial == null) {
            $this->ed47_v_nomesocial = "";
        }
        ...
        if ($this->ed47_paisresidencia == null) {
            $this->ed47_paisresidencia = "null";
        }
        if ($this->ed47_localizacaodiferenciada == null) {
            $this->ed47_localizacaodiferenciada = "0";
        }
        if ($this->ed47_censoregiao == null) {
            $this->ed47_censoregiao = "null";
        }
        if ($this->ed47_censoregiaonat == null) {
            $this->ed47_censoregiaonat = "null";
        }
        if ($this->ed47_i_certidado_estorage == null) {
            $this->ed47_i_certidado_estorage = "0";
        }
        if ($this->ed47_i_cpf_estorage == null) {
            $this->ed47_i_cpf_estorage = "0";
        }
        if($this->ed47_i_ocupacaopai == null ){ 
            $this->ed47_i_ocupacaopai = "null";
        }
        if($this->ed47_i_ocupacaomae == null ){ 
            $this->ed47_i_ocupacaomae = "null";
        }
        if($this->ed47_i_ocupacaoresp == null ){ 
            $this->ed47_i_ocupacaoresp = "null";
        }
        if($this->ed47_parentescofiliacao1 == null ){ 
            $this->ed47_parentescofiliacao1 = "null";
        }
        if($this->ed47_parentescofiliacao2 == null ){ 
            $this->ed47_parentescofiliacao2 = "null";
        }
        if($this->ed47_parentescoresponsavel == null ){ 
            $this->ed47_parentescoresponsavel = "null";
        }                 
        ...
        $sql = "insert into aluno(
                                      ...
                                      ,ed47_paisresidencia
                                      ,ed47_localizacaodiferenciada
                                      ,ed47_visto
                                      ,ed47_vistoresponsavel
                                      ,ed47_rnm
                                      ,ed47_rnmresponsavel
                                      ,ed47_censoregiao
                                      ,ed47_censoregiaonat
                                      ,ed47_i_certidado_estorage
                                      ,ed47_i_cpf_estorage
                                      ,ed47_v_sigla_concessionaria
                                      ,ed47_v_codigo_energia
                                      ,ed47_i_ocupacaopai 
                                      ,ed47_i_ocupacaomae 
                                      ,ed47_i_ocupacaoresp 
                                      ,ed47_parentescofiliacao1 
                                      ,ed47_parentescofiliacao2 
                ...
                values (
                               ...
                               ,$this->ed47_paisresidencia
                               ,$this->ed47_localizacaodiferenciada
                               ,'$this->ed47_visto'
                               ,'$this->ed47_vistoresponsavel'
                               ,'$this->ed47_rnm'
                               ,'$this->ed47_rnmresponsavel'
                               ,$this->ed47_censoregiao
                               ,$this->ed47_censoregiaonat
                               ,$this->ed47_i_certidado_estorage
                               ,$this->ed47_i_cpf_estorage
                               ,'$this->ed47_v_sigla_concessionaria'
                               ,'$this->ed47_v_codigo_energia'
                               ,$this->ed47_i_ocupacaopai
                               ,$this->ed47_i_ocupacaomae
                               ,$this->ed47_i_ocupacaoresp 
                               ,$this->ed47_parentescofiliacao1 
                               ,$this->ed47_parentescofiliacao2 
                               ,$this->ed47_parentescoresponsavel 
                      )";
        $result = db_query($sql);
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco!=false)||($this->numrows!=0)) {
                ...
                $resac = db_query("insert into db_acount values($acount,1010051,1014008,'','".AddSlashes(pg_result($resaco, 0, 'ed47_v_nomesocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                ...
                $resac = db_query("insert into db_acount values($acount,1010051,1010418,'','".AddSlashes(pg_result($resaco, 0, 'ed47_paisresidencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1010417,'','".AddSlashes(pg_result($resaco, 0, 'ed47_localizacaodiferenciada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1011751,'','".AddSlashes(pg_result($resaco, 0, 'ed47_visto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1011752,'','".AddSlashes(pg_result($resaco, 0, 'ed47_vistoresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1011753,'','".AddSlashes(pg_result($resaco, 0, 'ed47_rnm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1011754,'','".AddSlashes(pg_result($resaco, 0, 'ed47_rnmresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1013162,'','".AddSlashes(pg_result($resaco, 0, 'ed47_censoregiao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1013163,'','".AddSlashes(pg_result($resaco, 0, 'ed47_censoregiaonat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1014571,'','".AddSlashes(pg_result($resaco, 0, 'ed47_i_certidado_estorage'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1014570,'','".AddSlashes(pg_result($resaco, 0, 'ed47_i_cpf_estorage'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1015617,'','".AddSlashes(pg_result($resaco, 0, 'ed47_v_sigla_concessionaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,1015618,'','".AddSlashes(pg_result($resaco, 0, 'ed47_v_codigo_energia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,157934246,'','".AddSlashes(pg_result($resaco,0,'ed47_i_ocupacaopai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,60960368,'','".AddSlashes(pg_result($resaco,0,'ed47_i_ocupacaomae'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,162057576,'','".AddSlashes(pg_result($resaco,0,'ed47_i_ocupacaoresp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,88567100,'','".AddSlashes(pg_result($resaco,0,'ed47_parentescofiliacao1'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,176531801,'','".AddSlashes(pg_result($resaco,0,'ed47_parentescofiliacao2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,1010051,84753688,'','".AddSlashes(pg_result($resaco,0,'ed47_parentescoresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
        return true;
    }
    ...
    public function alterar($ed47_i_codigo = null)
    {
        ...
        if (trim($this->ed47_v_nomesocial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_nomesocial"])) {
            $sql  .= $virgula." ed47_v_nomesocial = '$this->ed47_v_nomesocial' ";
            $virgula = ",";
        }
        ...
        if (trim($this->ed47_c_transporte) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_c_transporte"])) {
            ...
            $virgula = ",";
        } elseif(trim($this->ed47_c_transporte) == ""){
            $sql  .= $virgula." ed47_c_transporte = null ";
            $virgula = ",";
        }
        ...
        if (trim($this->ed47_paisresidencia) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_paisresidencia"])) {
            if (trim($this->ed47_paisresidencia) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_paisresidencia"])) {
                $this->ed47_paisresidencia = "0" ;
            }
            $sql  .= $virgula." ed47_paisresidencia = $this->ed47_paisresidencia ";
            $virgula = ",";
        }
        if (trim($this->ed47_localizacaodiferenciada) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_localizacaodiferenciada"])) {
            if (trim($this->ed47_localizacaodiferenciada) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_localizacaodiferenciada"])) {
                $this->ed47_localizacaodiferenciada = "0" ;
            }
            $sql  .= $virgula." ed47_localizacaodiferenciada = $this->ed47_localizacaodiferenciada ";
            $virgula = ",";
        }
        if (trim($this->ed47_visto) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_visto"])) {
            $sql  .= $virgula." ed47_visto = '$this->ed47_visto' ";
            $virgula = ",";
        }
        if (trim($this->ed47_vistoresponsavel) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_vistoresponsavel"])) {
            $sql  .= $virgula." ed47_vistoresponsavel = '$this->ed47_vistoresponsavel' ";
            $virgula = ",";
        }
        if (trim($this->ed47_rnm) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_rnm"])) {
            $sql  .= $virgula." ed47_rnm = '$this->ed47_rnm' ";
            $virgula = ",";
        }
        if (trim($this->ed47_rnmresponsavel) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_rnmresponsavel"])) {
            $sql  .= $virgula." ed47_rnmresponsavel = '$this->ed47_rnmresponsavel' ";
            $virgula = ",";
        }
        if (trim($this->ed47_censoregiao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiao"])) {
            if (trim($this->ed47_censoregiao) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiao"])) {
                $this->ed47_censoregiao = "0" ;
            }
            $sql  .= $virgula." ed47_censoregiao = $this->ed47_censoregiao ";
            $virgula = ",";
        }
        if (trim($this->ed47_censoregiaonat) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiaonat"])) {
            if (trim($this->ed47_censoregiaonat) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiaonat"])) {
                $this->ed47_censoregiaonat = "0" ;
            }
            $sql  .= $virgula." ed47_censoregiaonat = $this->ed47_censoregiaonat ";
            $virgula = ",";
        }
        if (trim($this->ed47_i_certidado_estorage) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_certidado_estorage"])) {
            if (trim($this->ed47_i_certidado_estorage) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_certidado_estorage"])) {
                $this->ed47_i_certidado_estorage = "0" ;
            }
            $sql  .= $virgula." ed47_i_certidado_estorage = $this->ed47_i_certidado_estorage ";
            $virgula = ",";
        }
        if (trim($this->ed47_i_cpf_estorage) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_cpf_estorage"])) {
            if (trim($this->ed47_i_cpf_estorage) == "" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_cpf_estorage"])) {
                $this->ed47_i_cpf_estorage = "0" ;
            }
            $sql  .= $virgula." ed47_i_cpf_estorage = $this->ed47_i_cpf_estorage ";
            $virgula = ",";
        }
        if (trim($this->ed47_v_sigla_concessionaria) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_sigla_concessionaria"])) {
            $sql  .= $virgula." ed47_v_sigla_concessionaria = '$this->ed47_v_sigla_concessionaria' ";
            $virgula = ",";
        }
        if (trim($this->ed47_v_codigo_energia) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_codigo_energia"])) {
            $sql  .= $virgula." ed47_v_codigo_energia = '$this->ed47_v_codigo_energia' ";
            $virgula = ",";
        }
        if(trim($this->ed47_i_ocupacaopai)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaopai"])){ 
           if(trim($this->ed47_i_ocupacaopai)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaopai"])){ 
              $this->ed47_i_ocupacaopai = "null" ; 
           } 
          $sql  .= $virgula." ed47_i_ocupacaopai = $this->ed47_i_ocupacaopai ";
          $virgula = ",";
        }
        if(trim($this->ed47_i_ocupacaomae)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaomae"])){ 
           if(trim($this->ed47_i_ocupacaomae)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaomae"])){ 
              $this->ed47_i_ocupacaomae = "0" ; 
           } 
          $sql  .= $virgula." ed47_i_ocupacaomae = $this->ed47_i_ocupacaomae ";
          $virgula = ",";
        }
        if(trim($this->ed47_i_ocupacaoresp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaoresp"])){ 
           if(trim($this->ed47_i_ocupacaoresp)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaoresp"])){ 
              $this->ed47_i_ocupacaoresp = "0" ; 
           } 
          $sql  .= $virgula." ed47_i_ocupacaoresp = $this->ed47_i_ocupacaoresp ";
          $virgula = ",";
        }
        if(trim($this->ed47_parentescofiliacao1)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao1"])){ 
            if(trim($this->ed47_parentescofiliacao1)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao1"])){ 
               $this->ed47_parentescofiliacao1 = "0" ; 
            } 
           $sql  .= $virgula." ed47_parentescofiliacao1 = $this->ed47_parentescofiliacao1 ";
           $virgula = ",";
        }
        if(trim($this->ed47_parentescofiliacao2)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao2"])){ 
            if(trim($this->ed47_parentescofiliacao2)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao2"])){ 
               $this->ed47_parentescofiliacao2 = "0" ; 
            } 
           $sql  .= $virgula." ed47_parentescofiliacao2 = $this->ed47_parentescofiliacao2 ";
           $virgula = ",";
        }
        if(trim($this->ed47_parentescoresponsavel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescoresponsavel"])){ 
            if(trim($this->ed47_parentescoresponsavel)=="" && isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescoresponsavel"])){ 
               $this->ed47_parentescoresponsavel = "0" ; 
            } 
           $sql  .= $virgula." ed47_parentescoresponsavel = $this->ed47_parentescoresponsavel ";
           $virgula = ",";
        }        
        $sql .= " where ";
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if ($this->numrows > 0) {
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_nomesocial"]) || $this->ed47_v_nomesocial != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1014008,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_v_nomesocial'))."','$this->ed47_v_nomesocial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_paisresidencia"]) || $this->ed47_paisresidencia != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1010418,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_paisresidencia'))."','$this->ed47_paisresidencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_localizacaodiferenciada"]) || $this->ed47_localizacaodiferenciada != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1010417,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_localizacaodiferenciada'))."','$this->ed47_localizacaodiferenciada',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_visto"]) || $this->ed47_visto != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1011751,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_visto'))."','$this->ed47_visto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_vistoresponsavel"]) || $this->ed47_vistoresponsavel != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1011752,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_vistoresponsavel'))."','$this->ed47_vistoresponsavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_rnm"]) || $this->ed47_rnm != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1011753,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_rnm'))."','$this->ed47_rnm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_rnmresponsavel"]) || $this->ed47_rnmresponsavel != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1011754,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_rnmresponsavel'))."','$this->ed47_rnmresponsavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiao"]) || $this->ed47_censoregiao != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1013162,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_censoregiao'))."','$this->ed47_censoregiao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_censoregiaonat"]) || $this->ed47_censoregiaonat != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1013163,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_censoregiaonat'))."','$this->ed47_censoregiaonat',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_certidado_estorage"]) || $this->ed47_i_certidado_estorage != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1014571,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_i_certidado_estorage'))."','$this->ed47_i_certidado_estorage',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_cpf_estorage"]) || $this->ed47_i_cpf_estorage != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1014570,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_i_cpf_estorage'))."','$this->ed47_i_cpf_estorage',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_sigla_concessionaria"]) || $this->ed47_v_sigla_concessionaria != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1015617,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_v_sigla_concessionaria'))."','$this->ed47_v_sigla_concessionaria',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_v_codigo_energia"]) || $this->ed47_v_codigo_energia != "") {
                        $resac = db_query("insert into db_acount values($acount,1010051,1015618,'".AddSlashes(pg_result($resaco, $conresaco, 'ed47_v_codigo_energia'))."','$this->ed47_v_codigo_energia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaopai"]) || $this->ed47_i_ocupacaopai != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,157934246,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_i_ocupacaopai'))."','$this->ed47_i_ocupacaopai',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }                        
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaomae"]) || $this->ed47_i_ocupacaomae != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,60960368,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_i_ocupacaomae'))."','$this->ed47_i_ocupacaomae',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_i_ocupacaoresp"]) || $this->ed47_i_ocupacaoresp != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,162057576,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_i_ocupacaoresp'))."','$this->ed47_i_ocupacaoresp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");                    
                    }
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao1"]) || $this->ed47_parentescofiliacao1 != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,88567100,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_parentescofiliacao1'))."','$this->ed47_parentescofiliacao1',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }                    
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescofiliacao2"]) || $this->ed47_parentescofiliacao2 != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,176531801,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_parentescofiliacao2'))."','$this->ed47_parentescofiliacao2',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    }                    
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed47_parentescoresponsavel"]) || $this->ed47_parentescoresponsavel != ""){
                        $resac = db_query("insert into db_acount values($acount,1010051,84753688,'".AddSlashes(pg_result($resaco,$conresaco,'ed47_parentescoresponsavel'))."','$this->ed47_parentescoresponsavel',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");                      
                    }
        ...
        && ($lSessaoDesativarAccount === false))) {
            ...
            if (($resaco != false) || ($this->numrows!=0)) {
                for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
                    ...
                    $resac  = db_query("insert into db_acount values($acount,1010051,1014008,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_v_nomesocial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    ...
                    $resac  = db_query("insert into db_acount values($acount,1010051,1010418,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_paisresidencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1010417,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_localizacaodiferenciada'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1011751,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_visto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1011752,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_vistoresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1011753,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_rnm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1011754,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_rnmresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1013162,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_censoregiao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1013163,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_censoregiaonat'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1014571,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_i_certidado_estorage'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1014570,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_i_cpf_estorage'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1015617,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_v_sigla_concessionaria'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,1015618,'','".AddSlashes(pg_result($resaco, $iresaco, 'ed47_v_codigo_energia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,157934246,'','".AddSlashes(pg_result($resaco,$iresaco,'ed47_i_ocupacaopai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,60960368,'','".AddSlashes(pg_result($resaco,$iresaco, 'ed47_i_ocupacaomae'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,162057576,'','".AddSlashes(pg_result($resaco,$iresaco,'ed47_i_ocupacaoresp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,88567100,'','".AddSlashes(pg_result($resaco,$iresaco,'ed47_parentescofiliacao1'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,176531801,'','".AddSlashes(pg_result($resaco,$iresaco,'ed47_parentescofiliacao2'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                    $resac  = db_query("insert into db_acount values($acount,1010051,84753688,'','".AddSlashes(pg_result($resaco,$iresaco,'ed47_parentescoresponsavel'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
    ...
    public function sql_query($ed47_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    $sql .= "      left  join censoregiao as regiao on regiao.ed174_codigo = aluno.ed47_censoregiao";
    $sql .= "      left  join censoregiao as regiaonat on regiaonat.ed174_codigo = aluno.ed47_censoregiaonat";
    $sql2 = "";
    if (empty($dbwhere)) {
      if (!empty($ed47_i_codigo)) {
    ...
    public function sql_query_ficha_matricula($ed47_i_codigo = null,$campos = "*", $ordem = null, $dbwhere = "")
    {
    ...
    public function sql_query_file($ed47_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql  = "select {$campos} ";
        $sql .= "  from aluno ";
        $sql2 = "";
    ...
    public function sql_query_matricula_ano($ed47_i_codigo = null, $campos = "*", $group = null,$ordem = null, $dbwhere = "")
    {
        $sql  = "select {$campos} ";
        $sql .= "  from aluno ";
        $sql .= "join matricula ON matricula.ed60_i_aluno = aluno.ed47_i_codigo";
        $sql2 = "";
        if (empty($dbwhere)) {
            if (!empty($ed47_i_codigo)){
                $sql2 .= " where aluno.ed47_i_codigo = $ed47_i_codigo ";
    ...
    public function sql_query_censo($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
    ...
    public function sql_query_alunotrocaturma($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
    ...
    public function sql_query_matr($ed47_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if($campos != "*" ){
    ...
    public function sql_query_atestvaga($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
    ...
    public function sql_query_alunomatricula($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
            $sCamposSql = split('#', $sCampos);
    ...
    public function sql_query_censo_inep($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
            $sCamposSql = split('#', $sCampos);
    ...
    public function sql_query_aluno_curso($iCodigo = null, $sCampos = '*', $sOrdem = null, $sDbWhere = '')
    {
        $sSql = 'select ';
        if ($sCampos != '*') {
            $sCamposSql = split('#', $sCampos);
    ...
    public function sqlAlunosMatriculadosCenso($whereTurmarRegular, $whereTurmaAC, $where = [], $order = 'ed47_v_nome')
    {
      $sql = "
      with alunos_turma_regular as (
        select matricula.ed60_i_aluno
        from matricula
             join matriculaserie on matriculaserie.ed221_i_matricula = matricula.ed60_i_codigo
        ...
        where {$whereTurmarRegular}
      ), alunos_turma_nee as (
         select ed269_aluno
         from turmaac
              join turmaacmatricula on turmaacmatricula.ed269_i_turmaac = turmaac.ed268_i_codigo
              join calendario on calendario.ed52_i_codigo = turmaac.ed268_i_calendario
         where {$whereTurmaAC}
       ), alunos_matriculados as (
        select *
          from alunos_turma_regular
        union
        select *
          from alunos_turma_nee
      ) select aluno.*
          from alunos_matriculados
          join aluno on aluno.ed47_i_codigo = alunos_matriculados.ed60_i_aluno
      ";
