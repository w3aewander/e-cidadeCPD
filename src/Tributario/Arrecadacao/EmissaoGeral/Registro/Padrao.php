...
class Padrao
{
   ...
   */
     ...
     * @return integer
     */
    public function getParcelaUnica()
    {
        return $this->iParcelaUnica;
    }

    /**
     * @param integer $iParcelaUnica
     * @return Padrao
     */
    public function setParcelaUnica($iParcelaUnica)
    {
        $this->iParcelaUnica = $iParcelaUnica;
        return $this;
    }
}
