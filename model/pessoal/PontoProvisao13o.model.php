 ...
 */
class PontoProvisao13o extends Ponto {

  /**
   * Nome da tabela para ponto de provisao de 13o 
   */
  const TABELA = Ponto::PROVISAO_13o;

  /**
   * Sigla da tabela do ponto de provisao de 13o 
   */
  const SIGLA_TABELA = 'r92';
