...
<div class="container">
    ...
    <div id="containerAlunos" style="display: none;">
        ...
        <div class="btn-wrapper">
            <input type="button" id="btnAdicionarRematricula" value="Confirmar rematrícula">
        </div>
    </div>
</div>
...
<script>
    ...
    const btnAdicionarRematricula = document.querySelector('#btnAdicionarRematricula');
    ...
    const montaGrid = () => {
        ...
        dataGridCollectionAlunos.hideColumns([1]);
    ...
    btnPesquisarAlunos.addEventListener('click', () => {
        ...
        formData.append('acao', 'buscarAlunos');
    ...
    btnAdicionarRematricula.addEventListener('click', () => {
        ...
        const formData = new FormData();
        formData.append('acao', 'confirmarRematricula');
        formData.append('escola', escola.value);
        formData.append('calendario', calendario.value);
        formData.append('turma', turma.value);
