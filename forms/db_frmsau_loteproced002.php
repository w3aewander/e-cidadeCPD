						...
						<tr>
							...
							<table width="100%" cellspacing="0" cellpadding="0">
								<tr>
									...
									<?=@$Lsd29_c_hora?>
                                    <?php db_input ( 'sd29_c_hora', 5, $Isd29_c_hora, true, 'text', $db_opcao, "OnKeyUp=mascara_hora(this.value,'sd29_c_hora',event,false) onFocus='js_foco(this, \"".(isset($intQuant)?"intQuant":"sd29_t_tratamento")."\" );'  onblur=\"js_verifica_hora_webseller(this.value,this.name);\"  "   )?>
									</td>
                                    <?php if( isset($intQuant) ){ ?>
