...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_termovistlanc");
...
public function incluir (){
     ...
     $sql = "insert into fiscalizacao.fis_termovistlanc(
                                       y92_termovist
                                      ,y92_codvist
                       )
                values (
...
public function alterar ( $oid=null ) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_termovistlanc set ";
     $virgula = "";
...
public function excluir ( $oid=null ,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_termovistlanc
                    where ";
     $sql2 = "";
...
public function sql_query ( $oid = null,$campos="fis_termovistlanc.oid,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_termovistlanc ";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_termovistlanc.y92_codvist";
     $sql .= "      inner join fiscalizacao.fis_termovist  on  fis_termovist.y91_termovist = fis_termovistlanc.y92_termovist";
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where fis_termovistlanc.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
