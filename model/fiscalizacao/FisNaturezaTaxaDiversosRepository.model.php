...
*/
class FisNaturezaTaxaDiversosRepository extends BaseClassRepository {
  ...
  protected function make($iCodigo) {
    ...
    $oNaturezaTaxaDiversos = new FisNaturezaTaxaDiversos;
    ...
    db_utils::makeFromRecord($rsTaxadiversos, function ($oDados) use ($oNaturezaTaxaDiversos) {
      ...
      $oNaturezaTaxaDiversos->setGrupoTaxaDiversos (FisGrupoTaxaDiversosRepository::getInstanciaPorCodigo($oDados->y119_grupotaxadiversos));
