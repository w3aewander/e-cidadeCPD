...
if (isset($alterar)) {
    ...
    $sSql = $clemppresta->sql_query_prest_contas(null,
        "e60_codemp, emppresta.*, e44_descr, e60_vlrpag, e53_codord, e53_vlrpag",
        null,
...
if (isset($chavepesquisa)) {
  ...
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_empprestaitem.location.href='emp1_empprestaitem001.php?e60_codemp=$e60_codemp&e46_numemp=" . @$e45_numemp . "&e45_sequencial={$e45_sequencial}&e45_tipo={$e45_tipo}'";

    if (db_permissaomenu(db_getsession("DB_anousu"), db_getsession("DB_modulo"), 9489) == "false") {
        echo "
    ...
    echo "(window.CurrentWindow || parent.CurrentWindow).corpo.iframe_encerra.location.href='emp1_empprestaencerra.php?e60_codemp=$e60_codemp&e60_numemp=" . @$e45_numemp . "&e45_sequencial={$e45_sequencial}&e45_tipo={$e45_tipo}'";
    if (isset($liberaaba)) {
