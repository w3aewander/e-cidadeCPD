...
class cl_fis_fiscalandam {
   ...
   public $y49_codnoti = 0;
   public $y49_codandam = 0;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalandam");
...
public function incluir ($y49_codnoti,$y49_codandam){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalandam(
                                       y49_codnoti
                                      ,y49_codandam
                       )
                values (
...
public function alterar ($y49_codnoti=null,$y49_codandam=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalandam set ";
     $virgula = "";
...
public function excluir ($y49_codnoti=null,$y49_codandam=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalandam
                    where ";
     $sql2 = "";
...
public function sql_query ( $y49_codnoti=null,$y49_codandam=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalandam ";
     $sql .= "      inner join fiscalizacao.fis_fandam  on  fis_fandam.y39_codandam = fis_fiscalandam.y49_codandam";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalandam.y49_codnoti";
     ...
     if($dbwhere==""){
       if($y49_codnoti!=null ){
         $sql2 .= " where fis_fiscalandam.y49_codnoti = $y49_codnoti ";
       }
       if($y49_codandam!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fiscalandam.y49_codandam = $y49_codandam ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y49_codnoti=null,$y49_codandam=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
