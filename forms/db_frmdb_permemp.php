    ...
    <table border="0">
      ...
      <tr>
        ...
        <td nowrap>
          ...
          db_selectrecord("db20_orgao",$result,true,$db_opcao,"","","","$sStringTodos",$onchange=" js_atual('db20_orgao');");
          if($db_opcao==1){
            ?>
            <input name='incluir_todos' type="submit" value="Incluir Todos">
            <input name='excluir_todos' type="submit" value="Excluir Todos">
...
//      echo $clorcunidade->sql_query(null,null,null,"o41_unidade as db20_unidade,o41_descr","o41_unidade","o41_anousu=".db_getsession("DB_anousu")."  and o41_orgao=$db20_orgao " );
      ...
      <tr>
        ...
        <td>
          ...
          $sSql = $clorcdotacao->sql_query(null,null,"distinct o15_codigo as db20_codigo,o15_loaespecificacao || ' - ' || o15_descr","o15_codigo","o58_anousu=".db_getsession("DB_anousu")." $dbwhere");
  ...
  <?php if (empty($nao_retorna)) { ?>
    <input name="retorna" type="button" onclick='js_voltar();'  value="Voltar">
  <?php } ?>
      ...
      <td>
        ...
        $cliframe_alterar_excluir->sql     = $cldb_permemp->sql_query_origem(null,
                                                                             "db20_codperm,db20_anousu,db20_orgao,db20_unidade,
                                                                              ...
                                                                              case when db20_tipoperm = 'M' then 'MANUTENÇÃO' else 'CONSULTA' end as db20_tipoperm ",'db20_orgao',"$dbwhere");
        $cliframe_alterar_excluir->campos  ="db20_anousu,db20_orgao,db20_unidade,db20_funcao,db20_subfuncao,db20_programa,db20_projativ,db20_codele,db20_codigo,o15_loaespecificacao, db20_tipoperm";
        $cliframe_alterar_excluir->legenda = "Permissões Cadastradas";
        $cliframe_alterar_excluir->iframe_height ="250";
        $cliframe_alterar_excluir->alignlegenda = "left";
        $cliframe_alterar_excluir->iframe_alterar_excluir($db_opcao);

        if (!empty($nao_retorna)) {
          $query = "nao_retorna={$nao_retorna}&{$query}";
        }
        ?>
      </td>
    </tr>
...
<script>
  ...
  function js_limpa(){
    location.href = 'con1_db_permemp001.php?<?php echo $query; ?>';
  }
</script>
