...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  ...
  if ( !$lSqlErro && isset($o13_unidaderesp) && trim($o13_unidaderesp) != "" ) {
	...
	$oSql = "select o13_sequencial,o13_anousu as iano from orcprojativunidaderesp where o13_orcprojativ = ".$o55_projativ;
	$oResult = db_query($oSql);
	for( $x=0; $x < pg_num_rows($oResult) ; $x++ ){
	db_fieldsmemory($oResult,$x);
	...
	$clorcprojativunidaderesp->o13_sequencial       = $o13_sequencial;
