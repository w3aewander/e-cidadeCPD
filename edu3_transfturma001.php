      ...
      <td align="center" valign="top">
       <table border='1px' width="100%" bgcolor="#cccccc" style="" cellspacing="0px">
        ...
        $campos1 = "ed60_i_codigo,
                    ...
                    ed69_d_datatransf";
        $sql = $clalunotransfturma->sql_query("", $campos1, "ed69_d_datatransf,turma.ed57_c_descr", " turma.ed57_i_escola = $escola AND turma.ed57_i_calendario = $calendario");
        $result = $clalunotransfturma->sql_record($sql);
