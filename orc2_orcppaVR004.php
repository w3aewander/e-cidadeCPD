  ...
  foreach ( $oEstimativa->aAcoes as $iProjAtiv => $aDadosAcoes ) {
    ...
    if ($nTotalValorAcao > 0) {
      ...
      if ($oGet->quadroacao == 1) {
        ...
        $pdf->Cell(52,$alt,"Título"                             ,"TR" ,0,"C",0);
        ...
        $pdf->setfont('arial','', 6);
        $pdf->multicell(52,$iAltDescr,str_pad($aDadosAcoes['sDescricao'],70," ",STR_PAD_RIGHT),"TRL","L",1);
        $pdf->setfont('arial','', 8);
        ...
        $pdf->Cell(110,$alt,"Título"                              ,"TR" ,0,"C",0);
        // $pdf->Cell(26,$alt,"Subtítulo/"                          ,"TR" ,0,"C",0);
        ...
        $pdf->setfont('arial','', 8);
        $pdf->multicell(110,$iAltDescr,str_pad($aDadosAcoes['sDescricao'],70," ",STR_PAD_RIGHT),"TRL","L",1);
        $pdf->setfont('arial','', 8);
