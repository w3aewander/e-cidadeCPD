                ...
                <table border="1" align="center" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            ?>
                            <?php if ($minimo != $codrec) { ?>
                                <input name="anterior" value="Anterior" type="button"
                                       onclick="location.href='func_saldoorcreceita.php?cursor=anterior&codrec=<?= ($codrec - 1 < 1 ? $codrec : $codrec - 1) ?>'">
                            <?php } ?>
                            <?php if ($maximo != $codrec){ ?>
                            <input name="Proximo" value="Próximo" type="button"
                                   onclick="location.href='func_saldoorcreceita.php?cursor=proximo&codrec=<?= $codrec + 1 ?>'">
                        </td>
                        <?php } ?>
                    </tr>
