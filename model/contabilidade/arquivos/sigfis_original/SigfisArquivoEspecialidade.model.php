...
/*        $oDados->Nu_Empenho              = str_pad( ( $oDadosQuery->ano == 2014?"":"20") .$oDadosQuery->e60_codemp, 10, ' ', STR_PAD_RIGHT);
*/  

	if ($oDadosQuery->ano <= 2013) {
	    $oDados->Nu_Empenho = str_pad($oDadosQuery->ano . $oDadosQuery->e60_codemp, 10, ' ', STR_PAD_RIGHT);
	}
	else
	{
