...
DBViewManutencaoContratosEmergenciais.prototype.processar           = function() {
  ...
  this.oRequisicaoAjax.setCallBack(function(oResponse, lErro){
    ...
    sQuery += "&rubini=0001";
    sQuery += "&rubfim=R999";
    sQuery += "&campo_auxilio_regi="+$F("rh01_regist");
    sQuery += "&campo_auxilio_lota=";
    sQuery += "&manutencao";
    js_divCarregando("Inicializando ponto, aguarde.","msgBox");
    js_OpenJanelaIframe("",'db_iframe_ponto','pes4_inicializaponto002.php'+sQuery,'Inicialização do Ponto',true);	  
    js_removeObj("msgBox");
