...
class cl_db_uf {
   ...
   public function incluir ($db12_codigo){
      $this->atualizacampos();
   ...
   public function alterar ($db12_codigo=null) {
      $this->atualizacampos();
   ...
   public function excluir ($db12_codigo=null,$dbwhere=null) {
   ...
   public function sql_query ( $db12_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $db12_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
