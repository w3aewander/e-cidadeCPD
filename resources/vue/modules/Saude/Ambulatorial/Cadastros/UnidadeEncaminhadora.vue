...
const routes = {
    pesquisarUnidades:`v4/api/saude/ambulatorial/consulta/unidades-encaminhadoras`,
    salvarUnidade:`v4/api/saude/ambulatorial/cadastro/unidades-encaminhadoras/save`,
    excluirUnidade:`v4/api/saude/ambulatorial/cadastro/unidades-encaminhadoras/delete`
};
...
<template>
    ...
    <section class = "container w-6">
        <Panel header="Cadastros de Unidades Encaminhadoras">    
