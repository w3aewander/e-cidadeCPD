 ...
 <tr>
  <td height="430" align="center" valign="top" bgcolor="#CCCCCC">
    ...
    <table>
     ...
     <td>
      <?php db_inputdata('data1',@$dia1,@$mes1,@$ano1,true,'text',1,"")?>À
   ...
   query='';
    ...
    if(query == ""){
     alert("Indique o período");
      ...
      jan = window.open('fis2_fis_periodolevant002.php?'+query,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
      jan.moveTo(0,0);
    }
}
</script>
