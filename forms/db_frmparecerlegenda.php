...
<table border="0">
 ...
 <tr>
  ...
  <td>  
   <?db_input('ed91_c_descr',25,$Ied91_c_descr,true,'text',$db_opcao,"", "", "", "", 25 )?>   
  </td>
 </tr>
 <tr>
...
<script>
    console.log(document.getElementById("ed91_c_descr").maxLenght);
    document.getElementById("ed91_c_descr").maxLenght = "25";
    console.log(document.getElementById("ed91_c_descr").maxLenght);
</script>