...
try {
  ...
  if(isset($excluir)) {
    ...
    if ($sqlerro == false){
      ...
      $portaria = Portaria::find($h31_sequencial);
      $portariaDocumentoService = new \App\Domain\Patrimonial\Protocolo\Services\PortariaDocumentoService($portaria);
      $portariaDocumentoService->excluirDocumento();
