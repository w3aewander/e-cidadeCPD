...
if(isset($y59_codauto) && $y59_codauto != ""){
  if(isset($opcao) && $opcao == "alterar"){  
    echo "<script>parent.iframe_fiscais.loc  ation.href='fis1_fis_autousu002.php?chavepesquisa=$y56_codauto&chavepesquisa1=$y56_id_usuario&y59_codauto=$y59_codauto  &y39_codandam=$y39_codandam'</script>  ";}  
  if(isset($opcao) && $opcao == "excluir"){  
    echo "<script>parent.iframe_fiscais.location.href='fis1_fis_autousu003.php?chavepesquisa=$y56_codauto&chavepesquisa1=$y56_id_usuario&y59_codauto=$y59_codauto  &y39_codandam=$y39_codandam'</script>";
  }
  
  $rsConsultaProc = db_query(" select y111_procfiscal as procfiscal from fiscalizacao.fis_procfiscalauto where y111_auto = $y59_codauto");
...
<table border="0">
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_autousu001.php?y59_codauto=<?=$y59_codauto?>'">
      <?php
      }
      ?>
    </td>
  ...
  <tr>
   ...
   <?php
     if(isset($y59_codauto) && $y59_codauto != ""){
       ...
       $cliframe_alterar_excluir->sql           = $clautousu->sql_query("",""," fis_autousu.*,db_usuarios.*",""," y56_codauto = $y59_codauto");
       ...
       $clautousu1 = new cl_fis_autousu;
       $clautousu1->sql_record($clautousu1->sql_query("",""," fis_autousu.*,db_usuarios.*",""," y56_codauto = $y59_codauto"));
...
function js_pesquisay56_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y56_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
<?php }?> 
  ...
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe','func_fis_cadfiscaisdepto.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome'+sUrl,'Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe','func_fis_cadfiscaisdepto.php?pesquisa_chave='+document.form1.y56_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios'+sUrl,'Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe','func_fis_autousu.php?funcao_js=parent.js_preenchepesquisa|y56_codauto|1','Pesquisa',true);
}
