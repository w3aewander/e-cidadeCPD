...
class ProcessaArquivoRetencao{
  ...
  public function processarRegistros() {
    ...
    foreach ($this->aRegistrosRetencao as $iIndice => $oRegistroRetencao) {
      ...
      //$oDaoArrecad->k00_dtoper = $oData->getDate();
      $oDaoArrecad->k00_dtoper = $oRegistroRetencao->q91_datavencimento;
      ...
      $oDaoArrecad->k00_dtvenc = $oRegistroRetencao->q91_datavencimento;
      ...
      $sDataEmissaoRecibo = $oRegistroRetencao->q91_datavencimento;
      // $sDataEmissaoRecibo = $oRegistroRetencao->q91_dataemissaodocumento;
      ...
      $oDaoDisbanco->dtpago     = $oRegistroRetencao->q91_dataemissaodocumento;
