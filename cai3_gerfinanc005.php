...
$rsParJuridico = $oDaoParJuridico->sql_record($oDaoParJuridico->sql_query(db_getsession("DB_anousu"),
  db_getsession("DB_instit"), "v19_partilha"));
...
<center>
          ...
          <td>
            <table width="100%" border="1" cellspacing="0" bgcolor="#999999">
                  ...
                  <td>
                    ...
                    <input type="hidden" name="v07_parcel" value="<?php echo $v07_parcel; ?>">
                      ...
                      if ($mostrabotao == "true" || $mostrabotaoBySim == "true") {
                          if (@$mostra != "nao") {
                              ?>
                            <input type="button" name="anula" value="Simular Anulação de Parcelamento"
                                   onclick="js_anula();">
                              <?php
                          }
                      }
              ...
              <tr>
                ...
                <td> &nbsp; <?php echo @$v07_hist; ?> Protocolo: <?php echo $oProtocolo->numerodoprocesso; ?></td>
              </tr>
              <tr>
            ...
            if ($k03_tipo == 4) {
                ...
                if ($k03_tipo == 5) {
                    ...
                    if ($k03_tipo == 7) {
                        ...
                        if ($k03_tipo == 6 || $k03_tipo == 13 || $k03_tipo == 16 || $k03_tipo == 17 || $k03_tipo == 30) {
                ...
                <table width="97%" cellspacing="0" class="tab_cinza" style="font-size:14px">
                  <tr>
                    ...
                    for ($iContArrevenc = 0; $iContArrevenc < $iLinhaArrevenc; $iContArrevenc++) {
                        db_fieldsmemory($rsArrevenc, $iContArrevenc);
                        if ($k00_dtfim != "") {
    ...
    if ($numpar > 0) {
        ...
        if ($rsArrevenc != false && $clarrevenc->numrows > 0) {
          ...
          <table width="100%" border="1" cellspacing="0" bgcolor="#999999">
            <tr>
              <td bgcolor="#CCCCCC" align="center" colspan="3" style="font-size:14px"><strong>Prorrogações de
                  Vencimentos Efetuadas</strong></td>
            </tr>
            <tr>
              <td> Data Inicial</td>
              <td> Data Final</td>
    ...
    $rsArrehist = $clarrehist->sql_record($clarrehist->sql_query(null, "*", "k00_dtoper",
      " k00_numpre = $numpre " . ($numpar > 0 ? "and k00_numpar = $numpar" : "")));
  ...
  <fieldset>
    <legend>Lançamentos Efetuados</legend>
      ...
      ?>
    <iframe width="100%" height="300" border="0"
            src="<?php echo $sArquivoIframe; ?>?numpre=<?php echo $numpre; ?>&numpar=<?php echo $numpar; ?>"></iframe>
  </fieldset>
