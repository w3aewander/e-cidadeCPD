      ...
      if (iNumDados > 0) {
        ...
        oRetorno.dados.each(
                  function (oDado, iInd) {
                    ...
                    oGrvDetalhes.aRows[iInd].sEvents += `ondblClick="parent.js_showItens(1, '${oDado.codigo}', '${oDado.departamento}', '${oDado.anulacao}')"`;
                  }
      ...
      if (iNumDados > 0) {
        ...
        oRetorno.dados.each(
                  function (oDado, iInd) {
                    ...
                    aRow[4] = oDado.unidade.urlDecode() + `(${oDado.quantidadeUnidade})`;
