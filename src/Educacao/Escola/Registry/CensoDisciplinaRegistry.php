...
use ECidade\Educacao\Escola\Repository\CensoDisciplinaRepository;

class CensoDisciplinaRegistry
{
    /**
     * @var CensoDisciplina[]
     */
    ...
    {
        self::$storage[$censoDisciplina->getCodigo()] = $censoDisciplina;
    }
