...
class cl_termoanu { 
   ...
   public $v09_sequencial = 0; 
   public $v09_parcel = 0; 
   public $v09_usuario = 0; 
   public $v09_data_dia = null; 
   public $v09_data_mes = null; 
   public $v09_data_ano = null; 
   public $v09_data = null; 
   public $v09_hora = null; 
   public $v09_motivo = null; 
   ...
   public function incluir ($v09_sequencial){ 
      $this->atualizacampos();
   ...
   public function alterar ($v09_sequencial=null) { 
      $this->atualizacampos();
   ...
   public function excluir ($v09_sequencial=null,$dbwhere=null) { 
   ...
   public function sql_query ( $v09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $v09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sqlQueryTermoOrigem ( $v09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
     ...
     $sql .= "      left  join arreauto     on arreauto.k00_numpre    = termo.v07_numpre     ";
     $sql .= "      left  join arrelanc   on arrelanc.k00_numpre    = termo.v07_numpre     ";
     $sql .= "      inner join db_usuarios  on db_usuarios.id_usuario = termoanu.v09_usuario ";
     $sql .= "      inner join cgm          on cgm.z01_numcgm         = termo.v07_numcgm     ";
     $sql2 = "";
