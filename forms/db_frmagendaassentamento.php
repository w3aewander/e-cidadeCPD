...
<html>
  ...
  <body style="background-color: #ccc; margin-top: 30px">
    ...
    <form name="form1" id="form1" class="container">
      ...
      <div class="container">
        ...
        <?php
          ...
          $sCampos .= "formulaprorroga.db148_nome as h82_formulaprorrogafim,    ";
          ...
          $cliframe_alterar_excluir->campos  = "h82_tipoassentamento, h82_formulainicio, h82_formulafim, h82_formulafaltasperiodo, h82_formulacondicao, h82_formulaprorrogafim, h82_selecao ";
    ...
    <?php 
      ...
      $sMensagem .= "Recursos Humanos > Procedimentos > Concessão de Direitos > Parâmetros\n";
