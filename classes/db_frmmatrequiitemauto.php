      ...
      <table class="form-container">
        ...
        <?php
          ...
          if (isset($m41_codmatmater)&&$m41_codmatmater!="") {
            ...
            $sSql = "select m41_codmatrequi as m41_codmatrequi_old, m40_data as m40_data_old, m41_quant as m41_quant_old,
	    	     ( select m85_precomedio from matmaterprecomedio where m85_precomedio > 0 and to_timestamp(m85_data || ' ' || m85_hora, 'YYYY-MM-DD HH24:MI:SS') < to_timestamp(current_date || ' ' || current_time, 'YYYY-MM-DD HH24:MI:SS') and m85_matmater = m41_codmatmater order by to_timestamp(m85_data || ' ' || m85_hora, 'YYYY-MM-DD HH24:MI:SS') desc limit 1 ) as m41_pm
from matrequiitem inner join matrequi on m40_codigo = m41_codmatrequi where m41_codmatmater = $codmater order by 2 desc, 1 desc";
        ...
        <tr>
          <td title='Quantidade da ultima requisicao'>
            <b>Quantidade da ultima requisicao:</b></td>
          <td>
            <?php
              db_input('m41_quant_old',10,"Quantidade da ultima requisicao",true,'text',3,"");
            ?>
          </td>
        </tr>

        <tr>
          <td title='Data da ultima requisicao'>
            <b>Data da ultima requisicao:</b></td>
          <td>
            <?php
              $m40_data_old = db_formatar($m40_data_old,"d");
              db_input('m40_data_old',10,"data ultima requisicao",true,'text',3,"");
            ?>
          </td>
        </tr>
        ...
        <tr>
          <td title='Numero da ultima requisicao'>
            <b>Numero da ultima requisicao:</b></td>
          <td>
            <?php
              db_input('m41_codmatrequi_old',10,"numero da ultima requisicao",true,'text',3,"");
            ?>
          </td>
        </tr>
        ...
        <tr>
          <td title='Preco Medio'>
            <b>Preco Medio:</b></td>
          <td>
            <?php
              db_input('m41_pm',10,"Preco Medio",true,'text',3,"");
            ?>
          </td>
        </tr>
