...
function imprimeConta($pdf,$codigo,$descricao,$dtimplantacao,$debito,$credito,$lImprimeSaldo){
	...
	$pdf->SetFont('Arial','b',8);
        ...
        $pdf->Cell(72,5,"DATA IMPLANTACAO DA CONTA NA TESOURARIA: " ,0,0,"L",0);
        $pdf->SetFont('Arial','',8);
        $pdf->Cell(30,5,db_formatar($dtimplantacao,'d'),0,0,"L",0);
        $pdf->SetFont('Arial','b',8);

	if($lImprimeSaldo){
		$pdf->Cell(50,5,"SALDO ANTERIOR:"				,0,0,"R",0);
