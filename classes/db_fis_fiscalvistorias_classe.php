...
class cl_fis_fiscalvistorias {
   ...
   public $y21_codnoti = 0;
   public $y21_codvist = 0;
...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalvistorias");
...
public function incluir ($y21_codnoti,$y21_codvist){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalvistorias(
                                       y21_codnoti
                                      ,y21_codvist
                       )
                values (
...
public function alterar ($y21_codnoti=null,$y21_codvist=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalvistorias set ";
     $virgula = "";
...
public function excluir ($y21_codnoti=null,$y21_codvist=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalvistorias
                    where ";
     $sql2 = "";
...
public function sql_query ( $y21_codnoti=null,$y21_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fiscalvistorias ";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_fiscalvistorias.y21_codvist";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fiscalvistorias.y21_codnoti";
     ...
     $sql .= "      inner join db_depart  as a on   a.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y21_codnoti!=null ){
         $sql2 .= " where fis_fiscalvistorias.y21_codnoti = $y21_codnoti ";
       }
       if($y21_codvist!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fiscalvistorias.y21_codvist = $y21_codvist ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y21_codnoti=null,$y21_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
