    ...
    <tr>
        <td>
            ...
            $clcriaabas->identifica = array(
                ...
                "formformulariojson" => "Arquivo Json Formulario",
                "linkSaibaMais" => "Link Saiba mais...",
                "mensagem" => "Mensagem",
                "persona" => "Persona",
            ...
            $clcriaabas->src = array(
                "tipoprocesso" => "ouv1_aba1tipoproc005.php",
                "departamento" => "ouv1_aba2depto004.php",
                "formreclamacao" => "ouv1_aba3formrecl004.php",
                "andamentopadrao" => "pro1_andpadrao001.php?aba",
                "formformulariojson" => "ouv1_aba3formularioJson004.php",
                "linkSaibaMais" => "ouv1_abaLinkSaibaMais004.php",
                "mensagem" => "ouv1_abaMensagem004.php",
                "persona" => "ouv1_abaPersona004.php",
...
<script>
    ...
    document.formaba.formformulariojson.size = 25;
    document.formaba.linkSaibaMais.size = 25;
</script>
</html>
