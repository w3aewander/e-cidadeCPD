        ...
        <td align="center" valign="top">
         ...
         exists(SELECT abertura.pc10_numero,
            ...
            if (!empty($formacontrole)) {
                ...
                $where[] = " exists(select * from solicitavinculo as estimativa
                           inner join solicita as abertura on estimativa.pc53_solicitapai = abertura.pc10_numero
                           inner join solicitaregistropreco on pc54_solicita = abertura.pc10_numero
                           where estimativa.pc53_solicitafilho = solicita.pc10_numero";
