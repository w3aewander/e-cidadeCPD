...
<table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <input name="Fechar" type="button" id="fechar" value="Fechar"
                                   onClick="parent.db_iframe_matricula.hide();">
                        </td>
                    </tr>
                </form>
            </table>
    ...
    <tr>
        <td align="center" valign="top">
            ...
            /**
             * Verificamos se existe algum aluno com matricula, onde o turno da turma eh o mesmo turno da turma de
             * atividade complementar. Caso exista, nao apresentamos para vinculo, a nao ser que o aluno tenha
             * necessidade especial e a turma do aluno for de turno integral.
             */
