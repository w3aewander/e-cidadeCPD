...
class SigfisArquivoItemReceita extends SigfisArquivoBase implements iPadArquivoTXTBase {
  ...
  public function gerarDados() {
    ...
    $sSqlOrcFontes = "select case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,1) || substr(o57_fonte,3,7) else substr(o57_fonte,2,8) end as o57_fonte, o57_descr, o57_anousu, o57_codfon, reduz from ( $sSqlOrcFontes ) as x group by case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,1) || substr(o57_fonte,3,7) else substr(o57_fonte,2,8) end, o57_descr, o57_anousu, o57_codfon, reduz order by case when substr(o57_fonte,1,1) = '9' then substr(o57_fonte,1,1) || substr(o57_fonte,3,7) else substr(o57_fonte,2,8) end";
