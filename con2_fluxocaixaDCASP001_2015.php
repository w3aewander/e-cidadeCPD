...
if (empty($_SESSION['modelo_dcasp'])) {
   $_SESSION['modelo_dcasp'] = 1;
}
...
$checkQuadroPrincipal = 'checked';
$checkReceitasDerivadas = 'checked';
$checkTransferenciaRecebida = 'checked';
$checkDesembolsoPessoal = 'checked';
$checkJurosEncargos = 'checked';

$displayReceitasDerivadas = "";
if ($iAnoUsu >= 2020) {
    $displayReceitasDerivadas = "style='display:none;'";
    $checkReceitasDerivadas = '';
}
?>
<html>
    <head>
            ...
            <fieldset style="width: 400px;">
                ...
                <fieldset id="fieldsetSelecaoQuadros">
                    ...
                    <table id="tableSelecaoQuadros">
                        <tr>
                            <td><input type="checkbox" id="chkQuadroPrincipal" <?=$checkQuadroPrincipal?> /></td>
                            <td><label for="chkQuadroPrincipal"><b>Quadro Principal</b></label></td>
                        </tr>
                        <tr <?=$displayReceitasDerivadas?> >
                            <td><input type="checkbox" id="chkReceitasDerivadas" <?=$checkReceitasDerivadas?>  /></td>
                            <td nowrap><label for="chkReceitasDerivadas"><b>Quadro Receitas Derivadas Originárias</b></label></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" id="chkTransferenciaRecebida" <?=$checkTransferenciaRecebida?>/></td>
                            <td><label for="chkTransferenciaRecebida"><b>Quadro Transfêrencias Recebidas e Concedidas</b></label></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" id="chkDesembolsoPessoal" <?=$checkDesembolsoPessoal?> /></td>
                            <td><label for="chkDesembolsoPessoal"><b>Quadro Desembolso de Pessoal e Demais Despesas Por Função</b></label></td>
                        </tr>
                        <tr>
                            <td><input type="checkbox" id="chkJurosEncargos" <?=$checkJurosEncargos?> /></td>
                ...
                <table align="center">
                    <tr>
                        <td><label for="o116_periodo"><b>Modelo:</b></label></td>
                        <?php
...
<script>
    ...
    modelo.addEventListener('change', function () {
        ...
        const url = "con2_relatoriosdcasp001.php?codRelatorio="+codRel+"&codigoRelatorio="+codRel+"&sProgramaRelatorio=fluxodecaixa&modelo="+ this.value;
  ...
  function js_emite() {
    ...
    var sQuery  = "?db_selinstit="                    + sInstituicao;
        ...
        sQuery += "&modelo="                          + $F('modelo');

    var jan = window.open(sProgramaRelatorio + sQuery, '', 'scrollbars=1,location=0 ');
    jan.moveTo(0,0);
