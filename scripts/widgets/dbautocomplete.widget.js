...
//    sInnerCss += " } ";
  ...
  /**
   * Define o caminho da busca
   * @param string caminho com o caminho novo com parametro ou sem ex 'lab4_agendar.RPC.php?tipo=2&sexoPaciente='F''
   */
  this.setCaminho = function (caminho) {
	  this.sFileNameRpc = caminho;  
  }
