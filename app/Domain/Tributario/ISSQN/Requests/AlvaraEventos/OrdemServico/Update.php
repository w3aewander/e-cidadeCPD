...
class Update extends BaseFormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'q168_processo'     => 'required_without:q168_processoexterno|nullable|integer',
            ...
            'q168_processoexterno' => 'required_without:q168_processo|nullable|string',
            'q168_titularprocessoexterno' => 'required_without:q168_processo|nullable|string',
            'q168_dataprocessoexterno' => 'required_without:q168_processo|nullable|date',
        ];
    }
