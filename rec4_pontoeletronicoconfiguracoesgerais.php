...
if($iQtdeConfiguracoesGerais > 0) {
    ...
    if(!empty($aConfiguracoes['rh200_tipoasse_atraso'])) {
        $rh200_tipoasse_atraso                  = $aConfiguracoes['rh200_tipoasse_atraso']->codigo;
        $rh200_tipoasse_atraso_h12_assent       = $aConfiguracoes['rh200_tipoasse_atraso']->h12_assent;
        $rh200_tipoasse_atraso_h12_descr        = $aConfiguracoes['rh200_tipoasse_atraso']->h12_descr;
    }
}
?>
<html>
  ...
  <form>
    <fieldset>
      ...
      <table class="form-container">
        ...
        <tr>
          <td nowrap title="<?php echo $Trh200_tipoasse_atraso; ?>">
            <label id="lbl_rh200_tipoasse_atraso" for="rh200_tipoasse_atraso_h12_assent">
              <a href="#"><?php echo $Lrh200_tipoasse_atraso; ?></a>
            </label>
          </td>
          <td>
              <?php db_input('rh200_tipoasse_atraso', 10, $Irh200_tipoasse_atraso, true, "hidden", 3, 'class="codigo-tipoasse"'); ?>
              <?php db_input('rh200_tipoasse_atraso_h12_assent', 10, '', true, "text", $db_opcao); ?>
              <?php db_input('rh200_tipoasse_atraso_h12_descr', 10, $Irh200_tipoasse_atraso, true, "text", 3); ?>
          </td>
        </tr>
      </table>
    </fieldset>
...
<script type="text/javascript">
  ...
  new DBLookUp(
    $('lbl_rh200_tipoasse_atraso'),
    $('rh200_tipoasse_atraso_h12_assent'),
    $('rh200_tipoasse_atraso_h12_descr'),
    {
      'sArquivo' : 'func_tipoasse.php',
      'aParametrosAdicionais' : ['lConfiguracoesPontoEletronico=true'],
      'aCamposAdicionais'     : ['h12_codigo', 'h12_assent', 'h12_descr'],
      ...
      'fCallBack'             : function () {
        ...
        $('rh200_tipoasse_atraso').value            = '';
        $('rh200_tipoasse_atraso_h12_assent').value = '';
        $('rh200_tipoasse_atraso_h12_descr').value  = '';

        if(arguments.length < 3) {
          $('rh200_tipoasse_atraso_h12_descr').value  = arguments[0];
          return;
        }

        var parametros = ajustarValoresLookup(arguments);
        $('rh200_tipoasse_atraso').value            = parametros.id;
        $('rh200_tipoasse_atraso_h12_assent').value = parametros.codigo;
        $('rh200_tipoasse_atraso_h12_descr').value  = parametros.descricao;
      }
    }
  );
  ...
  $('rh200_tipoasse_atraso_h12_assent').observe('blur', function () {
    verificarPreenchimentoCodigoLookup.apply(this, arguments);
  });
  ...
  function salvarConfiguracoes () {
    AjaxRequest.create(
      'rec4_pontoeletronicoconfiguracoes.RPC.php',
      {
        ...
        'rh200_tipoasse_atraso'           : $F('rh200_tipoasse_atraso')
      },
