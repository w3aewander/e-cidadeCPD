      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_issgruposervico.php")==true){
             include(modification("funcoes/db_func_issgruposervico.php"));
           }else{
        ...
        $campos = "issgruposervico.q126_sequencial, db_estruturavalor.db121_estrutural, db_estruturavalor.db121_descricao::varchar(90), q136_exercicio, q136_deducao, q136_retencao";
