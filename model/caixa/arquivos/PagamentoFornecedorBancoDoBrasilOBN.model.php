    ...
    foreach ($aLinhasArquivo as $oArquivo) {
      ...
      switch (substr($oArquivo->tipo_linha, 0, 1)) {
        ...
        case '0':
          ...
          $oDadosRetorno->header->uso_banco    = $sNomeArqRetorno;
         ...
         *   nummov                        : NÚMERO DA RELAÇÃO EXTERNA - CÓDIGO DO ARQUIVO GERADO
         *   numob                         : NÚMERI DA OB - CÓDIGO DO MOVIMENTO DA AGENDA
        ...
        case '2' :
          ...
          $oRegistro->codigo_relextern = trim((int) $oArquivo->nummov);
       ...
       break;
        ...
        case '4' :
          ...
          $sValor                                           = substr($oArquivo->valorliqui, 0, 15) . ".";
          $sValor                                          .= substr($oArquivo->valorliqui, 15, 2);
          $sValor                                           = (float)$sValor;
          $oDadosRetornoDetalhe->e140_valor                 = $sValor;
          $oDadosRetornoDetalhe->e140_numeroautenticacao    = $oArquivo->numeroautenticacao;
          $oDadosRetornoDetalhe->e140_linhaarquivo          = $oArquivo->getLinha();
          $oDadosRetornoDetalhe->e140_datahoraprocessamento = date('Y-m-d H:i:s');
          $oDadosRetorno->dadosretornodetalhe[]             = $oDadosRetornoDetalhe;          
