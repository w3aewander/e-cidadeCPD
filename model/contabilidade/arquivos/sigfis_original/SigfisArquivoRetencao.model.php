    ...
    if ($oDaoEmpempenho->numrows > 0) {
      ...
      for ($iRetencao = 0; $iRetencao < $oDaoEmpempenho->numrows; $iRetencao++) {
      	...
      	if ($oContaContabil = SigfisVinculoReceita::getVinculoReceita($oRetencao->c61_codcon)) {
            ...
            $sContaCorrente = "select (CASE WHEN conplano.c60_anousu < 2016 THEN c56_sequencial ELSE c56_contabancaria END) as seq_conta_corrente from contabilidade.conplano left join conplanocontabancaria on conplano.c60_codcon = conplanocontabancaria.c56_codcon and conplano.c60_anousu   = conplanocontabancaria.c56_anousu left join configuracoes.contabancaria on db83_sequencial = c56_contabancaria where c60_anousu = $this->iAnoUso and c60_codcon = $oRetencao->conta ";
