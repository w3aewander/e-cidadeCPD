...
class cl_unidadesencaminhadoras
{
   ...
   // cria propriedade com as variaveis do arquivo 
    public $campos = "
                 sd112_sequencial = int4 = Sequencial da unidade encaminhadora 
    ...
    {
        $this->rotulo = new rotulo("unidadesencaminhadoras"); 
    ...
    public function incluir($sd112_sequencial)
    {
     ...
     if($sd112_sequencial == "" || $sd112_sequencial == null ){
       $result = db_query("select nextval('unidadesencaminhadoras_sd112_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: unidadesencaminhadoras_sd112_sequencial_seq do campo: sd112_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from unidadesencaminhadoras_sd112_sequencial_seq");
     ...
     $sql = "insert into unidadesencaminhadoras(
                                       sd112_sequencial 
                                      ,sd112_descricao 
                                      ,sd112_ativo 
                       )
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Unidades Encaminhadoras ($this->sd112_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Unidades Encaminhadoras já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Unidades Encaminhadoras ($this->sd112_sequencial) não Incluído. Inclusão Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    {
      $this->atualizacampos();
     $sql = " update unidadesencaminhadoras set ";
     $virgula = "";
     if(trim($this->sd112_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd112_sequencial"])){ 
       ...
       if(trim($this->sd112_sequencial) == null ){ 
         $this->erro_sql = " Campo Sequencial da unidade encaminhadora não informado.";
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Unidades Encaminhadoras não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd112_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Unidades Encaminhadoras não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd112_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    {
     $sql = " delete from unidadesencaminhadoras
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Unidades Encaminhadoras não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Unidades Encaminhadoras não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$sd112_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
    ...
    public function sql_record($sql)
    {
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:unidadesencaminhadoras";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
    ...
    public function sql_query($sd112_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 
     ...
     $sql  = "select {$campos}";
     $sql .= "  from unidadesencaminhadoras ";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($sd112_sequencial)) {
         $sql2 .= " where unidadesencaminhadoras.sd112_sequencial = $sd112_sequencial "; 
       } 
