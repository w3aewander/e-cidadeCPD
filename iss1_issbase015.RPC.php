...
use ECidade\Tributario\Issqn\Repository\FormaLocAlvaraRepository;
...
try {
    ...
    switch ($parametro->executa) {
        case "salvar":
            $formalocalvara = new FormaLocAlvara();

            $ctrlocalvaraRepository = FormaLocAlvaraRepository::getInstance();

            $formalocalvara->setSequencial($parametro->q167_sequencial);
            $formalocalvara->setDescricao($parametro->q167_descricao);
            $formalocalvara->setDataValidade($parametro->q167_data_validade);

            $ctrlocalvaraRepository->persist($formalocalvara);
        ...
        case "excluir":
            ...
            $ctrlocalvaraRepository = FormaLocAlvaraRepository::getInstance();
            $ctrlocalvaraRepository->delete($formalocalvara);
