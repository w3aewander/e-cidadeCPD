    ...
    public function gerarDados()
    {
      ...
      //          throw new Exception("Nenhum registro de Empenho encontrado");
        ...
        foreach ($aDadosEmpenho as $oDados) {
            ...
            $oDadosEmpenho->NumeroReciboAnexo23              = null;
            if (!!$lExisteAcordoReciboAnexo) {
                $oDadosEmpenho->NumeroReciboAnexo23            = ((empty($oDados->anexo23)||$oDados->anexo23=="0")?null:$oDados->anexo23);
            }
            ...
            $oDadosEmpenhoFonteRecurso->CodigoGrupoExercicioFonte = substr($oDados->o58_codigo, 0, 1);
            $oDadosEmpenhoFonteRecurso->CodigoClassificacaoFonte  = substr($oDados->o58_codigo, 1, 3);
        ...
        foreach ($aLancamentosEmpenho as $oDados) {
            ...
            switch ($oDados->c57_sequencial) {
                ...
                case 11:
                    ...
                    $oDadosAnulacaoEmpenho->NumeroDocumentoEmpenhoOriginal   = $oDados->e60_codemp;
              ...
              */
                case 20:
                    ...
                    $oDadosLiquidacao->NumeroDocumentoEmpenho           = $oDados->e60_codemp;
