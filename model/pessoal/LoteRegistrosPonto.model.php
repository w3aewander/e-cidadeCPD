...
class LoteRegistrosPonto {
  ...
  function __construct($iSequencial = null) {
    ...
    // seta como padrão o tipo de folha servidor.
    $this->setTipoFolha("1");
  }
  ...
  /**
   * Retorna o tipo de folha do lote.
   * 
   * @access public
   * @return String
   */
  ...
  public function toStdClass() {
    ...
    $oRetorno->sDescricao      = urlencode($this->getDescricao());
    $oRetorno->sUsuario        = urlencode($this->getUsuario()->getNome());
