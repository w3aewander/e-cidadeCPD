...
class Paises implements TabelasInterface
{
    /**
     * @var array
     */
    ...
    {
        $this->paises = JSON::create()->parse(file_get_contents("arquivos/esocial/tabelas/tabela06.json"));
    }
