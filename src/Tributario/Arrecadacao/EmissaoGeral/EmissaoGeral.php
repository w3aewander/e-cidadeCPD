...
class EmissaoGeral
{
   ...
   */
     ...
     * @var boolean
     */
    private $emissaoGeralPadrao;

    public static function create($iTipoEmissao, $iConvenio, $oParametros, $emissaoGeralPadrao)
    {
        ...
        $oEmissao->setEmissaoGeralPadrao($emissaoGeralPadrao);
   ...
   */
     ...
     * @return bool
     */
    public function isEmissaoGeralPadrao()
    {
        return $this->emissaoGeralPadrao;
    }

    /**
     * @param bool $emissaoGeralPadrao
     * @return EmissaoGeral
     */
    public function setEmissaoGeralPadrao($emissaoGeralPadrao)
    {
        $this->emissaoGeralPadrao = $emissaoGeralPadrao;
        return $this;
    }
}
