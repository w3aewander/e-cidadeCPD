...
<form name="form1" method="post" action="" class="container">
    <fieldset>
        <table border="0">
            <tr>
                <td nowrap title="<?php echo  @$To49_codsup ?>">
            ...
            <tr>
                <td nowrap title="<?php echo  @$To49_data ?>">
                    <?php echo  @$Lo49_data ?>
                </td>
                <td>
                    <?php db_inputdata('o49_data', @$o49_data_dia, @$o49_data_mes, @$o49_data_ano, true, 'text', $db_opcao,
                        "") ?>
                </td>
            </tr>
            <tr>
...
function js_initGrid() {
  ...
  oGridSuplementacoes.setCheckbox(0);
    oGridSuplementacoes.setCellAlign(['right', 'right', 'Left', 'right', 'right']);
    oGridSuplementacoes.setHeader(['Codigo', 'Tipo', 'Descricao', 'Suplementado', 'Reduzido']);
...
$('processa_projeto').addEventListener('click', function () {
    $('oGridSuplementacoesSelectAll').click();
});
js_initGrid();
</script>
