...
include(modification("classes/db_cadescritoresp_classe.php"));
include(modification("classes/db_cadescrito_classe.php"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmcadescritoresp.php"));
	?>
    </center>
	</td>
  </tr>
