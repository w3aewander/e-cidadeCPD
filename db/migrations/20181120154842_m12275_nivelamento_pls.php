...
class M12275NivelamentoPls extends PostgresMigration
{
    public function up()
    {
        $this->reciboUp();
        $this->fc_calcula_total_arrecadUp();
        $this->fc_verifica_desconto_faixa_valorUp();
    }
...
SQL;
    ...
    private function fc_calcula_total_arrecadUp()
    {
        $sql = <<<SQL
...
SQL;
    ...
    private function fc_verifica_desconto_faixa_valorUp()
    {
        $sql = <<<SQL
