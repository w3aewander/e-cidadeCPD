...
// echo 'Recurso --> '.$recurso; exit;

if ($recurso != '') {
    
  $sWhere .= " and o15_codigo = {$recurso}";
}
       
$orderBy = z01_nome ;

$oAgenda->setOrdemConsultas(' z01_nome');
...
$sql_recurso = "select o15_descr from orctiporec where o15_codigo = $recurso";
$rs_recusro  = db_query($sql_recurso);
db_fieldsmemory($rs_recusro,0);
...
$head4           = "Recurso:{$recurso} - {$o15_descr}";
