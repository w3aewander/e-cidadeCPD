...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fisctestem");
...
public function incluir ($y23_codnoti,$y23_numcgm){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fisctestem(
                                       y23_codnoti
                                      ,y23_numcgm
                       )
                values (
...
public function alterar ($y23_codnoti=null,$y23_numcgm=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fisctestem set ";
     $virgula = "";
...
public function excluir ($y23_codnoti=null,$y23_numcgm=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fisctestem
                    where ";
     $sql2 = "";
...
public function sql_query ( $y23_codnoti=null,$y23_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_fisctestem ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_fisctestem.y23_numcgm";
     $sql .= "      inner join fiscalizacao.fis_fiscal  on  fis_fiscal.y30_codnoti = fis_fisctestem.y23_codnoti";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_fiscal.y30_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y23_codnoti!=null ){
         $sql2 .= " where fis_fisctestem.y23_codnoti = $y23_codnoti ";
       }
       if($y23_numcgm!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_fisctestem.y23_numcgm = $y23_numcgm ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y23_codnoti=null,$y23_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
