...
switch ($oParam->exec) {
  ...
  case 'salvarEndereco':
    ...
    db_inicio_transacao();
    try {
      $compl = db_stdClass::normalizeStringJsonEscapeString($oParam->endereco->descricaoComplemento);
      ...
      $oEndereco->setDescricaoMunicipio($oParam->endereco->descricaoMunicipio);
      ...
      $aRetorno->sDescricaoMunicipio = $oEndereco->getDescricaoMunicipio();
  ...
  case 'buscaValoresPadrao':
    ...
    try {
      ...
      $oRetorno->municipio     = $oParam->ismunicipio=='f'?false:true;  
