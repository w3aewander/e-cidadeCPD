...
class M26248Doc2033Abertura extends Migration
{
    /**
     * Run the migrations.
     *
...
drop function if exists doc_2033_abertura;

create function doc_2033_abertura() returns setof tp_abertura_rps
    language plpgsql
as
$$
declare
...
begin
    ...
    for rDados in (
        select e91_numemp as empenho,
               (round(e91_vlrliq, 2) - round(e91_vlrpag, 2))::numeric as valor,
               o206_recurso
