...
try {
  ...
  switch ($oParametro->exec) {
    ...
    case 'excluir':
      ...
      $sWhereGrupoTaxaDiversos = "EXISTS(select 1 from fiscalizacao.fis_taxadiversos where y119_grupotaxadiversos = y118_sequencial)";
...
function getGrupos() {
  ...
  $oDao  = new cl_fis_grupotaxadiversos();
