...
class cl_liclicita {
   ...
   */
  function sql_queryContratos ( $l20_codigo=null,$campos="*",$ordem=null,$dbwhere="", $pncp = false){
    $sql = "select ";
    if($campos != "*" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
    ...
    $sql .= "       left join liclicitaproc         on liclicitaproc.l34_liclicita         = liclicita.l20_codigo";
    $sql .= "       left join protprocesso          on protprocesso.p58_codproc            = liclicitaproc.l34_protprocesso";
    $sqlPncp = "       left join liclicitem            on liclicita.l20_codigo                = l21_codliclicita ";
    if ($pncp) {
        $sqlPncp = "      inner join liclicitem            on liclicita.l20_codigo                = l21_codliclicita ";
    }
    $sql .= $sqlPncp;
  ...
  public function sql_query_licitantes($sCampos = null, $sWhere = null, $flagItensComPropostas=false) {
  ...
  public function sql_query_lote($sCampos, $sWhere, $sGroupBy, $sOrderBy) {
    ...
    function sqlPropostasLoteLicitacon($sCampos = null, $sWhere = null, $sGroupBy = null, $sOrderBy = null)
    {
        if (empty($sCampos)) {
            $sCampos = "*";
        }
        ...
        $sSql .= "        left  join liclicitaencerramentolicitacon on l18_liclicita = l20_codigo ";
        $sSql .= "        left  join pcorcamdescla on pcorcamdescla.pc32_orcamitem = pcorcamval.pc23_orcamitem ";
        $sSql .= "                                and pcorcamdescla.pc32_orcamforne = pcorcamval.pc23_orcamforne ";
        $sSql .= "         left join pcorcamjulg  on pcorcamjulg.pc24_orcamitem = pcorcamitem.pc22_orcamitem ";
