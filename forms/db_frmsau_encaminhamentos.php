    ...
    <table class="form-container" >
      ...
      <tr>
        ...
        <td style="display: flex">
          ...
          ?>
          <div style="padding-left: 75px; display: flex; align-items: center; height: 18px;" id="linhaDaIdadeCompleta"></div>
        </td>
...
function existeCgsUnd() {
    let cgsUnd = document.getElementById('s142_i_cgsund').value;
    if (cgsUnd !== '') {
