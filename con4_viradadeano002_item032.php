...
if ( !$sqlerro ) {
  ...
  try {
    ...
    if ( $iLinhasEstruturalPadrao > 0 ) {
      ...
      $oDaoEstruturalPadrao->ed139_ativo               = $oDados->ed139_ativo == 't' ? 'true' : 'false';
      $oDaoEstruturalPadrao->ed139_arredondamedia      = $oDados->ed139_arredondamedia  == 't' ? 'true' : 'false';
    ...
    if ($iLinhasAvaliacaoEstruturaNota > 0 )  {
      ...
      for ($iContadorNota = 0; $iContadorNota < $iLinhasAvaliacaoEstruturaNota; $iContadorNota++) {
        ...
        $oDaoAvaliacaoEstruturaNotaMigracao->ed315_ativo          = $oDadosEstruturaNota->ed315_ativo == 't' ? 'true':'false';
        $oDaoAvaliacaoEstruturaNotaMigracao->ed315_arredondamedia = $oDadosEstruturaNota->ed315_arredondamedia == 't' ? 'true':'false';
