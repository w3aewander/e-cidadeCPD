...
class M25294FcCalculaEncargosUnica extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement(<<<SQL1
        CREATE OR REPLACE FUNCTION public.fc_calcula(integer, integer, integer, date, date, integer, character varying)
...
for record_alias in select * 
    ...
    if calcula = true then
        ...
        if unica and unicaJuroMulta = false then
       		v_integr = true;
        end if;
        ...
        from (
            select arrecad.k00_numpre,
                    ...
                    (select
                        rinumcgm
                    from
                        fc_busca_envolvidos('t',
                        (case
                            when db_config.db21_regracgmiptu = 0
                    then 3
