...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_receitas.location.href='fis1_fis_vistoriarec002.php?chavepesquisa=$y76_codvist&chavepesquisa1=$y76_receita'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_receitas.location.href='fis1_fis_vistoriarec003.php?chavepesquisa=$y76_codvist&chavepesquisa1=$y76_receita'</script>";
}
?>
...
?>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_vistoriarec001.php?y76_codvist=<?=$y76_codvist?>'">
      <?php
      }
      ?>
    </td>
...
function js_pesquisay76_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist|y70_id_usuario','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y76_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_vistoriarec','func_fis_vistoriarec.php?funcao_js=parent.js_preenchepesquisa|y76_codvist|1','Pesquisa',true);
}
...
if(isset($y76_codvist) && $y76_codvist != ""){
  echo "<script>js_OpenJanelaIframe('','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave=$y76_codvist&funcao_js=parent.js_mostravistorias','Pesquisa',false);</script>";
}
?>
