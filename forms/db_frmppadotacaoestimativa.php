...
function js_pesquisao08_orgao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcorgao','func_orcorgao.php?funcao_js=parent.js_mostraorcorgao1|o40_orgao|o40_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_orgao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcorgao','func_orcorgao.php?pesquisa_chave='+document.form1.o08_orgao.value+'&funcao_js=parent.js_mostraorcorgao','Pesquisa',false);
     }else{
...
function js_pesquisao08_programa(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcprograma','func_orcprograma.php?funcao_js=parent.js_mostraorcprograma1|o54_programa|o54_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_programa.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcprograma','func_orcprograma.php?pesquisa_chave='+document.form1.o08_programa.value+'&funcao_js=parent.js_mostraorcprograma','Pesquisa',false);
     }else{
...
function js_pesquisao08_projativ(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcprojativ','func_orcprojativ.php?funcao_js=parent.js_mostraorcprojativ1|o55_projativ|o55_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_projativ.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_ppadotacao','db_iframe_orcprojativ','func_orcprojativ.php?pesquisa_chave='+document.form1.o08_projativ.value+'&funcao_js=parent.js_mostraorcprojativ','Pesquisa',false);
     }else{
...
function js_retornoPesquisa(oRequest) {
  ...
  if (oRetorno.status == 1) {
    ...
    a.each(function(input,id) {
     ...
     (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_ppadotacaoele.iAnoIni = oRetorno.o01_anoinicio;
     (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_ppadotacaoele.iAnoFim = oRetorno.o01_anofinal;
     (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_ppadotacaoele.$('o05_anoreferencia').onfocus = function(event) {
     if (this.value == "") {
  ...
  (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_ppadotacaoele.addValoresGrid(oRetorno.itens);
}
...
function js_alterarDotacoes() {
  ...
  var iTotalDotacoes  = (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_ppadotacaoele.oGridPPA.getElementsByClass('dotacaonormal').length;
  if (iTotalDotacoes == 0) {
