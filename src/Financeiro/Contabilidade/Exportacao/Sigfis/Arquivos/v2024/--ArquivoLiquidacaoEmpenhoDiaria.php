    ...
    public function gerarDados(){
       $velho = false;
        ...
        foreach ($empenhos as $empenho) {
            ...
            //$this->testa($dadosdiaria); die("Confere");
            ...
            if($velho){
                ...
                if($this->instit == 45){
                    ...
                    //$this->testa($planilha); die("Confere");
                    //$this->testa($dadosdiaria); die("Confere2");
                    //442917
