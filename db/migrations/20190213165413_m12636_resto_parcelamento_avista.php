...
class M12636RestoParcelamentoAvista extends PostgresMigration
{
    public function up()
    {
        $sql = <<<PARLEMANTINHOMONSTRO
...
PARLEMANTINHOMONSTRO;
    ...
    {
        $sql = <<<PARCELAMENTINHOMONSTROCAGADO
create or replace function fc_parcelamento(integer,date,date,integer,integer,float8,integer,integer,integer,integer,float8,float8,text,integer)
returns varchar(100)
as $$
declare
