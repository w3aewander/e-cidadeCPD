...
namespace ECidade\Saude\Laboratorio\Exame\Model;

use CID;
use DBDate;
use ProcedimentoSaude;
use RequisicaoExame;
use UsuarioSistema;

/**
 * Class ConferenciaResultado
 * @package ECidade\Saude\Laboratorio\Exame\Model
 */
class ConferenciaResultado
{
    /**
    ...
    /**
     * @param ProcedimentoSaude $procedimento
     */
    public function setProcedimento(ProcedimentoSaude $procedimento)
    {
