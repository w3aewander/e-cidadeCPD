...
include(modification("classes/db_orcprogramaunidade_classe.php"));
include(modification("classes/db_orcprogramahorizontetemp_classe.php"));
include(modification("classes/db_orcindicaprograma_classe.php"));
