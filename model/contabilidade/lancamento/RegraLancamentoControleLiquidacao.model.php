...
class RegraLancamentoControleLiquidacao implements IRegraLancamentoContabil
{
    ...
    public function getRegraLancamento($iCodigoDocumento, $iCodigoLancamento, ILancamentoAuxiliar $oLancamentoAuxiliar)
    {
        ...
        $sSqlTransacao = $oDaoTransacao->sql_queryRegraLancamento(null, "*", "c114_elemento desc", $sWhere);
