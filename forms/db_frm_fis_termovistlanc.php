...
function js_pesquisay92_termovist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_termovist','func_fis_termovist.php?funcao_js=parent.js_mostratermovist1|y91_termovist|y91_datatermo','Pesquisa',true);
  }else{
     if(document.form1.y92_termovist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_termovist','func_fis_termovist.php?pesquisa_chave='+document.form1.y92_termovist.value+'&funcao_js=parent.js_mostratermovist','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?funcao_js=parent.js_mostravistorias1|y70_codvist|y70_id_usuario','Pesquisa',true);
     ...
     if(document.form1.y92_codvist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y92_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_termovistlanc','func_fis_termovistlanc.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
