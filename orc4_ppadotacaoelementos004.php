...
<form method="post" name='form1'>
    <table>
        <tr>
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                db_input('o15_codigo', 10, $Io08_recurso, true, 'hidden', $db_opcao);
            ...
            <td align="center">
            <fieldset style="width: 100%; height: 116">
        ...
        <tr>
            <td colspan='2' align='center'>
                <input type='button' value='Cadastrar'
                       id='btncadastrar' onclick="return js_cadastrarDotacoes()">
...
function js_mostraorctiporec(descricao, erro, id, recurso, complemento) {
    ...
    document.form1.o15_codigo.value = id;
