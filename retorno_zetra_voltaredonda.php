...
try {
    if ($instituicao != 1) {
        throw new \BusinessException('Esse Relatório é de uso exclusivo da instituição PREFEITURA MUNICIPAL DE VOLTA REDONDA.');
    }
...
if (isset($oPost->incluir)) {
    ...
    $sqlerro = false;
    $processado = true;
    $nomearq = "./tmp/arquivo_retorno_voltaredonda_" . $_POST['mes'] . "_" . $_POST['ano'] . ".txt";
    ...
    $caminhoArquivo = "./tmp/arquivo_retorno_voltaredonda_" . $_POST['mes'] . "_" . $_POST['ano'] . ".txt";
    $conteudo = "";
    if ($linhas > 0) {
        $registro = "";
        for ($i = 0; $i < $linhas; $i++) {
