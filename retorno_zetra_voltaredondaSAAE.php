...
if (isset($oPost->incluir)) {
    ...
    $sqlerro = false;
    $processado = true;
    $nomearq = "./tmp/arquivo_retorno_voltaredonda_saae_" . $_POST['mes'] . "_" . $_POST['ano'] . ".txt";

    $sql = "WITH dados_filtrados AS (
 select
	...
	row_number() over (partition by r14_rubric,
	rh01_regist
order by
	z01_nome) as rn
from
...
left join rhlotaexe on
	rh26_codigo = rh02_lota
inner join cgm on
	rh01_numcgm = z01_numcgm
inner join pontofs on
	r10_regist = r14_regist
	and r10_instit = r14_instit
	and r10_mesusu = r14_mesusu
	and r10_anousu = r14_anousu
	and r10_rubric = r14_rubric
where
	r14_anousu = " . $_POST['ano'] . "
	and r14_mesusu = " . $_POST['mes'] . "
	and rh02_instit = $instituicao 
    $swhere
	and r14_rubric in (
      '0180', '0204', '0246', '0289', '0294', '0309', '0314', '0333', '0349', '0365', '0378',
      '0428', '0432', '0463', '0483', '0484', '0490', '0498', '0543', '0544', '0554', '0564',
      '0574', '0584', '0585', '0619', '0625', '0308', '0310', '0317', '0320', '0321', '0327',
      '0334', '0335', '0336', '0339', '0347', '0350', '0356', '0357', '0377', '0379', '0381',
      '0382', '0383', '0384', '0385', '0389', '0394', '0395', '0397', '0262', '0131', '0174',
      '0177', '0179', '0189', '0219', '0220', '0285', '0300', '0315', '0372', '0375', '0400',
      '0401', '0402', '0406', '0410', '0430', '0431', '0464', '0475', '0479', '0481', '0482',
      '0485', '0511', '0513', '0514', '0515', '0521', '0523', '0534', '0537', '0545', '0565',
      '0573', '0575', '0576', '0577', '0582', '0583', '0586', '0589', '0590', '0605', '0613',
      '0666', '0306', '0316', '0318', '0319', '0322', '0323', '0326', '0328', '0329', '0330',
      '0331', '0332', '0337', '0338', '0340', '0341', '0342', '0343', '0344', '0345', '0346',
      '0348', '0351', '0352', '0353', '0354', '0355', '0362', '0366', '0370', '0371', '0373',
      '0374', '0376', '0380', '0386', '0387', '0398', '0405', '0563', '0568', '0569', '0462',
      '0113', '0118', '0231', '0313', '0325', '0358', '0361'
    )
)
SELECT
  '000' || substring(matricula::text from 4) as matricula,
  cpf,
  nome,
  instit,
  orgao,
...
ORDER BY
  nome";
    ...
    $caminhoArquivo = "./tmp/arquivo_retorno_voltaredonda_saae_" . $_POST['mes'] . "_" . $_POST['ano'] . ".txt";
    $conteudo = "";
    if ($linhas > 0) {
        $registro = "";
        for ($i = 0; $i < $linhas; $i++) {
