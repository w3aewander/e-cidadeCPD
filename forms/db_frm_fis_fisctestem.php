...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_test.location.href='fis1_fis_fisctestem002.php?chavepesquisa=$y23_codnoti&chavepesquisa1=$y23_numcgm".$getIntimacao."'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_test.location.href='fis1_fis_fisctestem003.php?chavepesquisa=$y23_codnoti&chavepesquisa1=$y23_numcgm".$getIntimacao."'</script>";
}

// Ticket 108335
if(isset($intimacao) && $intimacao == 1){
  $Ty23_codnoti = 'Código da Intimação
...
Campo:y30_data                             ';
  ...
  $Ly23_codnoti = '<strong>Código da Intimação:</strong>';
...
db_input('z01_nome',40,$Iz01_nome,true,'text',3,'')
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_fisctestem001.php?y23_codnoti=<?=$y23_codnoti?><?=$getIntimacao?>'">
      <?php 
      }
      ?>
    </td>
  ...
  <tr>
   ...
   <?php 
    ...
    $cliframe_alterar_excluir->legenda="TESTEMUNHAS DA ".mb_strtoupper($getLabel);
...
function js_pesquisay23_codnoti(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y23_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
