    ...
    <table class="form-container">
      ...
      <tr>
        ...
        <td valign="top">
          <?
            ...
            //$sCondicao    .= "       OR (ed56_c_situacao   = 'APROVADO' OR ed56_c_situacao = 'REPETENTE')             \n";            
            ...
            //var_dump($sSqlAluno); die("Confere");
        ...
        <td colspan="3">
          <fieldset class="separator">
            ...
            <table>
              ...
              <?php //Campo ALTERAR SITUAÇÃO abaixo ?>
              <tr>
      ...
      <tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="obssituacao" id="obssituacao" maxlength="300" style="width:406px">
            <!--<textarea name="obssituacao" id="obssituacao" cols="50" rows="2" maxlength="500"></textarea>-->
          </td>
        </tr>

        <tr>
              <td nowrap="nowrap" class = 'bold field-size3'>Assinatura:</td>
              <td nowrap="nowrap" >
                <select id='assinatura' name="assinatura" style="width:100%;">                  
                  <?php foreach ($assinaturas as $assinatura)  : ?>
                    <option value="<?=$assinatura['nome'] . ' - ' . $assinatura['funcao']?>"><?=$assinatura['nome'] . ' - ' . $assinatura['funcao']?></option>  
                  <?php endforeach; ?>
  ...
  if (atual == "MATRICULADO") {
    opcoes = new Array("CANCELADO|CANCELADO",
                       ...
                       "MATRICULA INDEFERIDA|MATRICULA INDEFERIDA",
                        "MATRICULA INDEVID|MATRICULA INDEVIDA"
                       );
