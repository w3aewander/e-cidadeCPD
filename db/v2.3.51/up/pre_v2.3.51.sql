...
update db_layoutcampos set db52_codigo = 1000000 , db52_layoutlinha = 589 , db52_nome = 'codigo_do_registro' , db52_descr = 'CODIGO DO REGISTRO' , db52_layoutformat = 2 , db52_posicao = 1 , db52_default = '1' , db52_tamanho = 1 , db52_ident = 't' , db52_imprimir = 't' , db52_alinha = 'e' , db52_obs = '' , db52_quebraapos = 0 where db52_codigo = 1000000;
