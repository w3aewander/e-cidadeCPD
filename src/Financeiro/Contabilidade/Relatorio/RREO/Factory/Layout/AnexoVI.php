...
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\V2018\Layout\AnexoVI as Anexo2018;
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\V2019\Layout\AnexoVI as Anexo2019;
...
class AnexoVI
{
    ...
    {
        if ($ano >= 2020) {
            return new \ECidade\Financeiro\Contabilidade\Relatorio\RREO\V2020\Layout\AnexoVI();
        }
        if ($ano >= 2019) {
