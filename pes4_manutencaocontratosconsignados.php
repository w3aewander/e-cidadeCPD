        ...
        <fieldset class="container">
          ...
          <table class="form-container">
            ...
            <tr>
              ...
              <tr>
                  <td>
                      <label id="lbl_rh153_econsignado" for="rh153_econsignado">N° Contato eConsignado:</label>
                  </td>
                  <td>
                      <input type="text" name="rh153_econsignado" id="rh153_econsignado" />
                  </td>
              </tr>
            <tr>
              <td>
...
(function(){
  ...
  var oeConsignado   = new DBInputInteger($('rh153_econsignado'));
    oeConsignado.getElement().style.width = '110px';
    oeConsignado.getElement().maxLength   = '15';
...
function getDadosConsignado(iConsignado, iAcao) {
  ...
  var oAjaxRequest = new AjaxRequest('pes4_manutencaocontratosconsignados.RPC.php', {exec: 'getContrato', iCodigoConsignado: iConsignado}, function(oRetorno) {
    ...
    if (iAcao != 4 && iAcao != 5) {
      ...
      $('rh153_econsignado').value    = oContrato.ieConsignado;
...
function salvar() {
  ...
  oDadosContrato.ieConsignado      = $F('rh153_econsignado');
