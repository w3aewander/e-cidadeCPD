...
class M13860RecalculoIptuCreditoPorReceita extends PostgresMigration
{
    public function up()
    {
        $sql = <<<PLRECALCULO
...
BEGIN
    ...
    LOOP
        ...
        ELSIF nTotalComplementarReceita < 0
        THEN

            lCreditoRecalculo := TRUE;
            nTotalCalculoNovo := nTotalCalculoAnterior - abs(nTotalComplementarReceita);
            ...
            PERFORM fc_debug(' <iptu_gerafinanceiro> nTotalCalculoAnterior '||nTotalCalculoAnterior, lRaise, FALSE,FALSE);
            PERFORM fc_debug(' <iptu_gerafinanceiro> nTotalCalculoNovo '||nTotalCalculoNovo, lRaise, FALSE,FALSE);
            PERFORM fc_debug(' <iptu_gerafinanceiro> nTotalCalculoCredito '||nTotalCalculoCredito, lRaise, FALSE,FALSE);
