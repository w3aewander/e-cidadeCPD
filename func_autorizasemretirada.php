  ...
  <table>
          ...
          <form name="form1" method="post" action="" >
            ...
            <tr>
              <td colspan="2" align="center">
                ...
                <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_autsemret.hide();">
              </td>
            </tr>
          </form>
        </table>
    ...
    <tr>
      <td align="center" valign="top">
        ...
        $aWhere[] = " ve13_sequencial not in (SELECT idautorizacao FROM veicretirada WHERE idautorizacao = ve13_sequencial) ";
        $aWhere[] = " ve13_dataemissao = '{$hoje}' ";
        ...
        if (!isset($pesquisa_chave)) {
          ...
          $sCampos  = " ve13_sequencial, ve01_placa, b.z01_nome as dl_Motorista, ve13_datainicial, ve13_datafinal, ve13_dataemissao, ve13_observacao, ve13_motorista as idmotorista, ve13_veiculo as idveiculo ";
          ...
          if ($pesquisa_chave != null && $pesquisa_chave != "") {
            ...
            if ($oDaoAutorizacao->numrows != 0) {
              ...
              //var_dump($oStdAutorizacao->ve01_placa); die("Mostra");
