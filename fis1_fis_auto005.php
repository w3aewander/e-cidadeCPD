  ...
  <table valign="top" marginwidth="0" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
       ...
       <?php
         ...
         $clcriaabas->src        = array("auto"         => "fis1_fis_auto001.php?abas=1&como=$optionComo",
                                         "autolevanta"  => "fis1_fis_autolevanta001.php",
                                         "autotipo"     => "fis1_fis_autotipo001.php",
                                         /*"receitas"     => "fis1_fis_autorec001.php",*/
                                         "fiscais"      => "fis1_fis_autousu001.php",
                                         "teste"        => "fis1_fis_autotestem001.php",
                                         "respons"      => "fis1_fis_autorespons001.php",
                                         "precalculo"   => "fis1_fis_autoprecalc001.php");
                                         // "calculo"      => "fis1_fis_autocalc001.php");
...
if(isset($db_opcao) && $db_opcao==2){
  ...
  echo "
     <script>
        ...
        iframe_auto.location.href  = 'fis1_fis_auto002.php?abas=1';\n
  	   }
	     js_src();
     </script>";
  exit;
  ...
  echo "
       <script>
    	   function js_src(){
    	    ...
    	    document.formaba.auto.size            = 15;
          iframe_auto.location.href             ='fis1_fis_auto003.php?abas=1';\n
          ...
          document.formaba.respons.disabled      = true;
