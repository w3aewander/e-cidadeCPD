...
function js_pesquisay51_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y51_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisay51_codnoti(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_fiscal','func_fis_fiscal.php?pesquisa_chave='+document.form1.y51_codnoti.value+'&funcao_js=parent.js_mostrafiscal','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autofiscal','func_fis_autofiscal.php?funcao_js=parent.js_preenchepesquisa|y51_codauto','Pesquisa',true);
}
