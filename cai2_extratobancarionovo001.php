...
function js_relatorio2() {
  ...
  query += "&considerar_retencoes="+F.considerar_retencoes.value;
  ...
  jan = window.open('cai2_extratobancarionovo002.php?'+query,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0');
  jan.moveTo(0,0);
}
</script>
	...
	<tr>
      ...
      <td colspan=2 >
          ...
          $aux_conta->funcao_gera_formulario();
			...
			<tr>
             <td nowrap align=right><b>Considerar retenções:</b></td>
              <td><? $matriz = array("s"=>"Sim","n"=>"Não");             
                   db_select("considerar_retencoes", $matriz,true,1); 
                   ?> 
              </td>
           </tr>
