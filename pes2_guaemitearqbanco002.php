...
if ($clrharqbanco->numrows > 0) {
  ...
  if ($rh34_codban == "041") {
    ...
    if ($rh34_codban == "001") {
      ...
      $layoutimprime = 21;
    } else if ($rh34_codban == "237") {
      $layoutimprime = 11000000;
...
//$rh34_wherepensa .= " r52_codbco = '$rh34_codban' and r52_anousu = " . \DBPessoal::getAnoFolha() . " and r52_mesusu = " . \DBPessoal::getMesFolha();

if (!empty($rh34_wherefolha)) {
  $rh34_wherefolha .= " and ";
}

$rh34_wherefolha .= " r38_liq > 0 ";
$rh34_wherefolha .= " AND r38_banco NOT IN ('0') ";
$rh34_wherefolha .= " AND rh02_fpagto = 3 ";
...
if ($sqlerro == false) {
  ...
  $sql = $clfolha->sql_query_gerarqbag(
                                        null,
                                        "$campos,length(trim(r38_agenc)) as qtddigitosagencia,
                                        r70_descr,
  ...
  if ($numrows > 0 && $rh34_codban == "041") {
  ...
  } elseif ($numrows > 0 && $rh34_codban == "237") {
    ...
    for ($i = 0; $i < $numrows; $i++) {
      ...
      $sWhere .= " and rh02_anousu = " . \DBPessoal::getAnoFolha();
      $sWhere .= " and rh02_mesusu = " . \DBPessoal::getMesFolha();
