...
function js_retorna(chave){
  document.location.href = 'fis3_fis_consultavist002.php?y70_codvist='+chave;
}
</script>
</head>
...
function js_imprime(chave){
    jan = window.open('fis2_fis_relatoriovist002.php?y70_codvist='+chave+'&listatipo='+document.form1.y70_tipovist.value+'&consulta=1','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);
}
</script>
