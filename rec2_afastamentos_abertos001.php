...
$result_tipoassent = $cltipoasse->sql_record($cltipoasse->sql_query(
    null,
    "h12_codigo, h12_assent || ' - ' || h12_descr as h12_descr",
    "h12_descr"
));
?>
...
function js_emite() {
  ...
  qry += "&datai=" + document.form1.datai_ano.value+'-'+document.form1.datai_mes.value+'-';
  qry += document.form1.datai_dia.value;
  qry += "&tipos=" + js_db_multiploselect_retornaselecionados();
  jan = window.open('rec2_afastamentos_abertos002.php'+qry,'',
            ...
            <td align="left">
              <?php
                $result_regime = $clrhcadregime->sql_record($clrhcadregime->sql_query_file(
                    null,
                    "rh52_regime,rh52_regime||' - '||rh52_descr"
                ));
