...
class cl_periodocalendario
{
    ...
    public $ed53_i_codigo = 0;
    public $ed53_i_calendario = 0;
    public $ed53_i_periodoavaliacao = 0;
    public $ed53_d_inicio_dia = null;
    public $ed53_d_inicio_mes = null;
    public $ed53_d_inicio_ano = null;
    public $ed53_d_inicio = null;
    public $ed53_d_fim_dia = null;
    public $ed53_d_fim_mes = null;
    public $ed53_d_fim_ano = null;
    public $ed53_d_fim = null;
    public $ed53_i_diasletivos = 0;
    public $ed53_i_semletivas = 0;
    ...
    public function incluir($ed53_i_codigo)
    {
        $this->atualizacampos();
        ...
        if (($this->ed53_i_codigo == null) || ($this->ed53_i_codigo == "")) {
            $this->erro_sql = " Campo ed53_i_codigo não declarado.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = "Períodos do Calendário Escolar ($this->ed53_i_codigo) não Incluído. Inclusão Abortada.";
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    public function alterar($ed53_i_codigo = null)
    {
        $this->atualizacampos();
        ...
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
            ...
            if ($this->numrows > 0) {
                ...
                for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_i_codigo"]) || $this->ed53_i_codigo != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_i_calendario"]) || $this->ed53_i_calendario != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_i_periodoavaliacao"]) || $this->ed53_i_periodoavaliacao != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_d_inicio"]) || $this->ed53_d_inicio != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_d_fim"]) || $this->ed53_d_fim != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_i_diasletivos"]) || $this->ed53_i_diasletivos != "")
                    ...
                    if (isset($GLOBALS["HTTP_POST_VARS"]["ed53_i_semletivas"]) || $this->ed53_i_semletivas != "")
        ...
        if (!$result) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Períodos do Calendário Escolar não Alterado. Alteração Abortada.\\n";
            $this->erro_sql .= "Valores : " . $this->ed53_i_codigo;
            $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Períodos do Calendário Escolar não foi Alterado. Alteração Executada.\\n";
                $this->erro_sql .= "Valores : " . $this->ed53_i_codigo;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function excluir($ed53_i_codigo = null, $dbwhere = null)
    {
        $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
        if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
                && ($lSessaoDesativarAccount === false))) {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql = "Períodos do Calendário Escolar não Excluído. Exclusão Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Períodos do Calendário Escolar não Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $ed53_i_codigo;
                $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function sql_query($ed53_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select {$campos}";
    ...
    public function sql_query_file($ed53_i_codigo = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
