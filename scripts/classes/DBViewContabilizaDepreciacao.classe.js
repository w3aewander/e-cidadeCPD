...
DBViewContabilizaDepreciacao = function (sNomeInstancia, iMes, iAno, iInstituicao, lEstorno) {
  ...
  me.show = function () {
    ...
    sConteudo         += "</center>";
    me.oWindowAux = new windowAux("oWindowAux"+me.iHistoricoDepreciacao, sTituloWindow, 900, 400);
    ...
    var aCellWidth = new Array("55%", "15%", "30%");
  ...
  me.preencheGrid = function (oAjax) {
    ...
    oRetorno.aDadosDepreciacao.each(function(oDado, iIndice) {
      ...
      aLinha[0] = "&nbsp"+oDado.iCodigoConta + " - " + oDado.sDescricaoConta.urlDecode();
