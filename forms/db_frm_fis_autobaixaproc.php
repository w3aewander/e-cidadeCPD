  ...
  <tr>   
    ...
    <tr>
	 ...
	 <?php 
      ...
      <td colspan=3> 
  <?php 
  db_input('y114_processo',12,@$Iy114_processo,true,'text',$db_opcao," onchange='js_pesquisay114_processo(false);'")
  ?>
...
function js_inscr(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_inscr','func_fis_autoalt.php?funcao_js=parent.js_mostrainscr|dl_auto|z01_nome&baixa=1&fisauto=1','Pesquisa',true);
  }else{
    if(inscr!=""){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_inscr','func_fis_autoalt.php?pesquisa_chave='+inscr+'&funcao_js=parent.js_mostrainscr1&baixa=1&fisauto=1','Pesquisa',false);
    }else{
...
function js_pesquisay114_processo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_processo','func_protprocesso.php?funcao_js=parent.js_mostraprocesso1|p58_numero|p58_requer','Pesquisa',true);
  }else{
