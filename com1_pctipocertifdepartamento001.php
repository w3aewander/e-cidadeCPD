...
include(modification("classes/db_pctipocertifdepartamento_classe.php"));
include(modification("classes/db_pctipocertif_classe.php"));
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmpctipocertifdepartamento.php"));
	?>
    </center>
	</td>
  </tr>
