...
class M20496CorrecaoAnulacaoEntradaOrdemCompra extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->upFcConlancamvalLancamInc();
        $this->upFcCalculaPrecoMedio();
    }
    ...
    {
        $this->downFcConlancamvalLancamInc();
        $this->downFcCalculaPrecoMedio();
    }
    
    private function upFcCalculaPrecoMedio()
    {
        DB::connection()->getPdo()->exec(<<<SQL
    CREATE OR REPLACE FUNCTION public.fc_calculaprecomedio(integer, integer, double precision, integer)
     RETURNS numeric
    AS $$
...
SQL
    ...
    private function upFcConlancamvalLancamInc()
    {
        DB::connection()->getPdo()->exec(<<<SQL
...
SQL
    ...
    private function downFcCalculaPrecoMedio()
    {
        DB::connection()->getPdo()->exec(<<<SQL
    CREATE OR REPLACE FUNCTION public.fc_calculaprecomedio(integer, integer, double precision, integer)
     RETURNS numeric
...
SQL
    ...
    private function downFcConlancamvalLancamInc()
    {
        DB::connection()->getPdo()->exec(<<<SQL
    CREATE OR REPLACE FUNCTION public.fc_conlancamval_lancam_inc()
     RETURNS trigger
