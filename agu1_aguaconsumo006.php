...
include(modification("classes/db_aguaconsumo_classe.php"));
include(modification("classes/db_aguaconsumorec_classe.php"));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmaguaconsumo.php"));
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_aguaconsumorec.location.href='agu1_aguaconsumorec001.php?db_opcaoal=33&x20_codconsumo=".@$x19_codconsumo."&x19_descr=".@$x19_descr."';
     ";
         if(isset($liberaaba)){
