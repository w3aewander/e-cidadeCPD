 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_atendcadareamod.location.href='ate1_atendcadareamod001.php?db_opcaoal=33&at26_sequencia=".@$at26_sequencial."';
     ";
         if(isset($liberaaba)){
