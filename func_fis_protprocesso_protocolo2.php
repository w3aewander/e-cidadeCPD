...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    <td align="center" valign="top"> 
      <?php 
      $sLeft = "";
#Alterado por Clayton para atenter as demandas de Niterói - onde todas as instituições consultarão todos os processos
      $where = " p58_instit = ".db_getsession("DB_instit");
      
      if(isset($grupo) && trim($grupo) != '' ){
      	$where .= " and tipoproc.p51_tipoprocgrupo = $grupo";
        //$where = " tipoproc.p51_tipoprocgrupo = $grupo";
      }       
