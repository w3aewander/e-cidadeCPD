...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_autotestem");
...
public function incluir ($y24_codauto,$y24_numcgm){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_autotestem(
                                       y24_codauto
                                      ,y24_numcgm
                       )
                values (
...
public function alterar ($y24_codauto=null,$y24_numcgm=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_autotestem set ";
     $virgula = "";
...
public function excluir ($y24_codauto=null,$y24_numcgm=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_autotestem
                    where ";
     $sql2 = "";
...
public function sql_query ( $y24_codauto=null,$y24_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_autotestem ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_autotestem.y24_numcgm";
     $sql .= "      inner join fiscalizacao.fis_auto  on  fis_auto.y50_codauto = fis_autotestem.y24_codauto";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = fis_auto.y50_setor";
     $sql2 = "";
     if($dbwhere==""){
       if($y24_codauto!=null ){
         $sql2 .= " where fis_autotestem.y24_codauto = $y24_codauto ";
       }
       if($y24_numcgm!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " fis_autotestem.y24_numcgm = $y24_numcgm ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y24_codauto=null,$y24_numcgm=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
