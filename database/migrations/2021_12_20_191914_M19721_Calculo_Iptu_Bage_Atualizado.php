...
class M19721CalculoIptuBageAtualizado extends Migration
{
    /**
     * Run the migrations.
     *
...
-- quando caracteristica 441 e tem mais de um logradouro, o sistema calcula 10% a mais
...
SQL
    ...
    public function down()
    {
        $this->dicionarioDown();
        DB::statement(<<<SQL
            drop function fc_calculoiptu_bag_2019;
SQL
        );
    ...
    {
        DB::connection()->getPdo()->exec(<<<SQL
        update db_sysfuncoes set obsfuncao = 'cálculo IPTU Bagé homologado para o ano de 2021.', 
        corpofuncao='-- quando caracteristica 441 e tem mais de um logradouro, o sistema calcula 10% a mais
                    -- V_TEM_CARACT_ESQUINA = 441 quando encontrada no carlot
                    -- no iptucalc a area gravada e a area corrigidae nao a area real
