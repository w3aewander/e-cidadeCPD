...
/**
 * Arquivo 4.38
 * Class RelacionamentoEmpenhoLicitacao
 * @package ECidade\Financeiro\Contabilidade\Sagres\V2022
 */
class RelacionamentoEmpenhoLicitacao extends OutrosArquivosSagresFiscal
{
    const TAG = 'RelacionamentoEmpenhoLicitacao';

    protected $colunasTemplate = [
        'codUnidadeGestora',
        'codUnidadeOrcamentaria',
        'numEmpenho',
        'codUnidadeGestoraLicitacao',
        'numLicitacao',
        'modalidadeLicitacao',
        'reservado',
    ];
