...
<div class='container'>
  ...
  <input type="button" value='Imprimir PDF' name='imprimir' id='imprimir'>
  <input type="button" value='Gerar Excel' name='imprimirPDF' id='imprimirPDF' onclick="js_processar();">
</div>
<?php 
...
$('imprimirPDF').observe('click', function () {
  ...
  var sUrl  = 'edu2_resultparcialPDF003.php?periodo='+$F('cntPeriodo');
  sUrl += '&trocaTurma='+$F('exibeTrocaTurma');
  sUrl += '&classificacaoAlunoTurma='+$F('exibeClassificacao');
  sUrl += '&oTurmas='+Object.toJSON(aTurmas);
  sUrl += '&tamanhoFonte='+$F('tamanhoFonte');
...
function js_processar(sUrl) {
  var oAjax = new Ajax.Request("edu2_resultparcialPDF003.php",
		                            {
                                  method:'post',
                                  parameters:'json='+Object.toJSON(sUrl),
