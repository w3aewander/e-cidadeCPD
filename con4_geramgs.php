...
<head>
    ...
    <script>
        ...
        function js_seleciona(sTipo) {
            ...
            iframe_processapad.location.href = 'con4_processapad.php?processar=true&tipo=mgs&data_pro=' + data_pro + '&data_ini=' + data_ini + '&data_fim=' + data_fim + '&lista=' + lista + '&mgs';
        }
...
<center>
<table width="790" border="0" style="margin-top:20px;" cellspacing="0" cellpadding="0">
    <tr>
