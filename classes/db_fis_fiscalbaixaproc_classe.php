...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_fiscalbaixaproc");
...
public function incluir ($y48_codnoti){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_fiscalbaixaproc(
                                       y48_codnoti
                                      ,y48_codproc
                       )
                values (
...
public function alterar ($y48_codnoti=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_fiscalbaixaproc set ";
     $virgula = "";
...
public function excluir ($y48_codnoti=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_fiscalbaixaproc
                    where ";
     $sql2 = "";
