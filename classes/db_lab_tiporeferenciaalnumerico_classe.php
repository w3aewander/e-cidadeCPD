...
class cl_lab_tiporeferenciaalnumerico {
   ...
   public $la30_i_codigo = 0;
   public $la30_i_valorref = 0;
   public $la30_f_normalmin = 0;
   public $la30_f_normalmax = 0;
   public $la30_c_calculavel = null;
   public $la30_f_absurdomin = 0;
   public $la30_f_absurdomax = 0;
   public $la30_casasdecimaisapresentacao = null;
  ...
  public function incluir ($la30_i_codigo){
    $this->atualizacampos();
...
public function sql_query_dados_referencia ( $la30_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
