...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    <td align="center" valign="top"> 
      <?php 
      $dbwhere = "";
         $dbwhere = " y60_importado is true and y60_codlev not in (select y117_levanta from fiscalizacao.fis_autolevanta)";
...
//die($sql);	
           ...
           $dbwhere = " and y60_importado is true and y60_codlev not in (select y117_levanta from fiscalizacao.fis_autolevanta)";
