...
class cl_itburbano {
   ...
   public $it05_guia = 0;
   public $it05_frente = 0;
   public $it05_fundos = 0;
   public $it05_direito = 0;
   public $it05_esquerdo = 0;
   public $it05_itbisituacao = 0;
   ...
   public function incluir ($it05_guia){
      $this->atualizacampos();
     ...
     $sql = "insert into itburbano(
                ...
                values (
                               ...
                               ,$this->it05_direito
                               ,$this->it05_esquerdo
                               ,".(empty($this->it05_itbisituacao) ? "NULL" : $this->it05_itbisituacao)."
                      )";
     $result = db_query($sql);
     if($result==false){
   ...
   public function alterar ($it05_guia=null) {
      $this->atualizacampos();
   ...
   public function excluir ($it05_guia=null,$dbwhere=null) {
   ...
   public function sql_query ( $it05_guia=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_file ( $it05_guia=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_dados( $it05_guia=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
