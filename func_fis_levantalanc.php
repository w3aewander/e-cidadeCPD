        ...
        if(isset($chave_y60_codlev) && (trim($chave_y60_codlev)!="")){
          ...
          from ( select fis_levanta.*,y62_inscr, y93_numcgm,empresa.z01_nome as nome_empresa,cgm.z01_nome as nome_cgm,y112_procfiscal 
           ...
           if($linhasUser == 0){
            ...
            $sql .="            ) as x where x.y60_codlev = $chave_y60_codlev  AND x.y60_codlev NOT IN(select nl15_levanta from fiscalizacao.fis_lanclevanta) order by y60_codlev desc ";
          ...
          from ( select fis_levanta.*,y62_inscr, y93_numcgm,empresa.z01_nome as nome_empresa,cgm.z01_nome as nome_cgm,y112_procfiscal 
           ...
           if($linhasUser == 0){
            ...
            $sql .="            ) as x where x.y60_codlev NOT IN(select nl15_levanta from fiscalizacao.fis_lanclevanta) order by y60_codlev desc ";
