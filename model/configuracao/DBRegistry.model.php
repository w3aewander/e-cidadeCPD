...
final class DBRegistry
{
    ...
    /**
     * Retorna todos os itens do registry
     * @return array
     */
    public static function all()
    {
        return self::getInstance()->aitens;
    }
     ...
     * @return mixed
     */
    public static function addToArray($identificador, $valor, $toIndex = null)
    {
        $instance = self::getInstance();
        if ($instance::has($identificador)) {
            if (!empty($toIndex)) {
