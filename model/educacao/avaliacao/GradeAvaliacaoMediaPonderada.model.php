...
class GradeAvaliacaoMediaPonderada
{
    ...
    private function escreverDisciplinas()
    {
        ...
        foreach ($this->oGradeAvaliacao->getGradeAproveitamento() as $oGrade) {
            ...
            $this->oPdf->SetFont('arial', '', 8);
            $this->oPdf->Cell(20 * 2, $this->iAlturaCelula, $oGrade->oResultadoFinal->sTermoResultadoFinal, 1, 1, "C");
        }
    ...
    protected function escreverTotalDeFaltas()
    {
        ...
        $this->oPdf->Cell(21, $this->iAlturaCelula, 'T. DE FALTAS', 1, 0, "L");
        ...
        $this->oPdf->Cell(40, $this->iAlturaCelula, "", 1, 1, "L");
        $this->oPdf->SetFont('arial', 'b', 8);
        $this->oPdf->Cell(191, $this->iAlturaCelula, "RESULTADO FINAL: {$sResultadoFinal}", 1, 0, "L");
        $this->oPdf->SetFont('arial', '', 8);
    }
}
