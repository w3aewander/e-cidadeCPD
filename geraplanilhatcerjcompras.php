...
<center>
  <form method="post" action="telapreinclusaoplanilha.php">
    <fieldset style="width: 250px; padding: 10px;">
      <legend><b>Planilha de Itens</b></legend>
      <table width="100%">
        <tr>
          <td width="55%">
            <?php
    ...
    <br />
    <input type="submit" name="btnEnviarDados" id="btnEnviarDados" value="Enviar Dados" />
  </form>
