 ...
 */
 class VinculoServidorRepository {
  ...
  public function make($iCodigoVinculoServidor) {
    ...
    $sCampos        = "rh30_codreg, rh30_descr, rh30_regime, rh30_vinculo, rh30_instit, rh30_codigocategoria, rh30_admissao, rh30_provimento";
    ...
    $oVinculoServidor->setCodigoCategoria($oStdRhRegime->rh30_codigocategoria);
    $oVinculoServidor->setTpProvimento($oStdRhRegime->rh30_provimento);
    $oVinculoServidor->setTipoAdmissao($oStdRhRegime->rh30_admissao);
