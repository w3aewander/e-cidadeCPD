...
$aCampos .= " bi06_paginacao as paginacao, ";
$aCampos .= " bi06_volume as volume, ";
$aCampos .= " bi06_tomo as tomo, ";
...
<div class='subcontainer' style="width: 99%;">
  ...
  <fieldset>
    ...
    <table class='dados-gerais'>
      ...
      <tr>
        <td>Paginação:</td>
        <td class="valores"><?= $paginacao ?></td>
        <td>Volume:</td>
        <td class="valores"><?= $volume ?></td>
        <td>Tomo:</td>
        <td class="valores"><?= $tomo ?></td>
      </tr>
      <tr>
...
<div class="subcontainer" style="width: 99%;">
  <fieldset>
    <legend>Opções</legend>
      ...
      $oTabDetalhes->add("abaEmprestimos", "Empréstimos Abertos",
        "edu3_emprestimosaberto.php?iAcervo={$oGet->iAcervo}");
      $oTabDetalhes->show();
      ?>
  </fieldset>
</div>
