...
function js_procurar(ano,tipo) {
 ...
 if(ano!="" && tipo!=""){
     location.href = "edu_dectransfpl.php?ano="+ano+"&tipo="+tipo;
 }
}
...
function js_pesquisa(tipo) {
  ...
  if (tipo == "") {
    ...
    var oRelatorio = new EmissaoRelatorio('edu_dectransfpl002.php', oParametros);
        oRelatorio.setMethod('get');
        oRelatorio.open();
  }

  location.href = "edu_dectransfpl.php?diretor="+document.form1.diretor.value+"&ed283_c_bolsafamilia="+document.form1.ed283_c_bolsafamilia.value+"&ed283_t_mensagem="+document.form1.ed283_t_mensagem.value+"&incluirobs";
}
