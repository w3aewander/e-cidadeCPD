...
DBViewCadastroAtributoDinamico = function () {
  ...
  this.carregarTiposAtributos = function() {

    AjaxRequest.create(
      this.sUrlRPC,
      {'sMethod' : 'getTiposAtributos'},
      function (retorno, erro) {
        me.aTiposDados = retorno.tipoAtributos;
      }
    ).asynchronous(false).execute();
  };
  this.carregarTiposAtributos();
  ...
  this.showForm = function () {
    ...
    if (this.usuarioAdministrador === true) {
      me.aTiposDados.push( { 'codigo': this.TIPO_HIDDEN, 'nome': 'Hidden' } );
    }
    ...
    aRows.each(
      function (oRow,iInd) {
        ...
        var sInput  = "<input type='button' id='"+iInd+"' value='A' data-codigo='"+ oRow.iCodigo +"'/> ";
            ...
            if(oRow.lFixo == true) {
                sInput  = "<input type='button' id='"+iInd+"' value='A' data-codigo='"+ oRow.iCodigo +"' disabled/> ";
                sInput += "<input type='button' id='"+iInd+"' value='E' data-codigo='"+ oRow.iCodigo +"' disabled/> ";
            }
