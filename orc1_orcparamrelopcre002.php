...
if(isset($alterar)){
  db_inicio_transacao();
  $db_opcao = 2;
  $clorcparamrelopcre->alterar($o98_sequencial);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 2;
   $result = $clorcparamrelopcre->sql_record($clorcparamrelopcre->sql_query($chavepesquisa)); 
...
if(isset($alterar)){
  if($clorcparamrelopcre->erro_status=="0"){
    ...
    $clorcparamrelopcre->erro(true,true);
  }
}
if($db_opcao==22){
