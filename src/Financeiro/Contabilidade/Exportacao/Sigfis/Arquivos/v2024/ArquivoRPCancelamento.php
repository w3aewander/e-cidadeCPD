...
class ArquivoRPCancelamento extends ArquivoBase
{
    ...
    public function gerarDados(){
        ...
        if ($this->competencia == 202501 && $this->instit == 50) {
    $obj->RestosPagarCancelamentos[] = (object)[
        'RestosPagarCancelamento' => (object)[
            'Identificador' => $ix,
            'CodigoUnidadeGestora' => $this->sCodigoTribunal,
            'Competencia' => $this->competencia,
            'NumeroEmpenho' => '307',
            'AnoEmpenho' => 2024,
            'Tipo' => 1,
            'NumeroCancelamento' => '21404',
            'DataCancelamento' => '2025-01-22',
            'AnoCancelamento' => '2025',
            'Cpf' => $ugs,
            'Justificativa' => 'ORDEM DE PAGAMENTO EMITIDA EM DUPLICIDADE',
            'Valor' => 2615.24,
            'CodigoOrgao' => '50',
            'CodigoUnidadeOrcamentaria' => '3',
            'Liquidacoes' => (object)[
                'LiquidacaoRestosPagar' => (object)[
                    'Identificador' => 1,
                    'NumeroNotaLiquidacao' => '552348',
                    'AnoLiquidacao' => 2025,
                    'Valor' => 2615.24,
                ]
            ]
