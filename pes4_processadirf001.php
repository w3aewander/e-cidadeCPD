        ...
        <table border='0'>
         ...
         <table>
          ...
          <tr>
            ...
            <td nowrap>
              <input name="tempoini" id="tempoini" type="hidden">
              <input name="duracao" id="duracao" type="text" size="5" readonly>
            </td>
          </tr>
         </table>
