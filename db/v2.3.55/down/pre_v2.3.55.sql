...
delete from db_layoutcampos where db52_layoutlinha in (861,862,863);
delete from db_layoutlinha where db51_layouttxt in (261);
delete from db_layouttxt where db50_codigo in (261);

delete from db_layoutcampos where db52_layoutlinha in (864,865,866);
delete from db_layoutlinha where db51_layouttxt in (262);
delete from db_layouttxt where db50_codigo in (262);
---------------------------------------------------------------------------------------------------------------
---------------------------------------- FINAL TRIBUTARIO -----------------------------------------------------
---------------------------------------------------------------------------------------------------------------
