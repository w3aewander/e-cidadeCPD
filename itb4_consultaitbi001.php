...
$rsConsultaNome = $clitbinome->sql_record($clitbinome->sql_queryguia(null, "*", null, $sWhere));
$iNumRowsNome = $clitbinome->numrows;

// dd(pg_fetch_assoc($rsConsultaNome));
...
for ($iInd = 0; $iInd < $iNumRowsNome; $iInd++) {
    ...
    if ($oDadosNome->it03_tipo == "T" && $oDadosNome->it03_princ == "t") {
        ...
        if ($oDadosNome->it03_tipo == "C" && $oDadosNome->it03_princ == "t") {
...
<table width='100%' cellspacing=0>
  <tr>
    <td colspan='2'>
      <fieldset>
        <legend><strong>Dados da ITBI Guia
            - <?= $oGet->it01_guia ?> <?= ($lCancelada ? "<font color='red'>- CANCELADA</font>" : "") ?></strong>
        </legend>
        <table border='0'>
        <?php if (!empty($oDadosITBI->it01_tituprocesso)) : ?>
          <tr>
            <td><strong>Processo :</strong></td>
            <td colspan="3" class='texto'><?= $oDadosITBI->it01_processo ?>              </td>
          </tr>
        <?php endif ?>

        <?php if (!empty($oDadosITBI->it01_tituprocesso)) : ?>
          <tr>
            <td><strong>Titular do Processo :</strong></td>
            <td colspan="3" class='texto'><?= $oDadosITBI->it01_tituprocesso ?>              </td>
          </tr>
        <?php endif ?>

        <?php if (!empty($oDadosITBI->it01_dtprocesso)) : ?>
          <tr>
            <td><strong>Data do Processo :</strong></td>
            <td colspan="3" class='texto'><?= db_formatar($oDadosITBI->it01_dtprocesso, 'd') ?>              </td>
          </tr>
        <?php endif ?>
        ...
        <table width='100%'>
          <tr>
            <td width='20%' valign='top' height='100%' rowspan='2'>
                <?php if ($sTipo == "Urbano") { ?>
                  <a class='selecionados' onclick='js_marca(this);this.blur()'
                     href='itb4_consultadadosimovel001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong> Dados
                      do Imóvel </strong></a>
                <?php } else { ?>
                  <a class='selecionados' onclick='js_marca(this);this.blur()'
                     href='itb4_consultadadosimovelrural001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                      Dados da Terra </strong></a>
                <?php } ?>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_situacaoitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Situação </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultavaloresitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong> Valores
                  Informados / Avaliados </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultaformaspgtoitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong> Formas
                  de Pagamento Informado </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultaformaspgtoavaliaitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Formas de Pagamento Avaliação </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultatransmitenteitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Transmitentes </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultaadquirenteitbi001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Adquirentes </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultadadosbenfeitoriasl001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Benfeitorias </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultadadosalteracoes001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Alterações Realizadas </strong></a>
                <?php if ($sTipo == "Rural") { ?>
                  <a class='dados' onclick='js_marca(this);this.blur()'
                     href='itb4_consultacaracruralutil001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                      Utilização da Terra </strong></a>
                  <a class='dados' onclick='js_marca(this);this.blur()'
                     href='itb4_consultacaracruraldist001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                      Distribuição da Terra </strong></a>
                <?php } ?>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultaguiaemitidas001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong> Guias
                  Emitidas </strong></a>
              <a class='dados' onclick='js_marca(this);this.blur()'
                 href='itb4_consultacancelamento001.php?guia=<?= $oGet->it01_guia; ?>' target='dados'><strong>
                  Cancelamento </strong></a>
            </td>
            <td valign='top' height='100%' style='border:1px inset white'>
                <?php if ($sTipo == "Urbano") { ?>
                  <iframe height='300' name='dados' frameborder='0' width='100%'
                          src='itb4_consultadadosimovel001.php?guia=<?= $oGet->it01_guia; ?>'
                          style='background-color:#CCCCCC'></iframe>
                <?php } else { ?>
                  <iframe height='300' name='dados' frameborder='0' width='100%'
                          src='itb4_consultadadosimovelrural001.php?guia=<?= $oGet->it01_guia; ?>'
                          style='background-color:#CCCCCC'></iframe>
                <?php } ?>
            </td>
          </tr>
...
<script>
  ...
  function js_buscaCgm(iCgm) {
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_nome', 'prot3_consultacgmnovo002.php?fechar=db_iframe_nome&numcgm=' + iCgm, 'Pesquisa', true);
  }
</script> 