...
class cl_empempaut
{
  ...
  // funcao para inclusao
    public function incluir($e61_numemp)
    {
        $this->atualizacampos();
        ...
        if (($resaco!=false)||($this->numrows!=0)) {
            ...
            $resac = db_query("insert into db_acount values($acount,890,5664,'','".addSlashes(pg_fetch_result($resaco, 0, 'e61_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            $resac = db_query("insert into db_acount values($acount,890,5665,'','".addSlashes(pg_fetch_result($resaco, 0, 'e61_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
        }
        return true;
    }
  // funcao para alteracao
    public function alterar($e61_numemp = null)
    {
        $this->atualizacampos();
        ...
        if ($this->numrows>0) {
            for ($conresaco=0; $conresaco<$this->numrows; $conresaco++) {
                ...
                if (isset($GLOBALS["HTTP_POST_VARS"]["e61_numemp"])) {
                    $resac = db_query("insert into db_acount values($acount,890,5664,'".addSlashes(pg_fetch_result($resaco, $conresaco, 'e61_numemp'))."','$this->e61_numemp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
                if (isset($GLOBALS["HTTP_POST_VARS"]["e61_autori"])) {
                    $resac = db_query("insert into db_acount values($acount,890,5665,'".addSlashes(pg_fetch_result($resaco, $conresaco, 'e61_autori'))."','$this->e61_autori',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                }
            }
        }
        $result = db_query($sql);
  ...
  // funcao para exclusao
    public function excluir($e61_numemp = null, $dbwhere = null)
    {
        ...
        if (($resaco!=false)||($this->numrows!=0)) {
            for ($iresaco=0; $iresaco<$this->numrows; $iresaco++) {
                ...
                $resac = db_query("insert into db_acount values($acount,890,5664,'','".addSlashes(pg_fetch_result($resaco, $iresaco, 'e61_numemp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
                $resac = db_query("insert into db_acount values($acount,890,5665,'','".addSlashes(pg_fetch_result($resaco, $iresaco, 'e61_autori'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
            }
        }
  ...
  // funcao do recordset
    ...
    public function sql_query($e61_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_empenho($e61_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_file($e61_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
    ...
    public function sql_query_empenho_inscricaopassivo($e61_numemp = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
