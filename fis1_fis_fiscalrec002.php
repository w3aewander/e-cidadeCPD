...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?php
	include(modification("forms/db_frm_fis_fiscalrec.php"));
	?>
    </center>
	</td>
  </tr>
...
if(isset($db_opcao) && $db_opcao == "Alterar"){
  if($clfiscalrec->erro_status=="0"){
    ...
    if($clfiscalrec->erro_campo!=""){
      ...
      echo "<script>parent.iframe_receitas.location.href='fis1_fis_fiscalrec001.php?y42_codnoti=".$y42_codnoti."&abas=1&receitasdosfiscal';</script>\n";
    }
  }else{
    $clfiscalrec->erro(true,false);
    echo "<script>parent.iframe_receitas.location.href='fis1_fis_fiscalrec001.php?y42_codnoti=".$y42_codnoti."&abas=1&receitasdofiscal=1';</script>\n";
  }
}
if($db_opcao==22){
