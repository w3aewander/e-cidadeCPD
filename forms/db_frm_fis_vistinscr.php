...
function js_pesquisay71_codvist(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_fis_vistorias.php?pesquisa_chave='+document.form1.y71_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistinscr','func_fis_vistinscr.php?funcao_js=parent.js_preenchepesquisa|y71_codvist','Pesquisa',true);
}
