...
class cl_fis_procfiscal
{
    ...
    public $y100_sequencial = 0;
    public $y100_coddepto = 0;
    public $y100_instit = 0;
    public $y100_procfiscalcadtipo = 0;
    public $y100_dtinicial_dia = null;
    public $y100_dtinicial_mes = null;
    public $y100_dtinicial_ano = null;
    public $y100_dtinicial = null;
    public $y100_dtfinal_dia = null;
    public $y100_dtfinal_mes = null;
    public $y100_dtfinal_ano = null;
    public $y100_dtfinal = null;
    public $y100_obs = null;
    ...
    public function __construct()
    {
      //classes dos rotulos dos campos
        $this->rotulo = new rotulo("fis_procfiscal");
   ...
   // funcao para inclusao
    public function incluir($y100_sequencial = null)
    {
        $this->atualizacampos();
        ...
        $sql = "insert into fiscalizacao.fis_procfiscal(
                                       y100_sequencial
                                      ,y100_coddepto
                                      ,y100_instit
                ...
                values (
                               ...
                               ,'$this->y100_obs'
                      ) returning y100_sequencial ";
        $result = db_query($sql);
        $this->y100_sequencial = db_utils::fieldsmemory($result, 0)->y100_sequencial;
   ...
   // funcao para exclusao
    public function excluir($y100_sequencial = null, $dbwhere = null)
    {
        $sql = " delete from fiscalizacao.fis_procfiscal where ";
        $sql2 = "";
   ...
   // funcao do recordset
    ...
    public function sql_query($y100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
        ...
        if ($dbwhere=="") {
            if ($y100_sequencial!=null) {
                $sql2 .= " where fis_procfiscal.y100_sequencial = $y100_sequencial ";
            }
        } elseif ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
    ...
    public function sql_query_file($y100_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = explode("#", $campos);
