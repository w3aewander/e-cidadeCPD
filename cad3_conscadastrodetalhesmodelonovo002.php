...
$clrotulo->label('j83_pontos');
$clrotulo->label('j37_segmento');
$clrotulo->label('j37_sequencia');
$clrotulo->label('j01_areaprivativa');
...
if (isset($anoMatricula)) {
	$calculoRetroativoIptuRepository = CalculoRetroativoIptuRepository::getInstance();

	$calculoRetroativoIptuRepository->setAnousu($iAnoUsu)
		->setAnoRetroativoMatricula($anoMatricula)
		->setMatricula($parametro);
	$calculoRetroativoIptuRepository->getAlteraSearchPath();

	$iAnoUsu = $anoMatricula;
}
...
$lImprimeDadosSigilosos = false;
if (isset($oGet->imprimeDadosComplementares)) {
    $lImprimeDadosSigilosos = true;
}

$sSqlConsulta = " select iptubase.j01_fracao,                                                                                                                    ";
$sSqlConsulta .= "        iptubase.j01_areaprivativa,                                                                                                          ";
$sSqlConsulta .= "        lote.j34_areapreservada,                                                                                                                ";
$sSqlConsulta .= "        lote.j34_areal,                                                                                                                         ";
...
$sSqlConsulta .= "        proprietario.j39_numero,                                                                                                                ";
$sSqlConsulta .= "        proprietario.j39_compl,                                                                                                                ";
$sSqlConsulta .= "        proprietario.j40_refant,                                                                                                                ";
$sSqlConsulta .= "        proprietario.j40_registrocartografico,                                                                                                  ";
...
$sSqlConsulta .= "        setorfiscal.j90_codigo,                                                                                                                 ";
$sSqlConsulta .= "        setorfiscal.j90_descr                                                                                                                   ";
...
$sSqlConsulta .= "        left   join  lotesetorfiscal    on lotesetorfiscal.j91_idbql      = lote.j34_idbql                                                      ";
$sSqlConsulta .= "        left   join  setorfiscal        on setorfiscal.j90_codigo         = lotesetorfiscal.j91_codigo                                          ";
...
for ($iInd = 0; $iInd < $iNumRows; $iInd++) {
    ...
    if (isset($oGet->dadosimovel)) {
        ...
        $oDadosImovel->iIdbql = $oDados->j01_idbql;
        ...
        $oDadosImovel->sRegistroCartografico = $oDados->j40_registrocartografico;
        ...
        $oDadosImovel->sNumero = $oDados->j39_numero;
        $oDadosImovel->sCompl = $oDados->j39_compl;
        ...
        $nAreaPrivativa = $oDados->j01_areaprivativa;
        if (empty($nAreaPrivativa)) {
            $nAreaPrivativa = '0';
        }
        ...
        $oDadosImovel->nAreaPrivativa = trim(db_formatar($nAreaPrivativa, 'p', ' ', 15, 'e', 2));
        ...
        $sSetorFiscal = '';
        if (!empty($oDados->j90_codigo) && !empty($oDados->j90_descr)) {
            $sSetorFiscal = $oDados->j90_codigo . '-' . $oDados->j90_descr;
        }
    ...
    if (isset($oGet->testadaslote)) {
        ...
        $sSqlDadosTestadaLote .= "         inner join ruastipo      on ruas.j14_tipo           = ruastipo.j88_codigo      ";
        ...
        if ($iNumRowsDadosTestadaLote > 0) {
            ...
            for ($xIndTestadaLote = 0; $xIndTestadaLote < $iNumRowsDadosTestadaLote; $xIndTestadaLote++) {
                ...
                $oDadosTestadaLote->iSequencia   = $oDadoTestadaLote->j37_sequencia;
    ...
    $sSqlOutrosProprietarios .= "  ROUND(COALESCE(j42_fracaoproprietario, 0), 4) as fracao,                                                    ";
    $sSqlOutrosProprietarios .= "  COALESCE(j42_arealoteproprietario, 0) as area                                                               ";
    $sSqlOutrosProprietarios .= "     from propri                                                                                              ";
    $sSqlOutrosProprietarios .= "          inner join cgm          on cgm.z01_numcgm          = propri.j42_numcgm                              ";
    $sSqlOutrosProprietarios .= "          inner join tipoproprietario ON tipoproprietario.j163_tipoproprietario = propri.j42_tipoproprietario ";
    ...
    $existeOutroProprietario = $iNumRowsOutrosProprietarios == 1;
    $existemOutrosProprietarios = $iNumRowsOutrosProprietarios > 1;
    ...
    if (isset($oGet->proprietarios)) {
        ...
        $sSqlDadosProprietario .= "         ROUND(iptubase.j01_fracaoproprietario, 4) as fracao,                                                  ";
        $sSqlDadosProprietario .= "         lote.j34_area                             as area,                                                    ";
        $sSqlDadosProprietario .= "         tipoproprietario.j163_descricao           as tipo_proprietario                                        ";
        ...
        $sSqlDadosProprietario .= "         inner join lote on lote.j34_idbql = iptubase.j01_idbql                                                ";
        $sSqlDadosProprietario .= "         inner join tipoproprietario ON tipoproprietario.j163_tipoproprietario = iptubase.j01_tipoproprietario ";
        ...
        if ($iNumRowsDadosProprietario > 0) {
            ...
            for ($xIndProprietario = 0; $xIndProprietario < $iNumRowsDadosProprietario; $xIndProprietario++) {
                ...
                $oDadosProprietario->sTipo = 'Principal';
                $oDadosProprietario->sTipoProprietario = $oDadoProprietario->tipo_proprietario;
                $oDadosProprietario->sNome = $oDadoProprietario->nome . $sulfixoOutroProprietario;
                ...
                $oDadosProprietario->fFracao = $oDadoProprietario-> fracao;
                $oDadosProprietario->fArea = ((float)$oDadoProprietario->fracao / 100) * (float)$oDadoProprietario->area;
    ...
    if (isset($oGet->outrosproprietarios)) {
        if ($iNumRowsOutrosProprietarios > 0) {
            ...
            for ($xIndOutrosProprietarios = 0; $xIndOutrosProprietarios < $iNumRowsOutrosProprietarios; $xIndOutrosProprietarios++) {
                ...
                $oDadosOutrosProprietarios->sTipo = 'Outro Proprietário';
                $oDadosOutrosProprietarios->sTipoProprietario = $oDadoOutrosProprietarios->j163_descricao;
                ...
                $oDadosOutrosProprietarios->fFracao = $oDadoOutrosProprietarios->fracao;
                $oDadosOutrosProprietarios->fArea = $oDadoOutrosProprietarios->area;
    ...
    if (isset($oGet->promitentes)) {
        ...
        $sSqlPromitentes .= "           inner join tipopromitente ON promitente.j41_promitipo = tipopromitente.j164_promitipo           ";
        $sSqlPromitentes .= "               or tipopromitente.j164_tipopromitente = promitente.j41_tipopromitente                       ";
        ...
        if ($iNumRowsPromitentes > 0) {
            ...
            for ($xIndPromitentes = 0; $xIndPromitentes < $iNumRowsPromitentes; $xIndPromitentes++) {
                ...
                $oDadosPromitentes->sTipo = 'Promitente';
                $oDadosPromitentes->sTipoPromitente = $oDadoPromitentes->j164_descricao;
    ...
    if (isset($oGet->outrospromitentes)) {
        ...
        $sSqlOutrosPromitentes .= "           inner join tipopromitente ON promitente.j41_promitipo = tipopromitente.j164_promitipo            ";
        $sSqlOutrosPromitentes .= "             or promitente.j41_promitipo = tipopromitente.j164_promitipo                                    ";
        ...
        if ($iNumRowsOutrosPromitentes > 0) {
            ...
            for ($xIndOutrosPromitentes = 0; $xIndOutrosPromitentes < $iNumRowsOutrosPromitentes; $xIndOutrosPromitentes++) {
                ...
                $oDadosOutrosPromitentes->sTipo = 'Outro Promitente';
                $oDadosOutrosPromitentes->sTipoPromitente = $oDadoOutrosPromitentes->j164_descricao;
    ...
    if (isset($oGet->edificacoes)) {
        ...
        $sSqlEdificacoes .= "            left join carconstr     on carconstr.j48_matric  = iptuconstr.j39_matric  ";
        ...
        $sSqlEdificacoes .= "           left outer join iptuconstrhabite                                           ";
        $sSqlEdificacoes .= "        on iptuconstr.j39_matric = iptuconstrhabite.j131_matric                       ";
        $sSqlEdificacoes .= "       and iptuconstr.j39_idcons = iptuconstrhabite.j131_idcons                       ";
        $sSqlEdificacoes .= "           left outer join iptuconstrpontos                                           ";
        $sSqlEdificacoes .= "        on iptuconstr.j39_matric = iptuconstrpontos.j83_matric                        ";
        $sSqlEdificacoes .= "       and iptuconstr.j39_idcons = iptuconstrpontos.j83_idcons                        ";
        ...
        if ($iNumRowsEdificacoes > 0) {
            ...
            for ($xIndEdificacoes = 0; $xIndEdificacoes < $iNumRowsEdificacoes; $xIndEdificacoes++) {
                ...
                $oDadosEdificacoes->iCodHabitese = $oDadoEdificacoes->j131_cadhab;
                $oDadosEdificacoes->dtHabite = $oDadoEdificacoes->j131_dthabite;
                $oDadosEdificacoes->sHabiteObservacao = $oDadoEdificacoes->j131_obs;
                ...
                $oDadosEdificacoes->iAreaPrivada = $oDadoEdificacoes->j39_areap;
                $oDadosEdificacoes->sTipo = ($oDadoEdificacoes->j39_idprinc == 't' ? 'Principal' : 'Secundária');
                $oDadosEdificacoes->sLogradouro = $oDadoEdificacoes->j88_descricao . ' ' . $oDadoEdificacoes->j14_nome;
                $oDadosEdificacoes->iNumeroEnder = $oDadoEdificacoes->j14_codigo;
                $oDadosEdificacoes->sComplEnder = $oDadoEdificacoes->j39_compl;
                $oDadosEdificacoes->iPontos = $oDadoEdificacoes->j83_pontos;
                $oDadosEdificacoes->sObsConstr = $oDadoEdificacoes->j39_obs;
    ...
    if (isset($oGet->calculos)) {
        ...
        if ($iNumRowsIptuCalc > 0) {
            ...
            for ($xIndIptuCalc = 0; $xIndIptuCalc < $iNumRowsIptuCalc; $xIndIptuCalc++) {
                ...
                $sSqlValoresLancados .= "                   sum(j21_valor) as j21_valor,                                                                                                 ";
                $sSqlValoresLancados .= "                   sum(j21_valorisen) as j21_valorisen                                                                                          ";
                $sSqlValoresLancados .= "              from ( select DISTINCT k02_codigo,                                                                                                ";
                $sSqlValoresLancados .= "                            k02_descr,                                                                                                          ";
         ...
         select k02_codigo,
                ...
                (select j17_descr
                 from iptucalh
                 inner join iptutaxacalv on iptucalh.j17_codhis = iptutaxacalv.j152_codhis
                 and iptutaxacalv.j152_receit = total.k02_codigo limit 1) as j17_descr,
                (select j17_codhis
                 from iptucalh
                 inner join iptutaxacalv on iptucalh.j17_codhis = iptutaxacalv.j152_codhis
                 and iptutaxacalv.j152_receit = total.k02_codigo limit 1) as j17_codhis,
                sum(j152_valor) as j21_valor,
                sum(j21_valorisen) as j21_valorisen
         from (select k02_codigo,
                      k02_descr,
                      min(j17_codhis) as j17_codhis,
                      j17_descr,
                      sum(j152_valor) as j152_valor,
                      sum(j152_valorisen) as j21_valorisen
                   from (select DISTINCT k02_codigo,
                                k02_descr,
                                j17_codhis,
                                j17_descr,
                                case when iptucalh.j17_codhis = iptucadtaxaexe.j08_iptucalh or iptucalh.j17_codhis = 1
                                     then j152_valor
                                     else 0
                                end as j152_valor,
                                case when iptucalh.j17_codhis = iptucadtaxaexe.j08_histisen or iptucalh.j17_codhis = (select j18_iptuhistisen from cfiptu where j18_anousu = {$oDadoCalculo->j23_anousu})
                                     then j152_valor
                                     else 0
                                end as j152_valorisen
                        from iptutaxanump
                        inner join iptutaxacalv on j151_codigo = j152_iptutaxanump
                        inner  join iptucadtaxaexe on iptucadtaxaexe.j08_anousu = {$oDadoCalculo->j23_anousu}
                        and j151_iptucadtaxaexe = j08_iptucadtaxaexe
                        inner join iptucalv on j21_matric = j151_matric and j08_anousu = j21_anousu
                        inner join iptucalh on iptucalh.j17_codhis       = j152_codhis
                        inner join tabrec on tabrec.k02_codigo         = j152_receit
                        where j21_matric = {$oDadoCalculo->j23_matric}
                            and j21_anousu = {$oDadoCalculo->j23_anousu}
                       ) as x
                       group by k02_codigo,
                                k02_descr,
                                j17_descr
           having sum(j152_valor) <> 0 or sum(j152_valorisen) <> 0
         ) as total
         group by k02_codigo,
                  k02_descr
         order by k02_codigo";
                ...
                if ($iNumRowsValoresLancados > 0) {
                    ...
                    /* PLUGIN LIC - Busca se ha desconto para a matricula e exercicio informados */
                }
...
if (isset($oGet->dadosimovel)) {
    ...
    if (count($aDadosImovel) > 0) {
        ...
        foreach ($aDadosImovel as $oDadoImovel) {
            ...
            $pdf->cell(50, $iAlt, $RLj40_refant, 0, 0, "L", 0);
            $pdf->cell(50, $iAlt, $RLj40_registrocartografico, 0, 1, "L", 0);
            ...
            $pdf->cell(50, $iAlt, $oDadoImovel->sRefAnterior, 0, 0, "L", 0);
            $pdf->cell(50, $iAlt, $oDadoImovel->sRegistroCartografico, 0, 1, "L", 0);
            ...
            $pdf->cell(100, $iAlt, 'Logradouro', 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, 'Número', 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, 'Complemento', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontBic);
            $pdf->cell(25, $iAlt, $oDadoImovel->iCodLogradouro, 0, 0, "L", 0);
            $pdf->cell(25, $iAlt, $oDadoImovel->sRuaTipoDescr, 0, 0, "L", 0);
            $pdf->cell(100, $iAlt, $oDadoImovel->sLogradouroDescr, 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, $oDadoImovel->sNumero, 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, $oDadoImovel->sCompl, 0, 1, "L", 0);

            //$pdf->cell(193, 1, ''                                                                       ,0,1,"L",0);

            $pdf->setfont('arial', 'B', $iFontBic);
            $pdf->cell(100, $iAlt, 'Setor de Localização', 0, 0, "L", 0);
            $pdf->cell(50, $iAlt, 'Quadra de Localização', 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, 'Lote de Localização', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontBic);
            $pdf->cell(100, $iAlt, "$oDadosImovel->iSetorLoc - $oDadoImovel->sDescrLoc", 0, 0, "L", 0);
            $pdf->cell(50, $iAlt, $oDadoImovel->iQuadraLoc, 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, $oDadoImovel->iLoteLoc, 0, 1, "L", 0);

            //$pdf->cell(193, 1, ''                                                                       ,0,1,"L",0);

            /* Plugin AJUSTECADASTRO: area_lote e areal_real_lote */

            $pdf->setfont('arial', 'B', $iFontBic);
            $pdf->cell(40, $iAlt, 'Área do Lote', 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, 'Área Real do Lote', 0, 0, "L", 0);
            ...
            $pdf->cell(40, $iAlt, trim(db_formatar($oDadoImovel->nAreaRealLote, 'f')), 0, 0, "L", 0);
            ...
            $pdf->cell(40, $iAlt, 'Fração Ideal', 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, 'Zona Fiscal', 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, $RLj91_codigo, 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, 'Condomínio', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontBic);
            $pdf->cell(40, $iAlt, trim(db_formatar($oDadoImovel->nFracaoIdeal, 'f')), 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, $oDadoImovel->sZonaFiscal, 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, $oDadoImovel->sSetorFiscal, 0, 0, "L", 0);
            $pdf->cell(40, $iAlt, $oDadoImovel->sCondominio, 0, 1, "L", 0);
        }
    } else {
...
if (isset($oGet->testadaslote)) {
    ...
    if (count($aDadosTestadaLote) > 0) {
        ...
        $pdf->setfont('arial', 'B', $iFontDados);
        $pdf->cell(15, $iAlt, 'Testada  MI', 0, 0, "L", 0);
        $pdf->cell(19, $iAlt, 'Testada Medida', 0, 0, "L", 0);
        $pdf->cell(15, $iAlt, 'Cód. Log.', 0, 0, "L", 0);
        $pdf->cell(50, $iAlt, 'Descrição Logradouro', 0, 0, "L", 0);
        $pdf->cell(15, $iAlt, 'Número', 0, 0, "L", 0);
        $pdf->cell(50, $iAlt, 'Complemento', 0, 0, "L", 0);
        $pdf->cell(15, $iAlt, $RLj37_segmento, 0, 0, "L", 0);
        $pdf->cell(15, $iAlt, $RLj37_sequencia, 0, 1, "L", 0);
        ...
        foreach ($aDadosTestadaLote as $aDadoTestadaLote) {
            ...
            foreach ($aDadoTestadaLote as $oDadoTestLote) {
                ...
                $pdf->setfont('arial', '', $iFontBic);
                $pdf->cell(15, $iAlt, $oDadoTestLote->iCodigoMI, 0, 0, "L", 0);
                $pdf->cell(19, $iAlt, $oDadoTestLote->iMedida, 0, 0, "L", 0);
                $pdf->cell(15, $iAlt, $oDadoTestLote->iCodigoLogr, 0, 0, "L", 0);
                $pdf->cell(50, $iAlt, $oDadoTestLote->sDescrLogr, 0, 0, "L", 0);
                $pdf->cell(15, $iAlt, $oDadoTestLote->iNumero, 0, 0, "L", 0);
                $pdf->cell(50, $iAlt, $oDadoTestLote->sComplemento, 0, 0, "L", 0);
                $pdf->cell(15, $iAlt, $oDadoTestLote->iSegmento, 0, 0, "L", 0);
                $pdf->cell(15, $iAlt, $oDadoTestLote->iSequencia, 0, 1, "L", 0);

                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(50, $iAlt, 'Oritentação', 0, 1, "L", 0);

                $pdf->setfont('arial', '', $iFontBic);
                $pdf->cell(50, $iAlt, $oDadoTestLote->sOrientacaoTestada, 0, 1, "L", 0);
            }
        }
    } else {
    ...
    if (count($aDadosTestadaInterna) > 0) {
        ...
        foreach ($aDadosTestadaInterna as $aDadoTestadaInterna) {
            ...
            foreach ($aDadoTestadaInterna as $oDadoTestInterna) {
                ...
                $pdf->cell(38, $iAlt, $oDadoTestInterna->sOutro, 0, 0, "L", 0);
                $pdf->cell(38, $iAlt, $oDadoTestInterna->sOrientacao, 0, 0, "L", 0);
...
if (isset($oGet->caracteristicasface)) {
    ...
    } else if (count($iTotalCaracteristicaFace) == 0 && $lImprimeNulo) {
        imprimirCabecalhoFixo($pdf, $iAlt, true, 'Características da Face');
...
if (isset($oGet->proprietarios)) {
    ...
    imprimirCabecalhoFixo($pdf, $iAlt, true, 'Proprietários');

    if (count($aDadosProprietario) > 0) {

        if (isset($oGet->outrosproprietarios) && count($aDadosOutrosProprietarios) > 0) {
            $aDadosOutrosProprietarios = array_map(function($item){
                return $item['oDadosOutrosProprietarios'];
            },$aDadosOutrosProprietarios);

            $aDadosProprietario = array_merge( $aDadosProprietario, $aDadosOutrosProprietarios);
        }


        foreach ($aDadosProprietario as $oDadoPropri) {
            $pdf->ln(2);
            if ($lImprimeDadosSigilosos) {
                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(12, $iAlt, 'CGM', 0, 0, "L", 0);
                $pdf->cell(80, $iAlt, 'Nome', 0, 0, "L", 0);
                $pdf->cell(50, $iAlt, 'CPF/CNPJ', 0, 0, "L", 0);
                $pdf->cell(40, $iAlt, 'Tipo Proprietário', 0, 0, "L", 0);
                $pdf->cell(27, $iAlt, 'Principal', 0, 1, "L", 0);
                ...
                $pdf->cell(50, $iAlt, $sCgcCpf, 0, 0, "L", 0);

                $pdf->cell(40, $iAlt, $oDadoPropri->sTipoProprietario, 0, 0, "L", 0);
                $pdf->cell(27, $iAlt, ($oDadoPropri->sTipo && $oDadoPropri->sTipo == 'Principal') ? 'SIM' : 'NÃO', 0, 1, "L", 0);
                ...
                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(60, $iAlt, 'Fação', 0, 0, "L", 0);
                $pdf->cell(25, $iAlt, 'Área', 0, 0, "L", 0);
                $pdf->cell(60, $iAlt, '', 0, 0, "L", 0);
                $pdf->cell(40, $iAlt, '', 0, 1, "L", 0);

                $pdf->setfont('arial', '', $iFontBic);
                $pdf->cell(60, $iAlt, $oDadoPropri->fFracao . '%', 0, 0, "L", 0);
                $pdf->cell(25, $iAlt, $oDadoPropri->fArea . 'm²', 0, 0, "L", 0);
                $pdf->cell(60, $iAlt, '', 0, 0, "L", 0);
                $pdf->cell(40, $iAlt, '', 0, 1, "L", 0);
            } else {
                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(12, $iAlt, 'CGM', 0, 0, "L", 0);
                $pdf->cell(80, $iAlt, 'Nome', 0, 0, "L", 0);
                $pdf->cell(27, $iAlt, 'Tipo Proprietário', 0, 1, "L", 0);
...
if (isset($oGet->promitentes)) {
    ...
    if (count($aDadosPromitentes) > 0) {
        ...
        if ((isset($oGet->outrospromitentes)) && count($aDadosOutrosPromitentes) > 0) {
            $aDadosPromitentes = array_merge( $aDadosPromitentes, $aDadosOutrosPromitentes);
        }
        ...
        foreach ($aDadosPromitentes as $aPromitentes) {
            ...
            foreach ($aPromitentes as $oPromitentes) {
                ...
                $pdf->setfont('arial', 'B', $iFontDados);
                    $pdf->cell(12, $iAlt, 'CGM', 0, 0, "L", 0);
                    $pdf->cell(57, $iAlt, 'Nome', 0, 0, "L", 0);
                    $pdf->cell(34, $iAlt, 'CPF/CNPJ', 0, 0, "L", 0);
                    $pdf->cell(44, $iAlt, 'Contato', 0, 0, "L", 0);
                    $pdf->cell(35, $iAlt, 'Tipo Promitente', 0, 0, "L", 0);
                    $pdf->cell(27, $iAlt, 'Principal', 0, 1, "L", 0);
                ...
                $pdf->cell(44, $iAlt, substr($oPromitentes->sContato, 0, 30), 0, 0, "L", 0);

                $pdf->cell(35, $iAlt, $oPromitentes->sTipoPromitente, 0, 0, "L", 0);
                $pdf->cell(27, $iAlt, ($oPromitentes->sTipo && $oPromitentes->sTipo == 'Promitente') ? 'SIM' : 'NÃO', 0, 1, "L", 0);
                ...
                $pdf->cell(60, $iAlt, $oPromitentes->sEmail, 0, 1, "L", 0);
                    ...
                    $pdf->cell(12, $iAlt, 'CGM', 0, 0, "L", 0);
                    $pdf->cell(57, $iAlt, 'Nome', 0, 0, "L", 0);
                    $pdf->cell(27, $iAlt, 'Tipo Promitente', 0, 1, "L", 0);
    ...
    if (count($aDadosImobiliaria) > 0) {
        ...
        foreach ($aDadosImobiliaria as $oDadoImobiliaria) {
            ...
            if ($lImprimeDadosSigilosos) {
                ...
                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(25, $iAlt, 'CGM', 0, 0, "L", 0);
                $pdf->cell(100, $iAlt, 'Nome', 0, 1, "L", 0);
 ...
 */
if (isset($oGet->enderecoentrega) && $lImprimeDadosSigilosos) {
...
if (isset($oGet->edificacoes)) {
    ...
    if (count($aDadosEdificacoes) > 0) {
        ...
        foreach ($aDadosEdificacoes as $oEdificacoes) {
            ...
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->sTipo, 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->sSituacao, 0, 1, "L", 0);

            //$pdf->cell(193, 1, ''                                                                       ,0,1,"L",0);

            $pdf->setfont('arial', 'B', $iFontDados);
            $pdf->cell(30, $iAlt, 'Área Privada', 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, 'Origem da Construção', 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, $RLj83_pontos, 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, 'Pavimento', 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, 'Data Demolição', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontDados);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->iAreaPrivada, 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->iOrigem, 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, db_formatar($oEdificacoes['oDadosEdificacoes']->iPontos, 'p'), 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->iPavimento, 0, 0, "L", 0);
            $dtDemolicao = '';
            if (!empty($oEdificacoes['oDadosEdificacoes']->dtDemolicao)) {
                $dtDemolicao = db_formatar($oEdificacoes['oDadosEdificacoes']->dtDemolicao, 'd');
            }
            $pdf->cell(30, $iAlt, $dtDemolicao, 0, 1, "L", 0);
            ...
            $pdf->cell(90, $iAlt, 'Logradouro', 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, 'Número', 0, 0, "L", 0);
            $pdf->cell(60, $iAlt, 'Complemento', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontDados);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->iNumeroEnder, 0, 0, "L", 0);
            $pdf->cell(90, $iAlt, $oEdificacoes['oDadosEdificacoes']->sLogradouro, 0, 0, "L", 0);
            $pdf->cell(20, $iAlt, $oEdificacoes['oDadosEdificacoes']->iNumeroConstr, 0, 0, "L", 0);
            $pdf->cell(60, $iAlt, $oEdificacoes['oDadosEdificacoes']->sComplemento, 0, 1, "L", 0);

            //$pdf->cell(193, 1, ''                                                                       ,0,1,"L",0);
            $pdf->setfont('arial', 'B', $iFontDados);
            $pdf->cell(30, $iAlt, 'Cód. Habite-se', 0, 0, "L", 0);
            $pdf->cell(30, $iAlt, 'Data Habite-se', 0, 0, "L", 0);
            $pdf->cell(135, $iAlt, 'Observação Habite-se', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontDados);
            $pdf->cell(30, $iAlt, $oEdificacoes['oDadosEdificacoes']->iCodHabitese, 0, 0, "L", 0);
            $dtHabite = '';
            if (!empty($oEdificacoes['oDadosEdificacoes']->dtHabite)) {
                $dtHabite = db_formatar($oEdificacoes['oDadosEdificacoes']->dtHabite, 'd');
            }

            $pdf->cell(30, $iAlt, $dtHabite, 0, 0, "L", 0);
            $pdf->MultiCell(135, $iAlt, $oEdificacoes['oDadosEdificacoes']->sHabiteObservacao, 0, 'L', 0, 0);

            $pdf->setfont('arial', 'B', $iFontDados);
            $pdf->cell(195, $iAlt, 'Observação da Construção', 0, 1, "L", 0);

            $pdf->setfont('arial', '', $iFontDados);
            $pdf->MultiCell(195, $iAlt, $oEdificacoes['oDadosEdificacoes']->sObsConstr, 0, 'L', 0, 0);
    ...
    if (count($aDadosCalculos) > 0) {
        ...
        foreach ($aDadosCalculos as $aCalculos) {
            ...
            foreach ($aCalculos as $oCalculo) {
                ...
                $pdf->cell(33, $iAlt, 'Área do lote m2', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Fração', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Valor m2', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Alíquota', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Valor Venal Terreno', 0, 1, "L", 0);
                ...
                $pdf->cell(32, $iAlt, trim(db_formatar($oCalculo->nValorVenalTerreno, 'f')), 0, 1, "L", 0);

                $pdf->setfont('arial', 'B', $iFontDados);
                $pdf->cell(33, $iAlt, '', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Área Construída', 0, 0, "L", 0);
                if(isParaiba()) {
                    $pdf->cell(32, $iAlt, 'Ano da Edificação', 0, 0, "L", 0);
                } else {
                    $pdf->cell(32, $iAlt, 'Ano', 0, 0, "L", 0);
                }
                $pdf->cell(32, $iAlt, 'Testada', 0, 0, "L", 0);
                ...
                $pdf->cell(32, $iAlt, $oCalculo->nTestada . 'm', 0, 0, "L", 0);
                ...
                if (isset($oCalculo->aValorlancado)) {
                    ...
                    if (count($oCalculo->aValorlancado) > 0) {
                        ...
                        $pdf->setfont('arial', '', $iFontBic);
                        $pdf->cell(193, $iAlt, 'Não possui valores disponíveis', 0, 1, "L", 0);
                    }
                ...
                $pdf->cell(32, $iAlt, 'Núm.', 0, 0, "L", 0);
                $pdf->cell(32, $iAlt, 'Área m2', 0, 0, "L", 0);
                if(isParaiba()) {
                    $pdf->cell(32, $iAlt, 'Ano da Edificação', 0, 0, "L", 0);
                } else {
                ...
                /* PLUGIN LIC - Observação com o número do processo e descrição */
...
if (isset($oGet->outrosdados)) {
    ...
    if (count($aDadosOutrosDados) > 0 && !empty($oOutrosDados->sObservacao)) {
