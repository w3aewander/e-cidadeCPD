...
class M27530CalculaValeAlimentacao extends Migration
{
    public function up()
 {
    DB::connection()->getPdo()->exec(<<<SQL
      create or replace function fc_valealimentacao_dias_afasta_vr(integer,integer,integer) returns setof tp_dias_afastamento as
$$
declare
...
SQL
 ...
 {
    DB::connection()->getPdo()->exec(<<<SQL
      drop function fc_valealimentacao_dias_afasta_vr(integer,integer,integer);
SQL
     );
