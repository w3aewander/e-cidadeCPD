...
include(modification("classes/db_empautitempcprocitem_classe.php"));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
        <?
        include(modification("forms/db_frmexcpcproc.php"));
        ?>
    </center>
    </td>
  </tr>
...
if(isset($excluir)){
  if($sqlerro==true){
    ...
    echo "<script>(window.CurrentWindow || parent.CurrentWindow).corpo.location.href='com1_pcproc003.php'</script>";
  }
}
if($db_opcao==33){
  echo "<script>";
