...
<script>
function js_abrejan1(TorF){
  if(TorF == true){
    if(document.form1.r54_codrel.value == "" && document.form1.r54_codeve.value == ""){
    ...
    jan = window.open('pes2_RetornoConsignados002.php<?=$queryst?>','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);
  }
}
...
function js_abrejan(TorF){
  if(TorF == true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_geraarqbanco','pes2_RetornoConsignados002.php<?=$queryst?>','Gerando Arquivo', true );
//    jan = window.open('pes2_RetornoConsignados002.php<?=$queryst?>','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
//    jan.moveTo(0,0);
  }
}
...
function js_detectaarquivo(arquivo,pdf,pdf1){
