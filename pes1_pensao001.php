...
if(isset($incluir)){
  ...
  $rsPensao = $clpensao->sql_record($clpensao->sql_query_file($r52_anousu,$r52_mesusu,$r52_regist,null,'r52_sequencial', null, '',$r52_cgmalimentado));
  if (pg_numrows($rsPensao) > 0) {
      $lErro = true;
      $sqlerro = true;
      $erro_msg = "o CGM Alimentado já está cadastrado para este funcionário";
  }
  if (!$lErro) {
      $clpensao->incluir($r52_anousu, $r52_mesusu, $r52_regist, $r52_numcgm, $r52_cgmalimentado);
      ...
      $sWhere = "rh139_regist = $r52_regist
         ...
         and rh139_cgmalimentado = $r52_cgmalimentado";
  ...
  if ( !$lErro ) {
	  if ( isset($rh77_retencaotiporec) && trim($rh77_retencaotiporec) != '' ) {
		  ...
		  $clpensaoretencao->rh77_cgmalimentado = $r52_cgmalimentado;
  ...
  $clpensao->r52_dvconta    = $inputDvConta;
  $clpensao->r52_relacaodependencia  = $r52_relacaodependencia;
  if ($r52_cgmalimentado != $r52_cgmalimentadoantigo) {
      $rsPensao = $clpensao->sql_record($clpensao->sql_query_file($r52_anousu,$r52_mesusu,$r52_regist,null,'r52_sequencial', null, '',$r52_cgmalimentado));
      if (pg_numrows($rsPensao) > 0) {
          $lErro = true;
          $sqlerro = true;
  ...
  if (!$lErro ) {
      ...
      $clpensao->alterar($r52_anousu, $r52_mesusu, $r52_regist, $r52_numcgm, $r52_cgmalimentadoantigo);
  ...
  if ( !$lErro ) {
    ...
    $clpensaoretencao->rh77_regist = $r52_regist;
	  ...
	  $sWhereRetencao  .= "and rh77_cgmalimentado = {$r52_cgmalimentado} ";
  ...
  if(isset($db_opcaoal) && $db_opcaoal!=33){
  	$numcgm = $r52_numcgm;
    $cgmalimentado = $r52_cgmalimentado;
  }
  ...
  if ( trim($numcgm) != '' && trim($cgmalimentado) != '') {
    $sWhereRetencao .= "and rh77_numcgm = {$numcgm}   ";
    $sWhereRetencao .= "and rh77_cgmalimentado = {$cgmalimentado} ";
  }
  ...
  $sql = $clpensao->sql_query_dados(
                                    ...
                                    "
                                     ...
                                     r52_observacao,
                                     r52_cgmalimentado,
                                     r52_cgmalimentado as r52_cgmalimentadoantigo
                                    ",
                                    "
                                     z01_nome
                                    "
...
if($limpar_campos == true){
  ...
  unset($r52_cgmalimentado,$r52_cgmalimentadoantigo,$z01_nome03);
}
