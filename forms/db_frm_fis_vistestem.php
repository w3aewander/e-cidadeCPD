...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_testem.location.href='fis1_fis_vistestem002.php?chavepesquisa=$y25_codvist&chavepesquisa1=$y25_numcgm'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_testem.location.href='fis1_fis_vistestem003.php?chavepesquisa=$y25_codvist&chavepesquisa1=$y25_numcgm'</script>";
}
?>
...
db_input('z01_nome',40,$Iz01_nome,true,'text',3,'')
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_vistestem001.php?y25_codvist=<?=$y25_codvist?>&y39_codandam=<?=$y39_codandam?>'">
      <?php
      }
      ?>
    </td>
...
function js_pesquisay25_codvist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_vistal','func_fis_vistorias.php?funcao_js=parent.js_mostravistal1|y70_codvist|y70_id_usuario','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_vistal','func_fis_vistorias.php?pesquisa_chave='+document.form1.y25_codvist.value+'&funcao_js=parent.js_mostravistal','Pesquisa',false);
  }
}
