...
" select t52_ident, t52_descr, t52_dtaqu,  t52_valaqu, t52_valaquhist, t52_codcla, t52_obs ".
...
if ($qtd_linhas) {
    foreach ($consulta as $linha) {
        ...
        if(substr($linha['t52_dtaqu'], 0, 4) >= 2021){
            $custo_aqui = $linha["t52_valaqu"];            
        } else {
            $custo_aqui = $linha["t52_valaquhist"];
        }        
        ...
        if(substr($linha['t52_dtaqu'], 0, 4) >= 2021){
            ...
            $total_custos += $linha["t52_valaquhist"];
        }
        //$total_custos += $linha["t52_valaqu"];
