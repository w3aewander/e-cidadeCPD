...
class SuplementacaoArquivoTemplate {
  ...
  protected function __construct() {
    ...
    $this->aListaArquivos['1005'] = $this->getAuxilioConvenio();
    ...
    $this->aListaArquivos['1017'] = $this->getCreditoExtraordinarioReducao();
    $this->aListaArquivos['1018'] = $this->getCreditoExtraordinarioArrecadacaoMaior();
    $this->aListaArquivos['1019'] = $this->getCreditoExtraordinarioSuperavitFinanceiro();
    $this->aListaArquivos['1020'] = $this->getCreditoExtraordinarioOperacaoCredito();
  }
