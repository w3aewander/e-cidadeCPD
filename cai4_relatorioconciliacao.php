...
$sqlDadosConta .= "        ( select array_to_string( array_accum(distinct c61_reduz),', ') from conplanocontabancaria inner join conplanoreduz on c61_anousu = c56_anousu and c61_reduz=c56_reduz and c61_codcon = c56_codcon where c56_contabancaria = {$k68_contabancaria} and c56_anousu = " . db_getsession('DB_anousu') . " ) as reduzido_contabil ";
