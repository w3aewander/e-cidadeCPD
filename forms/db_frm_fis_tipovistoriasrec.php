...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_vistrec.location.href='fis1_fis_tipovistoriasrec002.php?chavepesquisa=$y78_codtipo&chavepesquisa1=$y78_receit'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_vistrec.location.href='fis1_fis_tipovistoriasrec003.php?chavepesquisa=$y78_codtipo&chavepesquisa1=$y78_receit'</script>";
}
?>
...
function js_pesquisay78_codtipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_tipovistorias','func_fis_tipovistorias.php?funcao_js=parent.js_mostratipovistorias1|y77_codtipo|y77_descricao','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('','db_iframe_tipovistorias','func_fis_tipovistorias.php?pesquisa_chave='+document.form1.y78_codtipo.value+'&funcao_js=parent.js_mostratipovistorias','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('','db_iframe_tipovistoriasrec','func_fis_tipovistoriasrec.php?funcao_js=parent.js_preenchepesquisa|y78_codtipo|1','Pesquisa',true);
}
...
<?php
  if(isset($y78_codtipo) && $y78_codtipo != ""){
    echo "<script>js_OpenJanelaIframe('','db_iframe_tipovistorias1','func_fis_tipovistorias.php?pesquisa_chave=$y78_codtipo&funcao_js=parent.js_mostratipovistorias','Pesquisa',false);</script>";
  }
?>
