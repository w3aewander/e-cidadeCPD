  ...
  echo "
    <script>
      function js_db_libera(){
        ...
        (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_acordogrupodocumento.location.href='aco1_acordogrupodocumento001.php?db_opcaoal=33&ac02_sequencial=".@$ac02_sequencial."';
        parent.document.formaba.acordogruponumeracao.disabled=false;
        (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_acordogruponumeracao.location.href='aco1_acordogruponumeracao001.php?db_opcaoal=33&ac02_sequencial=".@$ac02_sequencial."';
  ";
