...
class Parser implements ParserInterface
{
    ...
    /**
     * @return \Avaliacao|\ECidade\Configuracao\Formulario\Arquivo\Avaliacao
    ...
    /**
     * Cria instância do Formulário / Avaliação
     *
     * @param array|null $data
     * @return \Avaliacao|bool
     * @throws \BusinessException
     * @throws \DBException
     */
     ...
     * @param $index
     * @param null $default valor default do campo de acordo com o tipo de dados
     * @return mixed|null
     */
    ...
    private function createGroups(array & $groups = null)
    {
        ...
        foreach ($groups as $key => $dataGroup) {
    ...
    private function createQuestion(array & $questions = null, \AvaliacaoGrupo $group)
    {
        ...
        foreach ($questions as $key => $dataQuestion) {
            ...
            $question->setObrigatoria($this->getValue($dataQuestion, 'obrigatoria', false));
            ...
            $question->setPerguntaIdentificadora($this->getValue(
                $dataQuestion,
                'pergunta_identificadora_formulario',
                false
            ));
            ...
            $question->setSomenteLeitura($this->getValue($dataQuestion, 'somente_leitura', false));
