...
class cl_pagordemele {
   ...
   private function validarValorPago(){
    ...
    $sql = "
             select *
               from pagordemele
              where e53_codord = {$this->e53_codord};
    ";
      ...
      if ( $this->numrows > 0 ) {
        ...
        if (  ($dados->e53_vlrpag - $dados->e53_vlranu) > $dados->e53_valor ) {

            $this->erro_sql = " Ordem já teve seu valor Integral Pago.";
            $this->erro_campo = "e53_vlrpag";
            $this->erro_banco = "";
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($e53_codord=null,$e53_codele=null) {
     ...
     if(trim($this->e53_codord)!="" || isset($GLOBALS["HTTP_POST_VARS"]["e53_codord"])){
        ...
        $sqlLock = " SELECT * FROM pagordemele WHERE e53_codord = {$this->e53_codord}  FOR UPDATE ";
        db_query($sqlLock);
