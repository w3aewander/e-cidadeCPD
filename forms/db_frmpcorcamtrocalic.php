...
<form name="form1" method="post" action="lic1_pcorcamtroca001.php">
  <center>
    ...
    <table border="0">
      <tr>
        <td nowrap>
          <input name="confirmar" type="submit" value="Confirmar" onclick="return js_confirmar();"
...
<script>
  function js_confirmar() {
    ...
    if (iframe_solicitem.julgamentoPossuiErros) {
        alert('O julgamento possui erros. Conserte-os antes de proceder!');
        return false;
    }
