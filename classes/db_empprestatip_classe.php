...
class cl_empprestatip { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->e44_diaria = ($this->e44_diaria == "f"?@$GLOBALS["HTTP_POST_VARS"]["e44_diaria"]:$this->e44_diaria);
     }else{
       $this->e44_tipo = ($this->e44_tipo == ""?@$GLOBALS["HTTP_POST_VARS"]["e44_tipo"]:$this->e44_tipo);
     }
   }
   ...
   function incluir ($e44_tipo){ 
     ...
     if(($this->e44_tipo == null) || ($this->e44_tipo == "") ){ 
       $this->erro_sql = " Campo e44_tipo não declarado.";
   ...
   public function alterar ($e44_tipo=null) { 
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipos de prestação não Alterado. Alteração Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->e44_tipo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Tipos de prestação não foi Alterado. Alteração Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->e44_tipo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($e44_tipo=null,$dbwhere=null) { 
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipos de prestação não Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Tipos de prestação não Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$e44_tipo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
