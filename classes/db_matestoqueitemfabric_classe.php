...
class cl_matestoqueitemfabric {
   ...
   public $m78_sequencial = 0;
   public $m78_matestoqueitem = 0;
   public $m78_matfabricante = 0;
   ...
   public function cl_matestoqueitemfabric() {
   ...
   public function incluir ($m78_sequencial){
      $this->atualizacampos();
   ...
   public function alterar ($m78_sequencial=null) {
      $this->atualizacampos();
   ...
   public function excluir ($m78_sequencial=null,$dbwhere=null) {
   ...
   public function sql_query ( $m78_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   public function sql_query_cgm ( $m78_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   public function sql_query_file ( $m78_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
