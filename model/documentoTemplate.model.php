...
class documentoTemplate  {
   ...
   */
  public function __construct($iTipo='', $iCodDocumento=null, $sCaminhoArquivo='', $lTemTransacaoAtiva = false, $sExtensaoArq = "sxw") {
    ...
    if($oDaoDocumentoTemplate->numrows == 1) {
      ...
      if (empty($conn)) {
          $DB_SERVIDOR = env("DB_HOST");
          $DB_BASE = env("DB_DATABASE");
          $DB_PORTA = env("DB_PORT");
          $DB_USUARIO = env("DB_USERNAME");
