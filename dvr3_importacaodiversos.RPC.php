...
db_app::import('diversos.ImportacaoDiversosDiversos');
...
switch ($oParam->sExec) {
    ...
    case 'cancelaImportacao':
        ...
        try {
            ...
            foreach ( $oParam->aCodigosImportacao as $iCodigoImportacao ) {
                ...
                $oImportacaoDiversos = new ImportacaoDiversosDiversos($iCodigoImportacao);
                if ( $oImportacaoDiversos->cancelar() == ImportacaoDiversosDiversos::CANCELAMENTO_PARCIAL ) {
    ...
    case 'processarDebitos':
        ...
        try {
            ...
            $oProcedenciaDiversos = new ImportacaoDiversosDiversos(null);
