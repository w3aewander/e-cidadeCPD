...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_vistlocal");
...
public function incluir ($y10_codvist){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_vistlocal(
                                       y10_codvist
                                      ,y10_codigo
                                      ,y10_codi
                                      ,y10_numero
...
public function alterar ($y10_codvist=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_vistlocal set ";
     $virgula = "";
...
public function excluir ($y10_codvist=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_vistlocal
                    where ";
     $sql2 = "";
...
public function sql_query ( $y10_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_vistlocal ";
     $sql .= "      inner join bairro  on  bairro.j13_codi = fis_vistlocal.y10_codi";
     $sql .= "      inner join ruas  on  ruas.j14_codigo = fis_vistlocal.y10_codigo";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_vistlocal.y10_codvist";
     ...
     if($dbwhere==""){
       if($y10_codvist!=null ){
         $sql2 .= " where fis_vistlocal.y10_codvist = $y10_codvist ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y10_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
