...
$clcgm->rotulo->label("z01_numero");
$clcgm->rotulo->label("z01_compl");
$clcgm->rotulo->label("z01_bairro");
$clcgm->rotulo->label("z01_telcel");
$clcgm->rotulo->label("z01_munic");
$clcgm->rotulo->label("z01_ender");
$clcgm->rotulo->label("z01_nomefanta");
...
if (isset($testanome) && !isset($pesquisa_chave)) {
	...
	$funcao_js = $funmat[0] . "|z01_numcgm|z01_nome|z01_numero|z01_compl|z01_bairro|z01_telcel|z01_cgccpf|z01_munic|z01_ender|z01_nomefanta" . $valores;
}
			...
			<td height="63" align="center" valign="top">
				<table width="100%" border="0" cellspacing="0">
					<form name="form2" method="post" action="">
						...
						<tr>
							<td align="right">
								<label for="emailDigitadoParaPesquisa">E-mail:</label>
							</td>
							<td>
								<?php
			...
			<td align="center" valign="top">
				...
				if (!isset($pesquisa_chave)) {
					...
					if (isset($campos) == false) { 
						...
						$campos = "cgm.z01_numcgm, z01_nome,cgm.z01_telcel, trim(z01_cgccpf) as z01_cgccpf, case when length(trim(z01_cgccpf)) = 14 then 'JURIDICA' else 'FÍSICA' end as tipo, trim(z01_ender) as z01_ender, z01_munic, z01_uf, z01_cep, z01_email,cgm.z01_numero,cgm.z01_compl,cgm.z01_bairro, cgm.z01_nomefanta";
					}

					if ($filtro == 1) {
						$campos = "cgm.z01_numcgm, z01_nome,trim(z01_cpf) as z01_cpf,case when length(trim(z01_cpf)) = 11 then 'FISICA' else 'JURIDICA' end as tipo, trim(z01_ender) as z01_ender, z01_munic, z01_uf, z01_cep, z01_email, cgm.z01_numero,cgm.z01_compl,cgm.z01_bairro, cgm.z01_nomefanta";
					} elseif ($filtro == 2) {
						$campos = "cgm.z01_numcgm, z01_nome,trim(z01_cgc) as z01_cgc, case when length(trim(z01_cgc)) = 14 then 'JURIDICA' else 'FISICA' end as tipo, trim(z01_ender) as z01_ender, z01_munic, z01_uf, z01_cep, z01_email, cgm.z01_numero,cgm.z01_compl,cgm.z01_bairro, cgm.z01_nomefanta";
					}

					if (isset($lCadTecMunic)) {
						$campos = "cgm.z01_numcgm, z01_nome,trim(z01_cgccpf) as z01_cgccpf, case when length(trim(z01_cgccpf)) = 14 then 'JURIDICA' else 'FÍSICA' end as tipo, trim(z01_ender) as z01_ender, z01_numero, z01_compl, z01_munic, z01_uf, z01_cep, z01_email, cgm.z01_bairro, cgm.z01_nomefanta";
					}
						...
						if (!isset($testanome)) {
							if (($result != false) && (pg_numrows($result) != 0)) {
								...
								if ($filtro == 1) {
									...
									echo "<script>" . $funcao_js . "(false,\"$z01_nome\",\"$z01_cgccpf\",\"$z01_numero\",\"$z01_compl\",\"$z01_bairro\",\"$z01_telcel\",\"$z01_munic\",\"$z01_ender\",\"$z01_nomefanta\");</script>";                                    
								} else {
