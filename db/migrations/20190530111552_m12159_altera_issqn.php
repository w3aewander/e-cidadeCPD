...
class M12159AlteraIssqn extends PostgresMigration
{
    public function up()
    {
        $this->execute(<<<SQL
                ...
                **/
                if iNumeroParcelas > 1 or (v_record_cadcalc.cadcalc = 2 and iNumeroParcelas > 0) then
                    ...
                    loop
                        ...
                        if v_record_cadcalc.cadcalc = 2 and iNumeroParcelas > 0 then
...
drop function if exists fc_issqn(integer,date,integer,date,boolean,boolean,integer,varchar,integer,integer, integer);
