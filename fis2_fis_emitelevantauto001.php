...
function js_mandadados() {
  jan = window.open('fis2_fis_emitelevantauto002.php?codlev='+document.form1.y60_codlev.value+'&numcgm='+document.form1.z01_numcgm.value+'&codinscr='+document.form1.q02_inscr.value+'&enqlegal='+document.form1.enqlegal.value+'&rectrib='+document.form1.rectrib.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}

function js_lev(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_fis_levanta02.php?todos=true&funcao_js=parent.js_mostralev1|y60_codlev|z01_nome','Pesquisa',true);
  }else{
    lev = document.form1.y60_codlev.value;
    if(lev != ''){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_fis_levanta02.php?todos=true&pesquisa_chave='+lev+'&funcao_js=parent.js_mostralev','Pesquisa',false);
    }else{
