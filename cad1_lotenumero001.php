...
require_once(modification("classes/db_lotenumero_classe.php"));
require_once(modification("classes/db_lotenumero_proc_classe.php"));
...
<table align="center" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include(modification("forms/db_frmlotenumero.php"));
	?>
    </center>
	</td>
  </tr>
