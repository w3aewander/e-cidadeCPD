...
$this->objpdf->RoundedRect(10,$y+1,158,6,2,'DF','1234'); // Matricula/ Inscrição
$this->objpdf->RoundedRect(170,$y+1,25,6,2,'DF','1234'); // Data Emissão
$this->objpdf->RoundedRect(10,$y+8,185,15,2,'DF','1234'); // Nome / Endereço
$this->objpdf->RoundedRect(10,$y+24,185,27,2,'DF','1234'); // Dados
...
$this->objpdf->SetFont('Arial','',5);
$this->objpdf->Text(172,$y+3,"Data Emissão"); // Data Emissão
$this->objpdf->SetFont('Arial','B',7);
$this->objpdf->Text(172,$y+6,date('d/m/Y', db_getsession('DB_datausu'))); // Data Emissão
...
$this->objpdf->setx(12);
$this->objpdf->SetFont('Arial','B', 7);
$this->objpdf->MultiCell(155,3,$this->dados1,0,1,"L",0);
$this->objpdf->setx(12);
