...
if (isset($z01_i_cgsund)) {
    ...
    $usuarioSistema = ($oCgsAuditoria !== null) ? $oCgsAuditoria->getUsuario() : "";
}
...
<form name="form1" method="post" action="" class="container">
    ...
    <fieldset>
        ...
        <table class="form-container">
            <tr>
                <td>
                    <label for="z18_usuario">Cadastrado Pelo Usuário:</label>
                </td>
                <td>
                    <?= db_input('usuarioSistema', 40, $usuarioSistema, true, 'text', 3, "") ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php
                    db_inputdata('dataCadastro', $dataCad[2], $dataCad[1], $dataCad[0], false, 'text', 3); ?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?php
                    db_inputdata('dataAtualizacao', $dataAlt[2], $dataAlt[1], $dataAlt[0], false, 'text', 3); ?>
                </td>
            </tr>
        </table>
    </fieldset>
