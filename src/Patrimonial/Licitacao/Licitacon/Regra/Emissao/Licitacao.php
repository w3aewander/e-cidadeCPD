...
class Licitacao extends BaseAbstract
{
    ...
    /**
     * Adicionado campo no layout do licitacon na versão 1.4
     */
    const CODIGO_LAYOUT_V14_1 = 304;
    ...
    public function getFornecedor()
    {
        ...
        if ($this->oLicitacao->getTipoJulgamento() != oLicitacao::TIPO_JULGAMENTO_GLOBAL
            || $sSiglaModalidade == 'CPC'
        ) {
        ...
        if ($this->oLicitacao->getFase() == EventoLicitacao::FASE_ADJUDICACAO_HOMOLOGACAO) {
            ...
            $sSqlFornecedores = $oDaoPCOrcamJulg->sql_query_orcamento_licitacao(
                " distinct " . $sCamposFornecedores,
                $sWhereFornecedores
            );
    ...
    {
        $ehObrigatorio = in_array($modalidade, array('CCE', 'CCP', 'EST', 'ESE', 'PCE', 'PCP', 'RDC', 'RDE'));
    ...
    public function getTipoNatureza(oLicitacao $oLicitacao)
    {
        ...
        $modalidadesRegistroDePreco = array('CCE','CCP','CNC','PCE','PCP','PRE','PRP','RDC','RDE','EST','ESE');
