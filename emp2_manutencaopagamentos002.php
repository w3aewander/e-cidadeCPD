...
if ($oParam->fonteRecurso != '') {
  $sWhere .= " and o15_recurso = '{$oParam->fonteRecurso}'";
}
...
$head4           = "Recurso:{$oParam->fonteRecurso}";
...
foreach ($aOrdensAgenda as $oMovimento) {
 ...
 $recurso = RecursoRepository::getRecursoPorCodigo($oMovimento->o15_codigo);
  ...
  $oPdf->cell(10,5,$recurso->getFonteDeRecurso(),"TBR",0,"R");
  ...
  $oPdf->cell(20,5, trim(db_formatar($oMovimento->e43_valor,"f")), "TBR", 0, "R");
  ...
  $oPdf->cell(20,5,trim(db_formatar($oMovimento->e43_valor - $oMovimento->valorretencao,"f")),"TBL",1,"R");
  //$nTotalOP         += $oMovimento->e53_valor;
  $nTotalOP         += $oMovimento->e43_valor;
  ...
  $nTotalLiquido    += ($oMovimento->e43_valor - $oMovimento->valorretencao);
