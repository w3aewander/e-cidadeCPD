  ...
  <div class="container">
    <fieldset>
      ...
      <table border="0" class="form-container">
        ...
        <tr>
          <td nowrap title="<?=$Ted254_c_email?>">
            <label for="ed254_criterioacessofuncao_cod"><?=$Led254_criterioacessofuncao?></label>
          </td>
          <td>
            <?php
              $criterios = array(
        ...
        <tr id="container_ed254_especificacaocriteriooutros">
          <td nowrap title="<?=$Ted254_especificacaocriteriooutros?>">
            <label for="ed254_especificacaocriteriooutros"><?=$Led254_especificacaocriteriooutros?></label>
          </td>
          <td>
            <?php
              db_input('ed254_especificacaocriteriooutros', 50, $Ied254_especificacaocriteriooutros, true, 'text', $db_opcao);
            ?>
          </td>
        </tr>
        <tr>
      ...
      <td valign="top">
        <?php
          ...
          $campossql = "ed254_i_codigo,
                        ...
                        ed254_d_datacad,
                        case
                            when ed254_criterioacessofuncao = 1
                                then 'Ser proprietário(a) ou sócio(a)-proprietário(a) da escola'
                            when ed254_criterioacessofuncao = 2
                                then 'Exclusivamente por indicação/escolha da gestão'
                            when ed254_criterioacessofuncao = 3
                                then 'Processo seletivo qualificado e escolha/nomeação da gestão'
                            when ed254_criterioacessofuncao = 4
                                then 'Concurso público específico para o cargo de gestor escolar'
                            when ed254_criterioacessofuncao = 5
                                then 'Exclusivamente por processo eleitoral com a participação da comunidade escolar'
                            when ed254_criterioacessofuncao = 6
                                then 'Processo seletivo qualificado e eleição com a participação da comunidade escolar'
                            when ed254_criterioacessofuncao = 7
                                then 'Outros'
                            else
                                'Não informado'
                        end as ed254_criterioacessofuncao,
                        ed254_criterioacessofuncao as ed254_criterioacessofuncao_cod,
          ...
          $chavepri= array(
                            ...
                            "ed254_criterioacessofuncao_cod" => @$ed254_criterioacessofuncao_cod,
          ...
          $sCampos     = "ed254_i_rechumano, z01_nome, ed15_c_nome, ed254_d_dataini, ed254_d_datafim, ed254_c_tipo, ed254_criterioacessofuncao, ed254_especificacaocriteriooutros";
...
$('db_opcao').onclick = function(e) {
  ...
  if (e.target.name != 'excluir' && $F('ed01_c_exigeato') == 'S' && empty( $F('ed254_i_atolegal') ) ) {
    alert( 'Diretor(a) selecionado(a) exige a informação do Ato Legal.' );
    return false;
  }

  if ($F('ed254_criterioacessofuncao_cod') == 7 && empty($F('ed254_especificacaocriteriooutros').trim())) {
    alert('Especifique o critério de acesso a função!');
    return false;
  }

  $('ed254_criterioacessofuncao_cod').name = 'ed254_criterioacessofuncao';
...
function js_cancelar() {
  ...
  $('ed254_criterioacessofuncao_cod').value = '';
  $('ed254_especificacaocriteriooutros').value = '';

  location.href = "edu1_escoladiretor001.php?ed254_i_escola=" + iEscola +"&ed18_c_nome="+ sEscola;
}

function verificaCriterioOutros(ev, target) {
    var value = target.value;
    var container = document.getElementById('container_ed254_especificacaocriteriooutros');
...
$('ed254_criterioacessofuncao_cod').on('change', verificaCriterioOutros);
verificaCriterioOutros(null, $('ed254_criterioacessofuncao_cod'));

// Mostra apropriadamente o critério de acesso a função
(function() {
