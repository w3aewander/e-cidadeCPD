...
class cl_caracter {
  ...
  function sql_query_carconstr($iMatric, $iIdConstr, $sCaracter)
  {
    $sql = "with buscagrupo as ( ";
    $sql .= "      select j31_grupo as grupo, ";
    $sql .= "             j31_codigo as caract ";
    $sql .= "      from caracter ";
    $sql .= "      where j31_codigo in ({$sCaracter}) ";
    $sql .= "    ), ";
    $sql .= " ";
    $sql .= "    buscacaracter as ( ";
    $sql .= "       select j48_caract as caractmatric, ";
    $sql .= "              j31_grupo as grupomatric, ";
    $sql .= "              j48_matric as matricula ";
    $sql .= "       from caracter ";
    $sql .= "            join carconstr on j48_matric = {$iMatric} ";
    $sql .= "                          and j48_idcons = {$iIdConstr} ";
    $sql .= "                          and j48_caract = caracter.j31_codigo ";
    $sql .= "       where j31_grupo in (select j31_grupo from buscagrupo) ";
    $sql .= "    ) ";
    $sql .= " ";
    $sql .= "select caract, ";
    $sql .= "       coalesce(caractmatric, 0) as caractmatric ";
    $sql .= "from buscagrupo ";
    $sql .= "     left join buscacaracter on grupomatric = grupo ";
