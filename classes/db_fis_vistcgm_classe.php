...
public function __construct() {
     ...
     $this->rotulo = new rotulo("fis_vistcgm");
...
public function incluir ($y73_codvist){
      $this->atualizacampos();
     ...
     $sql = "insert into fiscalizacao.fis_vistcgm(
                                       y73_codvist
                                      ,y73_numcgm
                       )
                values (
...
public function alterar ($y73_codvist=null) {
      $this->atualizacampos();
     $sql = " update fiscalizacao.fis_vistcgm set ";
     $virgula = "";
...
public function excluir ($y73_codvist=null,$dbwhere=null) {
     $sql = " delete from fiscalizacao.fis_vistcgm
                    where ";
     $sql2 = "";
...
public function sql_query ( $y73_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from fiscalizacao.fis_vistcgm ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = fis_vistcgm.y73_numcgm";
     $sql .= "      inner join fiscalizacao.fis_vistorias  on  fis_vistorias.y70_codvist = fis_vistcgm.y73_codvist";
     $sql .= "      inner join fiscalizacao.fis_tipovistorias  on  fis_tipovistorias.y77_codtipo = fis_vistorias.y70_tipovist";
     $sql2 = "";
     if($dbwhere==""){
       if($y73_codvist!=null ){
         $sql2 .= " where fis_vistcgm.y73_codvist = $y73_codvist ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
...
public function sql_query_file ( $y73_codvist=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
