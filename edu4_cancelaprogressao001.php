...
if ( isset( $incluir ) ) {
  ...
  for ( $z = 0; $z < $linhas_exc; $z++ ) {
    ...
    $codigosDiarioAvaliacao = "select ed72_i_codigo  from diarioavaliacao where  ed72_i_diario = {$coddiario}";

    $cltransfaprov->excluir("", "ed251_i_diariodestino in ($codigosDiarioAvaliacao) or ed251_i_diarioorigem in({$codigosDiarioAvaliacao})");
