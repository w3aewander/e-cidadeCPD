...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include(modification("forms/db_frmempenho.php"));
	?>
    </center>
	</td>
  </tr>
...
if(isset($incluir)){
  if($clempautoriza->erro_status=="0"){
    ...
    echo "
		...
		(window.CurrentWindow || parent.CurrentWindow).corpo.iframe_prazos.location.href='emp1_empautoriza007.php?e54_autori=$e54_autori';\n
