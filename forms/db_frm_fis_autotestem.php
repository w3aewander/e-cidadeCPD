...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_testem.location.href='fis1_fis_autotestem002.php?chavepesquisa=$y24_codauto&chavepesquisa1=$y24_numcgm'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_testem.location.href='fis1_fis_autotestem003.php?chavepesquisa=$y24_codauto&chavepesquisa1=$y24_numcgm'</script>";
}
?>
...
echo "<script>js_OpenJanelaIframe('','db_iframe_auto','func_fis_auto.php?pesquisa_chave=$y24_codauto&funcao_js=parent.js_mostraauto','Pesquisa',false);</script>";
       ?>
    </td>
  </tr>
  <tr>
...
db_input('z01_nome',40,$Iz01_nome,true,'text',3,'')
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      ?>
        <input name="novo" type="button" id="novo" value="Novo" onclick="location.href='fis1_fis_autotestem001.php?y24_codauto=<?=$y24_codauto?>'">
      <?php
      }
      ?>
    </td>
...
function js_pesquisay24_codauto(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_auto','func_fis_auto.php?pesquisa_chave='+document.form1.y24_codauto.value+'&funcao_js=parent.js_mostraauto','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_autotestem','func_fis_autotestem.php?funcao_js=parent.js_preenchepesquisa|y24_numcgm|1','Pesquisa',true);
}
