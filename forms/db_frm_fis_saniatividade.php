...
if(isset($opcao) && $opcao == "alterar"){
  echo "<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade002.php?chavepesquisa=$y83_codsani&chavepesquisa1=$y83_seq'</script>";
}
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_saniatividade.location.href='fis1_fis_saniatividade003.php?chavepesquisa=$y83_codsani&chavepesquisa1=$y83_seq'</script>";
}
...
if($db_opcao == 1){
  $clsaniatividade2 = new cl_fis_saniatividade;
...
//die($clsaniatividade->sql_query("","","  y83_codsani,y83_seq,case when y83_ativprinc is true then 'SIM' else 'NÃO' end as y83_ativprinc,y83_dtini,y83_dtfim,y83_area,y83_ativ,ativid.q03_descr",""," y83_codsani = $y83_codsani"));
  ...
  //  $cliframe_alterar_excluir->sql_disabled=$clsaniatividade->sql_query("",""," saniatividade.*,ativid.q03_descr ",""," y83_codsani = $y83_codsani and y83_dtfim is not null");
    ...
    $clsaniatividade1 = new cl_fis_saniatividade;
