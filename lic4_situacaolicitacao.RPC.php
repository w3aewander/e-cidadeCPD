...
try {
  ...
  switch ($oParam->exec) {
    ...
    case 'getRegistroDePreco':
      ...
      $oLicitacao = new licitacao($oParam->iCodigoLicitacao);
      $getRegistroDePreco = $oLicitacao->getRegistroDePreco();
      
      $oRetorno->pc10_numero = $getRegistroDePreco->pc10_numero;
      $oRetorno->pc54_datainicio = $getRegistroDePreco->pc54_datainicio;
      $oRetorno->pc54_datatermino = $getRegistroDePreco->pc54_datatermino;
      break;
