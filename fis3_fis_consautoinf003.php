...
<script>
  // var codauto = <?=$codauto?>;
  function js_imprime(codauto) {

    var sLocation  = "fis3_fis_consultaautoinf_imp.php?";
  	sLocation     += "codauto="+codauto;
...
?>
  ...
  <table  border="0" align="center">
    ...
    <tr bgcolor="#CCCCCC"> 
      <td colspan="4" style="text-align: center;">
        <label><h2>DADOS DO AUTO DE INFRAÇÃO</h2></label>
      </td>
    </tr>
    <tr> 
      <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;AUTO nº </td>
      <td nowrap bgcolor="#FFFFFF">
        <strong style="color: #666666;">&nbsp;<?=$y50_codauto?>&nbsp; </strong>
      </td>
      <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;N° DO BLOCO </td>
      <td nowrap bgcolor="#FFFFFF"> 
        <strong style="color: #666666;">&nbsp;<?=$y50_numbloco?></strong>
      </td>
    </tr>
    <?php
    ...
    ?>
    <tr> 
      <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;IDENTIFICAÇÃ0 </td>
      <td nowrap bgcolor="#FFFFFF"> 
    ...
    <tr> 
      ...
      <td nowrap bgcolor="#FFFFFF">
        &nbsp;<strong style="color: #666666;"><?=@substr($y50_obs,0,25)?>&nbsp; </strong>
      </td>
    </tr>
    <tr> 
      ...
      <td nowrap bgcolor="#FFFFFF">
        &nbsp;<strong style="color: #666666;"><?=@$y50_nome?>&nbsp; </strong>
      </td>
    </tr>
    <tr> 
      ...
      <td nowrap bgcolor="#FFFFFF">
        &nbsp;<strong style="color: #666666;"><?=@$y50_hora?>&nbsp; </strong>
      </td>
    </tr>
    <tr> 
      <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;Vencimento Atual </td>
      <td nowrap bgcolor="#FFFFFF">
        &nbsp;<strong style="color: #666666;"><?=@$y50_dtvenc?>&nbsp; </strong>
      </td>
      <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;Prazo p/ Recurso &nbsp;</td>
      <td nowrap bgcolor="#FFFFFF">
        &nbsp;<strong style="color: #666666;"><?=@$y50_prazorec?>&nbsp; </strong>
      </td>
    </tr>
  ...
  <tr> 
    ...
    <td nowrap bgcolor="#FFFFFF">
      <strong style="color: #666666;">&nbsp;<?=@$y14_numero?>&nbsp; </strong>
    </td>
  </tr>
  <tr> 
    ...
    <td nowrap bgcolor="#FFFFFF">
      <strong style="color: #666666;">&nbsp;<?=@$y14_compl?>&nbsp; </strong>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;nº </td>
    <td nowrap bgcolor="#FFFFFF">
      <strong style="color: #666666;">&nbsp;<?=@$y15_numero?>&nbsp; </strong>
    </td>
  </tr>
  <tr> 
    <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;Bairro </td>
    ...
    <td align="left" nowrap bgcolor="#CCCCCC">&nbsp;Complemento </td>
    <td nowrap bgcolor="#FFFFFF">
      <strong style="color: #666666;">&nbsp;<?=@$y15_compl?>&nbsp; </strong>
    </td>
  </tr>
...
<table  align="center"  style="margin-top: 2%;">
    ...
    <?php foreach ($ln as $rln) {?>
      ...
      <tr> 
            ...
            <td><textarea style="width: 500px;" readonly><?=$rln["pl10_texto"]; ?></textarea></td>
      </tr>
...
<div style="text-align:center;">
  ...
  <input  style="margin-top: 30px;" id='imprimir' type="button" value='Imprimir' onclick="js_imprime(<?=$codauto?>);"/>
