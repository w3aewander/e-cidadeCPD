...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
     ...
     <?php
       ...
       $clcriaabas->src = array("sanitario"=>"fis1_fis_sanitario005.php","observacoes"=>"fis1_fis_sanitario006.php","saniatividade"=>"fis1_fis_saniatividade001.php","resptecnico"=>"fis1_fis_resptecnico001.php","calculo"=>"fis1_fis_sanicalc001.php");//nome do iframe e o label
...
if(isset($db_opcao) && $db_opcao==2){
  echo "
         <script>
	   function js_src(){
            iframe_sanitario.location.href='fis1_fis_sanitario002.php?y80_codsani=';\n
	   }
	   js_src();
         </script>
       ";
...
echo "
         <script>
	   function js_src(){
            iframe_sanitario.location.href='fis1_fis_sanitario003.php?y80_codsani=';\n
