...
try {
  switch ($oParam->exec) {
    ...
    case "apensandoProcessos":
      ...
      if ($oParam->principal == $oParam->apesado) {
          throw new Exception("Não é possível apensar o mesmo processo");
      }
      /**
       * Inclui um processo apensado a um processo principal
       */
      $oDaoProcessoApensado = new cl_processosapensados();
      ...
      if ($oDaoProcessoApensado->erro_status == 0) {
          ...
          throw new Exception($oDaoProcessoApensado->erro_msg);
      }
