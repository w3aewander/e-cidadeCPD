...
if (isset($incluir) && !isset($_POST['opcao'])) {
    ...
    if (empty($ed254_i_atolegal)) {
        $clescoladiretor->ed254_i_atolegal = $ed254_i_atolegal = null;
    }
...
if (isset($alterar) && !isset($_POST['opcao'])) {
...
if (isset($excluir) && !isset($_POST['opcao'])) {
...
<body bgcolor=#CCCCCC>
<?php require_once(modification("forms/db_frmescoladiretor.php")); ?>
</body>
</html>
<script>
