 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_cadenderbairrocadenderrua.location.href='con1_cadenderbairrocadenderrua001.php?db_opcaoal=33&db87_sequencial=".@$db74_sequencial."';
     ";
         if(isset($liberaaba)){
