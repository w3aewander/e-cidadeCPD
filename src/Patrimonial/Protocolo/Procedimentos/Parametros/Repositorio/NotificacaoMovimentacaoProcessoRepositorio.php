    ...
    public function alterar(NotificacaoMovimentacaoProcesso $notificacaoMovimentacaoProcesso)
    {
        ...
        $query = "
            UPDATE {$this->tabela} SET
                ...
                p101_tipoprazo = '{$notificacaoMovimentacaoProcesso->getTipoPrazo()}',
                p101_usuarioremetente = '{$notificacaoMovimentacaoProcesso->getUsuarioRemetente()}',
                p101_permitirnotificardepartamento = '{$notificacaoMovimentacaoProcesso->getPermitirNotificarDepartamento()}'
