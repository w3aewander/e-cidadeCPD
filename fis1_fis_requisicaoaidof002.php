 ...
 */
  ...
  $clrequisicaoaidof = new cl_fis_requisicaoaidof;
  ...
  if (isset($bOpcao)) {
    ...
    switch ($bOpcao) {
      ...
      case 'liberar' :
        ...
        $oModelRequisicaoAidof = new FisRequisicaoAidof($y116_id);
        ...
        if ($oRetorno->bStatus) {
          ...
          db_fim_transacao();
          db_redireciona('fis1_fis_requisicaoaidof001.php');
        } else {
...
<html>
  ...
  <body onLoad="a=1">
    <?php include(modification("forms/db_frm_fis_requisicaoaidof.php")); ?>
    <?php
      db_menu(
