...
require_once(modification("model/fiscalizacao/FisAidof.model.php"));
 ...
 */
class FisAidofWebService extends FisAidof {
  ...
  public function setGrafica($iGrafica) {
    $oGrafica =  new FisGrafica($iGrafica);
  ...
  public function validaNumeracao () {
  	...
  	$oDaoNumeracaoAidof = db_utils::getDao('fis_aidof'); ;
   ...
   * Define a data de recebimento do talao de notas do contribuiente
   */
  public function LiberarAidofQuantidade($iIdRequisicao,$iQuantidadeLiberada,$sObservacao = '')
  {
    $oModelRequisicaoAidof = new FisRequisicaoAidof($iIdRequisicao);
    $oModelRequisicaoAidof->setQuantidadeLiberada($iQuantidadeLiberada);
    $oModelRequisicaoAidof->setObservacao($sObservacao);
