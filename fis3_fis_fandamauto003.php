...
if(!isset($abas)){
  echo "<script>location.href='fis3_fis_fandamauto005.php?db_opcao=3'</script>";
  exit;
}
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  ...
  $db_opcao = 3;
  $db_botao = false;
  echo "<script>parent.iframe_fiscais.location.href='fis3_fis_fandamautousu001.php?primeira=1';</script>";
...
if($clautoultandam->numrows > 0){
  ...
  $desliga="1";
  echo "<script>parent.iframe_fiscais.location.href='fis3_fis_fandamautousu001.php?abas=1';</script>";
}
?>
<html>
<head>
...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Excluir"){
  if($clfandam->erro_status=="0"){
    ...
    if(@$sqlerro==true){
      ...
      $clfandam->erro(true,false);
      echo "<script>parent.document.formaba.fiscais.disabled=true;</script>";
      echo "<script>parent.iframe_fandam.location.href='fis3_fis_fandamauto003.php?abas=1&y50_codauto=$y50_codauto';</script>";
    }
  };
};
