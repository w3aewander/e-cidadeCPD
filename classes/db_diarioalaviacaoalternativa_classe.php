...
class cl_diarioalaviacaoalternativa { 
   ...
   function cl_diarioalaviacaoalternativa() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("diarioalaviacaoalternativa"); 
   ...
   function incluir ($ed136_sequencial){ 
     ...
     if($ed136_sequencial == "" || $ed136_sequencial == null ){
       $result = db_query("select nextval('diarioalaviacaoalternativa_ed136_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: diarioalaviacaoalternativa_ed136_sequencial_seq do campo: ed136_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from diarioalaviacaoalternativa_ed136_sequencial_seq");
     ...
     $sql = "insert into diarioalaviacaoalternativa(
                                       ed136_sequencial 
                                      ,ed136_diario 
   ...
   public function alterar ($ed136_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update diarioalaviacaoalternativa set ";
     $virgula = "";
   ...
   public function excluir ($ed136_sequencial=null,$dbwhere=null) { 
     ...
     $sql = " delete from diarioalaviacaoalternativa
                    where ";
     $sql2 = "";
     if (empty($dbwhere)) {
   ...
   public function sql_record($sql) { 
     ...
     $this->numrows = pg_num_rows($result);
      if ($this->numrows == 0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:diarioalaviacaoalternativa";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   public function sql_query ($ed136_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") { 
     ...
     $sql  = "select {$campos}";
     $sql .= "  from diarioalaviacaoalternativa ";
     $sql .= "      inner join procavalalternativa  on  procavalalternativa.ed281_i_codigo = diarioalaviacaoalternativa.ed136_procavalalternativa";
     $sql .= "      inner join diario  on  diario.ed95_i_codigo = diarioalaviacaoalternativa.ed136_diario";
     ...
     if (empty($dbwhere)) {
       if (!empty($ed136_sequencial)) {
         $sql2 .= " where diarioalaviacaoalternativa.ed136_sequencial = $ed136_sequencial "; 
       } 
