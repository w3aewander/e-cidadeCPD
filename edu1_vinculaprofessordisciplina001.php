    ...
    <form name="form1" id='frmVinculaProfessorDisciplina' method="post" style="display:none">
        <fieldset style="width:25%">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <button type='button' id='btnMoveOneRightToLeft' class="btnArrow">
                            <i class="fas fa-angle-right"></i>
                        </button>
                        <br>
                        <button type='button' id='btnMoveAllRightToLeft' class="btnArrow">
                            <i class="fas fa-angle-double-right"></i>
                        </button>
                        <br>
                        <button type='button' id='btnMoveOneLeftToRight' class="btnArrow">
                            <i class="fas fa-angle-left"></i>
                        </button>
                        <br>
                        <button type='button' id='btnMoveAllLeftToRight' class="btnArrow">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td><label for="ed58_datafim" class="bold">Até: </label>
                    <input id="ed58_datafim" name="ed58_datafim" type="text" />
                </td>
            </tr>
        </table>
        <button type="button" id="btnVincular" name="btnVincular">
            <i class="far fa-save"></i>
            Vincular
        </button>
    </form>
</div>
<div id="divVinculos" class="container" style="display:none">
...
<script>
    ...
    function js_salvarVinculos(aDisciplinasParaVincular) {
        ...
        var oParametro = {
            exec : 'vincularRegenteDisciplina',
            iRecHumano : $('ed20_i_codigo').value,
            aRegencias : aDisciplinasParaVincular,
            dataInicio : js_formatar(oDataInicio.__toLocaleDateString(), 'd'),
            dataFim : js_formatar(oDataFim.__toLocaleDateString(), 'd'),
            iTurma : iTurma,
            iEtapa : iEtapa
        };
    ...
    function js_desvincularRegenteDisciplina(iRegencia, iRecHumano, sRegente, sDisciplina) {
        ...
        oViewRemocao = new DBViewRemocaoPeriodoGradeHorario(oGet.ed59_i_turma, oGet.ed59_i_serie, null, iRecHumano, iRegencia);
    ...
    function buscaDatasCalendario() {

        new AjaxRequest('edu4_calendario.RPC.php', {exec: 'dadosCalendarioTurma', iTurma : oGet.ed59_i_turma},
