...
if (isset($emissaoGeralPadrao) && $emissaoGeralPadrao) {
    $emissaoGeralPadrao = true;
} else {
    $emissaoGeralPadrao = false;
}
...
foreach ($aEmissoes as $iIndice => $oEmissao) {
    ...
    $descricao .= " - Ocorrências: {$sOcorrencia}";
    $tipoEmissoes[$oEmissao->getCodigo()] = $descricao;
}
...
<body class="body-default" onload="js_mostraOpVenc();js_mostracapa(); js_gridUnicas();">
  <form name="form1" action="" class="form-container" method="post">
      <input type="hidden" name="emissaoGeralPadrao" value="<?= $emissaoGeralPadrao ?>">
            ...
            <tr>
              ...
              <tr>
                  ...
                  <td>
                      ...
                      db_select('tipoGeracao', $tipoEmissoes, true, 1);
                      ?>
                  </td>
              </tr>
          </table>
        ...
        <fieldset class="separator" style="margin-top: 20px;">
          ...
          <table border="0" class="form-container">
            ...
            <tr id="showSetor" style='display: none;'>
              ...
              <tr>
                  <td>
                      <strong>Intervalo de matrículas:</strong>
                  </td>
                  <td>
                      <input type='text' id='matriculaInicial' size='10' name='matriculaInicial' >
                      <strong>à</strong>
                      <input type='text' id='matriculaFinal'   size='10' name='matriculaFinal' >
                  </td>
              </tr>
            <tr>
              <td>
        ...
        <fieldset class="separator" style="margin-top: 20px;">
          ...
          <table border="0" class="form-container">
            ...
            <tr>
              ...
              <td>
                  <input type="checkbox" id="expressaoIsento" name="expressaoIsento" <?= (!isset($ordem) ? "checked" : (isset($expressaoIsento) ? "checked": "")) ?>>
              </td>
            </tr>
    ...
    <div id="abaArquivo" class="container">
      <fieldset>
        ...
        <tr>
            ...
            <td>
                <?php db_select("gerarPix", ["0" => "Não", "1" => "Sim"], true, 2, "style='width:165px;'");?>
            </td>
        </tr>
...
function js_carregarGrid() {
  ...
  var aParametros = {
    ...
    'emissaoGeralPadrao' : <?= $emissaoGeralPadrao ? "true" : "false" ?>,
  }
...
$('emitir').observe('click', function(){
  ...
  sParametros += '&gerarPix='                  + $F('gerarPix');
...
var aEventoShow = new Array('onMouseover','onFocus');
  ...
  var oDbHintisencao = new DBHint('oDbHintisencao');
      oDbHintisencao.setText('Informar se deseja gerar registros <br> com isenção, sem isenção ou todos');
      oDbHintisencao.setShowEvents(aEventoShow);
      oDbHintisencao.setHideEvents(aEventoHide);
      oDbHintisencao.make($('isencao'));
  ...
  var oDbHintMatriculaInicial = new DBHint('oDbHintMatriculaInicial');
      oDbHintMatriculaInicial.setText("Este filtro juntamente com o filtro matrícula final invalidam os filtros <br> <strong>Gerar Apenas para as Matrículas:</strong> e <strong>Quantidade de registros do select:</strong>");
      oDbHintMatriculaInicial.setShowEvents(aEventoShow);
      oDbHintMatriculaInicial.setHideEvents(aEventoHide);
      oDbHintMatriculaInicial.make($('matriculaInicial'));
  
  var oDbHintMatriculaFinal = new DBHint('oDbHintMatriculaFinal');
      oDbHintMatriculaFinal.setText("Este filtro juntamente com o filtro matrícula inicial invalidam os filtros <br> <strong>Gerar Apenas para as Matrículas:</strong> e <strong>Quantidade de registros do select:</strong>");
      oDbHintMatriculaFinal.setShowEvents(aEventoShow);
      oDbHintMatriculaFinal.setHideEvents(aEventoHide);
      oDbHintMatriculaFinal.make($('matriculaFinal'));
...
if(isset($processar)){
  ...
  $querystring .= "&isencao={$oPost->isencao}";
  ...
  $querystring .= "&matriculaInicial={$oPost->matriculaInicial}";
  $querystring .= "&matriculaFinal={$oPost->matriculaFinal}";
  $querystring .= "&tipoGeracao={$oPost->tipoGeracao}";
  $querystring .= "&emissaoGeralPadrao={$emissaoGeralPadrao}";
  $querystring .= "&expressaoIsento={$oPost->expressaoIsento}";
