...
class M10695 extends PostgresMigration
{
    public function up()
    {
        $sql = <<<PLMANEIRA
      ...
      IF PROCESSA = TRUE THEN
        ...
        FOR RECORD_ALIAS IN
            select k00_receit,
                   ...
                   fc_calculavenci(arrecad.k00_numpre,k00_numpar,k00_dtvenc,dtemite) as k00_dtvenc,
                   arrecad.k00_numpre,
                   k00_numpar,
             ...
             where arrecad.k00_numpre = record_numpre.k99_numpre
               and k00_numpar = numpar
             group by k00_receit,
                      k00_dtoper,
                      arrenumcgm.k00_numcgm,
                      fc_calculavenci(arrecad.k00_numpre,k00_numpar,k00_dtvenc,dtemite),
                      arrecad.k00_numpre,
                      k00_numpar,
                      k00_tipo
