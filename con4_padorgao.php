...
class orgao {
  ...
  function processa($instit=1,$data_ini="",$data_fim="",$tribinst="",$subelemento="") {
    ...
    //////
    $where = " where o40_instit in ($instit)";
    ...
    $sql = "select distinct  o40_anousu,
     ...
     $sql .= " union 
                       select distinct o40_anousu,
                              o40_orgao,
                              o40_descr as nome
                         from orcorgao
                   inner join orcreceita on o70_orcorgao  = o40_orgao
                                        and o70_anousu = o40_anousu
$where and o40_anousu <= $ano ";
