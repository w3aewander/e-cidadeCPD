...
class Proposta extends BaseAbstract
{
    ...
    private static function getSiglaResultado(\OrcamentoFornecedor $oFornecedor, \ItemOrcamento $oItem = null)
    {
        ...
        $sCampos .= "when pc23_vlrun is null or pc23_vlrun = 0 then '" . self::RESULTADO_DESCLASSIFICADO;
        $sCampos .= "' else '" . self::RESULTADO_CLASSIFICADO . "' end as tipo_resultado";
    ...
    public function getResultadoLicitacaoPorLote()
    {
        ...
        $tipoJulgamento = \licitacao::TIPO_JULGAMENTO_POR_LOTE;
        return $this->verificaModalidadeJulgamento($tipoJulgamento) ? $this->getResultadoProposta() : '';
    }
    ...
    public function getResultadoLicitacaoPorItem()
    {
        ...
        $tipoJulgamento = \licitacao::TIPO_JULGAMENTO_POR_ITEM;
        return $this->verificaModalidadeJulgamento($tipoJulgamento) ? $this->getResultadoProposta() : '';
    }
    ...
    public function getResultadoLicitacaoGlobal()
    {
        ...
        $tipoJulgamento = \licitacao::TIPO_JULGAMENTO_GLOBAL;
        return $this->verificaModalidadeJulgamento($tipoJulgamento) ? $this->getResultadoProposta() : '';
    }
