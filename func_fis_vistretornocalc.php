...
include(modification("classes/db_fis_vistretornocalc_classe.php"));
db_postmemory($HTTP_POST_VARS);
parse_str($HTTP_SERVER_VARS["QUERY_STRING"]);
$clvistretornocalc = new cl_fis_vistretornocalc;
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_vistretornocalc.php")==true){
             include(modification("funcoes/db_func_fis_vistretornocalc.php"));
           }else{
           $campos = "fis_vistretornocalc.*";
           }
        }
