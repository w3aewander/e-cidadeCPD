          ...
          <tr>
            <td colspan="2" align="center">
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar"
                     onClick="parent.db_iframe_bensmotbaixa.hide();">
            </td>
          </tr>
        </form>
      </table>
        ...
        if (!isset($pesquisa_chave)) {
            if (isset($campos) == false) {
                if (file_exists("funcoes/db_func_bensmotbaixa.php") == true) {
                    include(modification("funcoes/db_func_bensmotbaixa.php"));
                } else {
                    $campos = "bensmotbaixa.*";
                }
            }
            if (isset($chave_t51_motivo) && (trim($chave_t51_motivo) != "")) {
                ...
                if (isset($chave_t51_descr) && (trim($chave_t51_descr) != "")) {
            ...
            if ($pesquisa_chave != null && $pesquisa_chave != "") {
                ...
                if ($clbensmotbaixa->numrows != 0) {
                    ...
                    echo "<script>" . $funcao_js . "('$t51_descr',false, '$t51_anexoobrigatorio');</script>";
                } else {
