...
use ECidade\Financeiro\Contabilidade\Relatorio\RREO\Factory\Layout\AnexoVI as FactoryLayout;
...
try {
    ...
    $dadosAnexoVI = FactoryRelatorio::getInstance($anoSessao, $get->periodo);
    $dadosAnexoVI->setInstituicoes(str_replace("-", ",", $get->db_selinstit));

    $layoutAnexoVI = FactoryLayout::getInstance($anoSessao);
    $layoutAnexoVI->setAnexo($dadosAnexoVI);
    $layoutAnexoVI->imprimir();
