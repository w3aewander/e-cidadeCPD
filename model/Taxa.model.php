...
class Taxa
{
     ...
     * @var bool
     */
    private $lDebitosComProcesso = false;

    /**
     * Identifica se a taxa sera aplicada a debitos sem processo
     * @var bool
     */
    private $lDebitosSemProcesso = false;

    /**
     * Identifica se a taxa deve aplicar juros e multa
     * @var boolean
     */
    private $lAplicaJuroMulta = false;


    /**
     * Identifica se a taxa deve aplicar honorário
     * @var boolean
     */
    private $lHonorario;

    /**
     * Identifica se taxa pode ser parcelada
     * @var boolean
     */
    private $lPermiteParcelamento;
    ...
    public function __construct($iCodigoTaxa = null)
    {
        ...
        if (!empty($iCodigoTaxa)) {
            ...
            $this->setDebitosComProcesso($oTaxa->ar36_debitoscomprocesso == 't' );
            $this->setDebitosSemProcesso($oTaxa->ar36_debitossemprocesso == 't' );
            $this->aplicaJuroMulta($oTaxa->ar36_aplicajurosmulta == 't');
            $this->aplicaHonorario($oTaxa->ar36_honorario == 't');
            $this->setPermissaoParcelamento($oTaxa->ar36_permiteparcelamento == 't');
        }
    }
    ...
    /**
     * Define se aplica juros e multa na taxa
     * @param  boolean $lAplicaJuroMulta
     */
    public function aplicaJuroMulta($lAplicaJuroMulta = false)
    {
        $this->lAplicaJuroMulta = $lAplicaJuroMulta;
    }

    /**
     * Se aplica juros e multa na taxa
     * @return boolean booleam
     */
    public function isAplicaJuroMulta()
    {
        return $this->lAplicaJuroMulta;
    }

    /**
     * Define se aplica honorário na taxa
     * @param  boolean $lHonorario
     */
    public function aplicaHonorario($lHonorario)
    {
        $this->lHonorario = $lHonorario;
    }

    /**
     * Se aplica honorário na taxa
     * @return boolean booleam
     */
    public function isAplicaHonorario()
    {
        return $this->lHonorario;
    }

    /**
     * Se taxa é de valor fixo
     * @return boolean booleam
     */
    public function isFixo()
    {
        return (!empty($this->nValor) && $this->nValor > 0);
    }

    /**
     * Se taxa é de porcentagem
     * @return boolean booleam
     */
    public function isPorcentagem()
    {
        return (!empty($this->nPercentual) && $this->nPercentual > 0);
    }

    /**
     * Define se a taxa pode ser parcelada
     * @param bool $lPermiteParcelamento
     */
    public function setPermissaoParcelamento($lPermiteParcelamento)
    {
        $this->lPermiteParcelamento = $lPermiteParcelamento;
    }

    /**
     * Retorna se taxa pode ser parcelada
     * @return bool
     */
    public function getPermissaoParcelamento()
    {
        return $this->lPermiteParcelamento;
    }
}
