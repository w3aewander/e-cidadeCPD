...
include(modification("classes/db_fis_autofiscal_classe.php"));
    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_fis_autofiscal.php")==true){
             include(modification("funcoes/db_func_fis_autofiscal.php"));
           }else{
           $campos = "fis_autofiscal.*";
           }
        }
