...
try {
    ...
    switch ($oParam->exec) {
        ...
        case "importar":
            ...
            $contasNaoExcluidas = $oImportacao->getContasNaoExcluidas();
            if (count($contasNaoExcluidas) > 0){
                $msg  = "\n\nAVISO: As contas abaixo não foram excluídas por já possuirem lançamentos contábeis no ano.\n";
                $msg .= implode("\n", $contasNaoExcluidas);
                $oRetorno->mensagem .= $msg;
            }
