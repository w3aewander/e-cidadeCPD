...
?>
  ...
  <form name="form1" method="post" action="">
    <div class="container">
      <fieldset>
        <legend>Tipo de Processo / Documento</legend>
        <table class="form-container">
          <tr>
            ...
            <td>
                <?php
                db_input('p57_codigo', 3, $Ip57_codigo, true, 'text', $db_opcao,
                  " onchange='js_pesquisap57_codigo(false);'");
          ...
          <tr>
            ...
            <td>
                <?php
                db_input('p57_coddoc', 3, $Ip57_coddoc, true, 'text', $db_opcao,
                  " onchange='js_pesquisap57_coddoc(false);'");
          ...
          <tr>
            <td>
              <label for="p57_ouvidoriaobrigatorio">
                Obrigatório( Sistema Externo ):
              </label>
            </td>
      ...
      <table>
        <tr>
          <td align="top" colspan="2">
              ...
              $cliframe_alterar_excluir->sql = $clprocdoctipo->sql_query("", "", $campos, "",
                " p57_codigo = " . @$p57_codigo . "");
  ...
  <script>
    ...
    function js_mostratipoproc(chave, chave2) {
      document.form1.p51_descr.value = chave2;
      location.href = '<?=basename($GLOBALS["HTTP_SERVER_VARS"]["PHP_SELF"])?>' + "?p57_codigo=" + document.form1.p57_codigo.value + "&p51_descr=" + chave2 + "&grupo=" + document.form1.grupo.value;
    }
    ...
    function js_mostraprocdoc(chave, erro, chave2) {
