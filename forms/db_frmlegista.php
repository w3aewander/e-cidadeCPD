  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.cm32_i_numcgm.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_cgm.php?pesquisa_chave='+document.form1.cm32_i_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
