...
class BalancoPatrimonialDCASP2015 extends RelatoriosLegaisBase
{
    ...
    private function escreverLinha(stdClass $oLinha)
    {
        ...
        $this->oPdf->Cell($this->iLargura * 0.20, $this->iAltura, db_formatar($oLinha->vlrexatual, 'f') . $sEspacamento,
            'L' . $sBorda, 0, 'R');
        $this->oPdf->Cell($this->iLargura * 0.20, $this->iAltura, $sExercioAnterior . $sEspacamento, 'L' . $sBorda, 1,
            'R');
