...
function callBackRetorno(oRetorno, lErro) {
  ...
  if (typeof oRetorno.oDadosPaciente.sNomeSocial != "undefined" && oRetorno.oDadosPaciente.sNomeSocial != "") {
    $('nome_social').innerHTML    = oRetorno.oDadosPaciente.sNomeSocial.urlDecode();
  }
