...
if (isset($processar)) {
    ...
    try {
        ...
        foreach ($aMatriculas as $iMatricula) {
            ...
            $sSqlDadosPeriodoAquisitivo = "select distinct
                                                   rh01_regist                              as rh109_regist,
                                                   (rh109_periodoaquisitivofinal+1)::date  as rh109_periodoaquisitivoinicial,
                                                   (rh109_periodoaquisitivofinal +  '1 year'::interval)::date  as rh109_periodoaquisitivofinal,
                                            ...
                                            order by rh109_periodoaquisitivofinal desc
                                            limit 1";


            $rsNovoPeriodoAquisitivo = db_query($sSqlDadosPeriodoAquisitivo);
            if (pg_num_rows($rsNovoPeriodoAquisitivo) == 0) {
                continue;
            }
            ...
            foreach ($dadosParaIncluir as $periodosInclusao) {
                ...
                $oDaoRhPeriodoAquisitivo->rh109_regist = $periodosInclusao->rh109_regist;
                $oDaoRhPeriodoAquisitivo->rh109_periodoaquisitivoinicial = $periodosInclusao->rh109_periodoaquisitivoinicial;
                $oDaoRhPeriodoAquisitivo->rh109_periodoaquisitivofinal = $periodosInclusao->rh109_periodoaquisitivofinal;
                $oDaoRhPeriodoAquisitivo->rh109_diasdireito = $periodosInclusao->rh109_diasdireito;
                $oDaoRhPeriodoAquisitivo->rh109_faltasperiodoaquisitivo = 0;
                $oDaoRhPeriodoAquisitivo->rh109_perdeudireitoferias = 'false';
                $oDaoRhPeriodoAquisitivo->rh109_observacao = 'Período gerado automaticamente';
                $oDaoRhPeriodoAquisitivo->incluir(null);
                if ($oDaoRhPeriodoAquisitivo->erro_status == 0) {
                    throw new BusinessException("Não foi possível criar o período aquisitivo para o servidor {$periodosInclusao->rh109_regist}\n" . $oDaoRhPeriodoAquisitivo->erro_msg);
                }
            }
