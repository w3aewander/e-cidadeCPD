 ...
 echo "
  <script>     
      function js_db_libera(){
         ...
         (window.CurrentWindow || parent.CurrentWindow).corpo.iframe_benstransfcodigo.location.href='pat1_benstransfcodigo001.php?t95_codtran=".@$t93_codtran."&t93_depart=".@$t93_depart."';
     ";
         if(isset($liberaaba)){
