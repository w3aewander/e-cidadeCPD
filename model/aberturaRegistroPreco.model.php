...
class aberturaRegistroPreco extends solicitacaoCompra {
  ...
  public function __construct($iRegistroCompras = '') {
     ...
     */
    public function setAlterado($lItensAlterados) {

        $this->lItensAlterados = $lItensAlterados;
    }

    public function isAlterado() {
        return $this->lItensAlterados;
    }
   ...
   */
    ...
    // Insere ou atualiza os dados da abertura
  ...
  public function removerItemVinculadoNoItemDaAbertura($iCodigoItemAbertura) {
    ...
    //dump('Itens vinculados: ', $sSqlItensVinculados);
