...
class DocumentoContabilRegra {
  ...
  public function salvar() {
    ...
    $oDaoRegra                     = new cl_conhistdocregra();
    $oDaoRegra->excluir(null, "c92_conhistdoc = {$this->iCodigoDocumento} and c92_anousu = {$this->iAnoUsu}");
