...
class M22244CalculoIptuCampinaGrande2023 extends Migration
{
...
SQL
    ...
    public function upEstrutura()
    {
        ...
        CREATE OR REPLACE FUNCTION fc_calculoiptu_campinagrande_2023(integer,integer,boolean,boolean,boolean,boolean,boolean,integer,integer) RETURNS varchar(100) AS
        $$
        ...
        */
          ...
          perform fc_debug('PARAMETROS fc_iptu_calculavvt_campinagrande_2023 IDBQL: '||iIdbql||' - iMatricula: '||iMatricula||' - Anousu: '||iAnousu||' - FRACAO DO LOTE: '||nFracaolote||' - DEMO: '||lDemonstrativo||' - DEBUG: '||lRaise, lRaise);
          ...
          from fc_iptu_calculavvt_campinagrande_2023( iIdbql, iMatricula, iAnousu, nFracaolote, lDemonstrativo, lRaise);

          perform fc_debug('RETORNO fc_iptu_calculavvt_campinagrande_2023 -> VVT: '||nVvt||' - AREA CONSTRUIDA: '||nAreac||' - RETORNO: '||tRetorno||' - ERRO: '||lErro, lRaise);
          ...
          perform fc_debug('PARAMETROS fc_iptu_calculavvc_campinagrande_2023 MATRICULA: '||iMatricula||' - ANOUSU: '||iAnousu||' - DEMO: '||lDemonstrativo||' - DEBUG: '||lRaise, lRaise);
          ...
          from fc_iptu_calculavvc_campinagrande_2023( iMatricula, iAnousu, lDemonstrativo, lRaise );

          perform fc_debug('RETORNO fc_iptu_calculavvc_campinagrande_2023 -> VVC: '||nVvc||' - AREA TOTAL: '||nTotarea||' - NUMERO DE CONSTRUCOES: '||iNumconstr||' - RETORNO: '||tRetorno||' - ERRO: '||lErro, lRaise);
          perform fc_debug('', lRaise);
          ...
          from fc_iptu_getaliquota_campinagrande_2023(iMatricula, iIdbql, iAnousu, lPredial, lSubRaise);
...
SQL1
        ...
        create or replace function fc_iptu_taxalixo_campinagrande_2023(integer, numeric, integer, numeric, numeric, boolean) returns boolean as
        $$
...
SQL2
        ...
        create or replace function fc_iptu_calculavvc_campinagrande_2023(integer,integer,boolean,boolean) returns tp_iptu_calculavvc as
        $$
         ...
         begin
             ...
             for rConstr in select j39_matric, j39_idcons, j39_idprinc, j39_area, j39_areap
                             ...
                             where j39_matric = iMatricula
                               and j39_dtdemo is null
                               /* (Redmine: M22244) - Busca com se tiver caracteristicas diferente de: 11-NAO CONSTRUIDO */
                               and exists (select 1
                                             from carconstr
                                            where j48_matric = iMatricula
                                              and j48_caract in (11))
...
SQL3
        ...
        create or replace function fc_iptu_calculavvt_campinagrande_2023(integer,integer,integer,numeric,boolean,boolean) returns tp_iptu_calculavvt as
        $$
...
SQL4
        ...
        */
        ...
        create or replace function fc_iptu_getaliquota_campinagrande_2023(integer, integer, integer, boolean, boolean) returns tp_aliquota_iptu as
        $$
...
SQL5
    ...
    public function downDicionario()
    {
      ...
      delete
        ...
        where db42_funcao in (224, 225, 226, 227, 228);

      delete
        from db_sysfuncoes
       where codfuncao in (224, 225, 226, 227, 228);
SQL
);
    }
    ...
    public function downEstrutura()
    {
      ...
      drop function if exists fc_iptu_taxalixo_campinagrande_2023(integer, numeric, integer, numeric, numeric, boolean);
      drop function if exists fc_calculoiptu_campinagrande_2023(integer,integer,boolean,boolean,boolean,boolean,boolean,integer,integer);
      drop function if exists fc_iptu_calculavvc_campinagrande_2023(integer,integer,boolean,boolean);
      drop function if exists fc_iptu_calculavvt_campinagrande_2023(integer,integer,integer,numeric,boolean,boolean);
      drop function if exists fc_iptu_getaliquota_campinagrande_2023(integer, integer, integer, boolean, boolean);
