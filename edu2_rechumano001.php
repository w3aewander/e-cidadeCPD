...
<body  class="container" bgcolor="#CCCCCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1">
<center>
        ...
        <tr>
            <td valign="top" bgcolor="#CCCCCC">
                ...
                <fieldset style="width:95%">
                    <legend><b>Relatório de Recursos Humanos</b></legend>
                    <table border="0">
                        <tr>
                            <?php
                            if ($iModulo == 7159) {
                                ...
                                $sSqlEscola = $oDaoEscola->sql_query_file("", "ed18_i_codigo,ed18_c_nome", "ed18_c_nome", "");
                        ...
                        <tr>
                            <td align="left">
                                ...
                                <select id="atividade" name="atividade" size="15" style="font-size:9px;width:300px;"
                                        multiple>
                        ...
                        <tr>
                            <td align="left">
                                <b>Exibir Data de Saída? </b><br>
                                <select id="saida" name="saida" style="font-size:9px;width:300px;">
                            ...
                            <td>
                                <fieldset style="width:250;align:center">
                                    Caso SIM o relatório irá incluir todos os servidores que estão registrados para a
                                    Escola, mesmo que já tenham encerrado suas atividades.
                                </fieldset>
                            </td>
                        <tr>
                            <td align="left">
                                <b>Exibir Relatório Com: </b><br>
                                <select id="tipoRelatorio" name="tipoRelatorio" style="font-size:9px;width:300px;">
                        ...
                        <tr>
                            <td valign='bottom'>
                                ...
                                <input type="button" name="procurar" value="Processar"
                                       onclick="js_procurar(document.form1.atividade.value)">
                            </td>
                        </tr>
                    </table>
                </fieldset>
...
<script>
    function js_procurar(atividade) {
        ...
        if ($('tipoRelatorio').value == 'cpf') {

            jan = window.open('edu2_rechumano002.php?atividades=' + atividades + '&ordem=' + $('ordem').value + '&iEscola=' + $('escola').value + '&saida=' + $('saida').value,
                '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0 '
            );
            jan.moveTo(0, 0);

        } else if ($('tipoRelatorio').value == 'assinatura') {

            jan = window.open('edu2_rechumano003.php?atividades=' + atividades + '&ordem=' + $('ordem').value + '&iEscola=' + $('escola').value + '&saida=' + $('saida').value,
                '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0 '
            );
            jan.moveTo(0, 0);
