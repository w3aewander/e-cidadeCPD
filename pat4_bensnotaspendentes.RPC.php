...
switch ($oParam->exec) {
    case "getNotasPendentes":
        ...
        //$sCamposBensPendentes .= "e60_anousu as anoempenho";
        $sCamposBensPendentes .= "e69_numero as numeronf";
        ...
        if (!empty($dtImplantacaoDepreciacao) && !USE_PCASP) {
        ...
        $sSqlDadosBensPendentes = $oDaoNotaItemBensPendentes->sql_query_bens_nota(null, $sCamposBensPendentes, null,
          $sWhereBensPendentes);
    ...
    case "getBensPorCodigoNota":
        ...
        $sSqlBensNotaPendente = $oDaoNotaItemBensPendentes->sql_query_bens(null, $sCamposBensNotaPendentes, null,
          $sWhereBensNotaPendente);
