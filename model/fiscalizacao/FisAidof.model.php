...
class FisAidof {
  ...
  public function __construct($iCodigo = null) {
    ...
    $oDaoAidof = db_utils::getDao('fis_aidof');
    ...
    $this->oGrafica                     = new FisGrafica($oAidof->y08_numcgm);
    ...
    $oDaoAidofProc = db_utils::getDao('fis_aidofproc');
   ...
   * @param oGrafica
   */
  public function setGrafica( FisGrafica $oGrafica ) {
  ...
  public function salvar() {
    ...
    db_utils::getDao('fis_aidofproc', false);
    db_utils::getDao('fis_aidof', false);

    $oDaoAidof               = new cl_fis_aidof();
    ...
    if ( empty($this->iCodigo) ) {
       ...
       */
      $oDaoAidofProc = new cl_fis_aidofproc();
  ...
  public static function getProximaNumeracao() {
    ...
    $sUpdate  = "update fis_aidofnumeracao                      ";
    ...
    $sSqlNextVal .= "   from fis_aidofnumeracao         ";
     ...
     */
    $lAtualizaSequencial = db_query("select setval('fis_aidof_y08_codigo_seq', {$iNumeroAidof})");
