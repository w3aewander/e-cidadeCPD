...
//MODULO: fiscal
$clcadgestorfiscal->rotulo->label();
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cadgestorfiscal','func_fis_cadgestorfiscal_instit.php?funcao_js=parent.js_preenchepesquisa|id_usuario','Pesquisa',true);
}
function js_preenchepesquisa(chave){
  db_iframe_cadgestorfiscal.hide();
  <?php 
  if($db_opcao!=1){
