...
<form id="formPesquisarEsocial" method="POST" action="eso2_preenchimentodesligamento.php" class="container">
    <fieldset>
        <legend>Dados do servidor/ funcionário:</legend>
...
<script>
    (function() {
        ...
        var oLookUpCgm = new DBLookUp ($('lbl_rh01_regist'), $('rh01_regist'), $('z01_nome'), {
            'sArquivo'      : 'func_desligamentoservidor.php',
            'sLabel'        : 'Pesquisa de Servidores Desligados',
