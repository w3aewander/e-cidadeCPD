...
$oRotuloCampo->label("rh168_tipoassentamentopecunia");
...
if (isset($oPost->btnSalvar)) {
    ...
    $oDaoFeriasConfiguracao->rh168_tipoassentamentopecunia = $oPost->rh168_tipoassentamentopecunia;
...
$sCampos .= "rh168_tipoassentamentopecunia, assentamento_pecunia.h12_assent as h12_assent_pecunia, ";
$sCampos .= "assentamento_pecunia.h12_descr as h12_descricao_pecunia,";
    ...
    <div class="container">
      <fieldset>
        ...
        <table>
          ...
          <tr>
            <td>
              <label for="h12_assent_pecunia">
                  <?php db_ancora($Lrh168_tipoassentamentopecunia, "js_pesquisa_assentamento(true, 'pecunia')", 1);?>
              </label>
            </td>
            <td>
                <?php
                db_input("rh168_tipoassentamentopecunia", 10, $Irh168_tipoassentamentopecunia, true, 'hidden');
                db_input("h12_assent", 10, $Ih12_assent, true, 'text', 1, "onchange='js_pesquisa_assentamento(false, \"pecunia\")'", "h12_assent_pecunia");
                db_input("h12_descricao_pecunia", 30, $Ih12_descr, true, 'text', 3);
                ?>
            </td>
          </tr>
          <tr>
