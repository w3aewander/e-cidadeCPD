...
class InformacoesFinanceirasTipoAssentamento
{
    ...
    private function __construct(TipoAssentamento $oTipoAssentamento)
    {
        ...
        $sSqlTipoassefinanceiro = $oDaoTipoassefinanceiro->sql_query_file(null,
            "*,(select db148_formula from db_formulas where db148_sequencial = rh165_db_formulas) as db148_formula",
            null, $sWhereTipoassefinanceiro);
    ...
    {
        return new InformacoesFinanceirasTipoAssentamento($oTipoAssentamento);
