...
require_once(modification("libs/db_utils.php"));
  ...
  $sqlPrescr .= "          coalesce(dv05_exerc, v01_exerc) as v01_exerc,                                       ";
  ...
  $sqlPrescr .= "          procdivida.v03_codigo     as procdivida_codigo,                                     ";
  $sqlPrescr .= "          procdivida.v03_descr      as procdivida_descricao,                                  ";
  $sqlPrescr .= "          procdivida.v03_tributaria as procdivida_tributaria,                                 ";
  $sqlPrescr .= "          tipodivida.v07_descricao  as tipodivida_descricao,                                  ";
 
  $sqlPrescr .= "          procdiversos.v03_codigo     as procdiversos_codigo,                                 ";
  $sqlPrescr .= "          procdiversos.v03_descr      as procdiversos_descricao,                              ";
  $sqlPrescr .= "          procdiversos.v03_tributaria as procdiversos_tributaria,                             ";
  $sqlPrescr .= "          tipodiver.v07_descricao     as tipodiver_descricao,                                 ";
  ...
  // DIVIDA
  $sqlPrescr .= " LEFT JOIN divida ON v01_numpre = arreprescr.k30_numpre AND v01_numpar = arreprescr.k30_numpar ";
  $sqlPrescr .= " LEFT JOIN proced procdivida ON procdivida.v03_codigo = divida.v01_proced  ";
  $sqlPrescr .= " LEFT JOIN tipoproced tipodivida ON tipodivida.v07_sequencial = procdivida.v03_tributaria ";

  // DIVERSOS
  $sqlPrescr .= " LEFT JOIN diversos ON dv05_numpre = arreprescr.k30_numpre ";
  $sqlPrescr .= " LEFT JOIN procdiver ON procdiver.dv09_procdiver = diversos.dv05_procdiver ";
  $sqlPrescr .= " LEFT JOIN proced procdiversos ON procdiversos.v03_codigo = procdiver.dv09_proced ";
  $sqlPrescr .= " LEFT JOIN tipoproced tipodiver ON tipodiver.v07_sequencial = procdiversos.v03_tributaria ";
  ...
  $sqlPrescr .= "         left  join taborc             on taborc.k02_codigo     = tabrec.k02_codigo           ";
  $sqlPrescr .= "                                      and taborc.k02_anousu     = ".db_getsession("DB_anousu");
  $sqlPrescr .= "           left join orcreceita        on taborc.k02_anousu = o70_anousu                      ";
  $sqlPrescr .= "                                      and k02_codrec = o70_codrec                             ";
  $sqlPrescr .= "           left join orcfontes         on o57_anousu = o70_anousu                      ";
  $sqlPrescr .= "                                      and o57_codfon = o70_codfon                             ";
  ...
  $sqlPrescr .= " $orderby ";
    ...
    $oPrescr->v03_codigo     =  !empty($oPrescr->procdivida_codigo)     ? $oPrescr->procdivida_codigo     : $oPrescr->procdiversos_codigo;
    $oPrescr->v03_descr      =  !empty($oPrescr->procdivida_descricao)  ? $oPrescr->procdivida_descricao  : $oPrescr->procdiversos_descricao;
    $oPrescr->v03_tributaria =  !empty($oPrescr->procdivida_tributaria) ? $oPrescr->procdivida_tributaria : $oPrescr->procdiversos_tributaria;
    $oPrescr->v07_descricao  =  !empty($oPrescr->tipodivida_descricao)  ? $oPrescr->tipodivida_descricao  : $oPrescr->tipodiver_descricao;
      ...
      if ( isset($aResumos[$sDescrAgrupa][$oPrescr->$sCampo]) ) {
		...
		if($oGet->seltipo == "c"){
		  ...
		  if($oGet->selhist == "s" &&  $codPrescr != $oPrescr->k31_codigo && $iInd !=0 ){
				...
				if(strlen($obsPrescr) > 200){
					$pdf->MultiCell(280,$alt,"Histórico : ".$obsPrescr,0,"L",($iList==0?$iList=1:$iList=0));
				} else {
