...
/**
 * Função que envia os dados para o RPC
 */
                   ...
                   var aRow    = new Array();
                       ...
                       */
                       if (oDado.tipo == "ERRO") {
                         ...
                         sTipoInconsistencia = '<span style="color:#FF0000; font-weight:bold;">'+oDado.tipoErro+'</span>';
                       }
                       if (oDado.tipo == "SUCESSO") {
                        //  $('gerararquivo').disabled = true;
                         sTipoInconsistencia = '<span style="color:#00AB66; font-weight:bold;">'+oDado.tipoErro+'</span>';
                       }
