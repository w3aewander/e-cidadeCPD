...
class cl_curso {
  ...
  // funcao do sql
  public function sql_cursos_ministrados ($ed29_i_codigo = null,$campos = "*", $ordem = null, $dbwhere = "") {

    $sql  = "select {$campos}";
    $sql .= "  from cursoedu   ";
    $sql .= "  join ensino     on ensino.ed10_i_codigo     = cursoedu.ed29_i_ensino";
    $sql .= "  join base       on base.ed31_i_curso        = cursoedu.ed29_i_codigo";
    $sql .= "  join turma      on turma.ed57_i_base        = base.ed31_i_codigo ";
    $sql .= "  join calendario on calendario.ed52_i_codigo = ed57_i_calendario ";
